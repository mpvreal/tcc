...
define dso_local void @_Z8psq_evalP7state_tP12t_eval_comps(ptr nocapture noundef readonly %0, ptr nocapture noundef %1) local_unnamed_addr #0 {
  ...
  %7 = or i64 %6, %4
  %8 = load i64, ptr @KSMask, align 8, !tbaa !5
  %9 = and i64 %7, %8
  %10 = icmp eq i64 %9, 0
  %11 = load i64, ptr @QSMask, align 8, !tbaa !5
  %12 = and i64 %11, %7
  %13 = icmp eq i64 %12, 0
...
59:                                               ; preds = %5, %10, %20, %30, %40, %51, %47, %37, %27, %17, %7
  ...
  br i1 %64, label %65, label %5, !llvm.loop !22

65:                                               ; preds = %59
  %66 = add nuw nsw i64 %2, 1
  %67 = icmp eq i64 %66, 13
  br i1 %67, label %68, label %1, !llvm.loop !23
...
!12 = !{!11, !11, i64 0}
!13 = !{!14, !11, i64 24}
!14 = !{!"_ZTS12t_eval_comps", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !11, i64 32, !11, i64 36, !11, i64 40}
!15 = !{!10, !11, i64 468}
!16 = !{!14, !11, i64 28}
!17 = !{!10, !6, i64 264}
!18 = !{!7, !7, i64 0}
