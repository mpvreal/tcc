...
define dso_local noundef i32 @_Z3seeP7state_tiiii(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4) local_unnamed_addr #0 {
  ...
  store i32 %29, ptr %6, align 16, !tbaa !5
  %30 = icmp eq i32 %4, 0
...
63:                                               ; preds = %41
  %64 = load i32, ptr %6, align 16, !tbaa !5
  br label %181
...
80:                                               ; preds = %72
  %81 = load i64, ptr %68, align 8, !tbaa !12
  %82 = and i64 %81, %76
  %83 = icmp eq i64 %82, 0
...
88:                                               ; preds = %84
  %89 = load i64, ptr %54, align 8, !tbaa !12
  %90 = and i64 %89, %76
  %91 = icmp eq i64 %90, 0
  br i1 %91, label %92, label %128

92:                                               ; preds = %88
  %93 = load i64, ptr %48, align 8, !tbaa !12
  %94 = and i64 %93, %76
  %95 = icmp eq i64 %94, 0
...
100:                                              ; preds = %96
  %101 = load i64, ptr %61, align 8, !tbaa !12
  %102 = and i64 %101, %76
  %103 = icmp eq i64 %102, 0
  br i1 %103, label %159, label %128

104:                                              ; preds = %72
  %105 = load i64, ptr %66, align 8, !tbaa !12
  %106 = and i64 %105, %76
  %107 = icmp eq i64 %106, 0
  br i1 %107, label %108, label %128

108:                                              ; preds = %104
  %109 = load i64, ptr %67, align 8, !tbaa !12
  %110 = and i64 %109, %76
  %111 = icmp eq i64 %110, 0
  br i1 %111, label %112, label %128

112:                                              ; preds = %108
  %113 = load i64, ptr %56, align 8, !tbaa !12
  %114 = and i64 %113, %76
...
120:                                              ; preds = %116
  %121 = load i64, ptr %45, align 8, !tbaa !12
  %122 = and i64 %121, %76
...
128:                                              ; preds = %124, %120, %116, %112, %108, %104, %100, %96, %92, %88, %84, %80
  ...
  %138 = load i64, ptr %70, align 8, !tbaa !12
  %139 = and i64 %138, %53
...
145:                                              ; preds = %141, %128
  ...
  %147 = load i64, ptr %71, align 8, !tbaa !12
  %148 = and i64 %147, %59
...
154:                                              ; preds = %150, %145
  ...
  br i1 %158, label %159, label %72, !llvm.loop !13
...
169:                                              ; preds = %167, %169
  ...
  br i1 %180, label %169, label %181, !llvm.loop !15
