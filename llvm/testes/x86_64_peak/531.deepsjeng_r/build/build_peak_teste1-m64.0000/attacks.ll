...
126:                                              ; preds = %122, %115
  ...
  %129 = load i64, ptr %102, align 8, !tbaa !11
  %130 = or i64 %129, %128
...
5:                                                ; preds = %1
  ...
  %8 = tail call noundef i32 @_Z11is_attackedP7state_tii(ptr noundef nonnull %0, i32 noundef %7, i32 noundef 0), !range !14
  br label %13

9:                                                ; preds = %1
  %10 = getelementptr inbounds %struct.state_t, ptr %0, i64 0, i32 13
  %11 = load i32, ptr %10, align 4, !tbaa !15
  %12 = tail call noundef i32 @_Z11is_attackedP7state_tii(ptr noundef nonnull %0, i32 noundef %11, i32 noundef 1), !range !14
  br label %13
