...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #0 {
  ...
  %21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef 100, i32 noundef 100, i32 noundef 130, double noundef nofpclass(nan inf) 0x3FF4CCCCCCCCCCCC, i32 noundef %6, ptr noundef %8, ptr noundef nonnull %20, ptr noundef nonnull %18, ptr noundef nonnull %16)
...
25:                                               ; preds = %23, %35
  ...
  %27 = load ptr, ptr @srcGrid, align 8, !tbaa !15
  call void @LBM_handleInOutFlow(ptr noundef %27) #9
  %28 = load ptr, ptr @srcGrid, align 8, !tbaa !15
  %29 = load ptr, ptr @dstGrid, align 8, !tbaa !15
...
32:                                               ; preds = %25
  ...
  %34 = load ptr, ptr @srcGrid, align 8, !tbaa !15
...
38:                                               ; preds = %23, %47
  ...
  %40 = load ptr, ptr @srcGrid, align 8, !tbaa !15
  %41 = load ptr, ptr @dstGrid, align 8, !tbaa !15
...
44:                                               ; preds = %38
  ...
  %46 = load ptr, ptr @srcGrid, align 8, !tbaa !15
...
50:                                               ; preds = %47, %35, %2
  %51 = load ptr, ptr @srcGrid, align 8, !tbaa !15
...
37:                                               ; preds = %28
  ...
  %40 = icmp eq i64 %39, 1313130
  br i1 %40, label %47, label %41

41:                                               ; preds = %37
  %42 = load ptr, ptr %31, align 8, !tbaa !14
  %43 = trunc i64 %39 to i32
  %44 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, ptr noundef %42, i32 noundef %43, i32 noundef 1313130)
  tail call void @exit(i32 noundef 1) #10
  unreachable
...
define dso_local void @MAIN_printInfo(ptr nocapture noundef readonly %0) local_unnamed_addr #2 {
  ...
  %19 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef 100, i32 noundef 100, i32 noundef 130, double noundef nofpclass(nan inf) 0x3FF4CCCCCCCCCCCC, i32 noundef %4, ptr noundef %6, ptr noundef nonnull %18, ptr noundef nonnull %16, ptr noundef nonnull %14)
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %3) #9
...
define dso_local void @MAIN_initialize(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  ...
  %2 = load ptr, ptr @srcGrid, align 8, !tbaa !15
  tail call void @LBM_initializeGrid(ptr noundef %2) #9
  %3 = load ptr, ptr @dstGrid, align 8, !tbaa !15
...
7:                                                ; preds = %1
  %8 = load ptr, ptr @srcGrid, align 8, !tbaa !15
  tail call void @LBM_loadObstacleFile(ptr noundef %8, ptr noundef nonnull %5) #9
  %9 = load ptr, ptr @dstGrid, align 8, !tbaa !15
...
11:                                               ; preds = %7, %1
  ...
  %14 = icmp eq i32 %13, 1
  %15 = load ptr, ptr @srcGrid, align 8, !tbaa !15
  br i1 %14, label %16, label %18

16:                                               ; preds = %11
  tail call void @LBM_initializeSpecialCellsForChannel(ptr noundef %15) #9
  %17 = load ptr, ptr @dstGrid, align 8, !tbaa !15
...
18:                                               ; preds = %11
  ...
  %19 = load ptr, ptr @dstGrid, align 8, !tbaa !15
  tail call void @LBM_initializeSpecialCellsForLDC(ptr noundef %19) #9
  br label %20

20:                                               ; preds = %18, %16
  %21 = load ptr, ptr @srcGrid, align 8, !tbaa !15
...
6:                                                ; preds = %1
  %7 = load ptr, ptr @srcGrid, align 8, !tbaa !15
...
!5 = !{!6, !7, i64 0}
!6 = !{!"", !7, i64 0, !10, i64 8, !8, i64 16, !8, i64 20, !10, i64 24}
!7 = !{!"int", !8, i64 0}
...
!18 = !{!19, !20, i64 48}
!19 = !{!"stat", !20, i64 0, !20, i64 8, !20, i64 16, !7, i64 24, !7, i64 28, !7, i64 32, !7, i64 36, !20, i64 40, !20, i64 48, !20, i64 56, !20, i64 64, !21, i64 72, !21, i64 88, !21, i64 104, !8, i64 120}
!20 = !{!"long", !8, i64 0}
