...
6:                                                ; preds = %1, %18
  ...
  %17 = load ptr, ptr @perm_p, align 8, !tbaa !6
  br label %25

18:                                               ; preds = %52
  %19 = getelementptr inbounds %struct.basket, ptr %53, i64 0, i32 3
  store i64 %9, ptr %19, align 8, !tbaa !10
  ...
  br i1 %24, label %81, label %6, !llvm.loop !13
...
38:                                               ; preds = %35
  ...
  %41 = load ptr, ptr @perm_p, align 8, !tbaa !6
...
44:                                               ; preds = %42, %35
  ...
  store ptr %45, ptr %2, align 8, !tbaa !6
  br label %47
...
57:                                               ; preds = %75, %55
  ...
  %60 = load ptr, ptr %58, align 8, !tbaa !6
...
66:                                               ; preds = %57
  ...
  store i64 %59, ptr %67, align 8, !tbaa !10
...
75:                                               ; preds = %66
  ...
  br i1 %80, label %81, label %57, !llvm.loop !13
...
define dso_local void @worker(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  ...
  %13 = load ptr, ptr @basket_sizes, align 8, !tbaa !6
...
18:                                               ; preds = %3
  ...
  %23 = load ptr, ptr @basket, align 8, !tbaa !6
...
65:                                               ; preds = %60, %65
  %66 = load ptr, ptr @basket_sizes, align 8, !tbaa !6
  %67 = load i64, ptr %12, align 8, !tbaa !21
  %68 = add nsw i64 %67, %14
  %69 = srem i64 %68, %61
  %70 = load i64, ptr %62, align 8, !tbaa !25
...
77:                                               ; preds = %55, %77
  ...
  br i1 %84, label %58, label %77, !llvm.loop !27

85:                                               ; preds = %60, %85
  %86 = load ptr, ptr @basket_sizes, align 8, !tbaa !6
  %87 = load i64, ptr %12, align 8, !tbaa !21
  %88 = add nsw i64 %87, %14
  %89 = srem i64 %88, %61
  %90 = load i64, ptr %62, align 8, !tbaa !25
  ...
  %92 = load ptr, ptr @opt_basket, align 8, !tbaa !6
  %93 = getelementptr inbounds ptr, ptr %92, i64 %14
  store ptr %91, ptr %93, align 8, !tbaa !6
  %94 = load ptr, ptr @perm_p, align 8, !tbaa !6
  %95 = getelementptr inbounds ptr, ptr %94, i64 %14
  store ptr %63, ptr %95, align 8, !tbaa !6
...
define dso_local void @master(ptr nocapture noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  ...
  %17 = load ptr, ptr @basket_sizes, align 8, !tbaa !6
...
20:                                               ; preds = %2
  %21 = load ptr, ptr @basket, align 8, !tbaa !6
...
29:                                               ; preds = %29, %26
  ...
  br i1 %46, label %47, label %29, !llvm.loop !28
...
60:                                               ; preds = %49, %60
  ...
  br i1 %65, label %51, label %60, !llvm.loop !29

66:                                               ; preds = %53, %158
  %67 = load ptr, ptr @basket_sizes, align 8, !tbaa !6
  %68 = load i64, ptr %15, align 8, !tbaa !21
  %69 = srem i64 %68, %54
  %70 = load i64, ptr %55, align 8, !tbaa !25
  ...
  %73 = load ptr, ptr @perm_p, align 8, !tbaa !6
  store ptr %56, ptr %73, align 8, !tbaa !6
...
84:                                               ; preds = %83
  ...
  %88 = load ptr, ptr @opt_basket, align 8, !tbaa !6
...
95:                                               ; preds = %82, %83, %84, %92
  ...
  br i1 %98, label %100, label %74, !llvm.loop !30
...
109:                                              ; preds = %107
  ...
  store i64 %111, ptr %15, align 8, !tbaa !21
...
121:                                              ; preds = %109
  ...
  store i64 %123, ptr %16, align 8, !tbaa !21
  %124 = getelementptr inbounds %struct.arc, ptr %105, i64 0, i32 4
  %125 = load i16, ptr %124, align 8, !tbaa !33
  %126 = icmp eq i16 %125, 2
  %127 = select i1 %126, i16 1, i16 2
  store i16 %127, ptr %124, align 8, !tbaa !33
...
132:                                              ; preds = %109
  ...
  %154 = load i64, ptr %59, align 8, !tbaa !42
  ...
  store i16 0, ptr %155, align 8, !tbaa !33
  %156 = getelementptr inbounds %struct.arc, ptr %140, i64 0, i32 4
  store i16 %145, ptr %156, align 8, !tbaa !33
  br label %158
...
158:                                              ; preds = %132, %130, %121
  ...
  br i1 %159, label %160, label %66, !llvm.loop !43
...
define dso_local i64 @primal_net_simplex(ptr noundef %0) local_unnamed_addr #0 {
  ...
  %10 = load ptr, ptr @perm_p, align 8, !tbaa !6
  tail call void @free(ptr noundef %10) #5
  %11 = load ptr, ptr @opt_basket, align 8, !tbaa !6
  tail call void @free(ptr noundef %11) #5
  %12 = load ptr, ptr @basket_sizes, align 8, !tbaa !6
  tail call void @free(ptr noundef %12) #5
  %13 = load ptr, ptr @basket, align 8, !tbaa !6
...
!9 = !{!"Simple C/C++ TBAA"}
!10 = !{!11, !12, i64 24}
!11 = !{!"basket", !7, i64 0, !12, i64 8, !12, i64 16, !12, i64 24}
!12 = !{!"long", !8, i64 0}
!13 = distinct !{!13, !14}
!14 = !{!"llvm.loop.mustprogress"}
!15 = distinct !{!15, !14}
!16 = !{!17, !7, i64 568}
!17 = !{!"network", !8, i64 0, !8, i64 200, !12, i64 400, !12, i64 408, !12, i64 416, !12, i64 424, !12, i64 432, !12, i64 440, !12, i64 448, !12, i64 456, !12, i64 464, !12, i64 472, !12, i64 480, !12, i64 488, !12, i64 496, !12, i64 504, !12, i64 512, !12, i64 520, !12, i64 528, !18, i64 536, !12, i64 544, !7, i64 552, !7, i64 560, !7, i64 568, !7, i64 576, !7, i64 584, !7, i64 592, !7, i64 600, !12, i64 608, !12, i64 616, !12, i64 624, !12, i64 632, !12, i64 640}
!18 = !{!"double", !8, i64 0}
!19 = !{!17, !7, i64 576}
!20 = !{!17, !12, i64 424}
!21 = !{!12, !12, i64 0}
...
!28 = distinct !{!28, !14, !23, !24}
!29 = distinct !{!29, !14, !24, !23}
!30 = distinct !{!30, !14}
!31 = !{!11, !12, i64 8}
!32 = !{!11, !7, i64 0}
!33 = !{!34, !36, i64 32}
!34 = !{!"arc", !35, i64 0, !12, i64 8, !7, i64 16, !7, i64 24, !36, i64 32, !7, i64 40, !7, i64 48, !12, i64 56, !12, i64 64}
!35 = !{!"int", !8, i64 0}
!36 = !{!"short", !8, i64 0}
!37 = !{!38, !7, i64 24}
!38 = !{!"node", !12, i64 0, !35, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !12, i64 80, !12, i64 88, !35, i64 96, !35, i64 100}
!39 = !{!38, !7, i64 48}
!40 = !{!38, !35, i64 8}
!41 = !{!34, !7, i64 16}
!42 = !{!17, !12, i64 512}
