...
-o aminos.out -e aminos.err echo "../run_peak_train_teste1-m64.0000/nab_r_peak.teste1-m64 aminos 391519156 1000" > run.sh ; $BIND bash run.sh
-o gcn4dna.out -e gcn4dna.err echo "../run_peak_train_teste1-m64.0000/nab_r_peak.teste1-m64 gcn4dna 1850041461 300" > run.sh ; $BIND bash run.sh
