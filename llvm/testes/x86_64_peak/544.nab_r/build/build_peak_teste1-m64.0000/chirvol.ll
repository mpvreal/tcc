...
define dso_local void @chirvol(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, ptr nocapture noundef readonly %5, ptr nocapture noundef %6, ptr nocapture noundef %7) local_unnamed_addr #0 {
  ...
  %60 = load <2 x double>, ptr %11, align 8, !tbaa !5
  ...
  store double %101, ptr %7, align 8, !tbaa !5
  store <2 x double> %84, ptr %52, align 8, !tbaa !5
  store double %90, ptr %54, align 8, !tbaa !5
  ...
  store <2 x double> %106, ptr %56, align 8, !tbaa !5
  store double %109, ptr %57, align 8, !tbaa !5
  ...
  store <2 x double> %116, ptr %58, align 8, !tbaa !5
  store double %119, ptr %59, align 8, !tbaa !5
  %120 = fadd fast <2 x double> %110, %116
  %121 = fneg fast <2 x double> %120
  store <2 x double> %121, ptr %6, align 8, !tbaa !5
  %122 = fadd fast double %111, %119
  %123 = fneg fast double %122
  store double %123, ptr %55, align 8, !tbaa !5
  %124 = load double, ptr %7, align 8, !tbaa !5
  %125 = fmul fast double %124, 0x3FC555555567A895
  store double %125, ptr %7, align 8, !tbaa !5
  %126 = load <4 x double>, ptr %6, align 8, !tbaa !5
  ...
  store <4 x double> %127, ptr %6, align 8, !tbaa !5
  %128 = load <4 x double>, ptr %53, align 8, !tbaa !5
  ...
  store <4 x double> %129, ptr %53, align 8, !tbaa !5
  %130 = load <4 x double>, ptr %57, align 8, !tbaa !5
  ...
  store <4 x double> %131, ptr %57, align 8, !tbaa !5
  ret void
}
