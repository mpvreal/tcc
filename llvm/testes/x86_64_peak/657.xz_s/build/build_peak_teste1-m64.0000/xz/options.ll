...
@.str.1 = private unnamed_addr constant [61 x i8] c"%s: Options must be `name=value' pairs separated with commas\00", align 1
@.str.2 = private unnamed_addr constant [24 x i8] c"%s: Invalid option name\00", align 1
@.str.3 = private unnamed_addr constant [25 x i8] c"%s: Invalid option value\00", align 1
@options_bcj.opts = internal unnamed_addr constant [2 x %struct.option_map] [%struct.option_map { ptr @.str.4, ptr null, i64 0, i64 4294967295 }, %struct.option_map zeroinitializer], align 16
@.str.4 = private unnamed_addr constant [6 x i8] c"start\00", align 1
@options_lzma.modes = internal constant [3 x %struct.name_id_map] [%struct.name_id_map { ptr @.str.5, i64 1 }, %struct.name_id_map { ptr @.str.6, i64 2 }, %struct.name_id_map zeroinitializer], align 16
...
@options_lzma.mfs = internal constant [6 x %struct.name_id_map] [%struct.name_id_map { ptr @.str.7, i64 3 }, %struct.name_id_map { ptr @.str.8, i64 4 }, %struct.name_id_map { ptr @.str.9, i64 18 }, %struct.name_id_map { ptr @.str.10, i64 19 }, %struct.name_id_map { ptr @.str.11, i64 20 }, %struct.name_id_map zeroinitializer], align 16
@.str.7 = private unnamed_addr constant [4 x i8] c"hc3\00", align 1
@.str.8 = private unnamed_addr constant [4 x i8] c"hc4\00", align 1
@.str.9 = private unnamed_addr constant [4 x i8] c"bt2\00", align 1
@.str.10 = private unnamed_addr constant [4 x i8] c"bt3\00", align 1
@.str.11 = private unnamed_addr constant [4 x i8] c"bt4\00", align 1
@options_lzma.opts = internal unnamed_addr constant [10 x %struct.option_map] [%struct.option_map { ptr @.str.12, ptr null, i64 -1, i64 0 }, %struct.option_map { ptr @.str.13, ptr null, i64 4096, i64 1610612736 }, %struct.option_map { ptr @.str.14, ptr null, i64 0, i64 4 }, %struct.option_map { ptr @.str.15, ptr null, i64 0, i64 4 }, %struct.option_map { ptr @.str.16, ptr null, i64 0, i64 4 }, %struct.option_map { ptr @.str.17, ptr @options_lzma.modes, i64 0, i64 0 }, %struct.option_map { ptr @.str.18, ptr null, i64 2, i64 273 }, %struct.option_map { ptr @.str.19, ptr @options_lzma.mfs, i64 0, i64 0 }, %struct.option_map { ptr @.str.20, ptr null, i64 0, i64 4294967295 }, %struct.option_map zeroinitializer], align 16
@.str.12 = private unnamed_addr constant [7 x i8] c"preset\00", align 1
@.str.13 = private unnamed_addr constant [5 x i8] c"dict\00", align 1
@.str.14 = private unnamed_addr constant [3 x i8] c"lc\00", align 1
...
@.str.18 = private unnamed_addr constant [5 x i8] c"nice\00", align 1
@.str.19 = private unnamed_addr constant [3 x i8] c"mf\00", align 1
@.str.20 = private unnamed_addr constant [6 x i8] c"depth\00", align 1
@.str.21 = private unnamed_addr constant [39 x i8] c"The sum of lc and lp must not exceed 4\00", align 1
@.str.22 = private unnamed_addr constant [52 x i8] c"The selected match finder requires at least nice=%u\00", align 1
...
define dso_local ptr @options_delta(ptr noundef %0) local_unnamed_addr #0 {
  ...
  store i32 0, ptr %2, align 8, !tbaa.struct !6
  %3 = getelementptr inbounds i8, ptr %2, i64 4
  store i32 1, ptr %3, align 4, !tbaa.struct !14
...
28:                                               ; preds = %24, %21
  ...
  tail call void (ptr, ...) @message_fatal(ptr noundef nonnull @.str.1, ptr noundef nonnull %0) #5
  br label %30
...
37:                                               ; preds = %32
  tail call void (ptr, ...) @message_fatal(ptr noundef nonnull @.str.2, ptr noundef nonnull %12) #5
  br label %38
...
42:                                               ; preds = %38
  ...
  %44 = load i64, ptr %43, align 16, !tbaa !20
  %45 = icmp eq i64 %44, -1
...
57:                                               ; preds = %55, %46
  ...
  store i32 %58, ptr %3, align 4, !tbaa !22
  br label %59
...
define dso_local ptr @options_bcj(ptr noundef %0) local_unnamed_addr #0 {
  ...
  store i32 0, ptr %2, align 4, !tbaa.struct !24
...
35:                                               ; preds = %30
  tail call void (ptr, ...) @message_fatal(ptr noundef nonnull @.str.2, ptr noundef nonnull %10) #5
  br label %36
...
46:                                               ; preds = %40
  ...
  store i32 %47, ptr %2, align 4, !tbaa !25
  br label %48
...
39:                                               ; preds = %34
  tail call void (ptr, ...) @message_fatal(ptr noundef nonnull @.str.2, ptr noundef nonnull %14) #5
  br label %40
...
56:                                               ; preds = %51
  ...
  br i1 %60, label %61, label %51, !llvm.loop !30

61:                                               ; preds = %56, %48
  %62 = phi i64 [ 0, %48 ], [ %57, %56 ]
  tail call void (ptr, ...) @message_fatal(ptr noundef nonnull @.str.3, ptr noundef %33) #5
  br label %63
...
63:                                               ; preds = %51, %61
  ...
  tail call fastcc void @set_lzma(ptr noundef %2, i32 noundef %65, i64 noundef %67, ptr noundef %33) #5, !callees !32
  br label %79

68:                                               ; preds = %44
  %69 = getelementptr inbounds %struct.option_map, ptr @options_lzma.opts, i64 %35, i32 2
  %70 = load i64, ptr %69, align 16, !tbaa !20
  %71 = icmp eq i64 %70, -1
  br i1 %71, label %72, label %74

72:                                               ; preds = %68
  %73 = trunc i64 %35 to i32
  tail call fastcc void @set_lzma(ptr noundef %2, i32 noundef %73, i64 noundef 0, ptr noundef %33) #5, !callees !32
  br label %79
...
74:                                               ; preds = %68
  ...
  tail call fastcc void @set_lzma(ptr noundef %2, i32 noundef %78, i64 noundef %77, ptr noundef %33) #5, !callees !32
  br label %79
...
88:                                               ; preds = %81
  tail call void (ptr, ...) @message_fatal(ptr noundef nonnull @.str.21) #5
  br label %89
...
96:                                               ; preds = %89
  tail call void (ptr, ...) @message_fatal(ptr noundef nonnull @.str.22, i32 noundef %92) #5
  br label %97
...
9:                                                ; preds = %5
  ...
  %10 = load i8, ptr %3, align 1, !tbaa !7
  br label %11
...
31:                                               ; preds = %4
  ...
  store i32 %32, ptr %0, align 8, !tbaa !38
  br label %54
...
48:                                               ; preds = %4
  ...
  store i32 %49, ptr %50, align 8, !tbaa !36
  br label %54
...
!6 = !{i64 0, i64 4, !7, i64 4, i64 4, !10, i64 8, i64 4, !10, i64 12, i64 4, !10, i64 16, i64 4, !10, i64 20, i64 4, !10, i64 24, i64 8, !12, i64 32, i64 8, !12}
!7 = !{!8, !8, i64 0}
...
!14 = !{i64 0, i64 4, !10, i64 4, i64 4, !10, i64 8, i64 4, !10, i64 12, i64 4, !10, i64 16, i64 4, !10, i64 20, i64 8, !12, i64 28, i64 8, !12}
!15 = distinct !{!15, !16}
!16 = !{!"llvm.loop.mustprogress"}
!17 = !{!18, !13, i64 0}
!18 = !{!"", !13, i64 0, !13, i64 8, !19, i64 16, !19, i64 24}
!19 = !{!"long", !8, i64 0}
!20 = !{!18, !19, i64 16}
!21 = !{!18, !19, i64 24}
!22 = !{!23, !11, i64 4}
!23 = !{!"", !8, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !13, i64 24, !13, i64 32}
!24 = !{i64 0, i64 4, !10}
!25 = !{!26, !11, i64 0}
!26 = !{!"", !11, i64 0}
!27 = !{!18, !13, i64 8}
!28 = !{!29, !13, i64 0}
!29 = !{!"", !13, i64 0, !19, i64 8}
!30 = distinct !{!30, !16}
!31 = !{!29, !19, i64 8}
!32 = !{ptr @set_lzma}
!33 = !{!34, !11, i64 20}
!34 = !{!"", !11, i64 0, !13, i64 8, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !8, i64 32, !11, i64 36, !8, i64 40, !11, i64 44, !11, i64 48, !11, i64 52, !11, i64 56, !11, i64 60, !11, i64 64, !11, i64 68, !11, i64 72, !11, i64 76, !8, i64 80, !8, i64 84, !8, i64 88, !8, i64 92, !13, i64 96, !13, i64 104}
!35 = !{!34, !11, i64 24}
!36 = !{!34, !8, i64 40}
!37 = !{!34, !11, i64 36}
!38 = !{!34, !11, i64 0}
