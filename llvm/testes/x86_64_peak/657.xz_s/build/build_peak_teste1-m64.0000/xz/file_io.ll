...
@.str.1 = private unnamed_addr constant [19 x i8] c"(benchmark output)\00", align 1
@.str.2 = private unnamed_addr constant [59 x i8] c"%s: Seeking failed when trying to create a sparse file: %s\00", align 1
@.str.3 = private unnamed_addr constant [20 x i8] c"%s: Write error: %s\00", align 1
@.str.4 = private unnamed_addr constant [32 x i8] c"%s: Closing the file failed: %s\00", align 1
@.str.5 = private unnamed_addr constant [19 x i8] c"%s: Read error: %s\00", align 1
@.str.6 = private unnamed_addr constant [31 x i8] c"%s: Error seeking the file: %s\00", align 1
@.str.7 = private unnamed_addr constant [27 x i8] c"%s: Unexpected end of file\00", align 1
...
3:                                                ; preds = %1
  store ptr %0, ptr @io_open_src.pair, align 8, !tbaa.struct !6
  store ptr null, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 1), align 8, !tbaa.struct !17
  store i32 -1, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 2), align 8, !tbaa.struct !18
  store i32 -1, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 3), align 4, !tbaa.struct !19
  store i8 0, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 4), align 8, !tbaa.struct !20
  store i8 0, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 5), align 1, !tbaa.struct !21
  store i64 0, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 6), align 8, !tbaa.struct !22
  tail call void @signals_block() #7
  %4 = load i8, ptr @opt_stdout, align 1, !tbaa !13, !range !23, !noundef !24
  %5 = icmp eq i8 %4, 0
...
8:                                                ; preds = %7, %13
  %9 = load ptr, ptr @spec_fd, align 8, !tbaa !7
  %10 = load ptr, ptr @io_open_src.pair, align 8, !tbaa !25
  %11 = tail call i32 @spec_mem_open(ptr noundef %9, i32 noundef 3, ptr noundef %10, i32 noundef 256) #7
  store i32 %11, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 2), align 8, !tbaa !27
  %12 = icmp eq i32 %11, -1
...
21:                                               ; preds = %20
  tail call void @signals_block() #7
  %22 = load i32, ptr getelementptr inbounds (%struct.file_pair, ptr @io_open_src.pair, i64 0, i32 2), align 8, !tbaa !27
  br label %23
...
30:                                               ; preds = %26
  %31 = load ptr, ptr @io_open_src.pair, align 8, !tbaa !25
  %32 = tail call ptr @strerror(i32 noundef %28) #7
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str, ptr noundef %31, ptr noundef %32) #7
  br label %33
...
define dso_local zeroext i1 @io_open_dest(ptr nocapture noundef %0) local_unnamed_addr #0 {
  ...
  %3 = load ptr, ptr @spec_fd, align 8, !tbaa !7
  %4 = tail call i32 @spec_mem_open(ptr noundef %3, i32 noundef 3, ptr noundef nonnull @.str.1, i32 noundef 0) #7
...
7:                                                ; preds = %1
  ...
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str, ptr noundef %8, ptr noundef %11) #7
...
4:                                                ; preds = %2
  ...
  %6 = load i8, ptr %5, align 1, !tbaa !32, !range !23, !noundef !24
  %7 = icmp eq i8 %6, 0
...
12:                                               ; preds = %8
  %13 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
19:                                               ; preds = %12
  ...
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str.2, ptr noundef %21, ptr noundef %24) #7
  br label %51
...
26:                                               ; preds = %25, %46
  ...
  %29 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
36:                                               ; preds = %33
  %37 = load i32, ptr @user_abort, align 4, !tbaa !11
  %38 = icmp eq i32 %37, 0
  br i1 %38, label %46, label %50, !llvm.loop !34

39:                                               ; preds = %33
  %40 = getelementptr inbounds %struct.file_pair, ptr %0, i64 0, i32 1
  %41 = load ptr, ptr %40, align 8, !tbaa !30
  %42 = call ptr @strerror(i32 noundef %35) #7
  call void (ptr, ...) @message_error(ptr noundef nonnull @.str.3, ptr noundef %41, ptr noundef %42) #7
  br label %50
...
54:                                               ; preds = %51
  %55 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
60:                                               ; preds = %54
  ...
  call void (ptr, ...) @message_error(ptr noundef nonnull @.str.4, ptr noundef %59, ptr noundef %63) #7
...
67:                                               ; preds = %65, %51, %51
  ...
  %70 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
7:                                                ; preds = %5, %29
  %8 = phi i64 [ %2, %5 ], [ %31, %29 ]
  %9 = phi ptr [ %1, %5 ], [ %30, %29 ]
  %10 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
19:                                               ; preds = %15
  %20 = load i32, ptr @user_abort, align 4, !tbaa !11
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %29, label %36, !llvm.loop !36

22:                                               ; preds = %15
  %23 = load ptr, ptr %0, align 8, !tbaa !25
  %24 = tail call ptr @strerror(i32 noundef %17) #7
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str.5, ptr noundef %23, ptr noundef %24) #7
...
define dso_local zeroext i1 @io_pread(ptr nocapture noundef %0, ptr noundef %1, i64 noundef %2, i64 noundef %3) local_unnamed_addr #0 {
  %5 = load ptr, ptr @spec_fd, align 8, !tbaa !7
  %6 = getelementptr inbounds %struct.file_pair, ptr %0, i64 0, i32 2
...
10:                                               ; preds = %4
  ...
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str.6, ptr noundef %11, ptr noundef %14) #7
  br label %51
...
17:                                               ; preds = %15, %39
  ...
  %20 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
29:                                               ; preds = %25
  %30 = load i32, ptr @user_abort, align 4, !tbaa !11
  %31 = icmp eq i32 %30, 0
  br i1 %31, label %39, label %51, !llvm.loop !36

32:                                               ; preds = %25
  %33 = load ptr, ptr %0, align 8, !tbaa !25
  %34 = tail call ptr @strerror(i32 noundef %27) #7
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str.5, ptr noundef %33, ptr noundef %34) #7
  %35 = getelementptr inbounds %struct.file_pair, ptr %0, i64 0, i32 4
  store i8 1, ptr %35, align 8, !tbaa !35
  br label %51
...
49:                                               ; preds = %47
  ...
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str.7, ptr noundef %50) #7
  br label %51
...
define dso_local zeroext i1 @io_write(ptr nocapture noundef %0, ptr noundef %1, i64 noundef %2) local_unnamed_addr #0 {
  ...
  %5 = load i8, ptr %4, align 1, !tbaa !32, !range !23, !noundef !24
  %6 = icmp eq i8 %5, 0
...
11:                                               ; preds = %8, %30
  ...
  %16 = icmp eq i64 %15, 0
  br i1 %16, label %17, label %34, !llvm.loop !38
...
17:                                               ; preds = %11
  ...
  %21 = icmp eq i64 %20, 0
  br i1 %21, label %22, label %34, !llvm.loop !38
...
45:                                               ; preds = %41
  %46 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
51:                                               ; preds = %45
  ...
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str.2, ptr noundef %53, ptr noundef %56) #7
  br label %85
...
61:                                               ; preds = %58, %81
  ...
  %64 = load ptr, ptr @spec_fd, align 8, !tbaa !7
...
71:                                               ; preds = %68
  %72 = load i32, ptr @user_abort, align 4, !tbaa !11
  %73 = icmp eq i32 %72, 0
  br i1 %73, label %81, label %85, !llvm.loop !34

74:                                               ; preds = %68
  %75 = getelementptr inbounds %struct.file_pair, ptr %0, i64 0, i32 1
  %76 = load ptr, ptr %75, align 8, !tbaa !30
  %77 = tail call ptr @strerror(i32 noundef %70) #7
  tail call void (ptr, ...) @message_error(ptr noundef nonnull @.str.3, ptr noundef %76, ptr noundef %77) #7
  br label %85
...
!6 = !{i64 0, i64 8, !7, i64 8, i64 8, !7, i64 16, i64 4, !11, i64 20, i64 4, !11, i64 24, i64 1, !13, i64 25, i64 1, !13, i64 32, i64 8, !15}
!7 = !{!8, !8, i64 0}
...
!15 = !{!16, !16, i64 0}
!16 = !{!"long", !9, i64 0}
!17 = !{i64 0, i64 8, !7, i64 8, i64 4, !11, i64 12, i64 4, !11, i64 16, i64 1, !13, i64 17, i64 1, !13, i64 24, i64 8, !15}
!18 = !{i64 0, i64 4, !11, i64 4, i64 4, !11, i64 8, i64 1, !13, i64 9, i64 1, !13, i64 16, i64 8, !15}
!19 = !{i64 0, i64 4, !11, i64 4, i64 1, !13, i64 5, i64 1, !13, i64 12, i64 8, !15}
!20 = !{i64 0, i64 1, !13, i64 1, i64 1, !13, i64 8, i64 8, !15}
!21 = !{i64 0, i64 1, !13, i64 7, i64 8, !15}
!22 = !{i64 0, i64 8, !15}
!23 = !{i8 0, i8 2}
!24 = !{}
!25 = !{!26, !8, i64 0}
!26 = !{!"", !8, i64 0, !8, i64 8, !12, i64 16, !12, i64 20, !14, i64 24, !14, i64 25, !16, i64 32}
!27 = !{!26, !12, i64 16}
!28 = distinct !{!28, !29}
