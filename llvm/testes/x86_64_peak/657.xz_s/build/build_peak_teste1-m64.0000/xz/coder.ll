...
define dso_local void @coder_set_check(i32 noundef %0) local_unnamed_addr #0 {
  store i32 %0, ptr @check, align 4, !tbaa !6
...
define dso_local void @coder_set_preset(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr @preset_number, align 4, !tbaa !9
  %3 = and i32 %2, -32
  %4 = or i32 %3, %0
  store i32 %4, ptr @preset_number, align 4, !tbaa !9
  %5 = load i32, ptr @filters_count, align 4, !tbaa !9
  %6 = icmp eq i32 %5, 0
...
16:                                               ; preds = %9
  store i32 0, ptr @filters_count, align 4, !tbaa !9
  br label %17
...
define dso_local void @coder_set_extreme() local_unnamed_addr #1 {
  %1 = load i32, ptr @preset_number, align 4, !tbaa !9
  %2 = or i32 %1, -2147483648
  store i32 %2, ptr @preset_number, align 4, !tbaa !9
  %3 = load i32, ptr @filters_count, align 4, !tbaa !9
  %4 = icmp eq i32 %3, 0
...
5:                                                ; preds = %2
  ...
  %6 = load i32, ptr @filters_count, align 4, !tbaa !9
  br label %7
...
7:                                                ; preds = %5, %2
  ...
  store i64 %0, ptr %10, align 16, !tbaa !17
  %11 = getelementptr inbounds [5 x %struct.lzma_filter], ptr @filters, i64 0, i64 %9, i32 1
  store ptr %1, ptr %11, align 8, !tbaa !11
  %12 = add i32 %8, 1
  store i32 %12, ptr @filters_count, align 4, !tbaa !9
  store i32 6, ptr @preset_number, align 4, !tbaa !9
  ret void
}

declare void @message_fatal(ptr noundef, ...) local_unnamed_addr #3

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @coder_set_compression_settings() local_unnamed_addr #1 {
  %1 = load i32, ptr @filters_count, align 4
  %2 = icmp eq i32 %1, 0
  %3 = load i32, ptr @opt_format, align 4, !tbaa !6
...
7:                                                ; preds = %6, %4
  %8 = load i32, ptr @preset_number, align 4, !tbaa !9
...
12:                                               ; preds = %11, %7
  %13 = load i32, ptr @opt_format, align 4, !tbaa !6
  %14 = icmp eq i32 %13, 2
  %15 = select i1 %14, i64 4611686018427387905, i64 33
  store i64 %15, ptr @filters, align 16, !tbaa !17
  store ptr @coder_set_compression_settings.opt_lzma, ptr getelementptr inbounds ([5 x %struct.lzma_filter], ptr @filters, i64 0, i64 0, i32 1), align 8, !tbaa !11
  store i32 1, ptr @filters_count, align 4, !tbaa !9
  br label %16
...
16:                                               ; preds = %12, %0
  ...
  store i64 -1, ptr %20, align 16, !tbaa !17
  %21 = icmp eq i32 %17, 2
...
27:                                               ; preds = %22
  ...
  %28 = load i32, ptr @opt_format, align 4, !tbaa !6
...
62:                                               ; preds = %61, %58
  ...
  %63 = load i32, ptr @opt_mode, align 4, !tbaa !6
  %64 = icmp eq i32 %63, 0
...
73:                                               ; preds = %71
  %74 = load i8, ptr @opt_auto_adjust, align 1, !tbaa !19, !range !21, !noundef !22
  %75 = icmp eq i8 %74, 0
...
81:                                               ; preds = %80, %86
  ...
  %84 = load i64, ptr %83, align 16, !tbaa !17
...
93:                                               ; preds = %104, %88
  ...
  store i32 %94, ptr %90, align 8, !tbaa !24
...
declare void @message(i32 noundef, ptr noundef, ...) local_unnamed_addr #3

declare zeroext i8 @lzma_lzma_preset(ptr noundef, i32 noundef) local_unnamed_addr #3

declare void @message_bug() local_unnamed_addr #3
...
declare void @message_filters_show(i32 noundef, ptr noundef) local_unnamed_addr #3

declare i64 @hardware_memlimit_get(i32 noundef) local_unnamed_addr #3

declare i64 @lzma_raw_encoder_memusage(ptr noundef) local_unnamed_addr #3

declare i64 @lzma_raw_decoder_memusage(ptr noundef) local_unnamed_addr #3

declare void @message_mem_needed(i32 noundef, i64 noundef) local_unnamed_addr #3

declare ptr @uint64_to_str(i64 noundef, i32 noundef) local_unnamed_addr #3

declare i64 @round_up_to_mib(i64 noundef) local_unnamed_addr #3

declare zeroext i8 @lzma_check_is_supported(i32 noundef) local_unnamed_addr #3

declare void @tuklib_exit(i32 noundef, i32 noundef, i32 noundef) local_unnamed_addr #3
...
4:                                                ; preds = %1
  store ptr @in_buf, ptr @strm, align 8, !tbaa !26
  %5 = tail call i64 @io_read(ptr noundef nonnull %2, ptr noundef nonnull @in_buf, i64 noundef 8192) #8
  store i64 %5, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  %6 = icmp eq i64 %5, -1
...
7:                                                ; preds = %4
  ...
  %9 = icmp eq i32 %8, 0
  %10 = load i32, ptr @opt_format, align 4, !tbaa !6
...
12:                                               ; preds = %11
  %13 = load i32, ptr @check, align 4, !tbaa !6
  %14 = tail call i32 @lzma_stream_encoder(ptr noundef nonnull @strm, ptr noundef nonnull @filters, i32 noundef %13) #8
  br label %58

15:                                               ; preds = %11
  %16 = load ptr, ptr getelementptr inbounds ([5 x %struct.lzma_filter], ptr @filters, i64 0, i64 0, i32 1), align 8, !tbaa !11
...
36:                                               ; preds = %34, %30, %28, %26, %20
  %37 = load i32, ptr @opt_mode, align 4, !tbaa !6
  %38 = icmp ne i32 %37, 1
  %39 = load i8, ptr @opt_stdout, align 1, !range !21
  %40 = icmp eq i8 %39, 0
  %41 = select i1 %38, i1 true, i1 %40
  %42 = load i8, ptr @opt_force, align 1, !range !21
  %43 = icmp eq i8 %42, 0
...
72:                                               ; preds = %68
  %73 = load i32, ptr @opt_mode, align 4, !tbaa !6
  %74 = icmp eq i32 %73, 2
...
78:                                               ; preds = %77
  ...
  %80 = load i8, ptr %79, align 8, !tbaa !31, !range !21, !noundef !22
  store ptr @out_buf, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 3), align 8, !tbaa !32
  store i64 8192, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 4), align 8, !tbaa !33
  %81 = load i32, ptr @user_abort, align 4, !tbaa !9
  %82 = icmp eq i32 %81, 0
...
86:                                               ; preds = %144, %83
  ...
  %88 = load i64, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  %89 = icmp eq i64 %88, 0
  br i1 %89, label %90, label %100

90:                                               ; preds = %86
  %91 = load i8, ptr %79, align 8, !tbaa !31, !range !21, !noundef !22
  %92 = icmp eq i8 %91, 0
...
93:                                               ; preds = %90
  ...
  store i64 %94, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  %95 = icmp eq i64 %94, -1
  br i1 %95, label %164, label %96

96:                                               ; preds = %93
  %97 = load i8, ptr %79, align 8, !tbaa !31, !range !21, !noundef !22
  %98 = icmp eq i8 %97, 0
...
100:                                              ; preds = %96, %90, %86
  ...
  %103 = load i64, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 4), align 8, !tbaa !33
  %104 = icmp eq i64 %103, 0
  br i1 %104, label %105, label %111

105:                                              ; preds = %100
  %106 = load i32, ptr @opt_mode, align 4, !tbaa !6
...
125:                                              ; preds = %123
  %126 = load i64, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  %127 = icmp eq i64 %126, 0
  br i1 %127, label %128, label %134

128:                                              ; preds = %125
  %129 = load i8, ptr %79, align 8, !tbaa !31, !range !21, !noundef !22
  %130 = icmp eq i8 %129, 0
  br i1 %130, label %131, label %164

131:                                              ; preds = %128
  %132 = tail call i64 @io_read(ptr noundef nonnull %2, ptr noundef nonnull @in_buf, i64 noundef 1) #8
  store i64 %132, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
...
144:                                              ; preds = %141, %111
  ...
  %145 = load i32, ptr @user_abort, align 4, !tbaa !9
  %146 = icmp eq i32 %145, 0
  br i1 %146, label %86, label %164, !llvm.loop !34

147:                                              ; preds = %131
  br label %164

148:                                              ; preds = %77
  %149 = load i64, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  br label %150
...
158:                                              ; preds = %156
  %159 = load i64, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  %160 = load i64, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 2), align 8, !tbaa !35
  %161 = add i64 %160, %159
  store i64 %161, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 2), align 8, !tbaa !35
  store i64 %161, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 5), align 8, !tbaa !36
  tail call void @message_progress_update() #8
  %162 = tail call i64 @io_read(ptr noundef nonnull %2, ptr noundef nonnull @in_buf, i64 noundef 8192) #8
  store i64 %162, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  %163 = icmp eq i64 %162, -1
  br i1 %163, label %164, label %150, !llvm.loop !37
...
declare void @message_filename(ptr noundef) local_unnamed_addr #3

declare ptr @io_open_src(ptr noundef) local_unnamed_addr #3

declare i64 @io_read(ptr noundef, ptr noundef, i64 noundef) local_unnamed_addr #3

declare zeroext i1 @io_open_dest(ptr noundef) local_unnamed_addr #3

declare void @message_progress_start(ptr noundef, i64 noundef) local_unnamed_addr #3

declare void @message_progress_end(i1 noundef zeroext) local_unnamed_addr #3

declare void @io_close(ptr noundef, i1 noundef zeroext) local_unnamed_addr #3

declare i32 @lzma_stream_encoder(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #3

declare i32 @lzma_alone_encoder(ptr noundef, ptr noundef) local_unnamed_addr #3

declare i32 @lzma_raw_encoder(ptr noundef, ptr noundef) local_unnamed_addr #3

; Function Attrs: nounwind sspstrong uwtable
define internal fastcc zeroext i1 @is_format_lzma() unnamed_addr #1 {
  %1 = alloca %struct.lzma_filter, align 8
  %2 = load i64, ptr getelementptr inbounds (%struct.lzma_stream, ptr @strm, i64 0, i32 1), align 8, !tbaa !28
  %3 = icmp ult i64 %2, 13
...
28:                                               ; preds = %12, %7
  %29 = load i8, ptr getelementptr inbounds ([8192 x i8], ptr @in_buf, i64 0, i64 5), align 1, !tbaa !6
  %30 = zext i8 %29 to i64
  %31 = load i8, ptr getelementptr inbounds ([8192 x i8], ptr @in_buf, i64 0, i64 6), align 2, !tbaa !6
  %32 = zext i8 %31 to i64
  %33 = shl nuw nsw i64 %32, 8
  %34 = or i64 %33, %30
  %35 = load i8, ptr getelementptr inbounds ([8192 x i8], ptr @in_buf, i64 0, i64 7), align 1, !tbaa !6
  %36 = zext i8 %35 to i64
  %37 = shl nuw nsw i64 %36, 16
  %38 = or i64 %37, %34
  %39 = load i8, ptr getelementptr inbounds (%union.io_buf, ptr @in_buf, i64 0, i32 0, i64 1), align 8, !tbaa !6
  %40 = zext i8 %39 to i64
  %41 = shl nuw nsw i64 %40, 24
  %42 = or i64 %41, %38
  %43 = load i8, ptr getelementptr inbounds ([8192 x i8], ptr @in_buf, i64 0, i64 9), align 1, !tbaa !6
  %44 = zext i8 %43 to i64
  %45 = shl nuw nsw i64 %44, 32
  %46 = or i64 %45, %42
  %47 = load i8, ptr getelementptr inbounds ([8192 x i8], ptr @in_buf, i64 0, i64 10), align 2, !tbaa !6
  %48 = zext i8 %47 to i64
  %49 = shl nuw nsw i64 %48, 40
  %50 = or i64 %49, %46
  %51 = load i8, ptr getelementptr inbounds ([8192 x i8], ptr @in_buf, i64 0, i64 11), align 1, !tbaa !6
  %52 = zext i8 %51 to i64
  %53 = shl nuw nsw i64 %52, 48
  %54 = or i64 %53, %50
  %55 = load i8, ptr getelementptr inbounds ([8192 x i8], ptr @in_buf, i64 0, i64 12), align 4, !tbaa !6
...
declare i32 @lzma_stream_decoder(ptr noundef, i64 noundef, i32 noundef) local_unnamed_addr #3

declare i32 @lzma_alone_decoder(ptr noundef, i64 noundef) local_unnamed_addr #3

declare i32 @lzma_raw_decoder(ptr noundef, ptr noundef) local_unnamed_addr #3

declare i32 @lzma_code(ptr noundef, i32 noundef) local_unnamed_addr #3

declare void @message_error(ptr noundef, ...) local_unnamed_addr #3

declare ptr @message_strm(i32 noundef) local_unnamed_addr #3

declare i64 @lzma_memusage(ptr noundef) local_unnamed_addr #3

; Function Attrs: mustprogress nocallback nofree nounwind willreturn memory(argmem: readwrite)
declare void @llvm.memcpy.p0.p0.i64(ptr noalias nocapture writeonly, ptr noalias nocapture readonly, i64, i1 immarg) #5

declare i32 @lzma_properties_decode(ptr noundef, ptr noundef, ptr noundef, i64 noundef) local_unnamed_addr #3

declare zeroext i1 @io_write(ptr noundef, ptr noundef, i64 noundef) local_unnamed_addr #3

declare void @message_warning(ptr noundef, ...) local_unnamed_addr #3

declare void @message_progress_update() local_unnamed_addr #3
...
!23 = distinct !{!23, !16}
!24 = !{!25, !10, i64 0}
!25 = !{!"", !10, i64 0, !14, i64 8, !10, i64 16, !10, i64 20, !10, i64 24, !10, i64 28, !7, i64 32, !10, i64 36, !7, i64 40, !10, i64 44, !10, i64 48, !10, i64 52, !10, i64 56, !10, i64 60, !10, i64 64, !10, i64 68, !10, i64 72, !10, i64 76, !7, i64 80, !7, i64 84, !7, i64 88, !7, i64 92, !14, i64 96, !14, i64 104}
!26 = !{!27, !14, i64 0}
!27 = !{!"", !14, i64 0, !13, i64 8, !13, i64 16, !14, i64 24, !13, i64 32, !13, i64 40, !14, i64 48, !14, i64 56, !14, i64 64, !14, i64 72, !14, i64 80, !14, i64 88, !13, i64 96, !13, i64 104, !13, i64 112, !13, i64 120, !7, i64 128, !7, i64 132}
!28 = !{!27, !13, i64 8}
!29 = !{!30, !14, i64 0}
!30 = !{!"", !14, i64 0, !14, i64 8, !10, i64 16, !10, i64 20, !20, i64 24, !20, i64 25, !13, i64 32}
!31 = !{!30, !20, i64 24}
!32 = !{!27, !14, i64 24}
!33 = !{!27, !13, i64 32}
!34 = distinct !{!34, !16}
