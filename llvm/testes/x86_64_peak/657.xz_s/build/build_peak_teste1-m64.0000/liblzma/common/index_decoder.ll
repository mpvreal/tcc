...
6:                                                ; preds = %3
  ...
  %11 = tail call i32 @index_decoder_init(ptr noundef %8, ptr noundef %10, ptr noundef %1, i64 noundef %2), !range !13
  %12 = icmp eq i32 %11, 0
...
14:                                               ; preds = %6
  ...
  store i8 1, ptr %16, align 8, !tbaa !14
...
9:                                                ; preds = %8, %4
  store i64 ptrtoint (ptr @index_decoder_init to i64), ptr %5, align 8, !tbaa !16
...
19:                                               ; preds = %16
  ...
  store ptr @index_decode, ptr %20, align 8, !tbaa !19
  %21 = getelementptr inbounds %struct.lzma_next_coder_s, ptr %0, i64 0, i32 4
  store ptr @index_decoder_end, ptr %21, align 8, !tbaa !20
  %22 = getelementptr inbounds %struct.lzma_next_coder_s, ptr %0, i64 0, i32 6
  store ptr @index_decoder_memconfig, ptr %22, align 8, !tbaa !21
...
34:                                               ; preds = %28
  ...
  store i64 %3, ptr %35, align 8, !tbaa !28
...
25:                                               ; preds = %20
  %26 = add nuw i64 %22, 1
  store i64 %26, ptr %3, align 8, !tbaa !32
...
34:                                               ; preds = %20, %33
  %35 = load i64, ptr %17, align 8, !tbaa !29
...
50:                                               ; preds = %45
  store i64 0, ptr %14, align 8, !tbaa !30
  %51 = load i32, ptr %0, align 8, !tbaa !27
  %52 = icmp eq i32 %51, 3
...
63:                                               ; preds = %57
  ...
  %65 = add i64 %64, -1
  store i64 %65, ptr %17, align 8, !tbaa !29
  %66 = icmp eq i64 %65, 0
...
68:                                               ; preds = %20
  ...
  store i64 %71, ptr %14, align 8, !tbaa !30
...
75:                                               ; preds = %72
  %76 = add i64 %73, -1
  store i64 %76, ptr %14, align 8, !tbaa !30
...
82:                                               ; preds = %72
  ...
  store i32 %88, ptr %86, align 8, !tbaa !31
...
96:                                               ; preds = %93
  %97 = load i32, ptr %92, align 8, !tbaa !31
  %98 = load i64, ptr %14, align 8, !tbaa !30
  %99 = trunc i64 %98 to i32
  %100 = shl i32 %99, 3
  %101 = lshr i32 %97, %100
  %102 = add i64 %94, 1
  store i64 %102, ptr %3, align 8, !tbaa !32
...
107:                                              ; preds = %96
  ...
  br i1 %109, label %93, label %110, !llvm.loop !36
...
114:                                              ; preds = %53, %63, %25, %39
  ...
  store i32 %115, ptr %0, align 8, !tbaa !27
  br label %116

116:                                              ; preds = %114, %75
  %117 = phi i32 [ 6, %75 ], [ %115, %114 ]
  %118 = load i64, ptr %3, align 8, !tbaa !32
  %119 = icmp ult i64 %118, %4
  br i1 %119, label %20, label %120, !llvm.loop !38

120:                                              ; preds = %45, %34, %116, %30
  %121 = phi i32 [ %31, %30 ], [ 0, %116 ], [ 6, %34 ], [ %48, %45 ]
  %122 = load i64, ptr %3, align 8, !tbaa !32
  br label %123
...
123:                                              ; preds = %120, %9
  ...
  store i32 %130, ptr %128, align 8, !tbaa !31
  br label %131
...
24:                                               ; preds = %18
  ...
  store i64 %19, ptr %25, align 8, !tbaa !28
...
34:                                               ; preds = %32
  ...
  store i64 %36, ptr %1, align 8, !tbaa !32
  br label %38
...
!15 = !{!"_Bool", !9, i64 0}
!16 = !{!17, !11, i64 16}
!17 = !{!"lzma_next_coder_s", !8, i64 0, !11, i64 8, !11, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56}
!18 = !{!17, !8, i64 0}
!19 = !{!17, !8, i64 24}
!20 = !{!17, !8, i64 32}
!21 = !{!17, !8, i64 48}
!22 = !{!23, !8, i64 16}
!23 = !{!"lzma_coder_s", !9, i64 0, !11, i64 8, !8, i64 16, !8, i64 24, !11, i64 32, !11, i64 40, !11, i64 48, !11, i64 56, !24, i64 64}
!24 = !{!"int", !9, i64 0}
!25 = !{!23, !8, i64 24}
!26 = !{!8, !8, i64 0}
!27 = !{!23, !9, i64 0}
