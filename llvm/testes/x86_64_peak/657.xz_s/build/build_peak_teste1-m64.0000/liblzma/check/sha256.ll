...
61:                                               ; preds = %757, %1
  ...
  %96 = load i32, ptr %95, align 16, !tbaa !11
  %97 = icmp eq i64 %62, 0
...
241:                                              ; preds = %227, %198
  ...
  %269 = load i32, ptr %268, align 16, !tbaa !11
...
413:                                              ; preds = %399, %370
  ...
  %441 = load i32, ptr %440, align 16, !tbaa !11
...
499:                                              ; preds = %485, %456
  ...
  %527 = load i32, ptr %526, align 8, !tbaa !11
...
585:                                              ; preds = %571, %542
  ...
  %613 = load i32, ptr %612, align 16, !tbaa !11
...
757:                                              ; preds = %743, %714
  ...
  br i1 %776, label %61, label %777, !llvm.loop !13
...
777:                                              ; preds = %757
  ...
  store <4 x i32> %782, ptr %49, align 4, !tbaa !11
  ...
  store <4 x i32> %787, ptr %51, align 4, !tbaa !11
  ret void
}
...
define dso_local void @lzma_sha256_finish(ptr nocapture noundef %0) local_unnamed_addr #3 {
  ...
  store i8 -128, ptr %5, align 1, !tbaa !6
...
17:                                               ; preds = %10, %1
  ...
  %20 = shl i64 %19, 3
  store i64 %20, ptr %2, align 8, !tbaa !6
  %21 = shl i64 %19, 59
  %22 = shl i64 %19, 43
  ...
  tail call fastcc void @process(ptr noundef nonnull %0)
  %43 = load <8 x i32>, ptr %18, align 4, !tbaa !6
  %44 = tail call <8 x i32> @llvm.bswap.v8i32(<8 x i32> %43)
  store <8 x i32> %44, ptr %0, align 4, !tbaa !6
  ret void
}
