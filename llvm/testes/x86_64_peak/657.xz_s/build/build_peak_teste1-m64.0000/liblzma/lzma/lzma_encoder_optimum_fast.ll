...
35:                                               ; preds = %20
  %36 = load i8, ptr %27, align 1, !tbaa !25
  %37 = icmp eq i32 %33, 2
...
47:                                               ; preds = %38
  %48 = load i8, ptr %26, align 1, !tbaa !25
...
75:                                               ; preds = %65
  %76 = load i8, ptr %26, align 1, !tbaa !25
  %77 = load i8, ptr %71, align 1, !tbaa !25
  %78 = icmp eq i8 %76, %77
...
88:                                               ; preds = %81
  ...
  br i1 %90, label %93, label %81, !llvm.loop !26
...
111:                                              ; preds = %100
  %112 = load i8, ptr %26, align 1, !tbaa !25
  %113 = load i8, ptr %107, align 1, !tbaa !25
...
124:                                              ; preds = %117
  ...
  br i1 %126, label %129, label %117, !llvm.loop !26
...
147:                                              ; preds = %136
  %148 = load i8, ptr %26, align 1, !tbaa !25
  %149 = load i8, ptr %143, align 1, !tbaa !25
...
160:                                              ; preds = %153
  ...
  br i1 %162, label %165, label %153, !llvm.loop !26
...
172:                                              ; preds = %53
  ...
  br i1 %174, label %62, label %53, !llvm.loop !26
...
187:                                              ; preds = %186
  %188 = load i8, ptr %26, align 1, !tbaa !25
  %189 = load i8, ptr %181, align 1, !tbaa !25
...
204:                                              ; preds = %193
  %205 = load i8, ptr %26, align 1, !tbaa !25
  %206 = load i8, ptr %200, align 1, !tbaa !25
...
221:                                              ; preds = %210
  %222 = load i8, ptr %26, align 1, !tbaa !25
  %223 = load i8, ptr %217, align 1, !tbaa !25
...
239:                                              ; preds = %228
  %240 = load i8, ptr %26, align 1, !tbaa !25
  %241 = load i8, ptr %235, align 1, !tbaa !25
...
247:                                              ; preds = %185
  %248 = load i8, ptr %26, align 1, !tbaa !25
  %249 = load i8, ptr %181, align 1, !tbaa !25
  %250 = icmp eq i8 %248, %249
  br i1 %250, label %251, label %264

251:                                              ; preds = %299, %286, %273, %247
  %252 = phi i32 [ 3, %299 ], [ 2, %286 ], [ 1, %273 ], [ 0, %247 ]
  store i32 %252, ptr %2, align 4, !tbaa !21
...
253:                                              ; preds = %62, %93, %129, %165
  ...
  store i32 %254, ptr %2, align 4, !tbaa !21
  store i32 %255, ptr %3, align 4, !tbaa !21
  %256 = add i32 %255, -1
...
273:                                              ; preds = %264
  %274 = load i8, ptr %26, align 1, !tbaa !25
  %275 = load i8, ptr %269, align 1, !tbaa !25
...
286:                                              ; preds = %277
  %287 = load i8, ptr %26, align 1, !tbaa !25
  %288 = load i8, ptr %282, align 1, !tbaa !25
...
299:                                              ; preds = %290
  %300 = load i8, ptr %26, align 1, !tbaa !25
  %301 = load i8, ptr %295, align 1, !tbaa !25
...
307:                                              ; preds = %303
  ...
  %313 = add i32 %312, 4
  store i32 %313, ptr %2, align 4, !tbaa !21
...
346:                                              ; preds = %341
  ...
  br i1 %349, label %332, label %350, !llvm.loop !32
...
375:                                              ; preds = %370, %365, %362
  store i32 %304, ptr %2, align 4, !tbaa !21
  store i32 %305, ptr %3, align 4, !tbaa !21
  %376 = add i32 %305, -1
  ...
  %380 = add i32 %379, %376
  store i32 %380, ptr %9, align 4, !tbaa !12
  br label %577
...
386:                                              ; preds = %381
  ...
  store i32 %389, ptr %390, align 8, !tbaa !13
  %391 = icmp ugt i32 %389, 1
  br i1 %391, label %392, label %418

392:                                              ; preds = %386
  %393 = load i32, ptr %387, align 4, !tbaa !20
  %394 = add i32 %393, -1
...
418:                                              ; preds = %409, %386
  %419 = add i32 %360, -1
  %420 = load i8, ptr %26, align 1, !tbaa !25
...
433:                                              ; preds = %432
  %434 = load i8, ptr %421, align 1, !tbaa !25
  %435 = load i8, ptr %427, align 1, !tbaa !25
...
439:                                              ; preds = %442
  ...
  br i1 %441, label %567, label %442, !llvm.loop !33
...
458:                                              ; preds = %449
  %459 = load i8, ptr %421, align 1, !tbaa !25
  %460 = load i8, ptr %454, align 1, !tbaa !25
...
480:                                              ; preds = %464
  ...
  br i1 %482, label %567, label %464, !llvm.loop !33

483:                                              ; preds = %471
  %484 = load i8, ptr %421, align 1, !tbaa !25
  %485 = load i8, ptr %476, align 1, !tbaa !25
...
505:                                              ; preds = %489
  ...
  br i1 %507, label %567, label %489, !llvm.loop !33

508:                                              ; preds = %496
  %509 = load i8, ptr %421, align 1, !tbaa !25
  %510 = load i8, ptr %501, align 1, !tbaa !25
...
521:                                              ; preds = %514
  ...
  br i1 %523, label %567, label %514, !llvm.loop !33

524:                                              ; preds = %431
  %525 = load i8, ptr %421, align 1, !tbaa !25
  %526 = load i8, ptr %427, align 1, !tbaa !25
...
537:                                              ; preds = %528
  %538 = load i8, ptr %421, align 1, !tbaa !25
  %539 = load i8, ptr %533, align 1, !tbaa !25
...
550:                                              ; preds = %541
  %551 = load i8, ptr %421, align 1, !tbaa !25
  %552 = load i8, ptr %546, align 1, !tbaa !25
...
563:                                              ; preds = %554
  %564 = load i8, ptr %421, align 1, !tbaa !25
  %565 = load i8, ptr %559, align 1, !tbaa !25
...
568:                                              ; preds = %514, %554, %563, %496, %508
  %569 = add i32 %358, 4
  store i32 %569, ptr %2, align 4, !tbaa !21
  store i32 %360, ptr %3, align 4, !tbaa !21
  %570 = add i32 %360, -2
...
572:                                              ; preds = %568
  ...
  %576 = add i32 %575, %570
  store i32 %576, ptr %9, align 4, !tbaa !12
  br label %577
...
!12 = !{!7, !11, i64 28}
!13 = !{!14, !11, i64 2952}
!14 = !{!"lzma_coder_s", !15, i64 0, !9, i64 736, !9, i64 740, !9, i64 756, !11, i64 2948, !11, i64 2952, !17, i64 2956, !17, i64 2957, !17, i64 2958, !11, i64 2960, !11, i64 2964, !11, i64 2968, !9, i64 2972, !9, i64 27548, !9, i64 27932, !9, i64 27956, !9, i64 27980, !9, i64 28004, !9, i64 28028, !9, i64 28412, !9, i64 28924, !9, i64 29152, !18, i64 29184, !18, i64 47688, !9, i64 66192, !9, i64 67216, !11, i64 69264, !11, i64 69268, !9, i64 69272, !11, i64 69336, !11, i64 69340, !11, i64 69344, !9, i64 69348}
!15 = !{!"", !16, i64 0, !16, i64 8, !11, i64 16, !9, i64 20, !16, i64 24, !16, i64 32, !9, i64 40, !9, i64 272}
!16 = !{!"long", !9, i64 0}
!17 = !{!"_Bool", !9, i64 0}
!18 = !{!"", !19, i64 0, !19, i64 2, !9, i64 4, !9, i64 260, !9, i64 516, !9, i64 1028, !11, i64 18436, !9, i64 18440}
!19 = !{!"short", !9, i64 0}
!20 = !{!14, !11, i64 2948}
!21 = !{!11, !11, i64 0}
!22 = !{!7, !8, i64 0}
