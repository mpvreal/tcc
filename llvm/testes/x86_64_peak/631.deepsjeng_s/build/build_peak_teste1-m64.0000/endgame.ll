...
154:                                              ; preds = %148
  ...
  %157 = load i64, ptr @BlackSqMask, align 8, !tbaa !15
  %158 = and i64 %157, %156
...
199:                                              ; preds = %195
  ...
  %202 = load i64, ptr @BlackSqMask, align 8, !tbaa !15
  %203 = and i64 %202, %201
...
330:                                              ; preds = %328
  ...
  %334 = load <2 x i32>, ptr %332, align 4, !tbaa !14
  %335 = load <2 x i32>, ptr %333, align 4, !tbaa !14
...
344:                                              ; preds = %343
  ...
  %348 = load <2 x i32>, ptr %346, align 4, !tbaa !14
  %349 = load <2 x i32>, ptr %347, align 4, !tbaa !14
...
355:                                              ; preds = %344
  ...
  %362 = load i32, ptr %14, align 4, !tbaa !14
...
579:                                              ; preds = %576
  ...
  %582 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 7), align 8, !tbaa !15
  %583 = load i64, ptr @FileMask, align 16, !tbaa !15
  %584 = or i64 %583, %582
  %585 = and i64 %584, %581
...
590:                                              ; preds = %587
  ...
  %593 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 6), align 16, !tbaa !15
  %594 = and i64 %593, %592
...
596:                                              ; preds = %590
  ...
  %599 = load i64, ptr @BlackSqMask, align 8, !tbaa !15
  %600 = and i64 %599, %598
...
605:                                              ; preds = %602
  ...
  %607 = load i64, ptr %580, align 8, !tbaa !15
...
624:                                              ; preds = %621
  ...
  %627 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 1), align 8, !tbaa !15
  %628 = and i64 %627, %626
...
630:                                              ; preds = %624
  ...
  %633 = load i64, ptr @WhiteSqMask, align 8, !tbaa !15
  %634 = and i64 %633, %632
...
639:                                              ; preds = %636
  ...
  %641 = load i64, ptr %580, align 8, !tbaa !15
...
665:                                              ; preds = %661
  ...
  %668 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 7), align 8, !tbaa !15
  %669 = load i64, ptr @FileMask, align 16, !tbaa !15
  %670 = or i64 %669, %668
  %671 = and i64 %670, %667
...
676:                                              ; preds = %673
  ...
  %679 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 6), align 16, !tbaa !15
  %680 = and i64 %679, %678
...
682:                                              ; preds = %676
  ...
  %684 = load i64, ptr %683, align 8, !tbaa !15
  %685 = load i64, ptr @WhiteSqMask, align 8, !tbaa !15
  %686 = and i64 %685, %684
...
691:                                              ; preds = %688
  ...
  %693 = load i64, ptr %666, align 8, !tbaa !15
...
710:                                              ; preds = %707
  ...
  %713 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 1), align 8, !tbaa !15
  %714 = and i64 %713, %712
...
716:                                              ; preds = %710
  ...
  %719 = load i64, ptr @BlackSqMask, align 8, !tbaa !15
  %720 = and i64 %719, %718
...
725:                                              ; preds = %722
  ...
  %727 = load i64, ptr %666, align 8, !tbaa !15
...
745:                                              ; preds = %741
  %746 = load i32, ptr %11, align 4, !tbaa !14
...
748:                                              ; preds = %745
  ...
  %751 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 7), align 8, !tbaa !15
  %752 = and i64 %751, %750
...
754:                                              ; preds = %748
  ...
  %756 = load i64, ptr %755, align 8, !tbaa !15
  %757 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 7), align 8, !tbaa !15
  %758 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 15), align 8, !tbaa !15
  %759 = or i64 %758, %757
  %760 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 14), align 16, !tbaa !15
  %761 = or i64 %759, %760
  %762 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 6), align 16, !tbaa !15
  %763 = or i64 %761, %762
  %764 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 5), align 8, !tbaa !15
  %765 = or i64 %763, %764
  %766 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 23), align 8, !tbaa !15
  %767 = or i64 %765, %766
  %768 = and i64 %767, %756
...
772:                                              ; preds = %748
  %773 = load i64, ptr @FileMask, align 16, !tbaa !15
  %774 = and i64 %773, %750
...
776:                                              ; preds = %772
  ...
  %779 = load i64, ptr @Mask, align 16, !tbaa !15
  %780 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 8), align 16, !tbaa !15
  %781 = or i64 %780, %779
  %782 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 9), align 8, !tbaa !15
  %783 = or i64 %781, %782
  %784 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 1), align 8, !tbaa !15
  %785 = or i64 %783, %784
  %786 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 2), align 16, !tbaa !15
  %787 = or i64 %785, %786
  %788 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 16), align 16, !tbaa !15
  %789 = or i64 %787, %788
  %790 = and i64 %789, %778
...
802:                                              ; preds = %797
  ...
  %805 = load i64, ptr getelementptr inbounds ([8 x i64], ptr @FileMask, i64 0, i64 7), align 8, !tbaa !15
  %806 = and i64 %805, %804
...
808:                                              ; preds = %802
  ...
  %811 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 63), align 8, !tbaa !15
  %812 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 55), align 8, !tbaa !15
  %813 = or i64 %812, %811
  %814 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 62), align 16, !tbaa !15
  %815 = or i64 %813, %814
  %816 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 54), align 16, !tbaa !15
  %817 = or i64 %815, %816
  %818 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 61), align 8, !tbaa !15
  %819 = or i64 %817, %818
  %820 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 47), align 8, !tbaa !15
  %821 = or i64 %819, %820
  %822 = and i64 %821, %810
...
826:                                              ; preds = %802
  %827 = load i64, ptr @FileMask, align 16, !tbaa !15
  %828 = and i64 %827, %804
...
830:                                              ; preds = %826
  ...
  %833 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 56), align 16, !tbaa !15
  %834 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 48), align 16, !tbaa !15
  %835 = or i64 %834, %833
  %836 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 57), align 8, !tbaa !15
  %837 = or i64 %835, %836
  %838 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 49), align 8, !tbaa !15
  %839 = or i64 %837, %838
  %840 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 58), align 16, !tbaa !15
  %841 = or i64 %839, %840
  %842 = load i64, ptr getelementptr inbounds ([64 x i64], ptr @Mask, i64 0, i64 40), align 16, !tbaa !15
  %843 = or i64 %841, %842
  %844 = and i64 %843, %832
