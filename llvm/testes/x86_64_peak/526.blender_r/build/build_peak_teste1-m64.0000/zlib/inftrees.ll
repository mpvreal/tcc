...
@inflate_copyright = dso_local local_unnamed_addr constant [47 x i8] c" inflate 1.2.6 Copyright 1995-2012 Mark Adler \00", align 16
...
@inflate_table.lext = internal unnamed_addr constant [31 x i16] [i16 16, i16 16, i16 16, i16 16, i16 16, i16 16, i16 16, i16 16, i16 17, i16 17, i16 17, i16 17, i16 18, i16 18, i16 18, i16 18, i16 19, i16 19, i16 19, i16 19, i16 20, i16 20, i16 20, i16 20, i16 21, i16 21, i16 21, i16 21, i16 16, i16 203, i16 69], align 16
...
define hidden i32 @inflate_table(i32 noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2, ptr nocapture noundef %3, ptr nocapture noundef %4, ptr nocapture noundef %5) local_unnamed_addr #0 {
...
356:                                              ; preds = %350, %349, %352
  ...
  %358 = phi ptr [ @inflate_table.dbase, %352 ], [ %5, %349 ], [ getelementptr inbounds ([31 x i16], ptr @inflate_table.lbase, i64 -9, i64 22), %350 ]
  %359 = phi ptr [ @inflate_table.dext, %352 ], [ %5, %349 ], [ getelementptr inbounds ([31 x i16], ptr @inflate_table.lext, i64 -9, i64 22), %350 ]
  %360 = phi i32 [ -1, %352 ], [ 19, %349 ], [ 256, %350 ]
...
366:                                              ; preds = %484, %356
  %367 = phi i32 [ %441, %484 ], [ %161, %356 ]
  %368 = phi i32 [ %424, %484 ], [ 0, %356 ]
  %369 = phi i32 [ %477, %484 ], [ %162, %356 ]
  %370 = phi i32 [ %449, %484 ], [ 0, %356 ]
  %371 = phi i32 [ %478, %484 ], [ %362, %356 ]
  %372 = phi i32 [ %423, %484 ], [ 0, %356 ]
  %373 = phi i32 [ %444, %484 ], [ -1, %356 ]
  %374 = phi ptr [ %451, %484 ], [ %364, %356 ]
  %375 = shl nuw i32 1, %369
  br label %376

376:                                              ; preds = %446, %366
  %377 = phi i32 [ %367, %366 ], [ %441, %446 ]
  %378 = phi i32 [ %368, %366 ], [ %424, %446 ]
  %379 = phi i32 [ %372, %366 ], [ %423, %446 ]
  %380 = sub i32 %377, %370
...
387:                                              ; preds = %376
  %388 = icmp slt i32 %360, %385
  br i1 %388, label %389, label %396

389:                                              ; preds = %387
  %390 = zext i16 %384 to i64
  %391 = getelementptr inbounds i16, ptr %359, i64 %390
  %392 = load i16, ptr %391, align 2, !tbaa !5
  %393 = trunc i16 %392 to i8
  %394 = getelementptr inbounds i16, ptr %358, i64 %390
  %395 = load i16, ptr %394, align 2, !tbaa !5
  br label %396

396:                                              ; preds = %387, %376, %389
  %397 = phi i16 [ %395, %389 ], [ %384, %376 ], [ 0, %387 ]
  %398 = phi i8 [ %393, %389 ], [ 0, %376 ], [ 96, %387 ]
  %399 = shl nsw i32 -1, %380
  %400 = lshr i32 %379, %370
  br label %401

401:                                              ; preds = %401, %396
  %402 = phi i32 [ %375, %396 ], [ %403, %401 ]
  %403 = add i32 %402, %399
  %404 = add i32 %403, %400
  %405 = zext i32 %404 to i64
  %406 = getelementptr inbounds %struct.code, ptr %374, i64 %405
  store i8 %398, ptr %406, align 2, !tbaa.struct !17
  %407 = getelementptr inbounds i8, ptr %406, i64 1
  store i8 %381, ptr %407, align 1, !tbaa.struct !19
  %408 = getelementptr inbounds i8, ptr %406, i64 2
  store i16 %397, ptr %408, align 2, !tbaa.struct !20
  %409 = icmp eq i32 %403, 0
  br i1 %409, label %410, label %401, !llvm.loop !23
...
413:                                              ; preds = %413, %410
  %414 = phi i32 [ %412, %410 ], [ %417, %413 ]
  %415 = and i32 %414, %379
  %416 = icmp eq i32 %415, 0
  %417 = lshr i32 %414, 1
  br i1 %416, label %418, label %413, !llvm.loop !24
...
418:                                              ; preds = %413
  ...
  %421 = and i32 %420, %379
  %422 = add i32 %421, %414
  %423 = select i1 %419, i32 0, i32 %422
  %424 = add i32 %378, 1
  %425 = zext i32 %377 to i64
  %426 = getelementptr inbounds [16 x i16], ptr %7, i64 0, i64 %425
  %427 = load i16, ptr %426, align 2, !tbaa !5
  %428 = add i16 %427, -1
  store i16 %428, ptr %426, align 2, !tbaa !5
  %429 = icmp eq i16 %428, 0
  br i1 %429, label %430, label %440

430:                                              ; preds = %418
  %431 = icmp eq i32 %377, %158
  br i1 %431, label %496, label %432

432:                                              ; preds = %430
  %433 = zext i32 %424 to i64
  %434 = getelementptr inbounds i16, ptr %5, i64 %433
  %435 = load i16, ptr %434, align 2, !tbaa !5
  %436 = zext i16 %435 to i64
  %437 = getelementptr inbounds i16, ptr %1, i64 %436
  %438 = load i16, ptr %437, align 2, !tbaa !5
  %439 = zext i16 %438 to i32
  br label %440

440:                                              ; preds = %432, %418
  %441 = phi i32 [ %439, %432 ], [ %377, %418 ]
  %442 = icmp ugt i32 %441, %162
  br i1 %442, label %443, label %446

443:                                              ; preds = %440
  %444 = and i32 %423, %363
  %445 = icmp eq i32 %444, %373
...
447:                                              ; preds = %443
  %448 = icmp eq i32 %370, 0
  %449 = select i1 %448, i32 %162, i32 %370
  %450 = zext i32 %375 to i64
  %451 = getelementptr inbounds %struct.code, ptr %374, i64 %450
  %452 = sub i32 %441, %449
  %453 = shl nuw i32 1, %452
  %454 = icmp ult i32 %441, %158
...
457:                                              ; preds = %455, %467
  %458 = phi i32 [ %470, %467 ], [ %441, %455 ]
  %459 = phi i32 [ %469, %467 ], [ %453, %455 ]
  %460 = phi i32 [ %468, %467 ], [ %452, %455 ]
  %461 = zext i32 %458 to i64
  %462 = getelementptr inbounds [16 x i16], ptr %7, i64 0, i64 %461
  %463 = load i16, ptr %462, align 2, !tbaa !5
...
467:                                              ; preds = %457
  %468 = add i32 %460, 1
  %469 = shl nuw i32 %465, 1
  %470 = add i32 %468, %449
  %471 = icmp ult i32 %470, %158
  br i1 %471, label %457, label %472, !llvm.loop !25

472:                                              ; preds = %457, %467
  %473 = phi i32 [ %456, %467 ], [ %460, %457 ]
  %474 = shl nuw i32 1, %473
  br label %475

475:                                              ; preds = %472, %447
  %476 = phi i32 [ %474, %472 ], [ %453, %447 ]
  %477 = phi i32 [ %473, %472 ], [ %452, %447 ]
  %478 = add i32 %476, %371
  %479 = icmp ugt i32 %478, 851
  %480 = select i1 %361, i1 %479, i1 false
  %481 = icmp ugt i32 %478, 591
  %482 = select i1 %357, i1 %481, i1 false
  %483 = select i1 %480, i1 true, i1 %482
  br i1 %483, label %509, label %484

484:                                              ; preds = %475
  %485 = trunc i32 %477 to i8
  %486 = load ptr, ptr %3, align 8, !tbaa !15
  %487 = zext i32 %444 to i64
  %488 = getelementptr inbounds %struct.code, ptr %486, i64 %487
  store i8 %485, ptr %488, align 2, !tbaa !26
  %489 = getelementptr inbounds %struct.code, ptr %486, i64 %487, i32 1
  store i8 %365, ptr %489, align 1, !tbaa !28
  %490 = ptrtoint ptr %451 to i64
  %491 = ptrtoint ptr %486 to i64
  %492 = sub i64 %490, %491
  %493 = lshr exact i64 %492, 2
  %494 = trunc i64 %493 to i16
  %495 = getelementptr inbounds %struct.code, ptr %486, i64 %487, i32 2
  store i16 %494, ptr %495, align 2, !tbaa !29
  br label %366

496:                                              ; preds = %430
  %497 = icmp eq i32 %423, 0
  br i1 %497, label %503, label %498

498:                                              ; preds = %496
  %499 = zext i32 %423 to i64
  %500 = getelementptr inbounds %struct.code, ptr %374, i64 %499
  store i8 64, ptr %500, align 2, !tbaa.struct !17
  %501 = getelementptr inbounds i8, ptr %500, i64 1
  store i8 %381, ptr %501, align 1, !tbaa.struct !19
  %502 = getelementptr inbounds i8, ptr %500, i64 2
  store i16 0, ptr %502, align 2, !tbaa.struct !20
  br label %503

503:                                              ; preds = %498, %496
  %504 = load ptr, ptr %3, align 8, !tbaa !15
  %505 = zext i32 %371 to i64
  %506 = getelementptr inbounds %struct.code, ptr %504, i64 %505
  store ptr %506, ptr %3, align 8, !tbaa !15
  br label %507

507:                                              ; preds = %128, %503
  %508 = phi i32 [ %162, %503 ], [ 1, %128 ]
  store i32 %508, ptr %4, align 4, !tbaa !9
  br label %509

509:                                              ; preds = %475, %507, %263, %156, %166, %174, %181, %188, %195, %203, %210, %217, %224, %231, %238, %245, %252, %259, %350, %352
  %510 = phi i32 [ 1, %352 ], [ 1, %350 ], [ -1, %259 ], [ -1, %252 ], [ -1, %245 ], [ -1, %238 ], [ -1, %231 ], [ -1, %224 ], [ -1, %217 ], [ -1, %210 ], [ -1, %203 ], [ -1, %195 ], [ -1, %188 ], [ -1, %181 ], [ -1, %174 ], [ -1, %166 ], [ -1, %156 ], [ -1, %263 ], [ 0, %507 ], [ 1, %475 ]
