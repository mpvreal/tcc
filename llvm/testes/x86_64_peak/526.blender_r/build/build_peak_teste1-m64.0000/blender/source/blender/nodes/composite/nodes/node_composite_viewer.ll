; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_viewer.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_viewer.c"
...
define dso_local void @register_node_type_cmp_viewer() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_viewer.ntype, i32 noundef 201, ptr noundef nonnull @.str, i16 noundef signext 1, i16 noundef signext 4) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_viewer.ntype, ptr noundef nonnull @cmp_node_viewer_in, ptr noundef null) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_cmp_viewer.ntype, ptr noundef nonnull @node_composit_init_viewer) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_cmp_viewer.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @node_type_internal_links(ptr noundef nonnull @register_node_type_cmp_viewer.ntype, ptr noundef null) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_viewer.ntype) #2
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @node_composit_init_viewer(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
  ...
  %9 = getelementptr inbounds %struct.bNode, ptr %1, i64 0, i32 35
  store <2 x float> <float 5.000000e-01, float 5.000000e-01>, ptr %9, align 4, !tbaa !20
