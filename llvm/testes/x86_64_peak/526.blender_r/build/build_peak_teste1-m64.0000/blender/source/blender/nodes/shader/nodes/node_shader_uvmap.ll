; ModuleID = 'blender/source/blender/nodes/shader/nodes/node_shader_uvmap.c'
source_filename = "blender/source/blender/nodes/shader/nodes/node_shader_uvmap.c"
...
@register_node_type_sh_uvmap.ntype = internal global %struct.bNodeType zeroinitializer, align 8
@.str = private unnamed_addr constant [7 x i8] c"UV Map\00", align 1
@sh_node_uvmap_out = internal global [2 x %struct.bNodeSocketTemplate] [%struct.bNodeSocketTemplate { i32 1, i32 0, [64 x i8] c"UV\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }, %struct.bNodeSocketTemplate { i32 -1, i32 0, [64 x i8] zeroinitializer, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }], align 16
@.str.1 = private unnamed_addr constant [16 x i8] c"NodeShaderUVMap\00", align 1
@MEM_callocN = external local_unnamed_addr global ptr, align 8
@.str.2 = private unnamed_addr constant [11 x i8] c"node_uvmap\00", align 1

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_sh_uvmap() local_unnamed_addr #0 {
  tail call void @sh_node_type_base(ptr noundef nonnull @register_node_type_sh_uvmap.ntype, i32 noundef 187, ptr noundef nonnull @.str, i16 noundef signext 0, i16 noundef signext 0) #2
  tail call void @node_type_compatibility(ptr noundef nonnull @register_node_type_sh_uvmap.ntype, i16 noundef signext 2) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_sh_uvmap.ntype, ptr noundef null, ptr noundef nonnull @sh_node_uvmap_out) #2
  tail call void @node_type_size_preset(ptr noundef nonnull @register_node_type_sh_uvmap.ntype, i32 noundef 2) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_sh_uvmap.ntype, ptr noundef nonnull @node_shader_init_uvmap) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_sh_uvmap.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @node_type_gpu(ptr noundef nonnull @register_node_type_sh_uvmap.ntype, ptr noundef nonnull @node_shader_gpu_uvmap) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_sh_uvmap.ntype) #2
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @node_shader_init_uvmap(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
  %3 = load ptr, ptr @MEM_callocN, align 8, !tbaa !5
  %4 = tail call ptr %3(i64 noundef 64, ptr noundef nonnull @.str.1) #2
...
; Function Attrs: nounwind sspstrong uwtable
define internal i32 @node_shader_gpu_uvmap(ptr noundef %0, ptr nocapture noundef readonly %1, ptr nocapture readnone %2, ptr noundef %3, ptr noundef %4) #0 {
  %6 = getelementptr inbounds %struct.bNode, ptr %1, i64 0, i32 21
  %7 = load ptr, ptr %6, align 8, !tbaa !9
  %8 = tail call ptr @GPU_attribute(i32 noundef 5, ptr noundef %7) #2
  %9 = tail call zeroext i8 (ptr, ptr, ptr, ptr, ...) @GPU_stack_link(ptr noundef %0, ptr noundef nonnull @.str.2, ptr noundef %3, ptr noundef %4, ptr noundef %8) #2
  %10 = zext i8 %9 to i32
  ret i32 %10
}
