; ModuleID = 'blender/source/blender/nodes/shader/nodes/node_shader_tex_gradient.c'
source_filename = "blender/source/blender/nodes/shader/nodes/node_shader_tex_gradient.c"
...
%struct.NodeTexGradient = type { %struct.NodeTexBase, i32, i32 }
...
@register_node_type_sh_tex_gradient.ntype = internal global %struct.bNodeType zeroinitializer, align 8
@.str = private unnamed_addr constant [17 x i8] c"Gradient Texture\00", align 1
...
@.str.1 = private unnamed_addr constant [16 x i8] c"NodeTexGradient\00", align 1
@MEM_callocN = external local_unnamed_addr global ptr, align 8
@.str.2 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@.str.3 = private unnamed_addr constant [18 x i8] c"node_tex_gradient\00", align 1

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_sh_tex_gradient() local_unnamed_addr #0 {
  tail call void @sh_node_type_base(ptr noundef nonnull @register_node_type_sh_tex_gradient.ntype, i32 noundef 146, ptr noundef nonnull @.str, i16 noundef signext 13, i16 noundef signext 0) #2
  tail call void @node_type_compatibility(ptr noundef nonnull @register_node_type_sh_tex_gradient.ntype, i16 noundef signext 2) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_sh_tex_gradient.ntype, ptr noundef nonnull @sh_node_tex_gradient_in, ptr noundef nonnull @sh_node_tex_gradient_out) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_sh_tex_gradient.ntype, ptr noundef nonnull @node_shader_init_tex_gradient) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_sh_tex_gradient.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @node_type_gpu(ptr noundef nonnull @register_node_type_sh_tex_gradient.ntype, ptr noundef nonnull @node_shader_gpu_tex_gradient) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_sh_tex_gradient.ntype) #2
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @node_shader_init_tex_gradient(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
  ...
  %6 = getelementptr inbounds %struct.NodeTexGradient, ptr %4, i64 0, i32 1
...
; Function Attrs: nounwind sspstrong uwtable
define internal i32 @node_shader_gpu_tex_gradient(ptr noundef %0, ptr noundef %1, ptr nocapture readnone %2, ptr noundef %3, ptr noundef %4) #0 {
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !13, i64 968}
!10 = !{!"NodeTexGradient", !11, i64 0, !13, i64 968, !13, i64 972}
