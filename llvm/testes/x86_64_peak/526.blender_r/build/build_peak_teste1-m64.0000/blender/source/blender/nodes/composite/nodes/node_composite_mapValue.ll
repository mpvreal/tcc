; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_mapValue.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_mapValue.c"
...
define dso_local void @register_node_type_cmp_map_value() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_map_value.ntype, i32 noundef 213, ptr noundef nonnull @.str, i16 noundef signext 4, i16 noundef signext 0) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_map_value.ntype, ptr noundef nonnull @cmp_node_map_value_in, ptr noundef nonnull @cmp_node_map_value_out) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_cmp_map_value.ntype, ptr noundef nonnull @node_composit_init_map_value) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_cmp_map_value.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_map_value.ntype) #2
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @node_composit_init_map_value(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
  %3 = tail call ptr @add_tex_mapping(i32 noundef 0) #2
