; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_sunbeams.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_sunbeams.c"
...
@register_node_type_cmp_sunbeams.ntype = internal global %struct.bNodeType zeroinitializer, align 8
@.str = private unnamed_addr constant [10 x i8] c"Sun Beams\00", align 1
@inputs = internal global [2 x %struct.bNodeSocketTemplate] [%struct.bNodeSocketTemplate { i32 2, i32 1, [64 x i8] c"Image\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }, %struct.bNodeSocketTemplate { i32 -1, i32 0, [64 x i8] zeroinitializer, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }], align 16
...
@.str.1 = private unnamed_addr constant [13 x i8] c"NodeSunBeams\00", align 1
@MEM_callocN = external local_unnamed_addr global ptr, align 8
@.str.2 = private unnamed_addr constant [15 x i8] c"sun beams node\00", align 1

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_cmp_sunbeams() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_sunbeams.ntype, i32 noundef 304, ptr noundef nonnull @.str, i16 noundef signext 5, i16 noundef signext 0) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_sunbeams.ntype, ptr noundef nonnull @inputs, ptr noundef nonnull @outputs) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_cmp_sunbeams.ntype, ptr noundef nonnull @init) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_cmp_sunbeams.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_sunbeams.ntype) #2
  ret void
}
...
define internal void @init(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
  ...
  store <2 x float> <float 5.000000e-01, float 5.000000e-01>, ptr %4, align 4, !tbaa !9
