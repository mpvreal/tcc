; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_invert.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_invert.c"
...
define dso_local void @register_node_type_cmp_invert() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_invert.ntype, i32 noundef 251, ptr noundef nonnull @.str, i16 noundef signext 3, i16 noundef signext 0) #3
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_invert.ntype, ptr noundef nonnull @cmp_node_invert_in, ptr noundef nonnull @cmp_node_invert_out) #3
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_cmp_invert.ntype, ptr noundef nonnull @node_composit_init_invert) #3
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_invert.ntype) #3
  ret void
}
...
define internal void @node_composit_init_invert(ptr nocapture readnone %0, ptr nocapture noundef %1) #2 {
  %3 = getelementptr inbounds %struct.bNode, ptr %1, i64 0, i32 33
  %4 = load i16, ptr %3, align 8, !tbaa !5
  %5 = or i16 %4, 1
  store i16 %5, ptr %3, align 8, !tbaa !5
  ret void
}
