; ModuleID = 'blender/source/blender/nodes/texture/nodes/node_texture_invert.c'
source_filename = "blender/source/blender/nodes/texture/nodes/node_texture_invert.c"
...
@register_node_type_tex_invert.ntype = internal global %struct.bNodeType zeroinitializer, align 8
...
define dso_local void @register_node_type_tex_invert() local_unnamed_addr #0 {
  tail call void @tex_node_type_base(ptr noundef nonnull @register_node_type_tex_invert.ntype, i32 noundef 411, ptr noundef nonnull @.str, i16 noundef signext 3, i16 noundef signext 0) #3
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_tex_invert.ntype, ptr noundef nonnull @inputs, ptr noundef nonnull @outputs) #3
  tail call void @node_type_exec(ptr noundef nonnull @register_node_type_tex_invert.ntype, ptr noundef null, ptr noundef null, ptr noundef nonnull @exec) #3
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_tex_invert.ntype) #3
  ret void
}
...
define internal void @colorfn(ptr nocapture noundef writeonly %0, ptr noundef %1, ptr nocapture readnone %2, ptr nocapture noundef readonly %3, i16 noundef signext %4) #0 {
  ...
  %8 = getelementptr inbounds [4 x float], ptr %6, i64 0, i64 2
  %9 = load float, ptr %8, align 8, !tbaa !9
  %10 = fsub fast float 1.000000e+00, %9
  %11 = load <2 x float>, ptr %6, align 16, !tbaa !9
  %12 = fsub fast <2 x float> <float 1.000000e+00, float 1.000000e+00>, %11
  store <2 x float> %12, ptr %0, align 4, !tbaa !9
  %13 = getelementptr inbounds float, ptr %0, i64 2
  store float %10, ptr %13, align 4, !tbaa !9
  %14 = getelementptr inbounds [4 x float], ptr %6, i64 0, i64 3
  %15 = load float, ptr %14, align 4, !tbaa !9
  %16 = getelementptr inbounds float, ptr %0, i64 3
