; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_sepcombHSVA.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_sepcombHSVA.c"
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_cmp_combhsva() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_combhsva.ntype, i32 noundef 246, ptr noundef nonnull @.str.1, i16 noundef signext 8, i16 noundef signext 0) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_combhsva.ntype, ptr noundef nonnull @cmp_node_combhsva_in, ptr noundef nonnull @cmp_node_combhsva_out) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_combhsva.ntype) #2
  ret void
}
