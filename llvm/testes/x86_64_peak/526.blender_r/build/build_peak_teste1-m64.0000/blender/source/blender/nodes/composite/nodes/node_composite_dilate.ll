; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_dilate.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_dilate.c"
...
@register_node_type_cmp_dilateerode.ntype = internal global %struct.bNodeType zeroinitializer, align 8
@.str = private unnamed_addr constant [13 x i8] c"Dilate/Erode\00", align 1
@cmp_node_dilateerode_in = internal global [2 x %struct.bNodeSocketTemplate] [%struct.bNodeSocketTemplate { i32 0, i32 1, [64 x i8] c"Mask\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 1.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }, %struct.bNodeSocketTemplate { i32 -1, i32 0, [64 x i8] zeroinitializer, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }], align 16
@cmp_node_dilateerode_out = internal global [2 x %struct.bNodeSocketTemplate] [%struct.bNodeSocketTemplate { i32 0, i32 0, [64 x i8] c"Mask\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }, %struct.bNodeSocketTemplate { i32 -1, i32 0, [64 x i8] zeroinitializer, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }], align 16
@.str.1 = private unnamed_addr constant [16 x i8] c"NodeDilateErode\00", align 1
@MEM_callocN = external local_unnamed_addr global ptr, align 8

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_cmp_dilateerode() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_dilateerode.ntype, i32 noundef 228, ptr noundef nonnull @.str, i16 noundef signext 5, i16 noundef signext 0) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_dilateerode.ntype, ptr noundef nonnull @cmp_node_dilateerode_in, ptr noundef nonnull @cmp_node_dilateerode_out) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_cmp_dilateerode.ntype, ptr noundef nonnull @node_composit_init_dilateerode) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_cmp_dilateerode.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_dilateerode.ntype) #2
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @node_composit_init_dilateerode(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !7, i64 0}
!10 = !{!"NodeDilateErode", !7, i64 0, !7, i64 1}
!11 = !{!12, !6, i64 248}
