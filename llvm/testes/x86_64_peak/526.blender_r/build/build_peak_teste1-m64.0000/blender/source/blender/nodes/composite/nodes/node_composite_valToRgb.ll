...
@register_node_type_cmp_valtorgb.ntype = internal global %struct.bNodeType zeroinitializer, align 8
...
@register_node_type_cmp_rgbtobw.ntype = internal global %struct.bNodeType zeroinitializer, align 8
...
define dso_local void @register_node_type_cmp_valtorgb() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_valtorgb.ntype, i32 noundef 205, ptr noundef nonnull @.str, i16 noundef signext 8, i16 noundef signext 0) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_valtorgb.ntype, ptr noundef nonnull @cmp_node_valtorgb_in, ptr noundef nonnull @cmp_node_valtorgb_out) #2
  tail call void @node_type_size(ptr noundef nonnull @register_node_type_cmp_valtorgb.ntype, i32 noundef 240, i32 noundef 200, i32 noundef 320) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_cmp_valtorgb.ntype, ptr noundef nonnull @node_composit_init_valtorgb) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_cmp_valtorgb.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_valtorgb.ntype) #2
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @node_composit_init_valtorgb(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
  %3 = tail call ptr @add_colorband(i8 noundef zeroext 1) #2
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_cmp_rgbtobw() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_rgbtobw.ntype, i32 noundef 206, ptr noundef nonnull @.str.2, i16 noundef signext 8, i16 noundef signext 0) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_rgbtobw.ntype, ptr noundef nonnull @cmp_node_rgbtobw_in, ptr noundef nonnull @cmp_node_rgbtobw_out) #2
  tail call void @node_type_size_preset(ptr noundef nonnull @register_node_type_cmp_rgbtobw.ntype, i32 noundef 1) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_rgbtobw.ntype) #2
  ret void
}
