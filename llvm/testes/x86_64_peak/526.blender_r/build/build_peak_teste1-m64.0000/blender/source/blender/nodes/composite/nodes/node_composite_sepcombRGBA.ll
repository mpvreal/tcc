; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_sepcombRGBA.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_sepcombRGBA.c"
...
@register_node_type_cmp_seprgba.ntype = internal global %struct.bNodeType zeroinitializer, align 8
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_cmp_combrgba() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_combrgba.ntype, i32 noundef 227, ptr noundef nonnull @.str.1, i16 noundef signext 8, i16 noundef signext 0) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_combrgba.ntype, ptr noundef nonnull @cmp_node_combrgba_in, ptr noundef nonnull @cmp_node_combrgba_out) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_combrgba.ntype) #2
  ret void
}
