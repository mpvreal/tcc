; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_splitViewer.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_splitViewer.c"
...
@register_node_type_cmp_splitviewer.ntype = internal global %struct.bNodeType zeroinitializer, align 8
@.str = private unnamed_addr constant [13 x i8] c"Split Viewer\00", align 1
@cmp_node_splitviewer_in = internal global [3 x %struct.bNodeSocketTemplate] [%struct.bNodeSocketTemplate { i32 2, i32 1, [64 x i8] c"Image\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }, %struct.bNodeSocketTemplate { i32 2, i32 1, [64 x i8] c"Image\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }, %struct.bNodeSocketTemplate { i32 -1, i32 0, [64 x i8] zeroinitializer, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, i32 0, i32 0, ptr null, [64 x i8] zeroinitializer }], align 16
...
@.str.3 = private unnamed_addr constant [12 x i8] c"Viewer Node\00", align 1

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @register_node_type_cmp_splitviewer() local_unnamed_addr #0 {
  tail call void @cmp_node_type_base(ptr noundef nonnull @register_node_type_cmp_splitviewer.ntype, i32 noundef 240, ptr noundef nonnull @.str, i16 noundef signext 1, i16 noundef signext 4) #2
  tail call void @node_type_socket_templates(ptr noundef nonnull @register_node_type_cmp_splitviewer.ntype, ptr noundef nonnull @cmp_node_splitviewer_in, ptr noundef null) #2
  tail call void @node_type_init(ptr noundef nonnull @register_node_type_cmp_splitviewer.ntype, ptr noundef nonnull @node_composit_init_splitviewer) #2
  tail call void @node_type_storage(ptr noundef nonnull @register_node_type_cmp_splitviewer.ntype, ptr noundef nonnull @.str.1, ptr noundef nonnull @node_free_standard_storage, ptr noundef nonnull @node_copy_standard_storage) #2
  tail call void @node_type_internal_links(ptr noundef nonnull @register_node_type_cmp_splitviewer.ntype, ptr noundef null) #2
  tail call void @nodeRegisterType(ptr noundef nonnull @register_node_type_cmp_splitviewer.ntype) #2
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal void @node_composit_init_splitviewer(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #0 {
  ...
  store i16 50, ptr %9, align 8, !tbaa !20
  %10 = tail call ptr @BKE_image_verify_viewer(i32 noundef 5, ptr noundef nonnull @.str.3) #2
...
declare ptr @BKE_image_verify_viewer(i32 noundef, ptr noundef) local_unnamed_addr #1
