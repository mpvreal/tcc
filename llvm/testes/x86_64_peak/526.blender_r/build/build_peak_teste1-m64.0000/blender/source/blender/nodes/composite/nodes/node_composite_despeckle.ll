; ModuleID = 'blender/source/blender/nodes/composite/nodes/node_composite_despeckle.c'
source_filename = "blender/source/blender/nodes/composite/nodes/node_composite_despeckle.c"
...
define internal void @node_composit_init_despeckle(ptr nocapture readnone %0, ptr nocapture noundef writeonly %1) #2 {
  %3 = getelementptr inbounds %struct.bNode, ptr %1, i64 0, i32 35
  store <2 x float> <float 5.000000e-01, float 5.000000e-01>, ptr %3, align 4, !tbaa !5
  ret void
}
