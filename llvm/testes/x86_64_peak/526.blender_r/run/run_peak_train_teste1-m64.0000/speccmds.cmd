...
-o sh5_reduced.234.spec.out -e sh5_reduced.234.spec.err echo "../run_peak_train_teste1-m64.0000/blender_r_peak.teste1-m64 sh5_reduced.blend --render-output sh5_reduced_ --threads 1 -b -F RAWTGA -s 234 -e 234 -a" > run.sh ; $BIND bash run.sh
