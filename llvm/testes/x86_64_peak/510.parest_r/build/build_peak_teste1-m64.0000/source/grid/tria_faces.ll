...
%"struct.std::_Vector_base.31" = type { %"struct.std::_Vector_base<dealii::RefinementCase<1>, std::allocator<dealii::RefinementCase<1> > >::_Vector_impl" }
...
%"struct.std::_Vector_base.36" = type { %"struct.std::_Vector_base<dealii::internal::Triangulation::TriaObjects<dealii::internal::Triangulation::TriaObject<1> >::UserData, std::allocator<dealii::internal::Triangulation::TriaObjects<dealii::internal::Triangulation::TriaObject<1> >::UserData> >::_Vector_impl" }
...
define dso_local noundef i32 @_ZNK6dealii8internal13Triangulation9TriaFacesILi3EE18memory_consumptionEv(ptr noundef nonnull align 8 dereferenceable(488) %0) local_unnamed_addr #0 align 2 {
  %2 = tail call noundef i32 @_ZNK6dealii8internal13Triangulation17TriaObjectsQuad3D18memory_consumptionEv(ptr noundef nonnull align 8 dereferenceable(264) %0)
  %3 = getelementptr inbounds %"class.dealii::internal::Triangulation::TriaFaces", ptr %0, i64 0, i32 1
  %4 = tail call noundef i32 @_ZNK6dealii8internal13Triangulation11TriaObjectsINS1_10TriaObjectILi1EEEE18memory_consumptionEv(ptr noundef nonnull align 8 dereferenceable(220) %3)
  %5 = add i32 %4, %2
  ret i32 %5
}

declare noundef i32 @_ZNK6dealii8internal13Triangulation17TriaObjectsQuad3D18memory_consumptionEv(ptr noundef nonnull align 8 dereferenceable(264)) local_unnamed_addr #1

declare noundef i32 @_ZNK6dealii8internal13Triangulation11TriaObjectsINS1_10TriaObjectILi1EEEE18memory_consumptionEv(ptr noundef nonnull align 8 dereferenceable(220)) local_unnamed_addr #1
