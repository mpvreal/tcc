...
define dso_local noundef ptr @_ZN7Matcher11get_MatcherEv() local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  %1 = load ptr, ptr @_ZN7Matcher9s_matcherE, align 8, !tbaa !5
...
5:                                                ; preds = %3
  store ptr %4, ptr @_ZN7Matcher9s_matcherE, align 8, !tbaa !5
  br label %8
...
define dso_local void @_ZN7Matcher11set_MatcherEPS_(ptr noundef %0) local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
  %2 = load ptr, ptr @_ZN7Matcher9s_matcherE, align 8, !tbaa !5
...
14:                                               ; preds = %13, %1
  store ptr %0, ptr @_ZN7Matcher9s_matcherE, align 8, !tbaa !5
  ret void
}

; Function Attrs: sspstrong uwtable
define dso_local void @_ZN7MatcherC2Ev(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
...
40:                                               ; preds = %28, %51
  ...
  %44 = load i32, ptr %42, align 4, !tbaa !21
...
51:                                               ; preds = %40
  ...
  br i1 %53, label %56, label %40, !llvm.loop !25
...
122:                                              ; preds = %120
  %123 = load ptr, ptr %30, align 8, !tbaa !17
...
125:                                              ; preds = %122, %125
  ...
  br i1 %136, label %137, label %125, !llvm.loop !29
...
164:                                              ; preds = %158, %164
  ...
  br i1 %175, label %176, label %164, !llvm.loop !29
...
193:                                              ; preds = %178, %176, %158, %184
  ...
  store i8 %194, ptr %196, align 1, !tbaa !32
  %197 = add nuw nsw i64 %57, 1
  %198 = icmp eq i64 %197, 1048576
  br i1 %198, label %59, label %56, !llvm.loop !33
...
201:                                              ; preds = %38, %199, %36
  ...
  %203 = load ptr, ptr %25, align 8, !tbaa !27
...
declare void @_ZN9FastBoard11reset_boardEi(ptr noundef nonnull align 8 dereferenceable(8052), i32 noundef) local_unnamed_addr #6
...
26:                                               ; preds = %2, %20, %22
  ...
  store float %32, ptr %30, align 4, !tbaa !30
...
42:                                               ; preds = %38
  ...
  %44 = load i32, ptr %29, align 4, !tbaa !21
...
declare void @_ZN9FastBoard10set_squareEiNS_8square_tE(ptr noundef nonnull align 8 dereferenceable(8052), i32 noundef, i32 noundef) local_unnamed_addr #6

declare noundef i32 @_ZN9FastBoard13get_extra_dirEi(ptr noundef nonnull align 8 dereferenceable(8052), i32 noundef) local_unnamed_addr #6

declare noundef i32 @_ZN9FastBoard25get_pattern3_augment_specEiib(ptr noundef nonnull align 8 dereferenceable(8052), i32 noundef, i32 noundef, i1 noundef zeroext) local_unnamed_addr #6

; Function Attrs: mustprogress nofree nosync nounwind sspstrong willreturn memory(none) uwtable
define dso_local noundef zeroext i8 @_ZN7Matcher4clipEi(ptr nocapture noundef nonnull readnone align 8 dereferenceable(48) %0, i32 noundef %1) local_unnamed_addr #7 align 2 {
...
define linkonce_odr dso_local void @_ZN5boost5arrayISt6vectorIhSaIhEELm2EED2Ev(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #8 comdat align 2 personality ptr @__gxx_personality_v0 {
...
define dso_local noundef i32 @_ZN7Matcher7matchesEii(ptr nocapture noundef nonnull readonly align 8 dereferenceable(48) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #9 align 2 {
  %4 = sext i32 %1 to i64
...
52:                                               ; preds = %3
  ...
  %55 = load i32, ptr %53, align 4, !tbaa !21
...
76:                                               ; preds = %72, %76
  ...
  br i1 %85, label %86, label %76, !llvm.loop !41
...
attributes #7 = { mustprogress nofree nosync nounwind sspstrong willreturn memory(none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
...
!29 = distinct !{!29, !26}
!30 = !{!31, !24, i64 4}
!31 = !{!"_ZTSSt4pairIKifE", !22, i64 0, !24, i64 4}
!32 = !{!7, !7, i64 0}
!33 = distinct !{!33, !26}
!34 = !{!31, !22, i64 0}
!35 = !{!36, !24, i64 4}
!36 = !{!"_ZTSSt4pairIifE", !22, i64 0, !24, i64 4}
!37 = !{!14, !6, i64 24}
!38 = !{!14, !6, i64 16}
!39 = distinct !{!39, !26}
!40 = !{!10, !6, i64 16}
