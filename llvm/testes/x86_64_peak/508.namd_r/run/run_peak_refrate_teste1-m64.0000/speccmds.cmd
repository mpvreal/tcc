...
-o namd.out -e namd.err echo "../run_peak_refrate_teste1-m64.0000/namd_r_peak.teste1-m64 --input apoa1.input --output apoa1.ref.output --iterations 65" > run.sh ; $BIND bash run.sh
