...
-o namd.out -e namd.err echo "../run_peak_train_teste1-m64.0000/namd_r_peak.teste1-m64 --input apoa1.input --iterations 7 --output apoa1.train.output" > run.sh ; $BIND bash run.sh
