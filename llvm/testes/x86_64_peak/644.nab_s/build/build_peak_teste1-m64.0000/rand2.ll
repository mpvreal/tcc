...
define dso_local i32 @setseed(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  ...
  store i32 %7, ptr @spec_seed, align 4, !tbaa !6
...
define dso_local i32 @rseed() local_unnamed_addr #2 {
  %1 = load i32, ptr @spec_seed, align 4, !tbaa !6
  ret i32 %1
}
...
17:                                               ; preds = %3
  ...
  %24 = load double, ptr %1, align 8, !tbaa !12
  %25 = fmul fast double %23, %24
  %26 = load double, ptr %0, align 8, !tbaa !12
