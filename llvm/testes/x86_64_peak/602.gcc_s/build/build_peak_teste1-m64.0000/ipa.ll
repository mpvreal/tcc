...
@.str.5 = private unnamed_addr constant [19 x i8] c"externally_visible\00", align 1
@dump_file = external local_unnamed_addr global ptr, align 8
@.str.6 = private unnamed_addr constant [26 x i8] c"\0AMarking local functions:\00", align 1
@.str.7 = private unnamed_addr constant [3 x i8] c"\0A\0A\00", align 1
@.str.8 = private unnamed_addr constant [39 x i8] c"\0AMarking externally visible functions:\00", align 1
@.str.9 = private unnamed_addr constant [39 x i8] c"\0AMarking externally visible variables:\00", align 1
@cgraph_function_flags_ready = external local_unnamed_addr global i8, align 1
@pass_ipa_whole_program_visibility = dso_local local_unnamed_addr global %struct.ipa_opt_pass_d { %struct.opt_pass { i32 3, ptr @.str.10, ptr @gate_whole_program_function_and_variable_visibility, ptr @whole_program_function_and_variable_visibility, ptr null, ptr null, i32 0, i32 5, i32 0, i32 0, i32 0, i32 0, i32 384 }, ptr null, ptr null, ptr null, ptr null, ptr null, i32 0, ptr null, ptr null }, align 8
@.str.10 = private unnamed_addr constant [14 x i8] c"whole-program\00", align 1
...
define dso_local i32 @cgraph_postorder(ptr nocapture noundef writeonly %0) local_unnamed_addr #9 {
  ...
  %3 = load i32, ptr @cgraph_n_nodes, align 4, !tbaa !21
  %4 = sext i32 %3 to i64
...
9:                                                ; preds = %1, %9
  ...
  br i1 %14, label %8, label %9, !llvm.loop !32
...
38:                                               ; preds = %27, %35
  ...
  store ptr %42, ptr %19, align 8, !tbaa !24
  br label %43
...
52:                                               ; preds = %49
  ...
  br i1 %61, label %62, label %49, !llvm.loop !37
...
62:                                               ; preds = %52
  ...
  store ptr %68, ptr %64, align 8, !tbaa !24
  %69 = add nsw i32 %46, 1
  %70 = sext i32 %46 to i64
  %71 = getelementptr inbounds ptr, ptr %5, i64 %70
  store ptr %44, ptr %71, align 8, !tbaa !6
...
76:                                               ; preds = %49, %62
  ...
  store ptr %77, ptr %81, align 8, !tbaa !6
  %82 = icmp eq i32 %78, 0
...
88:                                               ; preds = %83, %62
  ...
  br i1 %92, label %93, label %43, !llvm.loop !38
...
93:                                               ; preds = %76, %88, %15, %27, %35
  ...
  br i1 %98, label %99, label %15, !llvm.loop !39

99:                                               ; preds = %93
  %100 = load ptr, ptr @cgraph_nodes, align 8, !tbaa !6
...
109:                                              ; preds = %102
  ...
  store ptr %113, ptr %106, align 8, !tbaa !24
  br label %114
...
133:                                              ; preds = %123
  ...
  store ptr %139, ptr %135, align 8, !tbaa !24
  %140 = add nsw i32 %117, 1
  %141 = sext i32 %117 to i64
  %142 = getelementptr inbounds ptr, ptr %5, i64 %141
  store ptr %115, ptr %142, align 8, !tbaa !6
  %143 = load ptr, ptr %134, align 8, !tbaa !36
...
159:                                              ; preds = %154, %133
  ...
  br i1 %163, label %164, label %114, !llvm.loop !38
...
164:                                              ; preds = %147, %159, %102
  ...
  br i1 %169, label %170, label %102, !llvm.loop !39

170:                                              ; preds = %164, %1, %99, %8
  %171 = phi i32 [ 0, %8 ], [ %95, %99 ], [ 0, %1 ], [ %166, %164 ]
  call void @free(ptr noundef %5)
  %172 = load ptr, ptr @cgraph_nodes, align 8, !tbaa !6
...
48:                                               ; preds = %42, %46
  ...
  store ptr %17, ptr %50, align 8, !tbaa !24
  %51 = or i16 %49, 8
  br label %61
...
99:                                               ; preds = %92
  %100 = load ptr, ptr %83, align 8, !tbaa !41
...
106:                                              ; preds = %99, %92
  ...
  %109 = load ptr, ptr %82, align 8, !tbaa !44
...
119:                                              ; preds = %106, %113
  store ptr %81, ptr %110, align 8, !tbaa !24
  br label %120
...
120:                                              ; preds = %113, %119, %106, %79, %88, %99
  ...
  br i1 %124, label %125, label %79, !llvm.loop !46
...
150:                                              ; preds = %140, %147
  ...
  br i1 %154, label %155, label %140, !llvm.loop !48
...
185:                                              ; preds = %289
  %186 = load ptr, ptr @cgraph_nodes, align 8, !tbaa !6
...
201:                                              ; preds = %196
  ...
  %207 = load ptr, ptr %193, align 8, !tbaa !24
...
219:                                              ; preds = %214
  %220 = load ptr, ptr %189, align 8, !tbaa !41
...
231:                                              ; preds = %235
  ...
  br i1 %234, label %242, label %235, !llvm.loop !52
...
249:                                              ; preds = %253
  ...
  br i1 %252, label %258, label %253, !llvm.loop !53
...
268:                                              ; preds = %264
  ...
  store ptr %270, ptr %271, align 8, !tbaa !55
  br label %280
...
276:                                              ; preds = %272
  ...
  store ptr %278, ptr %279, align 8, !tbaa !56
  br label %280
...
284:                                              ; preds = %280
  ...
  store ptr %266, ptr %285, align 8, !tbaa !54
  br label %286

286:                                              ; preds = %284, %280
  %287 = getelementptr inbounds %struct.cgraph_node, ptr %189, i64 0, i32 12
  store ptr null, ptr %287, align 8, !tbaa !49
...
289:                                              ; preds = %196, %226, %288, %286, %201
  ...
  br i1 %291, label %185, label %188, !llvm.loop !57
...
14:                                               ; preds = %6, %13
  ...
  br i1 %17, label %18, label %6, !llvm.loop !59
...
define internal i32 @local_function_and_variable_visibility() #9 {
  %1 = load i32, ptr @flag_whole_program, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
...
define internal fastcc void @function_and_variable_visibility(i8 noundef zeroext %0) unnamed_addr #9 {
  %2 = load ptr, ptr @cgraph_nodes, align 8, !tbaa !6
...
6:                                                ; preds = %177, %1
  %7 = load ptr, ptr @varpool_nodes, align 8, !tbaa !6
  %8 = icmp eq ptr %7, null
...
41:                                               ; preds = %33, %40
  ...
  br i1 %44, label %45, label %33, !llvm.loop !60
...
95:                                               ; preds = %90
  %96 = load ptr, ptr %25, align 8, !tbaa !47
...
110:                                              ; preds = %106, %95, %89
  ...
  %113 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 56), align 16, !tbaa !6
...
115:                                              ; preds = %110
  ...
  %118 = tail call ptr @lookup_attribute(ptr noundef nonnull @.str.5, ptr noundef %117) #16
...
177:                                              ; preds = %170, %158, %164
  ...
  br i1 %183, label %6, label %9, !llvm.loop !62
...
206:                                              ; preds = %201
  ...
  %207 = load ptr, ptr %191, align 8, !tbaa !63
...
246:                                              ; preds = %210, %239, %244
  ...
  br i1 %249, label %184, label %190, !llvm.loop !65
...
259:                                              ; preds = %256
  %260 = load ptr, ptr %251, align 8, !tbaa !63
...
273:                                              ; preds = %269
  ...
  %276 = tail call ptr @lookup_attribute(ptr noundef nonnull @.str.5, ptr noundef %275) #16
...
285:                                              ; preds = %282, %279
  ...
  %289 = load ptr, ptr %251, align 8, !tbaa !63
...
306:                                              ; preds = %305, %300, %250
  ...
  br i1 %309, label %310, label %250, !llvm.loop !66
...
313:                                              ; preds = %310
  %314 = tail call i64 @fwrite(ptr nonnull @.str.6, i64 25, i64 1, ptr nonnull %311)
  %315 = load ptr, ptr @cgraph_nodes, align 8, !tbaa !6
...
327:                                              ; preds = %317, %323
  ...
  br i1 %330, label %331, label %317, !llvm.loop !67

331:                                              ; preds = %327, %313
  %332 = load ptr, ptr @dump_file, align 8, !tbaa !6
  %333 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 2, i64 1, ptr %332)
  %334 = load ptr, ptr @dump_file, align 8, !tbaa !6
  %335 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 38, i64 1, ptr %334)
  %336 = load ptr, ptr @cgraph_nodes, align 8, !tbaa !6
...
348:                                              ; preds = %338, %344
  ...
  br i1 %351, label %352, label %338, !llvm.loop !68

352:                                              ; preds = %348, %331
  %353 = load ptr, ptr @dump_file, align 8, !tbaa !6
  %354 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 2, i64 1, ptr %353)
  %355 = load ptr, ptr @dump_file, align 8, !tbaa !6
  %356 = tail call i64 @fwrite(ptr nonnull @.str.9, i64 38, i64 1, ptr %355)
  %357 = load ptr, ptr @varpool_nodes_queue, align 8, !tbaa !6
...
369:                                              ; preds = %359, %365
  ...
  br i1 %372, label %373, label %359, !llvm.loop !69

373:                                              ; preds = %369, %352
  %374 = load ptr, ptr @dump_file, align 8, !tbaa !6
  %375 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 2, i64 1, ptr %374)
  br label %376
...
5:                                                ; preds = %24, %0
  %6 = load ptr, ptr @varpool_nodes_queue, align 8, !tbaa !6
  %7 = icmp eq ptr %6, null
...
24:                                               ; preds = %8, %14, %23
  ...
  %27 = icmp eq ptr %26, null
  br i1 %27, label %5, label %8, !llvm.loop !70
...
41:                                               ; preds = %28, %34, %40
  ...
  br i1 %44, label %45, label %28, !llvm.loop !71
...
62:                                               ; preds = %52, %58
  ...
  br i1 %65, label %66, label %52, !llvm.loop !72

66:                                               ; preds = %62, %48
  %67 = load ptr, ptr @dump_file, align 8, !tbaa !6
  %68 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 2, i64 1, ptr %67)
  br label %69
...
26:                                               ; preds = %21
  %27 = load i32, ptr %24, align 8, !tbaa !79
...
39:                                               ; preds = %34, %29
  ...
  store ptr %40, ptr %23, align 8, !tbaa !6
...
33:                                               ; preds = %27, %32
  ...
  store ptr %25, ptr %38, align 8, !tbaa !6
  br label %39
...
6:                                                ; preds = %2, %11
  %7 = phi ptr [ %16, %11 ], [ %4, %2 ]
  %8 = phi i32 [ %15, %11 ], [ 0, %2 ]
  %9 = load i32, ptr %7, align 8, !tbaa !79
  %10 = icmp ugt i32 %9, %8
...
!33 = !{!25, !7, i64 16}
!34 = !{!35, !7, i64 32}
!35 = !{!"cgraph_edge", !13, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !8, i64 72, !12, i64 76, !12, i64 80, !12, i64 84, !14, i64 88, !12, i64 90, !12, i64 90, !12, i64 90}
!36 = !{!35, !7, i64 8}
!37 = distinct !{!37, !23}
!38 = distinct !{!38, !23}
!39 = distinct !{!39, !23}
...
!62 = distinct !{!62, !23}
!63 = !{!64, !7, i64 0}
!64 = !{!"varpool_node", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !12, i64 32, !12, i64 36, !12, i64 36, !12, i64 36, !12, i64 36, !12, i64 36, !12, i64 36, !12, i64 36}
!65 = distinct !{!65, !23}
!66 = distinct !{!66, !23}
!67 = distinct !{!67, !23}
!68 = distinct !{!68, !23}
...
!72 = distinct !{!72, !23}
!73 = !{!74, !7, i64 0}
!74 = !{!"cgraph_node_set_def", !7, i64 0, !7, i64 8, !7, i64 16}
!75 = !{!74, !7, i64 8}
!76 = !{!77, !7, i64 0}
!77 = !{!"cgraph_node_set_element_def", !7, i64 0, !13, i64 8}
!78 = !{!77, !13, i64 8}
!79 = !{!80, !12, i64 0}
!80 = !{!"VEC_cgraph_node_ptr_base", !12, i64 0, !12, i64 4, !8, i64 8}
!81 = !{!80, !12, i64 4}
!82 = distinct !{!82, !23}
