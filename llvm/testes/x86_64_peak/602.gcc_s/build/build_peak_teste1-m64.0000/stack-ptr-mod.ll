...
define internal i32 @rest_of_handle_stack_ptr_mod() #8 {
  ...
  %7 = xor i32 %6, 1
  store i32 %7, ptr @current_function_sp_is_unchanging, align 4, !tbaa !21
...
44:                                               ; preds = %39, %34
  ...
  br i1 %48, label %49, label %25, !llvm.loop !33
...
52:                                               ; preds = %49, %17
  ...
  br i1 %61, label %62, label %17, !llvm.loop !34
...
define internal void @notice_stack_pointer_modification_1(ptr noundef readonly %0, ptr nocapture readnone %1, ptr nocapture readnone %2) #9 {
  %4 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
  %5 = icmp eq ptr %4, %0
