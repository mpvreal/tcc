...
3:                                                ; preds = %3, %2
  ...
  br i1 %8, label %10, label %3, !llvm.loop !24
...
define dso_local ptr @alloc_INSN_LIST(ptr noundef %0, ptr noundef %1) local_unnamed_addr #9 {
  %3 = load ptr, ptr @unused_insn_list, align 8, !tbaa !6
...
5:                                                ; preds = %2
  ...
  store ptr %8, ptr @unused_insn_list, align 8, !tbaa !6
...
define dso_local ptr @alloc_EXPR_LIST(i32 noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #9 {
  %4 = load ptr, ptr @unused_expr_list, align 8, !tbaa !6
...
6:                                                ; preds = %3
  ...
  store ptr %9, ptr @unused_expr_list, align 8, !tbaa !6
  store ptr %1, ptr %7, align 8, !tbaa !17
...
13:                                               ; preds = %8, %4
  %14 = phi ptr [ %2, %4 ], [ %9, %8 ]
  %15 = load ptr, ptr @unused_expr_list, align 8, !tbaa !6
  ...
  store ptr %17, ptr @unused_expr_list, align 8, !tbaa !6
...
20:                                               ; preds = %19, %13
  ...
  br i1 %23, label %24, label %13, !llvm.loop !25

24:                                               ; preds = %20, %11
  %25 = phi ptr [ %2, %11 ], [ %15, %20 ]
  %26 = load ptr, ptr @unused_insn_list, align 8, !tbaa !6
  ...
  store ptr %28, ptr @unused_insn_list, align 8, !tbaa !6
  store ptr null, ptr %0, align 8, !tbaa !6
  br label %29
...
16:                                               ; preds = %10, %15
  %17 = load ptr, ptr @unused_insn_list, align 8, !tbaa !6
  store ptr %17, ptr %9, align 8, !tbaa !17
  store ptr %5, ptr @unused_insn_list, align 8, !tbaa !6
  ret void
}
...
11:                                               ; preds = %1, %10
  %12 = load ptr, ptr @unused_insn_list, align 8, !tbaa !6
  store ptr %12, ptr %5, align 8, !tbaa !17
  store ptr %2, ptr @unused_insn_list, align 8, !tbaa !6
  ret ptr %4
}
...
define dso_local ptr @remove_free_EXPR_LIST_node(ptr nocapture noundef %0) local_unnamed_addr #11 {
  ...
  %6 = load ptr, ptr %5, align 8, !tbaa !17
  store ptr %6, ptr %0, align 8, !tbaa !6
  %7 = load ptr, ptr @unused_expr_list, align 8, !tbaa !6
  store ptr %7, ptr %5, align 8, !tbaa !17
  store ptr %2, ptr @unused_expr_list, align 8, !tbaa !6
  ret ptr %4
}
