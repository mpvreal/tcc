...
36:                                               ; preds = %34
  store i8 46, ptr %26, align 16, !tbaa !19
  store i8 47, ptr %27, align 1, !tbaa !19
...
54:                                               ; preds = %50
  %55 = load i8, ptr %32, align 1, !tbaa !19
  %56 = icmp eq i8 %55, 0
...
94:                                               ; preds = %86
  ...
  br i1 %96, label %235, label %86, !llvm.loop !24
...
120:                                              ; preds = %112
  ...
  br i1 %122, label %125, label %112, !llvm.loop !25
...
128:                                              ; preds = %125
  %129 = load i32, ptr %5, align 4, !tbaa !23
...
133:                                              ; preds = %131, %133
  ...
  br i1 %142, label %143, label %133, !llvm.loop !26
...
151:                                              ; preds = %149, %151
  ...
  br i1 %161, label %151, label %162, !llvm.loop !27
...
171:                                              ; preds = %169, %171
  ...
  br i1 %177, label %178, label %171, !llvm.loop !28
...
188:                                              ; preds = %182, %188
  ...
  store i8 47, ptr %192, align 1, !tbaa !19
  %194 = add nuw nsw i32 %190, 1
  %195 = add i32 %191, 1
  %196 = icmp eq i32 %195, %186
  br i1 %196, label %197, label %188, !llvm.loop !29
...
227:                                              ; preds = %225, %227
  ...
  br i1 %234, label %227, label %235, !llvm.loop !32
...
235:                                              ; preds = %94, %227, %105, %82, %223, %74, %97, %102, %125, %162
  ...
  %238 = load ptr, ptr %72, align 8, !tbaa !8
...
240:                                              ; preds = %235, %240
  ...
  br i1 %246, label %247, label %240, !llvm.loop !33
...
248:                                              ; preds = %247
  %249 = load ptr, ptr %75, align 8, !tbaa !8
...
251:                                              ; preds = %248, %251
  ...
  br i1 %257, label %258, label %251, !llvm.loop !33
...
261:                                              ; preds = %259
  %262 = load ptr, ptr %236, align 8, !tbaa !8
...
264:                                              ; preds = %261, %264
  ...
  br i1 %270, label %271, label %264, !llvm.loop !33
...
23:                                               ; preds = %17
  %24 = load i8, ptr %0, align 1, !tbaa !19
  %25 = icmp eq i8 %24, 0
...
33:                                               ; preds = %26, %33
  ...
  br i1 %36, label %33, label %38, !llvm.loop !36
...
38:                                               ; preds = %33
  ...
  store ptr %45, ptr %50, align 8, !tbaa !8
  br label %51
...
51:                                               ; preds = %38, %26
  ...
  %56 = icmp eq i8 %55, 0
  br i1 %56, label %57, label %26, !llvm.loop !37
...
65:                                               ; preds = %57
  ...
  store ptr %69, ptr %74, align 8, !tbaa !8
  br label %75
...
97:                                               ; preds = %95
  store i32 %76, ptr %1, align 4, !tbaa !23
  br label %98
