...
define internal i32 @rest_of_handle_stack_adjustments() #10 {
  ...
  %2 = load i32, ptr @flag_crossjumping, align 4, !tbaa !21
  %3 = icmp eq i32 %2, 0
...
63:                                               ; preds = %55
  %64 = load i32, ptr %57, align 8, !tbaa !34
...
84:                                               ; preds = %81, %75
  ...
  br i1 %86, label %87, label %68, !llvm.loop !36
...
87:                                               ; preds = %84, %63, %43, %37
  ...
  %93 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
...
115:                                              ; preds = %113
  ...
  %117 = call fastcc i32 @try_apply_stack_adjustment(ptr noundef nonnull %24, ptr noundef %25, i64 noundef %116, i64 noundef %111), !range !37
...
175:                                              ; preds = %169, %165, %159, %154, %149, %141
  ...
  %179 = load ptr, ptr %137, align 8, !tbaa !17
...
196:                                              ; preds = %169
  ...
  %201 = load ptr, ptr %160, align 8, !tbaa !17
...
243:                                              ; preds = %235
  %244 = load i32, ptr %237, align 8, !tbaa !34
...
264:                                              ; preds = %261, %255
  ...
  br i1 %266, label %267, label %248, !llvm.loop !36
...
267:                                              ; preds = %264, %261, %255, %243, %235, %229, %225, %220, %214
  ...
  %278 = load ptr, ptr %270, align 8, !tbaa !17
...
282:                                              ; preds = %267, %206
  ...
  store ptr %283, ptr %286, align 8, !tbaa !6
  br label %287
...
293:                                              ; preds = %287
  %294 = load ptr, ptr %38, align 8, !tbaa !17
...
307:                                              ; preds = %303
  %308 = load ptr, ptr %38, align 8, !tbaa !17
...
320:                                              ; preds = %312
  %321 = load i32, ptr %314, align 8, !tbaa !34
...
332:                                              ; preds = %325
  ...
  %336 = load ptr, ptr %333, align 8, !tbaa !17
...
341:                                              ; preds = %338, %332
  ...
  br i1 %343, label %344, label %325, !llvm.loop !36
...
344:                                              ; preds = %341, %338, %332, %320, %312, %307, %303, %298, %293
  ...
  store ptr %346, ptr %352, align 8, !tbaa !6
  %353 = load i32, ptr %26, align 8
  %354 = and i32 %353, 1073741824
  %355 = load ptr, ptr %347, align 8, !tbaa !17
...
364:                                              ; preds = %344
  ...
  store ptr %288, ptr %365, align 8, !tbaa !17
  br label %367
...
371:                                              ; preds = %369
  ...
  %374 = call fastcc i32 @try_apply_stack_adjustment(ptr noundef nonnull %26, ptr noundef %25, i64 noundef %372, i64 noundef %373), !range !37
...
379:                                              ; preds = %376, %379
  ...
  br i1 %383, label %498, label %379, !llvm.loop !41
...
390:                                              ; preds = %388, %390
  ...
  br i1 %394, label %498, label %390, !llvm.loop !41
...
445:                                              ; preds = %442
  ...
  %447 = lshr i32 %446, 16
  %448 = and i32 %447, 255
  %449 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
...
452:                                              ; preds = %445
  ...
  %454 = call fastcc i32 @try_apply_stack_adjustment(ptr noundef nonnull %26, ptr noundef %25, i64 noundef 0, i64 noundef %453), !range !37
...
459:                                              ; preds = %456, %459
  ...
  br i1 %463, label %498, label %459, !llvm.loop !41

464:                                              ; preds = %81, %75, %452, %445, %442, %438, %433, %427, %423, %417, %413, %405, %395, %55, %50, %46
  store ptr %26, ptr %1, align 8, !tbaa !42
  store ptr %25, ptr %16, align 8, !tbaa !44
...
470:                                              ; preds = %464
  ...
  %473 = load ptr, ptr %16, align 8, !tbaa !44
...
482:                                              ; preds = %478
  %483 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
  %484 = load ptr, ptr %38, align 8, !tbaa !17
...
493:                                              ; preds = %491, %493
  ...
  br i1 %497, label %498, label %493, !llvm.loop !41
...
498:                                              ; preds = %459, %493, %379, %390, %491, %482, %477, %470, %456, %388, %376, %367, %109, %22
  ...
  br i1 %30, label %502, label %22, !llvm.loop !45
...
510:                                              ; preds = %508, %510
  ...
  br i1 %514, label %515, label %510, !llvm.loop !41
...
515:                                              ; preds = %510, %508
  ...
  br i1 %523, label %524, label %17, !llvm.loop !46
...
38:                                               ; preds = %30
  %39 = load i32, ptr %32, align 8, !tbaa !34
...
59:                                               ; preds = %56, %50
  ...
  br i1 %61, label %62, label %43, !llvm.loop !36
...
69:                                               ; preds = %62
  %70 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
...
81:                                               ; preds = %79, %108
  ...
  %83 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
  %84 = load i64, ptr %82, align 8, !tbaa !47
  %85 = sub nsw i64 %84, %3
...
108:                                              ; preds = %95, %103, %93
  ...
  br i1 %116, label %117, label %81, !llvm.loop !50
...
125:                                              ; preds = %117, %125
  ...
  br i1 %131, label %132, label %125, !llvm.loop !51
...
16:                                               ; preds = %12
  ...
  %19 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
...
82:                                               ; preds = %74
  ...
  %85 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 2), align 16, !tbaa !6
...
92:                                               ; preds = %74, %82, %87
  ...
  store i64 %93, ptr %77, align 8, !tbaa !47
  %94 = getelementptr inbounds %struct.csa_reflist, ptr %77, i64 0, i32 1
  store ptr %70, ptr %94, align 8, !tbaa !49
  ...
  store ptr %76, ptr %96, align 8, !tbaa !39
...
!33 = !{!32, !7, i64 8}
!34 = !{!35, !12, i64 0}
!35 = !{!"rtvec_def", !12, i64 0, !8, i64 8}
!36 = distinct !{!36, !23}
!37 = !{i32 0, i32 2}
!38 = distinct !{!38, !23}
!39 = !{!40, !7, i64 24}
!40 = !{!"csa_reflist", !13, i64 0, !7, i64 8, !7, i64 16, !7, i64 24}
!41 = distinct !{!41, !23}
!42 = !{!43, !7, i64 0}
!43 = !{!"record_stack_refs_data", !7, i64 0, !7, i64 8}
!44 = !{!43, !7, i64 8}
!45 = distinct !{!45, !23}
!46 = distinct !{!46, !23}
!47 = !{!40, !13, i64 0}
