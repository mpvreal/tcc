...
25:                                               ; preds = %23, %19
  ...
  br i1 %30, label %31, label %11, !llvm.loop !24
...
define dso_local ptr @concat_copy2(ptr noundef readonly %0, ...) local_unnamed_addr #8 {
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %2) #14
  call void @llvm.va_start(ptr nonnull %2)
  %3 = load ptr, ptr @libiberty_concat_ptr, align 8, !tbaa !6
...
23:                                               ; preds = %20, %15
  ...
  br i1 %26, label %27, label %8, !llvm.loop !24
...
27:                                               ; preds = %23, %1
  ...
  call void @llvm.va_end(ptr nonnull %2)
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %2) #14
  %29 = load ptr, ptr @libiberty_concat_ptr, align 8, !tbaa !6
  ret ptr %29
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local ptr @concat(ptr noundef readonly %0, ...) local_unnamed_addr #12 {
  %2 = alloca [1 x %struct.__va_list_tag], align 16
  %3 = alloca [1 x %struct.__va_list_tag], align 16
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %2) #14
  call void @llvm.va_start(ptr nonnull %2)
...
54:                                               ; preds = %51, %46
  ...
  br i1 %57, label %58, label %39, !llvm.loop !24
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local ptr @reconcat(ptr noundef %0, ptr noundef readonly %1, ...) local_unnamed_addr #12 {
  %3 = alloca [1 x %struct.__va_list_tag], align 16
...
26:                                               ; preds = %24, %20
  ...
  br i1 %31, label %32, label %12, !llvm.loop !23
...
55:                                               ; preds = %52, %47
  ...
  br i1 %58, label %59, label %40, !llvm.loop !24
