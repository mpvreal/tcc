...
53:                                               ; preds = %55
  ...
  br i1 %54, label %69, label %55, !llvm.loop !37
...
64:                                               ; preds = %55
  ...
  %66 = tail call fastcc zeroext i8 @tree_unswitch_single_loop(ptr noundef nonnull %62, i32 noundef 0), !range !38
...
81:                                               ; preds = %83
  ...
  br i1 %82, label %98, label %83, !llvm.loop !37
...
83:                                               ; preds = %70, %81
  ...
  br i1 %91, label %81, label %92, !llvm.loop !37

92:                                               ; preds = %83
  %93 = trunc i64 %87 to i32
  %94 = tail call fastcc zeroext i8 @tree_unswitch_single_loop(ptr noundef nonnull %90, i32 noundef 0), !range !38
  %95 = or i8 %94, %72
  %96 = load i32, ptr %13, align 4, !tbaa !35
  %97 = icmp ugt i32 %96, %93
  br i1 %97, label %70, label %98, !llvm.loop !39
...
41:                                               ; preds = %29
  ...
  %43 = load ptr, ptr @compiler_params, align 8, !tbaa !6
...
59:                                               ; preds = %288, %56
  ...
  %63 = load i32, ptr %58, align 4, !tbaa !42
...
94:                                               ; preds = %91, %77
  %95 = lshr i32 %74, 16
  %96 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 47), align 8, !tbaa !6
  br label %120
...
113:                                              ; preds = %111
  ...
  %115 = and i32 %114, 255
  %116 = lshr i32 %114, 16
  %117 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 47), align 8, !tbaa !6
...
171:                                              ; preds = %166
  %172 = load i32, ptr %58, align 4, !tbaa !42
  br label %178

173:                                              ; preds = %108, %166, %161, %67, %73
  %174 = add nuw nsw i64 %68, 1
  %175 = load i32, ptr %58, align 4, !tbaa !42
  %176 = zext i32 %175 to i64
  %177 = icmp ult i64 %174, %176
  br i1 %177, label %67, label %178, !llvm.loop !49
...
189:                                              ; preds = %183
  ...
  %193 = load ptr, ptr %190, align 8, !tbaa !50
  br label %194
...
209:                                              ; preds = %203
  %210 = load i32, ptr getelementptr inbounds ([0 x i32], ptr @gss_for_code_, i64 0, i64 1), align 4, !tbaa !17
...
216:                                              ; preds = %215, %209
  ...
  %219 = load ptr, ptr %191, align 8, !tbaa !17
...
240:                                              ; preds = %236, %222
  ...
  %242 = load ptr, ptr %192, align 8, !tbaa !17
...
253:                                              ; preds = %240, %216, %203, %199, %194
  %254 = load ptr, ptr %196, align 8, !tbaa !50
  %255 = load ptr, ptr %254, align 8, !tbaa !53
  %256 = icmp eq ptr %255, null
  br i1 %256, label %269, label %257

257:                                              ; preds = %253
  %258 = load i32, ptr %255, align 8, !tbaa !55
...
290:                                              ; preds = %277
  ...
  %292 = load ptr, ptr @dump_file, align 8, !tbaa !6
  %293 = icmp eq ptr %292, null
  br i1 %293, label %300, label %294

294:                                              ; preds = %290
  %295 = load i32, ptr @dump_flags, align 4, !tbaa !21
  %296 = and i32 %295, 8
...
300:                                              ; preds = %298, %294, %290
  ...
  %301 = load ptr, ptr %291, align 8, !tbaa !6
...
307:                                              ; preds = %300
  ...
  tail call void @free_original_copy_tables() #12
  %308 = add nsw i32 %1, 1
  %309 = tail call fastcc zeroext i8 @tree_unswitch_single_loop(ptr noundef nonnull %302, i32 noundef %308), !range !38
  %310 = tail call fastcc zeroext i8 @tree_unswitch_single_loop(ptr noundef %0, i32 noundef %308), !range !38
  tail call void @free(ptr noundef nonnull %57)
  br label %305
}
...
13:                                               ; preds = %9
  %14 = load i32, ptr %11, align 8, !tbaa !55
  %15 = icmp eq i32 %14, 2
...
!39 = distinct !{!39, !23}
!40 = !{!41, !12, i64 8}
!41 = !{!"param_info", !7, i64 0, !12, i64 8, !8, i64 12, !12, i64 16, !12, i64 20, !7, i64 24}
!42 = !{!31, !12, i64 36}
!43 = !{!44, !7, i64 0}
!44 = !{!"use_optype_d", !7, i64 0, !45, i64 8}
...
!52 = !{!51, !12, i64 48}
!53 = !{!54, !7, i64 0}
!54 = !{!"basic_block_def", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !8, i64 32, !7, i64 48, !7, i64 56, !8, i64 64, !13, i64 72, !12, i64 80, !12, i64 84, !12, i64 88, !12, i64 92, !12, i64 96}
!55 = !{!56, !12, i64 0}
