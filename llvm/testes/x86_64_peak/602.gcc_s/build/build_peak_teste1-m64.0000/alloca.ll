...
define dso_local ptr @C_alloca(i64 noundef %0) local_unnamed_addr #8 {
  ...
  %3 = load i32, ptr @stack_dir, align 4, !tbaa !23
  %4 = icmp eq i32 %3, 0
...
6:                                                ; preds = %5, %1
  %7 = load ptr, ptr @last_alloca_header, align 8, !tbaa !6
  %8 = icmp eq ptr %7, null
  br i1 %8, label %26, label %9

9:                                                ; preds = %6, %23
  %10 = phi ptr [ %24, %23 ], [ %7, %6 ]
  %11 = load i32, ptr @stack_dir, align 4, !tbaa !23
...
23:                                               ; preds = %19, %13
  ...
  br i1 %25, label %26, label %9, !llvm.loop !24

26:                                               ; preds = %23, %19, %17, %13, %6
  %27 = phi ptr [ null, %6 ], [ %10, %13 ], [ %10, %17 ], [ %10, %19 ], [ null, %23 ]
  store ptr %27, ptr @last_alloca_header, align 8, !tbaa !6
  %28 = icmp eq i64 %0, 0
...
34:                                               ; preds = %29
  %35 = load ptr, ptr @last_alloca_header, align 8, !tbaa !6
  ...
  store ptr %31, ptr @last_alloca_header, align 8, !tbaa !6
...
define internal fastcc void @find_stack_direction() unnamed_addr #9 {
  ...
  %2 = load ptr, ptr @find_stack_direction.addr, align 8, !tbaa !6
  %3 = icmp eq ptr %2, null
  br i1 %3, label %4, label %5

4:                                                ; preds = %0
  store ptr %1, ptr @find_stack_direction.addr, align 8, !tbaa !6
...
7:                                                ; preds = %5
  store i32 1, ptr @stack_dir, align 4, !tbaa !23
  br label %9
