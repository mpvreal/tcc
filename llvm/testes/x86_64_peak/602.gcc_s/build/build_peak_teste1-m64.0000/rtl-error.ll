...
define dso_local void @error_for_asm(ptr nocapture noundef readonly %0, ptr noundef %1, ...) local_unnamed_addr #9 {
...
26:                                               ; preds = %2, %9, %15, %22, %25
  %27 = phi ptr [ %24, %22 ], [ null, %25 ], [ %11, %9 ], [ %6, %2 ], [ %19, %15 ]
  %28 = icmp eq ptr %27, null
  %29 = getelementptr inbounds %struct.rtx_def, ptr %27, i64 1, i32 1
  %30 = select i1 %28, ptr @input_location, ptr %29
  %31 = load i32, ptr %30, align 4, !tbaa !17
  call void @diagnostic_set_info(ptr noundef nonnull %3, ptr noundef %1, ptr noundef nonnull %4, i32 noundef %31, i32 noundef 4) #11
  %32 = load ptr, ptr @global_dc, align 8, !tbaa !6
  %33 = call zeroext i8 @diagnostic_report_diagnostic(ptr noundef %32, ptr noundef nonnull %3) #11
...
declare void @diagnostic_set_info(ptr noundef, ptr noundef, ptr noundef, i32 noundef, i32 noundef) local_unnamed_addr #3

declare zeroext i8 @diagnostic_report_diagnostic(ptr noundef, ptr noundef) local_unnamed_addr #3

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @warning_for_asm(ptr nocapture noundef readonly %0, ptr noundef %1, ...) local_unnamed_addr #9 {
  %3 = alloca %struct.diagnostic_info, align 8
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %4) #11
  call void @llvm.va_start(ptr nonnull %4)
...
26:                                               ; preds = %2, %9, %15, %22, %25
  ...
  %30 = select i1 %28, ptr @input_location, ptr %29
  %31 = load i32, ptr %30, align 4, !tbaa !17
  call void @diagnostic_set_info(ptr noundef nonnull %3, ptr noundef %1, ptr noundef nonnull %4, i32 noundef %31, i32 noundef 6) #11
  %32 = load ptr, ptr @global_dc, align 8, !tbaa !6
  %33 = call zeroext i8 @diagnostic_report_diagnostic(ptr noundef %32, ptr noundef nonnull %3) #11
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %3) #11
  call void @llvm.va_end(ptr nonnull %4)
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @_fatal_insn(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, ptr noundef %4) local_unnamed_addr #9 {
  tail call void (ptr, ...) @error(ptr noundef nonnull @.str, ptr noundef %0) #11
  ...
  tail call void @debug_rtx(ptr noundef %1) #11
  tail call void @fancy_abort(ptr noundef %2, i32 noundef %3, ptr noundef %4) #11
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @_fatal_insn_not_found(ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #9 {
  %5 = getelementptr inbounds %struct.rtx_def, ptr %0, i64 1, i32 1
  %6 = load i32, ptr %5, align 8, !tbaa !17
  %7 = icmp slt i32 %6, 0
  %8 = select i1 %7, ptr @.str.1, ptr @.str.2
  tail call void (ptr, ...) @error(ptr noundef nonnull @.str, ptr noundef nonnull %8) #11
  %9 = load ptr, ptr @global_dc, align 8, !tbaa !6
  %10 = getelementptr inbounds %struct.diagnostic_context, ptr %9, i64 0, i32 1, i64 4
  %11 = load i32, ptr %10, align 8, !tbaa !21
  %12 = add nsw i32 %11, -1
  store i32 %12, ptr %10, align 8, !tbaa !21
  tail call void @debug_rtx(ptr noundef nonnull %0) #11
  tail call void @fancy_abort(ptr noundef %1, i32 noundef %2, ptr noundef %3) #11
  ret void
}
