...
4:                                                ; preds = %1
  %5 = tail call ptr @__ctype_tolower_loc() #4
...
4:                                                ; preds = %1
  %5 = tail call ptr @__ctype_toupper_loc() #4
  %6 = load ptr, ptr %5, align 8, !tbaa !6
  %7 = sext i32 %0 to i64
  %8 = getelementptr inbounds i32, ptr %6, i64 %7
  %9 = load i32, ptr %8, align 4, !tbaa !10
...
define dso_local i32 @filename_cmp(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #2 {
