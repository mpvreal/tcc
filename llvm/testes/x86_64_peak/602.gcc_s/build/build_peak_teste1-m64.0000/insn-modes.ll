...
define dso_local void @init_adjust_machine_modes() local_unnamed_addr #8 {
  %1 = load i32, ptr @target_flags, align 4, !tbaa !21
  %2 = and i32 %1, 1
  %3 = icmp eq i32 %2, 0
  %4 = select i1 %3, i8 12, i8 16
  store i8 %4, ptr getelementptr inbounds ([87 x i8], ptr @mode_size, i64 0, i64 40), align 8, !tbaa !17
  %5 = select i1 %3, i8 4, i8 16
  %6 = shl nuw nsw i8 %4, 1
  store i8 %6, ptr getelementptr inbounds ([87 x i8], ptr @mode_size, i64 0, i64 53), align 1, !tbaa !17
  store i8 %5, ptr getelementptr inbounds ([87 x i8], ptr @mode_base_align, i64 0, i64 40), align 8, !tbaa !17
  store i8 %5, ptr getelementptr inbounds ([87 x i8], ptr @mode_base_align, i64 0, i64 53), align 1, !tbaa !17
  %7 = select i1 %3, ptr @ieee_extended_intel_96_format, ptr @ieee_extended_intel_128_format
  store ptr %7, ptr getelementptr inbounds ([7 x ptr], ptr @real_format_for_mode, i64 0, i64 2), align 16, !tbaa !6
  ret void
}
