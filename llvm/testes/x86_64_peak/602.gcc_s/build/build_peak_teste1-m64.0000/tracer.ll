...
18:                                               ; preds = %16, %12
  ...
  store i32 %60, ptr @probability_cutoff, align 4, !tbaa !21
  %61 = getelementptr inbounds %struct.param_info, ptr %55, i64 50, i32 1
  %62 = load i32, ptr %61, align 8, !tbaa !29
  %63 = mul nsw i32 %62, 100
  store i32 %63, ptr @branch_ratio_cutoff, align 4, !tbaa !21
...
73:                                               ; preds = %18, %119
  ...
  %78 = load i32, ptr %77, align 8, !tbaa !35, !noalias !36
  %79 = and i32 %78, 512
  %80 = icmp eq i32 %79, 0
...
81:                                               ; preds = %73
  ...
  %83 = load ptr, ptr %82, align 8, !tbaa !17, !noalias !36
  %84 = icmp eq ptr %83, null
  br i1 %84, label %100, label %85

85:                                               ; preds = %81
  %86 = load ptr, ptr %83, align 8, !tbaa !39, !noalias !36
  %87 = icmp eq ptr %86, null
  br i1 %87, label %100, label %88

88:                                               ; preds = %85
  %89 = load ptr, ptr %86, align 8, !tbaa !41, !noalias !36
...
91:                                               ; preds = %88, %91
  ...
  br i1 %99, label %100, label %91, !llvm.loop !46
...
108:                                              ; preds = %105
  %109 = load i32, ptr %102, align 8, !tbaa !47
  br label %119
...
110:                                              ; preds = %105
  ...
  %116 = load i32, ptr %102, align 8, !tbaa !47
  %117 = sext i32 %116 to i64
  %118 = getelementptr inbounds ptr, ptr %25, i64 %117
  store ptr %115, ptr %118, align 8, !tbaa !6
  br label %119
...
119:                                              ; preds = %110, %108, %100
  ...
  store i32 %101, ptr %122, align 4, !tbaa !21
  ...
  br i1 %136, label %137, label %73, !llvm.loop !49

137:                                              ; preds = %119
  %138 = load ptr, ptr @profile_info, align 8, !tbaa !6
...
177:                                              ; preds = %174
  ...
  store ptr null, ptr %181, align 8, !tbaa !6
...
183:                                              ; preds = %177
  ...
  br i1 %185, label %186, label %455, !llvm.loop !50

186:                                              ; preds = %183
  %187 = load i32, ptr %178, align 8, !tbaa !47
  %188 = load ptr, ptr @bb_seen, align 8, !tbaa !6
  %189 = lshr i32 %187, 6
...
202:                                              ; preds = %199
  %203 = load i32, ptr %178, align 8, !tbaa !47
...
210:                                              ; preds = %207, %243
  ...
  %213 = load ptr, ptr %211, align 8, !tbaa !52
  %214 = getelementptr i8, ptr %213, i64 80
  %215 = load i32, ptr %214, align 8, !tbaa !47
  %216 = load ptr, ptr @bb_seen, align 8, !tbaa !6
  %217 = lshr i32 %215, 6
...
256:                                              ; preds = %250, %246
  store ptr %247, ptr %33, align 8, !tbaa !6
...
259:                                              ; preds = %256, %292
  ...
  %266 = load ptr, ptr @bb_seen, align 8, !tbaa !6
  %267 = lshr i32 %265, 6
...
287:                                              ; preds = %284
  %288 = load i32, ptr %264, align 8, !tbaa !47
...
292:                                              ; preds = %287, %284
  ...
  store ptr %263, ptr %294, align 8, !tbaa !6
  %295 = call fastcc ptr @find_best_successor(ptr noundef nonnull %263)
  %296 = icmp eq ptr %295, null
  br i1 %296, label %297, label %259, !llvm.loop !56
...
306:                                              ; preds = %304, %300
  %307 = load ptr, ptr %33, align 8, !tbaa !6
...
321:                                              ; preds = %306
  ...
  %323 = load i32, ptr %310, align 8, !tbaa !47
  %324 = sext i32 %323 to i64
  %325 = getelementptr inbounds ptr, ptr %25, i64 %324
  store ptr null, ptr %325, align 8, !tbaa !6
  br label %326
...
343:                                              ; preds = %330
  ...
  store ptr null, ptr %347, align 8, !tbaa !6
  br label %348
...
348:                                              ; preds = %343, %330
  ...
  %357 = load ptr, ptr %336, align 8, !tbaa !57
  %358 = icmp eq ptr %357, null
  br i1 %358, label %391, label %359

359:                                              ; preds = %348
  %360 = load i32, ptr %357, align 8, !tbaa !58
...
365:                                              ; preds = %362
  ...
  %366 = load i32, ptr %337, align 8, !tbaa !47
  ...
  store ptr %372, ptr %1, align 8, !tbaa !6
...
389:                                              ; preds = %382, %365
  %390 = load ptr, ptr %1, align 8, !tbaa !6
...
391:                                              ; preds = %389, %362, %359, %348
  ...
  %394 = load ptr, ptr @bb_seen, align 8, !tbaa !6
...
401:                                              ; preds = %391
  ...
  store ptr %403, ptr @bb_seen, align 8, !tbaa !6
  %404 = load i32, ptr %398, align 8, !tbaa !47
  br label %405
...
426:                                              ; preds = %416
  ...
  %430 = load i32, ptr %398, align 8, !tbaa !47
  br label %431
...
439:                                              ; preds = %431
  ...
  br i1 %444, label %330, label %445, !llvm.loop !63
...
469:                                              ; preds = %461, %465
  ...
  %470 = load ptr, ptr @bb_seen, align 8, !tbaa !6
  %471 = load ptr, ptr %470, align 8, !tbaa !62
  call void @free(ptr noundef %471)
  %472 = load ptr, ptr @bb_seen, align 8, !tbaa !6
...
475:                                              ; preds = %469
  %476 = load i32, ptr @dump_flags, align 4, !tbaa !21
...
10:                                               ; preds = %7
  %11 = load i32, ptr %8, align 8, !tbaa !58
  br label %12
...
63:                                               ; preds = %46, %42, %26, %62, %52
  ...
  %65 = load i32, ptr %8, align 8, !tbaa !58
...
80:                                               ; preds = %77
  ...
  %93 = load i32, ptr @branch_ratio_cutoff, align 4, !tbaa !21
...
8:                                                ; preds = %3
  %9 = load i32, ptr %6, align 8, !tbaa !58
  br label %10
...
79:                                               ; preds = %76
  ...
  %82 = load i32, ptr @probability_cutoff, align 4, !tbaa !21
...
!28 = !{!27, !12, i64 32}
!29 = !{!30, !12, i64 8}
!30 = !{!"param_info", !7, i64 0, !12, i64 8, !8, i64 12, !12, i64 16, !12, i64 20, !7, i64 24}
!31 = !{!27, !7, i64 0}
!32 = !{!33, !7, i64 56}
...
!60 = !{!61, !12, i64 12}
!61 = !{!"simple_bitmap_def", !7, i64 0, !12, i64 8, !12, i64 12, !8, i64 16}
!62 = !{!61, !7, i64 0}
!63 = distinct !{!63, !23}
!64 = !{!53, !13, i64 56}
!65 = !{!53, !12, i64 52}
