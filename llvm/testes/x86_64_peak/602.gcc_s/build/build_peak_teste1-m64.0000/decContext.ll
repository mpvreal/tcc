...
define dso_local ptr @decContextDefault(ptr noundef returned writeonly %0, i32 noundef %1) local_unnamed_addr #8 {
  store <4 x i32> <i32 9, i32 999999999, i32 -999999999, i32 2>, ptr %0, align 4, !tbaa !17
  %3 = getelementptr inbounds %struct.decContext, ptr %0, i64 0, i32 4
  store i32 8927, ptr %3, align 4, !tbaa !25
  %4 = getelementptr inbounds %struct.decContext, ptr %0, i64 0, i32 5
...
7:                                                ; preds = %2
  store <4 x i32> <i32 7, i32 96, i32 -95, i32 3>, ptr %0, align 4, !tbaa !17
  store i32 0, ptr %3, align 4, !tbaa !25
  store i8 1, ptr %5, align 4, !tbaa !26
  br label %12

8:                                                ; preds = %2
  store <4 x i32> <i32 16, i32 384, i32 -383, i32 3>, ptr %0, align 4, !tbaa !17
  store i32 0, ptr %3, align 4, !tbaa !25
  store i8 1, ptr %5, align 4, !tbaa !26
  br label %12

9:                                                ; preds = %2
  store <4 x i32> <i32 34, i32 6144, i32 -6143, i32 3>, ptr %0, align 4, !tbaa !17
  store i32 0, ptr %3, align 4, !tbaa !25
  store i8 1, ptr %5, align 4, !tbaa !26
  br label %12

10:                                               ; preds = %2
  store i32 128, ptr %4, align 4, !tbaa !23
...
96:                                               ; preds = %93
  ...
  %99 = or i32 %98, 128
  store i32 %99, ptr %97, align 4, !tbaa !23
...
109:                                              ; preds = %106
  ...
  %112 = or i32 %111, 512
  store i32 %112, ptr %110, align 4, !tbaa !23
...
161:                                              ; preds = %158
  ...
  %164 = or i32 %163, 8192
  store i32 %164, ptr %162, align 4, !tbaa !23
...
!23 = !{!24, !12, i64 20}
!24 = !{!"", !12, i64 0, !12, i64 4, !12, i64 8, !8, i64 12, !12, i64 16, !12, i64 20, !8, i64 24}
!25 = !{!24, !12, i64 16}
!26 = !{!24, !8, i64 24}
!27 = !{!24, !8, i64 12}
