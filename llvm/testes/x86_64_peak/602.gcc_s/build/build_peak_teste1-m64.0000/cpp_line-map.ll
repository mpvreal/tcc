...
12:                                               ; preds = %10, %12
  ...
  br i1 %24, label %12, label %25, !llvm.loop !26
...
24:                                               ; preds = %20
  ...
  %37 = load i32, ptr %21, align 8, !tbaa !29
  %38 = sub i32 %37, %34
...
49:                                               ; preds = %43
  %50 = load i8, ptr %3, align 1, !tbaa !30
  %51 = icmp eq i8 %50, 0
  %52 = icmp ne i32 %1, 3
  %53 = and i1 %52, %51
...
103:                                              ; preds = %68
  %104 = add i32 %58, -1
  store i32 %104, ptr %57, align 8, !tbaa !15
  br label %165
...
105:                                              ; preds = %75, %84, %55, %60
  ...
  store i32 %8, ptr %114, align 4, !tbaa !28
  store ptr %106, ptr %47, align 8, !tbaa !25
  %115 = getelementptr inbounds %struct.line_map, ptr %45, i64 %46, i32 1
  store i32 %107, ptr %115, align 8, !tbaa !31
  ...
  store i32 %116, ptr %118, align 8, !tbaa !16
...
122:                                              ; preds = %105
  %123 = load i32, ptr %57, align 8, !tbaa !15
...
125:                                              ; preds = %122
  ...
  %127 = add i32 %123, 1
  store i32 %127, ptr %57, align 8, !tbaa !15
  %128 = getelementptr inbounds %struct.line_maps, ptr %0, i64 0, i32 6
  %129 = load i8, ptr %128, align 4, !tbaa !14
  %130 = icmp eq i8 %129, 0
  br i1 %130, label %165, label %147

131:                                              ; preds = %122
  %132 = load i32, ptr %9, align 4, !tbaa !22
  %133 = add i32 %132, -2
  %134 = getelementptr inbounds %struct.line_map, ptr %45, i64 %46, i32 3
  store i32 %133, ptr %134, align 8, !tbaa !23
  %135 = add i32 %123, 1
  store i32 %135, ptr %57, align 8, !tbaa !15
  %136 = getelementptr inbounds %struct.line_maps, ptr %0, i64 0, i32 6
  %137 = load i8, ptr %136, align 4, !tbaa !14
  %138 = icmp eq i8 %137, 0
  br i1 %138, label %165, label %139

139:                                              ; preds = %131, %139
  %140 = phi i32 [ %143, %139 ], [ %123, %131 ]
  %141 = load ptr, ptr @stderr, align 8, !tbaa !6
  %142 = tail call i32 @putc(i32 noundef 46, ptr noundef %141)
  %143 = add i32 %140, -1
  %144 = icmp eq i32 %143, 0
  br i1 %144, label %145, label %139, !llvm.loop !33

145:                                              ; preds = %139
  %146 = load ptr, ptr %47, align 8, !tbaa !25
  br label %147

147:                                              ; preds = %125, %145
  %148 = phi ptr [ %146, %145 ], [ %106, %125 ]
  %149 = load ptr, ptr @stderr, align 8, !tbaa !6
...
155:                                              ; preds = %105
  %156 = load i32, ptr %57, align 8, !tbaa !15
  %157 = add i32 %156, -1
  store i32 %157, ptr %57, align 8, !tbaa !15
...
44:                                               ; preds = %38, %44
  ...
  br i1 %47, label %49, label %44, !llvm.loop !34
...
67:                                               ; preds = %54, %61
  ...
  %76 = shl i32 %75, %51
  %77 = add i32 %76, %72
  %78 = load i32, ptr %10, align 8, !tbaa !17
  br label %89
...
94:                                               ; preds = %89
  store i32 %91, ptr %10, align 8, !tbaa !17
  br label %95

95:                                               ; preds = %94, %89
  %96 = getelementptr inbounds %struct.line_maps, ptr %0, i64 0, i32 9
  store i32 %92, ptr %96, align 8, !tbaa !19
  br label %97
...
25:                                               ; preds = %20, %25
  ...
  br i1 %37, label %25, label %38, !llvm.loop !35

38:                                               ; preds = %25, %20
  %39 = phi i32 [ %21, %20 ], [ %34, %25 ]
  store i32 %39, ptr %3, align 8, !tbaa !16
...
!11 = !{!"int", !8, i64 0}
!12 = !{!13, !11, i64 20}
!13 = !{!"line_maps", !7, i64 0, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !8, i64 28, !11, i64 32, !11, i64 36, !11, i64 40, !7, i64 48}
!14 = !{!13, !8, i64 28}
!15 = !{!13, !11, i64 24}
!16 = !{!13, !11, i64 16}
!17 = !{!13, !11, i64 32}
...
!22 = !{!13, !11, i64 12}
!23 = !{!24, !11, i64 16}
!24 = !{!"line_map", !7, i64 0, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !8, i64 21, !11, i64 22}
!25 = !{!24, !7, i64 0}
!26 = distinct !{!26, !27}
