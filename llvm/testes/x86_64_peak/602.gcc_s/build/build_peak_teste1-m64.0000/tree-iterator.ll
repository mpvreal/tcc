...
define dso_local ptr @alloc_stmt_list() local_unnamed_addr #8 {
  %1 = load ptr, ptr @stmt_list_cache, align 8, !tbaa !6
...
3:                                                ; preds = %0
  ...
  store ptr %5, ptr @stmt_list_cache, align 8, !tbaa !6
  %6 = icmp eq ptr %5, %1
...
16:                                               ; preds = %11
  ...
  %17 = load ptr, ptr @stmt_list_cache, align 8, !tbaa !6
  br label %18
...
18:                                               ; preds = %11, %16
  ...
  store ptr %0, ptr @stmt_list_cache, align 8, !tbaa !6
  ret void
}
...
21:                                               ; preds = %12
  tail call void @fancy_abort(ptr noundef nonnull @.str, i32 noundef 59, ptr noundef nonnull @.str.1) #12
  %22 = load ptr, ptr @stmt_list_cache, align 8, !tbaa !6
  br label %23
...
23:                                               ; preds = %12, %21
  ...
  store ptr %1, ptr @stmt_list_cache, align 8, !tbaa !6
...
43:                                               ; preds = %35
  ...
  store ptr %44, ptr %37, align 8, !tbaa !29
...
67:                                               ; preds = %64, %51
  ...
  store ptr %36, ptr %68, align 8, !tbaa !17
...
51:                                               ; preds = %43, %48
  ...
  store ptr %41, ptr %37, align 8, !tbaa !29
  store ptr %37, ptr %44, align 8, !tbaa !30
  br label %65
...
60:                                               ; preds = %53, %58
  ...
  store ptr %36, ptr %64, align 8, !tbaa !17
  br label %65
...
13:                                               ; preds = %3, %13
  ...
  %18 = and i64 %17, 65535
  %19 = icmp eq i64 %18, 52
  br i1 %19, label %13, label %20, !llvm.loop !32
