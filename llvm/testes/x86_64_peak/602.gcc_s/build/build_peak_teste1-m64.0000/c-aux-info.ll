...
define dso_local void @gen_aux_info_record(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) local_unnamed_addr #9 {
  ...
  %6 = load i32, ptr @flag_gen_aux_info, align 4, !tbaa !21
  %7 = icmp eq i32 %6, 0
...
8:                                                ; preds = %4
  ...
  %11 = load i32, ptr @gen_aux_info_record.compiled_from_record, align 4, !tbaa !21
  %12 = add nsw i32 %11, 1
  store i32 %12, ptr @gen_aux_info_record.compiled_from_record, align 4, !tbaa !21
  %13 = icmp eq i32 %11, 0
  br i1 %13, label %14, label %17

14:                                               ; preds = %8
  %15 = load ptr, ptr @aux_info_file, align 8, !tbaa !6
  %16 = call i64 @fwrite(ptr nonnull @.str, i64 23, i64 1, ptr %15)
  br label %17

17:                                               ; preds = %14, %8
  %18 = load ptr, ptr @aux_info_file, align 8, !tbaa !6
...
30:                                               ; preds = %17
  %31 = load ptr, ptr @aux_info_file, align 8, !tbaa !6
...
50:                                               ; preds = %42, %47
  ...
  br i1 %55, label %56, label %35, !llvm.loop !27
...
72:                                               ; preds = %69, %17
  %73 = load ptr, ptr @aux_info_file, align 8, !tbaa !6
...
28:                                               ; preds = %25, %20
  ...
  store ptr @.str.4, ptr @data_type, align 8, !tbaa !6
  %31 = and i64 %29, 65535
...
10:                                               ; preds = %8, %10
  ...
  br i1 %17, label %40, label %10, !llvm.loop !27
...
18:                                               ; preds = %8, %18
  ...
  br i1 %25, label %40, label %18, !llvm.loop !27
...
33:                                               ; preds = %26, %31
  ...
  br i1 %39, label %40, label %26, !llvm.loop !27
...
55:                                               ; preds = %48
  %56 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 38), align 16, !tbaa !6
  br label %61
...
57:                                               ; preds = %61
  ...
  %60 = icmp eq ptr %59, null
  br i1 %60, label %66, label %61, !llvm.loop !28
...
15:                                               ; preds = %11
  ...
  store ptr %19, ptr @data_type, align 8, !tbaa !6
  br label %258
...
107:                                              ; preds = %99
  %108 = load ptr, ptr @data_type, align 8, !tbaa !6
  br label %109
...
109:                                              ; preds = %107, %105
  ...
  br i1 %114, label %115, label %86, !llvm.loop !29
...
120:                                              ; preds = %119, %115
  %121 = load ptr, ptr %83, align 8, !tbaa !17
...
135:                                              ; preds = %20
  ...
  store ptr %137, ptr @data_type, align 8, !tbaa !6
  br label %258
...
146:                                              ; preds = %142, %146
  ...
  store ptr %150, ptr @data_type, align 8, !tbaa !6
  ...
  store ptr %153, ptr @data_type, align 8, !tbaa !6
  %154 = icmp eq ptr %152, null
  br i1 %154, label %155, label %146, !llvm.loop !30
...
169:                                              ; preds = %165, %169
  ...
  store ptr %173, ptr @data_type, align 8, !tbaa !6
  ...
  store ptr %176, ptr @data_type, align 8, !tbaa !6
  %177 = icmp eq ptr %175, null
  br i1 %177, label %178, label %169, !llvm.loop !31
...
192:                                              ; preds = %188
  ...
  store ptr %197, ptr @data_type, align 8, !tbaa !6
...
201:                                              ; preds = %192, %201
  ...
  store ptr %204, ptr @data_type, align 8, !tbaa !6
  ...
  store ptr %209, ptr @data_type, align 8, !tbaa !6
...
219:                                              ; preds = %20
  ...
  store ptr %223, ptr @data_type, align 8, !tbaa !6
  br label %258
...
224:                                              ; preds = %20, %20
  ...
  store ptr %228, ptr @data_type, align 8, !tbaa !6
...
248:                                              ; preds = %231
  ...
  store ptr %249, ptr @data_type, align 8, !tbaa !6
  br label %258
...
250:                                              ; preds = %20
  ...
  store ptr %254, ptr @data_type, align 8, !tbaa !6
  br label %258

255:                                              ; preds = %20
  store ptr @.str.25, ptr @data_type, align 8, !tbaa !6
  br label %258

256:                                              ; preds = %20
  store ptr @.str.26, ptr @data_type, align 8, !tbaa !6
  br label %258
...
define internal fastcc ptr @affix_data_type(ptr noundef %0) unnamed_addr #9 {
  ...
  %3 = add i64 %2, 1
  store i64 %3, ptr @libiberty_len, align 8, !tbaa !32
  %4 = alloca i8, i64 %3, align 16
  store ptr %4, ptr @libiberty_nptr, align 8, !tbaa !6
