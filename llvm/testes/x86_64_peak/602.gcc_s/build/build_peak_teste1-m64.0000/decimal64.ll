...
17:                                               ; preds = %3
  ...
  %19 = load i8, ptr %18, align 4, !tbaa !14
  br label %34
...
20:                                               ; preds = %3
  ...
  %27 = load i8, ptr %26, align 4, !tbaa !14
  %28 = and i8 %27, -128
  %29 = getelementptr inbounds %struct.decNumber, ptr %4, i64 0, i32 2
  %30 = load i8, ptr %29, align 4, !tbaa !14
  %31 = or i8 %30, %28
  store i8 %31, ptr %29, align 4, !tbaa !14
...
55:                                               ; preds = %45, %79
  ...
  %61 = load i16, ptr %59, align 2, !tbaa !18
  %62 = add nsw i32 %57, -3
...
72:                                               ; preds = %55
  ...
  %75 = sub i32 32, %60
  %76 = lshr i32 %67, %75
  %77 = load i32, ptr %73, align 4, !tbaa !20
  %78 = or i32 %77, %76
...
125:                                              ; preds = %117
  ...
  %126 = load i32, ptr %37, align 4, !tbaa !13
...
129:                                              ; preds = %125, %129
  ...
  br i1 %141, label %129, label %142, !llvm.loop !22

142:                                              ; preds = %129
  %143 = load i32, ptr %7, align 16, !tbaa !20
  ...
  %150 = shl i32 %147, 20
  %151 = or i32 %150, %149
  store i32 %151, ptr %6, align 8, !tbaa !20
...
153:                                              ; preds = %142
  ...
  %160 = load i32, ptr %159, align 16, !tbaa !20
  %161 = shl i32 %160, 8
  %162 = or i32 %161, %158
  br label %163
...
187:                                              ; preds = %177, %183, %112
  ...
  %196 = or i32 %193, %195
  %197 = load i8, ptr %38, align 4, !tbaa !14
  br label %198
...
198:                                              ; preds = %42, %91, %89, %187
  ...
  %205 = load i32, ptr %6, align 8, !tbaa !20
...
91:                                               ; preds = %79
  ...
  store i16 %93, ptr %81, align 2, !tbaa !18
  br label %94
...
106:                                              ; preds = %101
  store i16 %103, ptr %102, align 2, !tbaa !18
...
119:                                              ; preds = %119, %117
  ...
  store <16 x i16> zeroinitializer, ptr %123, align 2, !tbaa !18
  %124 = getelementptr i16, ptr %122, i64 -31
  store <16 x i16> zeroinitializer, ptr %124, align 2, !tbaa !18
  %125 = getelementptr i16, ptr %122, i64 -47
  store <16 x i16> zeroinitializer, ptr %125, align 2, !tbaa !18
  %126 = getelementptr i16, ptr %122, i64 -63
  store <16 x i16> zeroinitializer, ptr %126, align 2, !tbaa !18
  %127 = add nuw i64 %120, 64
  %128 = icmp eq i64 %127, %118
  br i1 %128, label %129, label %119, !llvm.loop !26
...
142:                                              ; preds = %142, %136
  ...
  store <8 x i16> zeroinitializer, ptr %145, align 2, !tbaa !18
  %146 = add nuw i64 %143, 8
  %147 = icmp eq i64 %146, %138
  br i1 %147, label %148, label %142, !llvm.loop !30
...
152:                                              ; preds = %150, %152
  ...
  store i16 0, ptr %153, align 2, !tbaa !18
  %154 = getelementptr inbounds i16, ptr %153, i64 -1
  %155 = icmp ult ptr %154, %4
  br i1 %155, label %156, label %152, !llvm.loop !31
...
162:                                              ; preds = %158
  %163 = load i32, ptr %1, align 4, !tbaa !20
  br label %164
...
164:                                              ; preds = %162, %188
  ...
  %170 = load i16, ptr %168, align 2, !tbaa !18
  ...
  %177 = shl i32 %176, %169
  %178 = or i32 %177, %165
  store i32 %178, ptr %167, align 4, !tbaa !20
...
181:                                              ; preds = %164
  ...
  %186 = load i32, ptr %182, align 4, !tbaa !20
  %187 = or i32 %186, %185
  store i32 %187, ptr %182, align 4, !tbaa !20
  br label %188
...
188:                                              ; preds = %164, %181
  ...
  br i1 %192, label %164, label %193, !llvm.loop !21
...
12:                                               ; preds = %2
  ...
  store i8 -128, ptr %13, align 4, !tbaa !14
  br label %14
...
22:                                               ; preds = %18
  ...
  %25 = or i8 %24, 64
  store i8 %25, ptr %23, align 4, !tbaa !14
  br label %183
...
73:                                               ; preds = %69, %64
  ...
  store i16 %74, ptr %66, align 2, !tbaa !18
...
97:                                               ; preds = %93, %89
  ...
  store i16 %98, ptr %86, align 2, !tbaa !18
  %100 = getelementptr inbounds %struct.decNumber, ptr %1, i64 0, i32 3, i64 3
  %101 = and i32 %65, 6
  %102 = icmp eq i32 %101, 2
  br i1 %102, label %167, label %103, !llvm.loop !32
...
130:                                              ; preds = %126, %121
  ...
  store i16 %131, ptr %118, align 2, !tbaa !18
  %133 = getelementptr inbounds %struct.decNumber, ptr %1, i64 0, i32 3, i64 5
  %134 = and i32 %65, 6
  %135 = icmp eq i32 %134, 4
  br i1 %135, label %167, label %136, !llvm.loop !32
...
164:                                              ; preds = %160, %151
  ...
  store i16 %165, ptr %148, align 2, !tbaa !18
  br label %167
...
167:                                              ; preds = %164, %145, %130, %115, %97, %83
  ...
  %174 = mul i32 %173, 3
  %175 = add i32 %174, 1
  store i32 %175, ptr %1, align 4, !tbaa !13
  %176 = load i16, ptr %168, align 2, !tbaa !18
  %177 = icmp ult i16 %176, 10
  br i1 %177, label %183, label %178

178:                                              ; preds = %167
  %179 = add i32 %174, 2
  store i32 %179, ptr %1, align 4, !tbaa !13
...
37:                                               ; preds = %26, %33
  ...
  store i16 %38, ptr %14, align 2, !tbaa !18
  %40 = getelementptr inbounds i16, ptr %14, i64 1
  %41 = icmp ugt i32 %10, 1
  br i1 %41, label %8, label %42, !llvm.loop !32
...
42:                                               ; preds = %37, %3
  ...
  %49 = mul i32 %48, 3
  %50 = add i32 %49, 1
  store i32 %50, ptr %0, align 4, !tbaa !13
  %51 = load i16, ptr %43, align 2, !tbaa !18
  %52 = icmp ult i16 %51, 10
  br i1 %52, label %58, label %53

53:                                               ; preds = %42
  %54 = add i32 %49, 2
  store i32 %54, ptr %0, align 4, !tbaa !13
  %55 = icmp ult i16 %51, 100
  br i1 %55, label %58, label %56

56:                                               ; preds = %53
  %57 = add i32 %49, 3
  store i32 %57, ptr %0, align 4, !tbaa !13
  br label %58
...
25:                                               ; preds = %22
  ...
  store i8 115, ptr %10, align 1, !tbaa !23
  br label %27
...
44:                                               ; preds = %33, %27
  ...
  %55 = load i8, ptr %54, align 4, !tbaa !23
  %56 = icmp eq i8 %55, 0
...
57:                                               ; preds = %33
  ...
  store i8 %61, ptr %10, align 1, !tbaa !23
  %63 = lshr i32 %5, 8
  %64 = and i32 %63, 1023
...
100:                                              ; preds = %81
  %101 = load i8, ptr %94, align 4, !tbaa !23
...
134:                                              ; preds = %103, %119
  ...
  %136 = load i8, ptr %135, align 4, !tbaa !23
...
202:                                              ; preds = %173, %188
  ...
  %204 = load i8, ptr %203, align 4, !tbaa !23
...
216:                                              ; preds = %202, %213
  ...
  store i8 48, ptr %82, align 1, !tbaa !23
  br label %218
...
242:                                              ; preds = %240, %242
  ...
  br i1 %248, label %249, label %242, !llvm.loop !33

249:                                              ; preds = %242, %240
  %250 = phi ptr [ %219, %240 ], [ %247, %242 ]
  store i8 46, ptr %250, align 1, !tbaa !23
...
255:                                              ; preds = %252
  ...
  store i8 69, ptr %253, align 1, !tbaa !23
  %257 = getelementptr inbounds i8, ptr %253, i64 2
  store i8 43, ptr %256, align 1, !tbaa !23
  %258 = icmp slt i32 %233, 0
  br i1 %258, label %259, label %261

259:                                              ; preds = %255
  store i8 45, ptr %256, align 1, !tbaa !23
...
261:                                              ; preds = %259, %255
  ...
  %267 = load i8, ptr %265, align 4, !tbaa !23
...
306:                                              ; preds = %306, %304
  ...
  %313 = load <16 x i8>, ptr %312, align 1, !tbaa !23
  %314 = getelementptr i8, ptr %311, i64 -31
  %315 = load <16 x i8>, ptr %314, align 1, !tbaa !23
  %316 = getelementptr i8, ptr %311, i64 -47
  %317 = load <16 x i8>, ptr %316, align 1, !tbaa !23
  %318 = getelementptr i8, ptr %311, i64 -63
  %319 = load <16 x i8>, ptr %318, align 1, !tbaa !23
  %320 = getelementptr i8, ptr %309, i64 -15
  store <16 x i8> %313, ptr %320, align 1, !tbaa !23
  %321 = getelementptr i8, ptr %309, i64 -31
  store <16 x i8> %315, ptr %321, align 1, !tbaa !23
  %322 = getelementptr i8, ptr %309, i64 -47
  store <16 x i8> %317, ptr %322, align 1, !tbaa !23
  %323 = getelementptr i8, ptr %309, i64 -63
  store <16 x i8> %319, ptr %323, align 1, !tbaa !23
  %324 = add nuw i64 %307, 64
  %325 = icmp eq i64 %324, %305
  br i1 %325, label %326, label %306, !llvm.loop !34
...
344:                                              ; preds = %344, %335
  ...
  %349 = load <8 x i8>, ptr %348, align 1, !tbaa !23
  %350 = getelementptr i8, ptr %343, i64 %346
  store <8 x i8> %349, ptr %350, align 1, !tbaa !23
  %351 = add nuw i64 %345, 8
  %352 = icmp eq i64 %351, %337
  br i1 %352, label %353, label %344, !llvm.loop !35
...
358:                                              ; preds = %355, %358
  ...
  br i1 %364, label %365, label %358, !llvm.loop !36

365:                                              ; preds = %358, %326, %353, %275
  %366 = getelementptr inbounds i8, ptr %82, i64 1
  store i8 48, ptr %82, align 1, !tbaa !23
  store i8 46, ptr %366, align 1, !tbaa !23
...
368:                                              ; preds = %365
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %369, i8 48, i64 %372, i1 false), !tbaa !23
  br label %373
...
define dso_local ptr @decimal64FromNumber(ptr noundef returned %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #4 {
  ...
  store i64 %8, ptr %0, align 1, !tbaa !23
...
define dso_local ptr @decimal64FromString(ptr noundef returned %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #4 {
  ...
  store i64 %15, ptr %0, align 1, !tbaa !23
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %4) #12
...
!24 = distinct !{!24, !7}
!25 = distinct !{!25, !7}
!26 = distinct !{!26, !7, !27, !28, !29}
!27 = !{!"llvm.loop.peeled.count", i32 1}
!28 = !{!"llvm.loop.isvectorized", i32 1}
!29 = !{!"llvm.loop.unroll.runtime.disable"}
!30 = distinct !{!30, !7, !27, !28, !29}
!31 = distinct !{!31, !7, !27, !29, !28}
!32 = distinct !{!32, !7}
!33 = distinct !{!33, !7}
!34 = distinct !{!34, !7, !28, !29}
!35 = distinct !{!35, !7, !28, !29}
!36 = distinct !{!36, !7, !28}
