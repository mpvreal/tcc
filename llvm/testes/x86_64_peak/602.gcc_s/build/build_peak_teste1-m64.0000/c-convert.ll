...
define dso_local ptr @convert(ptr noundef %0, ptr noundef %1) local_unnamed_addr #8 {
...
11:                                               ; preds = %2
  %12 = getelementptr inbounds %struct.tree_exp, ptr %1, i64 0, i32 1
...
24:                                               ; preds = %20
  %25 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 89), align 8, !tbaa !24
  %26 = tail call ptr %25(ptr noundef %22, ptr noundef nonnull %0) #9
  %27 = icmp eq ptr %26, null
  br i1 %27, label %30, label %28

28:                                               ; preds = %24
  tail call void (ptr, ...) @error(ptr noundef nonnull %26) #9
...
33:                                               ; preds = %30
  %34 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 95), align 8, !tbaa !36
  %35 = tail call ptr %34(ptr noundef nonnull %0, ptr noundef nonnull %1) #9
...
39:                                               ; preds = %37, %47
  %40 = phi ptr [ %45, %47 ], [ %1, %37 ]
  %41 = load i64, ptr %40, align 8
  %42 = trunc i64 %41 to i16
  switch i16 %42, label %53 [
    i16 116, label %43
    i16 113, label %43
    i16 117, label %43
  ]
...
47:                                               ; preds = %43
  %48 = getelementptr inbounds %struct.tree_common, ptr %40, i64 0, i32 2
  %49 = load ptr, ptr %48, align 8, !tbaa !17
  %50 = getelementptr inbounds %struct.tree_common, ptr %45, i64 0, i32 2
  %51 = load ptr, ptr %50, align 8, !tbaa !17
  %52 = icmp eq ptr %49, %51
  br i1 %52, label %39, label %53, !llvm.loop !37

53:                                               ; preds = %39, %43, %47
  %54 = getelementptr inbounds %struct.tree_type, ptr %0, i64 0, i32 16
...
60:                                               ; preds = %53
  %61 = tail call ptr @fold_convert_loc(i32 noundef %15, ptr noundef nonnull %0, ptr noundef nonnull %1) #9
  br label %99

62:                                               ; preds = %53
  %63 = load i64, ptr %56, align 8
  %64 = trunc i64 %63 to i16
  switch i16 %64, label %67 [
    i16 0, label %99
    i16 19, label %65
  ]

65:                                               ; preds = %62
  tail call void (ptr, ...) @error(ptr noundef nonnull @.str) #9
  %66 = load ptr, ptr @global_trees, align 16, !tbaa !6
  br label %99

67:                                               ; preds = %62
  switch i16 %4, label %97 [
    i16 19, label %68
    i16 8, label %70
    i16 6, label %70
    i16 7, label %72
...
68:                                               ; preds = %67
  %69 = tail call ptr @fold_convert_loc(i32 noundef %15, ptr noundef nonnull %0, ptr noundef nonnull %40) #9
  br label %99

70:                                               ; preds = %67, %67
  %71 = tail call ptr @convert_to_integer(ptr noundef nonnull %0, ptr noundef nonnull %40) #9
  br label %90

72:                                               ; preds = %67
  %73 = load i32, ptr @input_location, align 4, !tbaa !21
  %74 = tail call ptr @c_objc_common_truthvalue_conversion(i32 noundef %73, ptr noundef nonnull %1) #9
  %75 = tail call ptr @fold_convert_loc(i32 noundef %15, ptr noundef nonnull %0, ptr noundef %74) #9
  br label %99

76:                                               ; preds = %67, %67
  %77 = tail call ptr @convert_to_pointer(ptr noundef nonnull %0, ptr noundef nonnull %40) #9
  br label %90

78:                                               ; preds = %67
  %79 = tail call ptr @convert_to_real(ptr noundef nonnull %0, ptr noundef nonnull %40) #9
  br label %90

80:                                               ; preds = %67
  %81 = tail call ptr @convert_to_fixed(ptr noundef nonnull %0, ptr noundef nonnull %40) #9
  br label %90

82:                                               ; preds = %67
  %83 = tail call ptr @convert_to_complex(ptr noundef nonnull %0, ptr noundef nonnull %40) #9
  br label %90

84:                                               ; preds = %67
  %85 = tail call ptr @convert_to_vector(ptr noundef nonnull %0, ptr noundef nonnull %40) #9
  br label %90

86:                                               ; preds = %67, %67
  %87 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 24), align 8, !tbaa !38
  %88 = tail call i32 %87(ptr noundef nonnull %0, ptr noundef nonnull %56) #9
  %89 = icmp eq i32 %88, 0
  br i1 %89, label %97, label %99

90:                                               ; preds = %84, %82, %80, %78, %76, %70
  %91 = phi ptr [ %85, %84 ], [ %83, %82 ], [ %81, %80 ], [ %79, %78 ], [ %77, %76 ], [ %71, %70 ]
  %92 = load i64, ptr %91, align 8
  %93 = and i64 %92, 65535
  %94 = icmp eq i64 %93, 189
  br i1 %94, label %99, label %95

95:                                               ; preds = %90
  %96 = tail call ptr @fold(ptr noundef nonnull %91) #9
  br label %99

97:                                               ; preds = %67, %86
  tail call void (ptr, ...) @error(ptr noundef nonnull @.str.1) #9
  %98 = load ptr, ptr @global_trees, align 16, !tbaa !6
  br label %99

99:                                               ; preds = %62, %14, %20, %90, %95, %86, %33, %30, %97, %72, %68, %65, %60, %28
  %100 = phi ptr [ %29, %28 ], [ %61, %60 ], [ %66, %65 ], [ %98, %97 ], [ %75, %72 ], [ %69, %68 ], [ %1, %30 ], [ %35, %33 ], [ %40, %86 ], [ %96, %95 ], [ %91, %90 ], [ %16, %20 ], [ %16, %14 ], [ %38, %62 ]
  ret ptr %100
}
...
declare ptr @convert_to_integer(ptr noundef, ptr noundef) local_unnamed_addr #3

declare ptr @c_objc_common_truthvalue_conversion(i32 noundef, ptr noundef) local_unnamed_addr #3

declare ptr @convert_to_pointer(ptr noundef, ptr noundef) local_unnamed_addr #3

declare ptr @convert_to_real(ptr noundef, ptr noundef) local_unnamed_addr #3

declare ptr @convert_to_fixed(ptr noundef, ptr noundef) local_unnamed_addr #3

declare ptr @convert_to_complex(ptr noundef, ptr noundef) local_unnamed_addr #3

declare ptr @convert_to_vector(ptr noundef, ptr noundef) local_unnamed_addr #3
