...
define dso_local void @sha1_init_ctx(ptr nocapture noundef writeonly %0) local_unnamed_addr #5 {
  store <8 x i32> <i32 1732584193, i32 -271733879, i32 -1732584194, i32 271733878, i32 -1009589776, i32 0, i32 0, i32 0>, ptr %0, align 4, !tbaa !21
  ret void
}
...
13:                                               ; preds = %2, %11
  ...
  %33 = or <2 x i32> %31, %32
  store <2 x i32> %33, ptr %20, align 4, !tbaa !21
  ...
  %39 = load i32, ptr %0, align 4, !tbaa !22
...
define dso_local void @sha1_process_block(ptr noundef readonly %0, i64 noundef %1, ptr nocapture noundef %2) local_unnamed_addr #7 {
  ...
  %8 = load <4 x i32>, ptr %7, align 4, !tbaa !21
...
22:                                               ; preds = %19, %22
  ...
  store i32 %1034, ptr %2, align 4, !tbaa !22
  ...
  store <4 x i32> %1039, ptr %7, align 4, !tbaa !21
  %1040 = icmp ult ptr %73, %5
  br i1 %1040, label %22, label %1041, !llvm.loop !29
...
define dso_local i32 @sha1_stream(ptr nocapture noundef %0, ptr noundef %1) local_unnamed_addr #10 {
  ...
  store <8 x i32> <i32 1732584193, i32 -271733879, i32 -1732584194, i32 271733878, i32 -1009589776, i32 0, i32 0, i32 0>, ptr %3, align 4, !tbaa !21
  br label %5
...
41:                                               ; preds = %39, %41
  ...
  br i1 %46, label %41, label %55, !llvm.loop !31
...
define dso_local ptr @sha1_buffer(ptr noundef %0, i64 noundef %1, ptr noundef returned %2) local_unnamed_addr #12 {
  ...
  store <8 x i32> <i32 1732584193, i32 -271733879, i32 -1732584194, i32 271733878, i32 -1009589776, i32 0, i32 0, i32 0>, ptr %4, align 4, !tbaa !21
...
!21 = !{!12, !12, i64 0}
!22 = !{!23, !12, i64 0}
!23 = !{!"sha1_ctx", !12, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16, !8, i64 20, !12, i64 28, !8, i64 32}
!24 = !{!23, !12, i64 4}
!25 = !{!23, !12, i64 8}
!26 = !{!23, !12, i64 12}
!27 = !{!23, !12, i64 16}
