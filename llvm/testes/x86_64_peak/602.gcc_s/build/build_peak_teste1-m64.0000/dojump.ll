...
define dso_local void @init_pending_stack_adjust() local_unnamed_addr #9 {
  store i32 0, ptr @x_rtl, align 8, !tbaa !24
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @discard_pending_stack_adjust() local_unnamed_addr #10 {
  %1 = load i32, ptr @x_rtl, align 8, !tbaa !24
  %2 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 2), align 8, !tbaa !33
  %3 = sub nsw i32 %2, %1
  store i32 %3, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 2), align 8, !tbaa !33
  store i32 0, ptr @x_rtl, align 8, !tbaa !24
  ret void
}
...
3:                                                ; preds = %0
  %4 = load i32, ptr @flag_omit_frame_pointer, align 4, !tbaa !21
  %5 = icmp eq i32 %4, 0
...
12:                                               ; preds = %6, %3
  %13 = load i32, ptr @x_rtl, align 8, !tbaa !24
  %14 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 2), align 8, !tbaa !33
  %15 = sub nsw i32 %14, %13
  store i32 %15, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 2), align 8, !tbaa !33
  store i32 0, ptr @x_rtl, align 8, !tbaa !24
  br label %16
...
define dso_local void @do_pending_stack_adjust() local_unnamed_addr #12 {
  %1 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 1), align 4, !tbaa !34
  %2 = icmp eq i32 %1, 0
  br i1 %2, label %3, label %10

3:                                                ; preds = %0
  %4 = load i32, ptr @x_rtl, align 8, !tbaa !24
  %5 = icmp eq i32 %4, 0
...
72:                                               ; preds = %68, %63
  ...
  %76 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 1), align 4, !tbaa !34
  %77 = icmp eq i32 %76, 0
  br i1 %77, label %78, label %344

78:                                               ; preds = %72
  %79 = load i32, ptr @x_rtl, align 8, !tbaa !24
  %80 = icmp eq i32 %79, 0
...
86:                                               ; preds = %19, %19, %19, %19, %85
  ...
  %88 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 34, i32 3), align 8, !tbaa !35
...
149:                                              ; preds = %145
  ...
  br i1 %160, label %161, label %141, !llvm.loop !44
...
207:                                              ; preds = %202, %200
  ...
  %212 = tail call fastcc zeroext i8 @prefer_and_bit_test(i32 noundef %208, i32 noundef %211), !range !45
...
220:                                              ; preds = %180, %190, %193, %207, %172, %132
  %221 = load ptr, ptr %133, align 8, !tbaa !17
...
239:                                              ; preds = %235
  %240 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 34, i32 2), align 8, !tbaa !46
...
243:                                              ; preds = %239
  ...
  %247 = load ptr, ptr %226, align 8, !tbaa !17
...
274:                                              ; preds = %267
  %275 = load ptr, ptr %133, align 8, !tbaa !17
...
303:                                              ; preds = %32, %32, %32, %32, %19, %37, %120, %291, %297, %279, %285, %267, %274
  ...
  %305 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 1), align 4, !tbaa !34
  %306 = icmp eq i32 %305, 0
  br i1 %306, label %307, label %314

307:                                              ; preds = %303
  %308 = load i32, ptr @x_rtl, align 8, !tbaa !24
...
353:                                              ; preds = %344
  %354 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 1), align 4, !tbaa !34
  %355 = icmp eq i32 %354, 0
  br i1 %355, label %356, label %363

356:                                              ; preds = %353
  %357 = load i32, ptr @x_rtl, align 8, !tbaa !24
...
289:                                              ; preds = %286
  %290 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 1), align 4, !tbaa !34
  %291 = icmp eq i32 %290, 0
  br i1 %291, label %292, label %299

292:                                              ; preds = %289
  %293 = load i32, ptr @x_rtl, align 8, !tbaa !24
...
28:                                               ; preds = %25, %28
  ...
  %32 = load i32, ptr @word_mode, align 4, !tbaa !17
  ...
  br i1 %34, label %35, label %28, !llvm.loop !47
...
18:                                               ; preds = %5, %18
  ...
  %21 = load i32, ptr @word_mode, align 4, !tbaa !17
  ...
  br i1 %27, label %18, label %28, !llvm.loop !48
...
44:                                               ; preds = %42, %44
  ...
  %48 = load i32, ptr @word_mode, align 4, !tbaa !17
...
45:                                               ; preds = %44, %32
  %46 = load i32, ptr @flag_signaling_nans, align 4, !tbaa !21
  %47 = icmp eq i32 %46, 0
...
56:                                               ; preds = %52, %49
  ...
  %63 = load i8, ptr %62, align 2, !tbaa !50
  %64 = icmp eq i8 %63, 0
...
101:                                              ; preds = %99, %92
  ...
  %105 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 0, i32 1), align 4, !tbaa !34
  %106 = icmp eq i32 %105, 0
  br i1 %106, label %107, label %114

107:                                              ; preds = %101
  %108 = load i32, ptr @x_rtl, align 8, !tbaa !24
...
129:                                              ; preds = %122
  %130 = load ptr, ptr getelementptr inbounds ([129 x ptr], ptr @const_int_rtx, i64 0, i64 64), align 16, !tbaa !6
...
234:                                              ; preds = %223
  %235 = load i32, ptr @flag_signaling_nans, align 4, !tbaa !21
...
237:                                              ; preds = %234
  ...
  %243 = load i8, ptr %242, align 2, !tbaa !50
...
306:                                              ; preds = %299
  br i1 %305, label %311, label %296, !llvm.loop !56
...
311:                                              ; preds = %306, %296, %308, %307
  %312 = load ptr, ptr @dump_file, align 8, !tbaa !6
...
28:                                               ; preds = %23, %28
  ...
  %37 = load i32, ptr @word_mode, align 4, !tbaa !17
  ...
  %38 = load i32, ptr @word_mode, align 4, !tbaa !17
...
5:                                                ; preds = %2
  ...
  store ptr %11, ptr @shift_test, align 8, !tbaa !6
  br label %33

12:                                               ; preds = %2
  %13 = load ptr, ptr @and_reg, align 8, !tbaa !6
  ...
  %19 = load ptr, ptr @and_test, align 8, !tbaa !6
  %20 = load i32, ptr %19, align 8
  %21 = and i32 %20, -16711681
  %22 = or i32 %21, %16
  store i32 %22, ptr %19, align 8
  %23 = load ptr, ptr @shift_test, align 8, !tbaa !6
  %24 = load i32, ptr %23, align 8
  %25 = and i32 %24, -16711681
  %26 = or i32 %25, %16
  store i32 %26, ptr %23, align 8
  %27 = load ptr, ptr @shift_test, align 8, !tbaa !6
...
33:                                               ; preds = %12, %5
  ...
  %37 = load ptr, ptr @and_test, align 8, !tbaa !6
  ...
  %41 = load ptr, ptr @shift_test, align 8, !tbaa !6
  ...
  %45 = load ptr, ptr @and_test, align 8, !tbaa !6
  ...
  %48 = load ptr, ptr @shift_test, align 8, !tbaa !6
...
7:                                                ; preds = %4
  store i32 91, ptr %2, align 4, !tbaa !17
  store i32 94, ptr %3, align 4, !tbaa !17
  br label %45

8:                                                ; preds = %4
  store i32 91, ptr %2, align 4, !tbaa !17
  store i32 93, ptr %3, align 4, !tbaa !17
  br label %45
...
10:                                               ; preds = %4
  store i32 90, ptr %2, align 4, !tbaa !17
...
16:                                               ; preds = %4
  %17 = load i32, ptr @flag_signaling_nans, align 4, !tbaa !21
  %18 = icmp eq i32 %17, 0
...
!34 = !{!25, !12, i64 4}
!35 = !{!36, !7, i64 456}
!36 = !{!"lang_hooks", !7, i64 0, !13, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !7, i64 96, !7, i64 104, !7, i64 112, !7, i64 120, !7, i64 128, !7, i64 136, !7, i64 144, !7, i64 152, !7, i64 160, !7, i64 168, !7, i64 176, !7, i64 184, !7, i64 192, !7, i64 200, !7, i64 208, !7, i64 216, !7, i64 224, !7, i64 232, !37, i64 240, !38, i64 248, !39, i64 256, !40, i64 272, !41, i64 432, !42, i64 560, !7, i64 584, !7, i64 592, !7, i64 600, !7, i64 608, !7, i64 616, !7, i64 624, !7, i64 632, !7, i64 640, !7, i64 648, !7, i64 656, !7, i64 664, !8, i64 672}
!37 = !{!"lang_hooks_for_tree_inlining", !7, i64 0}
!38 = !{!"lang_hooks_for_callgraph", !7, i64 0}
!39 = !{!"lang_hooks_for_tree_dump", !7, i64 0, !7, i64 8}
!40 = !{!"lang_hooks_for_decls", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !7, i64 96, !7, i64 104, !7, i64 112, !7, i64 120, !7, i64 128, !7, i64 136, !7, i64 144, !7, i64 152}
!41 = !{!"lang_hooks_for_types", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !7, i64 96, !7, i64 104, !7, i64 112, !8, i64 120}
!42 = !{!"lang_hooks_for_lto", !7, i64 0, !7, i64 8, !7, i64 16}
!43 = !{!13, !13, i64 0}
!44 = distinct !{!44, !23}
!45 = !{i8 0, i8 2}
!46 = !{!36, !7, i64 448}
...
!49 = distinct !{!49, !23}
!50 = !{!51, !8, i64 46}
!51 = !{!"real_format", !7, i64 0, !7, i64 8, !12, i64 16, !12, i64 20, !12, i64 24, !12, i64 28, !12, i64 32, !12, i64 36, !12, i64 40, !8, i64 44, !8, i64 45, !8, i64 46, !8, i64 47, !8, i64 48, !8, i64 49, !8, i64 50, !8, i64 51}
!52 = !{!53, !7, i64 8}
