...
24:                                               ; preds = %20, %16
  %25 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 50), align 8, !tbaa !26
...
9:                                                ; preds = %2, %8
  %10 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 22), align 8, !tbaa !38
...
define dso_local void @write_global_declarations() local_unnamed_addr #11 {
  ...
  %1 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 33, i32 2), align 8, !tbaa !46
...
37:                                               ; preds = %33
  ...
  %42 = or i1 %40, %41
  br i1 %42, label %43, label %33, !llvm.loop !57
...
44:                                               ; preds = %33, %29, %43
  ...
  %52 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 22), align 8, !tbaa !38
...
80:                                               ; preds = %75
  ...
  %85 = or i1 %83, %84
  br i1 %85, label %86, label %75, !llvm.loop !58
...
93:                                               ; preds = %89
  ...
  br i1 %96, label %124, label %89, !llvm.loop !60

97:                                               ; preds = %86, %89
  %98 = phi ptr [ %90, %89 ], [ %76, %86 ]
  %99 = phi ptr [ null, %89 ], [ %65, %86 ]
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %4) #15
  %100 = load i32, ptr %61, align 4, !tbaa !21
...
105:                                              ; preds = %97
  %106 = load i32, ptr @flag_show_column, align 4, !tbaa !21
  %107 = icmp eq i32 %106, 0
  %108 = load ptr, ptr %0, align 8, !tbaa !53
  %109 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 22), align 8, !tbaa !38
  ...
  %113 = load i32, ptr %57, align 8, !tbaa !62
  br i1 %107, label %116, label %114

114:                                              ; preds = %105
  %115 = load i32, ptr %58, align 4, !tbaa !63
...
117:                                              ; preds = %97
  ...
  %119 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 22), align 8, !tbaa !38
...
122:                                              ; preds = %117, %116, %114
  ...
  br i1 %123, label %124, label %59, !llvm.loop !64

124:                                              ; preds = %122, %62, %93, %89, %44
  %125 = load ptr, ptr %0, align 8, !tbaa !53
...
132:                                              ; preds = %127, %130
  ...
  store ptr %133, ptr %5, align 8, !tbaa !48
  %134 = load ptr, ptr %0, align 8, !tbaa !53
  call void @pp_base_flush(ptr noundef %134) #15
  %135 = load ptr, ptr %0, align 8, !tbaa !53
  %136 = getelementptr inbounds %struct.pretty_print_info, ptr %135, i64 0, i32 1
  store ptr %16, ptr %136, align 8, !tbaa !54
...
define dso_local ptr @add_builtin_function(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr noundef %5) local_unnamed_addr #11 {
  %7 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 41), align 8, !tbaa !65
...
define dso_local ptr @add_builtin_function_ext_scope(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr noundef %5) local_unnamed_addr #11 {
  %7 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 42), align 8, !tbaa !66
  %8 = tail call fastcc ptr @add_builtin_function_common(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %7)
  ret ptr %8
}
...
define dso_local ptr @lhd_builtin_function(ptr noundef returned %0) local_unnamed_addr #11 {
  %2 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 33, i32 1), align 8, !tbaa !67
...
define dso_local void @lhd_begin_section(ptr noundef %0) local_unnamed_addr #11 {
  %2 = load ptr, ptr @saved_section, align 8, !tbaa !6
...
5:                                                ; preds = %1, %4
  %6 = load ptr, ptr @in_section, align 8, !tbaa !6
  store ptr %6, ptr @saved_section, align 8, !tbaa !6
  %7 = icmp eq ptr %6, null
  br i1 %7, label %8, label %10

8:                                                ; preds = %5
  %9 = load ptr, ptr @text_section, align 8, !tbaa !6
  store ptr %9, ptr @saved_section, align 8, !tbaa !6
  br label %10
...
define dso_local void @lhd_end_section() local_unnamed_addr #11 {
  %1 = load ptr, ptr @saved_section, align 8, !tbaa !6
  %2 = icmp eq ptr %1, null
  br i1 %2, label %4, label %3

3:                                                ; preds = %0
  tail call void @switch_to_section(ptr noundef nonnull %1) #15
  store ptr null, ptr @saved_section, align 8, !tbaa !6
  br label %4
...
!47 = distinct !{!47, !23}
!48 = !{!49, !7, i64 3568}
!49 = !{!"diagnostic_context", !7, i64 0, !8, i64 8, !8, i64 56, !8, i64 57, !8, i64 60, !8, i64 3540, !8, i64 3541, !7, i64 3544, !7, i64 3552, !7, i64 3560, !7, i64 3568, !7, i64 3576, !12, i64 3584, !8, i64 3588}
!50 = !{!51, !7, i64 48}
!51 = !{!"diagnostic_info", !52, i64 0, !12, i64 40, !12, i64 44, !7, i64 48, !8, i64 56, !12, i64 60}
!52 = !{!"", !7, i64 0, !7, i64 8, !12, i64 16, !7, i64 24, !7, i64 32}
!53 = !{!49, !7, i64 0}
!54 = !{!55, !7, i64 8}
!55 = !{!"pretty_print_info", !7, i64 0, !7, i64 8, !8, i64 16, !12, i64 20, !12, i64 24, !56, i64 28, !7, i64 40, !8, i64 48, !8, i64 49, !8, i64 50}
!56 = !{!"", !8, i64 0, !12, i64 4}
!57 = distinct !{!57, !23}
!58 = distinct !{!58, !23}
!59 = distinct !{!59, !23}
