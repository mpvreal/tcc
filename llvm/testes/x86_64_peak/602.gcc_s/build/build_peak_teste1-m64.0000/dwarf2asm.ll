...
@.str.107 = private unnamed_addr constant [22 x i8] c"\09.hidden %sDW.ref.%s\0A\00", align 1
@user_label_prefix = external local_unnamed_addr global ptr, align 8
@.str.108 = private unnamed_addr constant [8 x i8] c"\09.long\09\00", align 1
@.str.109 = private unnamed_addr constant [5 x i8] c"@GOT\00", align 1
@.str.110 = private unnamed_addr constant [8 x i8] c"@GOTOFF\00", align 1
...
30:                                               ; preds = %27, %30
  ...
  br i1 %38, label %39, label %30, !llvm.loop !24
...
20:                                               ; preds = %17, %14
  %21 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %22 = icmp ne i32 %21, 0
...
25:                                               ; preds = %20
  %26 = load ptr, ptr @asm_out_file, align 8, !tbaa !6
...
25:                                               ; preds = %18, %22, %23
  %26 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %27 = icmp ne i32 %26, 0
...
23:                                               ; preds = %16, %20, %21
  %24 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %25 = icmp ne i32 %24, 0
...
22:                                               ; preds = %15, %19, %20
  %23 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %24 = icmp ne i32 %23, 0
...
21:                                               ; preds = %14, %18, %19
  %22 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %23 = icmp ne i32 %22, 0
...
8:                                                ; preds = %6, %3
  %9 = phi i64 [ %7, %6 ], [ %1, %3 ]
  %10 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %11 = icmp ne i32 %10, 0
...
38:                                               ; preds = %36, %34
  %39 = add nuw i64 %19, 1
  %40 = icmp eq i64 %39, %9
  br i1 %40, label %41, label %18, !llvm.loop !26
...
70:                                               ; preds = %66
  ...
  br i1 %72, label %66, label %73, !llvm.loop !27
...
86:                                               ; preds = %82, %83
  ...
  %89 = load i8, ptr %54, align 1, !tbaa !17
  %90 = icmp eq i8 %89, 0
...
114:                                              ; preds = %110, %86
  %115 = load ptr, ptr @asm_out_file, align 8, !tbaa !6
...
121:                                              ; preds = %118, %117
  %122 = load i8, ptr %54, align 1, !tbaa !17
...
132:                                              ; preds = %121
  %133 = load ptr, ptr @asm_out_file, align 8, !tbaa !6
...
142:                                              ; preds = %128, %132, %136, %114
  ...
  br i1 %146, label %53, label %147, !llvm.loop !29
...
149:                                              ; preds = %147
  %150 = load ptr, ptr @asm_out_file, align 8, !tbaa !6
...
2:                                                ; preds = %2, %1
  ...
  br i1 %7, label %8, label %2, !llvm.loop !30
...
11:                                               ; preds = %2
  ...
  %14 = icmp ne i32 %8, 0
  %15 = and i1 %13, %14
  br i1 %15, label %16, label %2, !llvm.loop !31
...
define dso_local void @dw2_asm_output_data_uleb128(i64 noundef %0, ptr noundef readonly %1, ...) local_unnamed_addr #10 {
  ...
  %6 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %7 = icmp ne i32 %6, 0
...
define dso_local void @dw2_asm_output_delta_uleb128(ptr noundef %0, ptr noundef %1, ptr noundef readonly %2, ...) local_unnamed_addr #9 {
  ...
  %11 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
  %12 = icmp ne i32 %11, 0
...
define dso_local ptr @dw2_force_const_mem(ptr nocapture noundef readonly %0, i8 noundef zeroext %1) local_unnamed_addr #9 {
  ...
  %4 = load ptr, ptr @indirect_pool, align 8, !tbaa !6
...
6:                                                ; preds = %2
  ...
  store ptr %7, ptr @indirect_pool, align 8, !tbaa !6
  br label %8
...
13:                                               ; preds = %8
  ...
  %14 = load ptr, ptr @indirect_pool, align 8, !tbaa !6
  br label %15
...
26:                                               ; preds = %15
  %27 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 52), align 8, !tbaa !34
...
42:                                               ; preds = %26
  ...
  %43 = load i32, ptr @dw2_const_labelno, align 4, !tbaa !21
  ...
  %45 = load i32, ptr @dw2_const_labelno, align 4, !tbaa !21
  %46 = add nsw i32 %45, 1
  store i32 %46, ptr @dw2_const_labelno, align 4, !tbaa !21
...
59:                                               ; preds = %56, %52
  %60 = load ptr, ptr @indirect_pool, align 8, !tbaa !6
...
define dso_local void @dw2_output_indirect_constants() local_unnamed_addr #9 {
  %1 = load ptr, ptr @indirect_pool, align 8, !tbaa !6
...
23:                                               ; preds = %21, %18
  ...
  %25 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 52), align 8, !tbaa !34
...
30:                                               ; preds = %23
  %31 = load ptr, ptr @asm_out_file, align 8, !tbaa !6
  %32 = load ptr, ptr @user_label_prefix, align 8, !tbaa !6
  %33 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %31, ptr noundef nonnull @.str.107, ptr noundef %32, ptr noundef %26)
  br label %34
...
45:                                               ; preds = %32
  %46 = load ptr, ptr @asm_out_file, align 8, !tbaa !6
  %47 = call i64 @fwrite(ptr nonnull @.str.108, i64 7, i64 1, ptr %46)
  ...
  %51 = icmp eq i32 %37, 0
  %52 = select i1 %51, ptr @.str.110, ptr @.str.109
...
82:                                               ; preds = %77, %81
  %83 = load ptr, ptr @global_rtl, align 16, !tbaa !6
...
102:                                              ; preds = %99, %98, %94, %75, %74, %70, %45, %101, %43
  %103 = load i32, ptr @flag_debug_asm, align 4, !tbaa !21
...
112:                                              ; preds = %107, %102
  %113 = load ptr, ptr @asm_out_file, align 8, !tbaa !6
...
!34 = !{!35, !7, i64 1136}
!35 = !{!"gcc_target", !36, i64 0, !38, i64 368, !39, i64 664, !12, i64 744, !7, i64 752, !7, i64 760, !7, i64 768, !7, i64 776, !7, i64 784, !7, i64 792, !7, i64 800, !7, i64 808, !7, i64 816, !7, i64 824, !7, i64 832, !7, i64 840, !7, i64 848, !7, i64 856, !7, i64 864, !7, i64 872, !7, i64 880, !7, i64 888, !7, i64 896, !7, i64 904, !7, i64 912, !7, i64 920, !7, i64 928, !7, i64 936, !7, i64 944, !7, i64 952, !7, i64 960, !7, i64 968, !7, i64 976, !7, i64 984, !7, i64 992, !7, i64 1000, !7, i64 1008, !7, i64 1016, !7, i64 1024, !7, i64 1032, !7, i64 1040, !7, i64 1048, !7, i64 1056, !13, i64 1064, !13, i64 1072, !7, i64 1080, !7, i64 1088, !7, i64 1096, !7, i64 1104, !7, i64 1112, !7, i64 1120, !7, i64 1128, !7, i64 1136, !7, i64 1144, !7, i64 1152, !7, i64 1160, !7, i64 1168, !40, i64 1176, !7, i64 1232, !7, i64 1240, !7, i64 1248, !7, i64 1256, !7, i64 1264, !7, i64 1272, !7, i64 1280, !7, i64 1288, !7, i64 1296, !7, i64 1304, !7, i64 1312, !7, i64 1320, !7, i64 1328, !7, i64 1336, !7, i64 1344, !7, i64 1352, !7, i64 1360, !7, i64 1368, !7, i64 1376, !7, i64 1384, !7, i64 1392, !7, i64 1400, !7, i64 1408, !7, i64 1416, !7, i64 1424, !7, i64 1432, !7, i64 1440, !7, i64 1448, !7, i64 1456, !13, i64 1464, !41, i64 1472, !7, i64 1664, !7, i64 1672, !7, i64 1680, !7, i64 1688, !7, i64 1696, !7, i64 1704, !7, i64 1712, !7, i64 1720, !7, i64 1728, !7, i64 1736, !7, i64 1744, !7, i64 1752, !7, i64 1760, !7, i64 1768, !7, i64 1776, !42, i64 1784, !43, i64 1792, !44, i64 1896, !45, i64 1968, !7, i64 2016, !8, i64 2024, !8, i64 2025, !8, i64 2026, !8, i64 2027, !8, i64 2028, !8, i64 2029, !8, i64 2030, !8, i64 2031, !8, i64 2032, !8, i64 2033, !8, i64 2034, !8, i64 2035}
!36 = !{!"asm_out", !7, i64 0, !7, i64 8, !7, i64 16, !37, i64 24, !37, i64 56, !7, i64 88, !7, i64 96, !7, i64 104, !7, i64 112, !7, i64 120, !7, i64 128, !7, i64 136, !7, i64 144, !7, i64 152, !7, i64 160, !7, i64 168, !7, i64 176, !7, i64 184, !7, i64 192, !7, i64 200, !7, i64 208, !7, i64 216, !7, i64 224, !7, i64 232, !7, i64 240, !7, i64 248, !7, i64 256, !7, i64 264, !7, i64 272, !7, i64 280, !7, i64 288, !7, i64 296, !7, i64 304, !7, i64 312, !7, i64 320, !7, i64 328, !7, i64 336, !7, i64 344, !7, i64 352, !7, i64 360}
!37 = !{!"asm_int_op", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24}
!38 = !{!"sched", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !7, i64 96, !7, i64 104, !7, i64 112, !7, i64 120, !7, i64 128, !7, i64 136, !7, i64 144, !7, i64 152, !7, i64 160, !7, i64 168, !7, i64 176, !7, i64 184, !7, i64 192, !7, i64 200, !7, i64 208, !7, i64 216, !7, i64 224, !7, i64 232, !7, i64 240, !7, i64 248, !7, i64 256, !7, i64 264, !7, i64 272, !7, i64 280, !7, i64 288}
!39 = !{!"vectorize", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72}
!40 = !{!"addr_space", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48}
!41 = !{!"calls", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !7, i64 96, !7, i64 104, !7, i64 112, !7, i64 120, !7, i64 128, !7, i64 136, !7, i64 144, !7, i64 152, !7, i64 160, !7, i64 168, !7, i64 176, !7, i64 184}
!42 = !{!"c", !7, i64 0}
!43 = !{!"cxx", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !7, i64 96}
!44 = !{!"emutls", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !8, i64 64, !8, i64 65}
!45 = !{!"target_option_hooks", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40}
!46 = !{!33, !13, i64 0}
