...
define internal zeroext i8 @gate_tree_loop() #8 {
  %1 = load i32, ptr @flag_tree_loop_optimize, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_tree_ssa_loop_im() #8 {
  %1 = load i32, ptr @flag_tree_loop_im, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_tree_predictive_commoning() #8 {
  %1 = load i32, ptr @flag_predictive_commoning, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_tree_linear_transform() #8 {
  %1 = load i32, ptr @flag_tree_loop_linear, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_graphite_transforms() #10 {
  %1 = load i32, ptr @flag_loop_block, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
...
15:                                               ; preds = %0
  %16 = load i32, ptr @flag_graphite, align 4, !tbaa !21
  %17 = icmp ne i32 %16, 0
  %18 = zext i1 %17 to i8
  br label %20

19:                                               ; preds = %0
  store i32 1, ptr @flag_graphite, align 4, !tbaa !21
  br label %20
...
define internal zeroext i8 @gate_check_data_deps() #8 {
  %1 = load i32, ptr @flag_check_data_deps, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_tree_ssa_loop_ivcanon() #8 {
  %1 = load i32, ptr @flag_tree_loop_ivcanon, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_scev_const_prop() #8 {
  %1 = load i32, ptr @flag_tree_scev_cprop, align 4, !tbaa !21
  %2 = trunc i32 %1 to i8
  ret i8 %2
}
...
define internal zeroext i8 @gate_tree_parallelize_loops() #8 {
  %1 = load i32, ptr @flag_tree_parallelize_loops, align 4, !tbaa !21
  %2 = icmp sgt i32 %1, 1
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_tree_ssa_loop_prefetch() #8 {
  %1 = load i32, ptr @flag_prefetch_loop_arrays, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
define internal zeroext i8 @gate_tree_ssa_loop_ivopts() #8 {
  %1 = load i32, ptr @flag_ivopts, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
