...
@pass_slp_vectorize = dso_local local_unnamed_addr global %struct.gimple_opt_pass { %struct.opt_pass { i32 0, ptr @.str.6, ptr @gate_vect_slp, ptr @execute_vect_slp, ptr null, ptr null, i32 0, i32 90, i32 40, i32 0, i32 0, i32 0, i32 2071 } }, align 8
@.str.6 = private unnamed_addr constant [4 x i8] c"slp\00", align 1
...
@.str.7 = private unnamed_addr constant [34 x i8] c"basic block vectorized using SLP\0A\00", align 1
@pass_ipa_increase_alignment = dso_local local_unnamed_addr global %struct.simple_ipa_opt_pass { %struct.opt_pass { i32 2, ptr @.str.8, ptr @gate_increase_alignment, ptr @increase_alignment, ptr null, ptr null, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0 } }, align 8
@.str.8 = private unnamed_addr constant [19 x i8] c"increase_alignment\00", align 1
...
define dso_local void @vect_set_verbosity_level(ptr noundef %0) local_unnamed_addr #8 {
  ...
  store i32 %4, ptr @user_vect_verbosity_level, align 4, !tbaa !17
  ret void
}
...
define dso_local zeroext i8 @vect_print_dump_info(i32 noundef %0) local_unnamed_addr #8 {
  ...
  %8 = load i32, ptr @vect_verbosity_level, align 4, !tbaa !17
  %9 = icmp ult i32 %8, %0
...
16:                                               ; preds = %10
  %17 = load i32, ptr @vect_location, align 4, !tbaa !21
  %18 = icmp eq i32 %17, 0
...
26:                                               ; preds = %16
  ...
  %28 = load i32, ptr @vect_location, align 4, !tbaa !21
...
12:                                               ; preds = %9
  ...
  store ptr %13, ptr @vect_dump, align 8, !tbaa !6
  %14 = load i32, ptr @user_vect_verbosity_level, align 4, !tbaa !17
  %15 = icmp eq i32 %14, 10
  br i1 %15, label %31, label %16

16:                                               ; preds = %12
  store i32 %14, ptr @vect_verbosity_level, align 4, !tbaa !17
...
29:                                               ; preds = %16
  ...
  store ptr %30, ptr @vect_dump, align 8, !tbaa !6
  br label %46
...
39:                                               ; preds = %35
  store i32 9, ptr @vect_verbosity_level, align 4, !tbaa !17
  br label %46
...
43:                                               ; preds = %40
  store i32 2, ptr @vect_verbosity_level, align 4, !tbaa !17
  br label %46

44:                                               ; preds = %40
  store i32 0, ptr @vect_verbosity_level, align 4, !tbaa !17
  br label %46
...
55:                                               ; preds = %51
  %56 = load i32, ptr %53, align 8, !tbaa !31
  br label %57
...
69:                                               ; preds = %65
  %70 = load i32, ptr %59, align 4, !tbaa !38
  %71 = add i32 %70, 1
  store i32 %71, ptr %59, align 4, !tbaa !38
...
89:                                               ; preds = %85
  %90 = load i32, ptr %87, align 8, !tbaa !31
  %91 = icmp eq i32 %90, 0
...
92:                                               ; preds = %89
  ...
  br i1 %97, label %98, label %80, !llvm.loop !43
...
101:                                              ; preds = %98
  %102 = load i32, ptr %59, align 4, !tbaa !38
  %103 = zext i32 %102 to i64
  %104 = icmp eq i32 %102, 0
  br i1 %104, label %160, label %105

105:                                              ; preds = %101
  %106 = load ptr, ptr %100, align 8, !tbaa !29
  br label %109

107:                                              ; preds = %109
  %108 = icmp eq i64 %113, %103
  br i1 %108, label %160, label %109, !llvm.loop !44
...
109:                                              ; preds = %105, %107
  ...
  br i1 %117, label %107, label %118, !llvm.loop !44
...
125:                                              ; preds = %118
  ...
  store i32 %126, ptr @vect_location, align 4, !tbaa !21
...
130:                                              ; preds = %125
  ...
  %132 = load i8, ptr %131, align 4, !tbaa !46
...
136:                                              ; preds = %134, %130, %125, %118
  ...
  %138 = load i32, ptr %59, align 4, !tbaa !38
...
148:                                              ; preds = %150
  ...
  br i1 %149, label %160, label %150, !llvm.loop !44
...
150:                                              ; preds = %141, %148
  ...
  br i1 %158, label %148, label %159, !llvm.loop !44
...
162:                                              ; preds = %160, %98, %46
  ...
  store i32 0, ptr @vect_location, align 4, !tbaa !21
  ...
  %165 = tail call zeroext i8 @vect_print_dump_info(i32 noundef 2), !range !49
...
169:                                              ; preds = %167
  %170 = tail call zeroext i8 @vect_print_dump_info(i32 noundef 1), !range !49
...
182:                                              ; preds = %178, %175
  tail call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 51, ptr noundef nonnull @.str.4) #13
...
207:                                              ; preds = %193, %203
  ...
  br i1 %210, label %211, label %193, !llvm.loop !55
...
define internal zeroext i8 @gate_vect_slp() #10 {
...
define internal i32 @execute_vect_slp() #8 {
  ...
  store ptr %1, ptr @vect_dump, align 8, !tbaa !6
  %2 = load i32, ptr @user_vect_verbosity_level, align 4, !tbaa !17
  %3 = icmp eq i32 %2, 10
...
28:                                               ; preds = %17, %25, %21
  ...
  store i32 %29, ptr @vect_verbosity_level, align 4, !tbaa !17
  br label %30
...
40:                                               ; preds = %30, %51
  ...
  store i32 %42, ptr @vect_location, align 4, !tbaa !21
...
45:                                               ; preds = %40
  ...
  %46 = tail call zeroext i8 @vect_print_dump_info(i32 noundef 1), !range !49
  %47 = icmp eq i8 %46, 0
  br i1 %47, label %51, label %48

48:                                               ; preds = %45
  %49 = load ptr, ptr @vect_dump, align 8, !tbaa !6
  %50 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 33, i64 1, ptr %49)
  br label %51
...
51:                                               ; preds = %40, %48, %45
  ...
  br i1 %59, label %60, label %40, !llvm.loop !62
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(read, argmem: none, inaccessiblemem: none) uwtable
define internal zeroext i8 @gate_increase_alignment() #10 {
  %1 = load i32, ptr @flag_section_anchors, align 4, !tbaa !21
  %2 = icmp ne i32 %1, 0
...
35:                                               ; preds = %21, %30, %24, %15, %11, %3
  ...
  br i1 %38, label %39, label %3, !llvm.loop !65
...
!24 = !{!25, !7, i64 0}
!25 = !{!"", !7, i64 0, !12, i64 8, !12, i64 12, !8, i64 16}
!26 = !{!25, !12, i64 8}
!27 = !{!28, !7, i64 32}
...
!45 = !{!35, !7, i64 64}
!46 = !{!47, !8, i64 36}
!47 = !{!"_loop_vec_info", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !12, i64 32, !8, i64 36, !12, i64 40, !7, i64 48, !12, i64 56, !12, i64 60, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !12, i64 96, !7, i64 104, !7, i64 112, !12, i64 120}
!48 = distinct !{!48, !23}
!49 = !{i8 0, i8 2}
!50 = !{!28, !7, i64 24}
!51 = !{!52, !7, i64 24}
!52 = !{!"gimple_df", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !53, i64 32, !53, i64 48, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !12, i64 96, !54, i64 104}
!53 = !{!"pt_solution", !12, i64 0, !12, i64 0, !12, i64 0, !12, i64 0, !12, i64 0, !12, i64 0, !7, i64 8}
!54 = !{!"ssa_operands", !7, i64 0, !12, i64 8, !12, i64 12, !8, i64 16, !7, i64 24, !7, i64 32}
!55 = distinct !{!55, !23}
!56 = !{!28, !7, i64 8}
!57 = !{!58, !7, i64 0}
