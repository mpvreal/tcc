...
@gcc_exec_prefix = dso_local local_unnamed_addr global ptr null, align 8
@stdout = external local_unnamed_addr global ptr, align 8
@stdin = external local_unnamed_addr global ptr, align 8
@cpp_include_defaults = dso_local local_unnamed_addr constant [2 x %struct.default_include] [%struct.default_include { ptr @.str, ptr null, i8 0, i8 0, i8 1, i8 0 }, %struct.default_include zeroinitializer], align 16
@.str = private unnamed_addr constant [13 x i8] c"/usr/include\00", align 1
@cpp_GCC_INCLUDE_DIR = dso_local local_unnamed_addr constant [1 x i8] zeroinitializer, align 1
@cpp_GCC_INCLUDE_DIR_len = dso_local local_unnamed_addr constant i64 0, align 8
@cpp_PREFIX = dso_local local_unnamed_addr constant [2 x i8] c".\00", align 1
@cpp_PREFIX_len = dso_local local_unnamed_addr constant i64 1, align 8
@cpp_EXEC_PREFIX = dso_local local_unnamed_addr constant [2 x i8] c".\00", align 1
@cpp_relocated.relocated = internal unnamed_addr global i32 -1, align 4
...
; Function Attrs: nofree nounwind sspstrong memory(readwrite, argmem: read, inaccessiblemem: read) uwtable
define dso_local zeroext i8 @cpp_relocated() local_unnamed_addr #8 {
  %1 = load i32, ptr @cpp_relocated.relocated, align 4, !tbaa !21
  %2 = icmp eq i32 %1, -1
  br i1 %2, label %3, label %7

3:                                                ; preds = %0
  %4 = tail call ptr @getenv(ptr noundef nonnull @.str.1)
  store ptr %4, ptr @gcc_exec_prefix, align 8, !tbaa !6
  %5 = icmp ne ptr %4, null
  %6 = zext i1 %5 to i32
  store i32 %6, ptr @cpp_relocated.relocated, align 4, !tbaa !21
  br label %7
...
attributes #8 = { nofree nounwind sspstrong memory(readwrite, argmem: read, inaccessiblemem: read) uwtable "approx-func-fp-math"="true" "denormal-fp-math"="preserve-sign,preserve-sign" "min-legal-vector-width"="0" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" "unsafe-fp-math"="true" }
