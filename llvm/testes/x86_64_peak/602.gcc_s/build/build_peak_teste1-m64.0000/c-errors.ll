...
define dso_local void @pedwarn_c99(i32 noundef %0, i32 noundef %1, ptr noundef %2, ...) local_unnamed_addr #9 {
  ...
  %6 = load i32, ptr @flag_isoc99, align 4, !tbaa !21
  %7 = icmp eq i32 %6, 0
  %8 = select i1 %7, i32 6, i32 10
  call void @diagnostic_set_info(ptr noundef nonnull %4, ptr noundef %2, ptr noundef nonnull %5, i32 noundef %0, i32 noundef %8) #11
  %9 = getelementptr inbounds %struct.diagnostic_info, ptr %4, i64 0, i32 5
  store i32 %1, ptr %9, align 4, !tbaa !24
  %10 = load ptr, ptr @global_dc, align 8, !tbaa !6
  %11 = call zeroext i8 @diagnostic_report_diagnostic(ptr noundef %10, ptr noundef nonnull %4) #11
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local void @pedwarn_c90(i32 noundef %0, i32 noundef %1, ptr noundef %2, ...) local_unnamed_addr #9 {
  %4 = alloca %struct.diagnostic_info, align 8
  %5 = alloca [1 x %struct.__va_list_tag], align 16
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %4) #11
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %5) #11
...
!24 = !{!25, !12, i64 60}
!25 = !{!"diagnostic_info", !26, i64 0, !12, i64 40, !12, i64 44, !7, i64 48, !8, i64 56, !12, i64 60}
!26 = !{!"", !7, i64 0, !7, i64 8, !12, i64 16, !7, i64 24, !7, i64 32}
