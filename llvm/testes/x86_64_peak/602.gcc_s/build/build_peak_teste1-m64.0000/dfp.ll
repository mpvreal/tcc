...
@.str.3 = private unnamed_addr constant [6 x i8] c"dfp.c\00", align 1
...
@.str.5 = private unnamed_addr constant [12 x i8] c"9.999999E96\00", align 1
@.str.6 = private unnamed_addr constant [22 x i8] c"9.999999999999999E384\00", align 1
@.str.7 = private unnamed_addr constant [41 x i8] c"9.999999999999999999999999999999999E6144\00", align 1
...
define dso_local void @encode_decimal32(ptr nocapture noundef readnone %0, ptr nocapture noundef writeonly %1, ptr noundef %2) local_unnamed_addr #9 {
  ...
  store i64 %11, ptr %1, align 8, !tbaa !29
...
10:                                               ; preds = %2
  %11 = call ptr @decNumberFromString(ptr noundef %1, ptr noundef nonnull @.str, ptr noundef nonnull %3) #13
  br label %27
...
15:                                               ; preds = %12
  %16 = call ptr @decNumberFromString(ptr noundef %1, ptr noundef nonnull @.str.1, ptr noundef nonnull %3) #13
  br label %27

17:                                               ; preds = %12
  %18 = call ptr @decNumberFromString(ptr noundef %1, ptr noundef nonnull @.str.2, ptr noundef nonnull %3) #13
  br label %27
...
22:                                               ; preds = %19
  call void @fancy_abort(ptr noundef nonnull @.str.3, i32 noundef 115, ptr noundef nonnull @.str.4) #13
  br label %23
...
36:                                               ; preds = %27
  %37 = xor i8 %32, -128
  store i8 %37, ptr %31, align 4, !tbaa !26
  br label %38
...
define dso_local void @encode_decimal64(ptr nocapture noundef readnone %0, ptr nocapture noundef writeonly %1, ptr noundef %2) local_unnamed_addr #9 {
  ...
  store <2 x i64> %11, ptr %1, align 8, !tbaa !29
  call void @llvm.lifetime.end.p0(i64 28, ptr nonnull %6) #13
...
define dso_local void @decode_decimal64(ptr nocapture noundef readnone %0, ptr noundef %1, ptr nocapture noundef readonly %2) local_unnamed_addr #9 {
  ...
  %8 = getelementptr inbounds %struct.decContext, ptr %6, i64 0, i32 4
  store i32 0, ptr %8, align 4, !tbaa !24
  %9 = load <2 x i64>, ptr %2, align 8, !tbaa !29
...
define dso_local void @encode_decimal128(ptr nocapture noundef readnone %0, ptr nocapture noundef writeonly %1, ptr noundef %2) local_unnamed_addr #9 {
  ...
  store <4 x i64> %11, ptr %1, align 8, !tbaa !29
...
define dso_local void @decode_decimal128(ptr nocapture noundef readnone %0, ptr noundef %1, ptr nocapture noundef readonly %2) local_unnamed_addr #9 {
  ...
  %8 = getelementptr inbounds %struct.decContext, ptr %6, i64 0, i32 4
  store i32 0, ptr %8, align 4, !tbaa !24
  %9 = load <4 x i64>, ptr %2, align 8, !tbaa !29
...
28:                                               ; preds = %22
  call void @fancy_abort(ptr noundef nonnull @.str.3, i32 noundef 429, ptr noundef nonnull @.str.4) #13
  br label %29
...
7:                                                ; preds = %5
  tail call void @fancy_abort(ptr noundef nonnull @.str.3, i32 noundef 467, ptr noundef nonnull @.str.4) #13
  br label %8
...
31:                                               ; preds = %29
  %32 = call fastcc zeroext i8 @decimal_do_add(ptr noundef %0, ptr noundef nonnull %22, ptr noundef %30, i32 noundef 0), !range !34
  br label %133

33:                                               ; preds = %29
  %34 = call fastcc zeroext i8 @decimal_do_add(ptr noundef %0, ptr noundef nonnull %22, ptr noundef %30, i32 noundef 1), !range !34
  br label %133
...
67:                                               ; preds = %29
  ...
  %72 = load i8, ptr %71, align 4, !tbaa !26
  %73 = and i8 %72, 48
  %74 = icmp eq i8 %73, 0
...
90:                                               ; preds = %67
  ...
  %94 = load i32, ptr %78, align 4, !tbaa !28
  br label %95
...
103:                                              ; preds = %99
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull align 8 dereferenceable(32) %30, i64 32, i1 false), !tbaa.struct !35
  br label %133
...
107:                                              ; preds = %104
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull align 8 dereferenceable(32) %22, i64 32, i1 false), !tbaa.struct !35
  br label %133
...
132:                                              ; preds = %29
  call void @fancy_abort(ptr noundef nonnull @.str.3, i32 noundef 691, ptr noundef nonnull @.str.4) #13
  br label %133
...
6:                                                ; preds = %3
  tail call void @fancy_abort(ptr noundef nonnull @.str.3, i32 noundef 718, ptr noundef nonnull @.str.4) #13
  unreachable
...
!24 = !{!25, !12, i64 16}
!25 = !{!"", !12, i64 0, !12, i64 4, !12, i64 8, !8, i64 12, !12, i64 16, !12, i64 20, !8, i64 24}
!26 = !{!27, !8, i64 8}
!27 = !{!"", !12, i64 0, !12, i64 4, !8, i64 8, !8, i64 10}
!28 = !{!25, !12, i64 20}
!29 = !{!13, !13, i64 0}
!30 = !{!14, !14, i64 0}
!31 = !{!32, !12, i64 16}
!32 = !{!"real_format", !7, i64 0, !7, i64 8, !12, i64 16, !12, i64 20, !12, i64 24, !12, i64 28, !12, i64 32, !12, i64 36, !12, i64 40, !8, i64 44, !8, i64 45, !8, i64 46, !8, i64 47, !8, i64 48, !8, i64 49, !8, i64 50, !8, i64 51}
!33 = !{!25, !8, i64 12}
!34 = !{i8 0, i8 33}
!35 = !{i64 0, i64 4, !21, i64 0, i64 4, !21, i64 0, i64 4, !21, i64 0, i64 4, !21, i64 0, i64 4, !21, i64 0, i64 4, !21, i64 8, i64 24, !17}
