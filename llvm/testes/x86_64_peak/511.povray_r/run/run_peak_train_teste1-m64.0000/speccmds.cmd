...
-o SPEC-benchmark-train.stdout -e SPEC-benchmark-train.stderr echo "../run_peak_train_teste1-m64.0000/povray_r_peak.teste1-m64 SPEC-benchmark-train.ini" > run.sh ; $BIND bash run.sh
