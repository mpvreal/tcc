; ModuleID = 'specrand-common/specrand.c'
source_filename = "specrand-common/specrand.c"
...
define dso_local void @spec_srand(i32 noundef %0) local_unnamed_addr #0 {
  %2 = zext i32 %0 to i64
  store i64 %2, ptr @mt, align 16, !tbaa !5
  br label %3
...
3:                                                ; preds = %14, %1
  ...
  store i64 %11, ptr %10, align 8, !tbaa !5
...
14:                                               ; preds = %3
  ...
  store i64 %20, ptr %19, align 8, !tbaa !5
  %21 = add nuw nsw i64 %5, 2
  br label %3

22:                                               ; preds = %3
  store i32 624, ptr @mti, align 4, !tbaa !11
  ret void
}
...
define dso_local i64 @spec_genrand_int32() local_unnamed_addr #2 {
  %1 = load i32, ptr @mti, align 4, !tbaa !11
...
10:                                               ; preds = %8
  %11 = load i64, ptr @mt, align 16, !tbaa !5
  br label %12
...
14:                                               ; preds = %8
  store i64 5489, ptr @mt, align 16, !tbaa !5
  br label %15
...
15:                                               ; preds = %26, %14
  ...
  store i64 %23, ptr %22, align 8, !tbaa !5
...
26:                                               ; preds = %15
  ...
  store i64 %32, ptr %31, align 8, !tbaa !5
  %33 = add nuw nsw i64 %17, 2
  br label %15

34:                                               ; preds = %36
  %35 = load i64, ptr getelementptr inbounds ([624 x i64], ptr @mt, i64 0, i64 227), align 8, !tbaa !5
  br label %56
...
36:                                               ; preds = %12, %36
  ...
  %53 = xor i64 %52, %48
  %54 = xor i64 %53, %49
  store i64 %54, ptr %39, align 8, !tbaa !5
  %55 = icmp eq i64 %41, 227
  br i1 %55, label %34, label %36, !llvm.loop !13
...
56:                                               ; preds = %34, %56
  ...
  %73 = xor i64 %72, %68
  %74 = xor i64 %73, %69
  store i64 %74, ptr %59, align 8, !tbaa !5
  %75 = icmp eq i64 %61, 623
  br i1 %75, label %76, label %56, !llvm.loop !14

76:                                               ; preds = %56
  %77 = load i64, ptr getelementptr inbounds ([624 x i64], ptr @mt, i64 0, i64 623), align 8, !tbaa !5
  %78 = and i64 %77, 2147483648
  %79 = load i64, ptr @mt, align 16, !tbaa !5
  %80 = and i64 %79, 2147483646
  %81 = or i64 %80, %78
  %82 = load i64, ptr getelementptr inbounds ([624 x i64], ptr @mt, i64 0, i64 396), align 16, !tbaa !5
  ...
  %87 = xor i64 %86, %82
  %88 = xor i64 %87, %83
  store i64 %88, ptr getelementptr inbounds ([624 x i64], ptr @mt, i64 0, i64 623), align 8, !tbaa !5
  br label %89

89:                                               ; preds = %3, %76
  %90 = phi i64 [ %79, %76 ], [ %6, %3 ]
  %91 = phi i32 [ 1, %76 ], [ %7, %3 ]
  store i32 %91, ptr @mti, align 4, !tbaa !11
  %92 = lshr i64 %90, 11
  %93 = xor i64 %92, %90
  %94 = shl i64 %93, 7
...
define dso_local void @spec_init_by_array(ptr nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #3 {
  store i64 19650218, ptr @mt, align 16, !tbaa !5
  br label %3
...
24:                                               ; preds = %22, %50
  ...
  store i64 %44, ptr %29, align 8, !tbaa !5
  %45 = add nsw i32 %27, 1
  %46 = add nsw i32 %26, 1
...
48:                                               ; preds = %24
  %49 = load i64, ptr getelementptr inbounds ([624 x i64], ptr @mt, i64 0, i64 623), align 8, !tbaa !5
  store i64 %49, ptr @mt, align 16, !tbaa !5
  br label %50
...
56:                                               ; preds = %50, %76
  ...
  store i64 %71, ptr %60, align 8, !tbaa !5
  %72 = add nsw i32 %58, 1
  %73 = icmp sgt i32 %58, 622
  br i1 %73, label %74, label %76

74:                                               ; preds = %56
  %75 = load i64, ptr getelementptr inbounds ([624 x i64], ptr @mt, i64 0, i64 623), align 8, !tbaa !5
  store i64 %75, ptr @mt, align 16, !tbaa !5
  br label %76
...
76:                                               ; preds = %56, %74
  ...
  %78 = add nsw i32 %57, -1
  %79 = icmp eq i32 %78, 0
  br i1 %79, label %80, label %56, !llvm.loop !16

80:                                               ; preds = %76
  store i64 2147483648, ptr @mt, align 16, !tbaa !5
  ret void
}
