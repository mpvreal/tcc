...
@.str.1 = private unnamed_addr constant [30 x i8] c"contents of stringpool \22%s\22:\0A\00", align 1
@.str.2 = private unnamed_addr constant [22 x i8] c"  \22%s\22 %p, %d ref(s)\0A\00", align 1
@stderr = external local_unnamed_addr global ptr, align 8
@.str.3 = private unnamed_addr constant [106 x i8] c"ERROR: cStringPool::get(\22%s\22) invoked outside main() -- please do not use cStringPool from global objects\00", align 1
@_ZN11cStaticFlag10staticflagE = external local_unnamed_addr global i8, align 1
@.str.4 = private unnamed_addr constant [107 x i8] c"ERROR: cStringPool::peek(\22%s\22) invoked outside main() -- please do not use cStringPool from global objects\00", align 1
@.str.5 = private unnamed_addr constant [93 x i8] c"Warning: cStringPool::release(): string \22%s\22 released too late, after main() already exited\0A\00", align 1
@.str.6 = private unnamed_addr constant [65 x i8] c"ERROR: cStringPool::release(): string %p \22%s\22 not in stringpool\0A\00", align 1
@.str.7 = private unnamed_addr constant [113 x i8] c"ERROR: cStringPool::release(): wrong string pointer %p \22%s\22, stringpool has a different copy of the same string\0A\00", align 1
...
define dso_local void @_ZNK11cStringPool4dumpEv(ptr noundef nonnull readonly align 8 dereferenceable(81) %0) local_unnamed_addr #6 align 2 {
...
5:                                                ; preds = %1
  ...
  %7 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef %6)
...
12:                                               ; preds = %5, %12
  ...
  %18 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, ptr noundef %15, ptr noundef %15, i32 noundef %17)
...
define dso_local noundef ptr @_ZN11cStringPool3getEPKc(ptr noundef nonnull align 8 dereferenceable(81) %0, ptr noundef %1) local_unnamed_addr #0 align 2 {
  ...
  %4 = load i8, ptr @_ZN11cStaticFlag10staticflagE, align 1, !tbaa !38, !range !39, !noundef !40
  %5 = icmp eq i8 %4, 0
  br i1 %5, label %6, label %18

6:                                                ; preds = %2
  %7 = load ptr, ptr @stderr, align 8, !tbaa !41
  %8 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.3, ptr noundef %1) #19
...
26:                                               ; preds = %20
  %27 = load i8, ptr %1, align 1, !tbaa !14
  br label %28
...
55:                                               ; preds = %51
  ...
  %59 = load i8, ptr %56, align 1, !tbaa !14
...
57:                                               ; preds = %52
  ...
  %62 = load i8, ptr %60, align 1, !tbaa !14
...
; Function Attrs: nofree nounwind sspstrong uwtable
define dso_local noundef ptr @_ZNK11cStringPool4peekEPKc(ptr noundef nonnull readonly align 8 dereferenceable(81) %0, ptr noundef %1) local_unnamed_addr #6 align 2 {
  %3 = load i8, ptr @_ZN11cStaticFlag10staticflagE, align 1, !tbaa !38, !range !39, !noundef !40
  %4 = icmp eq i8 %3, 0
  br i1 %4, label %5, label %8

5:                                                ; preds = %2
  %6 = load ptr, ptr @stderr, align 8, !tbaa !41
  %7 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.4, ptr noundef %1) #19
  br label %51
...
define dso_local void @_ZN11cStringPool7releaseEPKc(ptr noundef nonnull align 8 dereferenceable(81) %0, ptr noundef %1) local_unnamed_addr #13 align 2 personality ptr @__gxx_personality_v0 {
  %3 = icmp eq ptr %1, null
...
8:                                                ; preds = %2
  %9 = load i8, ptr @_ZN11cStaticFlag10staticflagE, align 1, !tbaa !38, !range !39, !noundef !40
  %10 = icmp eq i8 %9, 0
  br i1 %10, label %11, label %14

11:                                               ; preds = %8
  %12 = load ptr, ptr @stderr, align 8, !tbaa !41
  %13 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %12, ptr noundef nonnull @.str.5, ptr noundef nonnull %1) #19
  br label %72
...
54:                                               ; preds = %44, %14, %42, %51
  ...
  %56 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %55, ptr noundef nonnull @.str.6, ptr noundef nonnull %1, ptr noundef nonnull %1) #19
  br label %72
...
59:                                               ; preds = %57
  ...
  %61 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %60, ptr noundef nonnull @.str.7, ptr noundef nonnull %1, ptr noundef nonnull %1) #19
  br label %72
...
!22 = !{!16, !13, i64 32}
!23 = !{!24, !30, i64 80}
!24 = !{!"_ZTS11cStringPool", !12, i64 0, !25, i64 32, !30, i64 80}
!25 = !{!"_ZTSSt3mapIPciN11cStringPool7strlessESaISt4pairIKS0_iEEE", !26, i64 0}
!26 = !{!"_ZTSSt8_Rb_treeIPcSt4pairIKS0_iESt10_Select1stIS3_EN11cStringPool7strlessESaIS3_EE", !27, i64 0}
!27 = !{!"_ZTSNSt8_Rb_treeIPcSt4pairIKS0_iESt10_Select1stIS3_EN11cStringPool7strlessESaIS3_EE13_Rb_tree_implIS7_Lb1EEE", !28, i64 0, !16, i64 8}
!28 = !{!"_ZTSSt20_Rb_tree_key_compareIN11cStringPool7strlessEE", !29, i64 0}
!29 = !{!"_ZTSN11cStringPool7strlessE"}
!30 = !{!"bool", !9, i64 0}
!31 = !{!12, !8, i64 0}
!32 = !{!17, !8, i64 24}
!33 = !{!17, !8, i64 16}
!34 = !{!35, !8, i64 0}
!35 = !{!"_ZTSSt4pairIKPciE", !8, i64 0, !36, i64 8}
!36 = !{!"int", !9, i64 0}
!37 = !{!35, !36, i64 8}
!38 = !{!30, !30, i64 0}
!39 = !{i8 0, i8 2}
