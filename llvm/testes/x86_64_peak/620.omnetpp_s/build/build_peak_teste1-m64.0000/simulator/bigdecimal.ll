...
@.str.11 = private unnamed_addr constant [38 x i8] c"BigDecimal::operator<() received Nil.\00", align 1
@.str.12 = private unnamed_addr constant [33 x i8] c"BigDecimal::dbl(): received Nil.\00", align 1
...
@.str.19 = private unnamed_addr constant [34 x i8] c"BigDecimal::ttoa(): received Nil.\00", align 1
...
@.str.23 = private unnamed_addr constant [4 x i8] c"ind\00", align 1
@.str.24 = private unnamed_addr constant [45 x i8] c"BigDecimal::parse(\22%s\22): arithmetic overflow\00", align 1
@.str.25 = private unnamed_addr constant [40 x i8] c"BigDecimal::parse(\22%s\22): missing digits\00", align 1
...
define dso_local void @_ZN10BigDecimal9normalizeEv(ptr nocapture noundef nonnull align 8 dereferenceable(12) %0) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
...
25:                                               ; preds = %21
  %26 = sdiv i64 %22, 10
  store i64 %26, ptr %0, align 8, !tbaa !6
  %27 = add nsw i32 %23, 1
...
41:                                               ; preds = %32
  ...
  store i64 %42, ptr %0, align 8, !tbaa !6
  %43 = add nsw i32 %33, -1
  store i32 %43, ptr %2, align 8, !tbaa !12
...
61:                                               ; preds = %52, %7
  ...
  store i64 %62, ptr %0, align 8, !tbaa !6
  br label %64

64:                                               ; preds = %25, %61
  %65 = phi i32 [ %63, %61 ], [ 0, %25 ]
  store i32 %65, ptr %2, align 8, !tbaa !12
  br label %66
...
define dso_local void @_ZN22PowersOfTenInitializerC2Ev(ptr nocapture nonnull readnone align 1 %0) unnamed_addr #1 align 2 {
  store <4 x i64> <i64 1, i64 10, i64 100, i64 1000>, ptr @_ZL11powersOfTen, align 32, !tbaa !13
  store <4 x i64> <i64 10000, i64 100000, i64 1000000, i64 10000000>, ptr getelementptr inbounds ([21 x i64], ptr @_ZL11powersOfTen, i64 0, i64 4), align 32, !tbaa !13
  store <4 x i64> <i64 100000000, i64 1000000000, i64 10000000000, i64 100000000000>, ptr getelementptr inbounds ([21 x i64], ptr @_ZL11powersOfTen, i64 0, i64 8), align 32, !tbaa !13
  store <4 x i64> <i64 1000000000000, i64 10000000000000, i64 100000000000000, i64 1000000000000000>, ptr getelementptr inbounds ([21 x i64], ptr @_ZL11powersOfTen, i64 0, i64 12), align 32, !tbaa !13
  store <4 x i64> <i64 10000000000000000, i64 100000000000000000, i64 1000000000000000000, i64 -8446744073709551616>, ptr getelementptr inbounds ([21 x i64], ptr @_ZL11powersOfTen, i64 0, i64 16), align 32, !tbaa !13
  store i64 7766279631452241920, ptr getelementptr inbounds ([21 x i64], ptr @_ZL11powersOfTen, i64 0, i64 20), align 32, !tbaa !13
  store <4 x double> <double 1.000000e+00, double 1.000000e-01, double 1.000000e-02, double 1.000000e-03>, ptr @_ZL19negativePowersOfTen, align 32, !tbaa !14
  store <4 x double> <double 1.000000e-04, double 1.000000e-05, double 0x3EB0C6F7A0B5ED8E, double 0x3E7AD7F29ABCAF4A>, ptr getelementptr inbounds ([21 x double], ptr @_ZL19negativePowersOfTen, i64 0, i64 4), align 32, !tbaa !14
  store <4 x double> <double 0x3E45798EE2308C3B, double 0x3E112E0BE826D696, double 0x3DDB7CDFD9D7BDBD, double 0x3DA5FD7FE1796497>, ptr getelementptr inbounds ([21 x double], ptr @_ZL19negativePowersOfTen, i64 0, i64 8), align 32, !tbaa !14
  store <4 x double> <double 0x3D719799812DEA12, double 0x3D3C25C268497683, double 0x3D06849B86A12B9C, double 1.000000e-15>, ptr getelementptr inbounds ([21 x double], ptr @_ZL19negativePowersOfTen, i64 0, i64 12), align 32, !tbaa !14
  store <4 x double> <double 0x3C9CD2B297D889BD, double 1.000000e-17, double 1.000000e-18, double 0x3BFD83C94FB6D2AD>, ptr getelementptr inbounds ([21 x double], ptr @_ZL19negativePowersOfTen, i64 0, i64 16), align 32, !tbaa !14
  store double 0x3BC79CA10C924224, ptr getelementptr inbounds ([21 x double], ptr @_ZL19negativePowersOfTen, i64 0, i64 20), align 32, !tbaa !14
  ret void
}
...
define dso_local noundef i64 @_ZNK10BigDecimal9getDigitsEii(ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #7 align 2 {
...
19:                                               ; preds = %13, %19
  ...
  br i1 %26, label %27, label %19, !llvm.loop !24
...
106:                                              ; preds = %86, %106
  ...
  br i1 %111, label %112, label %106, !llvm.loop !29
...
; Function Attrs: sspstrong uwtable
define dso_local noundef nonnull align 8 dereferenceable(12) ptr @_ZN10BigDecimalaSEd(ptr noundef nonnull returned align 8 dereferenceable(12) %0, double noundef %1) local_unnamed_addr #0 align 2 {
  %3 = alloca i32, align 4
  %4 = fcmp uno double %1, 0.000000e+00
  br i1 %4, label %5, label %9

5:                                                ; preds = %2
  %6 = load i64, ptr @_ZN10BigDecimal3NaNE, align 8, !tbaa !6
  store i64 %6, ptr %0, align 8, !tbaa !6
  %7 = load i32, ptr getelementptr inbounds (%class.BigDecimal, ptr @_ZN10BigDecimal3NaNE, i64 0, i32 1), align 8, !tbaa !12
...
11:                                               ; preds = %9
  %12 = load i64, ptr @_ZN10BigDecimal16PositiveInfinityE, align 8, !tbaa !6
  store i64 %12, ptr %0, align 8, !tbaa !6
  %13 = load i32, ptr getelementptr inbounds (%class.BigDecimal, ptr @_ZN10BigDecimal16PositiveInfinityE, i64 0, i32 1), align 8, !tbaa !12
...
17:                                               ; preds = %15
  %18 = load i64, ptr @_ZN10BigDecimal16NegativeInfinityE, align 8, !tbaa !6
  store i64 %18, ptr %0, align 8, !tbaa !6
  %19 = load i32, ptr getelementptr inbounds (%class.BigDecimal, ptr @_ZN10BigDecimal16NegativeInfinityE, i64 0, i32 1), align 8, !tbaa !12
...
178:                                              ; preds = %165, %176, %173, %109, %123, %116
  ...
  store i64 %182, ptr %0, align 8, !tbaa !6
  %183 = getelementptr inbounds %class.BigDecimal, ptr %0, i64 0, i32 1
  store i32 %180, ptr %183, align 8, !tbaa !12
...
; Function Attrs: sspstrong uwtable
define dso_local noundef zeroext i1 @_ZNK10BigDecimalltERKS_(ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %0, ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %1) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
...
45:                                               ; preds = %41, %22
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %46, ptr noundef nonnull @.str.11)
...
80:                                               ; preds = %6
  %81 = icmp eq i32 %4, %8
  %82 = load i64, ptr %0, align 8, !tbaa !6
  br i1 %81, label %83, label %86

83:                                               ; preds = %80
  %84 = load i64, ptr %1, align 8, !tbaa !6
...
86:                                               ; preds = %80
  ...
  %91 = load i64, ptr %1, align 8, !tbaa !6
...
147:                                              ; preds = %144, %147
  ...
  br i1 %154, label %155, label %147, !llvm.loop !30
...
193:                                              ; preds = %193, %190
  ...
  br i1 %204, label %205, label %193, !llvm.loop !31
...
231:                                              ; preds = %211, %231
  ...
  br i1 %236, label %237, label %231, !llvm.loop !32
...
292:                                              ; preds = %292, %289
  ...
  br i1 %303, label %304, label %292, !llvm.loop !34
...
330:                                              ; preds = %310, %330
  ...
  br i1 %335, label %336, label %330, !llvm.loop !35
...
; Function Attrs: sspstrong uwtable
define dso_local noundef double @_ZNK10BigDecimal3dblEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %0) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  %2 = getelementptr inbounds %class.BigDecimal, ptr %0, i64 0, i32 1
  %3 = load i32, ptr %2, align 8
  %4 = icmp eq i32 %3, 2147483647
...
28:                                               ; preds = %18
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %29, ptr noundef nonnull @.str.12)
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZNK10BigDecimal3strB5cxx11Ev(ptr noalias sret(%"class.std::__cxx11::basic_string") align 8 %0, ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %1) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
...
21:                                               ; preds = %10, %18
  ...
  store ptr %22, ptr %0, align 8, !tbaa !48, !alias.scope !49
  %23 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %0, i64 0, i32 1
  store i64 0, ptr %23, align 8, !tbaa !22, !alias.scope !49
  store i8 0, ptr %22, align 8, !tbaa !50, !alias.scope !49
  %24 = getelementptr inbounds %"class.std::__cxx11::basic_stringstream", ptr %5, i64 0, i32 1, i32 0, i32 5
  %25 = load ptr, ptr %24, align 8, !tbaa !51, !noalias !49
...
33:                                               ; preds = %21
  ...
  %35 = load ptr, ptr %34, align 8, !tbaa !53, !noalias !49
...
40:                                               ; preds = %48, %33
  %41 = landingpad { ptr, i32 }
          cleanup
  %42 = load ptr, ptr %0, align 8, !tbaa !18, !alias.scope !49
  %43 = icmp eq ptr %42, %22
  br i1 %43, label %44, label %47

44:                                               ; preds = %40
  %45 = load i64, ptr %23, align 8, !tbaa !22, !alias.scope !49
...
50:                                               ; preds = %48, %33
  ...
  store ptr getelementptr inbounds ({ [16 x ptr] }, ptr @_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE, i64 0, inrange i32 0, i64 2), ptr %57, align 8, !tbaa !16
...
67:                                               ; preds = %62, %66
  store ptr getelementptr inbounds ({ [16 x ptr] }, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 0, inrange i32 0, i64 2), ptr %57, align 8, !tbaa !16
...
; Function Attrs: sspstrong uwtable
define dso_local noundef ptr @_ZN10BigDecimal4ttoaEPcRKS_RS0_(ptr noundef %0, ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %1, ptr nocapture noundef nonnull align 8 dereferenceable(8) %2) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
...
22:                                               ; preds = %12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %0, ptr noundef nonnull align 1 dereferenceable(5) @.str.17, i64 5, i1 false) #16
...
34:                                               ; preds = %24
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %0, ptr noundef nonnull align 1 dereferenceable(5) @.str.18, i64 5, i1 false) #16
...
36:                                               ; preds = %24
  %37 = tail call ptr @__cxa_allocate_exception(i64 48) #16
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %37, ptr noundef nonnull @.str.19)
          to label %38 unwind label %39
...
75:                                               ; preds = %68
  ...
  store i8 46, ptr %76, align 1, !tbaa !50
  br label %77
...
95:                                               ; preds = %93
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %100, i8 48, i64 %101, i1 false), !tbaa !50
...
105:                                              ; preds = %95, %93
  ...
  store i8 46, ptr %107, align 1, !tbaa !50
  %108 = getelementptr inbounds i8, ptr %106, i64 -2
  store i8 48, ptr %108, align 1, !tbaa !50
  br label %109
...
111:                                              ; preds = %109
  ...
  store i8 45, ptr %112, align 1, !tbaa !50
  br label %113
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN10BigDecimal5parseEPKc(ptr noalias nocapture sret(%class.BigDecimal) align 8 %0, ptr noundef %1) local_unnamed_addr #0 align 2 {
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN10BigDecimal5parseEPKcRS1_(ptr noalias nocapture sret(%class.BigDecimal) align 8 %0, ptr noundef %1, ptr nocapture noundef nonnull writeonly align 8 dereferenceable(8) %2) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  br label %4
...
21:                                               ; preds = %11
  %22 = tail call i32 @strncasecmp(ptr noundef nonnull %16, ptr noundef nonnull @.str.20, i64 noundef 3) #20
  %23 = icmp eq i32 %22, 0
...
24:                                               ; preds = %21
  ...
  %26 = load i64, ptr @_ZN10BigDecimal3NaNE, align 8, !tbaa !6
  store i64 %26, ptr %0, align 8, !tbaa !6
  %27 = load i32, ptr getelementptr inbounds (%class.BigDecimal, ptr @_ZN10BigDecimal3NaNE, i64 0, i32 1), align 8, !tbaa !12
  %28 = getelementptr inbounds %class.BigDecimal, ptr %0, i64 0, i32 1
  store i32 %27, ptr %28, align 8, !tbaa !12
  br label %169

29:                                               ; preds = %21
  %30 = tail call i32 @strncasecmp(ptr noundef nonnull %16, ptr noundef nonnull @.str.21, i64 noundef 3) #20
  %31 = icmp eq i32 %30, 0
  br i1 %31, label %32, label %46

32:                                               ; preds = %29
  %33 = getelementptr inbounds i8, ptr %16, i64 3
  store ptr %33, ptr %2, align 8, !tbaa !56
  %34 = tail call i32 @strncasecmp(ptr noundef nonnull %33, ptr noundef nonnull @.str.22, i64 noundef 5) #20
  %35 = icmp eq i32 %34, 0
  br i1 %35, label %36, label %38

36:                                               ; preds = %32
  %37 = getelementptr inbounds i8, ptr %16, i64 8
  store ptr %37, ptr %2, align 8, !tbaa !56
  br label %38
...
38:                                               ; preds = %36, %32
  ...
  store i64 %41, ptr %0, align 8, !tbaa !6
...
46:                                               ; preds = %29
  store ptr %16, ptr %2, align 8, !tbaa !56
  %47 = load i64, ptr @_ZN10BigDecimal4ZeroE, align 8, !tbaa !6
  store i64 %47, ptr %0, align 8, !tbaa !6
  %48 = load i32, ptr getelementptr inbounds (%class.BigDecimal, ptr @_ZN10BigDecimal4ZeroE, i64 0, i32 1), align 8, !tbaa !12
  %49 = getelementptr inbounds %class.BigDecimal, ptr %0, i64 0, i32 1
  store i32 %48, ptr %49, align 8, !tbaa !12
  br label %169
...
60:                                               ; preds = %56
  ...
  %62 = tail call i32 @strncasecmp(ptr noundef nonnull %61, ptr noundef nonnull @.str.23, i64 noundef 3) #20
  %63 = icmp eq i32 %62, 0
  br i1 %63, label %64, label %69

64:                                               ; preds = %60
  %65 = getelementptr inbounds i8, ptr %16, i64 6
  store ptr %65, ptr %2, align 8, !tbaa !56
  %66 = load i64, ptr @_ZN10BigDecimal3NaNE, align 8, !tbaa !6
  store i64 %66, ptr %0, align 8, !tbaa !6
  %67 = load i32, ptr getelementptr inbounds (%class.BigDecimal, ptr @_ZN10BigDecimal3NaNE, i64 0, i32 1), align 8, !tbaa !12
  %68 = getelementptr inbounds %class.BigDecimal, ptr %0, i64 0, i32 1
  store i32 %67, ptr %68, align 8, !tbaa !12
  br label %169

69:                                               ; preds = %60
  %70 = tail call i32 @strncasecmp(ptr noundef nonnull %61, ptr noundef nonnull @.str.21, i64 noundef 6) #20
  %71 = icmp eq i32 %70, 0
  br i1 %71, label %72, label %84

72:                                               ; preds = %69
  %73 = getelementptr inbounds i8, ptr %16, i64 6
  store ptr %73, ptr %2, align 8, !tbaa !56
  ...
  store i32 %79, ptr %80, align 8, !tbaa !12
  br label %169
...
90:                                               ; preds = %85
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %91, ptr noundef nonnull @.str.24, ptr noundef %1)
...
100:                                              ; preds = %95
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %101, ptr noundef nonnull @.str.24, ptr noundef %1)
...
120:                                              ; preds = %113
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %121, ptr noundef nonnull @.str.25, ptr noundef %1)
...
138:                                              ; preds = %132
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %139, ptr noundef nonnull @.str.24, ptr noundef %1)
...
148:                                              ; preds = %143
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %149, ptr noundef nonnull @.str.24, ptr noundef %1)
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZplRK10BigDecimalS1_(ptr noalias sret(%class.BigDecimal) align 8 %0, ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %1, ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %2) local_unnamed_addr #0 {
  %4 = getelementptr inbounds %class.BigDecimal, ptr %1, i64 0, i32 1
...
39:                                               ; preds = %22
  store i64 %35, ptr %0, align 8, !tbaa !6
  %40 = getelementptr inbounds %class.BigDecimal, ptr %0, i64 0, i32 1
  store i32 %8, ptr %40, align 8, !tbaa !12
  tail call void @_ZN10BigDecimal9normalizeEv(ptr noundef nonnull align 8 dereferenceable(12) %0)
  br label %46
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZmiRK10BigDecimalS1_(ptr noalias sret(%class.BigDecimal) align 8 %0, ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %1, ptr nocapture noundef nonnull readonly align 8 dereferenceable(12) %2) local_unnamed_addr #0 {
  %4 = getelementptr inbounds %class.BigDecimal, ptr %1, i64 0, i32 1
  %5 = getelementptr inbounds %class.BigDecimal, ptr %2, i64 0, i32 1
  %6 = load i32, ptr %5, align 8
  %7 = load i32, ptr %4, align 8
...
attributes #7 = { nofree nosync nounwind sspstrong memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
attributes #8 = { mustprogress nofree nounwind willreturn memory(argmem: write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
...
!6 = !{!7, !8, i64 0}
!7 = !{!"_ZTS10BigDecimal", !8, i64 0, !11, i64 8}
!8 = !{!"long", !9, i64 0}
...
!32 = distinct !{!32, !28, !27}
!33 = distinct !{!33, !25}
!34 = distinct !{!34, !27, !28}
!35 = distinct !{!35, !28, !27}
!36 = !{!37, !39, i64 32}
!37 = !{!"_ZTSSt8ios_base", !8, i64 8, !8, i64 16, !38, i64 24, !39, i64 28, !39, i64 32, !21, i64 40, !40, i64 48, !9, i64 64, !11, i64 192, !21, i64 200, !41, i64 208}
!38 = !{!"_ZTSSt13_Ios_Fmtflags", !9, i64 0}
!39 = !{!"_ZTSSt12_Ios_Iostate", !9, i64 0}
!40 = !{!"_ZTSNSt8ios_base6_WordsE", !21, i64 0, !8, i64 8}
!41 = !{!"_ZTSSt6locale", !21, i64 0}
!42 = !{!43}
...
!50 = !{!9, !9, i64 0}
!51 = !{!52, !21, i64 40}
!52 = !{!"_ZTSSt15basic_streambufIcSt11char_traitsIcEE", !21, i64 8, !21, i64 16, !21, i64 24, !21, i64 32, !21, i64 40, !21, i64 48, !41, i64 56}
!53 = !{!52, !21, i64 32}
!54 = !{!55, !8, i64 8}
!55 = !{!"_ZTSSi", !8, i64 8}
!56 = !{!21, !21, i64 0}
