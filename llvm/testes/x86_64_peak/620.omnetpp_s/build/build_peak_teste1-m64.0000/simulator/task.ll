...
define dso_local void @_Z3eatP5_TaskjS0_(ptr noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #2 {
  ...
  store i64 3736059631, ptr %4, align 8, !tbaa !6
  %5 = getelementptr inbounds %struct._Task, ptr %4, i64 0, i32 10
  store i64 3736059631, ptr %5, align 8, !tbaa !13
...
35:                                               ; preds = %88, %28
  %36 = load i32, ptr %29, align 8, !tbaa !18
  %37 = add i32 %36, 1024
...
43:                                               ; preds = %40
  %44 = load i32, ptr %29, align 8, !tbaa !18
...
49:                                               ; preds = %45
  %50 = load ptr, ptr %30, align 8, !tbaa !19
  %51 = load ptr, ptr %31, align 8, !tbaa !20
  call void %50(ptr noundef %51)
  store i32 0, ptr %21, align 8, !tbaa !16
  %52 = load ptr, ptr %24, align 8, !tbaa !17
...
58:                                               ; preds = %54
  ...
  %62 = add i32 %61, %60
  store i32 %62, ptr %20, align 4, !tbaa !15
  %63 = getelementptr inbounds %struct._Task, ptr %52, i64 0, i32 5
  %64 = load ptr, ptr %63, align 8, !tbaa !17
  store ptr %64, ptr %24, align 8, !tbaa !17
  br label %65

65:                                               ; preds = %58, %54, %49
  %66 = phi ptr [ %64, %58 ], [ %52, %54 ], [ null, %49 ]
  %67 = load ptr, ptr getelementptr inbounds (%struct._Task, ptr @main_task, i64 0, i32 5), align 8, !tbaa !17
  %68 = icmp eq ptr %67, %4
...
78:                                               ; preds = %74
  ...
  store ptr %66, ptr %79, align 8, !tbaa !17
  br label %84
...
18:                                               ; preds = %10, %6, %1
  ...
  %20 = load ptr, ptr getelementptr inbounds (%struct._Task, ptr @main_task, i64 0, i32 5), align 8, !tbaa !17
  %21 = icmp eq ptr %20, %0
...
31:                                               ; preds = %27
  ...
  store ptr %19, ptr %32, align 8, !tbaa !17
  br label %38
...
define dso_local void @_Z13task_switchtoP5_Task(ptr noundef %0) local_unnamed_addr #7 {
  %2 = load ptr, ptr @current_task, align 8, !tbaa !21
...
6:                                                ; preds = %1
  store ptr %0, ptr @current_task, align 8, !tbaa !21
...
10:                                               ; preds = %2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(464) @main_task, ptr noundef nonnull align 8 dereferenceable(464) %3, i64 464, i1 false), !tbaa.struct !22
  store i32 1, ptr getelementptr inbounds (%struct._Task, ptr @main_task, i64 0, i32 3), align 8, !tbaa !16
  store ptr @main_task, ptr @current_task, align 8, !tbaa !21
...
define dso_local noundef ptr @_Z11task_createPFvPvES_j(ptr noundef %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #7 {
  %4 = load ptr, ptr getelementptr inbounds (%struct._Task, ptr @main_task, i64 0, i32 5), align 8, !tbaa !17
  %5 = icmp eq ptr %4, null
...
!6 = !{!7, !8, i64 0}
!7 = !{!"_ZTS5_Task", !8, i64 0, !9, i64 8, !9, i64 208, !11, i64 408, !11, i64 412, !12, i64 416, !12, i64 424, !12, i64 432, !11, i64 440, !12, i64 448, !8, i64 456}
!8 = !{!"long", !9, i64 0}
...
!20 = !{!7, !12, i64 432}
!21 = !{!12, !12, i64 0}
!22 = !{i64 0, i64 8, !23, i64 8, i64 200, !24, i64 208, i64 200, !24, i64 408, i64 4, !25, i64 412, i64 4, !25, i64 416, i64 8, !21, i64 424, i64 8, !21, i64 432, i64 8, !21, i64 440, i64 4, !25, i64 448, i64 8, !21, i64 456, i64 8, !23}
!23 = !{!8, !8, i64 0}
!24 = !{!9, !9, i64 0}
!25 = !{!11, !11, i64 0}
