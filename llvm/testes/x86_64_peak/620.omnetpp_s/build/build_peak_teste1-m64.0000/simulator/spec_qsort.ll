...
86:                                               ; preds = %85, %86
  ...
  %90 = load <32 x i8>, ptr %89, align 1, !tbaa !6, !alias.scope !9, !noalias !12
  %91 = getelementptr i8, ptr %89, i64 32
  %92 = load <32 x i8>, ptr %91, align 1, !tbaa !6, !alias.scope !9, !noalias !12
  %93 = load <32 x i8>, ptr %88, align 1, !tbaa !6, !alias.scope !12
  %94 = getelementptr i8, ptr %88, i64 32
  %95 = load <32 x i8>, ptr %94, align 1, !tbaa !6, !alias.scope !12
  store <32 x i8> %93, ptr %89, align 1, !tbaa !6, !alias.scope !9, !noalias !12
  store <32 x i8> %95, ptr %91, align 1, !tbaa !6, !alias.scope !9, !noalias !12
  store <32 x i8> %90, ptr %88, align 1, !tbaa !6, !alias.scope !12
  store <32 x i8> %92, ptr %94, align 1, !tbaa !6, !alias.scope !12
...
106:                                              ; preds = %106, %102
  ...
  %110 = load <16 x i8>, ptr %109, align 1, !tbaa !6, !alias.scope !17, !noalias !20
  %111 = load <16 x i8>, ptr %108, align 1, !tbaa !6, !alias.scope !20
  store <16 x i8> %111, ptr %109, align 1, !tbaa !6, !alias.scope !17, !noalias !20
  store <16 x i8> %110, ptr %108, align 1, !tbaa !6, !alias.scope !20
...
122:                                              ; preds = %115, %122
  ...
  %127 = add i64 %123, -1
  %128 = load i8, ptr %125, align 1, !tbaa !6
  %129 = load i8, ptr %124, align 1, !tbaa !6
  %130 = getelementptr inbounds i8, ptr %125, i64 1
  store i8 %129, ptr %125, align 1, !tbaa !6
  %131 = getelementptr inbounds i8, ptr %124, i64 1
  store i8 %128, ptr %124, align 1, !tbaa !6
  %132 = add i64 %126, 1
  %133 = icmp eq i64 %132, %120
  br i1 %133, label %134, label %122, !llvm.loop !23
...
139:                                              ; preds = %134, %139
  ...
  store i8 %144, ptr %142, align 1, !tbaa !6
  %146 = getelementptr inbounds i8, ptr %141, i64 1
  store i8 %143, ptr %141, align 1, !tbaa !6
  %147 = load i8, ptr %145, align 1, !tbaa !6
  %148 = load i8, ptr %146, align 1, !tbaa !6
  %149 = getelementptr inbounds i8, ptr %142, i64 2
  store i8 %148, ptr %145, align 1, !tbaa !6
  %150 = getelementptr inbounds i8, ptr %141, i64 2
  store i8 %147, ptr %146, align 1, !tbaa !6
  %151 = load i8, ptr %149, align 1, !tbaa !6
  %152 = load i8, ptr %150, align 1, !tbaa !6
  %153 = getelementptr inbounds i8, ptr %142, i64 3
  store i8 %152, ptr %149, align 1, !tbaa !6
  %154 = getelementptr inbounds i8, ptr %141, i64 3
  store i8 %151, ptr %150, align 1, !tbaa !6
  %155 = add i64 %140, -4
  %156 = load i8, ptr %153, align 1, !tbaa !6
  %157 = load i8, ptr %154, align 1, !tbaa !6
  %158 = getelementptr inbounds i8, ptr %142, i64 4
  store i8 %157, ptr %153, align 1, !tbaa !6
  %159 = getelementptr inbounds i8, ptr %141, i64 4
  store i8 %156, ptr %154, align 1, !tbaa !6
  %160 = icmp eq i64 %155, 0
  br i1 %160, label %161, label %139, !llvm.loop !25
...
178:                                              ; preds = %177, %178
  ...
  %182 = load <32 x i8>, ptr %181, align 1, !tbaa !6, !alias.scope !26, !noalias !29
  %183 = getelementptr i8, ptr %181, i64 32
  %184 = load <32 x i8>, ptr %183, align 1, !tbaa !6, !alias.scope !26, !noalias !29
  %185 = load <32 x i8>, ptr %180, align 1, !tbaa !6, !alias.scope !29
  %186 = getelementptr i8, ptr %180, i64 32
  %187 = load <32 x i8>, ptr %186, align 1, !tbaa !6, !alias.scope !29
  store <32 x i8> %185, ptr %181, align 1, !tbaa !6, !alias.scope !26, !noalias !29
  store <32 x i8> %187, ptr %183, align 1, !tbaa !6, !alias.scope !26, !noalias !29
  store <32 x i8> %182, ptr %180, align 1, !tbaa !6, !alias.scope !29
  store <32 x i8> %184, ptr %186, align 1, !tbaa !6, !alias.scope !29
  %188 = add nuw i64 %179, 64
  %189 = icmp eq i64 %188, %31
  br i1 %189, label %190, label %178, !llvm.loop !31
...
198:                                              ; preds = %198, %194
  ...
  %202 = load <16 x i8>, ptr %201, align 1, !tbaa !6, !alias.scope !32, !noalias !35
  %203 = load <16 x i8>, ptr %200, align 1, !tbaa !6, !alias.scope !35
  store <16 x i8> %203, ptr %201, align 1, !tbaa !6, !alias.scope !32, !noalias !35
  store <16 x i8> %202, ptr %200, align 1, !tbaa !6, !alias.scope !35
...
214:                                              ; preds = %207, %214
  ...
  %219 = add i64 %215, -1
  %220 = load i8, ptr %217, align 1, !tbaa !6
  %221 = load i8, ptr %216, align 1, !tbaa !6
  %222 = getelementptr inbounds i8, ptr %217, i64 1
  store i8 %221, ptr %217, align 1, !tbaa !6
  %223 = getelementptr inbounds i8, ptr %216, i64 1
  store i8 %220, ptr %216, align 1, !tbaa !6
  %224 = add i64 %218, 1
  %225 = icmp eq i64 %224, %212
  br i1 %225, label %226, label %214, !llvm.loop !38
...
231:                                              ; preds = %226, %231
  ...
  %236 = load i8, ptr %233, align 1, !tbaa !6
  %237 = getelementptr inbounds i8, ptr %234, i64 1
  store i8 %236, ptr %234, align 1, !tbaa !6
  %238 = getelementptr inbounds i8, ptr %233, i64 1
  store i8 %235, ptr %233, align 1, !tbaa !6
  %239 = load i8, ptr %237, align 1, !tbaa !6
  %240 = load i8, ptr %238, align 1, !tbaa !6
  %241 = getelementptr inbounds i8, ptr %234, i64 2
  store i8 %240, ptr %237, align 1, !tbaa !6
  %242 = getelementptr inbounds i8, ptr %233, i64 2
  store i8 %239, ptr %238, align 1, !tbaa !6
  %243 = load i8, ptr %241, align 1, !tbaa !6
  %244 = load i8, ptr %242, align 1, !tbaa !6
  %245 = getelementptr inbounds i8, ptr %234, i64 3
  store i8 %244, ptr %241, align 1, !tbaa !6
  %246 = getelementptr inbounds i8, ptr %233, i64 3
  store i8 %243, ptr %242, align 1, !tbaa !6
  %247 = add i64 %232, -4
  %248 = load i8, ptr %245, align 1, !tbaa !6
  %249 = load i8, ptr %246, align 1, !tbaa !6
  %250 = getelementptr inbounds i8, ptr %234, i64 4
  store i8 %249, ptr %245, align 1, !tbaa !6
  %251 = getelementptr inbounds i8, ptr %233, i64 4
  store i8 %248, ptr %246, align 1, !tbaa !6
  %252 = icmp eq i64 %247, 0
  br i1 %252, label %253, label %231, !llvm.loop !39
