...
@.str.9 = private unnamed_addr constant [31 x i8] c"INTERNAL ERROR: %s:%d: %s: %s\0A\00", align 1
@.str.10 = private unnamed_addr constant [33 x i8] c"INTERNAL ERROR: %s:%d: <%s>: %s\0A\00", align 1
@.str.11 = private unnamed_addr constant [27 x i8] c"INTERNAL ERROR: %s:%d: %s\0A\00", align 1
@switch.table._ZNK13NEDErrorStore13errorSeverityEi = private unnamed_addr constant [3 x ptr] [ptr @.str.5, ptr @.str.6, ptr @.str.7], align 8
...
35:                                               ; preds = %34, %32, %30
  ...
  store ptr %41, ptr %40, align 8, !tbaa !6
...
51:                                               ; preds = %49
  %52 = load i8, ptr %42, align 1, !tbaa !11
...
62:                                               ; preds = %53, %51, %49
  ...
  store ptr %68, ptr %15, align 8, !tbaa !20
  br label %70
...
100:                                              ; preds = %90, %84
  ...
  store ptr %1, ptr %86, align 8, !tbaa !23
  ...
  store i32 %3, ptr %109, align 8, !tbaa !26
  ...
  %116 = load i8, ptr %115, align 8, !tbaa !27, !range !33, !noundef !34
...
130:                                              ; preds = %129
  %131 = load ptr, ptr %1, align 8, !tbaa !21
...
34:                                               ; preds = %32
  store ptr %33, ptr %25, align 8, !tbaa !15
  %35 = load i64, ptr %3, align 8, !tbaa !19
  store i64 %35, ptr %27, align 8, !tbaa !11
  br label %36
...
50:                                               ; preds = %46
  %51 = load i64, ptr %22, align 8, !tbaa !18
...
define dso_local noundef zeroext i1 @_ZNK13NEDErrorStore13containsErrorEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(25) %0) local_unnamed_addr #14 align 2 {
...
define dso_local noundef ptr @_ZNK13NEDErrorStore13errorSeverityEi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(25) %0, i32 noundef %1) local_unnamed_addr #15 align 2 {
  %3 = icmp slt i32 %1, 0
...
23:                                               ; preds = %14, %19, %2, %4
  %24 = phi ptr [ null, %4 ], [ null, %2 ], [ %22, %19 ], [ @.str.8, %14 ]
  ret ptr %24
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local noundef i32 @_ZNK13NEDErrorStore17errorSeverityCodeEi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(25) %0, i32 noundef %1) local_unnamed_addr #15 align 2 {
  %3 = icmp slt i32 %1, 0
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local noundef ptr @_ZNK13NEDErrorStore13errorLocationEi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(25) %0, i32 noundef %1) local_unnamed_addr #15 align 2 {
  %3 = icmp slt i32 %1, 0
  br i1 %3, label %18, label %4
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local noundef ptr @_ZNK13NEDErrorStore12errorContextEi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(25) %0, i32 noundef %1) local_unnamed_addr #15 align 2 {
  %3 = icmp slt i32 %1, 0
  br i1 %3, label %18, label %4
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local noundef ptr @_ZNK13NEDErrorStore9errorTextEi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(25) %0, i32 noundef %1) local_unnamed_addr #15 align 2 {
  %3 = icmp slt i32 %1, 0
  br i1 %3, label %18, label %4
...
; Function Attrs: nofree norecurse nosync nounwind sspstrong memory(read, inaccessiblemem: none) uwtable
define dso_local noundef i32 @_ZNK13NEDErrorStore17findFirstErrorForEP10NEDElementi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(25) %0, ptr noundef readnone %1, i32 noundef %2) local_unnamed_addr #14 align 2 {
  %4 = getelementptr inbounds %"struct.std::_Vector_base<NEDErrorStore::Entry, std::allocator<NEDErrorStore::Entry> >::_Vector_impl_data", ptr %0, i64 0, i32 1
  %5 = load ptr, ptr %4, align 8, !tbaa !20
...
17:                                               ; preds = %10
  %18 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %16, ptr noundef nonnull @.str.9, ptr noundef %0, i32 noundef %1, ptr noundef nonnull %14, ptr noundef nonnull %5) #20
  br label %28
...
19:                                               ; preds = %10
  ...
  %24 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %16, ptr noundef nonnull @.str.10, ptr noundef %0, i32 noundef %1, ptr noundef %23, ptr noundef nonnull %5) #20
  br label %28

25:                                               ; preds = %4
  %26 = load ptr, ptr @stderr, align 8, !tbaa !12
  %27 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %26, ptr noundef nonnull @.str.11, ptr noundef %0, i32 noundef %1, ptr noundef nonnull %5) #20
  br label %28
...
!12 = !{!8, !8, i64 0}
!13 = !{!14, !8, i64 16}
!14 = !{!"_ZTSNSt12_Vector_baseIN13NEDErrorStore5EntryESaIS1_EE17_Vector_impl_dataE", !8, i64 0, !8, i64 8, !8, i64 16}
!15 = !{!16, !8, i64 0}
!16 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !7, i64 0, !17, i64 8, !9, i64 16}
!17 = !{!"long", !9, i64 0}
!18 = !{!16, !17, i64 8}
!19 = !{!17, !17, i64 0}
!20 = !{!14, !8, i64 8}
...
!23 = !{!24, !8, i64 0}
!24 = !{!"_ZTSN13NEDErrorStore5EntryE", !8, i64 0, !25, i64 8, !16, i64 16, !16, i64 48}
!25 = !{!"int", !9, i64 0}
!26 = !{!24, !25, i64 8}
!27 = !{!28, !32, i64 24}
!28 = !{!"_ZTS13NEDErrorStore", !29, i64 0, !32, i64 24}
!29 = !{!"_ZTSSt6vectorIN13NEDErrorStore5EntryESaIS1_EE", !30, i64 0}
!30 = !{!"_ZTSSt12_Vector_baseIN13NEDErrorStore5EntryESaIS1_EE", !31, i64 0}
!31 = !{!"_ZTSNSt12_Vector_baseIN13NEDErrorStore5EntryESaIS1_EE12_Vector_implE", !14, i64 0}
!32 = !{!"bool", !9, i64 0}
!33 = !{i8 0, i8 2}
!34 = !{}
!35 = !{!14, !8, i64 0}
