...
@.str.2 = private unnamed_addr constant [6 x i8] c", at \00", align 1
...
50:                                               ; preds = %48
  %51 = load i8, ptr %8, align 16, !tbaa !14
...
53:                                               ; preds = %52, %50, %48
  ...
  %58 = load ptr, ptr %12, align 8, !tbaa !15, !noalias !19
  %59 = load i64, ptr %55, align 8, !tbaa !11, !noalias !19
  %60 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %11, i64 0, i32 2
  store ptr %60, ptr %11, align 8, !tbaa !6, !alias.scope !22
  %61 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %11, i64 0, i32 1
  store i64 0, ptr %61, align 8, !tbaa !11, !alias.scope !22
  store i8 0, ptr %60, align 8, !tbaa !14, !alias.scope !22
  %62 = add i64 %59, 5
...
63:                                               ; preds = %53
  %64 = load i64, ptr %61, align 8, !tbaa !11, !alias.scope !22
...
69:                                               ; preds = %67
  %70 = load i64, ptr %61, align 8, !tbaa !11, !alias.scope !22
...
75:                                               ; preds = %69
  %76 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %11, ptr noundef nonnull @.str.2, i64 noundef 5)
          to label %85 unwind label %77

77:                                               ; preds = %75, %73, %67, %53
  %78 = landingpad { ptr, i32 }
          cleanup
  %79 = load ptr, ptr %11, align 8, !tbaa !15, !alias.scope !22
  %80 = icmp eq ptr %79, %60
  br i1 %80, label %81, label %84

81:                                               ; preds = %77
  %82 = load i64, ptr %61, align 8, !tbaa !11, !alias.scope !22
...
91:                                               ; preds = %89
  store ptr %90, ptr %13, align 8, !tbaa !15
...
95:                                               ; preds = %93
  %96 = load i8, ptr %37, align 1, !tbaa !14
...
98:                                               ; preds = %97, %95, %93
  %99 = load i64, ptr %5, align 8, !tbaa !18
  ...
  %103 = load ptr, ptr %11, align 8, !tbaa !15, !noalias !25
  %104 = load i64, ptr %61, align 8, !tbaa !11, !noalias !25
  %105 = load ptr, ptr %13, align 8, !tbaa !15, !noalias !25
  %106 = load i64, ptr %100, align 8, !tbaa !11, !noalias !25
  %107 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %10, i64 0, i32 2
  store ptr %107, ptr %10, align 8, !tbaa !6, !alias.scope !28
  %108 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %10, i64 0, i32 1
  store i64 0, ptr %108, align 8, !tbaa !11, !alias.scope !28
  store i8 0, ptr %107, align 8, !tbaa !14, !alias.scope !28
  %109 = add i64 %106, %104
...
110:                                              ; preds = %98
  %111 = load i64, ptr %108, align 8, !tbaa !11, !alias.scope !28
...
116:                                              ; preds = %114
  %117 = load i64, ptr %108, align 8, !tbaa !11, !alias.scope !28
...
124:                                              ; preds = %122, %120, %114, %98
  %125 = landingpad { ptr, i32 }
          cleanup
  %126 = load ptr, ptr %10, align 8, !tbaa !15, !alias.scope !28
  %127 = icmp eq ptr %126, %107
  br i1 %127, label %128, label %131

128:                                              ; preds = %124
  %129 = load i64, ptr %108, align 8, !tbaa !11, !alias.scope !28
...
143:                                              ; preds = %140
  %144 = load i64, ptr %100, align 8, !tbaa !11
...
150:                                              ; preds = %147
  %151 = load i64, ptr %61, align 8, !tbaa !11
...
157:                                              ; preds = %154
  %158 = load i64, ptr %55, align 8, !tbaa !11
...
181:                                              ; preds = %177
  %182 = load i64, ptr %108, align 8, !tbaa !11
...
189:                                              ; preds = %185
  %190 = load i64, ptr %100, align 8, !tbaa !11
...
197:                                              ; preds = %193
  %198 = load i64, ptr %61, align 8, !tbaa !11
...
205:                                              ; preds = %201
  %206 = load i64, ptr %55, align 8, !tbaa !11
...
211:                                              ; preds = %38
  ...
  %212 = load ptr, ptr %1, align 8, !tbaa !16
...
216:                                              ; preds = %211
  ...
  store ptr %217, ptr %16, align 8, !tbaa !6
...
221:                                              ; preds = %216
  ...
  store i64 %222, ptr %4, align 8, !tbaa !18
...
226:                                              ; preds = %224
  ...
  %227 = load i64, ptr %4, align 8, !tbaa !18
  store i64 %227, ptr %217, align 8, !tbaa !14
  br label %228
...
230:                                              ; preds = %228
  %231 = load i8, ptr %215, align 1, !tbaa !14
...
243:                                              ; preds = %233
  %244 = load i64, ptr %241, align 8, !tbaa !11, !alias.scope !34
...
249:                                              ; preds = %247
  %250 = load i64, ptr %241, align 8, !tbaa !11, !alias.scope !34
  %251 = and i64 %250, -2
...
255:                                              ; preds = %249
  %256 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %15, ptr noundef nonnull @.str.3, i64 noundef 2)
          to label %265 unwind label %257

257:                                              ; preds = %255, %253, %247, %233
  %258 = landingpad { ptr, i32 }
          cleanup
  %259 = load ptr, ptr %15, align 8, !tbaa !15, !alias.scope !34
  %260 = icmp eq ptr %259, %240
  br i1 %260, label %261, label %264

261:                                              ; preds = %257
  %262 = load i64, ptr %241, align 8, !tbaa !11, !alias.scope !34
...
265:                                              ; preds = %255
  ...
  %266 = load ptr, ptr %15, align 8, !tbaa !15, !noalias !37
  %267 = load i64, ptr %241, align 8, !tbaa !11, !noalias !37
  %268 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %8) #12, !noalias !37
  %269 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %14, i64 0, i32 2
  store ptr %269, ptr %14, align 8, !tbaa !6, !alias.scope !40
  %270 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %14, i64 0, i32 1
  store i64 0, ptr %270, align 8, !tbaa !11, !alias.scope !40
  store i8 0, ptr %269, align 8, !tbaa !14, !alias.scope !40
  %271 = add i64 %268, %267
...
272:                                              ; preds = %265
  %273 = load i64, ptr %270, align 8, !tbaa !11, !alias.scope !40
...
278:                                              ; preds = %276
  %279 = load i64, ptr %270, align 8, !tbaa !11, !alias.scope !40
...
286:                                              ; preds = %284, %282, %276, %265
  %287 = landingpad { ptr, i32 }
          cleanup
  %288 = load ptr, ptr %14, align 8, !tbaa !15, !alias.scope !40
  %289 = icmp eq ptr %288, %269
  br i1 %289, label %290, label %293

290:                                              ; preds = %286
  %291 = load i64, ptr %270, align 8, !tbaa !11, !alias.scope !40
...
298:                                              ; preds = %295
  %299 = load i64, ptr %270, align 8, !tbaa !11
...
305:                                              ; preds = %302
  %306 = load i64, ptr %241, align 8, !tbaa !11
...
309:                                              ; preds = %308, %305
  %310 = load ptr, ptr %16, align 8, !tbaa !15
  %311 = icmp eq ptr %310, %217
  br i1 %311, label %312, label %315

312:                                              ; preds = %309
  %313 = load i64, ptr %235, align 8, !tbaa !11
...
321:                                              ; preds = %294
  %322 = landingpad { ptr, i32 }
          cleanup
  %323 = load ptr, ptr %14, align 8, !tbaa !15
  %324 = icmp eq ptr %323, %269
  br i1 %324, label %325, label %328

325:                                              ; preds = %321
  %326 = load i64, ptr %270, align 8, !tbaa !11
...
333:                                              ; preds = %329
  %334 = load i64, ptr %241, align 8, !tbaa !11
...
341:                                              ; preds = %337
  %342 = load i64, ptr %235, align 8, !tbaa !11
...
347:                                              ; preds = %26
  %348 = load i64, ptr %29, align 8, !tbaa !11
...
352:                                              ; preds = %345, %209, %171
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %9) #12
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %8) #12
  %354 = load ptr, ptr %27, align 8, !tbaa !15
  %355 = icmp eq ptr %354, %28
  br i1 %355, label %356, label %359

356:                                              ; preds = %352
  %357 = load i64, ptr %29, align 8, !tbaa !11
