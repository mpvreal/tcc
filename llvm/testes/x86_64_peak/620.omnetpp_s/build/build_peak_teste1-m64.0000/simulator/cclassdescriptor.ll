...
define dso_local void @_ZN16cClassDescriptorD0Ev(ptr nocapture nonnull readnone align 8 %0) unnamed_addr #1 align 2 {
...
; Function Attrs: sspstrong uwtable
define dso_local noundef ptr @_ZNK16cClassDescriptor22getBaseClassDescriptorEv(ptr nocapture noundef nonnull align 8 dereferenceable(88) %0) unnamed_addr #3 align 2 {
...
19:                                               ; preds = %9
  %20 = tail call ptr @__dynamic_cast(ptr nonnull %16, ptr nonnull @_ZTI12cOwnedObject, ptr nonnull @_ZTI16cClassDescriptor, i64 0) #23
...
; Function Attrs: sspstrong uwtable
define dso_local noundef ptr @_ZNK16cClassDescriptor18getFieldDeclaredOnEPvi(ptr noundef nonnull align 8 dereferenceable(88) %0, ptr noundef %1, i32 noundef %2) unnamed_addr #3 align 2 {
...
define dso_local void @_ZN16cClassDescriptor11long2stringElPci(i64 noundef %0, ptr nocapture noundef writeonly %1, i32 noundef %2) local_unnamed_addr #4 align 2 {
  %4 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) @.str, i64 noundef %0) #23
  ret void
}
...
; Function Attrs: nofree nounwind sspstrong uwtable
define dso_local void @_ZN16cClassDescriptor12ulong2stringEmPci(i64 noundef %0, ptr nocapture noundef writeonly %1, i32 noundef %2) local_unnamed_addr #4 align 2 {
  %4 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) @.str.1, i64 noundef %0) #23
  ret void
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local noundef i64 @_ZN16cClassDescriptor12string2ulongEPKc(ptr noundef %0) local_unnamed_addr #2 align 2 {
  %2 = tail call i64 @__isoc23_strtoul(ptr noundef %0, ptr noundef null, i32 noundef 10) #23
  ret i64 %2
}
...
; Function Attrs: nofree nounwind sspstrong uwtable
define dso_local void @_ZN16cClassDescriptor12int642stringElPci(i64 noundef %0, ptr nocapture noundef writeonly %1, i32 noundef %2) local_unnamed_addr #4 align 2 {
  %4 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) @.str, i64 noundef %0) #23
  ret void
}
...
; Function Attrs: nounwind
declare i64 @__isoc23_strtoll(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #6

; Function Attrs: nofree nounwind sspstrong uwtable
define dso_local void @_ZN16cClassDescriptor13uint642stringEmPci(i64 noundef %0, ptr nocapture noundef writeonly %1, i32 noundef %2) local_unnamed_addr #4 align 2 {
  %4 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) @.str.1, i64 noundef %0) #23
  ret void
}
...
define dso_local noundef i64 @_ZN16cClassDescriptor13string2uint64EPKc(ptr noundef %0) local_unnamed_addr #2 align 2 {
  %2 = tail call i64 @__isoc23_strtoull(ptr noundef %0, ptr noundef null, i32 noundef 10) #23
  ret i64 %2
}
...
define dso_local void @_ZN16cClassDescriptor11bool2stringEbPci(i1 noundef zeroext %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #7 align 2 {
  %4 = select i1 %0, ptr @.str.2, ptr @.str.3
  %5 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) %4) #23
  ret void
}
...
define dso_local noundef zeroext i1 @_ZN16cClassDescriptor11string2boolEPKc(ptr nocapture noundef readonly %0) local_unnamed_addr #9 align 2 {
...
; Function Attrs: nofree nounwind sspstrong uwtable
define dso_local void @_ZN16cClassDescriptor13double2stringEdPci(double noundef %0, ptr nocapture noundef writeonly %1, i32 noundef %2) local_unnamed_addr #4 align 2 {
  %4 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %0) #23
  ret void
}

; Function Attrs: mustprogress nofree nounwind sspstrong willreturn uwtable
define dso_local noundef double @_ZN16cClassDescriptor13string2doubleEPKc(ptr nocapture noundef readonly %0) local_unnamed_addr #10 align 2 {
  %2 = tail call double @strtod(ptr nocapture noundef nonnull %0, ptr noundef null) #23
  ret double %2
}
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN16cClassDescriptor11enum2stringElPKcPci(i64 noundef %0, ptr noundef %1, ptr nocapture noundef %2, i32 noundef %3) local_unnamed_addr #3 align 2 {
  %5 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) @.str, i64 noundef %0) #23
...
15:                                               ; preds = %8
  %16 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %13, ptr noundef nonnull dereferenceable(1) @.str.6, ptr noundef nonnull %10) #23
  br label %17
...
declare noundef ptr @_ZN5cEnum12getStringForEi(ptr noundef nonnull align 8 dereferenceable(160), i32 noundef) local_unnamed_addr #0

; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
declare i64 @strlen(ptr nocapture noundef) local_unnamed_addr #12

; Function Attrs: sspstrong uwtable
define dso_local noundef i64 @_ZN16cClassDescriptor11string2enumEPKcS1_(ptr noundef %0, ptr noundef %1) local_unnamed_addr #3 align 2 {
...
7:                                                ; preds = %2
  %8 = tail call i64 @__isoc23_strtol(ptr noundef nonnull %0, ptr noundef null, i32 noundef 10) #23
  br label %15
...
declare noundef i32 @_ZN5cEnum6lookupEPKci(ptr noundef nonnull align 8 dereferenceable(160), ptr noundef, i32 noundef) local_unnamed_addr #0

; Function Attrs: mustprogress nofree nounwind sspstrong willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @_ZN16cClassDescriptor16oppstring2stringERK10opp_stringPci(ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #13 align 2 {
  %4 = load ptr, ptr %0, align 8, !tbaa !28
  %5 = icmp eq ptr %4, null
  %6 = select i1 %5, ptr @.str.7, ptr %4
  %7 = sext i32 %2 to i64
  %8 = tail call ptr @strncpy(ptr noundef %1, ptr noundef nonnull %6, i64 noundef %7) #23
  %9 = add nsw i32 %2, -1
...
; Function Attrs: mustprogress nofree nounwind sspstrong willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @_ZN16cClassDescriptor16oppstring2stringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPci(ptr nocapture noundef nonnull readonly align 8 dereferenceable(32) %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #13 align 2 {
  %4 = load ptr, ptr %0, align 8, !tbaa !25
  %5 = sext i32 %2 to i64
  %6 = tail call ptr @strncpy(ptr noundef %1, ptr noundef %4, i64 noundef %5) #23
  %7 = add nsw i32 %2, -1
  %8 = sext i32 %7 to i64
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN16cClassDescriptor16string2oppstringEPKcR10opp_string(ptr noundef readonly %0, ptr nocapture noundef nonnull align 8 dereferenceable(8) %1) local_unnamed_addr #3 align 2 {
...
11:                                               ; preds = %8
  %12 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %4) #24
  %13 = add i64 %12, 1
  %14 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %13) #26
  %15 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(1) %4) #23
  br label %16
...
; Function Attrs: mustprogress nofree nounwind sspstrong willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @_ZN16cClassDescriptor16oppstring2stringEPKcPci(ptr noundef readonly %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #13 align 2 {
  %4 = icmp eq ptr %0, null
  %5 = select i1 %4, ptr @.str.7, ptr %0
  %6 = sext i32 %2 to i64
  %7 = tail call ptr @strncpy(ptr noundef %1, ptr noundef nonnull %5, i64 noundef %6) #23
  %8 = add nsw i32 %2, -1
  %9 = sext i32 %8 to i64
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN16cClassDescriptor16string2oppstringEPKcRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef %0, ptr noundef nonnull align 8 dereferenceable(32) %1) local_unnamed_addr #3 align 2 {
  %3 = icmp eq ptr %0, null
  %4 = select i1 %3, ptr @.str.7, ptr %0
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN16cClassDescriptorC2EPKcS1_(ptr noundef nonnull align 8 dereferenceable(88) %0, ptr noundef %1, ptr noundef %2) unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
  ...
  store ptr getelementptr inbounds ({ [40 x ptr] }, ptr @_ZTV16cClassDescriptor, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !13
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN16cClassDescriptorD2Ev(ptr noundef nonnull align 8 dereferenceable(88) %0) unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [40 x ptr] }, ptr @_ZTV16cClassDescriptor, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !13
...
; Function Attrs: sspstrong uwtable
define dso_local noundef ptr @_ZN16cClassDescriptor16getDescriptorForEPKc(ptr noundef %0) local_unnamed_addr #3 align 2 {
...
8:                                                ; preds = %1
  %9 = tail call ptr @__dynamic_cast(ptr nonnull %6, ptr nonnull @_ZTI12cOwnedObject, ptr nonnull @_ZTI16cClassDescriptor, i64 0) #23
  br label %10
...
; Function Attrs: sspstrong uwtable
define dso_local noundef i32 @_ZNK16cClassDescriptor25getInheritanceChainLengthEv(ptr noundef nonnull align 8 dereferenceable(88) %0) local_unnamed_addr #3 align 2 {
  %2 = load ptr, ptr %0, align 8, !tbaa !13
...
; Function Attrs: sspstrong uwtable
define dso_local noundef zeroext i1 @_ZNK16cClassDescriptor14extendsCObjectEv(ptr noundef nonnull align 8 dereferenceable(88) %0) local_unnamed_addr #3 align 2 {
...
6:                                                ; preds = %5, %15
  ...
  %12 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(8) @.str.8, ptr noundef nonnull dereferenceable(1) %11) #24
  %13 = icmp eq i32 %12, 0
...
; Function Attrs: sspstrong uwtable
define dso_local noundef ptr @_ZN16cClassDescriptor16getDescriptorForEP7cObject(ptr noundef %0) local_unnamed_addr #3 align 2 {
  %2 = load ptr, ptr %0, align 8, !tbaa !13
...
12:                                               ; preds = %1
  %13 = tail call ptr @__dynamic_cast(ptr nonnull %10, ptr nonnull @_ZTI12cOwnedObject, ptr nonnull @_ZTI16cClassDescriptor, i64 0) #23
...
31:                                               ; preds = %22
  %32 = tail call ptr @__dynamic_cast(ptr nonnull %29, ptr nonnull @_ZTI12cOwnedObject, ptr nonnull @_ZTI16cClassDescriptor, i64 0) #23
...
attributes #10 = { mustprogress nofree nounwind sspstrong willreturn uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
...
attributes #16 = { noinline noreturn nounwind sspstrong uwtable "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+avx,+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave" "tune-cpu"="generic" }
...
!18 = !{!7, !12, i64 16}
!19 = !{!20, !9, i64 72}
!20 = !{!"_ZTS16cClassDescriptor", !21, i64 0, !22, i64 40, !9, i64 72, !17, i64 80, !17, i64 84}
