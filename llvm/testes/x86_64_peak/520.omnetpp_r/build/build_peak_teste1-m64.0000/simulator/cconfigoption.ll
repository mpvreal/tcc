...
@switch.table._ZN13cConfigOption11getTypeNameENS_4TypeE = private unnamed_addr constant [8 x ptr] [ptr @.str.11, ptr @.str.12, ptr @.str.13, ptr @.str.14, ptr @.str.15, ptr @.str.16, ptr @.str.17, ptr @.str.18], align 8
...
define dso_local void @_ZN13cConfigOptionC2EPKcbbNS_4TypeES1_S1_S1_(ptr noundef nonnull align 8 dereferenceable(144) %0, ptr noundef %1, i1 noundef zeroext %2, i1 noundef zeroext %3, i32 noundef %4, ptr noundef %5, ptr noundef %6, ptr noundef %7) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  %9 = zext i1 %2 to i8
  %10 = zext i1 %3 to i8
  ...
  store ptr getelementptr inbounds ({ [26 x ptr] }, ptr @_ZTV13cConfigOption, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !5
  ...
  store i8 %9, ptr %20, align 4, !tbaa !16
  %21 = getelementptr inbounds %class.cConfigOption, ptr %0, i64 0, i32 2
  store i8 %10, ptr %21, align 1, !tbaa !26
...
27:                                               ; preds = %8
  %28 = load i32, ptr %22, align 8, !tbaa !27
  %29 = icmp eq i32 %28, 0
...
45:                                               ; preds = %38
  tail call void @_ZdlPv(ptr noundef %40) #12
  br label %60
...
46:                                               ; preds = %32, %27
  ...
  %51 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %49) #11
...
53:                                               ; preds = %46
  ...
  %57 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %55) #11
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZNK13cConfigOption4infoB5cxx11Ev(ptr noalias sret(%"class.std::__cxx11::basic_string") align 8 %0, ptr nocapture noundef nonnull readonly align 8 dereferenceable(144) %1) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  ...
  %6 = load i8, ptr %5, align 4, !tbaa !16, !range !29, !noundef !30
  %7 = icmp eq i8 %6, 0
...
11:                                               ; preds = %2
  ...
  %13 = load i8, ptr %12, align 1, !tbaa !26, !range !29, !noundef !30
  %14 = icmp eq i8 %13, 0
...
28:                                               ; preds = %20, %24
  %29 = phi ptr [ %27, %24 ], [ @.str.19, %20 ]
  %30 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %29) #11
...
73:                                               ; preds = %69, %62
  ...
  store ptr %74, ptr %0, align 8, !tbaa !8, !alias.scope !37
  %75 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %0, i64 0, i32 1
  store i64 0, ptr %75, align 8, !tbaa !12, !alias.scope !37
  store i8 0, ptr %74, align 8, !tbaa !15, !alias.scope !37
  %76 = getelementptr inbounds %"class.std::__cxx11::basic_stringstream", ptr %3, i64 0, i32 1, i32 0, i32 5
  %77 = load ptr, ptr %76, align 8, !tbaa !38, !noalias !37
...
85:                                               ; preds = %73
  ...
  %87 = load ptr, ptr %86, align 8, !tbaa !41, !noalias !37
...
92:                                               ; preds = %100, %85
  %93 = landingpad { ptr, i32 }
          cleanup
  %94 = load ptr, ptr %0, align 8, !tbaa !28, !alias.scope !37
  %95 = icmp eq ptr %94, %74
  br i1 %95, label %96, label %99

96:                                               ; preds = %92
  %97 = load i64, ptr %75, align 8, !tbaa !12, !alias.scope !37
...
102:                                              ; preds = %100, %85
  ...
  store ptr %108, ptr %4, align 8, !tbaa !5
  %109 = getelementptr inbounds %"class.std::__cxx11::basic_stringstream", ptr %3, i64 0, i32 1
  store ptr getelementptr inbounds ({ [16 x ptr] }, ptr @_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE, i64 0, inrange i32 0, i64 2), ptr %109, align 8, !tbaa !5
...
119:                                              ; preds = %114, %118
  store ptr getelementptr inbounds ({ [16 x ptr] }, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 0, inrange i32 0, i64 2), ptr %109, align 8, !tbaa !5
  %120 = getelementptr inbounds %"class.std::__cxx11::basic_stringstream", ptr %3, i64 0, i32 1, i32 0, i32 7
  call void @_ZNSt6localeD1Ev(ptr noundef nonnull align 8 dereferenceable(8) %120) #11
  ...
  store ptr %121, ptr %3, align 8, !tbaa !5
...
define dso_local noundef nonnull ptr @_ZN13cConfigOption11getTypeNameENS_4TypeE(i32 noundef %0) local_unnamed_addr #3 align 2 {
  %2 = icmp ult i32 %0, 8
...
define linkonce_odr dso_local void @_ZN13cConfigOptionD2Ev(ptr noundef nonnull align 8 dereferenceable(144) %0) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [26 x ptr] }, ptr @_ZTV13cConfigOption, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !5
...
; Function Attrs: inlinehint sspstrong uwtable
define linkonce_odr dso_local void @_ZN13cConfigOptionD0Ev(ptr noundef nonnull align 8 dereferenceable(144) %0) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [26 x ptr] }, ptr @_ZTV13cConfigOption, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !5
  %2 = getelementptr inbounds %class.cConfigOption, ptr %0, i64 0, i32 6
  %3 = load ptr, ptr %2, align 8, !tbaa !28
  %4 = getelementptr inbounds %class.cConfigOption, ptr %0, i64 0, i32 6, i32 2
...
declare noundef ptr @_ZNK23cNoncopyableOwnedObject3dupEv(ptr noundef nonnull align 8 dereferenceable(36)) unnamed_addr #4
...
declare void @_ZN23cNoncopyableOwnedObject10parsimPackEP11cCommBuffer(ptr noundef nonnull align 8 dereferenceable(36), ptr noundef) unnamed_addr #4

declare void @_ZN23cNoncopyableOwnedObject12parsimUnpackEP11cCommBuffer(ptr noundef nonnull align 8 dereferenceable(36), ptr noundef) unnamed_addr #4
...
!15 = !{!11, !11, i64 0}
!16 = !{!17, !24, i64 36}
!17 = !{!"_ZTS13cConfigOption", !18, i64 0, !24, i64 36, !24, i64 37, !25, i64 40, !13, i64 48, !13, i64 80, !13, i64 112}
...
!23 = !{!"int", !11, i64 0}
!24 = !{!"bool", !11, i64 0}
!25 = !{!"_ZTSN13cConfigOption4TypeE", !11, i64 0}
!26 = !{!17, !24, i64 37}
!27 = !{!17, !25, i64 40}
!28 = !{!13, !10, i64 0}
!29 = !{i8 0, i8 2}
