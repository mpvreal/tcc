...
@_ZL7yytname = internal unnamed_addr constant [14 x ptr] [ptr @.str.19, ptr @.str.20, ptr @.str.21, ptr @.str.22, ptr @.str.23, ptr @.str.24, ptr @.str.25, ptr @.str.26, ptr @.str.27, ptr @.str.28, ptr @.str.29, ptr @.str.30, ptr @.str.31, ptr null], align 16
...
define dso_local noundef i32 @_Z22matchexpressionyyparsePv(ptr nocapture noundef readonly %0) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
  ...
  %14 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
  %15 = icmp eq i32 %14, 0
...
19:                                               ; preds = %16, %1
  store i16 0, ptr %7, align 16, !tbaa !11
...
42:                                               ; preds = %19, %33
  ...
  %47 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
  %48 = icmp eq i32 %47, 0
...
62:                                               ; preds = %60
  %63 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
  %64 = icmp eq i32 %63, 0
...
74:                                               ; preds = %71
  %75 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
  %76 = icmp eq i32 %75, 0
...
87:                                               ; preds = %80, %82
  ...
  %89 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
  %90 = icmp eq i32 %89, 0
...
91:                                               ; preds = %87
  ...
  %97 = select i1 %95, ptr @.str.16, ptr @.str.17
...
119:                                              ; preds = %115
  %120 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
...
122:                                              ; preds = %119
  ...
  %128 = select i1 %126, ptr @.str.16, ptr @.str.17
...
148:                                              ; preds = %140
  ...
  %156 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
...
158:                                              ; preds = %148
  ...
  %164 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %162, ptr noundef nonnull @.str.32, i32 noundef %163, i64 noundef %161) #20
...
168:                                              ; preds = %168, %158
  ...
  %172 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %170, ptr noundef nonnull @.str.33, i32 noundef %171) #20
  ...
  %186 = select i1 %183, ptr @.str.17, ptr @.str.16
...
202:                                              ; preds = %195
  ...
  store ptr %204, ptr %203, align 8, !tbaa !18
...
206:                                              ; preds = %202
  ...
  %210 = load ptr, ptr %208, align 8, !tbaa !28
...
217:                                              ; preds = %202
  %218 = load ptr, ptr %197, align 8, !tbaa !29
  %219 = getelementptr inbounds %"class.MatchExpression::Elem", ptr %218, i64 1
  store ptr %219, ptr %197, align 8, !tbaa !29
  br label %221
...
234:                                              ; preds = %227
  ...
  store ptr %236, ptr %235, align 8, !tbaa !18
  ...
  store i32 0, ptr %230, align 8, !tbaa !23
...
249:                                              ; preds = %234
  %250 = load ptr, ptr %229, align 8, !tbaa !29
  %251 = getelementptr inbounds %"class.MatchExpression::Elem", ptr %250, i64 1
  store ptr %251, ptr %229, align 8, !tbaa !29
  br label %253
...
259:                                              ; preds = %194
  ...
  store i32 2, ptr %11, align 8, !tbaa !23
...
266:                                              ; preds = %259
  ...
  store i64 0, ptr %269, align 8, !tbaa !20
  store i8 0, ptr %268, align 8, !tbaa !13
  store i32 0, ptr %262, align 8, !tbaa !23
...
270:                                              ; preds = %266
  ...
  %274 = load ptr, ptr %272, align 8, !tbaa !28
...
281:                                              ; preds = %266
  %282 = load ptr, ptr %261, align 8, !tbaa !29
  %283 = getelementptr inbounds %"class.MatchExpression::Elem", ptr %282, i64 1
  store ptr %283, ptr %261, align 8, !tbaa !29
  br label %285
...
293:                                              ; preds = %291
  %294 = load ptr, ptr %45, align 8, !tbaa !9
  %295 = load i8, ptr %21, align 8, !tbaa !30, !range !31, !noundef !32
  %296 = icmp ne i8 %295, 0
  %297 = load i8, ptr %22, align 1, !tbaa !33, !range !31, !noundef !32
  %298 = icmp ne i8 %297, 0
  %299 = load i8, ptr %23, align 2, !tbaa !34, !range !31, !noundef !32
...
322:                                              ; preds = %307
  %323 = load ptr, ptr %302, align 8, !tbaa !29
  %324 = getelementptr inbounds %"class.MatchExpression::Elem", ptr %323, i64 1
  store ptr %324, ptr %302, align 8, !tbaa !29
  br label %326
...
326:                                              ; preds = %322, %325
  ...
  %327 = load ptr, ptr %45, align 8, !tbaa !9
...
339:                                              ; preds = %337
  ...
  %342 = load i8, ptr %21, align 8, !tbaa !30, !range !31, !noundef !32
  %343 = icmp ne i8 %342, 0
  %344 = load i8, ptr %22, align 1, !tbaa !33, !range !31, !noundef !32
  %345 = icmp ne i8 %344, 0
  %346 = load i8, ptr %23, align 2, !tbaa !34, !range !31, !noundef !32
...
360:                                              ; preds = %356
  ...
  %364 = load ptr, ptr %362, align 8, !tbaa !28
...
371:                                              ; preds = %356
  %372 = load ptr, ptr %351, align 8, !tbaa !29
  %373 = getelementptr inbounds %"class.MatchExpression::Elem", ptr %372, i64 1
  store ptr %373, ptr %351, align 8, !tbaa !29
  br label %375
...
375:                                              ; preds = %371, %374
  ...
  %376 = load ptr, ptr %349, align 8, !tbaa !9
...
379:                                              ; preds = %378, %375
  %380 = load ptr, ptr %340, align 8, !tbaa !9
...
390:                                              ; preds = %379, %382, %326, %329, %221, %253, %285, %194
  %391 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
...
401:                                              ; preds = %390
  %402 = load ptr, ptr @stderr, align 8, !tbaa !9
  ...
  %410 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %404, ptr noundef nonnull @.str.17, ptr noundef %409) #20
  %411 = call i32 @fputc(i32 41, ptr %404)
  %412 = load ptr, ptr @stderr, align 8, !tbaa !9
  %413 = call i32 @fputc(i32 10, ptr %412)
  %414 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
...
424:                                              ; preds = %420, %424
  ...
  %427 = load i16, ptr %425, align 2, !tbaa !11
...
435:                                              ; preds = %393, %432, %401
  ...
  store ptr %155, ptr %440, align 8, !tbaa !9
  ...
  %445 = load i16, ptr %437, align 2, !tbaa !11
...
489:                                              ; preds = %488, %480
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %490, ptr noundef nonnull @.str.15, ptr noundef nonnull %4)
...
503:                                              ; preds = %502, %496
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %504, ptr noundef nonnull @.str.15, ptr noundef nonnull %3)
...
515:                                              ; preds = %514, %508
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %516, ptr noundef nonnull @.str.15, ptr noundef nonnull %2)
...
523:                                              ; preds = %520
  %524 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
  %525 = icmp eq i32 %524, 0
  br i1 %525, label %557, label %526

526:                                              ; preds = %523
  %527 = load ptr, ptr @stderr, align 8, !tbaa !9
  ...
  %532 = select i1 %530, ptr @.str.16, ptr @.str.17
...
539:                                              ; preds = %520, %526
  %540 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
...
546:                                              ; preds = %542, %546
  ...
  %548 = load ptr, ptr @stderr, align 8, !tbaa !9
  %549 = load i16, ptr %547, align 2, !tbaa !11
...
566:                                              ; preds = %562
  %567 = load i16, ptr %564, align 2, !tbaa !11
  ...
  %578 = select i1 %576, ptr @.str.17, ptr @.str.16
  ...
  %585 = load i32, ptr @matchexpressionyydebug, align 4, !tbaa !5
  br label %586
...
586:                                              ; preds = %562, %566
  ...
  br i1 %589, label %590, label %562, !llvm.loop !35
...
41:                                               ; preds = %26, %39
  ...
  store ptr %23, ptr %4, align 16, !tbaa !9
...
124:                                              ; preds = %122, %164
  ...
  %128 = load i8, ptr %125, align 1, !tbaa !13
...
152:                                              ; preds = %148, %142
  ...
  store i8 %153, ptr %155, align 1, !tbaa !13
  %156 = add i64 %143, 1
  br label %142
...
10:                                               ; preds = %9, %1
  ...
  invoke void (ptr, ptr, ...) @_ZN17opp_runtime_errorC1EPKcz(ptr noundef nonnull align 8 dereferenceable(48) %11, ptr noundef nonnull @.str.15, ptr noundef nonnull %2)
...
8:                                                ; preds = %5
  ...
  store i8 %11, ptr %12, align 8, !tbaa !30
  ...
  store i8 %9, ptr %14, align 2, !tbaa !34
...
define linkonce_odr dso_local void @_ZN17opp_runtime_errorD2Ev(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV17opp_runtime_error, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !37
...
; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local void @_ZN17opp_runtime_errorD0Ev(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV17opp_runtime_error, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !37
  %2 = getelementptr inbounds %class.opp_runtime_error, ptr %0, i64 0, i32 1
  %3 = load ptr, ptr %2, align 8, !tbaa !28
  %4 = getelementptr inbounds %class.opp_runtime_error, ptr %0, i64 0, i32 1, i32 2
...
; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local noundef ptr @_ZNK17opp_runtime_error4whatEv(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
  %2 = getelementptr inbounds %class.opp_runtime_error, ptr %0, i64 0, i32 1
  %3 = load ptr, ptr %2, align 8, !tbaa !28
  ret ptr %3
}
...
33:                                               ; preds = %27
  ...
  %35 = load ptr, ptr %30, align 8, !tbaa !28
  %36 = icmp eq ptr %35, %31
  br i1 %36, label %37, label %40

37:                                               ; preds = %33
  %38 = load i64, ptr %32, align 8, !tbaa !20
...
!13 = !{!7, !7, i64 0}
!14 = !{!15, !10, i64 16}
!15 = !{!"_ZTS27_MatchExpressionParserState", !10, i64 0, !16, i64 8, !16, i64 9, !16, i64 10, !10, i64 16}
!16 = !{!"bool", !7, i64 0}
!17 = !{!15, !10, i64 0}
!18 = !{!19, !10, i64 0}
...
!22 = !{!"long", !7, i64 0}
!23 = !{!24, !25, i64 0}
!24 = !{!"_ZTSN15MatchExpression4ElemE", !25, i64 0, !21, i64 8, !10, i64 40}
!25 = !{!"_ZTSN15MatchExpression4Elem4TypeE", !7, i64 0}
!26 = !{!27, !10, i64 16}
!27 = !{!"_ZTSNSt12_Vector_baseIN15MatchExpression4ElemESaIS1_EE17_Vector_impl_dataE", !10, i64 0, !10, i64 8, !10, i64 16}
!28 = !{!21, !10, i64 0}
!29 = !{!27, !10, i64 8}
!30 = !{!15, !16, i64 8}
!31 = !{i8 0, i8 2}
