...
define dso_local void @_ZN16ExecuteOnStartupC2EPFvvE(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1) unnamed_addr #0 align 2 {
  ...
  %3 = load ptr, ptr @_ZN16ExecuteOnStartup4headE, align 8, !tbaa !10
  %4 = getelementptr inbounds %class.ExecuteOnStartup, ptr %0, i64 0, i32 1
  store ptr %3, ptr %4, align 8, !tbaa !11
  store ptr %0, ptr @_ZN16ExecuteOnStartup4headE, align 8, !tbaa !10
  ret void
}
...
define dso_local void @_ZN16ExecuteOnStartup10executeAllEv() local_unnamed_addr #2 align 2 {
  %1 = load ptr, ptr @_ZN16ExecuteOnStartup4headE, align 8, !tbaa !10
...
9:                                                ; preds = %3, %0
  store ptr null, ptr @_ZN16ExecuteOnStartup4headE, align 8, !tbaa !10
  ret void
}
...
!5 = !{!6, !7, i64 0}
!6 = !{!"_ZTS16ExecuteOnStartup", !7, i64 0, !7, i64 8}
