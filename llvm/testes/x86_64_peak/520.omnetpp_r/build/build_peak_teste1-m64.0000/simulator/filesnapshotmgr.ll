...
@.str.2 = private unnamed_addr constant [14 x i8] c"snapshot-file\00", align 1
@.str.3 = private unnamed_addr constant [44 x i8] c"${resultdir}/${configname}-${runnumber}.sna\00", align 1
@.str.4 = private unnamed_addr constant [27 x i8] c"Name of the snapshot file.\00", align 1
...
define internal void @_ZN12_GLOBAL__N_119__onstartup_func_35Ev() #0 personality ptr @__gxx_personality_v0 {
  ...
  %2 = tail call noalias noundef nonnull dereferenceable(144) ptr @_Znwm(i64 noundef 144) #14
  invoke void @_ZN13cConfigOptionC1EPKcbbNS_4TypeES1_S1_S1_(ptr noundef nonnull align 8 dereferenceable(144) %2, ptr noundef nonnull @.str.2, i1 noundef zeroext false, i1 noundef zeroext false, i32 noundef 4, ptr noundef null, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4)
          to label %3 unwind label %7

3:                                                ; preds = %0
  store ptr %2, ptr @CFGID_SNAPSHOT_FILE, align 8, !tbaa !5
...
define dso_local void @_ZN20cFileSnapshotManagerC2Ev(ptr nocapture noundef nonnull writeonly align 8 dereferenceable(16) %0) unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [26 x ptr] }, ptr @_ZTV20cFileSnapshotManager, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !9
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN20cFileSnapshotManagerD2Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [26 x ptr] }, ptr @_ZTV20cFileSnapshotManager, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !9
  %2 = getelementptr inbounds %class.cFileSnapshotManager, ptr %0, i64 0, i32 1
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN20cFileSnapshotManagerD0Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [26 x ptr] }, ptr @_ZTV20cFileSnapshotManager, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !9
  %2 = getelementptr inbounds %class.cFileSnapshotManager, ptr %0, i64 0, i32 1
  %3 = load ptr, ptr %2, align 8, !tbaa !11
  %4 = icmp eq ptr %3, null
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN20cFileSnapshotManager8startRunEv(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  ...
  %8 = load ptr, ptr @CFGID_SNAPSHOT_FILE, align 8, !tbaa !5
...
22:                                               ; preds = %19
  %23 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %12) #17
  %24 = add i64 %23, 1
  %25 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %24) #14
          to label %26 unwind label %47

26:                                               ; preds = %22
  %27 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %25, ptr noundef nonnull dereferenceable(1) %12) #16
  br label %28
...
38:                                               ; preds = %33, %37
  ...
  %39 = load ptr, ptr @_ZN11cSimulation5evPtrE, align 8, !tbaa !5, !nonnull !19, !noundef !19
  %40 = call ptr @__dynamic_cast(ptr nonnull %39, ptr nonnull @_ZTI6cEnvir, ptr nonnull @_ZTI9EnvirBase, i64 0) #16
  ...
  call void @_Z10removeFilePKcS0_(ptr noundef nonnull %46, ptr noundef nonnull @.str)
  ret void
...
define dso_local void @_ZN20cFileSnapshotManager6endRunEv(ptr nocapture nonnull align 8 %0) unnamed_addr #7 align 2 {
  ret void
}

; Function Attrs: sspstrong uwtable
define dso_local noundef nonnull ptr @_ZN20cFileSnapshotManager20getStreamForSnapshotEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %0) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  %2 = alloca %"class.std::__cxx11::basic_string", align 8
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %2) #16
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN20cFileSnapshotManager24releaseStreamForSnapshotEPSo(ptr nocapture nonnull readnone align 8 %0, ptr noundef %1) unnamed_addr #0 align 2 {
...
define dso_local noundef nonnull ptr @_ZNK20cFileSnapshotManager11getFileNameEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %0) unnamed_addr #9 align 2 {
  %2 = getelementptr inbounds %class.cFileSnapshotManager, ptr %0, i64 0, i32 1
  %3 = load ptr, ptr %2, align 8, !tbaa !11
  %4 = icmp eq ptr %3, null
...
define linkonce_odr dso_local noundef ptr @_ZNK7cObject7getNameEv(ptr noundef nonnull align 8 dereferenceable(8) %0) unnamed_addr #10 comdat align 2 {
  ret ptr @.str.5
}
...
; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local noundef ptr @_ZNK7cObject8getOwnerEv(ptr noundef nonnull align 8 dereferenceable(8) %0) unnamed_addr #10 comdat align 2 {
  ret ptr null
}
...
; Function Attrs: sspstrong uwtable
define internal noalias noundef nonnull ptr @_ZL15__uniquename_38v() #0 personality ptr @__gxx_personality_v0 {
  %1 = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #14
  store ptr getelementptr inbounds ({ [26 x ptr] }, ptr @_ZTV20cFileSnapshotManager, i64 0, inrange i32 0, i64 2), ptr %1, align 8, !tbaa !9
...
; Function Attrs: sspstrong uwtable
define internal void @_GLOBAL__sub_I_filesnapshotmgr.cc() #0 section ".text.startup" {
  ...
  %2 = tail call i32 @__cxa_atexit(ptr nonnull @_ZN16ExecuteOnStartupD1Ev, ptr nonnull @_ZN12_GLOBAL__N_118__onstartup_obj_38E, ptr nonnull @__dso_handle) #16
  ret void
}
