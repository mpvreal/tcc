...
54:                                               ; preds = %58, %52
  ...
  %57 = load i8, ptr %55, align 1, !tbaa !16
...
80:                                               ; preds = %76
  store i8 8, ptr %74, align 1, !tbaa !16
  br label %142

81:                                               ; preds = %76
  store i8 12, ptr %74, align 1, !tbaa !16
  br label %142

82:                                               ; preds = %76
  store i8 10, ptr %74, align 1, !tbaa !16
  br label %142

83:                                               ; preds = %76
  store i8 13, ptr %74, align 1, !tbaa !16
  br label %142

84:                                               ; preds = %76
  store i8 9, ptr %74, align 1, !tbaa !16
  br label %142
...
129:                                              ; preds = %125, %122, %118, %102, %98
  ...
  store i8 %132, ptr %74, align 1, !tbaa !16
  %133 = getelementptr inbounds i8, ptr %130, i64 -1
  br label %142

134:                                              ; preds = %76
  store i8 34, ptr %74, align 1, !tbaa !16
  br label %142

135:                                              ; preds = %76
  store i8 92, ptr %74, align 1, !tbaa !16
  br label %142
...
161:                                              ; preds = %157, %68, %156
  ...
  %164 = load i32, ptr %35, align 4, !tbaa !17
  %165 = load i32, ptr %37, align 8, !tbaa !12
  %166 = icmp eq i32 %164, %165
  br i1 %166, label %167, label %174

167:                                              ; preds = %161
  %168 = tail call ptr @__cxa_allocate_exception(i64 48) #11
  %169 = load i32, ptr %37, align 8, !tbaa !12
...
174:                                              ; preds = %161
  %175 = load ptr, ptr %38, align 8, !tbaa !13
  %176 = add nsw i32 %164, 1
  store i32 %176, ptr %35, align 4, !tbaa !17
  %177 = sext i32 %164 to i64
  %178 = getelementptr inbounds ptr, ptr %175, i64 %177
  store ptr %163, ptr %178, align 8, !tbaa !18
  br label %39
...
define linkonce_odr dso_local void @_ZN17opp_runtime_errorD2Ev(ptr noundef nonnull align 8 dereferenceable(48) %0) unnamed_addr #2 comdat align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV17opp_runtime_error, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !19
...
!5 = !{!6, !7, i64 0}
!6 = !{!"_ZTS13LineTokenizer", !7, i64 0, !7, i64 1, !9, i64 4, !10, i64 8, !10, i64 16, !9, i64 24, !9, i64 28}
