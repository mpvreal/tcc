...
32:                                               ; preds = %22, %27
  ...
  %34 = icmp eq i32 %33, %1
  br i1 %34, label %37, label %22, !llvm.loop !12
...
48:                                               ; preds = %39, %44
  ...
  %50 = icmp eq i32 %49, %1
  br i1 %50, label %53, label %39, !llvm.loop !13
...
62:                                               ; preds = %55, %60
  ...
  %64 = icmp eq i32 %63, %1
  br i1 %64, label %67, label %55, !llvm.loop !14
...
declare void @spec_srand(i32 noundef) local_unnamed_addr #3

declare nofpclass(nan inf) double @spec_rand() local_unnamed_addr #3

declare i64 @spec_lrand48() local_unnamed_addr #3
