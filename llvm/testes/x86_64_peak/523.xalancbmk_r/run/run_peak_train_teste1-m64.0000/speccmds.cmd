...
-o train-allbooks.out -e train-allbooks.err echo "../run_peak_train_teste1-m64.0000/cpuxalan_r_peak.teste1-m64 -v allbooks.xml xalanc.xsl" > run.sh ; $BIND bash run.sh
