...
define dso_local noundef float @_ZN7Playout9get_scoreEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(120) %0) local_unnamed_addr #2 align 2 {
...
define dso_local void @_ZN7Playout15set_final_scoreEf(ptr nocapture noundef nonnull writeonly align 8 dereferenceable(120) %0, float noundef %1) local_unnamed_addr #3 align 2 {
...
define dso_local void @_ZN7Playout3runER9FastStateb(ptr nocapture noundef nonnull align 8 dereferenceable(120) %0, ptr noundef nonnull align 8 dereferenceable(8388) %1, i1 noundef zeroext %2) local_unnamed_addr #4 align 2 {
...
43:                                               ; preds = %40
  ...
  br i1 %46, label %10, label %80, !llvm.loop !16
...
76:                                               ; preds = %73
  ...
  br i1 %79, label %47, label %80, !llvm.loop !16
...
95:                                               ; preds = %85, %93
  ...
  %101 = load i64, ptr %98, align 8, !tbaa !14
  %102 = or i64 %101, %100
  store i64 %102, ptr %98, align 8, !tbaa !14
  br label %103

103:                                              ; preds = %95, %93, %90
  %104 = add nuw nsw i32 %86, 1
  %105 = icmp eq i32 %104, %5
  br i1 %105, label %106, label %85, !llvm.loop !18

106:                                              ; preds = %103
  %107 = add nuw nsw i32 %84, 1
  %108 = icmp eq i32 %107, %5
  br i1 %108, label %109, label %83, !llvm.loop !19
...
declare noundef i32 @_ZN9FastState16play_random_moveEv(ptr noundef nonnull align 8 dereferenceable(8388)) local_unnamed_addr #6
...
declare noundef i32 @_ZN9FastState11get_movenumEv(ptr noundef nonnull align 8 dereferenceable(8388)) local_unnamed_addr #6

declare noundef i32 @_ZN9FastState17estimate_mc_scoreEv(ptr noundef nonnull align 8 dereferenceable(8388)) local_unnamed_addr #6

declare noundef float @_ZN9FastState18calculate_mc_scoreEv(ptr noundef nonnull align 8 dereferenceable(8388)) local_unnamed_addr #6
...
declare noundef zeroext i1 @_ZN9FastBoard6is_eyeEii(ptr noundef nonnull align 8 dereferenceable(8052), i32 noundef, i32 noundef) local_unnamed_addr #6

declare noundef ptr @_ZN12MCOwnerTable7get_MCOEv() local_unnamed_addr #6

declare void @_ZN12MCOwnerTable6updateERSt6bitsetILm441EE(ptr noundef nonnull align 8 dereferenceable(40), ptr noundef nonnull align 8 dereferenceable(56)) local_unnamed_addr #6

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(argmem: read) uwtable
define dso_local noundef zeroext i1 @_ZN7Playout11passthroughEii(ptr nocapture noundef nonnull readonly align 8 dereferenceable(120) %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #2 align 2 {
  %4 = icmp eq i32 %2, -1
...
define dso_local void @_ZN7Playout20do_playout_benchmarkER9GameState(ptr noundef nonnull align 8 dereferenceable(8508) %0) local_unnamed_addr #7 align 2 {
...
19:                                               ; preds = %16
  ...
  br i1 %22, label %12, label %23, !llvm.loop !20
...
23:                                               ; preds = %16, %12, %19
  ...
  br i1 %30, label %31, label %8, !llvm.loop !21

31:                                               ; preds = %23
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #13
  call void @_ZN4TimeC1Ev(ptr noundef nonnull align 4 dereferenceable(4) %3)
  %32 = load i32, ptr %2, align 4, !tbaa.struct !22
  %33 = load i32, ptr %3, align 4, !tbaa.struct !22
  %34 = call noundef i32 @_ZN4Time8timediffES_S_(i32 %32, i32 %33)
  %35 = sitofp i32 %34 to float
  %36 = fpext float %35 to double
  %37 = fdiv double %36, 1.000000e+02
  %38 = load i32, ptr %2, align 4, !tbaa.struct !22
  %39 = load i32, ptr %3, align 4, !tbaa.struct !22
...
declare void @_ZN4TimeC1Ev(ptr noundef nonnull align 4 dereferenceable(4)) unnamed_addr #6
...
declare noundef i32 @_ZN4Time8timediffES_S_(i32, i32) local_unnamed_addr #6

; Function Attrs: mustprogress nocallback nofree nounwind willreturn memory(argmem: readwrite)
declare void @llvm.memcpy.p0.p0.i64(ptr noalias nocapture writeonly, ptr noalias nocapture readonly, i64, i1 immarg) #8

; Function Attrs: sspstrong uwtable
define dso_local noundef float @_ZN7Playout8mc_ownerER9FastStatei(ptr noundef nonnull align 8 dereferenceable(8388) %0, i32 noundef %1) local_unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
...
41:                                               ; preds = %31
  ...
  br i1 %42, label %43, label %44, !prof !27
...
53:                                               ; preds = %51
  %54 = load i32, ptr %35, align 4, !tbaa !23
  store i32 %54, ptr %47, align 4, !tbaa !23
  br label %55

55:                                               ; preds = %53, %51, %50
  store ptr %48, ptr %11, align 8, !tbaa !30
  %56 = load i32, ptr %14, align 8, !tbaa !33
  store i32 %56, ptr %13, align 8, !tbaa !33
...
57:                                               ; preds = %55
  %58 = load float, ptr %20, align 4, !tbaa !13
...
65:                                               ; preds = %57, %64
  ...
  %67 = icmp eq i32 %66, %1
  br i1 %67, label %21, label %31, !llvm.loop !44
...
!6 = !{!7, !8, i64 0}
!7 = !{!"_ZTS7Playout", !8, i64 0, !11, i64 4, !12, i64 8}
!8 = !{!"bool", !9, i64 0}
!9 = !{!"omnipotent char", !10, i64 0}
!10 = !{!"Simple C++ TBAA"}
!11 = !{!"float", !9, i64 0}
!12 = !{!"_ZTSN5boost5arrayISt6bitsetILm441EELm2EEE", !9, i64 0}
!13 = !{!7, !11, i64 4}
!14 = !{!15, !15, i64 0}
!15 = !{!"long", !9, i64 0}
!16 = distinct !{!16, !17}
...
!28 = !{!29, !26, i64 0}
!29 = !{!"_ZTSNSt12_Vector_baseIiSaIiEE17_Vector_impl_dataE", !26, i64 0, !26, i64 8, !26, i64 16}
!30 = !{!29, !26, i64 8}
!31 = !{!29, !26, i64 16}
!32 = !{!"branch_weights", i32 2000, i32 1}
!33 = !{!34, !24, i64 8048}
!34 = !{!"_ZTS9FastBoard", !35, i64 0, !35, i64 882, !24, i64 1764, !24, i64 1768, !24, i64 1772, !36, i64 1776, !37, i64 3540, !37, i64 4424, !37, i64 5308, !37, i64 6192, !35, i64 7076, !38, i64 7960, !39, i64 7976, !40, i64 8008, !40, i64 8016, !41, i64 8024, !24, i64 8048}
!35 = !{!"_ZTSN5boost5arrayItLm441EEE", !9, i64 0}
!36 = !{!"_ZTSN5boost5arrayIN9FastBoard8square_tELm441EEE", !9, i64 0}
!37 = !{!"_ZTSN5boost5arrayItLm442EEE", !9, i64 0}
!38 = !{!"_ZTSN5boost5arrayIiLm4EEE", !9, i64 0}
!39 = !{!"_ZTSN5boost5arrayIiLm8EEE", !9, i64 0}
!40 = !{!"_ZTSN5boost5arrayIiLm2EEE", !9, i64 0}
!41 = !{!"_ZTSSt6vectorIiSaIiEE", !42, i64 0}
!42 = !{!"_ZTSSt12_Vector_baseIiSaIiEE", !43, i64 0}
!43 = !{!"_ZTSNSt12_Vector_baseIiSaIiEE12_Vector_implE", !29, i64 0}
!44 = distinct !{!44, !17}
