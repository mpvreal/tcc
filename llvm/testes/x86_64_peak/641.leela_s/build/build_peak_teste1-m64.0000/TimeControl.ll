...
declare void @_ZN4TimeC1Ev(ptr noundef nonnull align 4 dereferenceable(4)) unnamed_addr #2

; Function Attrs: mustprogress sspstrong uwtable
define dso_local void @_ZN11TimeControl5startEi(ptr nocapture noundef nonnull writeonly align 4 dereferenceable(44) %0, i32 noundef %1) local_unnamed_addr #3 align 2 {
...
; Function Attrs: mustprogress sspstrong uwtable
define dso_local void @_ZN11TimeControl4stopEi(ptr nocapture noundef nonnull align 4 dereferenceable(44) %0, i32 noundef %1) local_unnamed_addr #3 align 2 {
  %3 = alloca %class.Time, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #6
  call void @_ZN4TimeC1Ev(ptr noundef nonnull align 4 dereferenceable(4) %3)
  %4 = getelementptr inbounds %class.TimeControl, ptr %0, i64 0, i32 7
  %5 = sext i32 %1 to i64
  %6 = getelementptr inbounds [2 x %class.Time], ptr %4, i64 0, i64 %5
  %7 = load i32, ptr %6, align 4, !tbaa.struct !20
  %8 = load i32, ptr %3, align 4, !tbaa.struct !20
...
declare noundef i32 @_ZN4Time8timediffES_S_(i32, i32) local_unnamed_addr #2
...
define dso_local noundef zeroext i1 @_ZN11TimeControl12time_forfeitEi(ptr nocapture noundef nonnull readonly align 4 dereferenceable(44) %0, i32 noundef %1) local_unnamed_addr #5 align 2 {
  ...
  %6 = load i8, ptr %5, align 1, !tbaa !17, !range !21, !noundef !22
  %7 = icmp eq i8 %6, 0
...
; Function Attrs: mustprogress sspstrong uwtable
define dso_local void @_ZN11TimeControl13display_timesEv(ptr nocapture noundef nonnull readonly align 4 dereferenceable(44) %0) local_unnamed_addr #3 align 2 {
  ...
  %13 = load i8, ptr %12, align 4, !tbaa !17, !range !21, !noundef !22
  %14 = icmp eq i8 %13, 0
...
18:                                               ; preds = %15, %1
  ...
  %30 = load i8, ptr %29, align 1, !tbaa !17, !range !21, !noundef !22
  %31 = icmp eq i8 %30, 0
...
declare void @_ZN5Utils8myprintfEPKcz(ptr noundef, ...) local_unnamed_addr #2
...
21:                                               ; preds = %17
  ...
  %25 = load i8, ptr %24, align 1, !tbaa !17, !range !21, !noundef !22
  %26 = icmp eq i8 %25, 0
...
!6 = !{!7, !8, i64 0}
!7 = !{!"_ZTS11TimeControl", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !11, i64 16, !11, i64 24, !12, i64 32, !13, i64 36}
!8 = !{!"int", !9, i64 0}
!9 = !{!"omnipotent char", !10, i64 0}
!10 = !{!"Simple C++ TBAA"}
!11 = !{!"_ZTSN5boost5arrayIiLm2EEE", !9, i64 0}
!12 = !{!"_ZTSN5boost5arrayIbLm2EEE", !9, i64 0}
!13 = !{!"_ZTSN5boost5arrayI4TimeLm2EEE", !9, i64 0}
!14 = !{!7, !8, i64 4}
!15 = !{!7, !8, i64 8}
!16 = !{!8, !8, i64 0}
!17 = !{!18, !18, i64 0}
