...
-o train_convert.out -e train_convert.err echo "../run_peak_train_teste1-m64.0000/imagick_r_peak.teste1-m64 -limit disk 0 train_input.tga -resize 320x240 -shear 31 -edge 140 -negate -flop -resize 900x900 -edge 10 train_output.tga" > run.sh ; $BIND bash run.sh
