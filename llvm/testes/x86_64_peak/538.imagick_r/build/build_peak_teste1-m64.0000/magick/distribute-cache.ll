...
14:                                               ; preds = %1
  ...
  store i64 2880220587, ptr %16, align 8, !tbaa !9
  ...
  %18 = tail call ptr @GetImageRegistry(i32 noundef 3, ptr noundef nonnull @.str.5, ptr noundef %0) #12
  store ptr %18, ptr %2, align 8, !tbaa !13
  %19 = icmp eq ptr %18, null
  br i1 %19, label %20, label %22

20:                                               ; preds = %14
  store i32 6668, ptr %17, align 4, !tbaa !5
  %21 = tail call ptr @AcquireString(ptr noundef nonnull @.str.6) #12
  br label %86

22:                                               ; preds = %14
  %23 = call i32 @SubstituteString(ptr noundef nonnull %2, ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.8) #12
...
29:                                               ; preds = %22
  store i32 6668, ptr %17, align 4, !tbaa !5
  %30 = call ptr @AcquireString(ptr noundef nonnull @.str.6) #12
  br label %86

31:                                               ; preds = %22
  %32 = load i64, ptr @GetHostname.id, align 8, !tbaa !15
  %33 = add i64 %32, 1
  store i64 %33, ptr @GetHostname.id, align 8, !tbaa !15
...
53:                                               ; preds = %44, %31
  ...
  %55 = call i32 @SubstituteString(ptr noundef nonnull %2, ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.8) #12
...
59:                                               ; preds = %53
  store i32 6668, ptr %17, align 4, !tbaa !5
  %60 = call ptr @AcquireString(ptr noundef nonnull @.str.6) #12
  br label %86
...
71:                                               ; preds = %68, %61
  ...
  store i32 %72, ptr %17, align 4, !tbaa !5
...
86:                                               ; preds = %20, %29, %59, %84
  ...
  %88 = call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef %0, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 243, i32 noundef 420, ptr noundef nonnull @.str.10, ptr noundef nonnull @.str.4) #12
...
95:                                               ; preds = %86
  store i64 -2880220588, ptr %16, align 8, !tbaa !9
...
97:                                               ; preds = %95, %86
  ...
  store i32 %99, ptr %100, align 8, !tbaa !21
  ret ptr %98
}
...
6:                                                ; preds = %4, %1
  ...
  store i64 -2880220588, ptr %7, align 8, !tbaa !9
...
define dso_local void @DistributePixelCacheServer(i32 noundef %0, ptr nocapture noundef readnone %1) local_unnamed_addr #6 {
  ...
  %7 = call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef nonnull %3, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 941, i32 noundef 420, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.3, ptr noundef %6) #12
...
define hidden i32 @GetDistributeCacheFile(ptr nocapture noundef readonly %0) local_unnamed_addr #7 {
  %2 = load i32, ptr %0, align 8, !tbaa !19
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(none) uwtable
define hidden nonnull ptr @GetDistributeCacheHostname(ptr noundef readnone %0) local_unnamed_addr #8 {
  %2 = getelementptr inbounds %struct._DistributeCacheInfo, ptr %0, i64 0, i32 2
  ret ptr %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(argmem: read) uwtable
define hidden i32 @GetDistributeCachePort(ptr nocapture noundef readonly %0) local_unnamed_addr #7 {
...
define hidden i32 @OpenDistributePixelCache(ptr nocapture noundef readnone %0, ptr nocapture noundef readnone %1) local_unnamed_addr #9 {
  %3 = tail call ptr @__errno_location() #13
  %4 = load i32, ptr %3, align 4, !tbaa !5
  %5 = icmp eq i32 %4, 4
  br i1 %5, label %6, label %7, !llvm.loop !22
...
; Function Attrs: nofree nosync nounwind sspstrong memory(read, inaccessiblemem: none) uwtable
define hidden i64 @ReadDistributePixelCacheIndexes(ptr nocapture noundef readnone %0, ptr nocapture noundef readnone %1, i64 noundef %2, ptr nocapture noundef readnone %3) local_unnamed_addr #9 {
  %5 = icmp slt i64 %2, 0
...
6:                                                ; preds = %4
  ...
  %9 = icmp eq i32 %8, 4
  br i1 %9, label %10, label %11, !llvm.loop !22
...
; Function Attrs: nofree nosync nounwind sspstrong memory(read, inaccessiblemem: none) uwtable
define hidden i64 @ReadDistributePixelCachePixels(ptr nocapture noundef readnone %0, ptr nocapture noundef readnone %1, i64 noundef %2, ptr noalias nocapture noundef readnone %3) local_unnamed_addr #9 {
  %5 = icmp slt i64 %2, 0
  br i1 %5, label %11, label %6
...
; Function Attrs: nofree nosync nounwind sspstrong memory(read, inaccessiblemem: none) uwtable
define hidden i32 @RelinquishDistributePixelCache(ptr nocapture noundef readnone %0) local_unnamed_addr #9 {
  %2 = tail call ptr @__errno_location() #13
  %3 = load i32, ptr %2, align 4, !tbaa !5
  %4 = icmp eq i32 %3, 4
  br i1 %4, label %5, label %6, !llvm.loop !22
...
; Function Attrs: nofree nosync nounwind sspstrong memory(read, inaccessiblemem: none) uwtable
define hidden i64 @WriteDistributePixelCacheIndexes(ptr nocapture noundef readnone %0, ptr nocapture noundef readnone %1, i64 noundef %2, ptr nocapture noundef readnone %3) local_unnamed_addr #9 {
  %5 = icmp slt i64 %2, 0
  br i1 %5, label %11, label %6
...
; Function Attrs: nofree nosync nounwind sspstrong memory(read, inaccessiblemem: none) uwtable
define hidden i64 @WriteDistributePixelCachePixels(ptr nocapture noundef readnone %0, ptr nocapture noundef readnone %1, i64 noundef %2, ptr noalias nocapture noundef readnone %3) local_unnamed_addr #9 {
  %5 = icmp slt i64 %2, 0
  br i1 %5, label %11, label %6
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !11, i64 4120}
!10 = !{!"_DistributeCacheInfo", !6, i64 0, !11, i64 8, !7, i64 16, !6, i64 4112, !11, i64 4120, !7, i64 4128}
!11 = !{!"long", !7, i64 0}
!12 = !{!10, !6, i64 4112}
!13 = !{!14, !14, i64 0}
