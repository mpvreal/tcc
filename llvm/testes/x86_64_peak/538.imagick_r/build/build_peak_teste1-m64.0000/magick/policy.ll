...
7:                                                ; preds = %3
  %8 = load ptr, ptr @policy_cache, align 8, !tbaa !9
...
13:                                               ; preds = %7
  %14 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  tail call void @LockSemaphoreInfo(ptr noundef %14) #9
  %15 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  tail call void @ResetLinkedListIterator(ptr noundef %15) #9
  %16 = load ptr, ptr @policy_cache, align 8, !tbaa !9
...
33:                                               ; preds = %30, %25, %19
  ...
  %35 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %36 = tail call ptr @GetNextValueInLinkedList(ptr noundef %35) #9
  %37 = icmp eq ptr %36, null
  br i1 %37, label %38, label %19, !llvm.loop !14

38:                                               ; preds = %33, %13
  %39 = phi i64 [ 0, %13 ], [ %34, %33 ]
  %40 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  ...
  store i64 %39, ptr %1, align 8, !tbaa !5
  br label %42
...
define internal fastcc ptr @GetPolicyInfo(ptr noundef %0, ptr noundef %1) unnamed_addr #0 {
  ...
  %5 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %6 = icmp eq ptr %5, null
  br i1 %6, label %7, label %63

7:                                                ; preds = %2
  %8 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  %9 = icmp eq ptr %8, null
  br i1 %9, label %10, label %12

10:                                               ; preds = %7
  tail call void @ActivateSemaphoreInfo(ptr noundef nonnull @policy_semaphore) #9
  %11 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  br label %12

12:                                               ; preds = %10, %7
  %13 = phi ptr [ %11, %10 ], [ %8, %7 ]
  tail call void @LockSemaphoreInfo(ptr noundef %13) #9
  %14 = load ptr, ptr @policy_cache, align 8, !tbaa !9
...
19:                                               ; preds = %16
  ...
  %23 = call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef nonnull %3, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 181, i32 noundef 700, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef %22) #9
...
26:                                               ; preds = %16
  %27 = tail call ptr @GetConfigureOptions(ptr noundef nonnull @.str.16, ptr noundef %1) #9
...
44:                                               ; preds = %39
  %45 = tail call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef %1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 207, i32 noundef 400, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef null) #9
  br label %58

46:                                               ; preds = %39
  %47 = tail call ptr @ResetMagickMemory(ptr noundef nonnull %42, i32 noundef 0, i64 noundef 72) #9
  store ptr @.str.19, ptr %42, align 8, !tbaa !19
  ...
  store i64 2880220587, ptr %50, align 8, !tbaa !21
...
54:                                               ; preds = %46
  ...
  %57 = tail call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef %1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 222, i32 noundef 400, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef %56) #9
  br label %58

58:                                               ; preds = %54, %46, %44
  store ptr %17, ptr @policy_cache, align 8, !tbaa !9
  br label %59

59:                                               ; preds = %12, %58
  %60 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  tail call void @UnlockSemaphoreInfo(ptr noundef %60) #9
  %61 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %62 = icmp eq ptr %61, null
  br i1 %62, label %115, label %63

63:                                               ; preds = %2, %59
  store i8 0, ptr %4, align 16, !tbaa !22
  %64 = icmp eq ptr %0, null
  br i1 %64, label %89, label %65

65:                                               ; preds = %63
  %66 = call i64 @CopyMagickString(ptr noundef nonnull %4, ptr noundef nonnull %0, i64 noundef 4096) #9
  %67 = load i8, ptr %4, align 16, !tbaa !22
  %68 = icmp eq i8 %67, 0
...
84:                                               ; preds = %71, %80
  ...
  %88 = icmp eq i8 %87, 0
  br i1 %88, label %89, label %71, !llvm.loop !25

89:                                               ; preds = %84, %63, %65
  %90 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  call void @LockSemaphoreInfo(ptr noundef %90) #9
  %91 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  call void @ResetLinkedListIterator(ptr noundef %91) #9
  %92 = load ptr, ptr @policy_cache, align 8, !tbaa !9
...
112:                                              ; preds = %106, %109, %97, %89, %94
  ...
  %114 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
...
35:                                               ; preds = %30, %25, %19
  ...
  %37 = load ptr, ptr @policy_cache, align 8, !tbaa !9
...
40:                                               ; preds = %35, %13
  ...
  %42 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
...
define dso_local i32 @IsRightsAuthorized(i32 noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
  ...
  %8 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 4096, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 574, ptr noundef nonnull @.str.4, ptr noundef %5, ptr noundef %7, ptr noundef %2) #9
...
42:                                               ; preds = %32, %38, %27
  ...
  %44 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %45 = tail call ptr @GetNextValueInLinkedList(ptr noundef %44) #9
  %46 = icmp ne ptr %45, null
  %47 = icmp ne i32 %43, 0
  %48 = and i1 %47, %46
  br i1 %48, label %27, label %172, !llvm.loop !32
...
67:                                               ; preds = %59, %54, %49
  ...
  %69 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %70 = tail call ptr @GetNextValueInLinkedList(ptr noundef %69) #9
  %71 = icmp ne ptr %70, null
  %72 = icmp ne i32 %68, 0
  %73 = and i1 %72, %71
  br i1 %73, label %49, label %172, !llvm.loop !32
...
91:                                               ; preds = %86, %81, %76
  ...
  %93 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %94 = tail call ptr @GetNextValueInLinkedList(ptr noundef %93) #9
  %95 = icmp ne ptr %94, null
  %96 = icmp ne i32 %92, 0
  %97 = and i1 %96, %95
  br i1 %97, label %76, label %172, !llvm.loop !32
...
115:                                              ; preds = %108, %103, %98
  ...
  %117 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %118 = tail call ptr @GetNextValueInLinkedList(ptr noundef %117) #9
  %119 = icmp ne ptr %118, null
  %120 = icmp ne i32 %116, 0
  %121 = and i1 %120, %119
  br i1 %121, label %98, label %172, !llvm.loop !32
...
141:                                              ; preds = %133, %128, %123
  ...
  %143 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %144 = tail call ptr @GetNextValueInLinkedList(ptr noundef %143) #9
  %145 = icmp ne ptr %144, null
  %146 = icmp ne i32 %142, 0
  %147 = and i1 %146, %145
  br i1 %147, label %123, label %172, !llvm.loop !32
...
31:                                               ; preds = %27
  %32 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.5, ptr noundef nonnull %29) #9
...
34:                                               ; preds = %31, %27, %22
  ...
  %41 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.6, ptr noundef %40) #9
...
51:                                               ; preds = %47
  %52 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.7, ptr noundef nonnull %49) #9
...
59:                                               ; preds = %54
  %60 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.8, ptr noundef nonnull %57) #9
  br label %104

61:                                               ; preds = %34
  %62 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.9) #9
...
67:                                               ; preds = %61
  %68 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.10) #9
...
76:                                               ; preds = %72
  %77 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.11) #9
...
85:                                               ; preds = %81
  %86 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.12) #9
...
94:                                               ; preds = %90
  %95 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.13) #9
  br label %96

96:                                               ; preds = %94, %90
  %97 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.14) #9
...
102:                                              ; preds = %96
  %103 = tail call i64 (ptr, ptr, ...) @FormatLocaleFile(ptr noundef %6, ptr noundef nonnull @.str.15, ptr noundef nonnull %100) #9
  br label %104
...
104:                                              ; preds = %59, %54, %102, %96, %12
  ...
  br i1 %107, label %108, label %12, !llvm.loop !33
...
define dso_local i32 @PolicyComponentGenesis() local_unnamed_addr #0 {
  %1 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  %2 = icmp eq ptr %1, null
  br i1 %2, label %3, label %5

3:                                                ; preds = %0
  %4 = tail call ptr @AllocateSemaphoreInfo() #9
  store ptr %4, ptr @policy_semaphore, align 8, !tbaa !9
  br label %5
...
3:                                                ; preds = %0
  tail call void @ActivateSemaphoreInfo(ptr noundef nonnull @policy_semaphore) #9
  %4 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
  br label %5

5:                                                ; preds = %3, %0
  %6 = phi ptr [ %4, %3 ], [ %1, %0 ]
  tail call void @LockSemaphoreInfo(ptr noundef %6) #9
  %7 = load ptr, ptr @policy_cache, align 8, !tbaa !9
  %8 = icmp eq ptr %7, null
  br i1 %8, label %11, label %9

9:                                                ; preds = %5
  %10 = tail call ptr @DestroyLinkedList(ptr noundef nonnull %7, ptr noundef nonnull @DestroyPolicyElement) #9
  store ptr %10, ptr @policy_cache, align 8, !tbaa !9
  br label %11

11:                                               ; preds = %9, %5
  %12 = load ptr, ptr @policy_semaphore, align 8, !tbaa !9
...
define internal fastcc i32 @LoadPolicyCache(ptr noundef %0, ptr noundef %1, ptr noundef %2, i64 noundef %3, ptr noundef %4) unnamed_addr #0 {
  ...
  %10 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 32, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 751, ptr noundef nonnull @.str.20, ptr noundef %2) #9
...
26:                                               ; preds = %20
  ...
  %28 = call i32 @LocaleNCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.21, i64 noundef 9) #9
  %29 = icmp eq i32 %28, 0
  br i1 %29, label %30, label %48

30:                                               ; preds = %26
  %31 = load ptr, ptr %7, align 8, !tbaa !9
  %32 = call i32 @LocaleNCompare(ptr noundef %31, ptr noundef nonnull @.str.22, i64 noundef 2) #9
  %33 = icmp eq i32 %32, 0
...
38:                                               ; preds = %34
  ...
  %40 = call i32 @LocaleNCompare(ptr noundef %39, ptr noundef nonnull @.str.22, i64 noundef 2) #9
  %41 = icmp eq i32 %40, 0
...
42:                                               ; preds = %59, %55, %38, %34, %75, %72, %69, %98, %95, %101, %177, %184, %190, %196, %203, %209, %174, %181, %187, %193, %200, %206, %169, %158, %161, %51, %30, %148, %153, %165
  ...
  %47 = icmp eq i8 %46, 0
  br i1 %47, label %212, label %20, !llvm.loop !35

48:                                               ; preds = %26
  %49 = call i32 @LocaleNCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.23, i64 noundef 4) #9
  %50 = icmp eq i32 %49, 0
  br i1 %50, label %51, label %63

51:                                               ; preds = %48
  %52 = load ptr, ptr %7, align 8, !tbaa !9
  %53 = call i32 @LocaleNCompare(ptr noundef %52, ptr noundef nonnull @.str.24, i64 noundef 2) #9
  %54 = icmp eq i32 %53, 0
...
59:                                               ; preds = %55
  ...
  %61 = call i32 @LocaleNCompare(ptr noundef %60, ptr noundef nonnull @.str.24, i64 noundef 2) #9
  %62 = icmp eq i32 %61, 0
  br i1 %62, label %42, label %55, !llvm.loop !36

63:                                               ; preds = %48
  %64 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.25) #9
  %65 = icmp eq i32 %64, 0
...
79:                                               ; preds = %75
  ...
  %83 = icmp eq i8 %82, 61
  br i1 %83, label %84, label %69, !llvm.loop !37

84:                                               ; preds = %79
  %85 = load ptr, ptr %7, align 8, !tbaa !9
  call void @GetMagickToken(ptr noundef %85, ptr noundef nonnull %7, ptr noundef nonnull %13) #9
  %86 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.26) #9
  %87 = icmp eq i32 %86, 0
  br i1 %87, label %88, label %90

88:                                               ; preds = %84
  %89 = call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef %4, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 800, i32 noundef 495, ptr noundef nonnull @.str.27, ptr noundef nonnull @.str.18, ptr noundef nonnull %13) #9
  br label %90
...
105:                                              ; preds = %101
  ...
  br i1 %109, label %110, label %95, !llvm.loop !37

110:                                              ; preds = %105
  %111 = load ptr, ptr %7, align 8, !tbaa !9
  call void @GetMagickToken(ptr noundef %111, ptr noundef nonnull %7, ptr noundef nonnull %13) #9
  %112 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.26) #9
  %113 = icmp eq i32 %112, 0
  br i1 %113, label %114, label %93, !llvm.loop !37
...
117:                                              ; preds = %114
  %118 = call i64 @ConcatenateMagickString(ptr noundef nonnull %8, ptr noundef nonnull @.str.28, i64 noundef 4096) #9
  br label %119
...
135:                                              ; preds = %63
  %136 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.29) #9
...
141:                                              ; preds = %138
  ...
  %145 = call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef nonnull %9, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 835, i32 noundef 700, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef %144) #9
...
148:                                              ; preds = %138
  ...
  store ptr %150, ptr %139, align 8, !tbaa !19
  ...
  store i64 2880220587, ptr %152, align 8, !tbaa !21
  br label %42
...
155:                                              ; preds = %153
  %156 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.30) #9
  %157 = icmp eq i32 %156, 0
...
161:                                              ; preds = %158
  ...
  %164 = call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef %4, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 848, i32 noundef 400, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef %163) #9
  br label %42

165:                                              ; preds = %155
  %166 = load ptr, ptr %7, align 8, !tbaa !9
  call void @GetMagickToken(ptr noundef %166, ptr noundef null, ptr noundef nonnull %13) #9
  %167 = load i8, ptr %13, align 1, !tbaa !22
...
169:                                              ; preds = %165
  ...
  %172 = load i8, ptr %6, align 16, !tbaa !22
...
174:                                              ; preds = %169, %169
  %175 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.31) #9
...
181:                                              ; preds = %169, %169
  %182 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.32) #9
...
184:                                              ; preds = %181
  ...
  store ptr %185, ptr %186, align 8, !tbaa !13
  br label %42

187:                                              ; preds = %169, %169
  %188 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.33) #9
...
190:                                              ; preds = %187
  ...
  store ptr %191, ptr %192, align 8, !tbaa !30
  br label %42

193:                                              ; preds = %169, %169
  %194 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.34) #9
...
200:                                              ; preds = %169, %169
  %201 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.35) #9
...
206:                                              ; preds = %169, %169
  %207 = call i32 @LocaleCompare(ptr noundef nonnull %6, ptr noundef nonnull @.str.36) #9
...
!11 = !{!12, !7, i64 44}
!12 = !{!"_PolicyInfo", !10, i64 0, !7, i64 8, !7, i64 12, !10, i64 16, !10, i64 24, !10, i64 32, !7, i64 40, !7, i64 44, !7, i64 48, !10, i64 56, !6, i64 64}
!13 = !{!12, !10, i64 16}
!14 = distinct !{!14, !15}
