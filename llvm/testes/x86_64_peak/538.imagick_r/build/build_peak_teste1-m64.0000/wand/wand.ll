...
11:                                               ; preds = %5
  ...
  store ptr %12, ptr @wand_ids, align 8, !tbaa !5
  store i1 true, ptr @instantiate_wand, align 4
  br label %13

13:                                               ; preds = %11, %5
  %14 = phi ptr [ %12, %11 ], [ %7, %5 ]
  %15 = load i64, ptr @AcquireWandId.id, align 8, !tbaa !9
  %16 = add i64 %15, 1
  store i64 %16, ptr @AcquireWandId.id, align 8, !tbaa !9
  %17 = inttoptr i64 %16 to ptr
  %18 = tail call i32 @AddValueToSplayTree(ptr noundef %14, ptr noundef %17, ptr noundef %17) #2
  %19 = load ptr, ptr @wand_semaphore, align 8, !tbaa !5
  tail call void @UnlockSemaphoreInfo(ptr noundef %19) #2
  %20 = load i64, ptr @AcquireWandId.id, align 8, !tbaa !9
  ret i64 %20
}
...
9:                                                ; preds = %5
  ...
  store ptr %10, ptr @wand_ids, align 8, !tbaa !5
  br label %11

11:                                               ; preds = %9, %5
  store i1 false, ptr @instantiate_wand, align 4
  %12 = load ptr, ptr @wand_semaphore, align 8, !tbaa !5
...
define dso_local void @RelinquishWandId(i64 noundef %0) local_unnamed_addr #0 {
  %2 = load ptr, ptr @wand_semaphore, align 8, !tbaa !5
  tail call void @LockSemaphoreInfo(ptr noundef %2) #2
  %3 = load ptr, ptr @wand_ids, align 8, !tbaa !5
...
8:                                                ; preds = %5, %1
  %9 = load ptr, ptr @wand_semaphore, align 8, !tbaa !5
