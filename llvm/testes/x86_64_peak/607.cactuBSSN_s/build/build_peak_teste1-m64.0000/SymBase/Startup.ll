...
10:                                               ; preds = %8, %5
  store i32 0, ptr @SymBase_num_symmetries, align 4, !tbaa !6
  store ptr null, ptr @SymBase_symmetry_names, align 8, !tbaa !10
  ret i32 0
}
...
11:                                               ; preds = %9, %3
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(400) %4, i8 -1, i64 400, i1 false), !tbaa !6
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(400) %5, i8 0, i64 400, i1 false), !tbaa !6
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(800) %6, i8 0, i64 800, i1 false), !tbaa !10
  %12 = tail call i32 @Util_TableCreate(i32 noundef 1) #6
  store i32 %12, ptr %7, align 8, !tbaa !12
...
36:                                               ; preds = %34, %29
  %37 = load i32, ptr %2, align 8, !tbaa !14
  %38 = shl nsw i32 %37, 1
...
72:                                               ; preds = %70, %67
  %73 = load i32, ptr %63, align 4, !tbaa !6
...
80:                                               ; preds = %78, %72
  %81 = load i32, ptr %63, align 4, !tbaa !6
...
88:                                               ; preds = %86, %80
  %89 = load i32, ptr %63, align 4, !tbaa !6
...
98:                                               ; preds = %59, %96, %94, %88
  ...
  br i1 %102, label %55, label %103, !llvm.loop !18
...
!12 = !{!13, !7, i64 0}
!13 = !{!"SymBase", !7, i64 0, !11, i64 8}
!14 = !{!15, !7, i64 0}
!15 = !{!"_cGH", !7, i64 0, !7, i64 4, !11, i64 8, !11, i64 16, !11, i64 24, !11, i64 32, !11, i64 40, !11, i64 48, !11, i64 56, !16, i64 64, !11, i64 72, !11, i64 80, !11, i64 88, !11, i64 96, !11, i64 104, !11, i64 112, !7, i64 120, !7, i64 124, !7, i64 128, !11, i64 136, !16, i64 144, !11, i64 152, !11, i64 160, !11, i64 168, !11, i64 176}
!16 = !{!"double", !8, i64 0}
!17 = !{!13, !11, i64 8}
!18 = distinct !{!18, !19}
