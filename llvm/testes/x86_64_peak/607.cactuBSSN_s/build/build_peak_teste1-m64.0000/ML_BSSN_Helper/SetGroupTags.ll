...
define dso_local i32 @ML_BSSN_SetGroupTags() local_unnamed_addr #0 {
  %1 = load i32, ptr getelementptr inbounds (%struct.anon.4, ptr @ml_bssnrest_, i64 0, i32 57), align 4, !tbaa !6
  %2 = load i32, ptr getelementptr inbounds (%struct.anon.4, ptr @ml_bssnrest_, i64 0, i32 56), align 8, !tbaa !13
  %3 = icmp slt i32 %1, 2
