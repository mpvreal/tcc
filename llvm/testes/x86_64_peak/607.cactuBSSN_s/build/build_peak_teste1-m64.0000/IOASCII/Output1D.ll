...
@.str = private unnamed_addr constant [53 x i8] c"$Id: Output1D.c 207 2009-12-05 03:07:04Z schnetter $\00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"IOASCII\00", align 1
@.str.2 = private unnamed_addr constant [19 x i8] c"IOASCII/Output1D.c\00", align 1
@.str.3 = private unnamed_addr constant [59 x i8] c"There is no such variable %s.  Ignoring IOASCII 1D output.\00", align 1
@.str.4 = private unnamed_addr constant [63 x i8] c"No IOASCII 1D output for '%s': not a grid function or an array\00", align 1
@.str.5 = private unnamed_addr constant [85 x i8] c"Already done IOASCII 1D output for '%s' in current iteration (probably via triggers)\00", align 1
...
@.str.7 = private unnamed_addr constant [39 x i8] c"Periodic 1D output every %d iterations\00", align 1
@.str.8 = private unnamed_addr constant [30 x i8] c"Periodic 1D output turned off\00", align 1
@.str.9 = private unnamed_addr constant [52 x i8] c"error while parsing parameter 'IOASCII::out1D_vars'\00", align 1
@.str.10 = private unnamed_addr constant [38 x i8] c"Periodic 1D output requested for '%s'\00", align 1
...
31:                                               ; preds = %25
  ...
  %33 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 5, i32 noundef 190, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5, ptr noundef %32) #7
...
21:                                               ; preds = %15
  ...
  %23 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 5, i32 noundef 190, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5, ptr noundef %22) #7
...
6:                                                ; preds = %3
  %7 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 133, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, ptr noundef %1) #7
  br label %17
...
12:                                               ; preds = %8
  ...
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 349, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4, ptr noundef %13) #7
...
define dso_local void @IOASCII_CheckSteerableParameters1D(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %3 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 11), align 8, !tbaa !19
  %4 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 20), align 4, !tbaa !21
...
11:                                               ; preds = %1
  %12 = tail call i32 @CCTK_Equals(ptr noundef %6, ptr noundef nonnull @.str.6) #7
  %13 = icmp eq i32 %12, 0
...
17:                                               ; preds = %14
  %18 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.7, i32 noundef %15) #7
  br label %21

19:                                               ; preds = %14
  %20 = tail call i32 @CCTK_Info(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.8) #7
  br label %21
...
37:                                               ; preds = %29
  ...
  %42 = tail call i32 @CCTK_Warn(i32 noundef %41, i32 noundef 295, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.9) #7
  br label %43
...
46:                                               ; preds = %43
  %47 = tail call i32 @CCTK_Equals(ptr noundef %6, ptr noundef nonnull @.str.6) #7
  %48 = icmp eq i32 %47, 0
...
53:                                               ; preds = %51, %69
  ...
  %55 = load ptr, ptr %31, align 8, !tbaa !6
...
64:                                               ; preds = %59
  %65 = call i32 (ptr, ptr, ...) @Util_asprintf(ptr noundef nonnull %2, ptr noundef nonnull @.str.10, ptr noundef %61) #7
  br label %68

66:                                               ; preds = %59
  %67 = call i32 (ptr, ptr, ...) @Util_asprintf(ptr noundef nonnull %2, ptr noundef nonnull @.str.11, ptr noundef nonnull %62, ptr noundef %61) #7
...
69:                                               ; preds = %53, %68
  ...
  br i1 %71, label %72, label %53, !llvm.loop !29
...
75:                                               ; preds = %72
  %76 = call i32 @CCTK_Info(ptr noundef nonnull @.str.1, ptr noundef nonnull %73) #7
...
78:                                               ; preds = %49, %72, %75, %46
  ...
  store ptr %80, ptr %22, align 8, !tbaa !26
  br label %81
...
7:                                                ; preds = %3
  ...
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 349, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4, ptr noundef %8) #7
