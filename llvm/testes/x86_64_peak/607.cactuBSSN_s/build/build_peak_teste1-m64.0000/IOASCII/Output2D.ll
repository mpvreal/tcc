...
@.str = private unnamed_addr constant [53 x i8] c"$Id: Output2D.c 207 2009-12-05 03:07:04Z schnetter $\00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"IOASCII\00", align 1
@.str.2 = private unnamed_addr constant [19 x i8] c"IOASCII/Output2D.c\00", align 1
@.str.3 = private unnamed_addr constant [59 x i8] c"There is no such variable %s.  Ignoring IOASCII 2D output.\00", align 1
@.str.4 = private unnamed_addr constant [13 x i8] c"dim != [2,3]\00", align 1
@.str.5 = private unnamed_addr constant [29 x i8] c"not a grid function or array\00", align 1
@.str.6 = private unnamed_addr constant [34 x i8] c"No IOASCII 2D output for '%s': %s\00", align 1
@.str.7 = private unnamed_addr constant [85 x i8] c"Already done IOASCII 2D output for '%s' in current iteration (probably via triggers)\00", align 1
...
@.str.9 = private unnamed_addr constant [39 x i8] c"Periodic 2D output every %d iterations\00", align 1
@.str.10 = private unnamed_addr constant [30 x i8] c"Periodic 2D output turned off\00", align 1
@.str.11 = private unnamed_addr constant [52 x i8] c"error while parsing parameter 'IOASCII::out2D_vars'\00", align 1
@.str.12 = private unnamed_addr constant [38 x i8] c"Periodic 2D output requested for '%s'\00", align 1
...
31:                                               ; preds = %25
  ...
  %33 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 5, i32 noundef 191, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.7, ptr noundef %32) #7
...
21:                                               ; preds = %15
  ...
  %23 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 5, i32 noundef 191, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.7, ptr noundef %22) #7
...
7:                                                ; preds = %3
  %8 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 134, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, ptr noundef %1) #7
  br label %26
...
20:                                               ; preds = %9, %16
  %21 = phi ptr [ @.str.5, %16 ], [ @.str.4, %9 ]
  %22 = call ptr @CCTK_FullName(i32 noundef %5) #7
  %23 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 363, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.6, ptr noundef %22, ptr noundef nonnull %21) #7
...
define dso_local void @IOASCII_CheckSteerableParameters2D(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %3 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 14), align 8, !tbaa !19
  %4 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 30), align 4, !tbaa !21
  %5 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 38), align 8, !tbaa !22
  %6 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 27), align 8, !tbaa !24
...
38:                                               ; preds = %30
  ...
  %43 = tail call i32 @CCTK_Warn(i32 noundef %42, i32 noundef 297, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.11) #7
  br label %44
...
70:                                               ; preds = %54, %69
  ...
  br i1 %72, label %73, label %54, !llvm.loop !29
...
79:                                               ; preds = %50, %73, %76, %47
  ...
  store ptr %81, ptr %23, align 8, !tbaa !26
  br label %82
...
15:                                               ; preds = %3, %11
  %16 = phi ptr [ @.str.5, %11 ], [ @.str.4, %3 ]
  %17 = call ptr @CCTK_FullName(i32 noundef %0) #7
  %18 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 363, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.6, ptr noundef %17, ptr noundef nonnull %16) #7
