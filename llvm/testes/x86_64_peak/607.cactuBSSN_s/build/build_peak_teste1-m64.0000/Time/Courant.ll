...
define dso_local void @Time_Courant(ptr noundef %0) local_unnamed_addr #0 {
  %2 = load ptr, ptr @timerest_, align 8, !tbaa !6
  %3 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @timerest_, i64 0, i32 1), align 8, !tbaa !12
  %4 = load double, ptr @timepriv_, align 8, !tbaa !13
  %5 = load double, ptr getelementptr inbounds (%struct.anon.0, ptr @timepriv_, i64 0, i32 1), align 8, !tbaa !16
  %6 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @timepriv_, i64 0, i32 3), align 8, !tbaa !17
  %7 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @timepriv_, i64 0, i32 4), align 4, !tbaa !18
  %8 = load double, ptr @cactusrest_, align 8, !tbaa !19
  %9 = load ptr, ptr getelementptr inbounds (%struct.anon.1, ptr @cactusrest_, i64 0, i32 3), align 8, !tbaa !21
...
58:                                               ; preds = %54
  %59 = load double, ptr %32, align 8, !tbaa !28
...
67:                                               ; preds = %64
  ...
  %69 = load double, ptr %39, align 8, !tbaa !28
...
74:                                               ; preds = %58, %67
  ...
  store double %75, ptr %25, align 8, !tbaa !28
  br label %76
...
82:                                               ; preds = %79, %76
  %83 = load double, ptr %13, align 8, !tbaa !29
  %84 = load double, ptr %25, align 8, !tbaa !28
...
87:                                               ; preds = %82
  ...
  store double %89, ptr %25, align 8, !tbaa !28
  br label %90
...
92:                                               ; preds = %90
  %93 = load double, ptr %25, align 8, !tbaa !28
  store double %93, ptr %11, align 8, !tbaa !24
  %94 = icmp eq i32 %7, 0
...
99:                                               ; preds = %90
  ...
  store double %100, ptr %11, align 8, !tbaa !24
  %101 = load i32, ptr %18, align 4, !tbaa !30
  %102 = srem i32 %101, %6
  %103 = icmp eq i32 %102, 0
  br i1 %103, label %104, label %107

104:                                              ; preds = %99
  %105 = load double, ptr %25, align 8, !tbaa !28
...
!12 = !{!7, !11, i64 8}
!13 = !{!14, !15, i64 0}
!14 = !{!"", !15, i64 0, !15, i64 8, !15, i64 16, !11, i64 24, !11, i64 28}
!15 = !{!"double", !9, i64 0}
!16 = !{!14, !15, i64 8}
!17 = !{!14, !11, i64 24}
!18 = !{!14, !11, i64 28}
!19 = !{!20, !15, i64 0}
!20 = !{!"", !15, i64 0, !15, i64 8, !15, i64 16, !8, i64 24, !11, i64 32, !11, i64 36}
!21 = !{!20, !8, i64 24}
!22 = !{!23, !11, i64 0}
!23 = !{!"_cGH", !11, i64 0, !11, i64 4, !8, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !15, i64 64, !8, i64 72, !8, i64 80, !8, i64 88, !8, i64 96, !8, i64 104, !8, i64 112, !11, i64 120, !11, i64 124, !11, i64 128, !8, i64 136, !15, i64 144, !8, i64 152, !8, i64 160, !8, i64 168, !8, i64 176}
!24 = !{!23, !15, i64 64}
!25 = !{!23, !8, i64 72}
!26 = !{!23, !11, i64 120}
!27 = !{!11, !11, i64 0}
