...
define dso_local void @Time_Given(ptr noundef %0) local_unnamed_addr #0 {
  %2 = load double, ptr getelementptr inbounds (%struct.anon.0, ptr @timepriv_, i64 0, i32 2), align 8, !tbaa !6
  %3 = load i32, ptr @Time_Given.cctki_vi_courant_dt, align 4, !tbaa !12
  %4 = icmp eq i32 %3, -100
  br i1 %4, label %5, label %7

5:                                                ; preds = %1
  %6 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str) #2
  store i32 %6, ptr @Time_Given.cctki_vi_courant_dt, align 4, !tbaa !12
  br label %7

7:                                                ; preds = %5, %1
  %8 = phi i32 [ %6, %5 ], [ %3, %1 ]
  %9 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %8) #2
  %10 = load i32, ptr @Time_Given.cctki_vi_courant_min_time, align 4, !tbaa !12
  %11 = icmp eq i32 %10, -100
  br i1 %11, label %12, label %14

12:                                               ; preds = %7
  %13 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #2
  store i32 %13, ptr @Time_Given.cctki_vi_courant_min_time, align 4, !tbaa !12
  br label %14

14:                                               ; preds = %12, %7
  %15 = phi i32 [ %13, %12 ], [ %10, %7 ]
  %16 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %15) #2
  %17 = load i32, ptr @Time_Given.cctki_vi_courant_wave_speed, align 4, !tbaa !12
  %18 = icmp eq i32 %17, -100
  br i1 %18, label %19, label %21

19:                                               ; preds = %14
  %20 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #2
  store i32 %20, ptr @Time_Given.cctki_vi_courant_wave_speed, align 4, !tbaa !12
  br label %21
...
21:                                               ; preds = %19, %14
  ...
  store double %2, ptr %23, align 8, !tbaa !13
  ret void
}
...
!6 = !{!7, !8, i64 16}
!7 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !11, i64 24, !11, i64 28}
!8 = !{!"double", !9, i64 0}
...
!12 = !{!11, !11, i64 0}
!13 = !{!14, !8, i64 64}
!14 = !{!"_cGH", !11, i64 0, !11, i64 4, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !15, i64 40, !15, i64 48, !15, i64 56, !8, i64 64, !15, i64 72, !15, i64 80, !15, i64 88, !15, i64 96, !15, i64 104, !15, i64 112, !11, i64 120, !11, i64 124, !11, i64 128, !15, i64 136, !8, i64 144, !15, i64 152, !15, i64 160, !15, i64 168, !15, i64 176}
