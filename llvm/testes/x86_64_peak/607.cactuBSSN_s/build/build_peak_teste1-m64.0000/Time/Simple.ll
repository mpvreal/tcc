...
define dso_local void @Time_Simple(ptr noundef %0) local_unnamed_addr #0 {
  ...
  %6 = load i32, ptr @Time_Simple.cctki_vi_courant_dt, align 4, !tbaa !14
  %7 = icmp eq i32 %6, -100
  br i1 %7, label %8, label %10

8:                                                ; preds = %1
  %9 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str) #3
  store i32 %9, ptr @Time_Simple.cctki_vi_courant_dt, align 4, !tbaa !14
  br label %10

10:                                               ; preds = %8, %1
  %11 = phi i32 [ %9, %8 ], [ %6, %1 ]
  %12 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %11) #3
  %13 = load i32, ptr @Time_Simple.cctki_vi_courant_min_time, align 4, !tbaa !14
  %14 = icmp eq i32 %13, -100
  br i1 %14, label %15, label %17

15:                                               ; preds = %10
  %16 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #3
  store i32 %16, ptr @Time_Simple.cctki_vi_courant_min_time, align 4, !tbaa !14
  br label %17

17:                                               ; preds = %15, %10
  %18 = phi i32 [ %16, %15 ], [ %13, %10 ]
  %19 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %18) #3
  %20 = load i32, ptr @Time_Simple.cctki_vi_courant_wave_speed, align 4, !tbaa !14
  %21 = icmp eq i32 %20, -100
  br i1 %21, label %22, label %24

22:                                               ; preds = %17
  %23 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #3
  store i32 %23, ptr @Time_Simple.cctki_vi_courant_wave_speed, align 4, !tbaa !14
  br label %24

24:                                               ; preds = %22, %17
  %25 = phi i32 [ %23, %22 ], [ %20, %17 ]
  %26 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %25) #3
  %27 = load double, ptr getelementptr inbounds (%struct.anon.0, ptr @timepriv_, i64 0, i32 1), align 8, !tbaa !15
  %28 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @timepriv_, i64 0, i32 4), align 4, !tbaa !17
  %29 = load double, ptr %5, align 8, !tbaa !18
  %30 = icmp sgt i32 %2, 1
...
40:                                               ; preds = %40, %35
  ...
  %48 = load <4 x double>, ptr %47, align 8, !tbaa !18
  %49 = getelementptr inbounds double, ptr %47, i64 4
  %50 = load <4 x double>, ptr %49, align 8, !tbaa !18
  %51 = getelementptr inbounds double, ptr %47, i64 8
  %52 = load <4 x double>, ptr %51, align 8, !tbaa !18
  %53 = getelementptr inbounds double, ptr %47, i64 12
  %54 = load <4 x double>, ptr %53, align 8, !tbaa !18
  ...
  br i1 %60, label %61, label %40, !llvm.loop !19
...
70:                                               ; preds = %74, %61, %24
  ...
  store double %72, ptr %3, align 8, !tbaa !23
  %73 = icmp eq i32 %28, 0
...
74:                                               ; preds = %67, %74
  ...
  br i1 %81, label %70, label %74, !llvm.loop !24
...
82:                                               ; preds = %70
  ...
  %86 = load double, ptr %3, align 8, !tbaa !23
  br label %87
...
!14 = !{!8, !8, i64 0}
!15 = !{!16, !12, i64 8}
!16 = !{!"", !12, i64 0, !12, i64 8, !12, i64 16, !8, i64 24, !8, i64 28}
!17 = !{!16, !8, i64 28}
!18 = !{!12, !12, i64 0}
