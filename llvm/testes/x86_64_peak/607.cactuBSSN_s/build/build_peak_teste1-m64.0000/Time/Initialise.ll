...
define dso_local void @Time_Initialise(ptr noundef %0) local_unnamed_addr #0 {
  %2 = load i32, ptr @Time_Initialise.cctki_vi_courant_dt, align 4, !tbaa !6
  %3 = icmp eq i32 %2, -100
  br i1 %3, label %4, label %6

4:                                                ; preds = %1
  %5 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str) #2
  store i32 %5, ptr @Time_Initialise.cctki_vi_courant_dt, align 4, !tbaa !6
  br label %6

6:                                                ; preds = %4, %1
  %7 = phi i32 [ %5, %4 ], [ %2, %1 ]
  %8 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %7) #2
  %9 = load i32, ptr @Time_Initialise.cctki_vi_courant_min_time, align 4, !tbaa !6
  %10 = icmp eq i32 %9, -100
  br i1 %10, label %11, label %13

11:                                               ; preds = %6
  %12 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #2
  store i32 %12, ptr @Time_Initialise.cctki_vi_courant_min_time, align 4, !tbaa !6
  br label %13

13:                                               ; preds = %11, %6
  %14 = phi i32 [ %12, %11 ], [ %9, %6 ]
  %15 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %14) #2
  %16 = load i32, ptr @Time_Initialise.cctki_vi_courant_wave_speed, align 4, !tbaa !6
  %17 = icmp eq i32 %16, -100
  br i1 %17, label %18, label %20

18:                                               ; preds = %13
  %19 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #2
  store i32 %19, ptr @Time_Initialise.cctki_vi_courant_wave_speed, align 4, !tbaa !6
  br label %20
