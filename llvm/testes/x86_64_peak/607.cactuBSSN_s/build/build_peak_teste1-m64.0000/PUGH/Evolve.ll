...
@.str.2 = private unnamed_addr constant [16 x i8] c"CCTK_CHECKPOINT\00", align 1
...
9:                                                ; preds = %31, %1
  ...
  %11 = load i32, ptr getelementptr inbounds (%struct.anon.1, ptr @cactusrest_, i64 0, i32 5), align 4, !tbaa !13
  %12 = icmp eq i32 %11, 0
...
37:                                               ; preds = %257, %181, %187, %218
  %38 = load i32, ptr getelementptr inbounds (%struct.anon.1, ptr @cactusrest_, i64 0, i32 5), align 4, !tbaa !13
  %39 = icmp eq i32 %38, 0
  br i1 %39, label %40, label %263, !llvm.loop !19
...
40:                                               ; preds = %9, %37
  ...
  %46 = load ptr, ptr getelementptr inbounds (%struct.anon.1, ptr @cactusrest_, i64 0, i32 3), align 8, !tbaa !22
  %47 = load double, ptr @cactusrest_, align 8, !tbaa !23
  %48 = load i32, ptr getelementptr inbounds (%struct.anon.1, ptr @cactusrest_, i64 0, i32 4), align 8, !tbaa !24
...
89:                                               ; preds = %85, %83, %75, %51, %69, %77, %87
  %90 = load i32, ptr %4, align 8, !tbaa !10
  %91 = icmp eq i32 %90, 0
...
98:                                               ; preds = %92
  ...
  %102 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 1), align 8, !tbaa !26
...
114:                                              ; preds = %109
  %115 = load ptr, ptr %108, align 8, !tbaa !30
...
124:                                              ; preds = %114
  %125 = load ptr, ptr %108, align 8, !tbaa !30
...
136:                                              ; preds = %133, %136
  ...
  %138 = load ptr, ptr %108, align 8, !tbaa !30
  ...
  %146 = load ptr, ptr %108, align 8, !tbaa !30
  ...
  store ptr %152, ptr %153, align 8, !tbaa !6
  %154 = icmp eq i64 %150, 0
  br i1 %154, label %155, label %136, !llvm.loop !31

155:                                              ; preds = %136, %133
  %156 = load ptr, ptr %108, align 8, !tbaa !30
  %157 = getelementptr inbounds ptr, ptr %156, i64 %110
  %158 = load ptr, ptr %157, align 8, !tbaa !6
  store ptr %121, ptr %158, align 8, !tbaa !6
...
170:                                              ; preds = %155, %109
  ...
  %172 = load i32, ptr %104, align 8, !tbaa !28
  %173 = sext i32 %172 to i64
  %174 = icmp slt i64 %171, %173
  br i1 %174, label %109, label %175, !llvm.loop !39

175:                                              ; preds = %170, %98, %92
  %176 = shl nsw i32 %94, 1
  %177 = add nuw nsw i64 %93, 1
  %178 = load i32, ptr %4, align 8, !tbaa !10
  %179 = zext i32 %178 to i64
  %180 = icmp ult i64 %177, %179
  br i1 %180, label %92, label %181, !llvm.loop !40

181:                                              ; preds = %175, %89
  %182 = load ptr, ptr @CCTK_SetMainLoopIndex, align 8, !tbaa !6
  %183 = add i32 %41, 1
  %184 = tail call i32 %182(i32 noundef %183) #3
  %185 = load i32, ptr %4, align 8, !tbaa !10
...
196:                                              ; preds = %189
  ...
  store double %204, ptr %200, align 8, !tbaa !20
  ...
  %211 = load i32, ptr %4, align 8, !tbaa !10
  br label %212
...
212:                                              ; preds = %196, %189
  ...
  br i1 %217, label %189, label %187, !llvm.loop !42
...
227:                                              ; preds = %220
  ...
  %231 = tail call i32 @CCTK_Traverse(ptr noundef %230, ptr noundef nonnull @.str.2) #3
  %232 = load i32, ptr %4, align 8, !tbaa !10
  br label %233
...
233:                                              ; preds = %227, %220
  ...
  br i1 %238, label %220, label %218, !llvm.loop !43
...
246:                                              ; preds = %239
  ...
  %250 = tail call i32 @CCTK_Traverse(ptr noundef %249, ptr noundef nonnull @.str.1) #3
  %251 = load ptr, ptr @CCTK_OutputGH, align 8, !tbaa !6
  ...
  %256 = load i32, ptr %4, align 8, !tbaa !10
  br label %257
...
257:                                              ; preds = %246, %239
  ...
  br i1 %262, label %239, label %37, !llvm.loop !44
...
!28 = !{!29, !12, i64 24}
!29 = !{!"PGH", !7, i64 0, !12, i64 8, !12, i64 12, !12, i64 16, !12, i64 20, !12, i64 24, !12, i64 28, !7, i64 32, !12, i64 40, !7, i64 48, !12, i64 56, !12, i64 60, !15, i64 64, !15, i64 72, !15, i64 80, !15, i64 88, !12, i64 96, !12, i64 100, !12, i64 104, !12, i64 108, !12, i64 112, !7, i64 120, !7, i64 128, !7, i64 136}
!30 = !{!29, !7, i64 32}
!31 = distinct !{!31, !18}
!32 = !{!33, !12, i64 52}
!33 = !{!"PGA", !7, i64 0, !12, i64 8, !12, i64 12, !7, i64 16, !7, i64 24, !12, i64 32, !12, i64 36, !7, i64 40, !12, i64 48, !12, i64 52, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !12, i64 88, !12, i64 92, !7, i64 96}
!34 = !{!33, !7, i64 56}
!35 = !{!36, !12, i64 56}
!36 = !{!"PGExtras", !12, i64 0, !7, i64 8, !15, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !12, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !7, i64 96, !8, i64 104, !8, i64 120, !8, i64 136}
!37 = !{!33, !12, i64 48}
!38 = !{!33, !7, i64 24}
!39 = distinct !{!39, !18}
!40 = distinct !{!40, !18}
