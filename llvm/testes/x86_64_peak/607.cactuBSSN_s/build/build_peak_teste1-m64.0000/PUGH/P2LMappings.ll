...
@.str.2 = private unnamed_addr constant [8 x i8] c"example\00", align 1
...
define dso_local i32 @PUGH_RegisterPUGHP2LRoutines() local_unnamed_addr #1 {
  %1 = tail call i32 @PUGH_RegisterP2L(ptr noundef nonnull @CreateDirectTranslation, ptr noundef nonnull @DestroyDirectTranslation, ptr noundef nonnull @DirectPhysicalToLogical, ptr noundef nonnull @DirectLogicalToPhysical, ptr noundef nonnull @.str.1) #8
  %2 = tail call i32 @PUGH_RegisterP2L(ptr noundef nonnull @CreateExampleTranslation, ptr noundef nonnull @DestroyExampleTranslation, ptr noundef nonnull @ExamplePhysicalToLogical, ptr noundef nonnull @ExampleLogicalToPhysical, ptr noundef nonnull @.str.2) #8
  ret i32 0
}
...
22:                                               ; preds = %22, %20
  ...
  store <8 x i32> %24, ptr %28, align 4, !tbaa !10
  %29 = getelementptr inbounds i32, ptr %28, i64 8
  store <8 x i32> %25, ptr %29, align 4, !tbaa !10
  %30 = getelementptr inbounds i32, ptr %28, i64 16
  store <8 x i32> %26, ptr %30, align 4, !tbaa !10
  %31 = getelementptr inbounds i32, ptr %28, i64 24
  store <8 x i32> %27, ptr %31, align 4, !tbaa !10
  %32 = getelementptr inbounds i32, ptr %10, i64 %23
  store <8 x i32> %24, ptr %32, align 4, !tbaa !10
  %33 = getelementptr inbounds i32, ptr %32, i64 8
  store <8 x i32> %25, ptr %33, align 4, !tbaa !10
  %34 = getelementptr inbounds i32, ptr %32, i64 16
  store <8 x i32> %26, ptr %34, align 4, !tbaa !10
  %35 = getelementptr inbounds i32, ptr %32, i64 24
  store <8 x i32> %27, ptr %35, align 4, !tbaa !10
