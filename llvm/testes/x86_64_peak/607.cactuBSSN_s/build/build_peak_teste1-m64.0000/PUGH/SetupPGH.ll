...
@.str.3 = private unnamed_addr constant [16 x i8] c"PUGH/SetupPGH.c\00", align 1
@.str.4 = private unnamed_addr constant [5 x i8] c"PUGH\00", align 1
@.str.5 = private unnamed_addr constant [76 x i8] c"internal error -- flesh parameter Cactus::allow_mixeddim_gfs does not exist\00", align 1
@.str.6 = private unnamed_addr constant [76 x i8] c"internal error -- flesh parameter Cactus::allow_mixeddim_gfs has wrong type\00", align 1
@.str.7 = private unnamed_addr constant [40 x i8] c"Setting up a topology for %d dimensions\00", align 1
@.str.8 = private unnamed_addr constant [44 x i8] c"Not setting up a topology for %d dimensions\00", align 1
...
@.str.9 = private unnamed_addr constant [30 x i8] c"Only 1D, 2D, and 3D supported\00", align 1
...
define dso_local noalias ptr @PUGH_SetupPGH(ptr noundef %0, i32 noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4) local_unnamed_addr #1 {
  ...
  %7 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 54), align 8, !tbaa !6
  ...
  %18 = call ptr @CCTK_ParameterGet(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull %6) #13
  %19 = icmp eq ptr %18, null
  br i1 %19, label %20, label %22

20:                                               ; preds = %5
  %21 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 140, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.5) #13
  br label %22
...
25:                                               ; preds = %22
  %26 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 144, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.6) #13
  br label %27
...
40:                                               ; preds = %35
  %41 = call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.7, i32 noundef %39) #13
...
44:                                               ; preds = %40
  %45 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 47), align 4, !tbaa !21
...
49:                                               ; preds = %40
  %50 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 49), align 4, !tbaa !22
  %51 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 48), align 8, !tbaa !23
  %52 = load i32, ptr @topology_2d_x, align 4
  %53 = icmp eq i32 %52, 0
  %54 = select i1 %53, i32 %51, i32 %52
  store i32 %54, ptr %43, align 4, !tbaa !20
...
59:                                               ; preds = %40
  %60 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 52), align 8, !tbaa !24
  %61 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 51), align 4, !tbaa !25
  %62 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 50), align 8, !tbaa !26
  %63 = load i32, ptr @topology_3d_x, align 4
  %64 = icmp eq i32 %63, 0
  %65 = select i1 %64, i32 %62, i32 %63
  store i32 %65, ptr %43, align 4, !tbaa !20
...
79:                                               ; preds = %79, %77
  ...
  %82 = load <8 x i32>, ptr %81, align 4, !tbaa !20
  %83 = icmp eq <8 x i32> %82, zeroinitializer
  %84 = getelementptr i32, ptr %2, i64 %80
  %85 = call <8 x i32> @llvm.masked.load.v8i32.p0(ptr %84, i32 4, <8 x i1> %83, <8 x i32> poison), !tbaa !20
  %86 = call <8 x i32> @llvm.abs.v8i32(<8 x i32> %85, i1 true)
  %87 = getelementptr i32, ptr %3, i64 %80
  %88 = call <8 x i32> @llvm.masked.load.v8i32.p0(ptr %87, i32 4, <8 x i1> %83, <8 x i32> poison), !tbaa !20
  ...
  call void @llvm.masked.store.v8i32.p0(<8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, ptr %81, i32 4, <8 x i1> %92), !tbaa !20
  %93 = add nuw i64 %80, 8
...
114:                                              ; preds = %99, %104, %113
  ...
  br i1 %116, label %117, label %99, !llvm.loop !31
...
126:                                              ; preds = %35
  %127 = call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.8, i32 noundef %39) #13
...
130:                                              ; preds = %117, %126
  ...
  br i1 %135, label %136, label %35, !llvm.loop !36
...
140:                                              ; preds = %136, %138
  ...
  store <4 x i32> <i32 0, i32 0, i32 0, i32 1>, ptr %145, align 8, !tbaa !20
...
3:                                                ; preds = %2
  %4 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 47), align 4, !tbaa !21
...
8:                                                ; preds = %2
  %9 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 49), align 4, !tbaa !22
  %10 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 48), align 8, !tbaa !23
  %11 = load i32, ptr @topology_2d_x, align 4
  %12 = icmp eq i32 %11, 0
  %13 = select i1 %12, i32 %10, i32 %11
  store i32 %13, ptr %1, align 4, !tbaa !20
...
18:                                               ; preds = %2
  %19 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 52), align 8, !tbaa !24
  %20 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 51), align 4, !tbaa !25
  %21 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 50), align 8, !tbaa !26
...
73:                                               ; preds = %70, %88
  ...
  %76 = load i32, ptr %12, align 4, !tbaa !51
...
78:                                               ; preds = %73, %78
  ...
  %85 = load i32, ptr %12, align 4, !tbaa !51
  %86 = sext i32 %85 to i64
  %87 = icmp slt i64 %84, %86
  br i1 %87, label %78, label %88, !llvm.loop !52
...
88:                                               ; preds = %78, %73
  ...
  br i1 %95, label %73, label %96, !llvm.loop !53
...
98:                                               ; preds = %96, %70, %20
  ...
  br i1 %101, label %13, label %20, !llvm.loop !54
...
102:                                              ; preds = %17, %102
  ...
  %109 = load i32, ptr %14, align 8, !tbaa !19
  %110 = sext i32 %109 to i64
  %111 = icmp slt i64 %108, %110
  br i1 %111, label %102, label %112, !llvm.loop !55
...
3:                                                ; preds = %2
  ...
  store i32 %4, ptr @topology_1d_x, align 4, !tbaa !20
  br label %17

5:                                                ; preds = %2
  %6 = load i32, ptr %1, align 4, !tbaa !20
  store i32 %6, ptr @topology_2d_x, align 4, !tbaa !20
  %7 = getelementptr inbounds i32, ptr %1, i64 1
  %8 = load i32, ptr %7, align 4, !tbaa !20
  store i32 %8, ptr @topology_2d_y, align 4, !tbaa !20
  br label %17

9:                                                ; preds = %2
  %10 = load i32, ptr %1, align 4, !tbaa !20
  store i32 %10, ptr @topology_3d_x, align 4, !tbaa !20
  %11 = getelementptr inbounds i32, ptr %1, i64 1
  %12 = load i32, ptr %11, align 4, !tbaa !20
  store i32 %12, ptr @topology_3d_y, align 4, !tbaa !20
  %13 = getelementptr inbounds i32, ptr %1, i64 2
  %14 = load i32, ptr %13, align 4, !tbaa !20
  store i32 %14, ptr @topology_3d_z, align 4, !tbaa !20
  br label %17

15:                                               ; preds = %2
  %16 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 401, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.9) #13
  br label %17
...
!11 = !{!"int", !9, i64 0}
!12 = !{!13, !8, i64 0}
!13 = !{!"PGH", !8, i64 0, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !8, i64 32, !11, i64 40, !8, i64 48, !11, i64 56, !11, i64 60, !14, i64 64, !14, i64 72, !14, i64 80, !14, i64 88, !11, i64 96, !11, i64 100, !11, i64 104, !11, i64 108, !11, i64 112, !8, i64 120, !8, i64 128, !8, i64 136}
!14 = !{!"double", !9, i64 0}
!15 = !{!13, !8, i64 120}
!16 = !{!13, !8, i64 128}
!17 = !{!13, !11, i64 12}
...
!32 = !{!8, !8, i64 0}
!33 = !{!34, !8, i64 8}
!34 = !{!"PConnectivity", !11, i64 0, !8, i64 8, !8, i64 16, !8, i64 24}
!35 = !{!34, !8, i64 16}
!36 = distinct !{!36, !28}
!37 = !{!13, !11, i64 112}
!38 = !{!13, !11, i64 20}
...
!40 = !{!13, !11, i64 60}
!41 = !{!42, !11, i64 16}
!42 = !{!"", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !11, i64 32}
!43 = !{!13, !8, i64 32}
!44 = !{!45, !8, i64 80}
!45 = !{!"PGA", !8, i64 0, !11, i64 8, !11, i64 12, !8, i64 16, !8, i64 24, !11, i64 32, !11, i64 36, !8, i64 40, !11, i64 48, !11, i64 52, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !11, i64 88, !11, i64 92, !8, i64 96}
!46 = !{!47, !11, i64 24}
!47 = !{!"PComm", !8, i64 0, !8, i64 8, !8, i64 16, !11, i64 24, !8, i64 32, !11, i64 40, !11, i64 44, !11, i64 48}
!48 = !{!42, !11, i64 12}
!49 = !{!45, !8, i64 64}
!50 = !{!45, !8, i64 56}
!51 = !{!42, !11, i64 20}
