...
@.str.1 = private unnamed_addr constant [17 x i8] c"PUGH/LoadAware.c\00", align 1
@.str.2 = private unnamed_addr constant [5 x i8] c"PUGH\00", align 1
@.str.3 = private unnamed_addr constant [30 x i8] c"Only 1D, 2D, and 3D supported\00", align 1
...
@.str.5 = private unnamed_addr constant [55 x i8] c"Only 1D, 2D, and 3D supported in manual topology setup\00", align 1
...
3:                                                ; preds = %2
  %4 = load ptr, ptr @partition_1D.0, align 8, !tbaa !6
...
7:                                                ; preds = %6, %3
  ...
  store ptr %9, ptr @partition_1D.0, align 8, !tbaa !6
  br label %47

10:                                               ; preds = %2
  %11 = load ptr, ptr @partition_2D.0, align 16, !tbaa !6
...
14:                                               ; preds = %13, %10
  %15 = load ptr, ptr @partition_2D.1, align 16, !tbaa !6
...
18:                                               ; preds = %17, %14
  ...
  store ptr %20, ptr @partition_2D.0, align 16, !tbaa !6
  %21 = getelementptr inbounds ptr, ptr %1, i64 1
  %22 = load ptr, ptr %21, align 8, !tbaa !6
  %23 = tail call ptr @Util_Strdup(ptr noundef %22) #8
  store ptr %23, ptr @partition_2D.1, align 16, !tbaa !6
  br label %47

24:                                               ; preds = %2
  %25 = load ptr, ptr @partition_3D.0, align 16, !tbaa !6
...
28:                                               ; preds = %27, %24
  %29 = load ptr, ptr @partition_3D.1, align 16, !tbaa !6
...
32:                                               ; preds = %31, %28
  %33 = load ptr, ptr @partition_3D.2, align 16, !tbaa !6
...
36:                                               ; preds = %35, %32
  ...
  store ptr %38, ptr @partition_3D.0, align 16, !tbaa !6
  %39 = getelementptr inbounds ptr, ptr %1, i64 1
  %40 = load ptr, ptr %39, align 8, !tbaa !6
  %41 = tail call ptr @Util_Strdup(ptr noundef %40) #8
  store ptr %41, ptr @partition_3D.1, align 16, !tbaa !6
  %42 = getelementptr inbounds ptr, ptr %1, i64 2
  %43 = load ptr, ptr %42, align 8, !tbaa !6
  %44 = tail call ptr @Util_Strdup(ptr noundef %43) #8
  store ptr %44, ptr @partition_3D.2, align 16, !tbaa !6
  br label %47

45:                                               ; preds = %2
  %46 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 131, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #8
  br label %47
...
define dso_local i32 @PUGH_GetBounds(i32 noundef %0, i32 noundef %1, ptr nocapture noundef %2, ptr nocapture noundef readonly %3, ptr nocapture noundef readonly %4) local_unnamed_addr #1 {
  %6 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 2), align 8, !tbaa !10
  %7 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 3), align 8, !tbaa !13
  %8 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 4), align 8, !tbaa !14
  %9 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 5), align 8, !tbaa !15
  %10 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 6), align 8, !tbaa !16
  %11 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 7), align 8, !tbaa !17
  %12 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 8), align 8, !tbaa !18
  %13 = tail call i32 @CCTK_Equals(ptr noundef %6, ptr noundef nonnull @.str.4) #8
...
88:                                               ; preds = %80
  %89 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 233, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.5) #8
  br label %143
...
90:                                               ; preds = %86, %140
  ...
  store ptr %99, ptr %96, align 8, !tbaa !6
  %100 = icmp eq ptr %99, null
  br i1 %100, label %101, label %103

101:                                              ; preds = %90
  %102 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 295, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.6) #8
  br label %103
...
105:                                              ; preds = %103
  %106 = load ptr, ptr %96, align 8, !tbaa !6
...
112:                                              ; preds = %112, %110
  ...
  store i32 %122, ptr %124, align 4, !tbaa !19
  %125 = xor i32 %122, -1
  %126 = add i32 %95, %125
...
138:                                              ; preds = %134
  ...
  store i32 %136, ptr %139, align 4, !tbaa !19
  br label %140

140:                                              ; preds = %138, %134, %103
  %141 = add nuw nsw i64 %91, 1
  %142 = icmp eq i64 %141, %87
  br i1 %142, label %143, label %90, !llvm.loop !22
...
11:                                               ; preds = %5
  %12 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 295, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.6) #8
  br label %13
...
23:                                               ; preds = %18
  %24 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 305, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.7) #8
  br label %25
...
25:                                               ; preds = %23, %18
  ...
  store i32 %29, ptr %31, align 4, !tbaa !19
...
36:                                               ; preds = %36, %25
  ...
  br i1 %43, label %45, label %36, !llvm.loop !26
...
48:                                               ; preds = %45, %56
  ...
  %54 = and i16 %53, 2048
  %55 = icmp eq i16 %54, 0
  br i1 %55, label %56, label %18, !llvm.loop !27

56:                                               ; preds = %48
  %57 = getelementptr inbounds i8, ptr %50, i64 1
  %58 = load i8, ptr %57, align 1, !tbaa !23
  %59 = icmp eq i8 %58, 0
  br i1 %59, label %60, label %48, !llvm.loop !28
...
63:                                               ; preds = %60
  %64 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 324, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.9) #8
  br label %65
...
67:                                               ; preds = %65
  %68 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 329, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.10) #8
  br label %106
...
!9 = !{!"Simple C/C++ TBAA"}
!10 = !{!11, !7, i64 16}
!11 = !{!"", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !7, i64 72, !7, i64 80, !7, i64 88, !12, i64 96, !12, i64 100, !12, i64 104, !12, i64 108, !12, i64 112, !12, i64 116, !12, i64 120, !12, i64 124, !12, i64 128, !12, i64 132, !12, i64 136, !12, i64 140, !12, i64 144, !12, i64 148, !12, i64 152, !12, i64 156, !12, i64 160, !12, i64 164, !12, i64 168, !12, i64 172, !12, i64 176, !12, i64 180, !12, i64 184, !12, i64 188, !12, i64 192, !12, i64 196, !12, i64 200, !12, i64 204, !12, i64 208, !12, i64 212, !12, i64 216, !12, i64 220, !12, i64 224, !12, i64 228, !12, i64 232, !12, i64 236, !12, i64 240, !12, i64 244, !12, i64 248, !12, i64 252, !12, i64 256, !12, i64 260, !12, i64 264}
!12 = !{!"int", !8, i64 0}
!13 = !{!11, !7, i64 24}
!14 = !{!11, !7, i64 32}
!15 = !{!11, !7, i64 40}
