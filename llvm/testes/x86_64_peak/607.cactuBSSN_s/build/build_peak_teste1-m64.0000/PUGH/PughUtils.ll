...
@.str.1 = private unnamed_addr constant [17 x i8] c"PUGH/PughUtils.c\00", align 1
@.str.2 = private unnamed_addr constant [5 x i8] c"PUGH\00", align 1
@.str.3 = private unnamed_addr constant [18 x i8] c"Illegal dimension\00", align 1
@pughpriv_ = external local_unnamed_addr global %struct.anon.0, align 8
@.str.4 = private unnamed_addr constant [27 x i8] c"Single processor evolution\00", align 1
@.str.5 = private unnamed_addr constant [30 x i8] c"%d-dimensional grid functions\00", align 1
@.str.7 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.9 = private unnamed_addr constant [6 x i8] c"%s%s \00", align 1
@.str.10 = private unnamed_addr constant [37 x i8] c"Grid Variables with storage enabled:\00", align 1
@.str.11 = private unnamed_addr constant [20 x i8] c" Grid Functions: %s\00", align 1
@.str.12 = private unnamed_addr constant [17 x i8] c" Grid Arrays: %s\00", align 1
@.str.13 = private unnamed_addr constant [18 x i8] c" Grid Scalars: %s\00", align 1
...
4:                                                ; preds = %2
  %5 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 75, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #8
  br label %6

6:                                                ; preds = %4, %2
  %7 = tail call ptr @CCTK_GHExtension(ptr noundef %0, ptr noundef nonnull @.str.2) #8
...
define dso_local ptr @PUGH_pGH(ptr noundef %0) local_unnamed_addr #1 {
  %2 = tail call ptr @CCTK_GHExtension(ptr noundef %0, ptr noundef nonnull @.str.2) #8
  ret ptr %2
}
...
define dso_local void @PUGH_Report(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %7 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.4) #8
...
26:                                               ; preds = %15, %22, %19
  ...
  br i1 %29, label %15, label %10, !llvm.loop !19
...
38:                                               ; preds = %30
  ...
  %40 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.5, i32 noundef %39) #8
...
41:                                               ; preds = %38, %41
  ...
  %50 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(1) @.str.7, ptr noundef nonnull %6, i32 noundef %49) #8
  %51 = add nuw nsw i64 %42, 1
  %52 = icmp eq i64 %51, %33
  br i1 %52, label %53, label %41, !llvm.loop !24

53:                                               ; preds = %41
  %54 = tail call i32 @CCTK_Info(ptr noundef nonnull @.str.2, ptr noundef nonnull %6) #8
...
56:                                               ; preds = %30, %53
  ...
  br i1 %59, label %30, label %61, !llvm.loop !25
...
define dso_local void @PUGH_PrintStorageReport(ptr nocapture noundef readonly %0) local_unnamed_addr #1 {
  %2 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @pughpriv_, i64 0, i32 53), align 4, !tbaa !26
  %3 = icmp sgt i32 %2, 0
...
32:                                               ; preds = %4, %26, %29, %14
  ...
  br i1 %38, label %4, label %39, !llvm.loop !29
...
72:                                               ; preds = %69
  ...
  %74 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %61, ptr noundef nonnull dereferenceable(1) @.str.9, ptr noundef %61, ptr noundef %73) #8
  br label %83
...
79:                                               ; preds = %75
  %80 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %60, ptr noundef nonnull dereferenceable(1) @.str.9, ptr noundef %60, ptr noundef %78) #8
  br label %83

81:                                               ; preds = %75
  %82 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %62, ptr noundef nonnull dereferenceable(1) @.str.9, ptr noundef %62, ptr noundef %78) #8
  br label %83
...
83:                                               ; preds = %65, %79, %81, %72
  ...
  br i1 %86, label %65, label %87, !llvm.loop !30
...
93:                                               ; preds = %87
  %94 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.10) #8
  br i1 %88, label %95, label %97

95:                                               ; preds = %93
  %96 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.11, ptr noundef nonnull %61) #8
  br label %97
...
98:                                               ; preds = %97
  %99 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.12, ptr noundef nonnull %60) #8
  br label %100
...
101:                                              ; preds = %100
  %102 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.13, ptr noundef nonnull %62) #8
  br label %103
