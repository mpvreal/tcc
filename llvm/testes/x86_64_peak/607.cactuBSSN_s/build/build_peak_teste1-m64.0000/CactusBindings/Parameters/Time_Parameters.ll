...
%struct.anon = type { double, double, double, i32, i32 }
%struct.anon.0 = type { ptr, i32 }

@timepriv_ = dso_local global %struct.anon zeroinitializer, align 8
@timerest_ = dso_local global %struct.anon.0 zeroinitializer, align 8
...
define dso_local i32 @CCTKi_BindingsCreateTimeParameters() local_unnamed_addr #0 {
  ...
  %2 = tail call i32 (ptr, ptr, ptr, ptr, i32, ptr, ptr, ptr, i32, ptr, i32, ...) @CCTKi_ParameterCreate(ptr noundef nonnull @.str.13, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.14, ptr noundef nonnull @.str.3, i32 noundef 200, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.16, ptr noundef nonnull getelementptr inbounds (%struct.anon.0, ptr @timerest_, i64 0, i32 1), i32 noundef 0, ptr noundef null, i32 noundef 0) #3
  ...
  %4 = tail call i32 (ptr, ptr, ptr, ptr, i32, ptr, ptr, ptr, i32, ptr, i32, ...) @CCTKi_ParameterCreate(ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19, i32 noundef 200, ptr noundef nonnull @.str.27, ptr noundef nonnull @.str.28, ptr noundef nonnull getelementptr inbounds (%struct.anon, ptr @timepriv_, i64 0, i32 1), i32 noundef 0, ptr noundef null, i32 noundef 2, ptr noundef nonnull @.str.22, ptr noundef nonnull @.str.23, ptr noundef nonnull @.str.24, ptr noundef nonnull @.str.25) #3
  %5 = tail call i32 (ptr, ptr, ptr, ptr, i32, ptr, ptr, ptr, i32, ptr, i32, ...) @CCTKi_ParameterCreate(ptr noundef nonnull @.str.29, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19, i32 noundef 200, ptr noundef nonnull @.str.30, ptr noundef nonnull @.str.31, ptr noundef nonnull getelementptr inbounds (%struct.anon, ptr @timepriv_, i64 0, i32 2), i32 noundef 0, ptr noundef null, i32 noundef 1, ptr noundef nonnull @.str.32, ptr noundef nonnull @.str.33) #3
  %6 = tail call i32 (ptr, ptr, ptr, ptr, i32, ptr, ptr, ptr, i32, ptr, i32, ...) @CCTKi_ParameterCreate(ptr noundef nonnull @.str.34, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.35, ptr noundef nonnull @.str.19, i32 noundef 200, ptr noundef nonnull @.str.36, ptr noundef nonnull @.str.37, ptr noundef nonnull getelementptr inbounds (%struct.anon, ptr @timepriv_, i64 0, i32 3), i32 noundef 0, ptr noundef null, i32 noundef 1, ptr noundef nonnull @.str.38, ptr noundef nonnull @.str.39) #3
  %7 = tail call i32 (ptr, ptr, ptr, ptr, i32, ptr, ptr, ptr, i32, ptr, i32, ...) @CCTKi_ParameterCreate(ptr noundef nonnull @.str.40, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.14, ptr noundef nonnull @.str.19, i32 noundef 200, ptr noundef nonnull @.str.41, ptr noundef nonnull @.str.16, ptr noundef nonnull getelementptr inbounds (%struct.anon, ptr @timepriv_, i64 0, i32 4), i32 noundef 0, ptr noundef null, i32 noundef 0) #3
  ret i32 0
}
