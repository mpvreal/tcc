...
define dso_local void @CCTKi_BindingsSchedule_TmunuBase() local_unnamed_addr #0 {
  ...
  %8 = load i32, ptr @tmunubaserest_, align 4, !tbaa !6
  %9 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @tmunubaserest_, i64 0, i32 1), align 4, !tbaa !11
  %10 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @tmunubasepriv_, i64 0, i32 1), align 8, !tbaa !12
  %11 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @tmunubasepriv_, i64 0, i32 2), align 4, !tbaa !15
