...
define dso_local void @CCTKi_BindingsSchedule_IOUtil() local_unnamed_addr #0 {
  ...
  %5 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @iorest_, i64 0, i32 15), align 8, !tbaa !6
  %6 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @iorest_, i64 0, i32 16), align 8, !tbaa !13
  %7 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @iorest_, i64 0, i32 23), align 8, !tbaa !14
  %8 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @iorest_, i64 0, i32 24), align 8, !tbaa !15
  %9 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @iorest_, i64 0, i32 52), align 8, !tbaa !16
