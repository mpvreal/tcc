...
define dso_local void @CCTKi_BindingsSchedule_ADMBase() local_unnamed_addr #0 {
  ...
  %24 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 1), align 8, !tbaa !6
  %25 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 2), align 8, !tbaa !12
  %26 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 3), align 8, !tbaa !13
  %27 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 4), align 8, !tbaa !14
  %28 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 5), align 8, !tbaa !15
  %29 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 6), align 8, !tbaa !16
  %30 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 7), align 8, !tbaa !17
  %31 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 8), align 8, !tbaa !18
  %32 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 9), align 8, !tbaa !19
  %33 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 13), align 8, !tbaa !20
  %34 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 15), align 8, !tbaa !21
  %35 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 16), align 4, !tbaa !22
  %36 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @admbaserest_, i64 0, i32 17), align 8, !tbaa !23
