...
define internal i32 @CCTKi_BindingsFortranWrapperCartGrid3D(ptr noundef %0, ptr nocapture noundef readonly %1) #0 {
  ...
  %4 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dx, align 4, !tbaa !9
  %5 = icmp eq i32 %4, -1
  br i1 %5, label %6, label %8

6:                                                ; preds = %2
  %7 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.28) #3
  store i32 %7, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dx, align 4, !tbaa !9
  br label %8

8:                                                ; preds = %6, %2
  %9 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKGROUPNUM_gridspacings, align 4, !tbaa !9
  %10 = icmp eq i32 %9, -1
  br i1 %10, label %11, label %13

11:                                               ; preds = %8
  %12 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.29) #3
  store i32 %12, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKGROUPNUM_gridspacings, align 4, !tbaa !9
  br label %13

13:                                               ; preds = %11, %8
  %14 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dy, align 4, !tbaa !9
  %15 = icmp eq i32 %14, -1
  br i1 %15, label %16, label %18

16:                                               ; preds = %13
  %17 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.30) #3
  store i32 %17, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dy, align 4, !tbaa !9
  br label %18

18:                                               ; preds = %16, %13
  %19 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dz, align 4, !tbaa !9
  %20 = icmp eq i32 %19, -1
  br i1 %20, label %21, label %23

21:                                               ; preds = %18
  %22 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.31) #3
  store i32 %22, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dz, align 4, !tbaa !9
  br label %23

23:                                               ; preds = %21, %18
  %24 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_r, align 4, !tbaa !9
  %25 = icmp eq i32 %24, -1
  br i1 %25, label %26, label %28

26:                                               ; preds = %23
  %27 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.32) #3
  store i32 %27, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_r, align 4, !tbaa !9
  br label %28

28:                                               ; preds = %26, %23
  %29 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKGROUPNUM_coordinates, align 4, !tbaa !9
  %30 = icmp eq i32 %29, -1
  br i1 %30, label %31, label %33

31:                                               ; preds = %28
  %32 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.33) #3
  store i32 %32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKGROUPNUM_coordinates, align 4, !tbaa !9
  br label %33

33:                                               ; preds = %31, %28
  %34 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_x, align 4, !tbaa !9
  %35 = icmp eq i32 %34, -1
  br i1 %35, label %36, label %38

36:                                               ; preds = %33
  %37 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.34) #3
  store i32 %37, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_x, align 4, !tbaa !9
  br label %38

38:                                               ; preds = %36, %33
  %39 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_y, align 4, !tbaa !9
  %40 = icmp eq i32 %39, -1
  br i1 %40, label %41, label %43

41:                                               ; preds = %38
  %42 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.35) #3
  store i32 %42, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_y, align 4, !tbaa !9
  br label %43

43:                                               ; preds = %41, %38
  %44 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_z, align 4, !tbaa !9
  %45 = icmp eq i32 %44, -1
  br i1 %45, label %46, label %48

46:                                               ; preds = %43
  %47 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.36) #3
  store i32 %47, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_z, align 4, !tbaa !9
  br label %48
...
48:                                               ; preds = %46, %43
  ...
  %78 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dx, align 4, !tbaa !9
...
87:                                               ; preds = %48, %80
  ...
  %89 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dy, align 4, !tbaa !9
...
98:                                               ; preds = %87, %91
  ...
  %100 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_coarse_dz, align 4, !tbaa !9
...
109:                                              ; preds = %98, %102
  ...
  %111 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_r, align 4, !tbaa !9
...
120:                                              ; preds = %109, %113
  ...
  %122 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_x, align 4, !tbaa !9
...
131:                                              ; preds = %120, %124
  ...
  %133 = load i32, ptr @CCTKi_BindingsFortranWrapperCartGrid3D.CCTKARGNUM_y, align 4, !tbaa !9
