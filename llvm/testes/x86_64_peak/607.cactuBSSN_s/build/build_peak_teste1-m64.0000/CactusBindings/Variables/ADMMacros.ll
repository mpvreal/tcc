...
define internal i32 @CCTKi_BindingsFortranWrapperADMMacros(ptr noundef %0, ptr nocapture noundef readonly %1) #0 {
  ...
  %4 = load i32, ptr @CCTKi_BindingsFortranWrapperADMMacros.CCTKARGNUM_local_spatial_order, align 4, !tbaa !9
  %5 = icmp eq i32 %4, -1
  br i1 %5, label %6, label %8

6:                                                ; preds = %2
  %7 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.14) #3
  store i32 %7, ptr @CCTKi_BindingsFortranWrapperADMMacros.CCTKARGNUM_local_spatial_order, align 4, !tbaa !9
  br label %8

8:                                                ; preds = %6, %2
  %9 = phi i32 [ %7, %6 ], [ %4, %2 ]
  %10 = load i32, ptr @CCTKi_BindingsFortranWrapperADMMacros.CCTKGROUPNUM_local_spatial_order, align 4, !tbaa !9
  %11 = icmp eq i32 %10, -1
  br i1 %11, label %12, label %15

12:                                               ; preds = %8
  %13 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.14) #3
  store i32 %13, ptr @CCTKi_BindingsFortranWrapperADMMacros.CCTKGROUPNUM_local_spatial_order, align 4, !tbaa !9
  %14 = load i32, ptr @CCTKi_BindingsFortranWrapperADMMacros.CCTKARGNUM_local_spatial_order, align 4, !tbaa !9
  br label %15
