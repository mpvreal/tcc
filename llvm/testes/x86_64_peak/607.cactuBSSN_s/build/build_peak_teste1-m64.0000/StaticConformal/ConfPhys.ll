...
@.str.1 = private unnamed_addr constant [27 x i8] c"StaticConformal/ConfPhys.c\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"StaticConformal\00", align 1
@.str.3 = private unnamed_addr constant [41 x i8] c"Converting metric: conformal -> physical\00", align 1
@.str.4 = private unnamed_addr constant [41 x i8] c"Converting metric: physical -> conformal\00", align 1
...
define dso_local void @StaticConf_ConfToPhysInPlace(i32 noundef %0, i32 noundef %1, i32 noundef %2, ptr noalias nocapture noundef readonly %3, ptr noalias nocapture noundef %4, ptr noalias nocapture noundef %5, ptr noalias nocapture noundef %6, ptr noalias nocapture noundef %7, ptr noalias nocapture noundef %8, ptr noalias nocapture noundef %9) local_unnamed_addr #1 {
  %11 = tail call i32 @CCTK_Warn(i32 noundef 4, i32 noundef 119, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #3
  %12 = mul nsw i32 %1, %0
  %13 = mul nsw i32 %12, %2
...
35:                                               ; preds = %35, %25
  ...
  %41 = load <4 x double>, ptr %40, align 8, !tbaa !6
  %42 = fmul fast <4 x double> %41, %41
  %43 = fmul fast <4 x double> %42, %42
  %44 = getelementptr double, ptr %29, i64 %39
  %45 = load <4 x double>, ptr %44, align 8, !tbaa !6
  %46 = fmul fast <4 x double> %43, %45
  store <4 x double> %46, ptr %44, align 8, !tbaa !6
  %47 = getelementptr double, ptr %30, i64 %39
  %48 = load <4 x double>, ptr %47, align 8, !tbaa !6
  %49 = fmul fast <4 x double> %48, %43
  store <4 x double> %49, ptr %47, align 8, !tbaa !6
  %50 = getelementptr double, ptr %31, i64 %39
  %51 = load <4 x double>, ptr %50, align 8, !tbaa !6
  %52 = fmul fast <4 x double> %51, %43
  store <4 x double> %52, ptr %50, align 8, !tbaa !6
  %53 = getelementptr double, ptr %32, i64 %39
  %54 = load <4 x double>, ptr %53, align 8, !tbaa !6
  %55 = fmul fast <4 x double> %54, %43
  store <4 x double> %55, ptr %53, align 8, !tbaa !6
  %56 = getelementptr double, ptr %33, i64 %39
  %57 = load <4 x double>, ptr %56, align 8, !tbaa !6
  %58 = fmul fast <4 x double> %57, %43
  store <4 x double> %58, ptr %56, align 8, !tbaa !6
  %59 = getelementptr double, ptr %34, i64 %39
  %60 = load <4 x double>, ptr %59, align 8, !tbaa !6
  %61 = fmul fast <4 x double> %60, %43
  store <4 x double> %61, ptr %59, align 8, !tbaa !6
  %62 = add nuw i64 %36, 4
...
define dso_local void @StaticConf_PhysToConfInPlace(i32 noundef %0, i32 noundef %1, i32 noundef %2, ptr noalias nocapture noundef readonly %3, ptr noalias nocapture noundef %4, ptr noalias nocapture noundef %5, ptr noalias nocapture noundef %6, ptr noalias nocapture noundef %7, ptr noalias nocapture noundef %8, ptr noalias nocapture noundef %9) local_unnamed_addr #1 {
  %11 = tail call i32 @CCTK_Warn(i32 noundef 4, i32 noundef 206, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.4) #3
  %12 = mul nsw i32 %1, %0
  %13 = mul nsw i32 %12, %2
  %14 = icmp sgt i32 %13, 0
...
35:                                               ; preds = %35, %25
  ...
  %46 = load <4 x double>, ptr %45, align 8, !tbaa !6
  %47 = fmul fast <4 x double> %44, %46
  store <4 x double> %47, ptr %45, align 8, !tbaa !6
  %48 = getelementptr double, ptr %30, i64 %39
  %49 = load <4 x double>, ptr %48, align 8, !tbaa !6
  %50 = fmul fast <4 x double> %49, %44
  store <4 x double> %50, ptr %48, align 8, !tbaa !6
  %51 = getelementptr double, ptr %31, i64 %39
  %52 = load <4 x double>, ptr %51, align 8, !tbaa !6
  %53 = fmul fast <4 x double> %52, %44
  store <4 x double> %53, ptr %51, align 8, !tbaa !6
  %54 = getelementptr double, ptr %32, i64 %39
  %55 = load <4 x double>, ptr %54, align 8, !tbaa !6
  %56 = fmul fast <4 x double> %55, %44
  store <4 x double> %56, ptr %54, align 8, !tbaa !6
  %57 = getelementptr double, ptr %33, i64 %39
  %58 = load <4 x double>, ptr %57, align 8, !tbaa !6
  %59 = fmul fast <4 x double> %58, %44
  store <4 x double> %59, ptr %57, align 8, !tbaa !6
  %60 = getelementptr double, ptr %34, i64 %39
  %61 = load <4 x double>, ptr %60, align 8, !tbaa !6
  %62 = fmul fast <4 x double> %61, %44
  store <4 x double> %62, ptr %60, align 8, !tbaa !6
  %63 = add nuw i64 %36, 4
...
69:                                               ; preds = %67, %69
  ...
  store double %80, ptr %78, align 8, !tbaa !6
