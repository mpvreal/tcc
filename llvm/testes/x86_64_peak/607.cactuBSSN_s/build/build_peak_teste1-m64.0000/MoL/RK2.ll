...
@.str.17 = private unnamed_addr constant [10 x i8] c"MoL/RK2.c\00", align 1
@.str.18 = private unnamed_addr constant [4 x i8] c"MoL\00", align 1
@.str.19 = private unnamed_addr constant [97 x i8] c"RK2 expects MoL_Intermediate_Step to be in [1,2]. This should be caught at ParamCheck - bug Ian!\00", align 1
...
define dso_local void @MoL_RK2Add(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %18 = load i32, ptr @MoL_RK2Add.cctki_vi_Count, align 4, !tbaa !14
  %19 = icmp eq i32 %18, -100
  br i1 %19, label %20, label %22

20:                                               ; preds = %1
  %21 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #4
  store i32 %21, ptr @MoL_RK2Add.cctki_vi_Count, align 4, !tbaa !14
  br label %22

22:                                               ; preds = %20, %1
  %23 = phi i32 [ %21, %20 ], [ %18, %1 ]
  %24 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %23) #4
  %25 = load i32, ptr @MoL_RK2Add.cctki_vi_Error, align 4, !tbaa !14
  %26 = icmp eq i32 %25, -100
  br i1 %26, label %27, label %29

27:                                               ; preds = %22
  %28 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #4
  store i32 %28, ptr @MoL_RK2Add.cctki_vi_Error, align 4, !tbaa !14
  br label %29

29:                                               ; preds = %27, %22
  %30 = phi i32 [ %28, %27 ], [ %25, %22 ]
  %31 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %30) #4
  %32 = load i32, ptr @MoL_RK2Add.cctki_vi_ErrorEstimate, align 4, !tbaa !14
  %33 = icmp eq i32 %32, -100
  br i1 %33, label %34, label %36

34:                                               ; preds = %29
  %35 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.3) #4
  store i32 %35, ptr @MoL_RK2Add.cctki_vi_ErrorEstimate, align 4, !tbaa !14
  br label %36

36:                                               ; preds = %34, %29
  %37 = phi i32 [ %35, %34 ], [ %32, %29 ]
  %38 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %37) #4
  %39 = load i32, ptr @MoL_RK2Add.cctki_vi_EstimatedDt, align 4, !tbaa !14
  %40 = icmp eq i32 %39, -100
  br i1 %40, label %41, label %43

41:                                               ; preds = %36
  %42 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.4) #4
  store i32 %42, ptr @MoL_RK2Add.cctki_vi_EstimatedDt, align 4, !tbaa !14
  br label %43

43:                                               ; preds = %41, %36
  %44 = phi i32 [ %42, %41 ], [ %39, %36 ]
  %45 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %44) #4
  %46 = load i32, ptr @MoL_RK2Add.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !14
  %47 = icmp eq i32 %46, -100
  br i1 %47, label %48, label %50

48:                                               ; preds = %43
  %49 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.5) #4
  store i32 %49, ptr @MoL_RK2Add.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !14
  br label %50

50:                                               ; preds = %48, %43
  %51 = phi i32 [ %49, %48 ], [ %46, %43 ]
  %52 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %51) #4
  %53 = load i32, ptr @MoL_RK2Add.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !14
  %54 = icmp eq i32 %53, -100
  br i1 %54, label %55, label %57

55:                                               ; preds = %50
  %56 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.6) #4
  store i32 %56, ptr @MoL_RK2Add.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !14
  br label %57

57:                                               ; preds = %55, %50
  %58 = phi i32 [ %56, %55 ], [ %53, %50 ]
  %59 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %58) #4
  %60 = load i32, ptr @MoL_RK2Add.cctki_vi_MoL_SlowStep, align 4, !tbaa !14
  %61 = icmp eq i32 %60, -100
  br i1 %61, label %62, label %64

62:                                               ; preds = %57
  %63 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.7) #4
  store i32 %63, ptr @MoL_RK2Add.cctki_vi_MoL_SlowStep, align 4, !tbaa !14
  br label %64

64:                                               ; preds = %62, %57
  %65 = phi i32 [ %63, %62 ], [ %60, %57 ]
  %66 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %65) #4
  %67 = load i32, ptr @MoL_RK2Add.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !14
  %68 = icmp eq i32 %67, -100
  br i1 %68, label %69, label %71

69:                                               ; preds = %64
  %70 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.8) #4
  store i32 %70, ptr @MoL_RK2Add.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !14
  br label %71

71:                                               ; preds = %69, %64
  %72 = phi i32 [ %70, %69 ], [ %67, %64 ]
  %73 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %72) #4
  %74 = load i32, ptr @MoL_RK2Add.cctki_vi_Original_Delta_Time, align 4, !tbaa !14
  %75 = icmp eq i32 %74, -100
  br i1 %75, label %76, label %78

76:                                               ; preds = %71
  %77 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.9) #4
  store i32 %77, ptr @MoL_RK2Add.cctki_vi_Original_Delta_Time, align 4, !tbaa !14
  br label %78

78:                                               ; preds = %76, %71
  %79 = phi i32 [ %77, %76 ], [ %74, %71 ]
  %80 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %79) #4
  %81 = load i32, ptr @MoL_RK2Add.cctki_vi_Original_Time, align 4, !tbaa !14
  %82 = icmp eq i32 %81, -100
  br i1 %82, label %83, label %85

83:                                               ; preds = %78
  %84 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.10) #4
  store i32 %84, ptr @MoL_RK2Add.cctki_vi_Original_Time, align 4, !tbaa !14
  br label %85

85:                                               ; preds = %83, %78
  %86 = phi i32 [ %84, %83 ], [ %81, %78 ]
  %87 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %86) #4
  %88 = load i32, ptr @MoL_RK2Add.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !14
  %89 = icmp eq i32 %88, -100
  br i1 %89, label %90, label %92

90:                                               ; preds = %85
  %91 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.11) #4
  store i32 %91, ptr @MoL_RK2Add.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !14
  br label %92

92:                                               ; preds = %90, %85
  %93 = phi i32 [ %91, %90 ], [ %88, %85 ]
  %94 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %93) #4
  %95 = load i32, ptr @MoL_RK2Add.cctki_vi_RKBetaCoefficients, align 4, !tbaa !14
  %96 = icmp eq i32 %95, -100
  br i1 %96, label %97, label %99

97:                                               ; preds = %92
  %98 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.12) #4
  store i32 %98, ptr @MoL_RK2Add.cctki_vi_RKBetaCoefficients, align 4, !tbaa !14
  br label %99

99:                                               ; preds = %97, %92
  %100 = phi i32 [ %98, %97 ], [ %95, %92 ]
  %101 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %100) #4
  %102 = load i32, ptr @MoL_RK2Add.cctki_vi_SandRScratchSpace, align 4, !tbaa !14
  %103 = icmp eq i32 %102, -100
  br i1 %103, label %104, label %106

104:                                              ; preds = %99
  %105 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.13) #4
  store i32 %105, ptr @MoL_RK2Add.cctki_vi_SandRScratchSpace, align 4, !tbaa !14
  br label %106

106:                                              ; preds = %104, %99
  %107 = phi i32 [ %105, %104 ], [ %102, %99 ]
  %108 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %107) #4
  %109 = load i32, ptr @MoL_RK2Add.cctki_vi_ScratchSpace, align 4, !tbaa !14
  %110 = icmp eq i32 %109, -100
  br i1 %110, label %111, label %113

111:                                              ; preds = %106
  %112 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.14) #4
  store i32 %112, ptr @MoL_RK2Add.cctki_vi_ScratchSpace, align 4, !tbaa !14
  br label %113

113:                                              ; preds = %111, %106
  %114 = phi i32 [ %112, %111 ], [ %109, %106 ]
  %115 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %114) #4
  %116 = load i32, ptr @MoL_RK2Add.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !14
  %117 = icmp eq i32 %116, -100
  br i1 %117, label %118, label %120

118:                                              ; preds = %113
  %119 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.15) #4
  store i32 %119, ptr @MoL_RK2Add.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !14
  br label %120

120:                                              ; preds = %118, %113
  %121 = phi i32 [ %119, %118 ], [ %116, %113 ]
  %122 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %121) #4
  %123 = load i32, ptr %52, align 4, !tbaa !14
...
124:                                              ; preds = %120
  %125 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
...
132:                                              ; preds = %120
  %133 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
...
138:                                              ; preds = %144, %132
  %139 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
...
144:                                              ; preds = %135, %144
  ...
  %146 = load ptr, ptr @RHSVariableIndex, align 8, !tbaa !15
  %147 = getelementptr inbounds i32, ptr %146, i64 %145
  %148 = load i32, ptr %147, align 4, !tbaa !14
  store i32 %148, ptr %2, align 4, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #4
  store i32 0, ptr %3, align 4
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %4) #4
  store double %137, ptr %4, align 8, !tbaa !16
  %149 = load ptr, ptr @EvolvedVariableIndex, align 8, !tbaa !15
  ...
  %154 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
  %155 = sext i32 %154 to i64
  %156 = icmp slt i64 %153, %155
  br i1 %156, label %144, label %138, !llvm.loop !17

157:                                              ; preds = %141, %157
  %158 = phi i64 [ 0, %141 ], [ %166, %157 ]
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #4
  %159 = load ptr, ptr @RHSArrayVariableIndex, align 8, !tbaa !15
  ...
  store double %143, ptr %7, align 8, !tbaa !16
  %162 = load ptr, ptr @EvolvedArrayVariableIndex, align 8, !tbaa !15
  ...
  %167 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
  %168 = sext i32 %167 to i64
  %169 = icmp slt i64 %166, %168
  br i1 %169, label %157, label %208, !llvm.loop !19

170:                                              ; preds = %178, %124
  %171 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
...
178:                                              ; preds = %127, %178
  ...
  %180 = load ptr, ptr @EvolvedVariableIndex, align 8, !tbaa !15
  %181 = getelementptr inbounds i32, ptr %180, i64 %179
  %182 = load i32, ptr %181, align 4, !tbaa !14
  store i32 %182, ptr %8, align 4, !tbaa !14
  %183 = load ptr, ptr @RHSVariableIndex, align 8, !tbaa !15
  %184 = getelementptr inbounds i32, ptr %183, i64 %179
  %185 = load i32, ptr %184, align 4, !tbaa !14
  store i32 %185, ptr %128, align 4, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %9) #4
  store i64 1, ptr %9, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %10) #4
  store double 5.000000e-01, ptr %10, align 16, !tbaa !16
  store double %131, ptr %129, align 8, !tbaa !16
  %186 = load i32, ptr %181, align 4, !tbaa !14
...
192:                                              ; preds = %173, %192
  ...
  %203 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
  %204 = sext i32 %203 to i64
  %205 = icmp slt i64 %202, %204
  br i1 %205, label %192, label %208, !llvm.loop !21

206:                                              ; preds = %120
  %207 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 214, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19) #4
  br label %208
