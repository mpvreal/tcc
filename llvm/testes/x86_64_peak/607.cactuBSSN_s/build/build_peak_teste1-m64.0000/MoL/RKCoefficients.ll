...
@.str.16 = private unnamed_addr constant [12 x i8] c"Classic RK3\00", align 1
@.str.17 = private unnamed_addr constant [21 x i8] c"MoL/RKCoefficients.c\00", align 1
@.str.18 = private unnamed_addr constant [4 x i8] c"MoL\00", align 1
@.str.19 = private unnamed_addr constant [61 x i8] c"For Classic RK3, MoL_Num_Scratch_Levels should be at least 2\00", align 1
@.str.20 = private unnamed_addr constant [61 x i8] c"For Classic RK3, MoL_Intermediate_Steps should be at least 3\00", align 1
@.str.21 = private unnamed_addr constant [4 x i8] c"ICN\00", align 1
@.str.22 = private unnamed_addr constant [3 x i8] c"RK\00", align 1
@.str.23 = private unnamed_addr constant [93 x i8] c"For generic RK methods, MoL_Num_Scratch_Levels should be at least MoL_Intermediate_Steps - 1\00", align 1
@.str.24 = private unnamed_addr constant [87 x i8] c"RKCoefficients cannot do generic RK methods with MoL_Intermediate_Steps greater than 4\00", align 1
@.str.25 = private unnamed_addr constant [6 x i8] c"Table\00", align 1
@.str.26 = private unnamed_addr constant [90 x i8] c"For generic methods, MoL_Num_Scratch_Levels should be at least MoL_Intermediate_Steps - 1\00", align 1
@.str.27 = private unnamed_addr constant [55 x i8] c"Failed to create table from Generic_Method_Descriptor!\00", align 1
@.str.28 = private unnamed_addr constant [19 x i8] c"GenericAlphaCoeffs\00", align 1
@.str.29 = private unnamed_addr constant [64 x i8] c"Insufficient elements in the specified GenericAlphaCoeffs array\00", align 1
@.str.30 = private unnamed_addr constant [92 x i8] c"When using the generic table options you must set \22GenericAlphaCoeffs\22 in the options table\00", align 1
@.str.31 = private unnamed_addr constant [30 x i8] c"Table error - check with Ian.\00", align 1
@.str.32 = private unnamed_addr constant [18 x i8] c"GenericBetaCoeffs\00", align 1
@.str.33 = private unnamed_addr constant [63 x i8] c"Insufficient elements in the specified GenericBetaCoeffs array\00", align 1
@.str.34 = private unnamed_addr constant [91 x i8] c"When using the generic table options you must set \22GenericBetaCoeffs\22 in the options table\00", align 1
@.str.35 = private unnamed_addr constant [60 x i8] c"RKCoefficients does not recognize the value of Generic_Type\00", align 1
...
define dso_local void @MoL_SetupRKCoefficients(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_Count, align 4, !tbaa !6
  %3 = icmp eq i32 %2, -100
  br i1 %3, label %4, label %6

4:                                                ; preds = %1
  %5 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #4
  store i32 %5, ptr @MoL_SetupRKCoefficients.cctki_vi_Count, align 4, !tbaa !6
  br label %6

6:                                                ; preds = %4, %1
  %7 = phi i32 [ %5, %4 ], [ %2, %1 ]
  %8 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %7) #4
  %9 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_Error, align 4, !tbaa !6
  %10 = icmp eq i32 %9, -100
  br i1 %10, label %11, label %13

11:                                               ; preds = %6
  %12 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #4
  store i32 %12, ptr @MoL_SetupRKCoefficients.cctki_vi_Error, align 4, !tbaa !6
  br label %13

13:                                               ; preds = %11, %6
  %14 = phi i32 [ %12, %11 ], [ %9, %6 ]
  %15 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %14) #4
  %16 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_ErrorEstimate, align 4, !tbaa !6
  %17 = icmp eq i32 %16, -100
  br i1 %17, label %18, label %20

18:                                               ; preds = %13
  %19 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.3) #4
  store i32 %19, ptr @MoL_SetupRKCoefficients.cctki_vi_ErrorEstimate, align 4, !tbaa !6
  br label %20

20:                                               ; preds = %18, %13
  %21 = phi i32 [ %19, %18 ], [ %16, %13 ]
  %22 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %21) #4
  %23 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_EstimatedDt, align 4, !tbaa !6
  %24 = icmp eq i32 %23, -100
  br i1 %24, label %25, label %27

25:                                               ; preds = %20
  %26 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.4) #4
  store i32 %26, ptr @MoL_SetupRKCoefficients.cctki_vi_EstimatedDt, align 4, !tbaa !6
  br label %27

27:                                               ; preds = %25, %20
  %28 = phi i32 [ %26, %25 ], [ %23, %20 ]
  %29 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %28) #4
  %30 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !6
  %31 = icmp eq i32 %30, -100
  br i1 %31, label %32, label %34

32:                                               ; preds = %27
  %33 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.5) #4
  store i32 %33, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !6
  br label %34

34:                                               ; preds = %32, %27
  %35 = phi i32 [ %33, %32 ], [ %30, %27 ]
  %36 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %35) #4
  %37 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !6
  %38 = icmp eq i32 %37, -100
  br i1 %38, label %39, label %41

39:                                               ; preds = %34
  %40 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.6) #4
  store i32 %40, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !6
  br label %41

41:                                               ; preds = %39, %34
  %42 = phi i32 [ %40, %39 ], [ %37, %34 ]
  %43 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %42) #4
  %44 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_SlowStep, align 4, !tbaa !6
  %45 = icmp eq i32 %44, -100
  br i1 %45, label %46, label %48

46:                                               ; preds = %41
  %47 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.7) #4
  store i32 %47, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_SlowStep, align 4, !tbaa !6
  br label %48

48:                                               ; preds = %46, %41
  %49 = phi i32 [ %47, %46 ], [ %44, %41 ]
  %50 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %49) #4
  %51 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !6
  %52 = icmp eq i32 %51, -100
  br i1 %52, label %53, label %55

53:                                               ; preds = %48
  %54 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.8) #4
  store i32 %54, ptr @MoL_SetupRKCoefficients.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !6
  br label %55

55:                                               ; preds = %53, %48
  %56 = phi i32 [ %54, %53 ], [ %51, %48 ]
  %57 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %56) #4
  %58 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_Original_Delta_Time, align 4, !tbaa !6
  %59 = icmp eq i32 %58, -100
  br i1 %59, label %60, label %62

60:                                               ; preds = %55
  %61 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.9) #4
  store i32 %61, ptr @MoL_SetupRKCoefficients.cctki_vi_Original_Delta_Time, align 4, !tbaa !6
  br label %62

62:                                               ; preds = %60, %55
  %63 = phi i32 [ %61, %60 ], [ %58, %55 ]
  %64 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %63) #4
  %65 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_Original_Time, align 4, !tbaa !6
  %66 = icmp eq i32 %65, -100
  br i1 %66, label %67, label %69

67:                                               ; preds = %62
  %68 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.10) #4
  store i32 %68, ptr @MoL_SetupRKCoefficients.cctki_vi_Original_Time, align 4, !tbaa !6
  br label %69

69:                                               ; preds = %67, %62
  %70 = phi i32 [ %68, %67 ], [ %65, %62 ]
  %71 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %70) #4
  %72 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !6
  %73 = icmp eq i32 %72, -100
  br i1 %73, label %74, label %76

74:                                               ; preds = %69
  %75 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.11) #4
  store i32 %75, ptr @MoL_SetupRKCoefficients.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !6
  br label %76

76:                                               ; preds = %74, %69
  %77 = phi i32 [ %75, %74 ], [ %72, %69 ]
  %78 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %77) #4
  %79 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_RKBetaCoefficients, align 4, !tbaa !6
  %80 = icmp eq i32 %79, -100
  br i1 %80, label %81, label %83

81:                                               ; preds = %76
  %82 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.12) #4
  store i32 %82, ptr @MoL_SetupRKCoefficients.cctki_vi_RKBetaCoefficients, align 4, !tbaa !6
  br label %83

83:                                               ; preds = %81, %76
  %84 = phi i32 [ %82, %81 ], [ %79, %76 ]
  %85 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %84) #4
  %86 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_SandRScratchSpace, align 4, !tbaa !6
  %87 = icmp eq i32 %86, -100
  br i1 %87, label %88, label %90

88:                                               ; preds = %83
  %89 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.13) #4
  store i32 %89, ptr @MoL_SetupRKCoefficients.cctki_vi_SandRScratchSpace, align 4, !tbaa !6
  br label %90

90:                                               ; preds = %88, %83
  %91 = phi i32 [ %89, %88 ], [ %86, %83 ]
  %92 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %91) #4
  %93 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_ScratchSpace, align 4, !tbaa !6
  %94 = icmp eq i32 %93, -100
  br i1 %94, label %95, label %97

95:                                               ; preds = %90
  %96 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.14) #4
  store i32 %96, ptr @MoL_SetupRKCoefficients.cctki_vi_ScratchSpace, align 4, !tbaa !6
  br label %97

97:                                               ; preds = %95, %90
  %98 = phi i32 [ %96, %95 ], [ %93, %90 ]
  %99 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %98) #4
  %100 = load i32, ptr @MoL_SetupRKCoefficients.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !6
  %101 = icmp eq i32 %100, -100
  br i1 %101, label %102, label %104

102:                                              ; preds = %97
  %103 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.15) #4
  store i32 %103, ptr @MoL_SetupRKCoefficients.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !6
  br label %104

104:                                              ; preds = %102, %97
  %105 = phi i32 [ %103, %102 ], [ %100, %97 ]
  %106 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %105) #4
  %107 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @methodoflinesrest_, i64 0, i32 15), align 4, !tbaa !10
  %108 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @molpriv_, i64 0, i32 9), align 8, !tbaa !12
  %109 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @molpriv_, i64 0, i32 10), align 8, !tbaa !16
  %110 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @molpriv_, i64 0, i32 15), align 8, !tbaa !17
  %111 = tail call i32 @CCTK_Equals(ptr noundef %109, ptr noundef nonnull @.str.16) #4
...
115:                                              ; preds = %113
  %116 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 94, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19) #4
  br label %117
...
119:                                              ; preds = %117
  %120 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 99, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.20) #4
...
136:                                              ; preds = %122
  tail call void @llvm.memset.p0.i64(ptr align 8 %85, i8 0, i64 %125, i1 false), !tbaa !18
  br label %170
...
137:                                              ; preds = %137, %134
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %141, i8 0, i64 %129, i1 false), !tbaa !18
  %142 = getelementptr inbounds double, ptr %85, i64 %138
  store double 0.000000e+00, ptr %142, align 8, !tbaa !18
  %143 = or i64 %138, 1
  %144 = mul i64 %125, %143
  %145 = getelementptr i8, ptr %78, i64 %144
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %145, i8 0, i64 %129, i1 false), !tbaa !18
  %146 = getelementptr inbounds double, ptr %85, i64 %143
  store double 0.000000e+00, ptr %146, align 8, !tbaa !18
  %147 = or i64 %138, 2
  %148 = mul i64 %125, %147
  %149 = getelementptr i8, ptr %78, i64 %148
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %149, i8 0, i64 %129, i1 false), !tbaa !18
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %153, i8 0, i64 %129, i1 false), !tbaa !18
  %154 = getelementptr inbounds double, ptr %85, i64 %151
  store double 0.000000e+00, ptr %154, align 8, !tbaa !18
  %155 = add nuw nsw i64 %138, 4
  %156 = add i64 %139, 4
  %157 = icmp eq i64 %156, %135
  br i1 %157, label %158, label %137, !llvm.loop !19
...
161:                                              ; preds = %158, %161
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %165, i8 0, i64 %129, i1 false), !tbaa !18
  %166 = getelementptr inbounds double, ptr %85, i64 %162
  store double 0.000000e+00, ptr %166, align 8, !tbaa !18
...
170:                                              ; preds = %158, %161, %136, %119
  store double 1.000000e+00, ptr %78, align 8, !tbaa !18
  ...
  store <2 x double> <double 0x3FBC71C71C71C71C, double 0x3FDC71C71C71C71C>, ptr %172, align 8, !tbaa !18
  %173 = getelementptr inbounds double, ptr %78, i64 8
  store double 0x3FDC71C71C71C71C, ptr %173, align 8, !tbaa !18
  store <2 x double> <double 5.000000e-01, double 7.500000e-01>, ptr %85, align 8, !tbaa !18
  %174 = getelementptr inbounds double, ptr %85, i64 2
  store double 0x3FDC71C71C71C71C, ptr %174, align 8, !tbaa !18
  br label %378

175:                                              ; preds = %104
  %176 = tail call i32 @CCTK_Equals(ptr noundef %109, ptr noundef nonnull @.str.21) #4
...
200:                                              ; preds = %200, %198
  ...
  store double 1.000000e+00, ptr %210, align 8, !tbaa !18
  ...
  br i1 %216, label %357, label %200, !llvm.loop !23
...
217:                                              ; preds = %217, %192
  ...
  store double 1.000000e+00, ptr %224, align 8, !tbaa !18
  tail call void @llvm.memset.p0.i64(ptr align 8 %222, i8 0, i64 %187, i1 false), !tbaa !18
  ...
  store double 1.000000e+00, ptr %233, align 8, !tbaa !18
  tail call void @llvm.memset.p0.i64(ptr align 8 %231, i8 0, i64 %187, i1 false), !tbaa !18
  ...
  br i1 %239, label %366, label %217, !llvm.loop !23

240:                                              ; preds = %175
  %241 = tail call i32 @CCTK_Equals(ptr noundef %109, ptr noundef nonnull @.str.22) #4
...
246:                                              ; preds = %243
  %247 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 142, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.23) #4
  br label %248
...
263:                                              ; preds = %250
  tail call void @llvm.memset.p0.i64(ptr align 8 %85, i8 0, i64 %253, i1 false), !tbaa !18
  br label %297
...
264:                                              ; preds = %264, %261
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %268, i8 0, i64 %257, i1 false), !tbaa !18
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %272, i8 0, i64 %257, i1 false), !tbaa !18
  %273 = getelementptr inbounds double, ptr %85, i64 %270
  store double 0.000000e+00, ptr %273, align 8, !tbaa !18
  %274 = or i64 %265, 2
  %275 = mul i64 %253, %274
  %276 = getelementptr i8, ptr %78, i64 %275
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %276, i8 0, i64 %257, i1 false), !tbaa !18
  %277 = getelementptr inbounds double, ptr %85, i64 %274
  store double 0.000000e+00, ptr %277, align 8, !tbaa !18
  %278 = or i64 %265, 3
  %279 = mul i64 %253, %278
  %280 = getelementptr i8, ptr %78, i64 %279
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %280, i8 0, i64 %257, i1 false), !tbaa !18
  %281 = getelementptr inbounds double, ptr %85, i64 %278
  store double 0.000000e+00, ptr %281, align 8, !tbaa !18
...
288:                                              ; preds = %285, %288
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %292, i8 0, i64 %257, i1 false), !tbaa !18
  %293 = getelementptr inbounds double, ptr %85, i64 %289
  store double 0.000000e+00, ptr %293, align 8, !tbaa !18
...
298:                                              ; preds = %297
  store double 1.000000e+00, ptr %78, align 8, !tbaa !18
  store double 1.000000e+00, ptr %85, align 8, !tbaa !18
  br label %378

299:                                              ; preds = %297
  store double 1.000000e+00, ptr %78, align 8, !tbaa !18
  %300 = getelementptr inbounds double, ptr %78, i64 2
  store <2 x double> <double 5.000000e-01, double 5.000000e-01>, ptr %300, align 8, !tbaa !18
  store <2 x double> <double 1.000000e+00, double 5.000000e-01>, ptr %85, align 8, !tbaa !18
  br label %378

301:                                              ; preds = %297
  store double 1.000000e+00, ptr %78, align 8, !tbaa !18
  %302 = getelementptr inbounds double, ptr %78, i64 3
  store <2 x double> <double 7.500000e-01, double 2.500000e-01>, ptr %302, align 8, !tbaa !18
  %303 = getelementptr inbounds double, ptr %78, i64 6
  store double 0x3FD5555555555555, ptr %303, align 8, !tbaa !18
  %304 = getelementptr inbounds double, ptr %78, i64 8
  store double 0x3FE5555555555555, ptr %304, align 8, !tbaa !18
  store <2 x double> <double 1.000000e+00, double 2.500000e-01>, ptr %85, align 8, !tbaa !18
  %305 = getelementptr inbounds double, ptr %85, i64 2
  store double 0x3FE5555555555555, ptr %305, align 8, !tbaa !18
  br label %378

306:                                              ; preds = %297
  store double 1.000000e+00, ptr %78, align 8, !tbaa !18
  %307 = getelementptr inbounds double, ptr %78, i64 4
  store double 1.000000e+00, ptr %307, align 8, !tbaa !18
  %308 = getelementptr inbounds double, ptr %78, i64 8
  store double 1.000000e+00, ptr %308, align 8, !tbaa !18
  %309 = getelementptr inbounds double, ptr %78, i64 12
  store <4 x double> <double 0xBFD5555555555555, double 0x3FD5555555555555, double 0x3FE5555555555555, double 0x3FD5555555555555>, ptr %309, align 8, !tbaa !18
  store <4 x double> <double 5.000000e-01, double 5.000000e-01, double 1.000000e+00, double 0x3FC5555555555555>, ptr %85, align 8, !tbaa !18
  br label %378

310:                                              ; preds = %297
  %311 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 194, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.24) #4
  br label %378

312:                                              ; preds = %240
  %313 = tail call i32 @CCTK_Equals(ptr noundef %109, ptr noundef nonnull @.str.25) #4
...
318:                                              ; preds = %315
  %319 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 202, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.26) #4
  br label %320
...
323:                                              ; preds = %320
  %324 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 209, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.27) #4
  br label %325

325:                                              ; preds = %323, %320
  %326 = add nsw i32 %107, 1
  %327 = mul nsw i32 %110, %326
  %328 = tail call i32 @Util_TableGetRealArray(i32 noundef %321, i32 noundef %327, ptr noundef %78, ptr noundef nonnull @.str.28) #4
...
332:                                              ; preds = %330
  %333 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 221, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.29) #4
  br label %340
...
336:                                              ; preds = %334
  %337 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 226, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.30) #4
  br label %340

338:                                              ; preds = %334
  %339 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 230, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.31) #4
  br label %340

340:                                              ; preds = %332, %338, %336, %325
  %341 = tail call i32 @Util_TableGetRealArray(i32 noundef %321, i32 noundef %110, ptr noundef %85, ptr noundef nonnull @.str.32) #4
...
345:                                              ; preds = %343
  %346 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 242, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.33) #4
  br label %353
...
349:                                              ; preds = %347
  %350 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 247, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.34) #4
  br label %353

351:                                              ; preds = %347
  %352 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 251, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.31) #4
  br label %353
...
355:                                              ; preds = %312
  %356 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 259, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.35) #4
  br label %378
...
360:                                              ; preds = %357
  ...
  store double 1.000000e+00, ptr %362, align 8, !tbaa !18
...
369:                                              ; preds = %366
  ...
  store double 1.000000e+00, ptr %374, align 8, !tbaa !18
  tail call void @llvm.memset.p0.i64(ptr align 8 %372, i8 0, i64 %187, i1 false), !tbaa !18
