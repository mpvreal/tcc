...
@.str.16 = private unnamed_addr constant [23 x i8] c"MOL::SANDRSCRATCHSPACE\00", align 1
...
149:                                              ; preds = %145, %107
  ...
  %151 = load i32, ptr @MoLNumSandRVariables, align 4, !tbaa !14
...
153:                                              ; preds = %142, %153
  ...
  br i1 %160, label %145, label %153, !llvm.loop !19

161:                                              ; preds = %149, %161
  %162 = phi i64 [ %171, %161 ], [ 0, %149 ]
  %163 = load ptr, ptr @SandRVariableIndex, align 8, !tbaa !20
  ...
  %167 = tail call i32 @CCTK_FirstVarIndex(ptr noundef nonnull @.str.16) #5
  ...
  %172 = load i32, ptr @MoLNumSandRVariables, align 4, !tbaa !14
  %173 = sext i32 %172 to i64
  %174 = icmp slt i64 %171, %173
  br i1 %174, label %161, label %175, !llvm.loop !21
