...
@.str.19 = private unnamed_addr constant [10 x i8] c"MoL/RK3.c\00", align 1
@.str.20 = private unnamed_addr constant [4 x i8] c"MoL\00", align 1
@.str.21 = private unnamed_addr constant [97 x i8] c"RK3 expects MoL_Intermediate_Step to be in [1,3]. This should be caught at ParamCheck - bug Ian!\00", align 1
...
define dso_local void @MoL_RK3Add(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %24 = load i32, ptr @MoL_RK3Add.cctki_vi_Count, align 4, !tbaa !14
  %25 = icmp eq i32 %24, -100
  br i1 %25, label %26, label %28

26:                                               ; preds = %1
  %27 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #4
  store i32 %27, ptr @MoL_RK3Add.cctki_vi_Count, align 4, !tbaa !14
  br label %28

28:                                               ; preds = %26, %1
  %29 = phi i32 [ %27, %26 ], [ %24, %1 ]
  %30 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %29) #4
  %31 = load i32, ptr @MoL_RK3Add.cctki_vi_Error, align 4, !tbaa !14
  %32 = icmp eq i32 %31, -100
  br i1 %32, label %33, label %35

33:                                               ; preds = %28
  %34 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #4
  store i32 %34, ptr @MoL_RK3Add.cctki_vi_Error, align 4, !tbaa !14
  br label %35

35:                                               ; preds = %33, %28
  %36 = phi i32 [ %34, %33 ], [ %31, %28 ]
  %37 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %36) #4
  %38 = load i32, ptr @MoL_RK3Add.cctki_vi_ErrorEstimate, align 4, !tbaa !14
  %39 = icmp eq i32 %38, -100
  br i1 %39, label %40, label %42

40:                                               ; preds = %35
  %41 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.3) #4
  store i32 %41, ptr @MoL_RK3Add.cctki_vi_ErrorEstimate, align 4, !tbaa !14
  br label %42

42:                                               ; preds = %40, %35
  %43 = phi i32 [ %41, %40 ], [ %38, %35 ]
  %44 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %43) #4
  %45 = load i32, ptr @MoL_RK3Add.cctki_vi_EstimatedDt, align 4, !tbaa !14
  %46 = icmp eq i32 %45, -100
  br i1 %46, label %47, label %49

47:                                               ; preds = %42
  %48 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.4) #4
  store i32 %48, ptr @MoL_RK3Add.cctki_vi_EstimatedDt, align 4, !tbaa !14
  br label %49

49:                                               ; preds = %47, %42
  %50 = phi i32 [ %48, %47 ], [ %45, %42 ]
  %51 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %50) #4
  %52 = load i32, ptr @MoL_RK3Add.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !14
  %53 = icmp eq i32 %52, -100
  br i1 %53, label %54, label %56

54:                                               ; preds = %49
  %55 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.5) #4
  store i32 %55, ptr @MoL_RK3Add.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !14
  br label %56

56:                                               ; preds = %54, %49
  %57 = phi i32 [ %55, %54 ], [ %52, %49 ]
  %58 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %57) #4
  %59 = load i32, ptr @MoL_RK3Add.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !14
  %60 = icmp eq i32 %59, -100
  br i1 %60, label %61, label %63

61:                                               ; preds = %56
  %62 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.6) #4
  store i32 %62, ptr @MoL_RK3Add.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !14
  br label %63

63:                                               ; preds = %61, %56
  %64 = phi i32 [ %62, %61 ], [ %59, %56 ]
  %65 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %64) #4
  %66 = load i32, ptr @MoL_RK3Add.cctki_vi_MoL_SlowStep, align 4, !tbaa !14
  %67 = icmp eq i32 %66, -100
  br i1 %67, label %68, label %70

68:                                               ; preds = %63
  %69 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.7) #4
  store i32 %69, ptr @MoL_RK3Add.cctki_vi_MoL_SlowStep, align 4, !tbaa !14
  br label %70

70:                                               ; preds = %68, %63
  %71 = phi i32 [ %69, %68 ], [ %66, %63 ]
  %72 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %71) #4
  %73 = load i32, ptr @MoL_RK3Add.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !14
  %74 = icmp eq i32 %73, -100
  br i1 %74, label %75, label %77

75:                                               ; preds = %70
  %76 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.8) #4
  store i32 %76, ptr @MoL_RK3Add.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !14
  br label %77

77:                                               ; preds = %75, %70
  %78 = phi i32 [ %76, %75 ], [ %73, %70 ]
  %79 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %78) #4
  %80 = load i32, ptr @MoL_RK3Add.cctki_vi_Original_Delta_Time, align 4, !tbaa !14
  %81 = icmp eq i32 %80, -100
  br i1 %81, label %82, label %84

82:                                               ; preds = %77
  %83 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.9) #4
  store i32 %83, ptr @MoL_RK3Add.cctki_vi_Original_Delta_Time, align 4, !tbaa !14
  br label %84

84:                                               ; preds = %82, %77
  %85 = phi i32 [ %83, %82 ], [ %80, %77 ]
  %86 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %85) #4
  %87 = load i32, ptr @MoL_RK3Add.cctki_vi_Original_Time, align 4, !tbaa !14
  %88 = icmp eq i32 %87, -100
  br i1 %88, label %89, label %91

89:                                               ; preds = %84
  %90 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.10) #4
  store i32 %90, ptr @MoL_RK3Add.cctki_vi_Original_Time, align 4, !tbaa !14
  br label %91

91:                                               ; preds = %89, %84
  %92 = phi i32 [ %90, %89 ], [ %87, %84 ]
  %93 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %92) #4
  %94 = load i32, ptr @MoL_RK3Add.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !14
  %95 = icmp eq i32 %94, -100
  br i1 %95, label %96, label %98

96:                                               ; preds = %91
  %97 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.11) #4
  store i32 %97, ptr @MoL_RK3Add.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !14
  br label %98

98:                                               ; preds = %96, %91
  %99 = phi i32 [ %97, %96 ], [ %94, %91 ]
  %100 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %99) #4
  %101 = load i32, ptr @MoL_RK3Add.cctki_vi_RKBetaCoefficients, align 4, !tbaa !14
  %102 = icmp eq i32 %101, -100
  br i1 %102, label %103, label %105

103:                                              ; preds = %98
  %104 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.12) #4
  store i32 %104, ptr @MoL_RK3Add.cctki_vi_RKBetaCoefficients, align 4, !tbaa !14
  br label %105

105:                                              ; preds = %103, %98
  %106 = phi i32 [ %104, %103 ], [ %101, %98 ]
  %107 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %106) #4
  %108 = load i32, ptr @MoL_RK3Add.cctki_vi_SandRScratchSpace, align 4, !tbaa !14
  %109 = icmp eq i32 %108, -100
  br i1 %109, label %110, label %112

110:                                              ; preds = %105
  %111 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.13) #4
  store i32 %111, ptr @MoL_RK3Add.cctki_vi_SandRScratchSpace, align 4, !tbaa !14
  br label %112

112:                                              ; preds = %110, %105
  %113 = phi i32 [ %111, %110 ], [ %108, %105 ]
  %114 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %113) #4
  %115 = load i32, ptr @MoL_RK3Add.cctki_vi_ScratchSpace, align 4, !tbaa !14
  %116 = icmp eq i32 %115, -100
  br i1 %116, label %117, label %119

117:                                              ; preds = %112
  %118 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.14) #4
  store i32 %118, ptr @MoL_RK3Add.cctki_vi_ScratchSpace, align 4, !tbaa !14
  br label %119

119:                                              ; preds = %117, %112
  %120 = phi i32 [ %118, %117 ], [ %115, %112 ]
  %121 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %120) #4
  %122 = load i32, ptr @MoL_RK3Add.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !14
  %123 = icmp eq i32 %122, -100
  br i1 %123, label %124, label %126

124:                                              ; preds = %119
  %125 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.15) #4
  store i32 %125, ptr @MoL_RK3Add.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !14
  br label %126

126:                                              ; preds = %124, %119
  %127 = phi i32 [ %125, %124 ], [ %122, %119 ]
  %128 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %127) #4
  %129 = load i32, ptr %58, align 4, !tbaa !14
...
130:                                              ; preds = %126
  %131 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
...
138:                                              ; preds = %126
  %139 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
...
152:                                              ; preds = %158, %146
  %153 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
...
158:                                              ; preds = %149, %158
  ...
  %160 = load ptr, ptr @RHSVariableIndex, align 8, !tbaa !15
  %161 = getelementptr inbounds i32, ptr %160, i64 %159
  %162 = load i32, ptr %161, align 4, !tbaa !14
  store i32 %162, ptr %2, align 4, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #4
  store i32 0, ptr %3, align 4
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %4) #4
  store double %151, ptr %4, align 8, !tbaa !16
  %163 = load ptr, ptr @EvolvedVariableIndex, align 8, !tbaa !15
  ...
  %168 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
  %169 = sext i32 %168 to i64
  %170 = icmp slt i64 %167, %169
  br i1 %170, label %158, label %152, !llvm.loop !17

171:                                              ; preds = %155, %171
  %172 = phi i64 [ 0, %155 ], [ %180, %171 ]
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #4
  %173 = load ptr, ptr @RHSArrayVariableIndex, align 8, !tbaa !15
  ...
  store double %157, ptr %7, align 8, !tbaa !16
  %176 = load ptr, ptr @EvolvedArrayVariableIndex, align 8, !tbaa !15
  ...
  %181 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
  %182 = sext i32 %181 to i64
  %183 = icmp slt i64 %180, %182
  br i1 %183, label %171, label %258, !llvm.loop !19

184:                                              ; preds = %192, %138
  %185 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
...
206:                                              ; preds = %187, %206
  ...
  %217 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
  %218 = sext i32 %217 to i64
  %219 = icmp slt i64 %216, %218
  br i1 %219, label %206, label %258, !llvm.loop !21

220:                                              ; preds = %228, %130
  %221 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
...
228:                                              ; preds = %133, %228
  ...
  %239 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
  %240 = sext i32 %239 to i64
  %241 = icmp slt i64 %238, %240
  br i1 %241, label %228, label %220, !llvm.loop !22

242:                                              ; preds = %223, %242
  %243 = phi i64 [ 0, %223 ], [ %252, %242 ]
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %17) #4
  %244 = load ptr, ptr @EvolvedArrayVariableIndex, align 8, !tbaa !15
  %245 = getelementptr inbounds i32, ptr %244, i64 %243
  %246 = load i32, ptr %245, align 4, !tbaa !14
  store i32 %246, ptr %17, align 4, !tbaa !14
  %247 = load ptr, ptr @RHSArrayVariableIndex, align 8, !tbaa !15
  %248 = getelementptr inbounds i32, ptr %247, i64 %243
  %249 = load i32, ptr %248, align 4, !tbaa !14
  store i32 %249, ptr %224, align 4, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %18) #4
  store i64 1, ptr %18, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %19) #4
  store double 0x3FD5555555555555, ptr %19, align 16, !tbaa !16
  store double %227, ptr %225, align 8, !tbaa !16
  %250 = load i32, ptr %245, align 4, !tbaa !14
  ...
  %253 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
  %254 = sext i32 %253 to i64
  %255 = icmp slt i64 %252, %254
  br i1 %255, label %242, label %258, !llvm.loop !23

256:                                              ; preds = %126
  %257 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 263, ptr noundef nonnull @.str.19, ptr noundef nonnull @.str.20, ptr noundef nonnull @.str.21) #4
  br label %258
