...
@.str.17 = private unnamed_addr constant [12 x i8] c"MoL/Euler.c\00", align 1
@.str.18 = private unnamed_addr constant [4 x i8] c"MoL\00", align 1
@.str.19 = private unnamed_addr constant [99 x i8] c"Euler expects MoL_Intermediate_Step to be in [1,1]. This should be caught at ParamCheck - bug Ian!\00", align 1
...
define dso_local void @MoL_EulerAdd(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %12 = load i32, ptr @MoL_EulerAdd.cctki_vi_Count, align 4, !tbaa !14
  %13 = icmp eq i32 %12, -100
  br i1 %13, label %14, label %16

14:                                               ; preds = %1
  %15 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #4
  store i32 %15, ptr @MoL_EulerAdd.cctki_vi_Count, align 4, !tbaa !14
  br label %16

16:                                               ; preds = %14, %1
  %17 = phi i32 [ %15, %14 ], [ %12, %1 ]
  %18 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %17) #4
  %19 = load i32, ptr @MoL_EulerAdd.cctki_vi_Error, align 4, !tbaa !14
  %20 = icmp eq i32 %19, -100
  br i1 %20, label %21, label %23

21:                                               ; preds = %16
  %22 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #4
  store i32 %22, ptr @MoL_EulerAdd.cctki_vi_Error, align 4, !tbaa !14
  br label %23

23:                                               ; preds = %21, %16
  %24 = phi i32 [ %22, %21 ], [ %19, %16 ]
  %25 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %24) #4
  %26 = load i32, ptr @MoL_EulerAdd.cctki_vi_ErrorEstimate, align 4, !tbaa !14
  %27 = icmp eq i32 %26, -100
  br i1 %27, label %28, label %30

28:                                               ; preds = %23
  %29 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.3) #4
  store i32 %29, ptr @MoL_EulerAdd.cctki_vi_ErrorEstimate, align 4, !tbaa !14
  br label %30

30:                                               ; preds = %28, %23
  %31 = phi i32 [ %29, %28 ], [ %26, %23 ]
  %32 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %31) #4
  %33 = load i32, ptr @MoL_EulerAdd.cctki_vi_EstimatedDt, align 4, !tbaa !14
  %34 = icmp eq i32 %33, -100
  br i1 %34, label %35, label %37

35:                                               ; preds = %30
  %36 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.4) #4
  store i32 %36, ptr @MoL_EulerAdd.cctki_vi_EstimatedDt, align 4, !tbaa !14
  br label %37

37:                                               ; preds = %35, %30
  %38 = phi i32 [ %36, %35 ], [ %33, %30 ]
  %39 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %38) #4
  %40 = load i32, ptr @MoL_EulerAdd.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !14
  %41 = icmp eq i32 %40, -100
  br i1 %41, label %42, label %44

42:                                               ; preds = %37
  %43 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.5) #4
  store i32 %43, ptr @MoL_EulerAdd.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !14
  br label %44

44:                                               ; preds = %42, %37
  %45 = phi i32 [ %43, %42 ], [ %40, %37 ]
  %46 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %45) #4
  %47 = load i32, ptr @MoL_EulerAdd.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !14
  %48 = icmp eq i32 %47, -100
  br i1 %48, label %49, label %51

49:                                               ; preds = %44
  %50 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.6) #4
  store i32 %50, ptr @MoL_EulerAdd.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !14
  br label %51

51:                                               ; preds = %49, %44
  %52 = phi i32 [ %50, %49 ], [ %47, %44 ]
  %53 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %52) #4
  %54 = load i32, ptr @MoL_EulerAdd.cctki_vi_MoL_SlowStep, align 4, !tbaa !14
  %55 = icmp eq i32 %54, -100
  br i1 %55, label %56, label %58

56:                                               ; preds = %51
  %57 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.7) #4
  store i32 %57, ptr @MoL_EulerAdd.cctki_vi_MoL_SlowStep, align 4, !tbaa !14
  br label %58

58:                                               ; preds = %56, %51
  %59 = phi i32 [ %57, %56 ], [ %54, %51 ]
  %60 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %59) #4
  %61 = load i32, ptr @MoL_EulerAdd.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !14
  %62 = icmp eq i32 %61, -100
  br i1 %62, label %63, label %65

63:                                               ; preds = %58
  %64 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.8) #4
  store i32 %64, ptr @MoL_EulerAdd.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !14
  br label %65

65:                                               ; preds = %63, %58
  %66 = phi i32 [ %64, %63 ], [ %61, %58 ]
  %67 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %66) #4
  %68 = load i32, ptr @MoL_EulerAdd.cctki_vi_Original_Delta_Time, align 4, !tbaa !14
  %69 = icmp eq i32 %68, -100
  br i1 %69, label %70, label %72

70:                                               ; preds = %65
  %71 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.9) #4
  store i32 %71, ptr @MoL_EulerAdd.cctki_vi_Original_Delta_Time, align 4, !tbaa !14
  br label %72

72:                                               ; preds = %70, %65
  %73 = phi i32 [ %71, %70 ], [ %68, %65 ]
  %74 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %73) #4
  %75 = load i32, ptr @MoL_EulerAdd.cctki_vi_Original_Time, align 4, !tbaa !14
  %76 = icmp eq i32 %75, -100
  br i1 %76, label %77, label %79

77:                                               ; preds = %72
  %78 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.10) #4
  store i32 %78, ptr @MoL_EulerAdd.cctki_vi_Original_Time, align 4, !tbaa !14
  br label %79

79:                                               ; preds = %77, %72
  %80 = phi i32 [ %78, %77 ], [ %75, %72 ]
  %81 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %80) #4
  %82 = load i32, ptr @MoL_EulerAdd.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !14
  %83 = icmp eq i32 %82, -100
  br i1 %83, label %84, label %86

84:                                               ; preds = %79
  %85 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.11) #4
  store i32 %85, ptr @MoL_EulerAdd.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !14
  br label %86

86:                                               ; preds = %84, %79
  %87 = phi i32 [ %85, %84 ], [ %82, %79 ]
  %88 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %87) #4
  %89 = load i32, ptr @MoL_EulerAdd.cctki_vi_RKBetaCoefficients, align 4, !tbaa !14
  %90 = icmp eq i32 %89, -100
  br i1 %90, label %91, label %93

91:                                               ; preds = %86
  %92 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.12) #4
  store i32 %92, ptr @MoL_EulerAdd.cctki_vi_RKBetaCoefficients, align 4, !tbaa !14
  br label %93

93:                                               ; preds = %91, %86
  %94 = phi i32 [ %92, %91 ], [ %89, %86 ]
  %95 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %94) #4
  %96 = load i32, ptr @MoL_EulerAdd.cctki_vi_SandRScratchSpace, align 4, !tbaa !14
  %97 = icmp eq i32 %96, -100
  br i1 %97, label %98, label %100

98:                                               ; preds = %93
  %99 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.13) #4
  store i32 %99, ptr @MoL_EulerAdd.cctki_vi_SandRScratchSpace, align 4, !tbaa !14
  br label %100

100:                                              ; preds = %98, %93
  %101 = phi i32 [ %99, %98 ], [ %96, %93 ]
  %102 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %101) #4
  %103 = load i32, ptr @MoL_EulerAdd.cctki_vi_ScratchSpace, align 4, !tbaa !14
  %104 = icmp eq i32 %103, -100
  br i1 %104, label %105, label %107

105:                                              ; preds = %100
  %106 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.14) #4
  store i32 %106, ptr @MoL_EulerAdd.cctki_vi_ScratchSpace, align 4, !tbaa !14
  br label %107

107:                                              ; preds = %105, %100
  %108 = phi i32 [ %106, %105 ], [ %103, %100 ]
  %109 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %108) #4
  %110 = load i32, ptr @MoL_EulerAdd.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !14
  %111 = icmp eq i32 %110, -100
  br i1 %111, label %112, label %114

112:                                              ; preds = %107
  %113 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.15) #4
  store i32 %113, ptr @MoL_EulerAdd.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !14
  br label %114

114:                                              ; preds = %112, %107
  %115 = phi i32 [ %113, %112 ], [ %110, %107 ]
  %116 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %115) #4
  %117 = load i32, ptr %46, align 4, !tbaa !14
  %118 = icmp eq i32 %117, 1
  br i1 %118, label %119, label %163

119:                                              ; preds = %114
  %120 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
...
127:                                              ; preds = %135, %119
  %128 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
...
135:                                              ; preds = %122, %135
  ...
  %146 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !14
  %147 = sext i32 %146 to i64
  %148 = icmp slt i64 %145, %147
  br i1 %148, label %135, label %127, !llvm.loop !17

149:                                              ; preds = %130, %149
  %150 = phi i64 [ 0, %130 ], [ %159, %149 ]
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %5) #4
  %151 = load ptr, ptr @EvolvedArrayVariableIndex, align 8, !tbaa !15
  %152 = getelementptr inbounds i32, ptr %151, i64 %150
  %153 = load i32, ptr %152, align 4, !tbaa !14
  store i32 %153, ptr %5, align 4, !tbaa !14
  %154 = load ptr, ptr @RHSArrayVariableIndex, align 8, !tbaa !15
  %155 = getelementptr inbounds i32, ptr %154, i64 %150
  %156 = load i32, ptr %155, align 4, !tbaa !14
  store i32 %156, ptr %131, align 4, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %6) #4
  store i64 1, ptr %6, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %7) #4
  store double 1.000000e+00, ptr %7, align 16, !tbaa !16
  store double %134, ptr %132, align 8, !tbaa !16
  %157 = load i32, ptr %152, align 4, !tbaa !14
  ...
  %160 = load i32, ptr @MoLNumEvolvedArrayVariables, align 4, !tbaa !14
  %161 = sext i32 %160 to i64
  %162 = icmp slt i64 %159, %161
  br i1 %162, label %149, label %165, !llvm.loop !19

163:                                              ; preds = %114
  %164 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 122, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19) #4
  br label %165
