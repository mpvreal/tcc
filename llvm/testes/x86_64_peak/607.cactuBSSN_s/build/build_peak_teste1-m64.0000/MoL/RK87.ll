...
@.str.18 = private unnamed_addr constant [11 x i8] c"MoL/RK87.c\00", align 1
@.str.19 = private unnamed_addr constant [4 x i8] c"MoL\00", align 1
@.str.20 = private unnamed_addr constant [103 x i8] c"Peter has been too lazy to write the RK87 routine out for array variables. Better send him an email...\00", align 1
...
define dso_local void @MoL_RK87Add(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %6 = load i32, ptr @MoL_RK87Add.cctki_vi_Count, align 4, !tbaa !6
  %7 = icmp eq i32 %6, -100
  br i1 %7, label %8, label %10

8:                                                ; preds = %1
  %9 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.1) #7
  store i32 %9, ptr @MoL_RK87Add.cctki_vi_Count, align 4, !tbaa !6
  br label %10

10:                                               ; preds = %8, %1
  %11 = phi i32 [ %9, %8 ], [ %6, %1 ]
  %12 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %11) #7
  %13 = load i32, ptr @MoL_RK87Add.cctki_vi_Error, align 4, !tbaa !6
  %14 = icmp eq i32 %13, -100
  br i1 %14, label %15, label %17

15:                                               ; preds = %10
  %16 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.2) #7
  store i32 %16, ptr @MoL_RK87Add.cctki_vi_Error, align 4, !tbaa !6
  br label %17

17:                                               ; preds = %15, %10
  %18 = phi i32 [ %16, %15 ], [ %13, %10 ]
  %19 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %18) #7
  %20 = load i32, ptr @MoL_RK87Add.cctki_vi_ErrorEstimate, align 4, !tbaa !6
  %21 = icmp eq i32 %20, -100
  br i1 %21, label %22, label %24

22:                                               ; preds = %17
  %23 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.3) #7
  store i32 %23, ptr @MoL_RK87Add.cctki_vi_ErrorEstimate, align 4, !tbaa !6
  br label %24

24:                                               ; preds = %22, %17
  %25 = phi i32 [ %23, %22 ], [ %20, %17 ]
  %26 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %25) #7
  %27 = load i32, ptr @MoL_RK87Add.cctki_vi_EstimatedDt, align 4, !tbaa !6
  %28 = icmp eq i32 %27, -100
  br i1 %28, label %29, label %31

29:                                               ; preds = %24
  %30 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.4) #7
  store i32 %30, ptr @MoL_RK87Add.cctki_vi_EstimatedDt, align 4, !tbaa !6
  br label %31

31:                                               ; preds = %29, %24
  %32 = phi i32 [ %30, %29 ], [ %27, %24 ]
  %33 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %32) #7
  %34 = load i32, ptr @MoL_RK87Add.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !6
  %35 = icmp eq i32 %34, -100
  br i1 %35, label %36, label %38

36:                                               ; preds = %31
  %37 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.5) #7
  store i32 %37, ptr @MoL_RK87Add.cctki_vi_MoL_Intermediate_Step, align 4, !tbaa !6
  br label %38

38:                                               ; preds = %36, %31
  %39 = phi i32 [ %37, %36 ], [ %34, %31 ]
  %40 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %39) #7
  %41 = load i32, ptr @MoL_RK87Add.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !6
  %42 = icmp eq i32 %41, -100
  br i1 %42, label %43, label %45

43:                                               ; preds = %38
  %44 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.6) #7
  store i32 %44, ptr @MoL_RK87Add.cctki_vi_MoL_SlowPostStep, align 4, !tbaa !6
  br label %45

45:                                               ; preds = %43, %38
  %46 = phi i32 [ %44, %43 ], [ %41, %38 ]
  %47 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %46) #7
  %48 = load i32, ptr @MoL_RK87Add.cctki_vi_MoL_SlowStep, align 4, !tbaa !6
  %49 = icmp eq i32 %48, -100
  br i1 %49, label %50, label %52

50:                                               ; preds = %45
  %51 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.7) #7
  store i32 %51, ptr @MoL_RK87Add.cctki_vi_MoL_SlowStep, align 4, !tbaa !6
  br label %52

52:                                               ; preds = %50, %45
  %53 = phi i32 [ %51, %50 ], [ %48, %45 ]
  %54 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %53) #7
  %55 = load i32, ptr @MoL_RK87Add.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !6
  %56 = icmp eq i32 %55, -100
  br i1 %56, label %57, label %59

57:                                               ; preds = %52
  %58 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.8) #7
  store i32 %58, ptr @MoL_RK87Add.cctki_vi_MoL_Stepsize_Bad, align 4, !tbaa !6
  br label %59

59:                                               ; preds = %57, %52
  %60 = phi i32 [ %58, %57 ], [ %55, %52 ]
  %61 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %60) #7
  %62 = load i32, ptr @MoL_RK87Add.cctki_vi_Original_Delta_Time, align 4, !tbaa !6
  %63 = icmp eq i32 %62, -100
  br i1 %63, label %64, label %66

64:                                               ; preds = %59
  %65 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.9) #7
  store i32 %65, ptr @MoL_RK87Add.cctki_vi_Original_Delta_Time, align 4, !tbaa !6
  br label %66

66:                                               ; preds = %64, %59
  %67 = phi i32 [ %65, %64 ], [ %62, %59 ]
  %68 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %67) #7
  %69 = load i32, ptr @MoL_RK87Add.cctki_vi_Original_Time, align 4, !tbaa !6
  %70 = icmp eq i32 %69, -100
  br i1 %70, label %71, label %73

71:                                               ; preds = %66
  %72 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.10) #7
  store i32 %72, ptr @MoL_RK87Add.cctki_vi_Original_Time, align 4, !tbaa !6
  br label %73

73:                                               ; preds = %71, %66
  %74 = phi i32 [ %72, %71 ], [ %69, %66 ]
  %75 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %74) #7
  %76 = load i32, ptr @MoL_RK87Add.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !6
  %77 = icmp eq i32 %76, -100
  br i1 %77, label %78, label %80

78:                                               ; preds = %73
  %79 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.11) #7
  store i32 %79, ptr @MoL_RK87Add.cctki_vi_RKAlphaCoefficients, align 4, !tbaa !6
  br label %80

80:                                               ; preds = %78, %73
  %81 = phi i32 [ %79, %78 ], [ %76, %73 ]
  %82 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %81) #7
  %83 = load i32, ptr @MoL_RK87Add.cctki_vi_RKBetaCoefficients, align 4, !tbaa !6
  %84 = icmp eq i32 %83, -100
  br i1 %84, label %85, label %87

85:                                               ; preds = %80
  %86 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.12) #7
  store i32 %86, ptr @MoL_RK87Add.cctki_vi_RKBetaCoefficients, align 4, !tbaa !6
  br label %87

87:                                               ; preds = %85, %80
  %88 = phi i32 [ %86, %85 ], [ %83, %80 ]
  %89 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %88) #7
  %90 = load i32, ptr @MoL_RK87Add.cctki_vi_SandRScratchSpace, align 4, !tbaa !6
  %91 = icmp eq i32 %90, -100
  br i1 %91, label %92, label %94

92:                                               ; preds = %87
  %93 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.13) #7
  store i32 %93, ptr @MoL_RK87Add.cctki_vi_SandRScratchSpace, align 4, !tbaa !6
  br label %94

94:                                               ; preds = %92, %87
  %95 = phi i32 [ %93, %92 ], [ %90, %87 ]
  %96 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %95) #7
  %97 = load i32, ptr @MoL_RK87Add.cctki_vi_ScratchSpace, align 4, !tbaa !6
  %98 = icmp eq i32 %97, -100
  br i1 %98, label %99, label %101

99:                                               ; preds = %94
  %100 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.14) #7
  store i32 %100, ptr @MoL_RK87Add.cctki_vi_ScratchSpace, align 4, !tbaa !6
  br label %101

101:                                              ; preds = %99, %94
  %102 = phi i32 [ %100, %99 ], [ %97, %94 ]
  %103 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %102) #7
  %104 = load i32, ptr @MoL_RK87Add.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !6
  %105 = icmp eq i32 %104, -100
  br i1 %105, label %106, label %108

106:                                              ; preds = %101
  %107 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.15) #7
  store i32 %107, ptr @MoL_RK87Add.cctki_vi_ScratchSpaceSlow, align 4, !tbaa !6
  br label %108

108:                                              ; preds = %106, %101
  %109 = phi i32 [ %107, %106 ], [ %104, %101 ]
  %110 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %109) #7
  %111 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @methodoflinesrest_, i64 0, i32 12), align 4, !tbaa !10
  %112 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @molpriv_, i64 0, i32 15), align 8, !tbaa !12
  %113 = load i32, ptr @MoL_RK87Add.scratchspace_firstindex, align 4, !tbaa !6
  %114 = icmp eq i32 %113, -99
  br i1 %114, label %115, label %117

115:                                              ; preds = %108
  %116 = tail call i32 @CCTK_FirstVarIndex(ptr noundef nonnull @.str.16) #7
  store i32 %116, ptr @MoL_RK87Add.scratchspace_firstindex, align 4, !tbaa !6
  br label %117

117:                                              ; preds = %115, %108
  %118 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !6
...
145:                                              ; preds = %117, %145
  ...
  %147 = load i32, ptr %40, align 4, !tbaa !6
  %148 = sub nsw i32 %112, %147
  %149 = load i32, ptr @MoL_RK87Add.scratchspace_firstindex, align 4, !tbaa !6
  %150 = mul nsw i32 %148, %111
  %151 = trunc i64 %146 to i32
  %152 = add i32 %149, %151
  %153 = add i32 %152, %150
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %2) #7
  %154 = load ptr, ptr @RHSVariableIndex, align 8, !tbaa !16
  %155 = getelementptr inbounds i32, ptr %154, i64 %146
  %156 = load i32, ptr %155, align 4, !tbaa !6
  store i32 %156, ptr %2, align 4, !tbaa !6
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #7
  store i32 0, ptr %3, align 4
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %4) #7
  %157 = load double, ptr %68, align 8, !tbaa !17
  %158 = load i32, ptr %5, align 8, !tbaa !18
  %159 = sitofp i32 %158 to double
  %160 = fdiv fast double %157, %159
  store double %160, ptr %4, align 8, !tbaa !17
  ...
  %163 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !6
  %164 = sext i32 %163 to i64
  %165 = icmp slt i64 %162, %164
  br i1 %165, label %145, label %120, !llvm.loop !20

166:                                              ; preds = %122, %318
  %167 = phi i64 [ 0, %122 ], [ %320, %318 ]
  %168 = call i32 @CCTK_FirstVarIndex(ptr noundef nonnull @.str.17) #7
  %169 = load i32, ptr %40, align 4, !tbaa !6
...
171:                                              ; preds = %166
  ...
  %179 = load ptr, ptr @EvolvedVariableIndex, align 8, !tbaa !16
  %180 = getelementptr inbounds i32, ptr %179, i64 %167
  %181 = load i32, ptr %180, align 4, !tbaa !6
  store i32 %181, ptr %176, align 16, !tbaa !6
  store i32 1, ptr %177, align 16, !tbaa !6
  store double 1.000000e+00, ptr %178, align 16, !tbaa !17
  %182 = icmp slt i32 %172, 0
  br i1 %182, label %245, label %183

183:                                              ; preds = %171
  %184 = load i32, ptr @MoL_RK87Add.scratchspace_firstindex, align 4, !tbaa !6
  %185 = getelementptr i8, ptr %177, i64 4
  %186 = sub i32 %123, %169
  %187 = zext i32 %186 to i64
  %188 = shl nuw nsw i64 %187, 2
  call void @llvm.memset.p0.i64(ptr align 4 %185, i8 0, i64 %188, i1 false), !tbaa !6
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %189, ptr align 16 %192, i64 %193, i1 false), !tbaa !17
...
236:                                              ; preds = %234, %236
  ...
  store i32 %241, ptr %243, align 4, !tbaa !6
  %244 = icmp eq i64 %242, %187
  br i1 %244, label %245, label %236, !llvm.loop !25

245:                                              ; preds = %236, %232, %171
  %246 = load i32, ptr %180, align 4, !tbaa !6
...
248:                                              ; preds = %166
  ...
  %253 = load ptr, ptr @EvolvedVariableIndex, align 8, !tbaa !16
  %254 = getelementptr inbounds i32, ptr %253, i64 %167
  %255 = load i32, ptr %254, align 4, !tbaa !6
  store i32 %255, ptr %250, align 16, !tbaa !6
  store i32 1, ptr %251, align 16, !tbaa !6
  store double 1.000000e+00, ptr %252, align 16, !tbaa !17
  %256 = load i32, ptr @MoL_RK87Add.scratchspace_firstindex, align 4, !tbaa !6
  %257 = getelementptr inbounds i8, ptr %251, i64 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(52) %257, i8 0, i64 52, i1 false), !tbaa !6
  %258 = getelementptr inbounds i8, ptr %252, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(104) %258, ptr noundef nonnull align 16 dereferenceable(104) @MoL_RK87Add.gamma_array, i64 104, i1 false), !tbaa !17
  ...
  store <4 x i32> %270, ptr %260, align 4, !tbaa !6
  %271 = add i32 %129, %259
  %272 = add i32 %271, %256
  ...
  store i32 %275, ptr %276, align 8, !tbaa !6
  %277 = add i32 %131, %259
  %278 = add i32 %277, %256
  ...
  store i32 %281, ptr %282, align 16, !tbaa !6
  %283 = add i32 %133, %259
  %284 = add i32 %283, %256
  %285 = getelementptr inbounds i32, ptr %250, i64 9
  store i32 %284, ptr %285, align 4, !tbaa !6
  ...
  store <4 x i32> %289, ptr %286, align 8, !tbaa !6
  %290 = load i32, ptr %254, align 4, !tbaa !6
  ...
  %296 = load i32, ptr @MoL_RK87Add.scratchspace_firstindex, align 4, !tbaa !6
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(52) %294, i8 0, i64 52, i1 false), !tbaa !6
  ...
  store <4 x i32> %299, ptr %293, align 16, !tbaa !6
  store <4 x double> <double 0x3F88F950374A4F36, double 0.000000e+00, double 0.000000e+00, double 0.000000e+00>, ptr %295, align 16, !tbaa !17
  %300 = getelementptr inbounds i32, ptr %293, i64 4
  %301 = getelementptr inbounds double, ptr %295, i64 4
  store <4 x double> <double 0.000000e+00, double 0x3FE8BDAD591CE63B, double 0xBFB269E126744244, double 0xBFFC38AA8C018342>, ptr %301, align 16, !tbaa !17
  ...
  store <8 x i32> %311, ptr %300, align 16, !tbaa !6
  store <4 x double> <double 0x3FFC984C3155396A, double 0xBFE90E37B7CA45BC, double 0x3FB42A64F4EA6F18, double 0xBFD2155D4D4BF749>, ptr %302, align 16, !tbaa !17
  %312 = extractelement <4 x i32> %288, i64 3
  %313 = add i32 %312, %296
  %314 = getelementptr inbounds i32, ptr %293, i64 12
  store i32 %313, ptr %314, align 16, !tbaa !6
  %315 = getelementptr inbounds double, ptr %295, i64 12
  store double 2.500000e-01, ptr %315, align 16, !tbaa !17
...
318:                                              ; preds = %248, %245
  ...
  %321 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !6
  %322 = sext i32 %321 to i64
  %323 = icmp slt i64 %320, %322
  br i1 %323, label %166, label %324, !llvm.loop !26

324:                                              ; preds = %318, %117, %120
  %325 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 248, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19, ptr noundef nonnull @.str.20) #7
  ret void
}
...
!17 = !{!14, !14, i64 0}
!18 = !{!19, !7, i64 120}
!19 = !{!"_cGH", !7, i64 0, !7, i64 4, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !15, i64 40, !15, i64 48, !15, i64 56, !14, i64 64, !15, i64 72, !15, i64 80, !15, i64 88, !15, i64 96, !15, i64 104, !15, i64 112, !7, i64 120, !7, i64 124, !7, i64 128, !15, i64 136, !14, i64 144, !15, i64 152, !15, i64 160, !15, i64 168, !15, i64 176}
!20 = distinct !{!20, !21}
