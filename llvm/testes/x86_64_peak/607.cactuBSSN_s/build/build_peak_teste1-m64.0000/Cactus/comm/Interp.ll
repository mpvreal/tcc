...
@.str.1 = private unnamed_addr constant [34 x i8] c"CCTK_InterpRegisterOpLocalUniform\00", align 1
@.str.2 = private unnamed_addr constant [21 x i8] c"Cactus/comm/Interp.c\00", align 1
@.str.3 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.4 = private unnamed_addr constant [95 x i8] c"%s (called from thorn '%s'):\0A   NULL function pointer passed for interpolation operator '%s' !\00", align 1
@.str.5 = private unnamed_addr constant [130 x i8] c"%s (called from thorn '%s'):\0A   Ignoring attempt to register operator '%s' because it has already been registered by thorn '%s' !\00", align 1
@.str.6 = private unnamed_addr constant [48 x i8] c"No handle found for interpolation operator '%s'\00", align 1
@.str.7 = private unnamed_addr constant [37 x i8] c"CCTK_InterpHandle: Handle %d invalid\00", align 1
@CCTK_InterpGridArrays = external local_unnamed_addr global ptr, align 8
@.str.8 = private unnamed_addr constant [174 x i8] c"CCTK_InterpLocalUniform(): no interpolation operator is registered under handle %d (did you activate LocalInterp or some other thorn providing this interpolation operator ?)\00", align 1
...
define dso_local i32 @CCTK_NumInterpOperators() local_unnamed_addr #1 {
  %1 = load i32, ptr @num_interp_operators, align 4, !tbaa !6
  ret i32 %1
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local ptr @CCTK_InterpOperatorImplementation(i32 noundef %0) local_unnamed_addr #2 {
  %2 = load ptr, ptr @interp_operators, align 8, !tbaa !10
...
6:                                                ; preds = %3
  %7 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 311, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, ptr noundef %2, ptr noundef %1) #7
  br label %30

8:                                                ; preds = %3
  %9 = load ptr, ptr @interp_operators, align 8, !tbaa !10
...
15:                                               ; preds = %12
  ...
  %18 = load i32, ptr @num_interp_operators, align 4, !tbaa !6
  %19 = add nsw i32 %18, 1
  store i32 %19, ptr @num_interp_operators, align 4, !tbaa !6
  br label %20
...
27:                                               ; preds = %20
  ...
  %29 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 352, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, ptr noundef %2, ptr noundef %1, ptr noundef %28) #7
  br label %30
...
5:                                                ; preds = %1
  %6 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 395, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.6, ptr noundef %0) #7
  br label %7
...
define dso_local void @cctk_interphandle_(ptr nocapture noundef writeonly %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #2 {
  ...
  %5 = load ptr, ptr @interp_operators, align 8, !tbaa !10
  %6 = tail call i32 @Util_GetHandle(ptr noundef %5, ptr noundef %4, ptr noundef null) #7
  %7 = icmp slt i32 %6, 0
  br i1 %7, label %8, label %10

8:                                                ; preds = %3
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 395, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.6, ptr noundef %4) #7
  br label %10
...
5:                                                ; preds = %1
  %6 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 441, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.7, i32 noundef %0) #7
  br label %10
...
define dso_local void @cctk_interpgridarrays_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr nocapture noundef readonly %4, ptr nocapture noundef readonly %5, ptr nocapture noundef readonly %6, ptr nocapture noundef readonly %7, ptr noundef %8, ptr nocapture noundef readonly %9, ptr noundef %10, ptr nocapture noundef readonly %11, ptr noundef %12, ptr noundef %13) local_unnamed_addr #2 {
  %15 = load ptr, ptr @CCTK_InterpGridArrays, align 8, !tbaa !10
...
define dso_local i32 @CCTK_InterpLocalUniform(i32 noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef %5, i32 noundef %6, ptr noundef %7, i32 noundef %8, ptr noundef %9, ptr noundef %10, ptr noundef %11, i32 noundef %12, ptr noundef %13, ptr noundef %14) local_unnamed_addr #2 {
  %16 = load ptr, ptr @interp_operators, align 8, !tbaa !10
...
25:                                               ; preds = %15, %19
  %26 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 736, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.8, i32 noundef %1) #7
  br label %27
...
define dso_local void @cctk_interplocaluniform_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr noundef %4, ptr noundef %5, ptr nocapture noundef readonly %6, ptr nocapture noundef readonly %7, ptr noundef %8, ptr nocapture noundef readonly %9, ptr noundef %10, ptr noundef %11, ptr noundef %12, ptr nocapture noundef readonly %13, ptr noundef %14, ptr noundef %15) local_unnamed_addr #2 {
  ...
  %24 = load ptr, ptr @interp_operators, align 8, !tbaa !10
...
33:                                               ; preds = %27, %16
  %34 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 736, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.8, i32 noundef %18) #7
  br label %35
...
!12 = !{!13, !11, i64 0}
!13 = !{!"", !11, i64 0, !11, i64 8, !11, i64 16}
!14 = !{!13, !11, i64 8}
!15 = !{!13, !11, i64 16}
