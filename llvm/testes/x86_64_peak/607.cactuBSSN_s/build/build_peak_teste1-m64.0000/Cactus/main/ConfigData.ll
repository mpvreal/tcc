...
@.str.1 = private unnamed_addr constant [56 x i8] c"Tried to store two GHs at the same convergence level !\0A\00", align 1
...
18:                                               ; preds = %10
  ...
  %19 = load i32, ptr %4, align 8, !tbaa !6
...
54:                                               ; preds = %36, %39, %18
  store i32 %13, ptr %4, align 8, !tbaa !6
  br label %55
...
62:                                               ; preds = %55
  store ptr %2, ptr %59, align 8, !tbaa !13
  br label %66

63:                                               ; preds = %10, %55
  %64 = load ptr, ptr @stderr, align 8, !tbaa !13
  %65 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 55, i64 1, ptr %64) #5
  br label %66
