...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  ...
  %7 = load i32, ptr @cctki_onlyprintschedule, align 4, !tbaa !6
  %8 = icmp eq i32 %7, 0
...
14:                                               ; preds = %2
  %15 = load ptr, ptr @CCTK_Initialise, align 8, !tbaa !10
  %16 = call i32 %15(ptr noundef nonnull %5)
  %17 = load ptr, ptr @CCTK_Evolve, align 8, !tbaa !10
  %18 = call i32 %17(ptr noundef nonnull %5)
  %19 = load ptr, ptr @CCTK_Shutdown, align 8, !tbaa !10
