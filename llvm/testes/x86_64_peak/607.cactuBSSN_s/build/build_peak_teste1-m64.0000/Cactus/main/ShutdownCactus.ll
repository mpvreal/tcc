...
define dso_local i32 @CCTKi_ShutdownCactus(ptr nocapture noundef readnone %0) local_unnamed_addr #1 {
  %2 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @cactuspriv_, i64 0, i32 1), align 8, !tbaa !6
  %3 = tail call i32 @CCTK_Equals(ptr noundef %2, ptr noundef nonnull @.str.1) #5
  %4 = icmp eq i32 %3, 0
