...
define dso_local i32 @CCTKi_SetupCache() local_unnamed_addr #1 {
  %1 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @cactuspriv_, i64 0, i32 12), align 4, !tbaa !6
  %2 = icmp eq i32 %1, 0
  br i1 %2, label %9, label %3

3:                                                ; preds = %0
  %4 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @cactuspriv_, i64 0, i32 14), align 4, !tbaa !12
  %5 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @cactuspriv_, i64 0, i32 13), align 8, !tbaa !13
  %6 = sext i32 %4 to i64
  %7 = sext i32 %5 to i64
...
!6 = !{!7, !11, i64 68}
!7 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !11, i64 40, !11, i64 44, !11, i64 48, !11, i64 52, !11, i64 56, !11, i64 60, !11, i64 64, !11, i64 68, !11, i64 72, !11, i64 76, !11, i64 80}
