...
5:                                                ; preds = %2
  ...
  store ptr %6, ptr @GroupData, align 8, !tbaa !6
  br label %7
...
24:                                               ; preds = %24, %22
  ...
  br i1 %57, label %58, label %24, !llvm.loop !15
...
6:                                                ; preds = %3
  ...
  store ptr %7, ptr @VariableData, align 8, !tbaa !6
  br label %8
...
65:                                               ; preds = %60, %65
  ...
  br i1 %77, label %78, label %65, !llvm.loop !22
...
define dso_local i32 @CCTKi_NamesRetrieveGroupNum(ptr noundef %0, ptr nocapture noundef writeonly %1) local_unnamed_addr #1 {
  %3 = load ptr, ptr @GroupData, align 8, !tbaa !6
  %4 = icmp eq ptr %3, null
...
16:                                               ; preds = %16, %14
  ...
  br i1 %49, label %50, label %16, !llvm.loop !15
...
55:                                               ; preds = %50, %55
  ...
  br i1 %67, label %68, label %55, !llvm.loop !23
...
72:                                               ; preds = %68
  %73 = load i32, ptr %70, align 4, !tbaa !10
...
define dso_local i32 @CCTKi_NamesRetrieveVariableNum(ptr noundef %0, ptr nocapture noundef writeonly %1, ptr nocapture noundef writeonly %2) local_unnamed_addr #1 {
  %4 = load ptr, ptr @VariableData, align 8, !tbaa !6
  %5 = icmp eq ptr %4, null
...
17:                                               ; preds = %17, %15
  ...
  br i1 %50, label %51, label %17, !llvm.loop !15
...
56:                                               ; preds = %51, %56
  ...
  br i1 %68, label %69, label %56, !llvm.loop !24
...
73:                                               ; preds = %69
  ...
  store i32 %74, ptr %1, align 4, !tbaa !14
...
!19 = !{!20, !12, i64 0}
!20 = !{!"IVariableData", !12, i64 0, !12, i64 4}
!21 = !{!20, !12, i64 4}
!22 = distinct !{!22, !18}
!23 = distinct !{!23, !18}
!24 = distinct !{!24, !18}
