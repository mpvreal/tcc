...
@.str.2 = private unnamed_addr constant [24 x i8] c"describe-all-parameters\00", align 1
@.str.3 = private unnamed_addr constant [19 x i8] c"describe-parameter\00", align 1
@.str.4 = private unnamed_addr constant [14 x i8] c"logging-level\00", align 1
@.str.5 = private unnamed_addr constant [14 x i8] c"warning-level\00", align 1
@.str.6 = private unnamed_addr constant [12 x i8] c"error-level\00", align 1
@.str.7 = private unnamed_addr constant [16 x i8] c"parameter-level\00", align 1
@.str.8 = private unnamed_addr constant [9 x i8] c"redirect\00", align 1
@.str.9 = private unnamed_addr constant [7 x i8] c"logdir\00", align 1
@.str.10 = private unnamed_addr constant [10 x i8] c"buffering\00", align 1
@.str.11 = private unnamed_addr constant [15 x i8] c"print-schedule\00", align 1
@.str.12 = private unnamed_addr constant [12 x i8] c"list-thorns\00", align 1
@.str.13 = private unnamed_addr constant [20 x i8] c"test-thorn-compiled\00", align 1
@.str.14 = private unnamed_addr constant [23 x i8] c"exit-after-param-check\00", align 1
@.str.15 = private unnamed_addr constant [8 x i8] c"version\00", align 1
@.str.16 = private unnamed_addr constant [12 x i8] c"ignore-next\00", align 1
@__const.CCTKi_ProcessCommandLine.long_options = private unnamed_addr constant [17 x %struct.option] [%struct.option { ptr @.str.1, i32 0, ptr null, i32 104 }, %struct.option { ptr @.str.2, i32 2, ptr null, i32 79 }, %struct.option { ptr @.str.3, i32 1, ptr null, i32 111 }, %struct.option { ptr @.str.4, i32 1, ptr null, i32 76 }, %struct.option { ptr @.str.5, i32 1, ptr null, i32 87 }, %struct.option { ptr @.str.6, i32 1, ptr null, i32 69 }, %struct.option { ptr @.str.7, i32 1, ptr null, i32 256 }, %struct.option { ptr @.str.8, i32 2, ptr null, i32 114 }, %struct.option { ptr @.str.9, i32 1, ptr null, i32 257 }, %struct.option { ptr @.str.10, i32 1, ptr null, i32 98 }, %struct.option { ptr @.str.11, i32 0, ptr null, i32 83 }, %struct.option { ptr @.str.12, i32 0, ptr null, i32 84 }, %struct.option { ptr @.str.13, i32 1, ptr null, i32 116 }, %struct.option { ptr @.str.14, i32 0, ptr null, i32 80 }, %struct.option { ptr @.str.15, i32 0, ptr null, i32 118 }, %struct.option { ptr @.str.16, i32 0, ptr null, i32 105 }, %struct.option zeroinitializer], align 16
@argc = internal unnamed_addr global i32 0, align 4
@argv = internal unnamed_addr global ptr null, align 8
@.str.17 = private unnamed_addr constant [28 x i8] c"hO::o:x::L:W:E:r::b:STt:Pvi\00", align 1
@optarg = external local_unnamed_addr global ptr, align 8
@exit_after_param_check = internal unnamed_addr global i1 false, align 4
@.str.18 = private unnamed_addr constant [42 x i8] c"?? getopt returned character code 0%o ??\0A\00", align 1
...
define dso_local i32 @CCTKi_ProcessCommandLine(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef writeonly %2) local_unnamed_addr #1 {
  ...
  store i32 %6, ptr @argc, align 4, !tbaa !6
  %7 = load ptr, ptr %1, align 8, !tbaa !10
  store ptr %7, ptr @argv, align 8, !tbaa !10
  %8 = icmp sgt i32 %6, 1
  br i1 %8, label %9, label %64

9:                                                ; preds = %3
  %10 = call i32 @getopt_long_only(i32 noundef %6, ptr noundef %7, ptr noundef nonnull @.str.17, ptr noundef nonnull %5, ptr noundef nonnull %4) #11
  %11 = icmp eq i32 %10, -1
...
39:                                               ; preds = %16
  %40 = load ptr, ptr @optarg, align 8, !tbaa !10
...
44:                                               ; preds = %16
  %45 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.18, i32 noundef %13)
  br label %48
...
48:                                               ; preds = %16, %17, %19, %21, %23, %25, %27, %29, %31, %33, %35, %37, %38, %39, %41, %42, %43, %44, %46
  ...
  %50 = load i32, ptr @argc, align 4, !tbaa !6
  %51 = load ptr, ptr @argv, align 8, !tbaa !10
  %52 = call i32 @getopt_long_only(i32 noundef %50, ptr noundef %51, ptr noundef nonnull @.str.17, ptr noundef nonnull %5, ptr noundef nonnull %4) #11
  %53 = icmp eq i32 %52, -1
  br i1 %53, label %54, label %12

54:                                               ; preds = %48, %9
  %55 = load i32, ptr @argc, align 4, !tbaa !6
  %56 = load i32, ptr @optind, align 4, !tbaa !6
  %57 = icmp sgt i32 %55, %56
  br i1 %57, label %58, label %63

58:                                               ; preds = %54
  %59 = load ptr, ptr @argv, align 8, !tbaa !10
  %60 = sext i32 %56 to i64
  %61 = getelementptr inbounds ptr, ptr %59, i64 %60
  %62 = load ptr, ptr %61, align 8, !tbaa !10
  store ptr %62, ptr %2, align 8, !tbaa !12
  store ptr %62, ptr @parameter_file_name, align 8, !tbaa !10
  br label %65
...
define dso_local i32 @CCTK_CommandLine(ptr nocapture noundef writeonly %0) local_unnamed_addr #6 {
  %2 = load ptr, ptr @argv, align 8, !tbaa !10
  store ptr %2, ptr %0, align 8, !tbaa !10
  %3 = load i32, ptr @argc, align 4, !tbaa !6
  ret i32 %3
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local i32 @CCTK_ParameterFilename(i32 noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = load ptr, ptr @parameter_file_name, align 8, !tbaa !10
  %4 = tail call i32 @CCTK_Equals(ptr noundef %3, ptr noundef nonnull @.str.20) #11
  %5 = icmp eq i32 %4, 0
  %6 = load ptr, ptr @parameter_file_name, align 8
  %7 = select i1 %5, ptr %6, ptr @.str.21
...
define dso_local void @cctk_parameterfilename_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr noundef %2) local_unnamed_addr #1 {
  ...
  %5 = load ptr, ptr @parameter_file_name, align 8, !tbaa !10
  %6 = tail call i32 @CCTK_Equals(ptr noundef %5, ptr noundef nonnull @.str.20) #11
  %7 = icmp eq i32 %6, 0
  %8 = load ptr, ptr @parameter_file_name, align 8
  %9 = select i1 %7, ptr %8, ptr @.str.21
...
!12 = !{!13, !11, i64 0}
!13 = !{!"", !11, i64 0, !11, i64 8, !7, i64 16, !7, i64 20}
!14 = !{!8, !8, i64 0}
