...
@.str.5 = private unnamed_addr constant [34 x i8] c"Cactus/schedule/ScheduleCreater.c\00", align 1
@.str.6 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.7 = private unnamed_addr constant [66 x i8] c"Error while sorting group '%s' - %d remaining unsorted routines.\0A\00", align 1
...
12:                                               ; preds = %6
  ...
  %14 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(7) @.str.1) #15
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %26, label %16

16:                                               ; preds = %12
  %17 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(6) @.str.2) #15
  %18 = icmp eq i32 %17, 0
  br i1 %18, label %26, label %19

19:                                               ; preds = %16
  %20 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(6) @.str.3) #15
  %21 = icmp eq i32 %20, 0
  br i1 %21, label %26, label %22

22:                                               ; preds = %19
  %23 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(3) @.str.4) #15
  %24 = icmp eq i32 %23, 0
...
define dso_local i32 @CCTKi_DoScheduleFunction(ptr noundef %0, ptr nocapture noundef readonly %1, ptr noundef %2, ptr noundef %3, ptr noundef %4) local_unnamed_addr #7 {
  ...
  %7 = load ptr, ptr @schedule_groups, align 8, !tbaa !13
...
17:                                               ; preds = %13
  ...
  %20 = call fastcc i32 @ScheduleAddItem(i32 noundef %14, ptr noundef nonnull %15), !range !18
  br label %21
...
define internal fastcc i32 @ScheduleCreateGroup(ptr noundef %0) unnamed_addr #7 {
  ...
  %3 = load ptr, ptr @schedule_groups, align 8, !tbaa !13
...
14:                                               ; preds = %9
  ...
  %20 = load i32, ptr @n_schedule_groups, align 4, !tbaa !24
  %21 = add nsw i32 %20, 1
  store i32 %21, ptr @n_schedule_groups, align 4, !tbaa !24
  br label %23
...
35:                                               ; preds = %29
  store ptr %33, ptr %18, align 8, !tbaa !30
...
47:                                               ; preds = %35
  store i32 %24, ptr %17, align 4, !tbaa !29
  br label %48
...
48:                                               ; preds = %29, %47, %44, %22
  ...
  br i1 %52, label %53, label %22, !llvm.loop !31
...
61:                                               ; preds = %56
  %62 = load i32, ptr %19, align 8, !tbaa !33
  %63 = add nsw i32 %62, 1
  store i32 %63, ptr %19, align 8, !tbaa !33
  %64 = load ptr, ptr %20, align 8, !tbaa !28
...
19:                                               ; preds = %13
  ...
  br i1 %21, label %25, label %13, !llvm.loop !36
...
31:                                               ; preds = %25
  ...
  %33 = load i32, ptr %6, align 8, !tbaa !22
  %34 = add nsw i32 %33, -1
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds %struct.t_sched_item, ptr %29, i64 %35
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %36, ptr noundef nonnull align 8 dereferenceable(72) %1, i64 72, i1 false), !tbaa.struct !37
  tail call void @free(ptr noundef %1) #16
  br label %40

37:                                               ; preds = %25
  %38 = load i32, ptr %6, align 8, !tbaa !22
  %39 = add nsw i32 %38, -1
...
12:                                               ; preds = %10, %5
  ...
  %14 = load ptr, ptr @schedule_groups, align 8, !tbaa !13
...
27:                                               ; preds = %24
  ...
  %30 = call fastcc i32 @ScheduleAddItem(i32 noundef %13, ptr noundef nonnull %25), !range !18
  br label %31
...
define dso_local i32 @CCTKi_DoScheduleSortAllGroups() local_unnamed_addr #7 {
  %1 = load i32, ptr @n_schedule_groups, align 4, !tbaa !24
  %2 = icmp sgt i32 %1, 0
...
3:                                                ; preds = %0, %162
  ...
  %6 = load ptr, ptr @schedule_groups, align 8, !tbaa !13
  %7 = tail call ptr @Util_GetHandledData(ptr noundef %6, i32 noundef %5) #16
  %8 = icmp eq ptr %7, null
  br i1 %8, label %162, label %9

9:                                                ; preds = %3
  %10 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @cactuspriv_, i64 0, i32 4), align 8, !tbaa !39
  %11 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @cactuspriv_, i64 0, i32 15), align 8, !tbaa !41
...
27:                                               ; preds = %24
  %28 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 757, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.14, ptr noundef %10) #16
  br label %39

29:                                               ; preds = %21
  %30 = getelementptr inbounds %struct.t_sched_group, ptr %7, i64 0, i32 3
  %31 = load ptr, ptr %30, align 8, !tbaa !23
  %32 = load i32, ptr %12, align 8, !tbaa !22
...
45:                                               ; preds = %139, %42
  ...
  %48 = load ptr, ptr %43, align 8, !tbaa !23
...
58:                                               ; preds = %52
  ...
  %61 = load i32, ptr %12, align 8, !tbaa !22
  %62 = icmp sgt i32 %61, 0
  br i1 %62, label %63, label %77

63:                                               ; preds = %58
  %64 = load ptr, ptr %43, align 8, !tbaa !23
...
72:                                               ; preds = %66
  ...
  br i1 %74, label %77, label %66, !llvm.loop !36
...
85:                                               ; preds = %81
  %86 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 812, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.15, i32 noundef %55) #16
  %87 = load ptr, ptr %59, align 8, !tbaa !6
  br label %88

88:                                               ; preds = %85, %84, %83, %82, %81
  %89 = phi ptr [ %87, %85 ], [ %60, %84 ], [ %60, %83 ], [ %60, %82 ], [ %60, %81 ]
  %90 = phi ptr [ null, %85 ], [ @.str.4, %84 ], [ @.str.3, %83 ], [ @.str.2, %82 ], [ @.str.1, %81 ]
  %91 = load ptr, ptr %43, align 8, !tbaa !23
  %92 = getelementptr inbounds %struct.t_sched_item, ptr %91, i64 %47
  %93 = load ptr, ptr %92, align 8, !tbaa !25
  %94 = load ptr, ptr %7, align 8, !tbaa !19
  %95 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 906, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.8, ptr noundef %90, ptr noundef %93, ptr noundef %94, ptr noundef %89) #16
  br label %107
...
100:                                              ; preds = %96
  ...
  store i32 %104, ptr %106, align 4, !tbaa !24
  br label %107

107:                                              ; preds = %100, %96, %88, %52
  %108 = load ptr, ptr %53, align 8, !tbaa !13
  %109 = icmp eq ptr %108, null
  br i1 %109, label %110, label %52, !llvm.loop !42

110:                                              ; preds = %107
  %111 = load i32, ptr %12, align 8, !tbaa !22
  br label %112
...
117:                                              ; preds = %112
  %118 = load ptr, ptr %43, align 8, !tbaa !23
  ...
  %126 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 944, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.9, ptr noundef %120, ptr noundef %121, ptr noundef %125) #16
  br label %127

127:                                              ; preds = %117, %112
  %128 = load i32, ptr %12, align 8, !tbaa !22
...
132:                                              ; preds = %127, %132
  ...
  %136 = load i32, ptr %12, align 8, !tbaa !22
  %137 = sext i32 %136 to i64
  %138 = icmp slt i64 %135, %137
  br i1 %138, label %132, label %139, !llvm.loop !43
...
139:                                              ; preds = %132, %130
  ...
  br i1 %143, label %45, label %144, !llvm.loop !44
...
148:                                              ; preds = %144
  ...
  %150 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 983, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.10, ptr noundef %149, i32 noundef %146) #16
  %151 = load i32, ptr %12, align 8, !tbaa !22
  tail call void @CCTKi_ScheduleDestroyIVec(i32 noundef %151, ptr noundef %18) #16
  %152 = load i32, ptr %12, align 8, !tbaa !22
  ...
  store ptr %16, ptr %153, align 8, !tbaa !21
  %154 = load ptr, ptr %7, align 8, !tbaa !19
  %155 = sub nsw i32 0, %146
  %156 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 381, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7, ptr noundef %154, i32 noundef %155) #16
  %157 = sub i32 %4, %146
  br label %162

158:                                              ; preds = %144
  %159 = load i32, ptr %12, align 8, !tbaa !22
  tail call void @CCTKi_ScheduleDestroyIVec(i32 noundef %159, ptr noundef %18) #16
  %160 = load i32, ptr %12, align 8, !tbaa !22
  ...
  store ptr %16, ptr %161, align 8, !tbaa !21
  br label %162

162:                                              ; preds = %158, %3, %148
  %163 = phi i32 [ %157, %148 ], [ %4, %3 ], [ %4, %158 ]
  %164 = add nuw nsw i32 %5, 1
  %165 = load i32, ptr @n_schedule_groups, align 4, !tbaa !24
  %166 = icmp slt i32 %164, %165
  br i1 %166, label %3, label %167, !llvm.loop !45
...
define dso_local ptr @CCTKi_DoScheduleGetGroups() local_unnamed_addr #12 {
  %1 = load ptr, ptr @schedule_groups, align 8, !tbaa !13
  ret ptr %1
}
...
!6 = !{!7, !8, i64 16}
!7 = !{!"T_SCHED_MODIFIER", !8, i64 0, !9, i64 8, !8, i64 16}
...
!13 = !{!8, !8, i64 0}
!14 = !{!15, !9, i64 8}
!15 = !{!"", !8, i64 0, !9, i64 8, !8, i64 16, !16, i64 24, !16, i64 28, !8, i64 32, !16, i64 40, !8, i64 48, !8, i64 56, !8, i64 64}
!16 = !{!"int", !9, i64 0}
!17 = !{!15, !8, i64 16}
!18 = !{i32 -2, i32 1}
!19 = !{!20, !8, i64 0}
!20 = !{!"", !8, i64 0, !8, i64 8, !16, i64 16, !8, i64 24}
!21 = !{!20, !8, i64 8}
!22 = !{!20, !16, i64 16}
!23 = !{!20, !8, i64 24}
!24 = !{!16, !16, i64 0}
...
!35 = !{!15, !8, i64 56}
!36 = distinct !{!36, !32}
!37 = !{i64 0, i64 8, !13, i64 8, i64 4, !38, i64 16, i64 8, !13, i64 24, i64 4, !24, i64 28, i64 4, !24, i64 32, i64 8, !13, i64 40, i64 4, !24, i64 48, i64 8, !13, i64 56, i64 8, !13, i64 64, i64 8, !13}
!38 = !{!9, !9, i64 0}
!39 = !{!40, !8, i64 32}
!40 = !{!"", !8, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !16, i64 40, !16, i64 44, !16, i64 48, !16, i64 52, !16, i64 56, !16, i64 60, !16, i64 64, !16, i64 68, !16, i64 72, !16, i64 76, !16, i64 80}
!41 = !{!40, !16, i64 80}
!42 = distinct !{!42, !32}
!43 = distinct !{!43, !32}
!44 = distinct !{!44, !32}
