...
@.str.1 = private unnamed_addr constant [33 x i8] c"Could not use file for reading.\0A\00", align 1
@.str.2 = private unnamed_addr constant [28 x i8] c"Could not allocate memory.\0A\00", align 1
@lineno = internal unnamed_addr global i32 1, align 4
@.str.13 = private unnamed_addr constant [45 x i8] c"Parse error at line %d.  No value supplied.\0A\00", align 1
@.str.14 = private unnamed_addr constant [8 x i8] c"%s%s%s\0A\00", align 1
@.str.15 = private unnamed_addr constant [26 x i8] c"WARNING: Multiple string \00", align 1
@.str.16 = private unnamed_addr constant [26 x i8] c"tokens not supported for \00", align 1
@.str.17 = private unnamed_addr constant [22 x i8] c"This is a fatal error\00", align 1
@.str.18 = private unnamed_addr constant [99 x i8] c"ERROR: extra characters found after closing quote for value of parameter '%s' starting in line %d\0A\00", align 1
@.str.19 = private unnamed_addr constant [24 x i8] c"This is a fatal error.\0A\00", align 1
@.str.20 = private unnamed_addr constant [86 x i8] c"ERROR: no closing quote found for quoted value of parameter '%s' starting in line %d\0A\00", align 1
...
5:                                                ; preds = %3
  ...
  %7 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 32, i64 1, ptr %6) #11
  br label %23
...
15:                                               ; preds = %8
  ...
  %17 = tail call i64 @fwrite(ptr nonnull @.str.2, i64 27, i64 1, ptr %16) #11
  br label %23
...
12:                                               ; preds = %10, %549
  ...
  %17 = load i32, ptr @lineno, align 4, !tbaa !11
  %18 = add i32 %16, 1
  %19 = and i8 %13, -3
  %20 = icmp eq i8 %19, 33
...
30:                                               ; preds = %24
  %31 = add nsw i32 %23, 1
  store i32 %31, ptr @lineno, align 4, !tbaa !11
  br label %32
...
32:                                               ; preds = %24, %24, %30
  ...
  %38 = and i8 %36, -3
  %39 = icmp eq i8 %38, 33
  br i1 %39, label %21, label %40, !llvm.loop !13
...
47:                                               ; preds = %45
  ...
  %49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %48, ptr noundef nonnull @.str.13, i32 noundef %41) #11
  %50 = add nsw i32 %14, 1
  %51 = load i32, ptr @lineno, align 4, !tbaa !11
  br label %52
...
52:                                               ; preds = %45, %47
  ...
  %55 = add nsw i32 %53, 1
  store i32 %55, ptr @lineno, align 4, !tbaa !11
  br label %549
...
60:                                               ; preds = %56
  ...
  store i8 %42, ptr %63, align 1, !tbaa !10
...
84:                                               ; preds = %79
  %85 = load i8, ptr %4, align 1, !tbaa !10
...
102:                                              ; preds = %92
  ...
  store i8 %93, ptr %95, align 1, !tbaa !10
  br label %104
...
124:                                              ; preds = %124, %121
  ...
  %131 = load <4 x i8>, ptr %130, align 1, !tbaa !10
  %132 = getelementptr inbounds i8, ptr %130, i64 4
  %133 = load <4 x i8>, ptr %132, align 1, !tbaa !10
  ...
  %137 = load <4 x i8>, ptr %136, align 1, !tbaa !10
  ...
  br i1 %151, label %152, label %124, !llvm.loop !18
...
167:                                              ; preds = %158, %167
  ...
  br i1 %178, label %167, label %162, !llvm.loop !21
...
186:                                              ; preds = %179
  ...
  store i32 %187, ptr @lineno, align 4, !tbaa !11
...
190:                                              ; preds = %188
  %191 = load ptr, ptr @stderr, align 8, !tbaa !6
  %192 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %191, ptr noundef nonnull @.str.14, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.16, ptr noundef nonnull %4) #11
  %193 = load ptr, ptr @stderr, align 8, !tbaa !6
  %194 = tail call i64 @fwrite(ptr nonnull @.str.17, i64 21, i64 1, ptr %193) #11
  br label %557
...
222:                                              ; preds = %195, %202
  ...
  store i8 %201, ptr %224, align 1, !tbaa !10
  %225 = icmp sgt i32 %197, 8190
  br i1 %225, label %226, label %235

226:                                              ; preds = %222
  %227 = load ptr, ptr @stderr, align 8, !tbaa !6
  ...
  %233 = load ptr, ptr @stderr, align 8, !tbaa !6
...
237:                                              ; preds = %235, %203
  ...
  store i32 %240, ptr @lineno, align 4, !tbaa !11
...
256:                                              ; preds = %246
  br i1 %255, label %257, label %246, !llvm.loop !24
...
260:                                              ; preds = %246
  ...
  store i32 %261, ptr @lineno, align 4, !tbaa !11
  br label %273

262:                                              ; preds = %257
  %263 = load ptr, ptr @stderr, align 8, !tbaa !6
  %264 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %263, ptr noundef nonnull @.str.18, ptr noundef nonnull %4, i32 noundef %165) #11
  %265 = load ptr, ptr @stderr, align 8, !tbaa !6
  %266 = tail call i64 @fwrite(ptr nonnull @.str.19, i64 23, i64 1, ptr %265) #11
...
268:                                              ; preds = %235, %262, %209
  ...
  %270 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %269, ptr noundef nonnull @.str.20, ptr noundef nonnull %4, i32 noundef %165) #11
  %271 = load ptr, ptr @stderr, align 8, !tbaa !6
  %272 = tail call i64 @fwrite(ptr nonnull @.str.19, i64 23, i64 1, ptr %271) #11
  br label %557
...
278:                                              ; preds = %179
  store i8 %184, ptr %5, align 1, !tbaa !10
...
288:                                              ; preds = %281
  ...
  store i8 %287, ptr %289, align 1, !tbaa !10
...
291:                                              ; preds = %288
  ...
  %294 = load ptr, ptr @stderr, align 8, !tbaa !6
  %295 = tail call i64 @fwrite(ptr nonnull @.str.23, i64 48, i64 1, ptr %294) #11
  %296 = load ptr, ptr @stderr, align 8, !tbaa !6
...
306:                                              ; preds = %300
  ...
  store i8 %305, ptr %307, align 1, !tbaa !10
...
318:                                              ; preds = %310
  %319 = load i32, ptr @lineno, align 4, !tbaa !11
  %320 = add nsw i32 %319, 1
  store i32 %320, ptr @lineno, align 4, !tbaa !11
  br label %549
...
334:                                              ; preds = %329
  ...
  store i8 %330, ptr %337, align 1, !tbaa !10
  %338 = icmp sgt i32 %331, 8190
  br i1 %338, label %339, label %348

339:                                              ; preds = %334
  %340 = load ptr, ptr @stderr, align 8, !tbaa !6
  ...
  %344 = load ptr, ptr @stderr, align 8, !tbaa !6
...
348:                                              ; preds = %334, %329, %329, %329, %329
  ...
  br i1 %359, label %329, label %360, !llvm.loop !26
...
369:                                              ; preds = %375, %366
  ...
  %374 = load i8, ptr %373, align 1, !tbaa !10
...
375:                                              ; preds = %369, %369, %369
  br label %369, !llvm.loop !27

376:                                              ; preds = %369
  %377 = add nsw i32 %367, 1
  store i32 %377, ptr @lineno, align 4, !tbaa !11
...
378:                                              ; preds = %369, %360
  ...
  store i8 %381, ptr %383, align 1, !tbaa !10
...
386:                                              ; preds = %394, %378
  ...
  %392 = load i8, ptr %391, align 1, !tbaa !10
  %393 = add i32 %388, 1
...
407:                                              ; preds = %386, %386, %386, %386, %386
  ...
  store i8 0, ptr %410, align 1, !tbaa !10
...
448:                                              ; preds = %442
  ...
  store i8 %446, ptr %451, align 1, !tbaa !10
  %452 = getelementptr inbounds i8, ptr %5, i64 %449
  %453 = load i8, ptr %452, align 1, !tbaa !10
...
455:                                              ; preds = %448
  ...
  store i8 %453, ptr %458, align 1, !tbaa !10
  %459 = icmp eq i64 %457, 8192
  br i1 %459, label %460, label %442, !llvm.loop !30

460:                                              ; preds = %455
  %461 = load i32, ptr @lineno, align 4, !tbaa !11
  ...
  %464 = load ptr, ptr @stderr, align 8, !tbaa !6
...
470:                                              ; preds = %448, %442
  ...
  %476 = load i32, ptr @lineno, align 4, !tbaa !11
  ...
  br i1 %481, label %412, label %416, !llvm.loop !31
...
488:                                              ; preds = %482
  ...
  store i8 %486, ptr %491, align 1, !tbaa !10
...
495:                                              ; preds = %488
  ...
  store i8 %493, ptr %498, align 1, !tbaa !10
  %499 = icmp eq i64 %497, 8192
  br i1 %499, label %500, label %482, !llvm.loop !32

500:                                              ; preds = %495
  %501 = load i32, ptr @lineno, align 4, !tbaa !11
  %502 = load ptr, ptr @stderr, align 8, !tbaa !6
  %503 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %502, ptr noundef nonnull @.str.22, i32 noundef %501) #11
  %504 = load ptr, ptr @stderr, align 8, !tbaa !6
  ...
  %508 = load ptr, ptr @stderr, align 8, !tbaa !6
...
510:                                              ; preds = %488, %482
  ...
  store i8 0, ptr %513, align 1, !tbaa !10
...
515:                                              ; preds = %528, %510
  ...
  %519 = load i8, ptr %518, align 1, !tbaa !10
...
521:                                              ; preds = %515
  ...
  store i8 %519, ptr %524, align 1, !tbaa !10
  %525 = getelementptr inbounds i8, ptr %5, i64 %522
  %526 = load i8, ptr %525, align 1, !tbaa !10
...
528:                                              ; preds = %521
  ...
  store i8 %526, ptr %531, align 1, !tbaa !10
  %532 = icmp eq i64 %530, 8192
  br i1 %532, label %533, label %515, !llvm.loop !33

533:                                              ; preds = %528
  %534 = load i32, ptr @lineno, align 4, !tbaa !11
  %535 = load ptr, ptr @stderr, align 8, !tbaa !6
  %536 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %535, ptr noundef nonnull @.str.22, i32 noundef %534) #11
  %537 = load ptr, ptr @stderr, align 8, !tbaa !6
  %538 = tail call i64 @fwrite(ptr nonnull @.str.23, i64 48, i64 1, ptr %537) #11
  %539 = load ptr, ptr @stderr, align 8, !tbaa !6
  %540 = tail call i64 @fwrite(ptr nonnull @.str.24, i64 60, i64 1, ptr %539) #11
  %541 = load ptr, ptr @stderr, align 8, !tbaa !6
...
543:                                              ; preds = %521, %515
  ...
  store i8 0, ptr %546, align 1, !tbaa !10
  %547 = load i32, ptr @lineno, align 4, !tbaa !11
...
549:                                              ; preds = %78, %310, %318, %543, %273, %78, %78, %52, %81, %79
  ...
  br i1 %556, label %557, label %12, !llvm.loop !34
