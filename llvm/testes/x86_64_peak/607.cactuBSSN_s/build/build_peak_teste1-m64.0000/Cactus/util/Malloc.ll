...
@.str.1 = private unnamed_addr constant [19 x i8] c"Allocation error! \00", align 1
...
@.str.2 = private unnamed_addr constant [10 x i8] c"ticket_%d\00", align 1
@n_tickets = internal unnamed_addr global i32 0, align 4
@ticketDB = internal global ptr null, align 8
@.str.3 = private unnamed_addr constant [21 x i8] c"Cactus/util/Malloc.c\00", align 1
@.str.4 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.5 = private unnamed_addr constant [44 x i8] c"CCTK_MemTicketCash: Cannot find ticket %d \0A\00", align 1
@.str.6 = private unnamed_addr constant [49 x i8] c"CCTK_Memstat: total: %lu  past: %lu  diff %+ld \0A\00", align 1
...
7:                                                ; preds = %3
  ...
  %9 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 18, i64 1, ptr %8) #10
  br label %10

10:                                               ; preds = %7, %3
  store i64 424242, ptr %5, align 8, !tbaa !10
  ...
  %15 = load i64, ptr @totmem, align 8, !tbaa !18
  store i64 %15, ptr @pastmem, align 8, !tbaa !18
  %16 = add i64 %15, %0
  store i64 %16, ptr @totmem, align 8, !tbaa !18
...
12:                                               ; preds = %8
  ...
  %14 = load <2 x i64>, ptr %10, align 8, !tbaa !18
  ...
  store <2 x i64> %17, ptr %10, align 8, !tbaa !18
  br label %24
...
define dso_local i32 @CCTK_MemTicketRequest() local_unnamed_addr #4 {
  ...
  %3 = load i32, ptr @n_tickets, align 4, !tbaa !21
  %4 = add nsw i32 %3, 1
  store i32 %4, ptr @n_tickets, align 4, !tbaa !21
  %5 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %3) #11
  %6 = load ptr, ptr @ticketDB, align 8, !tbaa !6
...
12:                                               ; preds = %9
  %13 = load i64, ptr @totmem, align 8, !tbaa !18
...
define dso_local i64 @CCTK_TotalMemory() local_unnamed_addr #7 {
  %1 = load i64, ptr @totmem, align 8, !tbaa !18
  ret i64 %1
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local i64 @CCTK_MemTicketCash(i32 noundef %0) local_unnamed_addr #4 {
  %2 = load ptr, ptr @ticketDB, align 8, !tbaa !6
...
5:                                                ; preds = %1
  ...
  %7 = load i64, ptr @totmem, align 8, !tbaa !18
  %8 = sub i64 %7, %6
  br label %11

9:                                                ; preds = %1
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 471, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.5, i32 noundef %0) #11
  br label %11
...
define dso_local void @CCTK_MemStat() local_unnamed_addr #1 {
  %1 = load i64, ptr @totmem, align 8, !tbaa !18
  %2 = load i64, ptr @pastmem, align 8, !tbaa !18
  %3 = sub i64 %1, %2
  %4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i64 noundef %1, i64 noundef %2, i64 noundef %3)
  ret void
}
...
!9 = !{!"Simple C/C++ TBAA"}
!10 = !{!11, !12, i64 0}
!11 = !{!"", !12, i64 0, !12, i64 8, !12, i64 16, !13, i64 24, !7, i64 32}
!12 = !{!"long", !8, i64 0}
!13 = !{!"int", !8, i64 0}
!14 = !{!11, !12, i64 8}
!15 = !{!11, !12, i64 16}
