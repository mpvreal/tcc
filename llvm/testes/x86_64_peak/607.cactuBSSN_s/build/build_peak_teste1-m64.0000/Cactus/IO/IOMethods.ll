...
@.str.1 = private unnamed_addr constant [13 x i8] c"IO method %s\00", align 1
...
@.str.2 = private unnamed_addr constant [22 x i8] c"Cactus/IO/IOMethods.c\00", align 1
@.str.3 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.4 = private unnamed_addr constant [88 x i8] c"CactusDefaultOutputVarAsByMethod: I/O method '%s' not found for output of variable '%s'\00", align 1
...
define dso_local i32 @CCTKi_RegisterIOMethod(ptr noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  ...
  %4 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
10:                                               ; preds = %7
  ...
  store ptr @DummyOutputGH, ptr %15, align 8, !tbaa !14
  %16 = getelementptr inbounds %struct.IOMethod, ptr %8, i64 0, i32 3
  store ptr @DummyOutputVarAs, ptr %16, align 8, !tbaa !15
  %17 = getelementptr inbounds %struct.IOMethod, ptr %8, i64 0, i32 4
  store ptr @DummyTriggerOutput, ptr %17, align 8, !tbaa !16
  %18 = getelementptr inbounds %struct.IOMethod, ptr %8, i64 0, i32 5
  store ptr @DummyTimeToOutput, ptr %18, align 8, !tbaa !17
  %19 = call i32 (ptr, ptr, ...) @Util_asprintf(ptr noundef nonnull %3, ptr noundef nonnull @.str.1, ptr noundef %1) #7
  ...
  %24 = load i32, ptr @num_methods, align 4, !tbaa !19
  %25 = add nsw i32 %24, 1
  store i32 %25, ptr @num_methods, align 4, !tbaa !19
  br label %26
...
define dso_local i32 @CCTK_RegisterIOMethodOutputGH(i32 noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
define dso_local i32 @CCTK_OutputVarAs(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #1 {
  %4 = load i32, ptr @num_methods, align 4, !tbaa !19
  %5 = icmp sgt i32 %4, 0
...
6:                                                ; preds = %3, %24
  %7 = phi i32 [ %26, %24 ], [ 0, %3 ]
  %8 = phi i32 [ %25, %24 ], [ 0, %3 ]
  %9 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
24:                                               ; preds = %6, %12
  ...
  %27 = load i32, ptr @num_methods, align 4, !tbaa !19
  %28 = icmp slt i32 %26, %27
  br i1 %28, label %6, label %29, !llvm.loop !20
...
define dso_local void @cctk_outputvaras_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr noundef %2, ptr noundef %3, i32 noundef %4, i32 noundef %5) local_unnamed_addr #1 {
  ...
  %10 = load i32, ptr @num_methods, align 4, !tbaa !19
...
12:                                               ; preds = %6, %30
  ...
  %15 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
18:                                               ; preds = %12
  ...
  %28 = load i32, ptr %19, align 8, !tbaa !18
...
30:                                               ; preds = %18, %12
  ...
  %33 = load i32, ptr @num_methods, align 4, !tbaa !19
  %34 = icmp slt i32 %32, %33
  br i1 %34, label %12, label %35, !llvm.loop !20

35:                                               ; preds = %30, %6
  %36 = phi i32 [ -1, %6 ], [ %31, %30 ]
  store i32 %36, ptr %0, align 4, !tbaa !19
...
define dso_local i32 @CCTK_OutputVar(ptr noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = load i32, ptr @num_methods, align 4, !tbaa !19
  %4 = icmp sgt i32 %3, 0
...
5:                                                ; preds = %2, %23
  %6 = phi i32 [ %25, %23 ], [ 0, %2 ]
  %7 = phi i32 [ %24, %23 ], [ 0, %2 ]
  %8 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
11:                                               ; preds = %5
  ...
  %20 = add nsw i32 %7, %19
  %21 = load i32, ptr %12, align 8, !tbaa !18
...
23:                                               ; preds = %11, %5
  ...
  %26 = load i32, ptr @num_methods, align 4, !tbaa !19
  %27 = icmp slt i32 %25, %26
  br i1 %27, label %5, label %28, !llvm.loop !20
...
define dso_local void @cctk_outputvar_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr noundef %2, i32 noundef %3) local_unnamed_addr #1 {
  ...
  %7 = load i32, ptr @num_methods, align 4, !tbaa !19
  %8 = icmp sgt i32 %7, 0
...
9:                                                ; preds = %4, %27
  ...
  %12 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
27:                                               ; preds = %15, %9
  ...
  %30 = load i32, ptr @num_methods, align 4, !tbaa !19
  %31 = icmp slt i32 %29, %30
  br i1 %31, label %9, label %32, !llvm.loop !20
...
define dso_local i32 @CCTK_OutputVarByMethod(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #1 {
  %4 = load ptr, ptr @CCTK_OutputVarAsByMethod, align 8, !tbaa !6
...
define dso_local void @cctk_outputvarbymethod_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr noundef %2, ptr noundef %3, i32 noundef %4, i32 noundef %5) local_unnamed_addr #1 {
  ...
  %8 = tail call ptr @Util_NullTerminateString(ptr noundef %3, i32 noundef %5) #7
  %9 = load ptr, ptr %1, align 8, !tbaa !6
  %10 = load ptr, ptr @CCTK_OutputVarAsByMethod, align 8, !tbaa !6
...
define dso_local i32 @CactusDefaultOutputGH(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr @num_methods, align 4, !tbaa !19
  %3 = icmp sgt i32 %2, 0
...
4:                                                ; preds = %1, %20
  %5 = phi i32 [ %22, %20 ], [ 0, %1 ]
  %6 = phi i32 [ %21, %20 ], [ 0, %1 ]
  %7 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
10:                                               ; preds = %4
  ...
  %17 = add nsw i32 %16, %6
  %18 = load i32, ptr %11, align 8, !tbaa !18
...
20:                                               ; preds = %4, %10
  ...
  %23 = load i32, ptr @num_methods, align 4, !tbaa !19
  %24 = icmp slt i32 %22, %23
  br i1 %24, label %4, label %25, !llvm.loop !22
...
define dso_local i32 @CactusDefaultOutputVarAsByMethod(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #1 {
  ...
  %6 = load ptr, ptr @IOMethods, align 8, !tbaa !6
...
10:                                               ; preds = %4
  ...
  %17 = load i32, ptr %11, align 8, !tbaa !18
  %18 = call i32 @CCTK_TimerStopI(i32 noundef %17) #7
  br label %21

19:                                               ; preds = %4
  %20 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 8, i32 noundef 801, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef %2, ptr noundef %1) #7
  br label %21
...
define dso_local void @cctk_outputvarasbymethod_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7) local_unnamed_addr #1 {
  ...
  %12 = load ptr, ptr @CCTK_OutputVarAsByMethod, align 8, !tbaa !6
...
15:                                               ; preds = %5, %10
  ...
  %17 = load i32, ptr @num_methods, align 4, !tbaa !19
  %18 = icmp slt i32 %16, %17
  br i1 %18, label %5, label %19, !llvm.loop !23
...
!9 = !{!"Simple C/C++ TBAA"}
!10 = !{!11, !7, i64 0}
!11 = !{!"IOMethod", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !12, i64 48}
!12 = !{!"int", !8, i64 0}
!13 = !{!11, !7, i64 8}
!14 = !{!11, !7, i64 16}
!15 = !{!11, !7, i64 24}
