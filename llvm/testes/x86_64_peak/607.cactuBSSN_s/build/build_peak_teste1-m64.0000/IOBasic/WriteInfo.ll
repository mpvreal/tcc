...
@.str.2 = private unnamed_addr constant [20 x i8] c"IOBasic/WriteInfo.c\00", align 1
@.str.3 = private unnamed_addr constant [56 x i8] c"IOBasic_WriteInfo: No info output for '%s' (no storage)\00", align 1
@.str.4 = private unnamed_addr constant [41 x i8] c"IOBasic_WriteInfo: Unsupported data type\00", align 1
@.str.5 = private unnamed_addr constant [52 x i8] c"IOBasic_WriteInfo: Internal error in reduction '%s'\00", align 1
...
define dso_local i32 @IOBasic_WriteInfo(ptr noundef %0, i32 noundef %1) local_unnamed_addr #1 {
  ...
  store i32 107, ptr %4, align 4, !tbaa !6
  store ptr %5, ptr %6, align 8, !tbaa !10
  %7 = call ptr @CCTK_GHExtension(ptr noundef %0, ptr noundef nonnull @.str.1) #5
...
16:                                               ; preds = %2
  ...
  %18 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 2, i32 noundef 86, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, ptr noundef %17) #5
...
20:                                               ; preds = %16, %20
  ...
  br i1 %25, label %117, label %20, !llvm.loop !20
...
35:                                               ; preds = %31
  %36 = load i8, ptr %33, align 1, !tbaa !22
...
39:                                               ; preds = %31
  %40 = load i32, ptr %33, align 4, !tbaa !6
...
59:                                               ; preds = %31
  %60 = load i16, ptr %33, align 2, !tbaa !25
...
67:                                               ; preds = %31
  %68 = load i64, ptr %33, align 8, !tbaa !27
...
71:                                               ; preds = %31
  %72 = load float, ptr %33, align 4, !tbaa !29
...
75:                                               ; preds = %31
  %76 = load float, ptr %33, align 4, !tbaa !29
  %77 = fpext float %76 to double
  %78 = getelementptr inbounds %struct.IOBASIC_REDUCTION, ptr %12, i64 0, i32 3
  store double %77, ptr %78, align 8, !tbaa !23
...
89:                                               ; preds = %31
  ...
  store double %93, ptr %96, align 8, !tbaa !23
  %97 = getelementptr inbounds %struct.IOBASIC_REDUCTION, ptr %95, i64 0, i32 2
  store i8 1, ptr %97, align 8, !tbaa !17
  br label %117

98:                                               ; preds = %31
  %99 = call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 175, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #5
...
100:                                              ; preds = %29, %113
  ...
  %107 = load double, ptr %5, align 8, !tbaa !24
...
109:                                              ; preds = %100
  ...
  %112 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 190, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5, ptr noundef %111) #5
  br label %113
...
!12 = !{!13, !11, i64 56}
!13 = !{!"IOBASIC_GH", !7, i64 0, !7, i64 4, !14, i64 8, !14, i64 16, !8, i64 24, !11, i64 32, !11, i64 40, !11, i64 48, !11, i64 56, !11, i64 64, !11, i64 72, !7, i64 80}
!14 = !{!"double", !8, i64 0}
!15 = !{!16, !11, i64 8}
!16 = !{!"IOBASIC_REDUCTIONLIST", !7, i64 0, !11, i64 8}
!17 = !{!18, !8, i64 16}
!18 = !{!"IOBASIC_REDUCTION", !7, i64 0, !11, i64 8, !8, i64 16, !14, i64 24, !11, i64 32}
!19 = !{!18, !11, i64 32}
!20 = distinct !{!20, !21}
