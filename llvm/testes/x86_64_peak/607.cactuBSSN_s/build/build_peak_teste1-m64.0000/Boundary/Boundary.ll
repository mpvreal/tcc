...
@.str.1 = private unnamed_addr constant [20 x i8] c"Boundary/Boundary.c\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"Boundary\00", align 1
@.str.3 = private unnamed_addr constant [116 x i8] c"New GH passed to Boundary_RegisterPhysicalBC.  Thorn CactusBase/Boundary does not yet handle multiple GHs properly.\00", align 1
@.str.4 = private unnamed_addr constant [74 x i8] c"Null pointer passed to Boundary_RegisterPhysicalBC.  Is this intentional?\00", align 1
@physbc_table_handle = internal unnamed_addr global i32 -1, align 4
@.str.5 = private unnamed_addr constant [69 x i8] c"Error creating table to hold registered physical boundary conditions\00", align 1
@.str.6 = private unnamed_addr constant [82 x i8] c"There already exists a physical boundary condition registered under the name \22%s\22\00", align 1
@.str.7 = private unnamed_addr constant [41 x i8] c"Error adding boundary condition to table\00", align 1
@.str.8 = private unnamed_addr constant [22 x i8] c"Invalid variable name\00", align 1
@.str.9 = private unnamed_addr constant [23 x i8] c"Invalid variable index\00", align 1
@.str.10 = private unnamed_addr constant [113 x i8] c"New GH passed to Boundary_SelectVarForBCI.  Thorn CactusBase/Boundary does not yet handle multiple GHs properly.\00", align 1
@.str.11 = private unnamed_addr constant [69 x i8] c"There is no function implementing the physical boundary condition %s\00", align 1
@selected_faces = internal unnamed_addr global ptr null, align 8
@.str.12 = private unnamed_addr constant [38 x i8] c"%s has already been selected for a bc\00", align 1
@.str.13 = private unnamed_addr constant [69 x i8] c"Unable to allocate memory for entry into 'selected for bcs' database\00", align 1
@bcdata_list = internal unnamed_addr global ptr null, align 8
@.str.14 = private unnamed_addr constant [53 x i8] c"Unable to allocate memory for internal 'bcdata' list\00", align 1
@num_cctk_vars = internal unnamed_addr global i32 0, align 4
@.str.15 = private unnamed_addr constant [62 x i8] c"Unable to allocate memory for internal 'selected_faces' array\00", align 1
@.str.16 = private unnamed_addr constant [58 x i8] c"%s has already been selected for this boundary condition!\00", align 1
@.str.17 = private unnamed_addr constant [23 x i8] c"Invalid group name %s\0A\00", align 1
@.str.18 = private unnamed_addr constant [20 x i8] c"Invalid group index\00", align 1
@.str.19 = private unnamed_addr constant [109 x i8] c"New GH passed to Boundary_SelectedGVs.  Thorn CactusBase/Boundary does not yet handle multiple GHs properly.\00", align 1
@.str.20 = private unnamed_addr constant [15 x i8] c"internal error\00", align 1
@.str.21 = private unnamed_addr constant [60 x i8] c"There is no boundary condition registered under the name %s\00", align 1
@.str.22 = private unnamed_addr constant [56 x i8] c"Error in Boundary_SelectedGVs for %s boundary condition\00", align 1
@.str.23 = private unnamed_addr constant [98 x i8] c"Boundary_SelectedGVs returned %d selected variables for \22%s\22 boundary condition, but %d expected\0A\00", align 1
@.str.24 = private unnamed_addr constant [62 x i8] c"Boundary_ApplyPhysicalBCs: Util_TableGetFnPointer returned %d\00", align 1
@.str.25 = private unnamed_addr constant [59 x i8] c"Function associated with boundary condition %s returned %d\00", align 1
@.str.27 = private unnamed_addr constant [39 x i8] c"Boundary condition %s for variable %s\0A\00", align 1
@.str.28 = private unnamed_addr constant [113 x i8] c"Someone thinks that the boundary selection list should be empty at this point.  Alas, it is not; I better abort.\00", align 1
...
define dso_local i32 @Bdry_Boundary_RegisterPhysicalBC(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #1 {
  %4 = load ptr, ptr @theGH, align 8, !tbaa !6
  %5 = icmp eq ptr %4, null
  br i1 %5, label %6, label %7

6:                                                ; preds = %3
  store ptr %0, ptr @theGH, align 8, !tbaa !6
  br label %11
...
9:                                                ; preds = %7
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 210, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #11
  br label %11
...
13:                                               ; preds = %11
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 2, i32 noundef 219, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.4) #11
  br label %15

15:                                               ; preds = %13, %11
  %16 = phi ptr [ @BndNone, %13 ], [ %1, %11 ]
  %17 = load i32, ptr @physbc_table_handle, align 4, !tbaa !10
  %18 = icmp eq i32 %17, -1
  br i1 %18, label %19, label %25

19:                                               ; preds = %15
  %20 = tail call i32 @Util_TableCreate(i32 noundef 1) #11
  store i32 %20, ptr @physbc_table_handle, align 4, !tbaa !10
  %21 = icmp slt i32 %20, 0
  br i1 %21, label %22, label %25

22:                                               ; preds = %19
  %23 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 238, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.5) #11
  %24 = load i32, ptr @physbc_table_handle, align 4, !tbaa !10
  br label %25
...
29:                                               ; preds = %25
  %30 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 248, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.6, ptr noundef %2) #11
  br label %37

31:                                               ; preds = %25
  %32 = load i32, ptr @physbc_table_handle, align 4, !tbaa !10
  %33 = tail call i32 @Util_TableSetFnPointer(i32 noundef %32, ptr noundef %16, ptr noundef %2) #11
  %34 = icmp slt i32 %33, 0
  br i1 %34, label %35, label %37

35:                                               ; preds = %31
  %36 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 259, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.7) #11
  br label %37
...
9:                                                ; preds = %6
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 338, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.8) #11
  br label %13

11:                                               ; preds = %6
  %12 = tail call i32 @Bdry_Boundary_SelectVarForBCI(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %7, ptr noundef %5), !range !12
  br label %13
...
11:                                               ; preds = %8, %6
  %12 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 425, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.9) #11
  br label %143

13:                                               ; preds = %8
  %14 = load ptr, ptr @theGH, align 8, !tbaa !6
...
19:                                               ; preds = %17
  %20 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 446, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.10) #11
  br label %21

21:                                               ; preds = %17, %19, %16
  %22 = phi i32 [ -5, %19 ], [ 0, %17 ], [ 0, %16 ]
  %23 = load i32, ptr @physbc_table_handle, align 4, !tbaa !10
  %24 = tail call i32 @Util_TableQueryValueInfo(i32 noundef %23, ptr noundef null, ptr noundef null, ptr noundef %5) #11
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %26, label %28

26:                                               ; preds = %21
  %27 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 459, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.11, ptr noundef %5) #11
  br label %28

28:                                               ; preds = %26, %21
  %29 = phi i32 [ %22, %21 ], [ -2, %26 ]
  %30 = load ptr, ptr @selected_faces, align 8, !tbaa !6
...
38:                                               ; preds = %32
  ...
  %40 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 471, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.12, ptr noundef %39) #11
  br label %143
...
46:                                               ; preds = %43
  %47 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 487, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.13) #11
  br label %48
...
48:                                               ; preds = %46, %43
  ...
  store i32 %3, ptr %51, align 8, !tbaa !16
  %52 = getelementptr inbounds %struct.BCVAR, ptr %44, i64 0, i32 4
  store i32 %4, ptr %52, align 4, !tbaa !17
  br label %53
...
57:                                               ; preds = %53
  ...
  %61 = icmp eq i32 %60, 0
  br i1 %61, label %53, label %89, !llvm.loop !20
...
65:                                               ; preds = %62
  %66 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 535, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.14) #11
  br label %67
...
76:                                               ; preds = %71
  ...
  br i1 %80, label %81, label %71, !llvm.loop !23
...
83:                                               ; preds = %81
  store ptr %63, ptr @bcdata_list, align 8, !tbaa !6
  store ptr %74, ptr %63, align 8, !tbaa !24
  br label %96

84:                                               ; preds = %81
  store ptr %74, ptr %63, align 8, !tbaa !24
  store ptr %63, ptr %73, align 8, !tbaa !24
  br label %96

85:                                               ; preds = %71
  %86 = load ptr, ptr @bcdata_list, align 8, !tbaa !6
  %87 = icmp eq ptr %86, null
  %88 = select i1 %87, ptr @bcdata_list, ptr %73
  store ptr %63, ptr %88, align 8, !tbaa !6
...
96:                                               ; preds = %84, %83, %85, %89
  ...
  store ptr %44, ptr %98, align 8, !tbaa !22
...
114:                                              ; preds = %112
  ...
  %116 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1270, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.16, ptr noundef %115) #11
  br label %120

117:                                              ; preds = %108, %100
  %118 = load ptr, ptr %102, align 8, !tbaa !26
  %119 = icmp eq ptr %118, null
  br i1 %119, label %123, label %100, !llvm.loop !27
...
122:                                              ; preds = %120
  store ptr %44, ptr %101, align 8, !tbaa !26
  store ptr %102, ptr %44, align 8, !tbaa !26
  br label %126

123:                                              ; preds = %117
  store ptr %44, ptr %102, align 8, !tbaa !26
  store ptr null, ptr %44, align 8, !tbaa !26
  br label %126

124:                                              ; preds = %120
  %125 = getelementptr inbounds %struct.BCDATA, ptr %55, i64 0, i32 1
  store ptr %44, ptr %125, align 8, !tbaa !22
  store ptr %102, ptr %44, align 8, !tbaa !26
  br label %126

126:                                              ; preds = %96, %124, %122, %123
  %127 = load ptr, ptr @selected_faces, align 8, !tbaa !6
  %128 = icmp eq ptr %127, null
  br i1 %128, label %129, label %137

129:                                              ; preds = %126
  %130 = tail call i32 @CCTK_NumVars() #11
  store i32 %130, ptr @num_cctk_vars, align 4, !tbaa !10
  %131 = sext i32 %130 to i64
  %132 = tail call noalias ptr @calloc(i64 noundef %131, i64 noundef 4) #13
  store ptr %132, ptr @selected_faces, align 8, !tbaa !6
  %133 = icmp eq ptr %132, null
  br i1 %133, label %134, label %137

134:                                              ; preds = %129
  %135 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 658, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.15) #11
  %136 = load ptr, ptr @selected_faces, align 8, !tbaa !6
  br label %137
...
9:                                                ; preds = %6
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 741, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.17, ptr noundef %4) #11
  br label %25
...
14:                                               ; preds = %11
  %15 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 820, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.18) #11
  br label %25
...
20:                                               ; preds = %16, %20
  ...
  %22 = tail call i32 @Bdry_Boundary_SelectVarForBCI(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %21, ptr noundef %5), !range !12
  %23 = add nsw i32 %21, 1
...
9:                                                ; preds = %6
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 820, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.18) #11
  br label %20
...
15:                                               ; preds = %11, %15
  ...
  %17 = tail call i32 @Bdry_Boundary_SelectVarForBCI(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %16, ptr noundef %5), !range !12
  %18 = add nsw i32 %16, 1
  %19 = icmp slt i32 %18, %13
  br i1 %19, label %15, label %20, !llvm.loop !28
...
define dso_local i32 @Bdry_Boundary_SelectedGVs(ptr noundef %0, i32 noundef %1, ptr noundef writeonly %2, ptr noundef writeonly %3, ptr noundef writeonly %4, ptr noundef writeonly %5, ptr noundef %6) local_unnamed_addr #1 {
  %8 = load ptr, ptr @theGH, align 8, !tbaa !6
...
13:                                               ; preds = %11
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 923, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.19) #11
  br label %15

15:                                               ; preds = %11, %13, %10
  %16 = phi i32 [ -5, %13 ], [ 0, %11 ], [ 0, %10 ]
  %17 = load ptr, ptr @bcdata_list, align 8, !tbaa !6
...
54:                                               ; preds = %52, %50, %48, %46, %44, %35
  ...
  %57 = load i32, ptr %36, align 8, !tbaa !25
  %58 = icmp sgt i32 %56, %57
  br i1 %58, label %59, label %61

59:                                               ; preds = %54
  %60 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 983, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %61
...
66:                                               ; preds = %63
  %67 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 984, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %68

68:                                               ; preds = %66, %63, %61, %30
  %69 = phi i32 [ %55, %66 ], [ %55, %63 ], [ %1, %61 ], [ %29, %30 ]
  %70 = phi i32 [ %38, %66 ], [ %38, %63 ], [ %38, %61 ], [ %28, %30 ]
  %71 = load ptr, ptr %27, align 8, !tbaa !6
  %72 = icmp eq ptr %71, null
  br i1 %72, label %382, label %26, !llvm.loop !29
...
88:                                               ; preds = %84, %83
  ...
  br i1 %94, label %75, label %44, !llvm.loop !30
...
97:                                               ; preds = %96, %97
  ...
  br i1 %109, label %97, label %46, !llvm.loop !30
...
110:                                              ; preds = %96, %110
  ...
  %122 = load ptr, ptr %112, align 8, !tbaa !6
  %123 = icmp slt i64 %120, %25
  %124 = icmp ne ptr %122, null
  %125 = select i1 %123, i1 %124, i1 false
  br i1 %125, label %110, label %48, !llvm.loop !30
...
127:                                              ; preds = %126, %127
  ...
  %139 = load ptr, ptr %129, align 8, !tbaa !6
  %140 = icmp slt i64 %137, %25
  %141 = icmp ne ptr %139, null
  %142 = select i1 %140, i1 %141, i1 false
  br i1 %142, label %127, label %50, !llvm.loop !30
...
143:                                              ; preds = %126, %143
  ...
  %158 = load ptr, ptr %145, align 8, !tbaa !6
  %159 = icmp slt i64 %156, %25
  %160 = icmp ne ptr %158, null
  %161 = select i1 %159, i1 %160, i1 false
  br i1 %161, label %143, label %52, !llvm.loop !30
...
186:                                              ; preds = %184, %182, %173
  ...
  %189 = load i32, ptr %174, align 8, !tbaa !25
  %190 = icmp sgt i32 %188, %189
  br i1 %190, label %191, label %193

191:                                              ; preds = %186
  %192 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 983, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %193
...
195:                                              ; preds = %193
  %196 = load i32, ptr %174, align 8, !tbaa !25
  %197 = icmp eq i32 %188, %196
  br i1 %197, label %200, label %198

198:                                              ; preds = %195
  %199 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 984, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %200

200:                                              ; preds = %198, %195, %193, %168
  %201 = phi i32 [ %187, %198 ], [ %187, %195 ], [ %1, %193 ], [ %167, %168 ]
  %202 = phi i32 [ %176, %198 ], [ %176, %195 ], [ %176, %193 ], [ %166, %168 ]
  %203 = load ptr, ptr %165, align 8, !tbaa !6
  %204 = icmp eq ptr %203, null
  br i1 %204, label %382, label %164, !llvm.loop !29
...
258:                                              ; preds = %256, %254, %245
  ...
  %261 = load i32, ptr %246, align 8, !tbaa !25
  %262 = icmp sgt i32 %260, %261
  br i1 %262, label %263, label %265

263:                                              ; preds = %258
  %264 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 983, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %265
...
267:                                              ; preds = %265
  %268 = load i32, ptr %246, align 8, !tbaa !25
  %269 = icmp eq i32 %260, %268
  br i1 %269, label %272, label %270

270:                                              ; preds = %267
  %271 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 984, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %272

272:                                              ; preds = %270, %267, %265, %240
  %273 = phi i32 [ %259, %270 ], [ %259, %267 ], [ %1, %265 ], [ %239, %240 ]
  %274 = phi i32 [ %248, %270 ], [ %248, %267 ], [ %248, %265 ], [ %238, %240 ]
  %275 = load ptr, ptr %237, align 8, !tbaa !6
  %276 = icmp eq ptr %275, null
  br i1 %276, label %382, label %236, !llvm.loop !29
...
334:                                              ; preds = %332, %353
  ...
  %339 = load i32, ptr %338, align 8, !tbaa !13
...
344:                                              ; preds = %334
  ...
  store i32 %346, ptr %347, align 4, !tbaa !10
  br label %348
...
353:                                              ; preds = %348, %349
  ...
  %356 = load ptr, ptr %336, align 8, !tbaa !6
  %357 = icmp slt i64 %354, %25
  %358 = icmp ne ptr %356, null
  %359 = select i1 %357, i1 %358, i1 false
  br i1 %359, label %334, label %360, !llvm.loop !30

360:                                              ; preds = %353
  %361 = trunc i64 %354 to i32
  %362 = load i32, ptr %324, align 8, !tbaa !25
  br label %363
...
368:                                              ; preds = %363
  %369 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 983, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %370
...
372:                                              ; preds = %370
  %373 = load i32, ptr %324, align 8, !tbaa !25
  %374 = icmp eq i32 %366, %373
  br i1 %374, label %377, label %375

375:                                              ; preds = %372
  %376 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 984, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.20) #11
  br label %377

377:                                              ; preds = %318, %375, %372, %370
  %378 = phi i32 [ %365, %375 ], [ %365, %372 ], [ %1, %370 ], [ %317, %318 ]
  %379 = phi i32 [ %326, %375 ], [ %326, %372 ], [ %326, %370 ], [ %316, %318 ]
  %380 = load ptr, ptr %315, align 8, !tbaa !6
  %381 = icmp eq ptr %380, null
  br i1 %381, label %382, label %314, !llvm.loop !29
...
385:                                              ; preds = %382
  %386 = load i32, ptr @physbc_table_handle, align 4, !tbaa !10
...
389:                                              ; preds = %385
  %390 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 992, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.21, ptr noundef nonnull %6) #11
  br label %391
...
define dso_local void @Boundary_ApplyPhysicalBCs(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %3 = load ptr, ptr @bcdata_list, align 8, !tbaa !6
...
32:                                               ; preds = %22
  ...
  %34 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1072, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.22, ptr noundef %33) #11
  br label %40
...
37:                                               ; preds = %35
  %38 = load ptr, ptr %28, align 8, !tbaa !18
  %39 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1077, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.23, i32 noundef %30, ptr noundef %38, i32 noundef %13) #11
  br label %40

40:                                               ; preds = %35, %37, %32
  %41 = load i32, ptr @physbc_table_handle, align 4, !tbaa !10
...
45:                                               ; preds = %40
  %46 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 1092, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.24, i32 noundef %43) #11
  br label %47
...
51:                                               ; preds = %47
  %52 = load ptr, ptr %28, align 8, !tbaa !18
  %53 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1107, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.25, ptr noundef %52, i32 noundef %49) #11
  br label %54

54:                                               ; preds = %47, %51
  %55 = load ptr, ptr %6, align 8, !tbaa !6
  %56 = icmp eq ptr %55, null
  br i1 %56, label %57, label %5, !llvm.loop !31
...
define dso_local void @Boundary_ClearSelection(ptr nocapture noundef readnone %0) local_unnamed_addr #1 {
  %2 = load ptr, ptr @bcdata_list, align 8, !tbaa !6
...
9:                                                ; preds = %4, %9
  ...
  br i1 %12, label %13, label %9, !llvm.loop !32
...
17:                                               ; preds = %13, %1
  %18 = load ptr, ptr @selected_faces, align 8, !tbaa !6
  %19 = load i32, ptr @num_cctk_vars, align 4, !tbaa !10
...
define dso_local void @Boundary_MakeSureThatTheSelectionIsEmpty() local_unnamed_addr #1 {
  %1 = load ptr, ptr @bcdata_list, align 8, !tbaa !6
  %2 = icmp eq ptr %1, null
  br i1 %2, label %39, label %7

3:                                                ; preds = %26, %21, %7
  %4 = phi i32 [ %9, %7 ], [ 0, %21 ], [ 0, %26 ]
  %5 = load ptr, ptr %8, align 8, !tbaa !6
  %6 = icmp eq ptr %5, null
  br i1 %6, label %35, label %7, !llvm.loop !34
...
21:                                               ; preds = %19, %13
  ...
  %23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.27, ptr noundef %22, ptr noundef %17)
...
26:                                               ; preds = %21, %26
  ...
  %32 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.27, ptr noundef %31, ptr noundef %30)
  tail call void @free(ptr noundef %30) #11
  %33 = load ptr, ptr %27, align 8, !tbaa !6
  %34 = icmp eq ptr %33, null
  br i1 %34, label %3, label %26, !llvm.loop !35
...
37:                                               ; preds = %35
  %38 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 1209, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.28) #11
  br label %39
...
!12 = !{i32 -7, i32 1}
!13 = !{!14, !11, i64 8}
!14 = !{!"BCVAR", !7, i64 0, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20}
!15 = !{!14, !11, i64 12}
!16 = !{!14, !11, i64 16}
!17 = !{!14, !11, i64 20}
!18 = !{!19, !7, i64 16}
!19 = !{!"BCDATA", !7, i64 0, !7, i64 8, !7, i64 16, !11, i64 24}
!20 = distinct !{!20, !21}
