...
@.str.1 = private unnamed_addr constant [9 x i8] c"15:34:31\00", align 1
@CCTK_CompileDate.date = internal global [13 x i8] zeroinitializer, align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"Mar 20 2024\00", align 1
@CCTK_CompileDateTime.buffer = internal global [26 x i8] zeroinitializer, align 16
@.str.3 = private unnamed_addr constant [22 x i8] c"CCTK_COMPILE_DATETIME\00", align 1
@.str.4 = private unnamed_addr constant [6 x i8] c"4.2.1\00", align 1
...
define dso_local nonnull ptr @CCTK_CompileDate() local_unnamed_addr #1 {
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) @CCTK_CompileDate.date, ptr noundef nonnull align 1 dereferenceable(12) @.str.2, i64 12, i1 false) #4
...
define dso_local nonnull ptr @CCTK_CompileDateTime() local_unnamed_addr #2 {
  %1 = load i8, ptr @CCTK_CompileDateTime.buffer, align 16, !tbaa !6
  %2 = icmp eq i8 %1, 0
  %3 = select i1 %2, ptr @.str.3, ptr @CCTK_CompileDateTime.buffer
  ret ptr %3
}
