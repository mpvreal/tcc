...
@VideoRes = internal unnamed_addr constant [12 x %struct.video_size] [%struct.video_size { ptr @.str.4, i32 176, i32 144 }, %struct.video_size { ptr @.str.5, i32 160, i32 128 }, %struct.video_size { ptr @.str.6, i32 320, i32 240 }, %struct.video_size { ptr @.str.7, i32 352, i32 240 }, %struct.video_size { ptr @.str.8, i32 352, i32 288 }, %struct.video_size { ptr @.str.9, i32 640, i32 480 }, %struct.video_size { ptr @.str.10, i32 720, i32 480 }, %struct.video_size { ptr @.str.11, i32 704, i32 576 }, %struct.video_size { ptr @.str.12, i32 720, i32 576 }, %struct.video_size { ptr @.str.13, i32 1280, i32 720 }, %struct.video_size { ptr @.str.14, i32 1920, i32 1080 }, %struct.video_size zeroinitializer], align 16
@.str.4 = private unnamed_addr constant [5 x i8] c"qcif\00", align 1
@.str.5 = private unnamed_addr constant [6 x i8] c"qqvga\00", align 1
@.str.6 = private unnamed_addr constant [5 x i8] c"qvga\00", align 1
@.str.7 = private unnamed_addr constant [4 x i8] c"sif\00", align 1
@.str.8 = private unnamed_addr constant [4 x i8] c"cif\00", align 1
@.str.9 = private unnamed_addr constant [4 x i8] c"vga\00", align 1
@.str.10 = private unnamed_addr constant [4 x i8] c"sd1\00", align 1
@.str.11 = private unnamed_addr constant [4 x i8] c"sd2\00", align 1
@.str.12 = private unnamed_addr constant [4 x i8] c"sd3\00", align 1
@.str.13 = private unnamed_addr constant [5 x i8] c"720p\00", align 1
@.str.14 = private unnamed_addr constant [6 x i8] c"1080p\00", align 1
@.str.17 = private unnamed_addr constant [5 x i8] c"%0*d\00", align 1
@.str.18 = private unnamed_addr constant [4 x i8] c"%*d\00", align 1
@.str.19 = private unnamed_addr constant [36 x i8] c"OpenFrameFile: cannot open file %s\0A\00", align 1
@errortext = external global [300 x i8], align 16
@.str.20 = private unnamed_addr constant [60 x i8] c"No input sequence name was provided. Please check settings.\00", align 1
@.str.21 = private unnamed_addr constant [29 x i8] c"Input file %s does not exist\00", align 1
@.str.22 = private unnamed_addr constant [4 x i8] c"yuv\00", align 1
@.str.23 = private unnamed_addr constant [4 x i8] c"rgb\00", align 1
@.str.24 = private unnamed_addr constant [4 x i8] c"tif\00", align 1
@.str.25 = private unnamed_addr constant [4 x i8] c"avi\00", align 1
...
24:                                               ; preds = %21, %14
  store i8 120, ptr %12, align 1, !tbaa !10
  br label %25
...
33:                                               ; preds = %29
  %34 = load i8, ptr %31, align 1, !tbaa !10
...
40:                                               ; preds = %33
  %41 = load i8, ptr %30, align 1, !tbaa !10
  %42 = icmp eq i8 %41, 0
...
48:                                               ; preds = %44
  ...
  store double %50, ptr %3, align 8, !tbaa !13
...
57:                                               ; preds = %54, %48
  store i8 %49, ptr %46, align 1, !tbaa !10
  br label %25
...
59:                                               ; preds = %10, %44, %25, %7, %4
  %60 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(5) @.str.4) #13
  %61 = icmp eq i32 %60, 0
  br i1 %61, label %62, label %92

62:                                               ; preds = %59
  %63 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(6) @.str.5) #13
  %64 = icmp eq i32 %63, 0
  br i1 %64, label %65, label %92

65:                                               ; preds = %62
  %66 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(5) @.str.6) #13
  %67 = icmp eq i32 %66, 0
  br i1 %67, label %68, label %92

68:                                               ; preds = %65
  %69 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(4) @.str.7) #13
  %70 = icmp eq i32 %69, 0
  br i1 %70, label %71, label %92

71:                                               ; preds = %68
  %72 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(4) @.str.8) #13
  %73 = icmp eq i32 %72, 0
  br i1 %73, label %74, label %92

74:                                               ; preds = %71
  %75 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(4) @.str.9) #13
  %76 = icmp eq i32 %75, 0
  br i1 %76, label %77, label %92

77:                                               ; preds = %74
  %78 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(4) @.str.10) #13
  %79 = icmp eq i32 %78, 0
  br i1 %79, label %80, label %92

80:                                               ; preds = %77
  %81 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(4) @.str.11) #13
  %82 = icmp eq i32 %81, 0
  br i1 %82, label %83, label %92

83:                                               ; preds = %80
  %84 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(4) @.str.12) #13
  %85 = icmp eq i32 %84, 0
  br i1 %85, label %86, label %92

86:                                               ; preds = %83
  %87 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(5) @.str.13) #13
  %88 = icmp eq i32 %87, 0
  br i1 %88, label %89, label %92

89:                                               ; preds = %86
  %90 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(6) @.str.14) #13
  %91 = icmp eq i32 %90, 0
...
28:                                               ; preds = %22
  %29 = load i8, ptr %18, align 1, !tbaa !10
  %30 = icmp eq i8 %29, 0
...
31:                                               ; preds = %28, %22
  ...
  br i1 %33, label %40, label %10, !llvm.loop !18
...
define dso_local void @OpenFrameFile(ptr nocapture noundef %0, i32 noundef %1) local_unnamed_addr #5 {
  ...
  %16 = select i1 %13, ptr @.str.18, ptr @.str.17
...
33:                                               ; preds = %2
  %34 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, ptr noundef nonnull %3)
...
9:                                                ; preds = %5
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(60) @errortext, ptr noundef nonnull align 1 dereferenceable(60) @.str.20, i64 60, i1 false)
...
14:                                               ; preds = %10
  %15 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.21, ptr noundef nonnull %0) #12
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #12
  br label %16
...
define dso_local i32 @ParseVideoType(ptr nocapture noundef %0) local_unnamed_addr #9 {
  ...
  %7 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(4) @.str.22) #13
  %8 = icmp eq i32 %7, 0
...
13:                                               ; preds = %1
  %14 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(4) @.str.23) #13
  %15 = icmp eq i32 %14, 0
...
16:                                               ; preds = %13
  ...
  store i32 3, ptr %18, align 8, !tbaa !27
  %19 = getelementptr inbounds %struct.video_data_file, ptr %0, i64 0, i32 17
  store ptr null, ptr %19, align 8, !tbaa !28
  br label %34

20:                                               ; preds = %13
  %21 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(4) @.str.24) #13
  %22 = icmp eq i32 %21, 0
...
26:                                               ; preds = %20
  %27 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(4) @.str.25) #13
  %28 = icmp eq i32 %27, 0
  %29 = getelementptr inbounds %struct.video_data_file, ptr %0, i64 0, i32 4
  br i1 %28, label %30, label %31

30:                                               ; preds = %26
  store i32 4, ptr %29, align 4, !tbaa !20
  br label %34
...
!14 = !{!"double", !8, i64 0}
!15 = !{!16, !7, i64 8}
!16 = !{!"video_size", !12, i64 0, !7, i64 8, !7, i64 12}
!17 = !{!16, !7, i64 12}
!18 = distinct !{!18, !19}
!19 = !{!"llvm.loop.mustprogress"}
!20 = !{!21, !8, i64 772}
!21 = !{!"video_data_file", !8, i64 0, !8, i64 255, !8, i64 510, !7, i64 768, !8, i64 772, !22, i64 776, !7, i64 912, !7, i64 916, !7, i64 920, !7, i64 924, !7, i64 928, !7, i64 932, !7, i64 936, !7, i64 940, !7, i64 944, !7, i64 948, !7, i64 952, !12, i64 960}
!22 = !{!"frame_format", !8, i64 0, !8, i64 4, !14, i64 8, !8, i64 16, !8, i64 28, !7, i64 40, !7, i64 44, !7, i64 48, !7, i64 52, !7, i64 56, !7, i64 60, !7, i64 64, !7, i64 68, !8, i64 72, !7, i64 84, !8, i64 88, !8, i64 100, !8, i64 112, !7, i64 124, !7, i64 128}
!23 = !{!21, !7, i64 920}
!24 = !{!21, !7, i64 924}
!25 = !{!21, !7, i64 768}
!26 = !{!21, !7, i64 912}
