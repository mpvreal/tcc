...
64:                                               ; preds = %57
  %65 = load i32, ptr %62, align 8, !tbaa !29
  %66 = icmp eq i32 %65, 1
...
107:                                              ; preds = %105, %101
  ...
  %109 = call fastcc zeroext i8 @same_phi_args_p(ptr noundef nonnull %70, ptr noundef nonnull %23, ptr noundef %108), !range !36
  %110 = icmp eq i8 %109, 0
  br i1 %110, label %385, label %111

111:                                              ; preds = %107
  %112 = getelementptr inbounds %struct.basic_block_def, ptr %23, i64 0, i32 13
  %113 = load i32, ptr %112, align 8, !tbaa !37, !noalias !38
  %114 = and i32 %113, 512
...
116:                                              ; preds = %111
  ...
  %118 = load ptr, ptr %117, align 8, !tbaa !16, !noalias !38
  %119 = icmp eq ptr %118, null
  br i1 %119, label %145, label %120

120:                                              ; preds = %116
  %121 = load ptr, ptr %118, align 8, !tbaa !41, !noalias !38
  %122 = icmp eq ptr %121, null
  br i1 %122, label %145, label %123

123:                                              ; preds = %120
  %124 = load ptr, ptr %121, align 8, !tbaa !43, !noalias !38
...
141:                                              ; preds = %137, %136
  ...
  br i1 %144, label %145, label %126, !llvm.loop !48
...
159:                                              ; preds = %155
  %160 = call fastcc zeroext i8 @recognize_single_bit_test(ptr noundef nonnull %146, ptr noundef nonnull %7, ptr noundef nonnull %9), !range !36
  %161 = icmp eq i8 %160, 0
  br i1 %161, label %216, label %162

162:                                              ; preds = %159
  %163 = call fastcc zeroext i8 @recognize_single_bit_test(ptr noundef nonnull %153, ptr noundef nonnull %8, ptr noundef nonnull %10), !range !36
...
169:                                              ; preds = %165
  ...
  %182 = load ptr, ptr %170, align 8, !tbaa !16
  ...
  %185 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 47), align 8, !tbaa !5
...
195:                                              ; preds = %189, %194
  %196 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 26), align 16, !tbaa !5
...
311:                                              ; preds = %307
  ...
  %315 = lshr i32 %314, 16
  %316 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 47), align 8, !tbaa !5
  %317 = and i32 %314, 255
...
368:                                              ; preds = %362, %367
  %369 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 26), align 16, !tbaa !5
...
385:                                              ; preds = %137, %126, %107, %105, %97, %92, %77
  %386 = load ptr, ptr %71, align 8, !tbaa !27
  %387 = icmp eq ptr %386, null
  br i1 %387, label %751, label %388

388:                                              ; preds = %385
  %389 = load i32, ptr %386, align 8, !tbaa !29
...
391:                                              ; preds = %388
  ...
  %403 = load i32, ptr %402, align 8, !tbaa !31
...
428:                                              ; preds = %425, %421
  ...
  %430 = call fastcc zeroext i8 @same_phi_args_p(ptr noundef nonnull %70, ptr noundef nonnull %23, ptr noundef %429), !range !36
  %431 = icmp eq i8 %430, 0
  br i1 %431, label %751, label %432

432:                                              ; preds = %428
  %433 = getelementptr inbounds %struct.basic_block_def, ptr %23, i64 0, i32 13
  %434 = load i32, ptr %433, align 8, !tbaa !37, !noalias !50
  %435 = and i32 %434, 512
...
437:                                              ; preds = %432
  ...
  %439 = load ptr, ptr %438, align 8, !tbaa !16, !noalias !50
  %440 = icmp eq ptr %439, null
  br i1 %440, label %466, label %441

441:                                              ; preds = %437
  %442 = load ptr, ptr %439, align 8, !tbaa !41, !noalias !50
  %443 = icmp eq ptr %442, null
  br i1 %443, label %466, label %444

444:                                              ; preds = %441
  %445 = load ptr, ptr %442, align 8, !tbaa !43, !noalias !50
...
462:                                              ; preds = %458, %457
  ...
  br i1 %465, label %466, label %447, !llvm.loop !48
...
480:                                              ; preds = %476
  %481 = call fastcc zeroext i8 @recognize_bits_test(ptr noundef nonnull %467, ptr noundef nonnull %1, ptr noundef nonnull %3), !range !36
  %482 = icmp eq i8 %481, 0
  br i1 %482, label %582, label %483

483:                                              ; preds = %480
  %484 = call fastcc zeroext i8 @recognize_bits_test(ptr noundef nonnull %474, ptr noundef nonnull %2, ptr noundef nonnull %4), !range !36
  %485 = icmp eq i8 %484, 0
  br i1 %485, label %582, label %486

486:                                              ; preds = %483
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %5) #14
  %487 = load ptr, ptr %1, align 8, !tbaa !5
  %488 = load ptr, ptr %2, align 8, !tbaa !5
  %489 = icmp eq ptr %487, %488
  %490 = load ptr, ptr %3, align 8, !tbaa !5
  %491 = load ptr, ptr %4, align 8, !tbaa !5
...
513:                                              ; preds = %498
  ...
  %519 = load ptr, ptr %507, align 8, !tbaa !16
  ...
  %522 = load ptr, ptr %516, align 8, !tbaa !16
...
524:                                              ; preds = %498
  ...
  %530 = load ptr, ptr %502, align 8, !tbaa !16
  ...
  %533 = load ptr, ptr %527, align 8, !tbaa !16
...
535:                                              ; preds = %524, %513
  ...
  %543 = load ptr, ptr %539, align 8, !tbaa !16
  ...
  %546 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 47), align 8, !tbaa !5
...
559:                                              ; preds = %558, %553
  %560 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 25), align 8, !tbaa !5
...
566:                                              ; preds = %565, %559
  %567 = load ptr, ptr @dump_file, align 8, !tbaa !5
...
569:                                              ; preds = %566
  ...
  %577 = load ptr, ptr @dump_file, align 8, !tbaa !5
...
600:                                              ; preds = %596
  ...
  %606 = load i64, ptr %605, align 8, !tbaa !49
...
677:                                              ; preds = %673
  ...
  %681 = lshr i32 %680, 16
  %682 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 47), align 8, !tbaa !5
  %683 = and i32 %680, 255
...
734:                                              ; preds = %728, %733
  %735 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 25), align 8, !tbaa !5
...
754:                                              ; preds = %751, %26, %19
  ...
  %757 = load ptr, ptr @cfun, align 8, !tbaa !5
  ...
  %761 = load i32, ptr %760, align 8, !tbaa !25
  %762 = add nsw i32 %761, -2
  %763 = sext i32 %762 to i64
  %764 = icmp slt i64 %756, %763
  br i1 %764, label %19, label %765, !llvm.loop !53
...
define internal fastcc zeroext i8 @same_phi_args_p(ptr noundef %0, ptr noundef %1, ptr noundef %2) unnamed_addr #10 {
  ...
  %7 = load ptr, ptr %4, align 8, !tbaa.struct !54
...
37:                                               ; preds = %30
  ...
  br i1 %40, label %41, label %12, !llvm.loop !58
...
293:                                              ; preds = %292, %280
  ...
  br i1 %301, label %155, label %302, !llvm.loop !59
...
307:                                              ; preds = %302
  %308 = tail call fastcc i32 @gimple_assign_rhs_code(ptr noundef nonnull %304), !range !60
...
399:                                              ; preds = %395
  ...
  store ptr %400, ptr %1, align 8, !tbaa !5
  %401 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @integer_types, i64 0, i64 5), align 8, !tbaa !5
  ...
  store ptr %405, ptr %2, align 8, !tbaa !5
  br label %500
...
441:                                              ; preds = %438
  ...
  %451 = load i64, ptr %450, align 8, !tbaa !49
...
473:                                              ; preds = %466
  %474 = tail call fastcc i32 @gimple_assign_rhs_code(ptr noundef nonnull %469), !range !60
...
480:                                              ; preds = %476
  ...
  store ptr %481, ptr %1, align 8, !tbaa !5
  %482 = tail call fastcc ptr @gimple_assign_rhs2(ptr noundef nonnull %469)
  store ptr %482, ptr %2, align 8, !tbaa !5
  br label %500
...
490:                                              ; preds = %483
  %491 = tail call fastcc i32 @gimple_assign_rhs_code(ptr noundef nonnull %486), !range !60
...
497:                                              ; preds = %493
  ...
  store ptr %498, ptr %1, align 8, !tbaa !5
  %499 = tail call fastcc ptr @gimple_assign_rhs2(ptr noundef nonnull %486)
  store ptr %499, ptr %2, align 8, !tbaa !5
  br label %500
...
21:                                               ; preds = %10
  %22 = load i32, ptr @flag_var_tracking_assignments, align 4, !tbaa !20
  %23 = icmp eq i32 %22, 0
...
120:                                              ; preds = %102, %116
  ...
  store ptr %122, ptr %1, align 8, !tbaa !5
...
!55 = !{!32, !11, i64 44}
!56 = !{!57, !6, i64 24}
!57 = !{!"ssa_use_operand_d", !6, i64 0, !6, i64 8, !7, i64 16, !6, i64 24}
!58 = distinct !{!58, !22}
!59 = distinct !{!59, !22}
!60 = !{i32 0, i32 65536}
!61 = !{!57, !6, i64 8}
