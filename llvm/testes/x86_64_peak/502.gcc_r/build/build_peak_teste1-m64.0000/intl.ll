...
@open_quote = dso_local local_unnamed_addr global ptr @.str, align 8
@close_quote = dso_local local_unnamed_addr global ptr @.str, align 8
@locale_encoding = dso_local local_unnamed_addr global ptr null, align 8
@locale_utf8 = dso_local local_unnamed_addr global i8 0, align 1
...
define dso_local ptr @fake_ngettext(ptr noundef readnone %0, ptr noundef readnone %1, i64 noundef %2) local_unnamed_addr #8 {
  %4 = icmp eq i64 %2, 1
...
define dso_local ptr @get_spaces(ptr nocapture noundef readonly %0) local_unnamed_addr #9 {
  %2 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0)
  %3 = add i64 %2, 1
  %4 = tail call ptr @xmalloc(i64 noundef %3) #12
  tail call void @llvm.memset.p0.i64(ptr align 1 %4, i8 32, i64 %2, i1 false)
