...
define dso_local void @ix86_target_macros() local_unnamed_addr #8 {
  ...
  %4 = load i32, ptr @ix86_arch, align 4, !tbaa !16
  %5 = load i32, ptr @ix86_tune, align 4, !tbaa !16
...
define dso_local void @ix86_register_pragmas() local_unnamed_addr #9 {
  store ptr @ix86_pragma_target_parse, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 107, i32 4), align 8, !tbaa !23
  ret void
}
...
13:                                               ; preds = %10, %5
  ...
  store ptr %14, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 128), align 16, !tbaa !5
  ...
  %25 = load i8, ptr %24, align 4, !tbaa !37
  ...
  %39 = load ptr, ptr @ix86_tune_string, align 8, !tbaa !5
...
57:                                               ; preds = %13
  ...
  %59 = load ptr, ptr @parse_in, align 8, !tbaa !5
  ...
  %61 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
62:                                               ; preds = %13
  ...
  %64 = load ptr, ptr @parse_in, align 8, !tbaa !5
  tail call void @cpp_undef(ptr noundef %64, ptr noundef nonnull @.str.15) #11
  br label %108

65:                                               ; preds = %13
  %66 = load ptr, ptr @ix86_arch_string, align 8, !tbaa !5
  ...
  %72 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
73:                                               ; preds = %65
  %74 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
95:                                               ; preds = %13
  %96 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
104:                                              ; preds = %13
  %105 = load ptr, ptr @parse_in, align 8, !tbaa !5
  tail call void @cpp_undef(ptr noundef %105, ptr noundef nonnull @.str.33) #11
  %106 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
117:                                              ; preds = %114
  %118 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
120:                                              ; preds = %108
  %121 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
126:                                              ; preds = %108
  %127 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
142:                                              ; preds = %139
  %143 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
147:                                              ; preds = %144
  %148 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
152:                                              ; preds = %149
  %153 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
157:                                              ; preds = %154
  %158 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
162:                                              ; preds = %159
  %163 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
167:                                              ; preds = %164
  %168 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
172:                                              ; preds = %169
  %173 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
177:                                              ; preds = %174
  %178 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
182:                                              ; preds = %179
  %183 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
187:                                              ; preds = %184
  %188 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
192:                                              ; preds = %189
  %193 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
197:                                              ; preds = %194
  %198 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
202:                                              ; preds = %199
  %203 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
207:                                              ; preds = %204
  %208 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
212:                                              ; preds = %209
  %213 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
217:                                              ; preds = %214
  %218 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
222:                                              ; preds = %219
  %223 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
227:                                              ; preds = %224
  %228 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
232:                                              ; preds = %229
  %233 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
238:                                              ; preds = %234
  %239 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
242:                                              ; preds = %240
  %243 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
define internal fastcc void @ix86_target_macros_internal.79(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) unnamed_addr #8 {
  %5 = load ptr, ptr @ix86_tune_string, align 8, !tbaa !5
...
23:                                               ; preds = %4
  ...
  %25 = load ptr, ptr @parse_in, align 8, !tbaa !5
  ...
  %27 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
41:                                               ; preds = %31
  %42 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
61:                                               ; preds = %4
  %62 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
64:                                               ; preds = %4
  %65 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
67:                                               ; preds = %4
  %68 = load ptr, ptr @parse_in, align 8, !tbaa !5
  tail call void @cpp_define(ptr noundef %68, ptr noundef nonnull @.str.31) #11
  %69 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
76:                                               ; preds = %74
  %77 = load ptr, ptr @parse_in, align 8, !tbaa !5
  tail call void @cpp_define(ptr noundef %77, ptr noundef nonnull @.str.39) #11
  %78 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
80:                                               ; preds = %74
  ...
  %82 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
86:                                               ; preds = %74
  %87 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
102:                                              ; preds = %92, %89, %86, %80, %83, %76, %74, %75, %85, %88, %96, %97, %98, %99, %100, %101
  ...
  %104 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
118:                                              ; preds = %115
  %119 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
123:                                              ; preds = %120
  %124 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
128:                                              ; preds = %125
  %129 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
133:                                              ; preds = %130
  %134 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
138:                                              ; preds = %135
  %139 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
143:                                              ; preds = %140
  %144 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
148:                                              ; preds = %145
  %149 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
153:                                              ; preds = %150
  %154 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
158:                                              ; preds = %155
  %159 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
163:                                              ; preds = %160
  %164 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
168:                                              ; preds = %165
  %169 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
173:                                              ; preds = %170
  %174 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
178:                                              ; preds = %175
  %179 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
183:                                              ; preds = %180
  %184 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
188:                                              ; preds = %185
  %189 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
193:                                              ; preds = %190
  %194 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
198:                                              ; preds = %195
  %199 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
204:                                              ; preds = %200
  %205 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
208:                                              ; preds = %206
  %209 = load ptr, ptr @parse_in, align 8, !tbaa !5
...
!35 = !{!36, !11, i64 12}
!36 = !{!"cl_target_option", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !7, i64 16, !7, i64 17, !7, i64 18, !7, i64 19, !7, i64 20, !7, i64 21, !7, i64 22}
!37 = !{!36, !7, i64 16}
!38 = !{!36, !7, i64 21}
!39 = !{!36, !7, i64 19}
