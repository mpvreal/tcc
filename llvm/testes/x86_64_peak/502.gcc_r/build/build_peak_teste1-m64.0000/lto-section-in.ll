...
10:                                               ; preds = %7, %1
  ...
  %13 = add i32 %11, 1
  store i32 %13, ptr %2, align 8, !tbaa !23
...
14:                                               ; preds = %5, %11
  ...
  %17 = add i32 %15, 1
  store i32 %17, ptr %2, align 8, !tbaa !23
...
define dso_local void @lto_set_in_hooks(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #10 {
  store ptr %0, ptr @file_decl_data, align 8, !tbaa !5
  store ptr %1, ptr @get_section_f, align 8, !tbaa !5
  store ptr %2, ptr @free_section_f, align 8, !tbaa !5
  ret void
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local ptr @lto_get_file_decl_data() local_unnamed_addr #9 {
  %1 = load ptr, ptr @file_decl_data, align 8, !tbaa !5
  %2 = icmp eq ptr %1, null
  br i1 %2, label %3, label %5

3:                                                ; preds = %0
  tail call void @fancy_abort(ptr noundef nonnull @.str.10, i32 noundef 166, ptr noundef nonnull @.str.11) #17
  %4 = load ptr, ptr @file_decl_data, align 8, !tbaa !5
  br label %5
...
define dso_local ptr @lto_get_section_data(ptr noundef %0, i32 noundef %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #9 {
  %5 = load ptr, ptr @get_section_f, align 8, !tbaa !5
...
define dso_local void @lto_free_section_data(ptr noundef %0, i32 noundef %1, ptr noundef %2, ptr noundef %3, i64 noundef %4) local_unnamed_addr #9 {
  ...
  %7 = load ptr, ptr @free_section_f, align 8, !tbaa !5
...
10:                                               ; preds = %5, %9
  %11 = load i32, ptr @flag_ltrans, align 4, !tbaa !20
  %12 = icmp eq i32 %11, 0
  %13 = load ptr, ptr @free_section_f, align 8, !tbaa !5
...
9:                                                ; preds = %5
  tail call void @fancy_abort(ptr noundef nonnull @.str.10, i32 noundef 269, ptr noundef nonnull @.str.11) #17
  %10 = load ptr, ptr @free_section_f, align 8, !tbaa !5
  br label %11

11:                                               ; preds = %9, %5
  %12 = phi ptr [ %10, %9 ], [ %7, %5 ]
  %13 = load i32, ptr @flag_ltrans, align 4, !tbaa !20
  %14 = icmp eq i32 %13, 0
...
define dso_local i32 @lto_eq_in_decl_state(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #15 {
  %3 = getelementptr inbounds %struct.lto_in_decl_state, ptr %0, i64 0, i32 1
  %4 = load ptr, ptr %3, align 8, !tbaa !41
...
!23 = !{!24, !11, i64 8}
!24 = !{!"lto_input_block", !6, i64 0, !11, i64 8, !11, i64 12}
!25 = !{!24, !11, i64 12}
!26 = !{!24, !6, i64 0}
!27 = !{!12, !12, i64 0}
!28 = !{!29, !6, i64 0}
!29 = !{!"lto_data_header", !6, i64 0, !12, i64 8}
!30 = !{!29, !12, i64 8}
!31 = !{!32, !11, i64 8}
!32 = !{!"lto_simple_header", !33, i64 0, !11, i64 8, !11, i64 12}
!33 = !{!"lto_header", !13, i64 0, !13, i64 2, !7, i64 4}
!34 = !{!35, !6, i64 8}
!35 = !{!"lto_renaming_slot", !6, i64 0, !6, i64 8}
!36 = !{!35, !6, i64 0}
!37 = !{!38, !6, i64 56}
!38 = !{!"lto_file_decl_data", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !11, i64 40, !6, i64 48, !6, i64 56}
!39 = !{!40, !6, i64 0}
!40 = !{!"lto_tree_ref_table", !6, i64 0, !11, i64 8}
!41 = !{!42, !6, i64 112}
!42 = !{!"lto_in_decl_state", !7, i64 0, !6, i64 112}
!43 = !{!38, !6, i64 24}
