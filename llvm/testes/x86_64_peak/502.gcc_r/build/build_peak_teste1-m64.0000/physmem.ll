...
define dso_local nofpclass(nan inf) double @physmem_total() local_unnamed_addr #5 {
  %1 = tail call i64 @sysconf(i32 noundef 85) #6
  %2 = tail call i64 @sysconf(i32 noundef 30) #6
  %3 = icmp slt i64 %1, 0
  %4 = icmp slt i64 %2, 0
  ...
  %9 = select i1 %5, double 0.000000e+00, double %8
  ret double %9
}
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local nofpclass(nan inf) double @physmem_available() local_unnamed_addr #5 {
  %1 = tail call i64 @sysconf(i32 noundef 86) #6
  %2 = tail call i64 @sysconf(i32 noundef 30) #6
  %3 = icmp slt i64 %1, 0
  %4 = icmp slt i64 %2, 0
  %5 = select i1 %3, i1 true, i1 %4
...
9:                                                ; preds = %0
  %10 = tail call i64 @sysconf(i32 noundef 85) #6
  %11 = tail call i64 @sysconf(i32 noundef 30) #6
  %12 = icmp slt i64 %10, 0
  %13 = icmp slt i64 %11, 0
  %14 = select i1 %12, i1 true, i1 %13
  %15 = sitofp i64 %11 to double
  %16 = sitofp i64 %10 to double
  %17 = fmul fast double %16, 2.500000e-01
  %18 = fmul fast double %17, %15
  %19 = select i1 %14, double 0.000000e+00, double %18
  br label %20

20:                                               ; preds = %0, %9
  %21 = phi double [ %8, %0 ], [ %19, %9 ]
  ret double %21
}
