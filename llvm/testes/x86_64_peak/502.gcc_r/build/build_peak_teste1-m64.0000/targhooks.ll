...
define dso_local void @default_external_libcall(ptr nocapture noundef readonly %0) local_unnamed_addr #8 {
  %2 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 6), align 8, !tbaa !23
...
18:                                               ; preds = %6
  %19 = load i32, ptr @flag_trapping_math, align 4, !tbaa !20
  %20 = icmp eq i32 %19, 0
...
26:                                               ; preds = %32
  ...
  br i1 %31, label %32, label %39, !llvm.loop !37
...
define dso_local ptr @default_expand_builtin_saveregs() local_unnamed_addr #8 {
  ...
  %1 = load ptr, ptr getelementptr inbounds ([129 x ptr], ptr @const_int_rtx, i64 0, i64 64), align 16, !tbaa !5
  ret ptr %1
}
...
define dso_local ptr @default_builtin_setjmp_frame_value() local_unnamed_addr #10 {
  %1 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 7), align 8, !tbaa !5
  ret ptr %1
}
...
define dso_local zeroext i8 @default_pretend_outgoing_varargs_named(ptr nocapture noundef readnone %0) local_unnamed_addr #10 {
  %2 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 88, i32 7), align 8, !tbaa !38
...
define dso_local i32 @default_eh_return_filter_mode() local_unnamed_addr #8 {
  %1 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 10), align 8, !tbaa !39
...
define dso_local i32 @default_libgcc_cmp_return_mode() local_unnamed_addr #10 {
  %1 = load i32, ptr @word_mode, align 4, !tbaa !16
  ret i32 %1
}
...
define dso_local ptr @default_cxx_guard_type() local_unnamed_addr #10 {
  %1 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @integer_types, i64 0, i64 9), align 8, !tbaa !5
  ret ptr %1
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local ptr @default_cxx_get_cookie_size(ptr nocapture noundef readonly %0) local_unnamed_addr #8 {
  %2 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
define dso_local zeroext i8 @hook_pass_by_reference_must_pass_in_stack(ptr nocapture noundef readnone %0, i32 noundef %1, ptr noundef %2, i8 noundef zeroext %3) local_unnamed_addr #8 {
  %5 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 88, i32 11), align 8, !tbaa !40
...
define dso_local ptr @default_stack_protect_guard() local_unnamed_addr #8 {
  %1 = load ptr, ptr @stack_chk_guard_decl, align 8, !tbaa !5
  %2 = icmp eq ptr %1, null
  br i1 %2, label %3, label %12

3:                                                ; preds = %0
  %4 = tail call ptr @get_identifier(ptr noundef nonnull @.str.5) #15
  %5 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 39), align 8, !tbaa !5
  ...
  store ptr %6, ptr @stack_chk_guard_decl, align 8, !tbaa !5
  br label %12
...
define dso_local ptr @default_external_stack_protect_fail() local_unnamed_addr #8 {
  %1 = load ptr, ptr @stack_chk_fail_decl, align 8, !tbaa !5
  %2 = icmp eq ptr %1, null
  br i1 %2, label %3, label %17

3:                                                ; preds = %0
  %4 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 38), align 16, !tbaa !5
  ...
  store ptr %7, ptr @stack_chk_fail_decl, align 8, !tbaa !5
  br label %17
...
3:                                                ; preds = %0
  %4 = load i32, ptr @flag_pic, align 4, !tbaa !20
  %5 = icmp eq i32 %4, 0
  %6 = select i1 %5, i32 4096, i32 6144
  %7 = select i1 %5, ptr @.str.6, ptr @.str.7
  %8 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 38), align 16, !tbaa !5
  ...
  store ptr %11, ptr @stack_chk_fail_decl, align 8, !tbaa !5
  br label %21
...
define dso_local ptr @default_internal_arg_pointer() local_unnamed_addr #8 {
  %1 = load i8, ptr getelementptr inbounds ([53 x i8], ptr @fixed_regs, i64 0, i64 16), align 16, !tbaa !16
  %2 = icmp eq i8 %1, 0
  %3 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @global_rtl, i64 0, i64 6), align 16, !tbaa !5
...
define dso_local i32 @default_reloc_rw_mask() local_unnamed_addr #10 {
  %1 = load i32, ptr @flag_pic, align 4, !tbaa !20
  %2 = icmp eq i32 %1, 0
...
4:                                                ; preds = %2
  %5 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 57), align 8, !tbaa !48
  %6 = tail call i32 %5(i8 noundef zeroext %1) #15
  %7 = icmp eq i32 %6, %0
  br i1 %7, label %16, label %8

8:                                                ; preds = %4
  %9 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 57, i32 1), align 8, !tbaa !49
...
13:                                               ; preds = %2
  %14 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 56), align 8, !tbaa !50
...
define dso_local zeroext i8 @target_default_pointer_address_modes_p() local_unnamed_addr #10 {
  %1 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 57, i32 1), align 8, !tbaa !49
...
7:                                                ; preds = %6, %4
  %8 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 41), align 8, !tbaa !51
...
6:                                                ; preds = %4
  %7 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 39), align 8, !tbaa !52
...
!41 = !{!13, !13, i64 0}
!42 = !{!43, !6, i64 8}
!43 = !{!"secondary_reload_info", !11, i64 0, !11, i64 4, !6, i64 8, !11, i64 16}
!44 = !{!43, !11, i64 16}
!45 = !{!43, !11, i64 0}
!46 = !{!47, !7, i64 0}
!47 = !{!"optab_handlers", !7, i64 0}
!48 = !{!24, !6, i64 1176}
!49 = !{!24, !6, i64 1184}
!50 = !{!24, !6, i64 1168}
!51 = !{!24, !6, i64 1048}
