...
define dso_local ptr @getpwd() local_unnamed_addr #8 {
  ...
  %3 = load ptr, ptr @getpwd.pwd, align 8, !tbaa !7
...
5:                                                ; preds = %0
  %6 = load i32, ptr @getpwd.failure_errno, align 4, !tbaa !22
...
35:                                               ; preds = %40
  ...
  br i1 %39, label %40, label %48, !llvm.loop !27
...
46:                                               ; preds = %40
  store i32 %44, ptr @getpwd.failure_errno, align 4, !tbaa !22
  %47 = tail call ptr @__errno_location() #11
  store i32 %44, ptr %47, align 4, !tbaa !22
  br label %48

48:                                               ; preds = %35, %31, %46, %27
  %49 = phi ptr [ %10, %27 ], [ null, %46 ], [ %32, %31 ], [ %37, %35 ]
  store ptr %49, ptr @getpwd.pwd, align 8, !tbaa !7
  br label %50
...
!22 = !{!13, !13, i64 0}
!23 = !{!24, !14, i64 8}
!24 = !{!"stat", !14, i64 0, !14, i64 8, !14, i64 16, !13, i64 24, !13, i64 28, !13, i64 32, !13, i64 36, !14, i64 40, !14, i64 48, !14, i64 56, !14, i64 64, !25, i64 72, !25, i64 88, !25, i64 104, !9, i64 120}
