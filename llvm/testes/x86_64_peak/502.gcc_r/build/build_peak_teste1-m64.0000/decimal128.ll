...
44:                                               ; preds = %41
  ...
  store i32 2013265920, ptr %45, align 4, !tbaa !17
  br label %128
...
55:                                               ; preds = %46
  ...
  %56 = load i8, ptr %37, align 4, !tbaa !13
  br label %57
...
63:                                               ; preds = %57
  ...
  store i32 %64, ptr %61, align 4, !tbaa !17
  br label %128

65:                                               ; preds = %57
  %66 = or i32 %62, 2113929216
  store i32 %66, ptr %61, align 4, !tbaa !17
  br label %128
...
116:                                              ; preds = %106, %112, %86
  ...
  %126 = or i32 %123, %125
  store i32 %126, ptr %122, align 4, !tbaa !17
  %127 = load i8, ptr %37, align 4, !tbaa !13
  br label %128
...
133:                                              ; preds = %128
  ...
  store i32 %135, ptr %134, align 4, !tbaa !17
  br label %136

136:                                              ; preds = %133, %128
  %137 = phi i32 [ %135, %133 ], [ %129, %128 ]
  %138 = load <2 x i32>, ptr %6, align 16, !tbaa !17
...
define dso_local ptr @__dpd128ToNumber(ptr nocapture noundef readonly %0, ptr noundef returned %1) local_unnamed_addr #4 {
  ...
  store i32 %4, ptr %3, align 16, !tbaa !17
...
18:                                               ; preds = %2
  ...
  store i8 -128, ptr %19, align 4, !tbaa !13
  br label %20
...
29:                                               ; preds = %27
  ...
  %32 = or i8 %31, 64
  store i8 %32, ptr %30, align 4, !tbaa !13
  br label %64
...
33:                                               ; preds = %27
  ...
  %39 = or i8 %37, %38
  store i8 %39, ptr %36, align 4, !tbaa !13
  %40 = and i32 %12, 16383
...
30:                                               ; preds = %27
  ...
  store i8 115, ptr %14, align 1, !tbaa !20
  br label %32
...
70:                                               ; preds = %53
  %71 = load i8, ptr %64, align 4, !tbaa !20
  %72 = icmp eq i8 %71, 0
...
97:                                               ; preds = %80
  %98 = load i8, ptr %91, align 4, !tbaa !20
  %99 = icmp eq i8 %98, 0
...
122:                                              ; preds = %107
  %123 = load i8, ptr %116, align 4, !tbaa !20
...
147:                                              ; preds = %132
  %148 = load i8, ptr %141, align 4, !tbaa !20
...
174:                                              ; preds = %157
  %175 = load i8, ptr %168, align 4, !tbaa !20
...
184:                                              ; preds = %174, %177, %170
  ...
  %190 = load i16, ptr %189, align 2, !tbaa !18
...
199:                                              ; preds = %184
  %200 = load i8, ptr %193, align 4, !tbaa !20
...
209:                                              ; preds = %199, %202, %195
  ...
  %215 = load i16, ptr %214, align 2, !tbaa !18
...
224:                                              ; preds = %209
  %225 = load i8, ptr %218, align 4, !tbaa !20
...
251:                                              ; preds = %234
  %252 = load i8, ptr %245, align 4, !tbaa !20
...
276:                                              ; preds = %261
  %277 = load i8, ptr %270, align 4, !tbaa !20
...
301:                                              ; preds = %286
  %302 = load i8, ptr %295, align 4, !tbaa !20
...
333:                                              ; preds = %304, %319
  ...
  %335 = load i8, ptr %334, align 4, !tbaa !20
...
347:                                              ; preds = %333, %344
  ...
  store i8 48, ptr %55, align 1, !tbaa !20
  br label %349
...
373:                                              ; preds = %371, %373
  ...
  %376 = load i8, ptr %374, align 1, !tbaa !20
  store i8 %376, ptr %375, align 1, !tbaa !20
  %377 = getelementptr inbounds i8, ptr %374, i64 -1
  %378 = getelementptr inbounds i8, ptr %375, i64 -1
  %379 = icmp ult ptr %377, %369
  br i1 %379, label %380, label %373, !llvm.loop !21

380:                                              ; preds = %373, %371
  %381 = phi ptr [ %350, %371 ], [ %378, %373 ]
  store i8 46, ptr %381, align 1, !tbaa !20
...
386:                                              ; preds = %383
  ...
  store i8 69, ptr %384, align 1, !tbaa !20
  %388 = getelementptr inbounds i8, ptr %384, i64 2
  store i8 43, ptr %387, align 1, !tbaa !20
  %389 = icmp slt i32 %364, 0
  br i1 %389, label %390, label %392

390:                                              ; preds = %386
  store i8 45, ptr %387, align 1, !tbaa !20
...
395:                                              ; preds = %392
  ...
  %400 = load i8, ptr %398, align 4, !tbaa !20
...
406:                                              ; preds = %392
  ...
  store i8 %413, ptr %388, align 1, !tbaa !20
...
423:                                              ; preds = %353
  ...
  store i8 0, ptr %428, align 1, !tbaa !20
...
454:                                              ; preds = %454, %452
  ...
  %461 = load <16 x i8>, ptr %460, align 1, !tbaa !20
  %462 = getelementptr i8, ptr %457, i64 -31
  %463 = load <16 x i8>, ptr %462, align 1, !tbaa !20
  %464 = getelementptr i8, ptr %457, i64 -47
  %465 = load <16 x i8>, ptr %464, align 1, !tbaa !20
  %466 = getelementptr i8, ptr %457, i64 -63
  %467 = load <16 x i8>, ptr %466, align 1, !tbaa !20
  %468 = getelementptr i8, ptr %459, i64 -15
  store <16 x i8> %461, ptr %468, align 1, !tbaa !20
  %469 = getelementptr i8, ptr %459, i64 -31
  store <16 x i8> %463, ptr %469, align 1, !tbaa !20
  %470 = getelementptr i8, ptr %459, i64 -47
  store <16 x i8> %465, ptr %470, align 1, !tbaa !20
  %471 = getelementptr i8, ptr %459, i64 -63
  store <16 x i8> %467, ptr %471, align 1, !tbaa !20
  %472 = add nuw i64 %455, 64
  %473 = icmp eq i64 %472, %453
  br i1 %473, label %474, label %454, !llvm.loop !22
...
492:                                              ; preds = %492, %483
  ...
  %497 = load <8 x i8>, ptr %496, align 1, !tbaa !20
  %498 = getelementptr i8, ptr %491, i64 %495
  store <8 x i8> %497, ptr %498, align 1, !tbaa !20
  %499 = add nuw i64 %493, 8
  %500 = icmp eq i64 %499, %485
  br i1 %500, label %501, label %492, !llvm.loop !25
...
516:                                              ; preds = %513
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %517, i8 48, i64 %520, i1 false), !tbaa !20
  br label %521
...
define dso_local ptr @decimal128FromNumber(ptr noundef returned %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #4 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !27
