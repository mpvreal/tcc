...
define dso_local ptr @addr_for_mem_ref(ptr nocapture noundef readonly %0, i8 noundef zeroext %1, i8 noundef zeroext %2) local_unnamed_addr #9 {
  ...
  %5 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 57, i32 1), align 8, !tbaa !23
...
75:                                               ; preds = %73, %66
  ...
  store ptr %79, ptr @mem_addr_template_list, align 8, !tbaa !5
...
81:                                               ; preds = %66, %75
  ...
  store i32 %82, ptr %85, align 8, !tbaa !41
...
104:                                              ; preds = %98, %101
  ...
  %106 = load ptr, ptr %45, align 8, !tbaa !39
...
124:                                              ; preds = %123
  ...
  store ptr %21, ptr %126, align 8, !tbaa !5
  br label %127
...
128:                                              ; preds = %127
  ...
  store ptr %36, ptr %130, align 8, !tbaa !5
  br label %154
...
134:                                              ; preds = %131
  %135 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
58:                                               ; preds = %55
  ...
  store ptr %59, ptr %6, align 8, !tbaa !5
...
70:                                               ; preds = %67
  %71 = load ptr, ptr getelementptr inbounds ([129 x ptr], ptr @const_int_rtx, i64 0, i64 64), align 16, !tbaa !5
...
52:                                               ; preds = %50
  %53 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
62:                                               ; preds = %57, %52, %43, %37, %28
  ...
  br i1 %64, label %74, label %28, !llvm.loop !53
...
74:                                               ; preds = %62, %71, %67
  ...
  %79 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 57, i32 1), align 8, !tbaa !23
  %80 = tail call i32 %79(i8 noundef zeroext %78) #14
  %81 = load i32, ptr %23, align 8, !tbaa !48
  %82 = icmp eq i32 %81, 0
...
118:                                              ; preds = %115
  %119 = load i64, ptr %90, align 8, !tbaa.struct !54
  %120 = load i64, ptr %92, align 8, !tbaa.struct !56
  br label %121
...
121:                                              ; preds = %118, %115, %111, %96, %85
  ...
  %126 = load i32, ptr %23, align 8, !tbaa !48
  %127 = zext i32 %126 to i64
  %128 = icmp ult i64 %125, %127
  br i1 %128, label %85, label %129, !llvm.loop !57
...
133:                                              ; preds = %131, %172
  ...
  %139 = load i64, ptr %138, align 8, !tbaa.struct !54
  %140 = getelementptr inbounds i8, ptr %138, i64 8
  %141 = load i64, ptr %140, align 8, !tbaa.struct !56
...
155:                                              ; preds = %149
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %157, ptr noundef nonnull align 8 dereferenceable(24) %137, i64 24, i1 false), !tbaa.struct !58
  %158 = add i32 %136, 1
  br label %172

159:                                              ; preds = %149, %133
  %160 = phi i32 [ 63, %133 ], [ 64, %149 ]
  %161 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
  %162 = load ptr, ptr %137, align 8, !tbaa !51
  %163 = tail call ptr @fold_convert_loc(i32 noundef 0, ptr noundef %161, ptr noundef %162) #14
  %164 = icmp eq ptr %135, null
  br i1 %164, label %168, label %165

165:                                              ; preds = %159
  %166 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
169:                                              ; preds = %168
  %170 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
172:                                              ; preds = %169, %168, %165, %155
  ...
  %176 = load i32, ptr %23, align 8, !tbaa !48
  %177 = zext i32 %176 to i64
  %178 = icmp ult i64 %175, %177
  br i1 %178, label %133, label %179, !llvm.loop !59

179:                                              ; preds = %172, %131
  %180 = phi i32 [ 0, %131 ], [ %173, %172 ]
  %181 = phi ptr [ null, %131 ], [ %174, %172 ]
  store i32 %180, ptr %23, align 8, !tbaa !48
  store ptr %181, ptr %8, align 8, !tbaa !40
  %182 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
  %183 = tail call ptr @double_int_to_tree(ptr noundef %182, i64 %123, i64 %124) #14
  store ptr %183, ptr %9, align 8, !tbaa !35
  %184 = load i32, ptr %23, align 8, !tbaa !48
  br label %185
...
206:                                              ; preds = %195
  ...
  %211 = load i32, ptr %23, align 8, !tbaa !48
...
212:                                              ; preds = %206, %195
  ...
  br i1 %217, label %195, label %218, !llvm.loop !60
...
224:                                              ; preds = %218
  ...
  %229 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 38), align 16, !tbaa !5
...
261:                                              ; preds = %254, %245
  ...
  br i1 %263, label %276, label %245, !llvm.loop !61
...
270:                                              ; preds = %266
  ...
  %271 = load i32, ptr %23, align 8, !tbaa !48
  br label %272
...
278:                                              ; preds = %276, %316
  ...
  %282 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
293:                                              ; preds = %278
  %294 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
300:                                              ; preds = %297
  %301 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
310:                                              ; preds = %305, %305
  %311 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
316:                                              ; preds = %310, %314, %303, %300
  ...
  %320 = load i32, ptr %23, align 8, !tbaa !48
  %321 = zext i32 %320 to i64
  %322 = icmp ult i64 %319, %321
  br i1 %322, label %278, label %323, !llvm.loop !62

323:                                              ; preds = %316
  store ptr %318, ptr %8, align 8, !tbaa !40
  store ptr %317, ptr %7, align 8, !tbaa !39
  br label %324
...
339:                                              ; preds = %337
  store ptr %332, ptr %7, align 8, !tbaa !39
  br label %353
...
345:                                              ; preds = %340, %340
  %346 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
351:                                              ; preds = %349, %345
  ...
  store ptr %352, ptr %7, align 8, !tbaa !39
  br label %353
...
357:                                              ; preds = %353
  ...
  store ptr %358, ptr %7, align 8, !tbaa !39
  br label %359
...
361:                                              ; preds = %359
  ...
  store ptr %362, ptr %8, align 8, !tbaa !40
  br label %363
...
372:                                              ; preds = %369
  %373 = load ptr, ptr %8, align 8, !tbaa !40
...
376:                                              ; preds = %372, %375
  %377 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
  ...
  store ptr %379, ptr %8, align 8, !tbaa !40
...
385:                                              ; preds = %382
  %386 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
394:                                              ; preds = %391
  %395 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
401:                                              ; preds = %394, %400
  %402 = load ptr, ptr %8, align 8, !tbaa !40
...
404:                                              ; preds = %401
  ...
  %407 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
411:                                              ; preds = %401
  store ptr %392, ptr %8, align 8, !tbaa !40
  br label %412

412:                                              ; preds = %391, %404, %411
  %413 = phi ptr [ %410, %404 ], [ %387, %411 ], [ %387, %391 ]
  store ptr %413, ptr %7, align 8, !tbaa !39
...
427:                                              ; preds = %419, %422
  ...
  store ptr %428, ptr %7, align 8, !tbaa !39
...
431:                                              ; preds = %427, %416
  %432 = load ptr, ptr %22, align 8, !tbaa !37
...
440:                                              ; preds = %437
  ...
  %443 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
447:                                              ; preds = %437, %440
  ...
  store ptr %448, ptr %7, align 8, !tbaa !39
...
451:                                              ; preds = %447, %434, %431
  %452 = load ptr, ptr %6, align 8, !tbaa !38
...
455:                                              ; preds = %451, %454
  %456 = load ptr, ptr %8, align 8, !tbaa !40
...
466:                                              ; preds = %459, %462, %465
  %467 = load ptr, ptr %22, align 8, !tbaa !37
...
43:                                               ; preds = %40, %42, %33
  ...
  %50 = load ptr, ptr %26, align 8, !tbaa !35
...
define dso_local void @get_address_description(ptr nocapture noundef readonly %0, ptr nocapture noundef writeonly %1) local_unnamed_addr #10 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(argmem: readwrite) uwtable
define dso_local void @copy_mem_ref_info(ptr nocapture noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #10 {
...
define dso_local ptr @maybe_fold_tmr(ptr nocapture noundef readonly %0) local_unnamed_addr #9 {
  ...
  %7 = load <4 x ptr>, ptr %3, align 8, !tbaa !16
  store <4 x ptr> %7, ptr %2, align 8, !tbaa !5
...
19:                                               ; preds = %17
  %20 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
37:                                               ; preds = %34
  %38 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
43:                                               ; preds = %40
  %44 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
16:                                               ; preds = %10, %15
  ...
  %18 = icmp eq i64 %17, %8
  br i1 %18, label %19, label %10, !llvm.loop !66
...
14:                                               ; preds = %8, %13
  ...
  %16 = icmp eq i64 %15, %6
  br i1 %16, label %17, label %8, !llvm.loop !67
...
10:                                               ; preds = %4, %10
  ...
  %14 = icmp eq i64 %13, %6
  br i1 %14, label %15, label %10, !llvm.loop !68
...
!35 = !{!36, !6, i64 24}
!36 = !{!"mem_address", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32}
!37 = !{!36, !6, i64 32}
!38 = !{!36, !6, i64 0}
!39 = !{!36, !6, i64 8}
!40 = !{!36, !6, i64 16}
!41 = !{!42, !11, i64 0}
!42 = !{!"VEC_mem_addr_template_base", !11, i64 0, !11, i64 4, !7, i64 8}
!43 = !{!42, !11, i64 4}
!44 = !{!45, !6, i64 0}
!45 = !{!"mem_addr_template", !6, i64 0, !6, i64 8, !6, i64 16}
!46 = !{!45, !6, i64 8}
!47 = !{!45, !6, i64 16}
!48 = !{!49, !11, i64 24}
!49 = !{!"affine_tree_combination", !6, i64 0, !50, i64 8, !11, i64 24, !7, i64 32, !6, i64 224}
!50 = !{!"", !12, i64 0, !12, i64 8}
!51 = !{!52, !6, i64 0}
!52 = !{!"aff_comb_elt", !6, i64 0, !50, i64 8}
!53 = distinct !{!53, !22}
!54 = !{i64 0, i64 8, !55, i64 8, i64 8, !55}
!55 = !{!12, !12, i64 0}
!56 = !{i64 0, i64 8, !55}
!57 = distinct !{!57, !22}
!58 = !{i64 0, i64 8, !5, i64 8, i64 8, !55, i64 16, i64 8, !55}
!59 = distinct !{!59, !22}
!60 = distinct !{!60, !22}
!61 = distinct !{!61, !22}
!62 = distinct !{!62, !22}
!63 = !{!49, !6, i64 224}
!64 = !{!65, !11, i64 0}
!65 = !{!"VEC_mem_addr_template_gc", !42, i64 0}
!66 = distinct !{!66, !22}
!67 = distinct !{!67, !22}
!68 = distinct !{!68, !22}
