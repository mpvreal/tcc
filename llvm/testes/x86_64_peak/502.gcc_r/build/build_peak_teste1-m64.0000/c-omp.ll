...
define dso_local void @c_finish_omp_barrier(i32 noundef %0) local_unnamed_addr #8 {
  %2 = load ptr, ptr getelementptr inbounds ([721 x ptr], ptr @built_in_decls, i64 0, i64 656), align 16, !tbaa !5
...
define dso_local void @c_finish_omp_taskwait(i32 noundef %0) local_unnamed_addr #8 {
  %2 = load ptr, ptr getelementptr inbounds ([721 x ptr], ptr @built_in_decls, i64 0, i64 657), align 8, !tbaa !5
  %3 = tail call ptr (i32, ptr, i32, ...) @build_call_expr_loc(i32 noundef %0, ptr noundef %2, i32 noundef 0) #10
  %4 = tail call ptr @add_stmt(ptr noundef %3) #10
  ret void
}
...
16:                                               ; preds = %9, %9, %9, %9, %9, %9
  ...
  %18 = load ptr, ptr @global_trees, align 16, !tbaa !5
...
50:                                               ; preds = %45, %49
  ...
  %53 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 38), align 16, !tbaa !5
...
define dso_local void @c_finish_omp_flush(i32 noundef %0) local_unnamed_addr #8 {
  %2 = load ptr, ptr getelementptr inbounds ([721 x ptr], ptr @built_in_decls, i64 0, i64 651), align 8, !tbaa !5
  %3 = tail call ptr (i32, ptr, i32, ...) @build_call_expr_loc(i32 noundef %0, ptr noundef %2, i32 noundef 0) #10
  %4 = tail call ptr @add_stmt(ptr noundef %3) #10
  ret void
}
...
27:                                               ; preds = %22
  ...
  %28 = load i32, ptr %8, align 8, !tbaa !16
  br label %29
...
70:                                               ; preds = %64
  ...
  %71 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 13), align 8, !tbaa !5
  br label %72
...
119:                                              ; preds = %115
  store ptr %36, ptr %108, align 8, !tbaa !16
  %120 = load ptr, ptr %56, align 8, !tbaa !16
  %121 = tail call ptr @fold_build1_stat_loc(i32 noundef %105, i32 noundef 116, ptr noundef %120, ptr noundef %111) #10
  store ptr %121, ptr %110, align 8, !tbaa !16
...
139:                                              ; preds = %134
  %140 = load ptr, ptr %110, align 8, !tbaa !16
...
143:                                              ; preds = %139
  ...
  %152 = load ptr, ptr %108, align 8, !tbaa !16
  store ptr %152, ptr %110, align 8, !tbaa !16
  store ptr %36, ptr %108, align 8, !tbaa !16
  br label %153
...
158:                                              ; preds = %153
  %159 = load ptr, ptr %56, align 8, !tbaa !16
...
171:                                              ; preds = %165
  %172 = load ptr, ptr %110, align 8, !tbaa !16
  %173 = load ptr, ptr %56, align 8, !tbaa !16
...
209:                                              ; preds = %205
  %210 = load ptr, ptr %56, align 8, !tbaa !16
...
217:                                              ; preds = %213
  %218 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
222:                                              ; preds = %217, %217
  %223 = load ptr, ptr @sizetype_tab, align 16, !tbaa !5
...
225:                                              ; preds = %217, %222
  ...
  %227 = load ptr, ptr %56, align 8, !tbaa !16
...
257:                                              ; preds = %251, %253
  ...
  %259 = load ptr, ptr @global_trees, align 16, !tbaa !5
  %260 = icmp eq ptr %258, %259
  br i1 %260, label %266, label %261

261:                                              ; preds = %257
  %262 = load ptr, ptr %56, align 8, !tbaa !16
  %263 = tail call ptr @build2_stat(i32 noundef 63, ptr noundef %262, ptr noundef nonnull %36, ptr noundef %258) #10
  %264 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 38), align 16, !tbaa !5
...
267:                                              ; preds = %261, %253, %243, %247, %209, %213, %225, %266, %189
  ...
  store ptr %77, ptr %37, align 8, !tbaa !16
  store ptr %268, ptr %41, align 8, !tbaa !16
  %270 = add nuw nsw i64 %33, 1
  %271 = load i32, ptr %8, align 8, !tbaa !16
  %272 = sext i32 %271 to i64
  %273 = icmp slt i64 %270, %272
  br i1 %273, label %32, label %274, !llvm.loop !23
...
276:                                              ; preds = %29, %274
  ...
  %278 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 38), align 16, !tbaa !5
...
21:                                               ; preds = %3, %11
  %22 = load ptr, ptr @global_trees, align 16, !tbaa !5
  br label %73
...
30:                                               ; preds = %27
  %31 = load ptr, ptr @global_trees, align 16, !tbaa !5
  br label %73
...
32:                                               ; preds = %27, %27
  ...
  %36 = load ptr, ptr @global_trees, align 16, !tbaa !5
...
41:                                               ; preds = %27
  ...
  %45 = load ptr, ptr @global_trees, align 16, !tbaa !5
...
18:                                               ; preds = %13, %15, %17
  ...
  br i1 %19, label %20, label %7, !llvm.loop !24
