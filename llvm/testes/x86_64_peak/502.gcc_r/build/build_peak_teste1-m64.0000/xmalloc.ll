...
@name = internal unnamed_addr global ptr @.str.2, align 8
...
define dso_local void @xmalloc_set_program_name(ptr noundef %0) local_unnamed_addr #7 {
  store ptr %0, ptr @name, align 8, !tbaa !5
  ret void
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @xmalloc_failed(i64 noundef %0) local_unnamed_addr #8 {
  %2 = load ptr, ptr @stderr, align 8, !tbaa !5
  %3 = load ptr, ptr @name, align 8, !tbaa !5
  %4 = load i8, ptr %3, align 1, !tbaa !16
  %5 = icmp eq i8 %4, 0
  %6 = select i1 %5, ptr @.str.2, ptr @.str.1
  %7 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str, ptr noundef nonnull %3, ptr noundef nonnull %6, i64 noundef %0) #14
  tail call void @xexit(i32 noundef 1) #13
  ret void
}
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local noalias ptr @xmalloc(i64 noundef %0) local_unnamed_addr #8 {
  %2 = tail call i64 @llvm.umax.i64(i64 %0, i64 1)
  %3 = tail call ptr @malloc(i64 noundef %2) #15
...
5:                                                ; preds = %1
  ...
  %11 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str, ptr noundef nonnull %7, ptr noundef nonnull %10, i64 noundef %2) #14
  tail call void @xexit(i32 noundef 1) #13
  br label %12
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local noalias ptr @xcalloc(i64 noundef %0, i64 noundef %1) local_unnamed_addr #8 {
  %3 = icmp eq i64 %0, 0
  %4 = icmp eq i64 %1, 0
  %5 = or i1 %3, %4
  %6 = select i1 %5, i64 1, i64 %1
  %7 = select i1 %5, i64 1, i64 %0
  %8 = tail call ptr @calloc(i64 noundef %7, i64 noundef %6) #16
...
10:                                               ; preds = %2
  ...
  %17 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %12, ptr noundef nonnull @.str, ptr noundef nonnull %13, ptr noundef nonnull %16, i64 noundef %11) #14
  tail call void @xexit(i32 noundef 1) #13
  br label %18
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local ptr @xrealloc(ptr noundef %0, i64 noundef %1) local_unnamed_addr #8 {
  %3 = tail call i64 @llvm.umax.i64(i64 %1, i64 1)
  %4 = icmp eq ptr %0, null
  br i1 %4, label %5, label %7

5:                                                ; preds = %2
  %6 = tail call ptr @malloc(i64 noundef %3) #15
  br label %9

7:                                                ; preds = %2
  %8 = tail call ptr @realloc(ptr noundef nonnull %0, i64 noundef %3) #17
  br label %9
...
12:                                               ; preds = %9
  ...
  %18 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef nonnull @.str, ptr noundef nonnull %14, ptr noundef nonnull %17, i64 noundef %3) #14
  tail call void @xexit(i32 noundef 1) #13
  br label %19
