...
define dso_local void @lto_fixup_nothrow_decls() local_unnamed_addr #9 {
  %1 = load i32, ptr @flag_wpa, align 4, !tbaa !20
  %2 = icmp ne i32 %1, 0
...
9:                                                ; preds = %0, %47
  ...
  %11 = load ptr, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
...
47:                                               ; preds = %43, %23, %9
  ...
  br i1 %50, label %51, label %9, !llvm.loop !35
...
6:                                                ; preds = %1, %5
  %7 = load ptr, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
  %8 = icmp eq ptr %7, null
  br i1 %8, label %9, label %11

9:                                                ; preds = %6
  %10 = tail call ptr @lto_bitmap_alloc() #11
  store ptr %10, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
  br label %11
...
define internal void @lto_output_wpa_fixup(ptr nocapture noundef readonly %0) #9 {
  ...
  %4 = load ptr, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
...
25:                                               ; preds = %16
  ...
  %28 = load ptr, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
  %29 = load i32, ptr %21, align 4, !tbaa !16
...
34:                                               ; preds = %32
  ...
  %37 = load i32, ptr %12, align 8, !tbaa !42
...
42:                                               ; preds = %34, %39
  ...
  store ptr %20, ptr %47, align 8, !tbaa !5
  br label %48
...
63:                                               ; preds = %53
  %64 = load i32, ptr %59, align 4, !tbaa !16
  %65 = tail call zeroext i8 @bitmap_set_bit(ptr noundef %3, i32 noundef %64) #11
  %66 = load ptr, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
  %67 = load i32, ptr %59, align 4, !tbaa !16
...
72:                                               ; preds = %70
  ...
  %75 = load i32, ptr %55, align 8, !tbaa !42
...
86:                                               ; preds = %53, %80, %63
  ...
  br i1 %90, label %91, label %53, !llvm.loop !44
...
91:                                               ; preds = %86, %48
  ...
  br i1 %95, label %96, label %10, !llvm.loop !45
...
define internal void @lto_input_wpa_fixup() #9 {
  ...
  %4 = load i32, ptr @flag_ltrans, align 4, !tbaa !20
  %5 = icmp eq i32 %4, 0
...
35:                                               ; preds = %34, %25
  %36 = load ptr, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
  %37 = icmp eq ptr %36, null
  br i1 %37, label %38, label %40

38:                                               ; preds = %35
  %39 = call ptr @lto_bitmap_alloc() #11
  store ptr %39, ptr @lto_nothrow_fndecls, align 8, !tbaa !5
  br label %40
...
40:                                               ; preds = %38, %35
  ...
  br i1 %46, label %47, label %16, !llvm.loop !55
...
47:                                               ; preds = %40, %9
  ...
  %51 = load ptr, ptr %50, align 8, !tbaa !5
  %52 = icmp eq ptr %51, null
  br i1 %52, label %53, label %9, !llvm.loop !57
...
!31 = !{!32, !6, i64 8}
!32 = !{!"cgraph_edge", !12, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !7, i64 72, !11, i64 76, !11, i64 80, !11, i64 84, !13, i64 88, !11, i64 90, !11, i64 90, !11, i64 90}
!33 = !{!32, !6, i64 56}
!34 = distinct !{!34, !22}
!35 = distinct !{!35, !22}
!36 = !{!37, !6, i64 8}
!37 = !{!"cgraph_node_set_def", !6, i64 0, !6, i64 8, !6, i64 16}
!38 = !{!39, !11, i64 0}
!39 = !{!"VEC_cgraph_node_ptr_base", !11, i64 0, !11, i64 4, !7, i64 8}
!40 = !{!41, !11, i64 4}
...
!45 = distinct !{!45, !22}
!46 = !{!47, !6, i64 16}
!47 = !{!"lto_simple_output_block", !7, i64 0, !6, i64 8, !6, i64 16}
!48 = !{!47, !6, i64 8}
!49 = distinct !{!49, !22}
!50 = !{!51, !6, i64 0}
!51 = !{!"lto_file_decl_data", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !11, i64 40, !6, i64 48, !6, i64 56}
!52 = !{!53, !11, i64 8}
!53 = !{!"lto_tree_ref_table", !6, i64 0, !11, i64 8}
!54 = !{!53, !6, i64 0}
!55 = distinct !{!55, !22}
!56 = !{!12, !12, i64 0}
!57 = distinct !{!57, !22}
