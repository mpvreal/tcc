...
12:                                               ; preds = %1
  %13 = load ptr, ptr @vect_dump, align 8, !tbaa !5
...
21:                                               ; preds = %17, %339
  ...
  %26 = load i32, ptr %25, align 8, !tbaa !30, !noalias !32
  %27 = and i32 %26, 512
  %28 = icmp eq i32 %27, 0
...
29:                                               ; preds = %21
  ...
  %31 = load ptr, ptr %30, align 8, !tbaa !16, !noalias !32
  %32 = icmp eq ptr %31, null
  br i1 %32, label %339, label %33

33:                                               ; preds = %29
  %34 = load ptr, ptr %31, align 8, !tbaa !35, !noalias !32
  %35 = icmp eq ptr %34, null
  br i1 %35, label %339, label %36

36:                                               ; preds = %33
  %37 = load ptr, ptr %34, align 8, !tbaa !37, !noalias !32
...
51:                                               ; preds = %41
  %52 = load i32, ptr %49, align 8, !tbaa !41
...
268:                                              ; preds = %264
  ...
  %271 = load ptr, ptr @vect_dump, align 8, !tbaa !5
...
283:                                              ; preds = %280
  %284 = load i32, ptr %281, align 8, !tbaa !41
  %285 = add i32 %284, 1
  br label %286

286:                                              ; preds = %283, %280
  %287 = phi i32 [ %285, %283 ], [ 1, %280 ]
  store i32 %287, ptr %274, align 4, !tbaa !16
  %288 = load ptr, ptr @stmt_vec_info_vec, align 8, !tbaa !5
...
290:                                              ; preds = %286
  ...
  %293 = load i32, ptr %288, align 8, !tbaa !41
  %294 = icmp eq i32 %292, %293
  br i1 %294, label %295, label %298

295:                                              ; preds = %290, %286
  %296 = call ptr @vec_heap_p_reserve(ptr noundef %288, i32 noundef 1) #12
  store ptr %296, ptr @stmt_vec_info_vec, align 8, !tbaa !5
...
298:                                              ; preds = %295, %290
  ...
  %301 = add i32 %299, 1
  store i32 %301, ptr %300, align 8, !tbaa !41
  br label %305
...
305:                                              ; preds = %302, %298
  ...
  store ptr %273, ptr %309, align 8, !tbaa !5
  %310 = load i32, ptr %274, align 4, !tbaa !16
...
319:                                              ; preds = %317, %314
  ...
  store ptr %45, ptr %325, align 8, !tbaa !52
...
127:                                              ; preds = %108, %123
  ...
  %129 = load i32, ptr %104, align 4, !tbaa !16
...
143:                                              ; preds = %124, %139
  ...
  store ptr %145, ptr %1, align 8, !tbaa !5
...
154:                                              ; preds = %143
  ...
  %157 = load ptr, ptr @vect_dump, align 8, !tbaa !5
...
70:                                               ; preds = %67
  ...
  %72 = load i8, ptr %71, align 8, !tbaa !55
  %73 = icmp eq i8 %72, 0
...
243:                                              ; preds = %240
  %244 = load i32, ptr %241, align 8, !tbaa !41
...
300:                                              ; preds = %296
  ...
  %303 = call fastcc i32 @gimple_assign_rhs_code(ptr noundef %302), !range !62
...
331:                                              ; preds = %326
  %332 = load i32, ptr %237, align 4, !tbaa !16
...
335:                                              ; preds = %331
  %336 = load ptr, ptr %8, align 8, !tbaa !5
  %337 = call fastcc ptr @gimple_assign_rhs1(ptr noundef %336)
  %338 = load i32, ptr %237, align 4, !tbaa !16
...
341:                                              ; preds = %335
  %342 = load ptr, ptr %8, align 8, !tbaa !5
  %343 = call fastcc ptr @gimple_assign_rhs1(ptr noundef %342)
  %344 = load ptr, ptr %6, align 8, !tbaa !5
...
358:                                              ; preds = %349, %316
  ...
  store ptr %362, ptr %4, align 8, !tbaa !5
  store ptr %362, ptr %1, align 8, !tbaa !5
  store ptr %228, ptr %2, align 8, !tbaa !5
...
368:                                              ; preds = %358
  %369 = load ptr, ptr @vect_dump, align 8, !tbaa !5
...
103:                                              ; preds = %96, %89
  ...
  store ptr %105, ptr %1, align 8, !tbaa !5
...
122:                                              ; preds = %117
  ...
  %126 = load ptr, ptr %123, align 8, !tbaa !16
...
93:                                               ; preds = %74, %89
  ...
  store ptr %96, ptr %2, align 8, !tbaa !5
...
!41 = !{!42, !11, i64 0}
!42 = !{!"VEC_vec_void_p_base", !11, i64 0, !11, i64 4, !7, i64 8}
!43 = !{!44, !6, i64 16}
!44 = !{!"_stmt_vec_info", !7, i64 0, !6, i64 8, !6, i64 16, !7, i64 24, !7, i64 28, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !6, i64 80, !6, i64 88, !7, i64 96, !6, i64 104, !6, i64 112, !7, i64 120, !6, i64 128, !6, i64 136, !11, i64 144, !11, i64 148, !11, i64 152, !6, i64 160, !7, i64 168, !45, i64 172, !7, i64 180, !6, i64 184}
!45 = !{!"", !11, i64 0, !11, i64 4}
!46 = !{!12, !12, i64 0}
!47 = !{!48, !7, i64 0}
!48 = !{!"optab_handlers", !7, i64 0}
!49 = !{!50, !6, i64 24}
!50 = !{!"insn_data", !6, i64 0, !7, i64 8, !6, i64 16, !6, i64 24, !7, i64 32, !7, i64 33, !7, i64 34, !7, i64 35}
!51 = !{!42, !11, i64 4}
!52 = !{!44, !6, i64 104}
!53 = !{!44, !7, i64 120}
!54 = !{!44, !6, i64 32}
