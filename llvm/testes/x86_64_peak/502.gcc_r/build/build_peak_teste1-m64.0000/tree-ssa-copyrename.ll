...
define internal zeroext i8 @gate_copyrename() #9 {
  %1 = load i32, ptr @flag_tree_copyrename, align 4, !tbaa !20
  %2 = icmp ne i32 %1, 0
  %3 = zext i1 %2 to i8
  ret i8 %3
}
...
17:                                               ; preds = %9
  %18 = load i32, ptr %15, align 8, !tbaa !29
  br label %19
...
33:                                               ; preds = %43, %51, %55, %31, %58
  ...
  br i1 %42, label %116, label %43, !llvm.loop !37
...
43:                                               ; preds = %19, %33
  ...
  %48 = load i32, ptr %47, align 8, !tbaa !38, !noalias !39
  %49 = and i32 %48, 512
  %50 = icmp eq i32 %49, 0
...
51:                                               ; preds = %43
  ...
  %53 = load ptr, ptr %52, align 8, !tbaa !16, !noalias !39
  %54 = icmp eq ptr %53, null
  br i1 %54, label %33, label %55

55:                                               ; preds = %51
  %56 = load ptr, ptr %53, align 8, !tbaa !42, !noalias !39
  %57 = icmp eq ptr %56, null
  br i1 %57, label %33, label %58

58:                                               ; preds = %55
  %59 = load ptr, ptr %56, align 8, !tbaa !44, !noalias !39
...
107:                                              ; preds = %89, %103
  ...
  %109 = tail call fastcc zeroext i8 @copy_rename_partition_coalesce(ptr noundef %21, ptr noundef %92, ptr noundef %108, ptr noundef %10), !range !49
  %110 = or i8 %109, %62
  br label %111
...
111:                                              ; preds = %61, %107
  ...
  br i1 %115, label %31, label %61, !llvm.loop !51

116:                                              ; preds = %33
  %117 = load ptr, ptr %39, align 8, !tbaa !32
...
121:                                              ; preds = %174, %131
  ...
  br i1 %130, label %179, label %131, !llvm.loop !52
...
131:                                              ; preds = %116, %121
  ...
  %134 = load ptr, ptr %1, align 8, !tbaa.struct !53
...
152:                                              ; preds = %150, %168
  ...
  %156 = load i32, ptr %151, align 8, !tbaa !16
...
165:                                              ; preds = %159
  %166 = call fastcc zeroext i8 @copy_rename_partition_coalesce(ptr noundef %21, ptr noundef %141, ptr noundef nonnull %161, ptr noundef %10), !range !49
  %167 = or i8 %166, %154
  br label %168
...
168:                                              ; preds = %165, %159
  ...
  %171 = load i32, ptr %147, align 4, !tbaa !16
  %172 = zext i32 %171 to i64
  %173 = icmp ult i64 %170, %172
  br i1 %173, label %152, label %174, !llvm.loop !57
...
174:                                              ; preds = %168, %146, %136
  ...
  br i1 %178, label %121, label %136, !llvm.loop !58
...
196:                                              ; preds = %188
  %197 = load i32, ptr %194, align 8, !tbaa !29
  br label %198
...
236:                                              ; preds = %228
  %237 = load i32, ptr %234, align 8, !tbaa !29
  br label %238
...
241:                                              ; preds = %238
  %242 = load ptr, ptr %183, align 8, !tbaa !59
...
85:                                               ; preds = %58, %83
  ...
  %91 = load i32, ptr %86, align 4, !tbaa !20
  br label %92
...
212:                                              ; preds = %200
  %213 = load ptr, ptr %0, align 8, !tbaa !61
...
232:                                              ; preds = %226, %222, %216
  ...
  %235 = load ptr, ptr %0, align 8, !tbaa !61
...
257:                                              ; preds = %248, %253
  ...
  %259 = load ptr, ptr %0, align 8, !tbaa !61
...
!54 = !{!55, !6, i64 32}
!55 = !{!"phi_arg_d", !56, i64 0, !6, i64 32, !11, i64 40}
!56 = !{!"ssa_use_operand_d", !6, i64 0, !6, i64 8, !7, i64 16, !6, i64 24}
!57 = distinct !{!57, !22}
!58 = distinct !{!58, !22}
!59 = !{!60, !6, i64 16}
!60 = !{!"_var_map", !6, i64 0, !6, i64 8, !6, i64 16, !11, i64 24, !11, i64 28, !11, i64 32, !6, i64 40, !6, i64 48}
!61 = !{!60, !6, i64 0}
!62 = !{!63, !11, i64 0}
!63 = !{!"partition_elem", !11, i64 0, !6, i64 8, !11, i64 16}
!64 = distinct !{!64, !22}
