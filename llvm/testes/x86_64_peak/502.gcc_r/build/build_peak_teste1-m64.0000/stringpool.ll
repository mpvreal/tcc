...
define dso_local void @init_stringpool() local_unnamed_addr #9 {
  ...
  store ptr %1, ptr @ident_hash, align 8, !tbaa !5
  %2 = getelementptr inbounds %struct.ht, ptr %1, i64 0, i32 2
  store ptr @alloc_node, ptr %2, align 8, !tbaa !23
  %3 = getelementptr inbounds %struct.ht, ptr %1, i64 0, i32 3
  store ptr @stringpool_ggc_alloc, ptr %3, align 8, !tbaa !26
  ret void
}
...
define dso_local nonnull ptr @get_identifier(ptr noundef %0) local_unnamed_addr #9 {
  %2 = load ptr, ptr @ident_hash, align 8, !tbaa !5
...
define dso_local nonnull ptr @get_identifier_with_length(ptr noundef %0, i64 noundef %1) local_unnamed_addr #9 {
  %3 = load ptr, ptr @ident_hash, align 8, !tbaa !5
...
define dso_local void @stringpool_statistics() local_unnamed_addr #9 {
  %1 = load ptr, ptr @ident_hash, align 8, !tbaa !5
...
define dso_local void @gt_pch_restore_stringpool() local_unnamed_addr #9 {
  %1 = load ptr, ptr @ident_hash, align 8, !tbaa !5
  %2 = load ptr, ptr @spd, align 8, !tbaa !5
  ...
  store ptr null, ptr @spd, align 8, !tbaa !5
  ret void
}
...
23:                                               ; preds = %20, %13
  ...
  br i1 %27, label %28, label %13, !llvm.loop !33
...
21:                                               ; preds = %18, %11
  ...
  br i1 %25, label %26, label %11, !llvm.loop !34
...
22:                                               ; preds = %12
  ...
  %25 = load i32, ptr %9, align 8, !tbaa !31
  br label %26
...
26:                                               ; preds = %22, %12
  ...
  br i1 %36, label %37, label %12, !llvm.loop !35
...
!23 = !{!24, !6, i64 96}
!24 = !{!"ht", !25, i64 0, !6, i64 88, !6, i64 96, !6, i64 104, !11, i64 112, !11, i64 116, !6, i64 120, !11, i64 128, !11, i64 132, !7, i64 136}
!25 = !{!"obstack", !12, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !12, i64 40, !11, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !11, i64 80, !11, i64 80, !11, i64 80}
!26 = !{!24, !6, i64 104}
!27 = !{!13, !13, i64 0}
!28 = !{!29, !6, i64 0}
!29 = !{!"string_pool_data", !6, i64 0, !11, i64 8, !11, i64 12}
!30 = !{!24, !6, i64 88}
!31 = !{!29, !11, i64 8}
!32 = !{!29, !11, i64 12}
!33 = distinct !{!33, !22}
