...
define internal zeroext i8 @gate_call_cdce() #9 {
  %1 = load i32, ptr @flag_tree_builtin_call_dce, align 4, !tbaa !20
  %2 = icmp eq i32 %1, 0
...
22:                                               ; preds = %32, %40, %44, %20, %47
  ...
  br i1 %31, label %407, label %32, !llvm.loop !30
...
32:                                               ; preds = %0, %22
  ...
  %37 = load i32, ptr %36, align 8, !tbaa !31, !noalias !32
  %38 = and i32 %37, 512
  %39 = icmp eq i32 %38, 0
...
40:                                               ; preds = %32
  ...
  %42 = load ptr, ptr %41, align 8, !tbaa !16, !noalias !32
  %43 = icmp eq ptr %42, null
  br i1 %43, label %22, label %44

44:                                               ; preds = %40
  %45 = load ptr, ptr %42, align 8, !tbaa !35, !noalias !32
  %46 = icmp eq ptr %45, null
  br i1 %46, label %22, label %47

47:                                               ; preds = %44
  %48 = load ptr, ptr %45, align 8, !tbaa !37, !noalias !32
...
260:                                              ; preds = %259
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %262, i64 32, i1 false), !tbaa.struct !42
...
386:                                              ; preds = %381, %383
  ...
  %390 = load i32, ptr %387, align 8, !tbaa !45
...
402:                                              ; preds = %137, %143, %149, %238, %232, %226, %288, %354, %343, %327, %290, %250, %161, %86, %100, %91, %95, %64, %396, %366, %50
  ...
  br i1 %406, label %20, label %50, !llvm.loop !47
...
423:                                              ; preds = %416
  %424 = load i32, ptr %421, align 8, !tbaa !45
...
517:                                              ; preds = %513
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %519, i64 32, i1 false), !tbaa.struct !42
...
552:                                              ; preds = %545
  ...
  %558 = load i64, ptr %557, align 8, !tbaa !41
...
581:                                              ; preds = %580, %578, %577
  ...
  %583 = load i32, ptr %421, align 8, !tbaa !45
  %584 = add i32 %583, 1
  store i32 %584, ptr %421, align 8, !tbaa !45
  %585 = zext i32 %583 to i64
  %586 = getelementptr inbounds %struct.VEC_gimple_base, ptr %421, i64 0, i32 2, i64 %585
  store ptr null, ptr %586, align 8, !tbaa !5
...
613:                                              ; preds = %612, %603
  ...
  store ptr %591, ptr %614, align 8, !tbaa !5
...
620:                                              ; preds = %616
  ...
  store ptr %589, ptr %621, align 8, !tbaa !16
  br label %622
...
656:                                              ; preds = %648
  ...
  %662 = load i64, ptr %661, align 8, !tbaa !41
...
685:                                              ; preds = %678
  %686 = load i32, ptr %421, align 8, !tbaa !45
  %687 = add i32 %686, 1
  store i32 %687, ptr %421, align 8, !tbaa !45
...
698:                                              ; preds = %695
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %5, ptr noundef nonnull align 8 dereferenceable(24) %7, i64 24, i1 false), !tbaa.struct !48
...
704:                                              ; preds = %698
  %705 = load ptr, ptr inttoptr (i64 8 to ptr), align 8, !tbaa !5
  br label %728

706:                                              ; preds = %698
  %707 = load i32, ptr %421, align 8, !tbaa !45
...
723:                                              ; preds = %722
  ...
  br i1 %725, label %726, label %713, !llvm.loop !51

726:                                              ; preds = %723
  %727 = add i32 %696, -1
  store i32 %727, ptr %6, align 4, !tbaa !20
  br label %737

728:                                              ; preds = %706, %704
  %729 = phi ptr [ %705, %704 ], [ %709, %706 ]
  %730 = add i32 %696, -1
  store i32 %730, ptr %6, align 4, !tbaa !20
  br label %744
...
733:                                              ; preds = %731, %721
  ...
  %735 = add i32 %696, -1
  store i32 %735, ptr %6, align 4, !tbaa !20
...
750:                                              ; preds = %744, %737
  ...
  %764 = or i32 %763, 1024
  store i32 %764, ptr %761, align 8, !tbaa !52
  ...
  store i32 100, ptr %768, align 4, !tbaa !53
  %769 = getelementptr inbounds %struct.edge_def, ptr %767, i64 0, i32 8
  store i32 9900, ptr %769, align 4, !tbaa !53
...
793:                                              ; preds = %792
  ...
  br i1 %795, label %796, label %783, !llvm.loop !54

796:                                              ; preds = %793
  %797 = add i32 %774, -1
  store i32 %797, ptr %6, align 4, !tbaa !20
  br label %805
...
800:                                              ; preds = %798, %791, %773
  ...
  %803 = add i32 %774, -1
  store i32 %803, ptr %6, align 4, !tbaa !20
...
816:                                              ; preds = %812, %805
  ...
  %822 = load i32, ptr %821, align 8, !tbaa !52
  %823 = and i32 %822, -2050
  %824 = or i32 %823, 2048
  store i32 %824, ptr %821, align 8, !tbaa !52
...
843:                                              ; preds = %838, %834, %831, %695
  ...
  br i1 %847, label %848, label %416, !llvm.loop !59
...
850:                                              ; preds = %848
  ...
  %851 = load ptr, ptr @cfun, align 8, !tbaa !5
...
define internal fastcc void @gen_one_condition(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4, ptr nocapture noundef %5, ptr nocapture noundef %6) unnamed_addr #9 {
  ...
  %10 = load ptr, ptr getelementptr inbounds ([11 x ptr], ptr @integer_types, i64 0, i64 5), align 8, !tbaa !5
...
39:                                               ; preds = %38, %29
  ...
  store ptr %17, ptr %40, align 8, !tbaa !5
...
48:                                               ; preds = %39, %42, %46
  %49 = load ptr, ptr getelementptr inbounds ([131 x ptr], ptr @global_trees, i64 0, i64 47), align 8, !tbaa !5
...
77:                                               ; preds = %76, %67
  ...
  store ptr %55, ptr %78, align 8, !tbaa !5
...
!41 = !{!12, !12, i64 0}
!42 = !{i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 8, i64 24, !16}
!43 = !{!44, !11, i64 4}
!44 = !{!"VEC_gimple_base", !11, i64 0, !11, i64 4, !7, i64 8}
!45 = !{!44, !11, i64 0}
!46 = !{!40, !6, i64 16}
!47 = distinct !{!47, !22}
...
!55 = distinct !{!55, !22}
!56 = !{!57, !6, i64 0}
!57 = !{!"", !6, i64 0, !11, i64 8, !11, i64 12, !7, i64 16}
!58 = !{!57, !11, i64 8}
!59 = distinct !{!59, !22}
!60 = !{!24, !6, i64 24}
!61 = !{!62, !6, i64 24}
!62 = !{!"gimple_df", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !63, i64 32, !63, i64 48, !6, i64 64, !6, i64 72, !6, i64 80, !6, i64 88, !11, i64 96, !64, i64 104}
!63 = !{!"pt_solution", !11, i64 0, !11, i64 0, !11, i64 0, !11, i64 0, !11, i64 0, !11, i64 0, !6, i64 8}
!64 = !{!"ssa_operands", !6, i64 0, !11, i64 8, !11, i64 12, !7, i64 16, !6, i64 24, !6, i64 32}
