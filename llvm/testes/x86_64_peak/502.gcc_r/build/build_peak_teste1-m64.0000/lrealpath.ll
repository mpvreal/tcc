...
; Function Attrs: mustprogress nofree nounwind sspstrong willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable
define dso_local noalias ptr @lrealpath(ptr nocapture noundef readonly %0) local_unnamed_addr #7 {
  %2 = tail call ptr @strdup(ptr noundef %0)
  ret ptr %2
}
