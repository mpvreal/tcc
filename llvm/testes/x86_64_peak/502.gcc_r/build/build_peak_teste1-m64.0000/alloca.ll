...
@last_alloca_header = internal unnamed_addr global ptr null, align 8
@libiberty_optr = dso_local local_unnamed_addr global ptr null, align 8
@libiberty_nptr = dso_local local_unnamed_addr global ptr null, align 8
@libiberty_len = dso_local local_unnamed_addr global i64 0, align 8
@find_stack_direction.addr = internal unnamed_addr global ptr null, align 8
...
define dso_local ptr @C_alloca(i64 noundef %0) local_unnamed_addr #8 {
  %2 = alloca i8, align 1
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %2) #12
  %3 = load i32, ptr @stack_dir, align 4, !tbaa !22
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %5, label %6

5:                                                ; preds = %1
  tail call fastcc void @find_stack_direction()
  br label %6

6:                                                ; preds = %5, %1
  %7 = load ptr, ptr @last_alloca_header, align 8, !tbaa !5
  %8 = icmp eq ptr %7, null
  br i1 %8, label %26, label %9

9:                                                ; preds = %6, %23
  %10 = phi ptr [ %24, %23 ], [ %7, %6 ]
  %11 = load i32, ptr @stack_dir, align 4, !tbaa !22
  %12 = icmp sgt i32 %11, 0
  br i1 %12, label %13, label %17

13:                                               ; preds = %9
  %14 = getelementptr inbounds %struct.anon, ptr %10, i64 0, i32 1
...
19:                                               ; preds = %17
  %20 = getelementptr inbounds %struct.anon, ptr %10, i64 0, i32 1
  %21 = load ptr, ptr %20, align 8, !tbaa !16
  %22 = icmp ult ptr %21, %2
...
23:                                               ; preds = %19, %13
  ...
  br i1 %25, label %26, label %9, !llvm.loop !23

26:                                               ; preds = %23, %19, %17, %13, %6
  %27 = phi ptr [ null, %6 ], [ %10, %13 ], [ %10, %17 ], [ %10, %19 ], [ null, %23 ]
  store ptr %27, ptr @last_alloca_header, align 8, !tbaa !5
  %28 = icmp eq i64 %0, 0
  br i1 %28, label %38, label %29

29:                                               ; preds = %26
  %30 = add i64 %0, 16
  %31 = call ptr @xmalloc(i64 noundef %30) #12
...
34:                                               ; preds = %29
  %35 = load ptr, ptr @last_alloca_header, align 8, !tbaa !5
  store ptr %35, ptr %31, align 8, !tbaa !16
  %36 = getelementptr inbounds %struct.anon, ptr %31, i64 0, i32 1
  store ptr %2, ptr %36, align 8, !tbaa !16
  store ptr %31, ptr @last_alloca_header, align 8, !tbaa !5
  %37 = getelementptr inbounds i8, ptr %31, i64 16
  br label %38

38:                                               ; preds = %26, %34
  %39 = phi ptr [ %37, %34 ], [ null, %26 ]
...
define internal fastcc void @find_stack_direction() unnamed_addr #9 {
  %1 = alloca i8, align 1
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %1) #12
  %2 = load ptr, ptr @find_stack_direction.addr, align 8, !tbaa !5
  %3 = icmp eq ptr %2, null
  br i1 %3, label %4, label %5

4:                                                ; preds = %0
  store ptr %1, ptr @find_stack_direction.addr, align 8, !tbaa !5
  call fastcc void @find_stack_direction()
  br label %9
...
7:                                                ; preds = %5
  store i32 1, ptr @stack_dir, align 4, !tbaa !22
  br label %9
