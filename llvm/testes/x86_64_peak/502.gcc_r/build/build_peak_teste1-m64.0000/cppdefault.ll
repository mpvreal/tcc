...
define dso_local zeroext i8 @cpp_relocated() local_unnamed_addr #8 {
  %1 = load i32, ptr @cpp_relocated.relocated, align 4, !tbaa !20
  %2 = icmp eq i32 %1, -1
  br i1 %2, label %3, label %7

3:                                                ; preds = %0
  %4 = tail call ptr @getenv(ptr noundef nonnull @.str.1)
  store ptr %4, ptr @gcc_exec_prefix, align 8, !tbaa !5
  %5 = icmp ne ptr %4, null
  %6 = zext i1 %5 to i32
  store i32 %6, ptr @cpp_relocated.relocated, align 4, !tbaa !20
  br label %7
