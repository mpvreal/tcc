...
@pass_compute_alignments = dso_local local_unnamed_addr global %struct.rtl_opt_pass { %struct.opt_pass { i32 1, ptr @.str.10, ptr null, ptr @compute_alignments, ptr null, ptr null, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1027 } }, align 8
...
@pass_final = dso_local local_unnamed_addr global %struct.rtl_opt_pass { %struct.opt_pass { i32 1, ptr @.str.51, ptr null, ptr @rest_of_handle_final, ptr null, ptr null, i32 0, i32 165, i32 0, i32 0, i32 0, i32 0, i32 2 } }, align 8
@.str.52 = private unnamed_addr constant [8 x i8] c"shorten\00", align 1
@pass_shorten_branches = dso_local local_unnamed_addr global %struct.rtl_opt_pass { %struct.opt_pass { i32 1, ptr @.str.52, ptr null, ptr @rest_of_handle_shorten_branches, ptr null, ptr null, i32 0, i32 165, i32 0, i32 0, i32 0, i32 0, i32 1 } }, align 8
@.str.53 = private unnamed_addr constant [13 x i8] c"*clean_state\00", align 1
@pass_clean_state = dso_local local_unnamed_addr global %struct.rtl_opt_pass { %struct.opt_pass { i32 1, ptr @.str.53, ptr null, ptr @rest_of_clean_state, ptr null, ptr null, i32 0, i32 165, i32 0, i32 0, i32 128, i32 0, i32 0 } }, align 8
...
define dso_local void @init_final(ptr nocapture noundef readnone %0) local_unnamed_addr #9 {
  ...
  store ptr null, ptr @final_sequence, align 8, !tbaa !5
  %2 = load i32, ptr @ix86_asm_dialect, align 4, !tbaa !16
  store i32 %2, ptr @dialect_number, align 4, !tbaa !20
  ret void
}
...
define dso_local void @init_insn_lengths() local_unnamed_addr #12 {
  %1 = load ptr, ptr @uid_shuid, align 8, !tbaa !5
  %2 = icmp eq ptr %1, null
  br i1 %2, label %4, label %3

3:                                                ; preds = %0
  tail call void @free(ptr noundef nonnull %1)
  store ptr null, ptr @uid_shuid, align 8, !tbaa !5
  br label %4

4:                                                ; preds = %3, %0
  %5 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %6 = icmp eq ptr %5, null
  br i1 %6, label %8, label %7

7:                                                ; preds = %4
  tail call void @free(ptr noundef nonnull %5)
  store ptr null, ptr @insn_lengths, align 8, !tbaa !5
  store i32 0, ptr @insn_lengths_max_uid, align 4, !tbaa !20
  br label %8

8:                                                ; preds = %7, %4
  %9 = load ptr, ptr @insn_addresses_, align 8, !tbaa !5
...
12:                                               ; preds = %8, %11
  store ptr null, ptr @insn_addresses_, align 8, !tbaa !5
  %13 = load ptr, ptr @uid_align, align 8, !tbaa !5
  %14 = icmp eq ptr %13, null
  br i1 %14, label %16, label %15

15:                                               ; preds = %12
  tail call void @free(ptr noundef nonnull %13)
  store ptr null, ptr @uid_align, align 8, !tbaa !5
  br label %16
...
define internal fastcc i32 @get_attr_length_1(ptr noundef %0, ptr nocapture noundef readonly %1) unnamed_addr #2 {
  %3 = load i32, ptr @insn_lengths_max_uid, align 4, !tbaa !20
...
7:                                                ; preds = %2
  %8 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %9 = sext i32 %5 to i64
...
15:                                               ; preds = %12
  %16 = tail call i32 %1(ptr noundef nonnull %0) #25, !callees !23
  br label %84
...
23:                                               ; preds = %17
  %24 = tail call i32 %1(ptr noundef nonnull %0) #25, !callees !23
  br label %84
...
57:                                               ; preds = %47, %43
  ...
  %59 = tail call i32 %1(ptr noundef nonnull %0) #25, !callees !23
...
69:                                               ; preds = %64, %69
  ...
  br i1 %81, label %69, label %84, !llvm.loop !27

82:                                               ; preds = %61
  %83 = tail call i32 %1(ptr noundef nonnull %0) #25, !callees !23
  br label %84
...
define dso_local i32 @label_to_alignment(ptr nocapture noundef readonly %0) local_unnamed_addr #15 {
  %2 = getelementptr inbounds %struct.rtx_def, ptr %0, i64 1, i32 1
  %3 = load i32, ptr %2, align 8, !tbaa !16
  %4 = load i32, ptr @max_labelno, align 4, !tbaa !20
  %5 = icmp sgt i32 %3, %4
  br i1 %5, label %14, label %6

6:                                                ; preds = %1
  %7 = load ptr, ptr @label_align, align 8, !tbaa !5
  %8 = load i32, ptr @min_labelno, align 4, !tbaa !20
  %9 = sub nsw i32 %3, %8
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(read, inaccessiblemem: none) uwtable
define dso_local i32 @label_to_max_skip(ptr nocapture noundef readonly %0) local_unnamed_addr #15 {
  %2 = getelementptr inbounds %struct.rtx_def, ptr %0, i64 1, i32 1
  %3 = load i32, ptr %2, align 8, !tbaa !16
  %4 = load i32, ptr @max_labelno, align 4, !tbaa !20
  %5 = icmp sgt i32 %3, %4
...
define dso_local i32 @insn_current_reference_address(ptr nocapture noundef readonly %0) local_unnamed_addr #16 {
...
8:                                                ; preds = %4
  %9 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  br label %136
...
10:                                               ; preds = %4
  ...
  %19 = load ptr, ptr @uid_shuid, align 8, !tbaa !5
...
29:                                               ; preds = %10
  %30 = load i32, ptr @insn_last_address, align 4, !tbaa !20
  %31 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %32 = getelementptr inbounds i32, ptr %31, i64 %20
  %33 = load i32, ptr %32, align 4, !tbaa !20
  %34 = add nsw i32 %33, %30
  %35 = load ptr, ptr @uid_align, align 8, !tbaa !5
...
39:                                               ; preds = %29
  %40 = load i32, ptr @length_unit_log, align 4, !tbaa !20
  %41 = shl nuw i32 1, %40
...
75:                                               ; preds = %69, %59
  ...
  br i1 %80, label %81, label %45, !llvm.loop !31
...
84:                                               ; preds = %10
  %85 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  %86 = load ptr, ptr @uid_align, align 8, !tbaa !5
...
90:                                               ; preds = %84
  %91 = load i32, ptr @length_unit_log, align 4, !tbaa !20
  %92 = shl nuw i32 1, %91
  %93 = getelementptr inbounds %struct.VEC_int_base, ptr %2, i64 0, i32 2
  %94 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
...
127:                                              ; preds = %121, %111
  ...
  br i1 %132, label %133, label %97, !llvm.loop !31
...
define dso_local i32 @compute_alignments() #14 {
  %1 = load ptr, ptr @label_align, align 8, !tbaa !5
  %2 = icmp eq ptr %1, null
  br i1 %2, label %4, label %3

3:                                                ; preds = %0
  tail call void @free(ptr noundef nonnull %1)
  store ptr null, ptr @label_align, align 8, !tbaa !5
  br label %4

4:                                                ; preds = %3, %0
  %5 = tail call i32 @max_label_num() #25
  store i32 %5, ptr @max_labelno, align 4, !tbaa !20
  %6 = tail call i32 @get_first_label_num() #25
  store i32 %6, ptr @min_labelno, align 4, !tbaa !20
  %7 = load i32, ptr @max_labelno, align 4, !tbaa !20
  %8 = sub i32 %7, %6
  %9 = add i32 %8, 1
  %10 = sext i32 %9 to i64
  %11 = tail call ptr @xcalloc(i64 noundef %10, i64 noundef 4) #25
  store ptr %11, ptr @label_align, align 8, !tbaa !5
  %12 = load i32, ptr @optimize, align 4, !tbaa !20
  %13 = icmp eq i32 %12, 0
...
33:                                               ; preds = %23, %33
  ...
  br i1 %41, label %42, label %33, !llvm.loop !40

42:                                               ; preds = %33, %23
  %43 = phi i32 [ 0, %23 ], [ %38, %33 ]
  %44 = load ptr, ptr @compiler_params, align 8, !tbaa !5
...
89:                                               ; preds = %72
  %90 = load i32, ptr @align_labels_log, align 4, !tbaa !20
  %91 = load i32, ptr @align_labels_max_skip, align 4, !tbaa !20
  br label %92
...
92:                                               ; preds = %89, %128
  ...
  %97 = load ptr, ptr %65, align 8, !tbaa !5
  %98 = icmp eq ptr %97, null
  br i1 %98, label %101, label %99

99:                                               ; preds = %92
  %100 = load i32, ptr %97, align 8, !tbaa !52
  br label %101
...
104:                                              ; preds = %101
  ...
  %125 = load i32, ptr %97, align 8, !tbaa !52
  %126 = icmp ult i32 %93, %125
  br i1 %126, label %128, label %127

127:                                              ; preds = %104
  tail call void @fancy_abort(ptr noundef nonnull @.str.54, i32 noundef 738, ptr noundef nonnull @.str.12) #25
  br label %128
...
133:                                              ; preds = %130
  ...
  %144 = load ptr, ptr %138, align 8, !tbaa !46
...
148:                                              ; preds = %133
  %149 = load i32, ptr %144, align 8, !tbaa !47
...
151:                                              ; preds = %148
  ...
  %154 = load ptr, ptr %138, align 8, !tbaa !46
  br label %155
...
188:                                              ; preds = %179, %168
  %189 = load i32, ptr @align_jumps_log, align 4, !tbaa !20
...
205:                                              ; preds = %199
  %206 = load ptr, ptr @compiler_params, align 8, !tbaa !5
...
211:                                              ; preds = %205
  %212 = load i32, ptr @align_loops_log, align 4, !tbaa !20
  %213 = load ptr, ptr @dump_file, align 8, !tbaa !5
...
238:                                              ; preds = %75, %78, %222
  ...
  br i1 %246, label %247, label %64, !llvm.loop !62
...
define dso_local void @shorten_branches(ptr noundef %0) local_unnamed_addr #14 {
  ...
  %4 = load ptr, ptr @uid_shuid, align 8, !tbaa !5
  tail call void @free(ptr noundef %4)
  %5 = sext i32 %3 to i64
  %6 = shl nsw i64 %5, 2
  %7 = tail call ptr @xmalloc(i64 noundef %6) #25
  store ptr %7, ptr @uid_shuid, align 8, !tbaa !5
  %8 = load i32, ptr @max_labelno, align 4, !tbaa !20
  %9 = tail call i32 @max_label_num() #25
  %10 = icmp eq i32 %8, %9
  br i1 %10, label %33, label %11

11:                                               ; preds = %1
  %12 = load i32, ptr @max_labelno, align 4, !tbaa !20
  %13 = tail call i32 @max_label_num() #25
  store i32 %13, ptr @max_labelno, align 4, !tbaa !20
  %14 = load i32, ptr @min_labelno, align 4, !tbaa !20
  %15 = sub nsw i32 %13, %14
  %16 = add nsw i32 %15, 1
  %17 = sub nsw i32 %12, %14
  %18 = add nsw i32 %17, 1
  %19 = load ptr, ptr @label_align, align 8, !tbaa !5
  %20 = sext i32 %16 to i64
  %21 = shl nsw i64 %20, 2
  %22 = tail call ptr @xrealloc(ptr noundef %19, i64 noundef %21) #25
  store ptr %22, ptr @label_align, align 8, !tbaa !5
  %23 = icmp sgt i32 %12, %13
  br i1 %23, label %24, label %26

24:                                               ; preds = %11
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 888, ptr noundef nonnull @.str.12) #25
  %25 = load ptr, ptr @label_align, align 8, !tbaa !5
  br label %26
...
78:                                               ; preds = %72, %63, %68
  %79 = load i32, ptr @align_labels_log, align 4, !tbaa !20
...
84:                                               ; preds = %72
  %85 = load ptr, ptr @readonly_data_section, align 8, !tbaa !5
  %86 = load ptr, ptr @text_section, align 8, !tbaa !5
...
106:                                              ; preds = %78, %88, %84
  ...
  %110 = load ptr, ptr @label_align, align 8, !tbaa !5
  %111 = load i32, ptr %50, align 8, !tbaa !16
  %112 = load i32, ptr @min_labelno, align 4, !tbaa !20
  %113 = sub nsw i32 %111, %112
  %114 = sext i32 %113 to i64
  %115 = getelementptr inbounds %struct.label_alignment, ptr %110, i64 %114
  store i16 %109, ptr %115, align 2, !tbaa !28
  %116 = trunc i32 %107 to i16
  %117 = load i32, ptr %50, align 8, !tbaa !16
  %118 = sub nsw i32 %117, %112
  %119 = sext i32 %118 to i64
  %120 = getelementptr inbounds %struct.label_alignment, ptr %110, i64 %119, i32 1
  store i16 %116, ptr %120, align 2, !tbaa !30
  br label %121
...
121:                                              ; preds = %36, %106
  ...
  br i1 %124, label %125, label %36, !llvm.loop !63

125:                                              ; preds = %121, %33
  %126 = tail call ptr @xmalloc(i64 noundef %6) #25
  store ptr %126, ptr @insn_lengths, align 8, !tbaa !5
  store i32 %3, ptr @insn_lengths_max_uid, align 4, !tbaa !20
  %127 = tail call ptr @vec_heap_o_reserve_exact(ptr noundef null, i32 noundef %3, i64 noundef 8, i64 noundef 4) #25
  store ptr %127, ptr @insn_addresses_, align 8, !tbaa !5
  %128 = icmp eq ptr %127, null
  br i1 %128, label %136, label %129

129:                                              ; preds = %125
  %130 = load i32, ptr %127, align 4, !tbaa !64
...
138:                                              ; preds = %136, %129
  ...
  store ptr %140, ptr @insn_addresses_, align 8, !tbaa !5
  br label %141

141:                                              ; preds = %129, %138
  %142 = phi ptr [ %127, %129 ], [ %140, %138 ]
  store i32 %3, ptr %142, align 4, !tbaa !64
  ...
  store ptr %148, ptr @uid_align, align 8, !tbaa !5
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(128) %2, i8 0, i64 128, i1 false), !tbaa !5
...
162:                                              ; preds = %155
  %163 = load ptr, ptr %2, align 16, !tbaa !5
...
166:                                              ; preds = %155
  ...
  %173 = load ptr, ptr %2, align 16, !tbaa !5
...
204:                                              ; preds = %204, %193
  ...
  store <4 x ptr> %197, ptr %210, align 8, !tbaa !5
  %211 = getelementptr inbounds ptr, ptr %209, i64 -7
  store <4 x ptr> %199, ptr %211, align 8, !tbaa !5
  %212 = getelementptr inbounds ptr, ptr %209, i64 -11
  store <4 x ptr> %201, ptr %212, align 8, !tbaa !5
  %213 = getelementptr inbounds ptr, ptr %209, i64 -15
  store <4 x ptr> %203, ptr %213, align 8, !tbaa !5
  %214 = add nuw i64 %205, 16
  %215 = icmp eq i64 %214, %194
  br i1 %215, label %216, label %204, !llvm.loop !67
...
220:                                              ; preds = %218, %220
  ...
  store ptr %156, ptr %224, align 8, !tbaa !5
  %225 = icmp ugt i64 %221, 1
  br i1 %225, label %220, label %226, !llvm.loop !70
...
226:                                              ; preds = %220, %216, %177, %162, %166
  ...
  br i1 %229, label %230, label %155, !llvm.loop !71

230:                                              ; preds = %226, %141
  store i32 0, ptr @insn_current_address, align 4, !tbaa !20
  %231 = icmp eq ptr %0, null
  br i1 %231, label %236, label %232

232:                                              ; preds = %230
  %233 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  br label %237
...
236:                                              ; preds = %230, %234
  store i32 15, ptr @insn_current_align, align 4, !tbaa !20
  store i32 0, ptr @insn_current_address, align 4, !tbaa !20
  br label %607
...
257:                                              ; preds = %247
  ...
  %260 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  %261 = add i32 %259, -1
  %262 = add i32 %261, %260
  %263 = sub nsw i32 0, %259
  %264 = and i32 %262, %263
  %265 = sub nsw i32 %264, %260
  store i32 %265, ptr %243, align 4, !tbaa !20
  br label %266

266:                                              ; preds = %247, %257, %237
  %267 = phi i32 [ 0, %247 ], [ %265, %257 ], [ 0, %237 ]
  %268 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  ...
  store i32 %269, ptr %274, align 4, !tbaa !20
...
286:                                              ; preds = %280, %280
  %287 = load ptr, ptr @readonly_data_section, align 8, !tbaa !5
  %288 = load ptr, ptr @text_section, align 8, !tbaa !5
...
290:                                              ; preds = %286
  ...
  store i32 %303, ptr %243, align 4, !tbaa !20
  br label %411
...
331:                                              ; preds = %321, %317
  ...
  %335 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %336 = getelementptr inbounds i32, ptr %335, i64 %242
  store i32 %334, ptr %336, align 4, !tbaa !20
  br label %411
...
390:                                              ; preds = %388, %384
  ...
  %392 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %393 = sext i32 %350 to i64
  %394 = getelementptr inbounds i32, ptr %392, i64 %393
  store i32 %391, ptr %394, align 4, !tbaa !20
...
429:                                              ; preds = %421
  ...
  %439 = load i32, ptr @insn_current_align, align 4, !tbaa !20
  %440 = icmp slt i32 %439, %438
  br i1 %440, label %441, label %452

441:                                              ; preds = %429
  %442 = shl nuw i32 1, %438
  %443 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  %444 = add i32 %442, -1
  %445 = add i32 %444, %443
  %446 = sub nsw i32 0, %442
  %447 = and i32 %445, %446
  %448 = sub nsw i32 %447, %443
  %449 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %450 = sext i32 %425 to i64
  %451 = getelementptr inbounds i32, ptr %449, i64 %450
  store i32 %448, ptr %451, align 4, !tbaa !20
  store i32 %438, ptr @insn_current_align, align 4, !tbaa !20
  store i32 %447, ptr @insn_current_address, align 4, !tbaa !20
  br label %457

452:                                              ; preds = %429
  %453 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %454 = sext i32 %425 to i64
  %455 = getelementptr inbounds i32, ptr %453, i64 %454
  store i32 0, ptr %455, align 4, !tbaa !20
  %456 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  br label %457
...
457:                                              ; preds = %452, %441
  ...
  store i32 %459, ptr %464, align 4, !tbaa !20
  br label %597

465:                                              ; preds = %421
  %466 = load i32, ptr @insn_current_align, align 4, !tbaa !20
  %467 = icmp slt i32 %235, %466
  br i1 %467, label %468, label %469

468:                                              ; preds = %465
  store i32 %235, ptr @insn_current_align, align 4, !tbaa !20
  br label %469
...
469:                                              ; preds = %468, %465
  ...
  store i32 %476, ptr @insn_last_address, align 4, !tbaa !20
  %477 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  store i32 %477, ptr %475, align 4, !tbaa !20
...
491:                                              ; preds = %485
  ...
  %494 = load i32, ptr %493, align 8, !tbaa !25
  %495 = icmp sgt i32 %494, 0
  br i1 %495, label %496, label %597

496:                                              ; preds = %491
  %497 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %498 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  br label %499
...
499:                                              ; preds = %496, %499
  ...
  %506 = load i32, ptr %505, align 8, !tbaa !16
  ...
  store i32 %500, ptr %512, align 4, !tbaa !20
  %513 = getelementptr inbounds i32, ptr %497, i64 %511
  %514 = load i32, ptr %513, align 4, !tbaa !20
  %515 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  %516 = add nsw i32 %515, %514
  store i32 %516, ptr @insn_current_address, align 4, !tbaa !20
  %517 = add nuw nsw i64 %501, 1
  %518 = load ptr, ptr %492, align 8, !tbaa !16
  %519 = load i32, ptr %518, align 8, !tbaa !25
  %520 = sext i32 %519 to i64
  %521 = icmp slt i64 %517, %520
  br i1 %521, label %499, label %597, !llvm.loop !74

522:                                              ; preds = %485, %484
  %523 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
  %524 = getelementptr inbounds i32, ptr %523, i64 %474
  %525 = load i32, ptr %524, align 4, !tbaa !20
  %526 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  %527 = add nsw i32 %526, %525
  store i32 %527, ptr @insn_current_address, align 4, !tbaa !20
  br label %597
...
540:                                              ; preds = %535
  %541 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  br label %542
...
542:                                              ; preds = %540, %573
  ...
  %551 = load i32, ptr %550, align 8, !tbaa !16
  ...
  store i32 %543, ptr %557, align 4, !tbaa !20
...
561:                                              ; preds = %542
  %562 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
...
565:                                              ; preds = %542
  ...
  %567 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
...
571:                                              ; preds = %565
  ...
  store i32 %566, ptr %572, align 4, !tbaa !20
  br label %573
...
573:                                              ; preds = %561, %571, %565
  ...
  %577 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  %578 = add nsw i32 %577, %575
  store i32 %578, ptr @insn_current_address, align 4, !tbaa !20
  %579 = add nsw i32 %574, %547
  %580 = add nuw nsw i64 %544, 1
  %581 = load ptr, ptr %536, align 8, !tbaa !16
  %582 = load i32, ptr %581, align 8, !tbaa !25
  %583 = sext i32 %582 to i64
  %584 = icmp slt i64 %580, %583
  br i1 %584, label %542, label %589, !llvm.loop !75

585:                                              ; preds = %529, %528
  %586 = tail call i32 @insn_current_length(ptr noundef nonnull %422) #25
  %587 = load i32, ptr @insn_current_address, align 4, !tbaa !20
  %588 = add nsw i32 %587, %586
  store i32 %588, ptr @insn_current_address, align 4, !tbaa !20
  br label %589

589:                                              ; preds = %573, %535, %585
  %590 = phi i32 [ %586, %585 ], [ 0, %535 ], [ %579, %573 ]
  %591 = phi i32 [ %423, %585 ], [ %423, %535 ], [ %576, %573 ]
  %592 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
...
596:                                              ; preds = %589
  store i32 %590, ptr %593, align 4, !tbaa !20
  br label %597
...
597:                                              ; preds = %499, %491, %589, %596, %522, %457
  ...
  br i1 %601, label %602, label %421, !llvm.loop !76

602:                                              ; preds = %597
  %603 = load i32, ptr @optimize, align 4, !tbaa !20
  %604 = icmp ne i32 %603, 0
  %605 = icmp ne i32 %598, 0
  %606 = select i1 %604, i1 %605, i1 false
  br i1 %606, label %420, label %607, !llvm.loop !77
...
; Function Attrs: nofree norecurse nosync nounwind sspstrong memory(read, inaccessiblemem: none) uwtable
define dso_local i32 @asm_str_count(ptr nocapture noundef readonly %0) local_unnamed_addr #16 {
...
4:                                                ; preds = %1
  tail call void (ptr, ...) @error(ptr noundef nonnull @.str.13, ptr noundef %0) #25
  br label %19
...
5:                                                ; preds = %1
  ...
  store i64 %9, ptr %11, align 8, !tbaa !80
...
define dso_local ptr @remap_debug_filename(ptr noundef readonly %0) local_unnamed_addr #14 {
  %2 = load ptr, ptr @debug_prefix_maps, align 8, !tbaa !5
  %3 = icmp eq ptr %2, null
...
11:                                               ; preds = %4
  ...
  %14 = icmp eq ptr %13, null
  br i1 %14, label %28, label %4, !llvm.loop !84
...
15:                                               ; preds = %4
  ...
  %25 = load i64, ptr %19, align 8, !tbaa !82
...
define dso_local void @final_start_function(ptr nocapture readnone %0, ptr noundef %1, i32 %2) local_unnamed_addr #14 {
  store i32 0, ptr @block_depth, align 4, !tbaa !20
  store ptr null, ptr @this_is_asm_operands, align 8, !tbaa !5
  %4 = load i32, ptr @prologue_locator, align 4, !tbaa !20
  %5 = tail call ptr @locator_file(i32 noundef %4) #25
  store ptr %5, ptr @last_filename, align 8, !tbaa !5
  %6 = load i32, ptr @prologue_locator, align 4, !tbaa !20
  %7 = tail call i32 @locator_line(i32 noundef %6) #25
  store i32 %7, ptr @last_linenum, align 4, !tbaa !20
  store i32 0, ptr @discriminator, align 4, !tbaa !20
  store i32 0, ptr @last_discriminator, align 4, !tbaa !20
  store i32 %7, ptr @high_function_linenum, align 4, !tbaa !20
  store i32 %7, ptr @high_block_linenum, align 4, !tbaa !20
...
13:                                               ; preds = %3
  %14 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
  %15 = getelementptr inbounds %struct.gcc_debug_hooks, ptr %14, i64 0, i32 11
  %16 = load ptr, ptr %15, align 8, !tbaa !85
  %17 = load ptr, ptr @last_filename, align 8, !tbaa !5
...
31:                                               ; preds = %30, %27
  %32 = load i32, ptr @write_symbols, align 4, !tbaa !16
  %33 = icmp eq i32 %32, 0
...
41:                                               ; preds = %34, %31
  %42 = load i8, ptr @warn_frame_larger_than, align 1, !tbaa !16
  %43 = icmp eq i8 %42, 0
  br i1 %43, label %52, label %44

44:                                               ; preds = %41
  %45 = tail call i64 @get_frame_size() #25
  %46 = load i64, ptr @frame_larger_than_size, align 8, !tbaa !87
  %47 = icmp sgt i64 %45, %46
  br i1 %47, label %48, label %52

48:                                               ; preds = %44
  %49 = tail call i64 @get_frame_size() #25
  %50 = load i64, ptr @frame_larger_than_size, align 8, !tbaa !87
  %51 = tail call zeroext i8 (i32, ptr, ...) @warning(i32 noundef 99, ptr noundef nonnull @.str.14, i64 noundef %49, i64 noundef %50) #25
  br label %52

52:                                               ; preds = %48, %44, %41
  %53 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 14), align 8, !tbaa !88
...
11:                                               ; preds = %5
  %12 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
  %13 = getelementptr inbounds %struct.gcc_debug_hooks, ptr %12, i64 0, i32 15
  %14 = load ptr, ptr %13, align 8, !tbaa !100
  %15 = load i32, ptr @high_function_linenum, align 4, !tbaa !20
  tail call void %14(i32 noundef %15) #25
  br label %16

16:                                               ; preds = %11, %5
  %17 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 17), align 8, !tbaa !101
...
25:                                               ; preds = %16
  ...
  %29 = load i32, ptr @last_linenum, align 4, !tbaa !20
  %30 = load ptr, ptr @last_filename, align 8, !tbaa !5
...
42:                                               ; preds = %39
  %43 = load i32, ptr @last_linenum, align 4, !tbaa !20
  %44 = load ptr, ptr @last_filename, align 8, !tbaa !5
...
19:                                               ; preds = %15
  call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 1715, ptr noundef nonnull @.str.12) #25
  br label %25
...
define dso_local ptr @final_scan_insn(ptr noundef %0, ptr noundef %1, i32 %2, i32 %3, ptr noundef %4) local_unnamed_addr #14 {
  ...
  %14 = load i32, ptr @insn_counter, align 4, !tbaa !20
  %15 = add nsw i32 %14, 1
  store i32 %15, ptr @insn_counter, align 4, !tbaa !20
...
27:                                               ; preds = %24
  %28 = load i8, ptr @in_cold_section_p, align 1, !tbaa !16
  %29 = icmp eq i8 %28, 0
  %30 = zext i1 %29 to i8
  store i8 %30, ptr @in_cold_section_p, align 1, !tbaa !16
...
40:                                               ; preds = %34
  %41 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
...
46:                                               ; preds = %24
  %47 = load i32, ptr @flag_debug_asm, align 4, !tbaa !20
  %48 = icmp eq i32 %47, 0
...
49:                                               ; preds = %46
  ...
  %55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %50, ptr noundef nonnull @.str.16, ptr noundef nonnull @.str.17, i32 noundef %54)
  br label %56
...
64:                                               ; preds = %62, %60
  ...
  store i32 %69, ptr @discriminator, align 4, !tbaa !20
  br label %722

70:                                               ; preds = %24
  %71 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 11), align 8, !tbaa !106
  ...
  tail call void %71(ptr noundef %72, ptr noundef nonnull @.str.18, i64 noundef %75) #25
  br label %722

76:                                               ; preds = %24
  %77 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 11), align 8, !tbaa !106
  ...
  tail call void %77(ptr noundef %78, ptr noundef nonnull @.str.19, i64 noundef %81) #25
  br label %722

82:                                               ; preds = %24
  %83 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 15), align 8, !tbaa !107
...
95:                                               ; preds = %94, %91
  %96 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 16), align 8, !tbaa !108
...
109:                                              ; preds = %103
  %110 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
  %111 = getelementptr inbounds %struct.gcc_debug_hooks, ptr %110, i64 0, i32 12
  %112 = load ptr, ptr %111, align 8, !tbaa !109
  %113 = load i32, ptr @last_linenum, align 4, !tbaa !20
  %114 = load ptr, ptr @last_filename, align 8, !tbaa !5
...
119:                                              ; preds = %115
  %120 = or i32 %116, 4
  store i32 %120, ptr %4, align 4, !tbaa !20
  store i1 true, ptr @force_source_line, align 1
  br label %722

121:                                              ; preds = %115
  %122 = or i32 %116, 2
  store i32 %122, ptr %4, align 4, !tbaa !20
  br label %722
...
140:                                              ; preds = %134
  %141 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %142 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 8, i64 1, ptr %141)
  store i1 false, ptr @app_on, align 4
  br label %143

143:                                              ; preds = %134, %140
  %144 = load i32, ptr @block_depth, align 4, !tbaa !20
  %145 = add nsw i32 %144, 1
  store i32 %145, ptr @block_depth, align 4, !tbaa !20
  %146 = load i32, ptr @last_linenum, align 4, !tbaa !20
  store i32 %146, ptr @high_block_linenum, align 4, !tbaa !20
...
152:                                              ; preds = %143
  %153 = lshr i32 %138, 1
  %154 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
...
157:                                              ; preds = %152, %143
  %158 = load ptr, ptr %135, align 8, !tbaa !16
...
171:                                              ; preds = %166
  %172 = load i32, ptr %169, align 4, !tbaa !20
  ...
  store ptr %173, ptr @override_filename, align 8, !tbaa !5
  %174 = load i32, ptr %169, align 4, !tbaa !20
  ...
  store i32 %176, ptr @override_linenum, align 4, !tbaa !20
  br label %722
...
195:                                              ; preds = %188
  %196 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %197 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 8, i64 1, ptr %196)
  store i1 false, ptr @app_on, align 4
  br label %198

198:                                              ; preds = %188, %195
  %199 = load i32, ptr @block_depth, align 4, !tbaa !20
  %200 = add nsw i32 %199, -1
  store i32 %200, ptr @block_depth, align 4, !tbaa !20
  %201 = icmp sgt i32 %199, 0
  br i1 %201, label %203, label %202

202:                                              ; preds = %198
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 1978, ptr noundef nonnull @.str.12) #25
  br label %203
...
225:                                              ; preds = %218
  %226 = load i32, ptr %223, align 4, !tbaa !20
  call void @expand_location(ptr nonnull sret(%struct.expanded_location) align 8 %8, i32 noundef %226) #25
  %227 = load ptr, ptr %8, align 8, !tbaa !111
  store ptr %227, ptr @override_filename, align 8, !tbaa !5
  %228 = load i32, ptr %223, align 4, !tbaa !20
...
231:                                              ; preds = %218
  store ptr null, ptr @override_filename, align 8, !tbaa !5
  br label %232

232:                                              ; preds = %231, %225
  %233 = phi i32 [ 0, %231 ], [ %230, %225 ]
  store i32 %233, ptr @override_linenum, align 4, !tbaa !20
  br label %722

234:                                              ; preds = %24
  %235 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 11), align 8, !tbaa !106
  %236 = getelementptr inbounds %struct.rtx_def, ptr %0, i64 1, i32 1
  %237 = load i32, ptr %236, align 8, !tbaa !16
  %238 = sext i32 %237 to i64
  tail call void %235(ptr noundef %1, ptr noundef nonnull @.str.20, i64 noundef %238) #25
  br label %722

239:                                              ; preds = %24
  %240 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
245:                                              ; preds = %239
  %246 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
...
249:                                              ; preds = %24
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 2016, ptr noundef nonnull @.str.12) #25
  br label %722
...
254:                                              ; preds = %22
  ...
  %257 = load i32, ptr @max_labelno, align 4, !tbaa !20
  %258 = icmp sgt i32 %256, %257
  br i1 %258, label %290, label %259

259:                                              ; preds = %254
  %260 = load ptr, ptr @label_align, align 8, !tbaa !5
  %261 = load i32, ptr @min_labelno, align 4, !tbaa !20
  ...
  %268 = load i16, ptr %267, align 2, !tbaa !30
...
277:                                              ; preds = %275
  %278 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.21, i32 noundef %266)
  br label %290

279:                                              ; preds = %275
  %280 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.22, i32 noundef %266, i32 noundef %269)
...
288:                                              ; preds = %282
  %289 = tail call i64 @fwrite(ptr nonnull @.str.23, i64 12, i64 1, ptr %1)
  br label %290
...
300:                                              ; preds = %296
  %301 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
...
322:                                              ; preds = %316
  %323 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 24), align 8, !tbaa !117
  %324 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
  %325 = tail call ptr %323(ptr noundef %324) #25
  tail call void @switch_to_section(ptr noundef %325) #25
  %326 = load ptr, ptr %317, align 8, !tbaa !16
...
330:                                              ; preds = %322
  ...
  %332 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.24, i32 noundef %331)
  br label %333

333:                                              ; preds = %330, %322
  %334 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.24, i32 noundef 4)
  %335 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 11), align 8, !tbaa !106
  %336 = load i32, ptr %255, align 8, !tbaa !16
  %337 = sext i32 %336 to i64
  tail call void %335(ptr noundef %1, ptr noundef nonnull @.str.20, i64 noundef %337) #25
  br label %722
...
349:                                              ; preds = %346
  %350 = tail call i64 @fwrite(ptr nonnull @.str.57, i64 7, i64 1, ptr %1)
  tail call void @assemble_name(ptr noundef %1, ptr noundef %348) #25
  %351 = tail call i32 @fputc(i32 noundef 10, ptr noundef %1)
  br label %352

352:                                              ; preds = %349, %346
  %353 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 6), align 8, !tbaa !118
  tail call void %353(ptr noundef %1, ptr noundef %348) #25
  br label %354

354:                                              ; preds = %352, %346
  %355 = tail call i64 @fwrite(ptr nonnull @.str.58, i64 7, i64 1, ptr %1)
  tail call void @assemble_name(ptr noundef %1, ptr noundef %348) #25
  %356 = tail call i64 @fwrite(ptr nonnull @.str.59, i64 2, i64 1, ptr %1)
  %357 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.60, ptr noundef nonnull @.str.61)
  %358 = tail call i32 @putc(i32 noundef 10, ptr noundef %1)
  tail call void @assemble_name(ptr noundef %1, ptr noundef %348) #25
  %359 = tail call i64 @fwrite(ptr nonnull @.str.62, i64 2, i64 1, ptr %1)
  br label %722
...
361:                                              ; preds = %338
  %362 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 11), align 8, !tbaa !106
  %363 = load i32, ptr %255, align 8, !tbaa !16
  %364 = sext i32 %363 to i64
  tail call void %362(ptr noundef %1, ptr noundef nonnull @.str.20, i64 noundef %364) #25
  br label %722
...
365:                                              ; preds = %22
  ...
  store ptr null, ptr @current_insn_predicate, align 8, !tbaa !5
...
371:                                              ; preds = %365, %365
  %372 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 24), align 8, !tbaa !117
  %373 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
376:                                              ; preds = %371
  %377 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
397:                                              ; preds = %392
  %398 = load ptr, ptr %380, align 8, !tbaa !16
...
405:                                              ; preds = %392
  %406 = load ptr, ptr %390, align 8, !tbaa !16
  ...
  %413 = load ptr, ptr %380, align 8, !tbaa !16
...
418:                                              ; preds = %397, %405
  ...
  br i1 %420, label %421, label %392, !llvm.loop !119
...
423:                                              ; preds = %365
  %424 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
429:                                              ; preds = %423
  %430 = call fastcc zeroext i8 @notice_source_line(ptr noundef nonnull %0, ptr noundef nonnull %10), !range !120
  %431 = icmp eq i8 %430, 0
  br i1 %431, label %440, label %432

432:                                              ; preds = %429
  %433 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
  %434 = getelementptr inbounds %struct.gcc_debug_hooks, ptr %433, i64 0, i32 10
  %435 = load ptr, ptr %434, align 8, !tbaa !121
  %436 = load i32, ptr @last_linenum, align 4, !tbaa !20
  %437 = load ptr, ptr @last_filename, align 8, !tbaa !5
  %438 = load i32, ptr @last_discriminator, align 4, !tbaa !20
  %439 = load i8, ptr %10, align 1, !tbaa !16
...
451:                                              ; preds = %449
  %452 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
454:                                              ; preds = %449, %451
  ...
  %457 = load ptr, ptr %11, align 8, !tbaa.struct !122
  %458 = getelementptr inbounds i8, ptr %11, i64 8
  %459 = load i32, ptr %458, align 8, !tbaa.struct !123
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %11) #25
  %460 = load i8, ptr %457, align 1, !tbaa !16
...
464:                                              ; preds = %454
  %465 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %466 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %465, ptr noundef nonnull @.str.25, ptr noundef nonnull @.str.17, i32 noundef %459, ptr noundef nonnull %457)
  br label %467

467:                                              ; preds = %464, %454
  %468 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %469 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %468, ptr noundef nonnull @.str.26, ptr noundef nonnull %446)
  %470 = load i8, ptr %457, align 1, !tbaa !16
  %471 = icmp ne i8 %470, 0
  %472 = select i1 %471, i1 %462, i1 false
  br i1 %472, label %473, label %718

473:                                              ; preds = %467
  %474 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %475 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %474, ptr noundef nonnull @.str.27, ptr noundef nonnull @.str.17)
  br label %718
...
479:                                              ; preds = %476
  ...
  store i32 %480, ptr @insn_noperands, align 4, !tbaa !20
  store ptr %0, ptr @this_is_asm_operands, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %13) #25
  %485 = load i32, ptr %12, align 4, !tbaa !20
  call void @expand_location(ptr nonnull sret(%struct.expanded_location) align 8 %13, i32 noundef %485) #25
  %486 = load ptr, ptr %13, align 8, !tbaa.struct !122
  %487 = getelementptr inbounds i8, ptr %13, i64 8
  %488 = load i32, ptr %487, align 8, !tbaa.struct !123
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %13) #25
  %489 = load i8, ptr %484, align 1, !tbaa !16
...
493:                                              ; preds = %491
  %494 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
500:                                              ; preds = %496
  %501 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %502 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %501, ptr noundef nonnull @.str.25, ptr noundef nonnull @.str.17, i32 noundef %488, ptr noundef nonnull %486)
  call void @output_asm_insn(ptr noundef nonnull %484, ptr noundef nonnull %483)
  %503 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %504 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %503, ptr noundef nonnull @.str.27, ptr noundef nonnull @.str.17)
  br label %506
...
506:                                              ; preds = %505, %500, %479
  %507 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 38), align 8, !tbaa !124
  %508 = icmp eq ptr %507, null
  br i1 %508, label %511, label %509

509:                                              ; preds = %506
  %510 = load i32, ptr @insn_noperands, align 4, !tbaa !20
...
514:                                              ; preds = %512
  %515 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
521:                                              ; preds = %517
  store ptr %368, ptr @final_sequence, align 8, !tbaa !5
...
526:                                              ; preds = %521
  %527 = load i32, ptr %525, align 8, !tbaa !25
...
529:                                              ; preds = %526, %529
  ...
  %535 = load ptr, ptr %524, align 8, !tbaa !16
  %536 = load i32, ptr %535, align 8, !tbaa !25
  %537 = sext i32 %536 to i64
  %538 = icmp slt i64 %534, %537
  br i1 %538, label %529, label %539, !llvm.loop !125
...
539:                                              ; preds = %529, %521, %526
  ...
  %545 = load ptr, ptr %541, align 8, !tbaa !16
...
560:                                              ; preds = %560, %553
  ...
  br i1 %563, label %564, label %560, !llvm.loop !126

564:                                              ; preds = %560
  %565 = add nuw nsw i64 %554, 1
  %566 = load ptr, ptr %541, align 8, !tbaa !16
  %567 = load i32, ptr %566, align 8, !tbaa !25
  %568 = sext i32 %567 to i64
  %569 = icmp slt i64 %565, %568
  br i1 %569, label %553, label %721, !llvm.loop !127

570:                                              ; preds = %517
  %571 = load ptr, ptr %367, align 8, !tbaa !16
...
575:                                              ; preds = %570
  ...
  store i32 %576, ptr %572, align 8, !tbaa !16
  br label %577

577:                                              ; preds = %570, %575
  %578 = phi i32 [ %576, %575 ], [ %573, %570 ]
  tail call void @cleanup_subreg_operands(ptr noundef nonnull %0)
  %579 = load i32, ptr @flag_dump_rtl_in_asm, align 4, !tbaa !20
  %580 = icmp eq i32 %579, 0
  br i1 %580, label %584, label %581

581:                                              ; preds = %577
  store ptr @.str.17, ptr @print_rtx_head, align 8, !tbaa !5
  %582 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %583 = tail call i32 @print_rtl_single(ptr noundef %582, ptr noundef nonnull %0) #25
  store ptr @.str.15, ptr @print_rtx_head, align 8, !tbaa !5
  br label %584
...
587:                                              ; preds = %584
  tail call void @_fatal_insn_not_found(ptr noundef nonnull %0, ptr noundef nonnull @.str.11, i32 noundef 2588, ptr noundef nonnull @.str.12) #25
  br label %588

588:                                              ; preds = %587, %584
  %589 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 35), align 8, !tbaa !128
  %590 = tail call zeroext i8 %589() #25
  %591 = icmp eq i8 %590, 0
  br i1 %591, label %600, label %592

592:                                              ; preds = %588
  %593 = load ptr, ptr %367, align 8, !tbaa !16
...
597:                                              ; preds = %592
  ...
  store ptr %599, ptr @current_insn_predicate, align 8, !tbaa !5
  br label %600

600:                                              ; preds = %597, %592, %588
  store ptr %0, ptr @debug_insn, align 8, !tbaa !5
  store ptr %0, ptr @current_output_insn, align 8, !tbaa !5
...
614:                                              ; preds = %611
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 2629, ptr noundef nonnull @.str.12) #25
  br label %615
...
623:                                              ; preds = %616, %621
  ...
  br i1 %626, label %719, label %616, !llvm.loop !129

627:                                              ; preds = %608
  %628 = load i8, ptr %609, align 1, !tbaa !16
...
637:                                              ; preds = %634
  %638 = load ptr, ptr %367, align 8, !tbaa !16
  %639 = icmp eq ptr %638, %571
  br i1 %639, label %640, label %641

640:                                              ; preds = %637
  tail call void @_fatal_insn(ptr noundef nonnull @.str.28, ptr noundef nonnull %0, ptr noundef nonnull @.str.11, i32 noundef 2654, ptr noundef nonnull @.str.12) #25
  br label %641

641:                                              ; preds = %640, %637, %634
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 2660, ptr noundef nonnull @.str.12) #25
  br label %719
...
666:                                              ; preds = %646, %651, %655, %665, %661, %642
  ...
  %667 = load i32, ptr @flag_enable_icf_debug, align 4, !tbaa !20
...
695:                                              ; preds = %691
  %696 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
...
699:                                              ; preds = %682
  %700 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
  %701 = getelementptr inbounds %struct.gcc_debug_hooks, ptr %700, i64 0, i32 29
  %702 = load ptr, ptr %701, align 8, !tbaa !131
  %703 = load i32, ptr %366, align 8, !tbaa !16
  tail call void %702(i32 noundef %703) #25
  br label %704

704:                                              ; preds = %688, %673, %678, %699, %695, %691, %669, %666
  %705 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 38), align 8, !tbaa !124
  %706 = icmp eq ptr %705, null
  br i1 %706, label %710, label %707

707:                                              ; preds = %704
  %708 = load i8, ptr getelementptr inbounds (%struct.recog_data, ptr @recog_data, i64 0, i32 7), align 2, !tbaa !132
  %709 = sext i8 %708 to i32
  tail call void %705(ptr noundef %1, ptr noundef nonnull %0, ptr noundef nonnull @recog_data, i32 noundef %709) #25
  br label %710

710:                                              ; preds = %707, %704
  %711 = load ptr, ptr @final_sequence, align 8, !tbaa !5
...
717:                                              ; preds = %716, %713, %710
  store ptr null, ptr @debug_insn, align 8, !tbaa !5
  store ptr null, ptr @current_output_insn, align 8, !tbaa !5
  br label %718
...
10:                                               ; preds = %2
  ...
  %12 = load ptr, ptr %11, align 8, !tbaa !16
  %13 = load i32, ptr @which_alternative, align 4, !tbaa !20
...
19:                                               ; preds = %17
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 1736, ptr noundef nonnull @.str.12) #25
  br label %20
...
24:                                               ; preds = %2
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 1740, ptr noundef nonnull @.str.12) #25
  br label %25

25:                                               ; preds = %24, %20, %10, %7
  %26 = phi ptr [ @.str.15, %24 ], [ %23, %20 ], [ %16, %10 ], [ %9, %7 ]
  ret ptr %26
}
...
define internal fastcc void @profile_after_prologue(ptr noundef %0) unnamed_addr #14 {
  %2 = load i8, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 35), align 1, !tbaa !136
  %3 = icmp eq i8 %2, 0
...
10:                                               ; preds = %4
  %11 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 88, i32 2), align 8, !tbaa !145
...
23:                                               ; preds = %17
  %24 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 88, i32 21), align 8, !tbaa !147
...
35:                                               ; preds = %31
  ...
  tail call void (ptr, ptr, ...) @asm_fprintf(ptr noundef %0, ptr noundef nonnull @.str.55, ptr noundef %40)
  br label %41
...
47:                                               ; preds = %43
  ...
  tail call void (ptr, ptr, ...) @asm_fprintf(ptr noundef %0, ptr noundef nonnull @.str.55, ptr noundef %52)
  br label %53
...
60:                                               ; preds = %53
  ...
  tail call void (ptr, ptr, ...) @asm_fprintf(ptr noundef %0, ptr noundef nonnull @.str.56, ptr noundef %65)
  br label %70
...
75:                                               ; preds = %71
  ...
  tail call void (ptr, ptr, ...) @asm_fprintf(ptr noundef %0, ptr noundef nonnull @.str.56, ptr noundef %80)
  br label %81
...
define internal fastcc zeroext i8 @notice_source_line(ptr noundef %0, ptr nocapture noundef writeonly %1) unnamed_addr #14 {
  %3 = load ptr, ptr @override_filename, align 8, !tbaa !5
  %4 = icmp eq ptr %3, null
  br i1 %4, label %7, label %5

5:                                                ; preds = %2
  %6 = load i32, ptr @override_linenum, align 4, !tbaa !20
  br label %11
...
22:                                               ; preds = %11
  ...
  store ptr %13, ptr @last_filename, align 8, !tbaa !5
  store i32 %12, ptr @last_linenum, align 4, !tbaa !20
  %23 = load i32, ptr @discriminator, align 4, !tbaa !20
  store i32 %23, ptr @last_discriminator, align 4, !tbaa !20
  store i8 1, ptr %1, align 1, !tbaa !16
  %24 = load i32, ptr @high_block_linenum, align 4
  %25 = tail call i32 @llvm.smax.i32(i32 %12, i32 %24)
  store i32 %25, ptr @high_block_linenum, align 4, !tbaa !20
  %26 = load i32, ptr @high_function_linenum, align 4
  %27 = tail call i32 @llvm.smax.i32(i32 %12, i32 %26)
  store i32 %27, ptr @high_function_linenum, align 4, !tbaa !20
  br label %28
...
42:                                               ; preds = %35
  %43 = load i32, ptr @flag_verbose_asm, align 4, !tbaa !20
  %44 = icmp eq i32 %43, 0
...
46:                                               ; preds = %45, %42
  %47 = load i32, ptr @flag_print_asm_name, align 4, !tbaa !20
  %48 = icmp eq i32 %47, 0
  br i1 %48, label %75, label %49

49:                                               ; preds = %46
  %50 = load ptr, ptr @debug_insn, align 8, !tbaa !5
...
52:                                               ; preds = %49
  ...
  %61 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %56, ptr noundef nonnull @.str.66, ptr noundef nonnull @.str.17, i32 noundef %57, ptr noundef %60)
  %62 = getelementptr inbounds [0 x %struct.insn_data], ptr @insn_data, i64 0, i64 %58, i32 6
  %63 = load i8, ptr %62, align 2, !tbaa !150
  %64 = icmp sgt i8 %63, 1
  br i1 %64, label %65, label %70

65:                                               ; preds = %52
  %66 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %67 = load i32, ptr @which_alternative, align 4, !tbaa !20
  %68 = add nsw i32 %67, 1
  %69 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %66, ptr noundef nonnull @.str.67, i32 noundef %68)
  br label %70

70:                                               ; preds = %65, %52
  %71 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %72 = load ptr, ptr @debug_insn, align 8, !tbaa !5
  %73 = call fastcc i32 @get_attr_length_1(ptr noundef %72, ptr noundef nonnull @insn_default_length)
  %74 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %71, ptr noundef nonnull @.str.68, i32 noundef %73)
  store ptr null, ptr @debug_insn, align 8, !tbaa !5
  br label %75
...
81:                                               ; preds = %78
  %82 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
89:                                               ; preds = %85
  %90 = load i32, ptr @ix86_isa_flags, align 4, !tbaa !20
  %91 = and i32 %90, 32
  %92 = icmp eq i32 %91, 0
...
97:                                               ; preds = %95
  call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.33)
  br label %98

98:                                               ; preds = %95, %97
  %99 = load i32, ptr @dialect_number, align 4, !tbaa !20
...
107:                                              ; preds = %104
  ...
  br i1 %109, label %110, label %104, !llvm.loop !152
...
117:                                              ; preds = %112, %115
  ...
  br i1 %120, label %121, label %101, !llvm.loop !153
...
125:                                              ; preds = %121
  call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.34)
  br label %286
...
133:                                              ; preds = %128
  ...
  br i1 %135, label %286, label %128, !llvm.loop !154
...
141:                                              ; preds = %139
  %142 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %143 = call i32 @putc(i32 noundef 125, ptr noundef %142)
  br label %286

144:                                              ; preds = %35
  %145 = load i8, ptr %40, align 1, !tbaa !16
...
147:                                              ; preds = %144
  ...
  %149 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %150 = call i32 @putc(i32 noundef 37, ptr noundef %149)
  br label %286

151:                                              ; preds = %144
  %152 = getelementptr inbounds i8, ptr %37, i64 2
  %153 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %154 = load i32, ptr @insn_counter, align 4, !tbaa !20
  %155 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %153, ptr noundef nonnull @.str.35, i32 noundef %154)
  br label %286
...
156:                                              ; preds = %144
  ...
  %160 = load i16, ptr %159, align 2, !tbaa !155
...
169:                                              ; preds = %164
  call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.36)
  br label %239

170:                                              ; preds = %164
  %171 = load ptr, ptr @this_is_asm_operands, align 8, !tbaa !5
...
177:                                              ; preds = %170
  call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.37)
  br label %239
...
197:                                              ; preds = %193, %189
  ...
  %200 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %5, ptr noundef nonnull dereferenceable(1) @.str.40, ptr noundef nonnull @.str.20, i32 noundef %199)
  br label %202

201:                                              ; preds = %193, %189
  call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.41)
  br label %202

202:                                              ; preds = %197, %201
  %203 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
215:                                              ; preds = %210
  ...
  %217 = load ptr, ptr %211, align 8, !tbaa !5
  call void @output_addr_const(ptr noundef %216, ptr noundef %217)
  br label %239

218:                                              ; preds = %210
  %219 = load ptr, ptr %211, align 8, !tbaa !5
...
220:                                              ; preds = %178
  ...
  %226 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
227:                                              ; preds = %220
  ...
  %231 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %226, ptr noundef nonnull @.str.38, i64 noundef %230)
  br label %239

232:                                              ; preds = %220
  %233 = call i32 @putc(i32 noundef 45, ptr noundef %226)
  %234 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %235 = load ptr, ptr %221, align 8, !tbaa !5
...
243:                                              ; preds = %239
  ...
  store i32 %244, ptr %247, align 4, !tbaa !20
  br label %248

248:                                              ; preds = %243, %239
  %249 = phi i32 [ %39, %239 ], [ %245, %243 ]
  store i8 1, ptr %240, align 1, !tbaa !16
  %250 = load ptr, ptr %8, align 8, !tbaa !5
...
254:                                              ; preds = %251
  ...
  %256 = load ptr, ptr @this_is_asm_operands, align 8, !tbaa !5
...
270:                                              ; preds = %266
  ...
  store i32 %271, ptr %274, align 4, !tbaa !20
  br label %275

275:                                              ; preds = %270, %266
  %276 = phi i32 [ %39, %266 ], [ %272, %270 ]
  store i8 1, ptr %267, align 1, !tbaa !16
...
282:                                              ; preds = %278
  call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.39)
  br label %286
...
291:                                              ; preds = %78, %286, %121, %85
  ...
  br i1 %296, label %297, label %35, !llvm.loop !156

297:                                              ; preds = %291, %28
  %298 = phi i32 [ 0, %28 ], [ %293, %291 ]
  %299 = load i32, ptr @flag_verbose_asm, align 4, !tbaa !20
...
302:                                              ; preds = %301, %297
  %303 = load i32, ptr @flag_print_asm_name, align 4, !tbaa !20
  %304 = icmp eq i32 %303, 0
  br i1 %304, label %331, label %305

305:                                              ; preds = %302
  %306 = load ptr, ptr @debug_insn, align 8, !tbaa !5
...
308:                                              ; preds = %305
  ...
  %312 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %313 = load i32, ptr %309, align 8, !tbaa !16
  ...
  %317 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %312, ptr noundef nonnull @.str.66, ptr noundef nonnull @.str.17, i32 noundef %313, ptr noundef %316)
  %318 = getelementptr inbounds [0 x %struct.insn_data], ptr @insn_data, i64 0, i64 %314, i32 6
  %319 = load i8, ptr %318, align 2, !tbaa !150
  %320 = icmp sgt i8 %319, 1
  br i1 %320, label %321, label %326

321:                                              ; preds = %308
  %322 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %323 = load i32, ptr @which_alternative, align 4, !tbaa !20
  %324 = add nsw i32 %323, 1
  %325 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %322, ptr noundef nonnull @.str.67, i32 noundef %324)
  br label %326

326:                                              ; preds = %321, %308
  %327 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %328 = load ptr, ptr @debug_insn, align 8, !tbaa !5
  %329 = call fastcc i32 @get_attr_length_1(ptr noundef %328, ptr noundef nonnull @insn_default_length)
  %330 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %327, ptr noundef nonnull @.str.68, i32 noundef %329)
  store ptr null, ptr @debug_insn, align 8, !tbaa !5
  br label %331

331:                                              ; preds = %326, %305, %302
  %332 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
...
define dso_local void @cleanup_subreg_operands(ptr noundef %0) local_unnamed_addr #14 {
  ...
  %3 = load i8, ptr getelementptr inbounds (%struct.recog_data, ptr @recog_data, i64 0, i32 7), align 2, !tbaa !132
  %4 = icmp sgt i8 %3, 0
  br i1 %4, label %8, label %5

5:                                                ; preds = %26, %1
  %6 = load i8, ptr getelementptr inbounds (%struct.recog_data, ptr @recog_data, i64 0, i32 8), align 1, !tbaa !157
  %7 = icmp sgt i8 %6, 0
...
26:                                               ; preds = %19, %16, %24
  ...
  %28 = load i8, ptr getelementptr inbounds (%struct.recog_data, ptr @recog_data, i64 0, i32 7), align 2, !tbaa !132
  %29 = sext i8 %28 to i64
  %30 = icmp slt i64 %27, %29
  br i1 %30, label %8, label %5, !llvm.loop !158
...
44:                                               ; preds = %31, %38, %41
  ...
  %46 = load i8, ptr getelementptr inbounds (%struct.recog_data, ptr @recog_data, i64 0, i32 8), align 1, !tbaa !157
  %47 = sext i8 %46 to i64
  %48 = icmp slt i64 %45, %47
  br i1 %48, label %31, label %49, !llvm.loop !159

49:                                               ; preds = %44, %5
  %50 = load i8, ptr %2, align 1, !tbaa !16
  %51 = icmp eq i8 %50, 0
...
5:                                                ; preds = %1
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 1783, ptr noundef nonnull @.str.12) #25
  br label %6
...
16:                                               ; preds = %12
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 1791, ptr noundef nonnull @.str.12) #25
  br label %17
...
45:                                               ; preds = %33
  %46 = load i32, ptr %22, align 8, !tbaa !16
  br label %47
...
define dso_local void @output_operand_lossage(ptr noundef %0, ...) local_unnamed_addr #14 {
  ...
  %5 = load ptr, ptr @this_is_asm_operands, align 8, !tbaa !5
  %6 = icmp eq ptr %5, null
  %7 = select i1 %6, ptr @.str.30, ptr @.str.29
  %8 = call i32 (ptr, ptr, ...) @asprintf(ptr noundef nonnull %2, ptr noundef nonnull @.str.31, ptr noundef nonnull %7, ptr noundef %0) #25
  %9 = load ptr, ptr %2, align 8, !tbaa !5
  %10 = call i32 @vasprintf(ptr noundef nonnull %3, ptr noundef %9, ptr noundef nonnull %4) #25
  %11 = load ptr, ptr @this_is_asm_operands, align 8, !tbaa !5
  %12 = icmp eq ptr %11, null
  %13 = load ptr, ptr %3, align 8, !tbaa !5
  br i1 %12, label %15, label %14

14:                                               ; preds = %1
  call void (ptr, ptr, ...) @error_for_asm(ptr noundef nonnull %11, ptr noundef nonnull @.str.32, ptr noundef %13) #25
  br label %16

15:                                               ; preds = %1
  call void (ptr, ...) @internal_error(ptr noundef nonnull @.str.32, ptr noundef %13) #25
  br label %16
...
6:                                                ; preds = %3
  ...
  %13 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %14 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef nonnull @.str.63, i32 noundef 9, ptr noundef nonnull @.str.17)
...
16:                                               ; preds = %6
  ...
  %19 = icmp eq i32 %18, 0
  %20 = select i1 %19, ptr @.str.15, ptr @.str.64
...
35:                                               ; preds = %31
  ...
  %37 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %36, ptr noundef nonnull @.str.65, i32 noundef %29)
  br label %38
...
40:                                               ; preds = %38, %73
  ...
  %49 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %48, ptr noundef nonnull @.str.63, i32 noundef 44, ptr noundef nonnull @.str.15)
...
51:                                               ; preds = %40
  ...
  %54 = icmp eq i32 %53, 0
  %55 = select i1 %54, ptr @.str.15, ptr @.str.64
...
70:                                               ; preds = %66
  %71 = load ptr, ptr @asm_out_file, align 8, !tbaa !5
  %72 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %71, ptr noundef nonnull @.str.65, i32 noundef %64)
  br label %73
...
73:                                               ; preds = %58, %62, %66, %70, %51
  ...
  %75 = icmp eq i64 %74, %7
  br i1 %75, label %76, label %40, !llvm.loop !161
...
18:                                               ; preds = %10, %14
  ...
  %21 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) @.str.40, ptr noundef nonnull @.str.20, i32 noundef %20)
  br label %23

22:                                               ; preds = %10, %14
  tail call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.41)
  br label %23
...
32:                                               ; preds = %5, %29
  ...
  %36 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(1) @.str.40, ptr noundef nonnull @.str.20, i32 noundef %35)
...
37:                                               ; preds = %5
  ...
  %40 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.38, i64 noundef %39)
  br label %130
...
53:                                               ; preds = %47
  %54 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.42, i64 noundef %50, i64 noundef %52)
  br label %130
...
57:                                               ; preds = %55
  %58 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.43, i64 noundef %52)
  br label %130

59:                                               ; preds = %55
  %60 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.38, i64 noundef %52)
  br label %130

61:                                               ; preds = %44
  tail call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.44)
  br label %130

62:                                               ; preds = %5
  %63 = getelementptr inbounds %struct.rtx_def, ptr %7, i64 0, i32 1
  %64 = load i64, ptr %63, align 8, !tbaa !16
  %65 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.43, i64 noundef %64)
  br label %130
...
117:                                              ; preds = %104, %112
  %118 = load ptr, ptr @targetm, align 8, !tbaa !163
  %119 = tail call i32 @fputs(ptr noundef %118, ptr noundef %0)
  %120 = load ptr, ptr %108, align 8, !tbaa !16
  tail call void @output_addr_const(ptr noundef %0, ptr noundef %120)
  %121 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 1), align 8, !tbaa !164
...
129:                                              ; preds = %126
  tail call void (ptr, ...) @output_operand_lossage(ptr noundef nonnull @.str.47)
  br label %130
...
21:                                               ; preds = %17
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 3496, ptr noundef nonnull @.str.12) #25
  br label %24
...
define dso_local void @asm_fprintf(ptr nocapture noundef %0, ptr nocapture noundef readonly %1, ...) local_unnamed_addr #14 {
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %4) #25
  call void @llvm.va_start(ptr nonnull %4)
  store i8 37, ptr %3, align 1, !tbaa !16
...
16:                                               ; preds = %11
  %17 = load i32, ptr @dialect_number, align 4, !tbaa !20
...
31:                                               ; preds = %27
  ...
  br i1 %33, label %34, label %27, !llvm.loop !165
...
46:                                               ; preds = %42
  ...
  br i1 %48, label %49, label %42, !llvm.loop !165
...
51:                                               ; preds = %42, %49
  ...
  br i1 %58, label %235, label %24, !llvm.loop !166
...
63:                                               ; preds = %59
  ...
  br i1 %65, label %254, label %59, !llvm.loop !167

66:                                               ; preds = %11
  %67 = getelementptr inbounds i8, ptr %13, i64 2
  %68 = load i8, ptr %14, align 1, !tbaa !16
...
88:                                               ; preds = %66, %88
  ...
  %94 = load i8, ptr %91, align 1, !tbaa !16
  ...
  br i1 %100, label %75, label %88, !llvm.loop !168
...
124:                                              ; preds = %117, %117, %117, %117, %117, %117, %117
  ...
  store i8 %120, ptr %119, align 1, !tbaa !16
...
140:                                              ; preds = %117
  ...
  %143 = load i8, ptr %118, align 1, !tbaa !16
...
159:                                              ; preds = %117
  ...
  store i8 %120, ptr %119, align 1, !tbaa !16
  %161 = load i8, ptr %118, align 1, !tbaa !16
...
165:                                              ; preds = %159
  store i8 108, ptr %160, align 1, !tbaa !16
  ...
  store i8 %167, ptr %164, align 1, !tbaa !16
...
214:                                              ; preds = %117
  %215 = load i8, ptr %118, align 1, !tbaa !16
...
229:                                              ; preds = %117
  %230 = load ptr, ptr @user_label_prefix, align 8, !tbaa !5
  %231 = call i32 @fputs(ptr noundef %230, ptr noundef %0)
  br label %254

232:                                              ; preds = %117
  call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 3812, ptr noundef nonnull @.str.12) #25
  br label %254
...
243:                                              ; preds = %239
  ...
  br i1 %245, label %246, label %239, !llvm.loop !165

246:                                              ; preds = %243
  %247 = load i8, ptr %244, align 1, !tbaa !16
  br label %248
...
257:                                              ; preds = %254, %214
  ...
  br i1 %260, label %261, label %11, !llvm.loop !170
...
33:                                               ; preds = %28, %24
  ...
  store ptr %39, ptr %2, align 8, !tbaa !5
  br label %61
...
40:                                               ; preds = %28
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %41, i64 32, i1 false), !tbaa.struct !171
  ...
  %44 = load i64, ptr %5, align 16, !tbaa !87
...
47:                                               ; preds = %40
  ...
  store i64 %48, ptr %5, align 16, !tbaa !87
  br label %49
...
define dso_local i32 @leaf_function_p() local_unnamed_addr #14 {
  %1 = load i8, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 35), align 1, !tbaa !136
  %2 = icmp ne i8 %1, 0
...
9:                                                ; preds = %34, %6
  %10 = load ptr, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 27), align 8, !tbaa !16
  %11 = icmp eq ptr %10, null
...
34:                                               ; preds = %17, %20, %26
  ...
  br i1 %37, label %9, label %12, !llvm.loop !172
...
62:                                               ; preds = %45, %48, %54
  ...
  br i1 %65, label %66, label %38, !llvm.loop !173
...
define dso_local i32 @final_forward_branch_p(ptr nocapture noundef readonly %0) local_unnamed_addr #14 {
  %2 = load ptr, ptr @uid_shuid, align 8, !tbaa !5
  %3 = icmp eq ptr %2, null
  br i1 %3, label %4, label %6

4:                                                ; preds = %1
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 4014, ptr noundef nonnull @.str.12) #25
  %5 = load ptr, ptr @uid_shuid, align 8, !tbaa !5
  br label %6
...
23:                                               ; preds = %6
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 4018, ptr noundef nonnull @.str.12) #25
  br label %24
...
define dso_local void @debug_flush_symbol_queue() local_unnamed_addr #14 {
  %1 = load i32, ptr @debug_nesting, align 4, !tbaa !20
  %2 = add nsw i32 %1, 1
  store i32 %2, ptr @debug_nesting, align 4, !tbaa !20
  %3 = load i32, ptr @symbol_queue_index, align 4, !tbaa !20
  %4 = icmp sgt i32 %3, 0
  br i1 %4, label %5, label %42

5:                                                ; preds = %0
  %6 = load ptr, ptr @symbol_queue, align 8, !tbaa !5
  br label %7
...
7:                                                ; preds = %5, %7
  ...
  %24 = load ptr, ptr @symbol_queue, align 8, !tbaa !5
  ...
  %36 = load i32, ptr @symbol_queue_index, align 4, !tbaa !20
  %37 = sext i32 %36 to i64
  %38 = icmp slt i64 %35, %37
  br i1 %38, label %7, label %39, !llvm.loop !174

39:                                               ; preds = %7
  %40 = load i32, ptr @debug_nesting, align 4, !tbaa !20
  %41 = add nsw i32 %40, -1
  br label %42

42:                                               ; preds = %39, %0
  %43 = phi i32 [ %41, %39 ], [ %1, %0 ]
  store i32 0, ptr @symbol_queue_index, align 4, !tbaa !20
  store i32 %43, ptr @debug_nesting, align 4, !tbaa !20
  ret void
}
...
define dso_local void @debug_queue_symbol(ptr noundef %0) local_unnamed_addr #14 {
  %2 = load i32, ptr @symbol_queue_index, align 4, !tbaa !20
  %3 = load i32, ptr @symbol_queue_size, align 4, !tbaa !20
  %4 = icmp slt i32 %2, %3
  %5 = load ptr, ptr @symbol_queue, align 8, !tbaa !5
  br i1 %4, label %12, label %6

6:                                                ; preds = %1
  %7 = add nsw i32 %3, 10
  store i32 %7, ptr @symbol_queue_size, align 4, !tbaa !20
  %8 = sext i32 %7 to i64
  %9 = shl nsw i64 %8, 3
  %10 = tail call ptr @xrealloc(ptr noundef %5, i64 noundef %9) #25
  store ptr %10, ptr @symbol_queue, align 8, !tbaa !5
  %11 = load i32, ptr @symbol_queue_index, align 4, !tbaa !20
  br label %12
...
12:                                               ; preds = %6, %1
  ...
  %14 = phi ptr [ %10, %6 ], [ %5, %1 ]
  %15 = add nsw i32 %13, 1
  store i32 %15, ptr @symbol_queue_index, align 4, !tbaa !20
...
define dso_local void @debug_free_queue() local_unnamed_addr #12 {
  %1 = load ptr, ptr @symbol_queue, align 8, !tbaa !5
  %2 = icmp eq ptr %1, null
  br i1 %2, label %4, label %3

3:                                                ; preds = %0
  tail call void @free(ptr noundef nonnull %1)
  store ptr null, ptr @symbol_queue, align 8, !tbaa !5
  store i32 0, ptr @symbol_queue_size, align 4, !tbaa !20
  br label %4
...
15:                                               ; preds = %10
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 4250, ptr noundef nonnull @.str.12) #25
  br label %16
...
22:                                               ; preds = %16
  tail call void @fancy_abort(ptr noundef nonnull @.str.11, i32 noundef 4252, ptr noundef nonnull @.str.12) #25
  br label %23
...
55:                                               ; preds = %51, %23
  ...
  store i8 0, ptr @user_defined_section_attribute, align 1, !tbaa !16
  call void @free_reg_info() #25
  %57 = load i32, ptr @quiet_flag, align 4, !tbaa !20
  %58 = icmp eq i32 %57, 0
...
62:                                               ; preds = %55, %59
  %63 = load i8, ptr @timevar_enable, align 1, !tbaa !16
  %64 = icmp eq i8 %63, 0
...
66:                                               ; preds = %65, %62
  %67 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
72:                                               ; preds = %66
  %73 = load ptr, ptr @debug_hooks, align 8, !tbaa !5
...
76:                                               ; preds = %66, %72
  %77 = load i8, ptr @timevar_enable, align 1, !tbaa !16
  %78 = icmp eq i8 %77, 0
...
80:                                               ; preds = %79, %76
  %81 = load ptr, ptr @global_trees, align 16, !tbaa !5
...
91:                                               ; preds = %80
  %92 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 25), align 8, !tbaa !176
...
100:                                              ; preds = %91, %96
  ...
  %107 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
119:                                              ; preds = %111
  %120 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 0, i32 26), align 8, !tbaa !177
...
124:                                              ; preds = %119
  ...
  %125 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
...
define internal i32 @rest_of_clean_state() #14 {
  %1 = load i32, ptr @flag_dump_unnumbered, align 4, !tbaa !20
  %2 = load i32, ptr @flag_dump_noaddr, align 4, !tbaa !20
  %3 = load ptr, ptr @flag_dump_final_insns, align 8, !tbaa !5
  %4 = icmp eq ptr %3, null
...
8:                                                ; preds = %5
  %9 = load ptr, ptr @flag_dump_final_insns, align 8, !tbaa !5
...
13:                                               ; preds = %5
  ...
  %23 = icmp eq i32 %22, 2
  %24 = icmp eq i32 %22, 0
  %25 = select i1 %24, ptr @.str.73, ptr @.str.15
  ...
  store i32 1, ptr @flag_dump_unnumbered, align 4, !tbaa !20
  store i32 1, ptr @flag_dump_noaddr, align 4, !tbaa !20
  %28 = load ptr, ptr @flag_compare_debug_opt, align 8, !tbaa !5
...
33:                                               ; preds = %13
  ...
  store i32 %35, ptr @dump_flags, align 4, !tbaa !20
  br label %36

36:                                               ; preds = %13, %33
  store i8 1, ptr @final_insns_dump_p, align 1, !tbaa !16
...
47:                                               ; preds = %39, %44
  ...
  br i1 %52, label %53, label %39, !llvm.loop !178
...
59:                                               ; preds = %57, %59
  ...
  br i1 %64, label %80, label %59, !llvm.loop !179
...
78:                                               ; preds = %73, %73, %73, %73, %76
  ...
  br i1 %79, label %80, label %65, !llvm.loop !179
...
82:                                               ; preds = %80
  store i32 %2, ptr @flag_dump_noaddr, align 4, !tbaa !20
  store i32 %1, ptr @flag_dump_unnumbered, align 4, !tbaa !20
  store i8 0, ptr @final_insns_dump_p, align 1, !tbaa !16
  %83 = tail call i32 @fclose(ptr noundef nonnull %54)
  %84 = icmp eq i32 %83, 0
  br i1 %84, label %90, label %85

85:                                               ; preds = %82
  %86 = load ptr, ptr @flag_dump_final_insns, align 8, !tbaa !5
...
90:                                               ; preds = %82, %85, %80
  store i32 0, ptr @flag_rerun_cse_after_global_opts, align 4, !tbaa !20
  store i32 0, ptr @reload_completed, align 4, !tbaa !20
  store i32 0, ptr @epilogue_completed, align 4, !tbaa !20
  store i32 0, ptr @regstack_completed, align 4, !tbaa !20
  %91 = load ptr, ptr @uid_shuid, align 8, !tbaa !5
...
94:                                               ; preds = %93, %90
  %95 = load ptr, ptr @insn_lengths, align 8, !tbaa !5
...
98:                                               ; preds = %97, %94
  %99 = load ptr, ptr @insn_addresses_, align 8, !tbaa !5
...
102:                                              ; preds = %101, %98
  store ptr null, ptr @insn_addresses_, align 8, !tbaa !5
  %103 = load ptr, ptr @uid_align, align 8, !tbaa !5
...
106:                                              ; preds = %102, %105
  ...
  %108 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 49), align 8, !tbaa !180
...
112:                                              ; preds = %106
  %113 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 23), align 8, !tbaa !181
  %114 = load i32, ptr getelementptr inbounds (%struct.rtl_data, ptr @x_rtl, i64 0, i32 22), align 4, !tbaa !182
  %115 = tail call i32 @llvm.umax.i32(i32 %114, i32 %113)
  %116 = load ptr, ptr @current_function_decl, align 8, !tbaa !5
  %117 = tail call ptr @cgraph_rtl_info(ptr noundef %116) #25
  store i32 %115, ptr %117, align 4, !tbaa !183
  br label %118
...
!23 = !{ptr @insn_default_length, ptr @insn_min_length}
!24 = distinct !{!24, !22}
!25 = !{!26, !11, i64 0}
!26 = !{!"rtvec_def", !11, i64 0, !7, i64 8}
!27 = distinct !{!27, !22}
!28 = !{!29, !13, i64 0}
!29 = !{!"label_alignment", !13, i64 0, !13, i64 2}
!30 = !{!29, !13, i64 2}
!31 = distinct !{!31, !22}
!32 = !{!33, !6, i64 8}
...
!40 = distinct !{!40, !22}
!41 = !{!42, !11, i64 8}
!42 = !{!"param_info", !6, i64 0, !11, i64 8, !7, i64 12, !11, i64 16, !11, i64 20, !6, i64 24}
!43 = !{!44, !6, i64 0}
!44 = !{!"rtl_bb_info", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !11, i64 32}
!45 = !{!38, !11, i64 80}
!46 = !{!38, !6, i64 24}
!47 = !{!48, !11, i64 0}
!48 = !{!"loop", !11, i64 0, !11, i64 4, !6, i64 8, !6, i64 16, !49, i64 24, !11, i64 32, !11, i64 36, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !50, i64 80, !50, i64 96, !7, i64 112, !7, i64 113, !7, i64 116, !6, i64 120, !6, i64 128, !7, i64 136, !6, i64 144}
!49 = !{!"lpt_decision", !7, i64 0, !11, i64 4}
!50 = !{!"", !12, i64 0, !12, i64 8}
!51 = !{!38, !11, i64 84}
!52 = !{!53, !11, i64 0}
!53 = !{!"VEC_edge_base", !11, i64 0, !11, i64 4, !7, i64 8}
!54 = !{!55, !11, i64 48}
!55 = !{!"edge_def", !6, i64 0, !6, i64 8, !7, i64 16, !6, i64 24, !6, i64 32, !11, i64 40, !11, i64 44, !11, i64 48, !11, i64 52, !12, i64 56}
!56 = !{!55, !6, i64 0}
!57 = !{!55, !11, i64 52}
!58 = distinct !{!58, !22}
!59 = !{!48, !6, i64 48}
...
!63 = distinct !{!63, !22}
!64 = !{!65, !11, i64 0}
!65 = !{!"VEC_int_base", !11, i64 0, !11, i64 4, !7, i64 8}
!66 = !{!65, !11, i64 4}
!67 = distinct !{!67, !22, !68, !69}
!68 = !{!"llvm.loop.isvectorized", i32 1}
!69 = !{!"llvm.loop.unroll.runtime.disable"}
!70 = distinct !{!70, !22, !68}
!71 = distinct !{!71, !22}
!72 = distinct !{!72, !22}
!73 = distinct !{!73, !22}
!74 = distinct !{!74, !22}
...
!77 = distinct !{!77, !22}
!78 = !{!79, !6, i64 0}
!79 = !{!"debug_prefix_map", !6, i64 0, !6, i64 8, !12, i64 16, !12, i64 24, !6, i64 32}
!80 = !{!79, !12, i64 16}
!81 = !{!79, !6, i64 8}
!82 = !{!79, !12, i64 24}
!83 = !{!79, !6, i64 32}
!84 = distinct !{!84, !22}
!85 = !{!86, !6, i64 88}
!86 = !{!"gcc_debug_hooks", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !6, i64 80, !6, i64 88, !6, i64 96, !6, i64 104, !6, i64 112, !6, i64 120, !6, i64 128, !6, i64 136, !6, i64 144, !6, i64 152, !6, i64 160, !6, i64 168, !6, i64 176, !6, i64 184, !6, i64 192, !6, i64 200, !6, i64 208, !6, i64 216, !6, i64 224, !6, i64 232, !6, i64 240, !11, i64 248}
!87 = !{!12, !12, i64 0}
!88 = !{!89, !6, i64 160}
!89 = !{!"gcc_target", !90, i64 0, !92, i64 368, !93, i64 664, !11, i64 744, !6, i64 752, !6, i64 760, !6, i64 768, !6, i64 776, !6, i64 784, !6, i64 792, !6, i64 800, !6, i64 808, !6, i64 816, !6, i64 824, !6, i64 832, !6, i64 840, !6, i64 848, !6, i64 856, !6, i64 864, !6, i64 872, !6, i64 880, !6, i64 888, !6, i64 896, !6, i64 904, !6, i64 912, !6, i64 920, !6, i64 928, !6, i64 936, !6, i64 944, !6, i64 952, !6, i64 960, !6, i64 968, !6, i64 976, !6, i64 984, !6, i64 992, !6, i64 1000, !6, i64 1008, !6, i64 1016, !6, i64 1024, !6, i64 1032, !6, i64 1040, !6, i64 1048, !6, i64 1056, !12, i64 1064, !12, i64 1072, !6, i64 1080, !6, i64 1088, !6, i64 1096, !6, i64 1104, !6, i64 1112, !6, i64 1120, !6, i64 1128, !6, i64 1136, !6, i64 1144, !6, i64 1152, !6, i64 1160, !6, i64 1168, !94, i64 1176, !6, i64 1232, !6, i64 1240, !6, i64 1248, !6, i64 1256, !6, i64 1264, !6, i64 1272, !6, i64 1280, !6, i64 1288, !6, i64 1296, !6, i64 1304, !6, i64 1312, !6, i64 1320, !6, i64 1328, !6, i64 1336, !6, i64 1344, !6, i64 1352, !6, i64 1360, !6, i64 1368, !6, i64 1376, !6, i64 1384, !6, i64 1392, !6, i64 1400, !6, i64 1408, !6, i64 1416, !6, i64 1424, !6, i64 1432, !6, i64 1440, !6, i64 1448, !6, i64 1456, !12, i64 1464, !95, i64 1472, !6, i64 1664, !6, i64 1672, !6, i64 1680, !6, i64 1688, !6, i64 1696, !6, i64 1704, !6, i64 1712, !6, i64 1720, !6, i64 1728, !6, i64 1736, !6, i64 1744, !6, i64 1752, !6, i64 1760, !6, i64 1768, !6, i64 1776, !96, i64 1784, !97, i64 1792, !98, i64 1896, !99, i64 1968, !6, i64 2016, !7, i64 2024, !7, i64 2025, !7, i64 2026, !7, i64 2027, !7, i64 2028, !7, i64 2029, !7, i64 2030, !7, i64 2031, !7, i64 2032, !7, i64 2033, !7, i64 2034, !7, i64 2035}
!90 = !{!"asm_out", !6, i64 0, !6, i64 8, !6, i64 16, !91, i64 24, !91, i64 56, !6, i64 88, !6, i64 96, !6, i64 104, !6, i64 112, !6, i64 120, !6, i64 128, !6, i64 136, !6, i64 144, !6, i64 152, !6, i64 160, !6, i64 168, !6, i64 176, !6, i64 184, !6, i64 192, !6, i64 200, !6, i64 208, !6, i64 216, !6, i64 224, !6, i64 232, !6, i64 240, !6, i64 248, !6, i64 256, !6, i64 264, !6, i64 272, !6, i64 280, !6, i64 288, !6, i64 296, !6, i64 304, !6, i64 312, !6, i64 320, !6, i64 328, !6, i64 336, !6, i64 344, !6, i64 352, !6, i64 360}
!91 = !{!"asm_int_op", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24}
!92 = !{!"sched", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !6, i64 80, !6, i64 88, !6, i64 96, !6, i64 104, !6, i64 112, !6, i64 120, !6, i64 128, !6, i64 136, !6, i64 144, !6, i64 152, !6, i64 160, !6, i64 168, !6, i64 176, !6, i64 184, !6, i64 192, !6, i64 200, !6, i64 208, !6, i64 216, !6, i64 224, !6, i64 232, !6, i64 240, !6, i64 248, !6, i64 256, !6, i64 264, !6, i64 272, !6, i64 280, !6, i64 288}
!93 = !{!"vectorize", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72}
!94 = !{!"addr_space", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48}
!95 = !{!"calls", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !6, i64 80, !6, i64 88, !6, i64 96, !6, i64 104, !6, i64 112, !6, i64 120, !6, i64 128, !6, i64 136, !6, i64 144, !6, i64 152, !6, i64 160, !6, i64 168, !6, i64 176, !6, i64 184}
!96 = !{!"c", !6, i64 0}
!97 = !{!"cxx", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !6, i64 80, !6, i64 88, !6, i64 96}
!98 = !{!"emutls", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !7, i64 64, !7, i64 65}
!99 = !{!"target_option_hooks", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40}
!100 = !{!86, !6, i64 120}
!101 = !{!89, !6, i64 184}
!102 = !{!86, !6, i64 104}
!103 = distinct !{!103, !22}
...
!120 = !{i8 0, i8 2}
!121 = !{!86, !6, i64 80}
!122 = !{i64 0, i64 8, !5, i64 8, i64 4, !20, i64 12, i64 4, !20, i64 16, i64 1, !16}
!123 = !{i64 0, i64 4, !20, i64 4, i64 4, !20, i64 8, i64 1, !16}
!124 = !{!89, !6, i64 352}
!125 = distinct !{!125, !22}
!126 = distinct !{!126, !22}
!127 = distinct !{!127, !22}
...
!131 = !{!86, !6, i64 232}
!132 = !{!133, !7, i64 1086}
!133 = !{!"recog_data", !7, i64 0, !7, i64 240, !7, i64 480, !7, i64 720, !7, i64 840, !7, i64 960, !7, i64 1072, !7, i64 1086, !7, i64 1087, !7, i64 1088, !7, i64 1089, !6, i64 1120}
!134 = !{!135, !7, i64 35}
!135 = !{!"insn_data", !6, i64 0, !7, i64 8, !6, i64 16, !6, i64 24, !7, i64 32, !7, i64 33, !7, i64 34, !7, i64 35}
!136 = !{!137, !7, i64 471}
!137 = !{!"rtl_data", !138, i64 0, !139, i64 40, !140, i64 96, !141, i64 112, !143, i64 208, !144, i64 248, !11, i64 312, !6, i64 320, !6, i64 328, !6, i64 336, !6, i64 344, !6, i64 352, !6, i64 360, !6, i64 368, !6, i64 376, !6, i64 384, !6, i64 392, !12, i64 400, !6, i64 408, !6, i64 416, !6, i64 424, !11, i64 432, !11, i64 436, !11, i64 440, !11, i64 444, !11, i64 448, !11, i64 452, !6, i64 456, !7, i64 464, !7, i64 465, !7, i64 466, !7, i64 467, !7, i64 468, !7, i64 469, !7, i64 470, !7, i64 471, !7, i64 472, !7, i64 473, !7, i64 474, !7, i64 475, !7, i64 476, !7, i64 477, !7, i64 478, !7, i64 479, !7, i64 480, !7, i64 481, !7, i64 482, !7, i64 483, !7, i64 484, !7, i64 485}
!138 = !{!"expr_status", !11, i64 0, !11, i64 4, !11, i64 8, !6, i64 16, !6, i64 24, !6, i64 32}
!139 = !{!"emit_status", !11, i64 0, !11, i64 4, !6, i64 8, !6, i64 16, !6, i64 24, !11, i64 32, !11, i64 36, !11, i64 40, !11, i64 44, !6, i64 48}
!140 = !{!"varasm_status", !6, i64 0, !11, i64 8}
!141 = !{!"incoming_args", !11, i64 0, !11, i64 4, !11, i64 8, !6, i64 16, !142, i64 24, !6, i64 88}
!142 = !{!"ix86_args", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !11, i64 32, !11, i64 36, !11, i64 40, !11, i64 44, !11, i64 48, !11, i64 52, !11, i64 56, !7, i64 60}
!143 = !{!"function_subsections", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32}
!144 = !{!"rtl_eh", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !7, i64 48}
!145 = !{!89, !6, i64 1488}
!146 = !{!33, !6, i64 56}
!147 = !{!89, !6, i64 1640}
!148 = !{!33, !11, i64 108}
...
!169 = distinct !{!169, !22}
!170 = distinct !{!170, !22}
!171 = !{i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 0, i64 4, !20, i64 8, i64 24, !16}
!172 = distinct !{!172, !22}
!173 = distinct !{!173, !22}
!174 = distinct !{!174, !22}
!175 = !{!86, !6, i64 128}
...
!182 = !{!137, !11, i64 436}
!183 = !{!184, !11, i64 0}
!184 = !{!"cgraph_rtl_info", !11, i64 0}
!185 = !{!186, !6, i64 0}
!186 = !{!"reg_attrs", !6, i64 0, !12, i64 8}
!187 = !{!188, !6, i64 0}
!188 = !{!"mem_attrs", !6, i64 0, !6, i64 8, !6, i64 16, !11, i64 24, !11, i64 28, !7, i64 32}
!189 = distinct !{!189, !22}
