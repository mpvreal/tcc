...
99:                                               ; preds = %95
  %100 = load i32, ptr %97, align 8, !tbaa !23
...
112:                                              ; preds = %99, %112
  ...
  %121 = load ptr, ptr %109, align 8, !tbaa !16
  %122 = load i32, ptr %121, align 8, !tbaa !23
  %123 = sext i32 %122 to i64
  %124 = icmp slt i64 %120, %123
  br i1 %124, label %112, label %126, !llvm.loop !25
...
126:                                              ; preds = %112, %99, %125, %92, %88, %95, %82, %82, %82, %82, %82, %82, %82, %82, %82
  ...
  br i1 %134, label %82, label %135, !llvm.loop !26
...
21:                                               ; preds = %15
  ...
  %24 = call i32 @rtx_equal_p_cb(ptr noundef %22, ptr noundef %23, ptr noundef nonnull %2), !range !27
  br label %183
...
43:                                               ; preds = %39
  ...
  %45 = load i8, ptr %44, align 8, !tbaa !28
...
131:                                              ; preds = %140
  ...
  br i1 %139, label %140, label %181, !llvm.loop !30
...
140:                                              ; preds = %129, %131
  ...
  %151 = call i32 @rtx_equal_p_cb(ptr noundef %144, ptr noundef %150, ptr noundef %2), !range !27
...
153:                                              ; preds = %91
  ...
  %162 = call i32 @rtx_equal_p_cb(ptr noundef %157, ptr noundef %161, ptr noundef %2), !range !27
...
181:                                              ; preds = %131, %129, %91, %180, %97, %107, %153, %177, %175, %91, %91
  ...
  br i1 %182, label %91, label %183, !llvm.loop !31
...
99:                                               ; preds = %105
  ...
  br i1 %104, label %105, label %135, !llvm.loop !32
...
105:                                              ; preds = %97, %99
  ...
  %110 = load ptr, ptr %93, align 8, !tbaa !16
  %111 = getelementptr inbounds %struct.rtvec_def, ptr %110, i64 0, i32 1, i64 %106
  %112 = load ptr, ptr %111, align 8, !tbaa !5
  %113 = tail call i32 @rtx_equal_p(ptr noundef %109, ptr noundef %112), !range !27
...
115:                                              ; preds = %71
  ...
  %120 = tail call i32 @rtx_equal_p(ptr noundef %117, ptr noundef %119), !range !27
...
135:                                              ; preds = %99, %97, %71, %134, %77, %83, %115, %131, %129, %71, %71
  ...
  br i1 %136, label %71, label %137, !llvm.loop !33
...
!27 = !{i32 0, i32 2}
!28 = !{!29, !7, i64 32}
!29 = !{!"mem_attrs", !6, i64 0, !6, i64 8, !6, i64 16, !11, i64 24, !11, i64 28, !7, i64 32}
!30 = distinct !{!30, !22}
!31 = distinct !{!31, !22}
!32 = distinct !{!32, !22}
!33 = distinct !{!33, !22}
