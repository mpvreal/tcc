...
34:                                               ; preds = %34, %32
  ...
  %54 = icmp eq i32 %51, 0
  br i1 %54, label %55, label %34, !llvm.loop !25
...
define internal i32 @floatformat_ibm_long_double_is_valid(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) #7 {
...
45:                                               ; preds = %45, %43
  ...
  %65 = icmp eq i32 %62, 0
  br i1 %65, label %66, label %45, !llvm.loop !25
...
74:                                               ; preds = %74, %66
  ...
  %94 = icmp eq i32 %91, 0
  br i1 %94, label %95, label %74, !llvm.loop !25
...
103:                                              ; preds = %95
  %104 = tail call fastcc i32 @mant_bits_set(ptr noundef nonnull %4, ptr noundef nonnull %1), !range !31
...
110:                                              ; preds = %108
  %111 = tail call fastcc i32 @mant_bits_set(ptr noundef nonnull %4, ptr noundef nonnull %96), !range !31
  %112 = xor i32 %111, 1
  br label %214
...
147:                                              ; preds = %130, %145
  ...
  br i1 %150, label %172, label %130, !llvm.loop !33
...
185:                                              ; preds = %181
  ...
  %188 = add i32 %124, -1
  %189 = add i32 %188, %187
  %190 = tail call fastcc i64 @get_field(ptr noundef %1, i32 noundef %6, i32 noundef %8, i32 noundef %189, i32 noundef 1), !range !34
...
211:                                              ; preds = %193
  %212 = tail call fastcc i32 @mant_bits_set(ptr noundef nonnull %4, ptr noundef nonnull %96), !range !31
  %213 = xor i32 %212, 1
  br label %214
...
define dso_local void @floatformat_to_double(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef writeonly %2) local_unnamed_addr #8 {
...
35:                                               ; preds = %35, %33
  ...
  %55 = icmp eq i32 %52, 0
  br i1 %55, label %56, label %35, !llvm.loop !25
...
62:                                               ; preds = %56
  %63 = tail call fastcc i32 @mant_bits_set(ptr noundef nonnull %0, ptr noundef nonnull %1), !range !31
  %64 = icmp eq i32 %63, 0
...
125:                                              ; preds = %125, %123
  ...
  br i1 %145, label %146, label %125, !llvm.loop !25
...
153:                                              ; preds = %146
  %154 = load i32, ptr %95, align 4, !tbaa !36
  %155 = add i32 %103, %154
  %156 = sub i32 %96, %155
  br label %160
...
160:                                              ; preds = %157, %153
  ...
  br i1 %168, label %97, label %169, !llvm.loop !38
...
176:                                              ; preds = %169, %62
  ...
  store double %190, ptr %2, align 8, !tbaa !39
  ret void
}
...
30:                                               ; preds = %30, %28
  ...
  %50 = icmp eq i32 %47, 0
  br i1 %50, label %51, label %30, !llvm.loop !25
...
37:                                               ; preds = %63
  ...
  br i1 %39, label %15, label %118, !llvm.loop !41
...
42:                                               ; preds = %42, %40
  ...
  %62 = icmp eq i32 %59, 0
  br i1 %62, label %63, label %42, !llvm.loop !25
...
66:                                               ; preds = %115
  ...
  br i1 %68, label %69, label %118, !llvm.loop !41
...
94:                                               ; preds = %94, %92
  ...
  br i1 %114, label %115, label %94, !llvm.loop !25
...
define dso_local void @floatformat_from_double(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef %2) local_unnamed_addr #11 {
  ...
  %5 = load double, ptr %1, align 8, !tbaa !39
...
11:                                               ; preds = %3
  ...
  %31 = and i8 %30, %26
  %32 = or i8 %31, %28
  store i8 %32, ptr %23, align 1, !tbaa !16
...
40:                                               ; preds = %37
  ...
  %64 = xor i32 %63, -1
  %65 = shl i32 %64, %57
  %66 = load i8, ptr %61, align 1, !tbaa !16
  ...
  store i8 %76, ptr %61, align 1, !tbaa !16
  %77 = sub i32 %46, %62
  %78 = icmp eq i32 %77, 0
...
83:                                               ; preds = %83, %79
  ...
  store i8 %100, ptr %90, align 1, !tbaa !16
  %101 = zext i32 %84 to i64
  %102 = lshr i64 %86, %101
  %103 = sub i32 %87, %84
  %104 = tail call i32 @llvm.umin.i32(i32 %103, i32 8)
  %105 = icmp eq i32 %103, 0
  br i1 %105, label %328, label %83, !llvm.loop !42
...
113:                                              ; preds = %106
  ...
  %115 = load i32, ptr %0, align 8, !tbaa !20
  ...
  %136 = xor i32 %135, -1
  %137 = shl i32 %136, %129
  %138 = load i8, ptr %133, align 1, !tbaa !16
  ...
  store i8 %148, ptr %133, align 1, !tbaa !16
  %149 = sub i32 %120, %134
...
155:                                              ; preds = %155, %151
  ...
  %164 = xor i32 %163, -1
  %165 = load i8, ptr %162, align 1, !tbaa !16
  ...
  store i8 %172, ptr %162, align 1, !tbaa !16
  %173 = zext i32 %156 to i64
  %174 = lshr i64 %158, %173
  %175 = sub i32 %159, %156
  %176 = tail call i32 @llvm.umin.i32(i32 %175, i32 8)
  %177 = icmp eq i32 %175, 0
  br i1 %177, label %228, label %155, !llvm.loop !42

178:                                              ; preds = %106
  %179 = load i32, ptr %0, align 8, !tbaa !20
  %180 = load i32, ptr %6, align 4, !tbaa !22
  ...
  %199 = xor i32 %198, -1
  %200 = shl i32 %199, %192
  %201 = load i8, ptr %196, align 1, !tbaa !16
...
209:                                              ; preds = %209, %207
  ...
  %217 = load i8, ptr %215, align 1, !tbaa !16
  ...
  br i1 %222, label %223, label %209, !llvm.loop !42

223:                                              ; preds = %209, %178
  %224 = load i32, ptr %109, align 4, !tbaa !36
  %225 = add i32 %108, -1
  %226 = add i32 %225, %224
...
237:                                              ; preds = %233, %325
  ...
  %246 = load i32, ptr %230, align 8, !tbaa !32
  %247 = icmp eq i32 %238, %246
  br i1 %247, label %248, label %258

248:                                              ; preds = %237
  %249 = load i32, ptr %236, align 4, !tbaa !37
  %250 = icmp eq i32 %249, 1
  br i1 %250, label %251, label %258

251:                                              ; preds = %248
  %252 = load i32, ptr %109, align 4, !tbaa !36
...
264:                                              ; preds = %258, %260, %255
  ...
  %267 = load i32, ptr %0, align 8, !tbaa !20
  %268 = load i32, ptr %6, align 4, !tbaa !22
  ...
  %283 = xor i32 %282, -1
  %284 = shl i32 %283, %276
  %285 = load i8, ptr %280, align 1, !tbaa !16
  ...
  store i8 %295, ptr %280, align 1, !tbaa !16
...
302:                                              ; preds = %302, %298
  ...
  %311 = xor i32 %310, -1
  %312 = load i8, ptr %309, align 1, !tbaa !16
  ...
  br i1 %324, label %325, label %302, !llvm.loop !42

325:                                              ; preds = %302, %264
  %326 = sub nsw i32 %238, %265
  %327 = icmp sgt i32 %326, 0
  br i1 %327, label %237, label %328, !llvm.loop !44
...
!19 = !{!10, !11, i64 0}
!20 = !{!21, !7, i64 0}
!21 = !{!"floatformat", !7, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !11, i64 32, !7, i64 36, !6, i64 40, !6, i64 48, !6, i64 56}
!22 = !{!21, !11, i64 4}
!23 = !{!21, !11, i64 12}
!24 = !{!21, !11, i64 16}
