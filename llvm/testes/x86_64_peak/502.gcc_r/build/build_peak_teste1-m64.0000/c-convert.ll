...
24:                                               ; preds = %20
  %25 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 89), align 8, !tbaa !23
...
28:                                               ; preds = %24
  ...
  %29 = load ptr, ptr @global_trees, align 16, !tbaa !5
  br label %99
...
33:                                               ; preds = %30
  %34 = load ptr, ptr getelementptr inbounds (%struct.gcc_target, ptr @targetm, i64 0, i32 95), align 8, !tbaa !35
...
47:                                               ; preds = %43
  ...
  br i1 %52, label %39, label %53, !llvm.loop !36
...
65:                                               ; preds = %62
  ...
  %66 = load ptr, ptr @global_trees, align 16, !tbaa !5
  br label %99
...
72:                                               ; preds = %67
  %73 = load i32, ptr @input_location, align 4, !tbaa !20
...
86:                                               ; preds = %67, %67
  %87 = load ptr, ptr getelementptr inbounds (%struct.lang_hooks, ptr @lang_hooks, i64 0, i32 24), align 8, !tbaa !37
