...
define dso_local void @statistics_fini_pass() local_unnamed_addr #9 {
  %1 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
12:                                               ; preds = %8
  ...
  %18 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
22:                                               ; preds = %12
  tail call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 87, ptr noundef nonnull @.str.6) #18
  %23 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
26:                                               ; preds = %22, %12
  ...
  %28 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  %29 = icmp ult i32 %27, %28
  %30 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
36:                                               ; preds = %26
  ...
  store ptr %40, ptr @statistics_hashes, align 8, !tbaa !5
  %41 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  ...
  store i32 %37, ptr @nr_statistics_hashes, align 4, !tbaa !20
...
48:                                               ; preds = %36, %31
  ...
  %51 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
57:                                               ; preds = %53, %8, %5
  %58 = load ptr, ptr @statistics_dump_file, align 8, !tbaa !5
  %59 = icmp eq ptr %58, null
  br i1 %59, label %102, label %60

60:                                               ; preds = %57
  %61 = load i32, ptr @statistics_dump_flags, align 4, !tbaa !20
  %62 = and i32 %61, 24
  %63 = icmp eq i32 %62, 0
  br i1 %63, label %64, label %102

64:                                               ; preds = %60
  %65 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
69:                                               ; preds = %64
  tail call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 87, ptr noundef nonnull @.str.6) #18
  %70 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
73:                                               ; preds = %69, %64
  ...
  %75 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  %76 = icmp ult i32 %74, %75
  %77 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
83:                                               ; preds = %73
  ...
  store ptr %87, ptr @statistics_hashes, align 8, !tbaa !5
  %88 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  ...
  store i32 %84, ptr @nr_statistics_hashes, align 4, !tbaa !20
...
95:                                               ; preds = %83, %78
  ...
  %98 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
102:                                              ; preds = %100, %60, %57
  %103 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
107:                                              ; preds = %102
  tail call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 87, ptr noundef nonnull @.str.6) #18
  %108 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
111:                                              ; preds = %107, %102
  ...
  %113 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  %114 = icmp ult i32 %112, %113
  %115 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
121:                                              ; preds = %111
  ...
  store ptr %125, ptr @statistics_hashes, align 8, !tbaa !5
  %126 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  ...
  store i32 %122, ptr @nr_statistics_hashes, align 4, !tbaa !20
...
133:                                              ; preds = %121, %116
  ...
  %136 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
16:                                               ; preds = %10
  ...
  %19 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.10, ptr noundef %15, i32 noundef %18, i64 noundef %8)
  br label %22

20:                                               ; preds = %10
  %21 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.11, ptr noundef %15, i64 noundef %8)
  br label %22
...
10:                                               ; preds = %2
  ...
  %12 = load i8, ptr %11, align 4, !tbaa !28
  %13 = icmp eq i8 %12, 0
  %14 = load ptr, ptr @statistics_dump_file, align 8, !tbaa !5
  %15 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
33:                                               ; preds = %21, %26
  ...
  %35 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.12, i32 noundef %17, ptr noundef %19, ptr noundef %20, i32 noundef %23, ptr noundef %34, i64 noundef %8)
  br label %49
...
46:                                               ; preds = %36, %39
  ...
  %48 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.13, i32 noundef %17, ptr noundef %19, ptr noundef %20, ptr noundef %47, i64 noundef %8)
  br label %49

49:                                               ; preds = %46, %33
  %50 = load i64, ptr %4, align 8, !tbaa !25
  store i64 %50, ptr %6, align 8, !tbaa !27
  br label %51
...
define dso_local void @statistics_fini() local_unnamed_addr #9 {
  %1 = load ptr, ptr @statistics_dump_file, align 8, !tbaa !5
  %2 = icmp eq ptr %1, null
  br i1 %2, label %35, label %3

3:                                                ; preds = %0
  %4 = load i32, ptr @statistics_dump_flags, align 4, !tbaa !20
  %5 = and i32 %4, 16
  %6 = icmp ne i32 %5, 0
...
10:                                               ; preds = %3, %25
  ...
  %12 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
20:                                               ; preds = %16
  %21 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
25:                                               ; preds = %10, %16, %20
  ...
  %27 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  %28 = zext i32 %27 to i64
  %29 = icmp ult i64 %26, %28
  br i1 %29, label %10, label %30, !llvm.loop !34

30:                                               ; preds = %25
  %31 = load ptr, ptr @statistics_dump_file, align 8, !tbaa !5
  br label %32

32:                                               ; preds = %30, %3
  %33 = phi ptr [ %31, %30 ], [ %1, %3 ]
  %34 = load i32, ptr @statistics_dump_nr, align 4, !tbaa !20
...
7:                                                ; preds = %2
  ...
  %10 = icmp eq i8 %9, 0
  %11 = load ptr, ptr @statistics_dump_file, align 8, !tbaa !5
...
17:                                               ; preds = %7
  ...
  %20 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %11, ptr noundef nonnull @.str.14, i32 noundef %13, ptr noundef %15, ptr noundef %16, i32 noundef %19, i64 noundef %5)
  br label %23

21:                                               ; preds = %7
  %22 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %11, ptr noundef nonnull @.str.15, i32 noundef %13, ptr noundef %15, ptr noundef %16, i64 noundef %5)
  br label %23
...
define dso_local void @statistics_early_init() local_unnamed_addr #9 {
  %1 = tail call i32 @dump_register(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.4, i32 noundef 512) #18
  store i32 %1, ptr @statistics_dump_nr, align 4, !tbaa !20
  ret void
}
...
define dso_local void @statistics_init() local_unnamed_addr #9 {
  %1 = load i32, ptr @statistics_dump_nr, align 4, !tbaa !20
  %2 = tail call ptr @dump_begin(i32 noundef %1, ptr noundef null) #18
  store ptr %2, ptr @statistics_dump_file, align 8, !tbaa !5
  %3 = load i32, ptr @statistics_dump_nr, align 4, !tbaa !20
  ...
  store i32 %6, ptr @statistics_dump_flags, align 4, !tbaa !20
  ret void
}
...
13:                                               ; preds = %3
  %14 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
20:                                               ; preds = %18
  tail call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 87, ptr noundef nonnull @.str.6) #18
  %21 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
24:                                               ; preds = %20, %18
  ...
  %26 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  %27 = icmp ult i32 %25, %26
  %28 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
34:                                               ; preds = %24
  ...
  store ptr %38, ptr @statistics_hashes, align 8, !tbaa !5
  %39 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  ...
  store i32 %35, ptr @nr_statistics_hashes, align 4, !tbaa !20
...
46:                                               ; preds = %34, %29
  ...
  %49 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
57:                                               ; preds = %51
  ...
  %61 = load ptr, ptr %54, align 8, !tbaa !5
  ...
  store i8 0, ptr %63, align 4, !tbaa !28
...
65:                                               ; preds = %51, %57
  ...
  %68 = load i8, ptr %67, align 4, !tbaa !28
  %69 = icmp eq i8 %68, 0
  br i1 %69, label %71, label %70

70:                                               ; preds = %65
  call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 303, ptr noundef nonnull @.str.6) #18
  br label %71
...
71:                                               ; preds = %65, %70
  ...
  %75 = add i64 %74, %72
  store i64 %75, ptr %73, align 8, !tbaa !25
  %76 = load ptr, ptr @statistics_dump_file, align 8, !tbaa !5
  br label %77
...
80:                                               ; preds = %77
  %81 = load i32, ptr @statistics_dump_flags, align 4, !tbaa !20
  %82 = and i32 %81, 8
  %83 = icmp eq i32 %82, 0
  br i1 %83, label %101, label %84

84:                                               ; preds = %80
  %85 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
98:                                               ; preds = %84, %91
  ...
  %100 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef nonnull %78, ptr noundef nonnull @.str.7, i32 noundef %87, ptr noundef %89, ptr noundef %1, ptr noundef %99, i32 noundef %2)
  br label %101
...
11:                                               ; preds = %3
  %12 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
16:                                               ; preds = %11
  tail call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 87, ptr noundef nonnull @.str.6) #18
  %17 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
20:                                               ; preds = %16, %11
  ...
  %22 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  %23 = icmp ult i32 %21, %22
  %24 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
30:                                               ; preds = %20
  ...
  store ptr %34, ptr @statistics_hashes, align 8, !tbaa !5
  %35 = load i32, ptr @nr_statistics_hashes, align 4, !tbaa !20
  %36 = zext i32 %35 to i64
  ...
  store i32 %31, ptr @nr_statistics_hashes, align 4, !tbaa !20
...
42:                                               ; preds = %30, %25
  ...
  %45 = load ptr, ptr @statistics_hashes, align 8, !tbaa !5
...
53:                                               ; preds = %47
  ...
  %57 = load ptr, ptr %50, align 8, !tbaa !5
  ...
  store i8 1, ptr %59, align 4, !tbaa !28
...
66:                                               ; preds = %61
  call void @fancy_abort(ptr noundef nonnull @.str.5, i32 noundef 334, ptr noundef nonnull @.str.6) #18
  br label %67
...
67:                                               ; preds = %61, %66
  ...
  %71 = load ptr, ptr @statistics_dump_file, align 8, !tbaa !5
  %72 = icmp eq ptr %71, null
  br i1 %72, label %94, label %73

73:                                               ; preds = %67
  %74 = load i32, ptr @statistics_dump_flags, align 4, !tbaa !20
  %75 = and i32 %74, 8
  %76 = icmp eq i32 %75, 0
  br i1 %76, label %94, label %77

77:                                               ; preds = %73
  %78 = load ptr, ptr @current_pass, align 8, !tbaa !5
...
91:                                               ; preds = %77, %84
  ...
  %93 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef nonnull %71, ptr noundef nonnull @.str.9, i32 noundef %80, ptr noundef %82, ptr noundef %1, i32 noundef %2, ptr noundef %92)
  br label %94
...
!25 = !{!26, !12, i64 16}
!26 = !{!"statistics_counter_s", !6, i64 0, !11, i64 8, !7, i64 12, !12, i64 16, !12, i64 24}
!27 = !{!26, !12, i64 24}
!28 = !{!26, !7, i64 12}
!29 = !{!26, !6, i64 0}
!30 = !{!26, !11, i64 8}
...
!34 = distinct !{!34, !22}
!35 = !{!36, !11, i64 24}
!36 = !{!"dump_file_info", !6, i64 0, !6, i64 8, !6, i64 16, !11, i64 24, !11, i64 28, !11, i64 32}
