...
-o 200.opts-O3_-finline-limit_50000.out -e 200.opts-O3_-finline-limit_50000.err echo "../run_peak_train_teste1-m64.0000/cpugcc_r_peak.teste1-m64 200.c -O3 -finline-limit=50000 -o 200.opts-O3_-finline-limit_50000.s" > run.sh ; $BIND bash run.sh
-o scilab.opts-O3_-finline-limit_50000.out -e scilab.opts-O3_-finline-limit_50000.err echo "../run_peak_train_teste1-m64.0000/cpugcc_r_peak.teste1-m64 scilab.c -O3 -finline-limit=50000 -o scilab.opts-O3_-finline-limit_50000.s" > run.sh ; $BIND bash run.sh
-o train01.opts-O3_-finline-limit_50000.out -e train01.opts-O3_-finline-limit_50000.err echo "../run_peak_train_teste1-m64.0000/cpugcc_r_peak.teste1-m64 train01.c -O3 -finline-limit=50000 -o train01.opts-O3_-finline-limit_50000.s" > run.sh ; $BIND bash run.sh
