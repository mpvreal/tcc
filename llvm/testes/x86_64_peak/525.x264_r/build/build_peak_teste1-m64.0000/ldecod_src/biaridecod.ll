...
define dso_local void @arideco_start_decoding(ptr nocapture noundef writeonly %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #5 {
  ...
  store i32 15, ptr %28, align 8, !tbaa !15
  store i32 510, ptr %0, align 8, !tbaa !16
  ret void
}
...
define dso_local i32 @biari_decode_symbol(ptr nocapture noundef %0, ptr nocapture noundef %1) local_unnamed_addr #4 {
  ...
  %7 = load i16, ptr %1, align 2, !tbaa !20
  %8 = zext i16 %7 to i64
...
22:                                               ; preds = %2
  ...
  store i16 %25, ptr %1, align 2, !tbaa !20
...
41:                                               ; preds = %30
  %42 = xor i8 %4, 1
  store i8 %42, ptr %3, align 2, !tbaa !17
  br label %43
...
43:                                               ; preds = %41, %30
  ...
  store i16 %46, ptr %1, align 2, !tbaa !20
  br label %47
...
!5 = !{!6, !10, i64 24}
!6 = !{!"", !7, i64 0, !7, i64 4, !7, i64 8, !10, i64 16, !10, i64 24}
!7 = !{!"int", !8, i64 0}
