...
define dso_local i32 @intrapred16x16(ptr noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = load ptr, ptr %0, align 8, !tbaa !5
  %5 = getelementptr inbounds %struct.slice, ptr %4, i64 0, i32 25
  %6 = load i32, ptr %5, align 8, !tbaa !13
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %10, label %8

8:                                                ; preds = %3
  %9 = tail call i32 @intrapred_16x16_mbaff(ptr noundef nonnull %0, i32 noundef %1, i32 noundef %2) #2
  br label %12

10:                                               ; preds = %3
  %11 = tail call i32 @intrapred_16x16_normal(ptr noundef nonnull %0, i32 noundef %1, i32 noundef %2) #2
  br label %12
