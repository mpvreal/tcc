...
7:                                                ; preds = %2
  ...
  %9 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 215, ptr noundef nonnull @.str.2, ptr noundef nonnull %8) #11
  br label %10

10:                                               ; preds = %7, %2
  %11 = tail call dereferenceable_or_null(8384) ptr @AcquireMagickMemory(i64 noundef 8384) #16
...
13:                                               ; preds = %10
  ...
  %16 = call ptr @GetExceptionMessage(i32 noundef %15) #11
  %17 = call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef nonnull %3, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 222, i32 noundef 700, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef %16) #11
  %18 = call ptr @DestroyString(ptr noundef %16) #11
  call void @CatchException(ptr noundef nonnull %3) #11
  %19 = call ptr @DestroyExceptionInfo(ptr noundef nonnull %3) #11
  call void @MagickCoreTerminus() #11
  call void @_exit(i32 noundef 1) #18
  unreachable

20:                                               ; preds = %10
  %21 = tail call ptr @ResetMagickMemory(ptr noundef nonnull %11, i32 noundef 0, i64 noundef 8384) #11
  %22 = getelementptr inbounds %struct._ResampleFilter, ptr %11, i64 0, i32 2
  store ptr %1, ptr %22, align 8, !tbaa !26
  %23 = tail call ptr @ReferenceImage(ptr noundef nonnull %0) #11
  %24 = getelementptr inbounds %struct._ResampleFilter, ptr %11, i64 0, i32 1
  store ptr %23, ptr %24, align 8, !tbaa !30
  %25 = tail call ptr @AcquireVirtualCacheView(ptr noundef %23, ptr noundef %1) #11
  store ptr %25, ptr %11, align 8, !tbaa !31
  %26 = tail call i32 @IsEventLogging() #11
  ...
  store i64 2880220587, ptr %28, align 8, !tbaa !33
  ...
  %42 = load i32, ptr %27, align 8, !tbaa !32
  %43 = icmp eq i32 %42, 0
...
44:                                               ; preds = %20
  ...
  %47 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 1423, ptr noundef nonnull @.str.2, ptr noundef nonnull %46) #11
  br label %48

48:                                               ; preds = %20, %44
  %49 = getelementptr inbounds %struct._ResampleFilter, ptr %11, i64 0, i32 5
  store i32 %41, ptr %49, align 8, !tbaa !41
  %50 = tail call i32 @GetImageVirtualPixelMethod(ptr noundef nonnull %0) #11
  %51 = load i32, ptr %27, align 8, !tbaa !32
  %52 = icmp eq i32 %51, 0
  br i1 %52, label %57, label %53

53:                                               ; preds = %48
  %54 = load ptr, ptr %24, align 8, !tbaa !30
  %55 = getelementptr inbounds %struct._Image, ptr %54, i64 0, i32 53
  %56 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 1462, ptr noundef nonnull @.str.2, ptr noundef nonnull %55) #11
  br label %57

57:                                               ; preds = %53, %48
  %58 = getelementptr inbounds %struct._ResampleFilter, ptr %11, i64 0, i32 6
  store i32 %50, ptr %58, align 4, !tbaa !42
  %59 = icmp eq i32 %50, 0
  br i1 %59, label %63, label %60

60:                                               ; preds = %57
  %61 = load ptr, ptr %11, align 8, !tbaa !31
  %62 = tail call i32 @SetCacheViewVirtualPixelMethod(ptr noundef %61, i32 noundef %50) #11
  br label %63
...
define dso_local void @SetResampleFilter(ptr nocapture noundef %0, i32 noundef %1, double noundef nofpclass(nan inf) %2) local_unnamed_addr #0 {
  ...
  %6 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 7
  %7 = icmp eq i32 %1, 0
  %8 = select i1 %7, i32 26, i32 %1
...
11:                                               ; preds = %3
  %12 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 1
  %13 = load ptr, ptr %12, align 8, !tbaa !30
  %14 = fptrunc double %2 to float
  %15 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 2
  %16 = load ptr, ptr %15, align 8, !tbaa !26
  %17 = tail call ptr @AcquireResizeFilter(ptr noundef %13, i32 noundef %8, float noundef nofpclass(nan inf) %14, i32 noundef 1, ptr noundef %16) #11
  %18 = icmp eq ptr %17, null
  br i1 %18, label %19, label %22

19:                                               ; preds = %11
  %20 = load ptr, ptr %15, align 8, !tbaa !26
  %21 = tail call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef %20, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 1277, i32 noundef 455, ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.6) #11
  store i32 1, ptr %6, align 8, !tbaa !44
  store i32 1, ptr %5, align 8, !tbaa !43
  br label %81

22:                                               ; preds = %11
  %23 = tail call fast nofpclass(nan inf) float @GetResizeFilterSupport(ptr noundef nonnull %17) #11
  %24 = fpext float %23 to double
  %25 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 20
  store double %24, ptr %25, align 8, !tbaa !45
  %26 = fmul fast double %24, 3.125000e-02
  br label %27
...
27:                                               ; preds = %22, %27
  ...
  %32 = fmul fast double %26, %31
  %33 = fptrunc double %32 to float
  %34 = tail call fast nofpclass(nan inf) float @GetResizeFilterWeight(ptr noundef nonnull %17, float noundef nofpclass(nan inf) %33) #11
  %35 = fpext float %34 to double
  %36 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 19, i64 %28
  store double %35, ptr %36, align 8, !tbaa !46
  %37 = add nuw nsw i64 %28, 1
  %38 = icmp eq i64 %37, 1024
  br i1 %38, label %39, label %27, !llvm.loop !47

39:                                               ; preds = %27
  %40 = tail call ptr @DestroyResizeFilter(ptr noundef nonnull %17) #11
  ...
  %41 = tail call i32 @__kmpc_single(ptr nonnull @1, i32 %4)
  %42 = icmp eq i32 %41, 0
  br i1 %42, label %80, label %43

43:                                               ; preds = %39
  %44 = load ptr, ptr %12, align 8, !tbaa !30
  %45 = tail call ptr @GetImageArtifact(ptr noundef %44, ptr noundef nonnull @.str.7) #11
  %46 = tail call i32 @IsMagickTrue(ptr noundef %45) #11
  %47 = icmp eq i32 %46, 0
  br i1 %47, label %79, label %48

48:                                               ; preds = %43
  %49 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.24)
  %50 = load i32, ptr %6, align 8, !tbaa !44
  %51 = zext i32 %50 to i64
  %52 = tail call ptr @CommandOptionToMnemonic(i32 noundef 25, i64 noundef %51) #11
  %53 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.9, i32 noundef 1024, ptr noundef %52)
  %54 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.24)
  %55 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.18)
  %56 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.19)
  %57 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.24)
  %58 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.21)
  %59 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.22)
  %60 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.23)
  %61 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.24)
  %62 = load double, ptr %25, align 8, !tbaa !45
  %63 = fmul fast double %62, 3.125000e-02
  br label %64

64:                                               ; preds = %48, %64
  %65 = phi i64 [ 0, %48 ], [ %75, %64 ]
  %66 = tail call i32 @GetMagickPrecision() #11
  %67 = trunc i64 %65 to i32
  %68 = sitofp i32 %67 to double
  %69 = tail call fast double @llvm.sqrt.f64(double %68)
  %70 = fmul fast double %63, %69
  %71 = tail call i32 @GetMagickPrecision() #11
  %72 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 19, i64 %65
  %73 = load double, ptr %72, align 8, !tbaa !46
  %74 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %66, double noundef nofpclass(nan inf) %70, i32 noundef %71, double noundef nofpclass(nan inf) %73)
  %75 = add nuw nsw i64 %65, 1
  %76 = icmp eq i64 %75, 1024
  br i1 %76, label %77, label %64, !llvm.loop !49

77:                                               ; preds = %64
  %78 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.25)
  br label %79

79:                                               ; preds = %77, %43
  tail call void @__kmpc_end_single(ptr nonnull @1, i32 %4)
  br label %80
...
6:                                                ; preds = %2
  ...
  %10 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 1423, ptr noundef nonnull @.str.2, ptr noundef nonnull %9) #11
  br label %11
...
6:                                                ; preds = %2
  ...
  %8 = load ptr, ptr %7, align 8, !tbaa !30
  %9 = getelementptr inbounds %struct._Image, ptr %8, i64 0, i32 53
  %10 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 1462, ptr noundef nonnull @.str.2, ptr noundef nonnull %9) #11
  br label %11
...
14:                                               ; preds = %11
  ...
  %16 = tail call i32 @SetCacheViewVirtualPixelMethod(ptr noundef %15, i32 noundef %1) #11
  br label %17
...
5:                                                ; preds = %1
  ...
  %9 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 276, ptr noundef nonnull @.str.2, ptr noundef nonnull %8) #11
  br label %10

10:                                               ; preds = %5, %1
  %11 = load ptr, ptr %0, align 8, !tbaa !31
  %12 = tail call ptr @DestroyCacheView(ptr noundef %11) #11
  store ptr %12, ptr %0, align 8, !tbaa !31
  %13 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 1
  %14 = load ptr, ptr %13, align 8, !tbaa !30
  %15 = tail call ptr @DestroyImage(ptr noundef %14) #11
  store ptr %15, ptr %13, align 8, !tbaa !30
  %16 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 21
  store i64 -2880220588, ptr %16, align 8, !tbaa !33
  %17 = tail call ptr @RelinquishMagickMemory(ptr noundef nonnull %0) #11
  ret ptr %17
}
...
8:                                                ; preds = %4
  ...
  %16 = tail call i32 @InterpolateMagickPixelPacket(ptr noundef %10, ptr noundef %11, i32 noundef %13, double noundef nofpclass(nan inf) %1, double noundef nofpclass(nan inf) %2, ptr noundef %3, ptr noundef %15) #11
  br label %539
...
162:                                              ; preds = %128, %133, %150, %155, %106, %111, %92, %97, %58, %63, %80, %85, %20, %24, %29, %38, %43
  ...
  %168 = tail call i32 @InterpolateMagickPixelPacket(ptr noundef %164, ptr noundef %165, i32 noundef 5, double noundef nofpclass(nan inf) %1, double noundef nofpclass(nan inf) %2, ptr noundef %3, ptr noundef %167) #11
  br label %539
...
174:                                              ; preds = %173, %173, %173, %173, %173
  ...
  %180 = tail call i32 @InterpolateMagickPixelPacket(ptr noundef %176, ptr noundef %177, i32 noundef 1, double noundef nofpclass(nan inf) %1, double noundef nofpclass(nan inf) %2, ptr noundef %3, ptr noundef %179) #11
  br label %539

181:                                              ; preds = %173, %173
  %182 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 1
  %183 = load ptr, ptr %182, align 8, !tbaa !30
  %184 = load ptr, ptr %0, align 8, !tbaa !31
  %185 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 2
  %186 = load ptr, ptr %185, align 8, !tbaa !26
  %187 = tail call i32 @InterpolateMagickPixelPacket(ptr noundef %183, ptr noundef %184, i32 noundef 5, double noundef nofpclass(nan inf) -1.000000e+00, double noundef nofpclass(nan inf) -1.000000e+00, ptr noundef %3, ptr noundef %186) #11
  br label %539
...
192:                                              ; preds = %188
  ...
  tail call void @GetMagickPixelPacket(ptr noundef %194, ptr noundef nonnull %195) #11
  store i32 1, ptr %189, align 4, !tbaa !37
  %196 = load ptr, ptr %193, align 8, !tbaa !30
  %197 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 2
  %198 = load ptr, ptr %197, align 8, !tbaa !26
  %199 = tail call ptr @ResizeImage(ptr noundef %196, i64 noundef 1, i64 noundef 1, i32 noundef 2, double noundef nofpclass(nan inf) 1.000000e+00, ptr noundef %198) #11
  %200 = icmp eq ptr %199, null
  br i1 %200, label %201, label %202

201:                                              ; preds = %192
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %3, ptr noundef nonnull align 8 dereferenceable(56) %195, i64 56, i1 false), !tbaa.struct !53
  br label %539

202:                                              ; preds = %192
  %203 = getelementptr inbounds %struct._Image, ptr %199, i64 0, i32 58
  %204 = tail call ptr @AcquireVirtualCacheView(ptr noundef nonnull %199, ptr noundef nonnull %203) #11
  %205 = load ptr, ptr %197, align 8, !tbaa !26
  %206 = tail call ptr @GetCacheViewVirtualPixels(ptr noundef %204, i64 noundef 0, i64 noundef 0, i64 noundef 1, i64 noundef 1, ptr noundef %205) #19
  %207 = icmp eq ptr %206, null
  br i1 %207, label %208, label %211

208:                                              ; preds = %202
  %209 = tail call ptr @DestroyCacheView(ptr noundef %204) #11
  %210 = tail call ptr @DestroyImage(ptr noundef nonnull %199) #11
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %3, ptr noundef nonnull align 8 dereferenceable(56) %195, i64 56, i1 false), !tbaa.struct !53
  br label %539

211:                                              ; preds = %202
  %212 = tail call ptr @GetCacheViewAuthenticIndexQueue(ptr noundef %204) #11
  %213 = load ptr, ptr %193, align 8, !tbaa !30
  ...
  %216 = tail call ptr @DestroyCacheView(ptr noundef %204) #11
  %217 = tail call ptr @DestroyImage(ptr noundef nonnull %199) #11
  %218 = load i32, ptr %18, align 4, !tbaa !42
...
220:                                              ; preds = %211
  ...
  %222 = load float, ptr %221, align 4, !tbaa !58
  ...
  %227 = load float, ptr %226, align 8, !tbaa !59
  ...
  %242 = load i16, ptr %241, align 8, !tbaa !61
  ...
  %252 = load <2 x float>, ptr %225, align 8, !tbaa !56
  ...
  %257 = load <2 x i16>, ptr %240, align 2, !tbaa !62
  ...
  store <2 x float> %269, ptr %225, align 8, !tbaa !56
  %270 = fpext float %248 to double
  %271 = fdiv fast double %270, %251
  %272 = fptrunc double %271 to float
  store float %272, ptr %226, align 8, !tbaa !59
  %273 = fmul fast float %250, 5.000000e-01
  store float %273, ptr %221, align 4, !tbaa !58
  br label %274

274:                                              ; preds = %211, %220, %188
  %275 = getelementptr inbounds %struct._ResampleFilter, ptr %0, i64 0, i32 11
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %3, ptr noundef nonnull align 8 dereferenceable(56) %275, i64 56, i1 false), !tbaa.struct !53
  br label %539

276:                                              ; preds = %169
  %277 = getelementptr inbounds %struct._MagickPixelPacket, ptr %3, i64 0, i32 7
  store float 0.000000e+00, ptr %277, align 8, !tbaa !63
  ...
  store <2 x float> zeroinitializer, ptr %279, align 8, !tbaa !56
...
283:                                              ; preds = %276
  ...
  store float 0.000000e+00, ptr %284, align 4, !tbaa !65
  br label %285
...
289:                                              ; preds = %285
  ...
  store float 0.000000e+00, ptr %290, align 8, !tbaa !67
  br label %291
...
311:                                              ; preds = %291
  ...
  %315 = load double, ptr %300, align 8, !tbaa !70
...
324:                                              ; preds = %311, %334
  ...
  %329 = load double, ptr %300, align 8, !tbaa !70
  %330 = load ptr, ptr %0, align 8, !tbaa !31
  %331 = load ptr, ptr %320, align 8, !tbaa !26
  %332 = tail call ptr @GetCacheViewVirtualPixels(ptr noundef %330, i64 noundef %328, i64 noundef %326, i64 noundef %306, i64 noundef 1, ptr noundef %331) #19
...
334:                                              ; preds = %324
  ...
  %337 = tail call ptr @GetCacheViewVirtualIndexQueue(ptr noundef %336) #11
  %338 = add i64 %326, 1
  %339 = icmp eq i64 %326, %299
  br i1 %339, label %458, label %324, !llvm.loop !71
...
340:                                              ; preds = %311, %449
  ...
  %348 = load double, ptr %300, align 8, !tbaa !70
  %349 = fadd fast double %348, %343
  %350 = load double, ptr %307, align 8, !tbaa !69
  %351 = load double, ptr %318, align 8, !tbaa !72
  %352 = load double, ptr %319, align 8, !tbaa !73
  %353 = load ptr, ptr %0, align 8, !tbaa !31
  %354 = load ptr, ptr %320, align 8, !tbaa !26
  %355 = tail call ptr @GetCacheViewVirtualPixels(ptr noundef %353, i64 noundef %347, i64 noundef %345, i64 noundef %306, i64 noundef 1, ptr noundef %354) #19
...
357:                                              ; preds = %340
  ...
  %373 = load ptr, ptr %0, align 8, !tbaa !31
  %374 = tail call ptr @GetCacheViewVirtualIndexQueue(ptr noundef %373) #11
  br label %375
...
385:                                              ; preds = %375
  ...
  %391 = load i16, ptr %390, align 2, !tbaa !74
  %392 = uitofp i16 %391 to double
  %393 = fmul fast double %389, %392
  %394 = load float, ptr %322, align 4, !tbaa !65
  %395 = fpext float %394 to double
  %396 = fadd fast double %393, %395
  %397 = fptrunc double %396 to float
  store float %397, ptr %322, align 4, !tbaa !65
  %398 = fadd fast double %389, %378
  %399 = load i32, ptr %280, align 8, !tbaa !64
...
406:                                              ; preds = %401, %385
  ...
  %409 = load <2 x i16>, ptr %408, align 2, !tbaa !62
...
439:                                              ; preds = %436, %375
  ...
  br i1 %448, label %449, label %375, !llvm.loop !76

449:                                              ; preds = %439
  %450 = add i64 %345, 1
  %451 = icmp eq i64 %345, %299
  br i1 %451, label %452, label %340, !llvm.loop !71
...
458:                                              ; preds = %334, %291, %452
  ...
  %461 = load ptr, ptr %0, align 8, !tbaa !31
  ...
  %466 = tail call i32 @InterpolateMagickPixelPacket(ptr noundef %460, ptr noundef %461, i32 noundef %463, double noundef nofpclass(nan inf) %1, double noundef nofpclass(nan inf) %2, ptr noundef %3, ptr noundef %465) #11
  br label %539
...
480:                                              ; preds = %467, %474, %476
  ...
  store float %481, ptr %468, align 4, !tbaa !65
  %482 = fdiv fast double 1.000000e+00, %441
  %483 = load float, ptr %279, align 8, !tbaa !77
...
494:                                              ; preds = %480, %488, %490
  ...
  store float %495, ptr %279, align 8, !tbaa !77
  %496 = load float, ptr %278, align 4, !tbaa !78
...
507:                                              ; preds = %494, %501, %503
  ...
  store float %508, ptr %278, align 4, !tbaa !78
  %509 = load float, ptr %277, align 8, !tbaa !63
...
520:                                              ; preds = %507, %514, %516
  ...
  store float %521, ptr %277, align 8, !tbaa !63
  %522 = load i32, ptr %286, align 4, !tbaa !66
...
524:                                              ; preds = %520
  ...
  %526 = load float, ptr %525, align 8, !tbaa !67
...
537:                                              ; preds = %524, %531, %533
  ...
  store float %538, ptr %525, align 8, !tbaa !67
  br label %539
...
96:                                               ; preds = %10
  ...
  store <2 x double> %112, ptr %105, align 8, !tbaa !46
...
declare void @__kmpc_end_single(ptr, i32) local_unnamed_addr #12

; Function Attrs: convergent nounwind
declare i32 @__kmpc_single(ptr, i32) local_unnamed_addr #12
...
!25 = !{!22, !22, i64 0}
!26 = !{!27, !11, i64 16}
!27 = !{!"_ResampleFilter", !11, i64 0, !11, i64 8, !11, i64 16, !8, i64 24, !10, i64 32, !8, i64 40, !8, i64 44, !8, i64 48, !8, i64 52, !8, i64 56, !8, i64 60, !28, i64 64, !14, i64 120, !14, i64 128, !14, i64 136, !14, i64 144, !14, i64 152, !14, i64 160, !14, i64 168, !8, i64 176, !14, i64 8368, !10, i64 8376}
!28 = !{!"_MagickPixelPacket", !8, i64 0, !8, i64 4, !8, i64 8, !14, i64 16, !10, i64 24, !29, i64 32, !29, i64 36, !29, i64 40, !29, i64 44, !29, i64 48}
!29 = !{!"float", !8, i64 0}
!30 = !{!27, !11, i64 8}
!31 = !{!27, !11, i64 0}
!32 = !{!27, !8, i64 24}
...
!51 = !{!27, !14, i64 152}
!52 = !{!27, !14, i64 144}
!53 = !{i64 0, i64 4, !54, i64 4, i64 4, !54, i64 8, i64 4, !54, i64 16, i64 8, !46, i64 24, i64 8, !55, i64 32, i64 4, !56, i64 36, i64 4, !56, i64 40, i64 4, !56, i64 44, i64 4, !56, i64 48, i64 4, !56}
!54 = !{!8, !8, i64 0}
!55 = !{!10, !10, i64 0}
!56 = !{!29, !29, i64 0}
!57 = !{!7, !8, i64 4}
