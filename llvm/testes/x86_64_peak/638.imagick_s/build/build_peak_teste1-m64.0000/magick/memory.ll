...
8:                                                ; preds = %6, %2
  ...
  store i32 12, ptr %9, align 4, !tbaa !6
  br label %28
...
define dso_local ptr @AcquireMagickMemory(i64 noundef %0) local_unnamed_addr #4 {
  %2 = load ptr, ptr @memory_methods.0, align 8, !tbaa !12
...
declare noalias noundef ptr @realloc(ptr allocptr nocapture noundef, i64 noundef) #5
...
define dso_local ptr @AcquireQuantumMemory(i64 noundef %0, i64 noundef %1) local_unnamed_addr #7 {
  %3 = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %0, i64 %1)
  %4 = extractvalue { i64, i1 } %3, 0
  %5 = icmp eq i64 %0, 0
  br i1 %5, label %8, label %6
...
10:                                               ; preds = %6
  %11 = load ptr, ptr @memory_methods.0, align 8, !tbaa !12
...
; Function Attrs: nounwind sspstrong allocsize(0,1) uwtable
define dso_local ptr @AcquireVirtualMemory(i64 noundef %0, i64 noundef %1) local_unnamed_addr #7 {
...
28:                                               ; preds = %14
  ...
  store i64 %5, ptr %29, align 8, !tbaa !14
  %30 = getelementptr inbounds %struct._MemoryInfo, ptr %18, i64 0, i32 4
  store i64 2880220587, ptr %30, align 8, !tbaa !17
...
45:                                               ; preds = %35, %33, %41
  ...
  store ptr null, ptr %46, align 16, !tbaa !18
  br label %57
...
47:                                               ; preds = %41
  ...
  store ptr %51, ptr %53, align 16, !tbaa !18
  %54 = icmp eq i64 %50, 0
  br i1 %54, label %57, label %55

55:                                               ; preds = %47
  %56 = getelementptr inbounds %struct._MemoryInfo, ptr %18, i64 0, i32 1
  store i32 1, ptr %56, align 64, !tbaa !19
  br label %58
...
58:                                               ; preds = %55, %57, %28
  ...
  %60 = load ptr, ptr %59, align 16, !tbaa !18
...
71:                                               ; preds = %70, %62
  %72 = load ptr, ptr %59, align 16, !tbaa !18
...
define dso_local ptr @ResetMagickMemory(ptr noundef returned writeonly %0, i32 noundef %1, i64 noundef %2) local_unnamed_addr #10 {
  %4 = trunc i32 %1 to i8
  tail call void @llvm.memset.p0.i64(ptr align 1 %0, i8 %4, i64 %2, i1 false)
  ret ptr %0
}

declare i32 @AcquireMagickResource(i32 noundef, i64 noundef) local_unnamed_addr #8

declare void @RelinquishMagickResource(i32 noundef, i64 noundef) local_unnamed_addr #8

declare ptr @MapBlob(i32 noundef, i32 noundef, i64 noundef, i64 noundef) local_unnamed_addr #8

declare i32 @AcquireUniqueFileResource(ptr noundef) local_unnamed_addr #8
...
define dso_local ptr @RelinquishVirtualMemory(ptr noundef %0) local_unnamed_addr #13 {
...
13:                                               ; preds = %5
  ...
  %18 = load i8, ptr %0, align 8, !tbaa !20
  %19 = icmp eq i8 %18, 0
...
22:                                               ; preds = %5
  %23 = load ptr, ptr @memory_methods.2, align 8, !tbaa !21
...
24:                                               ; preds = %8, %22, %20, %13, %1
  ...
  store i64 -2880220588, ptr %25, align 8, !tbaa !17
...
define dso_local ptr @CopyMagickMemory(ptr noundef returned writeonly %0, ptr nocapture noundef readonly %1, i64 noundef %2) local_unnamed_addr #14 {
...
define dso_local void @DestroyMagickMemory() local_unnamed_addr #16 {
  ret void
}
...
define dso_local void @GetMagickMemoryMethods(ptr nocapture noundef writeonly %0, ptr nocapture noundef writeonly %1, ptr nocapture noundef writeonly %2) local_unnamed_addr #17 {
  %4 = load ptr, ptr @memory_methods.0, align 8, !tbaa !12
  store ptr %4, ptr %0, align 8, !tbaa !10
  %5 = load ptr, ptr @memory_methods.1, align 8, !tbaa !22
  store ptr %5, ptr %1, align 8, !tbaa !10
  %6 = load ptr, ptr @memory_methods.2, align 8, !tbaa !21
  store ptr %6, ptr %2, align 8, !tbaa !10
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(argmem: read) uwtable
define dso_local ptr @GetVirtualMemoryBlob(ptr nocapture noundef readonly %0) local_unnamed_addr #18 {
  %2 = getelementptr inbounds %struct._MemoryInfo, ptr %0, i64 0, i32 3
  %3 = load ptr, ptr %2, align 8, !tbaa !18
  ret ptr %3
}
...
define dso_local noalias ptr @RelinquishAlignedMemory(ptr noundef readonly %0) local_unnamed_addr #19 {
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local ptr @RelinquishMagickMemory(ptr noundef %0) local_unnamed_addr #13 {
  %2 = icmp eq ptr %0, null
  br i1 %2, label %5, label %3

3:                                                ; preds = %1
  %4 = load ptr, ptr @memory_methods.2, align 8, !tbaa !21
...
declare i32 @UnmapBlob(ptr noundef, i64 noundef) local_unnamed_addr #8

declare i32 @RelinquishUniqueFileResource(ptr noundef) local_unnamed_addr #8

; Function Attrs: mustprogress nocallback nofree nounwind willreturn memory(argmem: write)
declare void @llvm.memset.p0.i64(ptr nocapture writeonly, i8, i64, i1 immarg) #20

; Function Attrs: nounwind sspstrong allocsize(1) uwtable
define dso_local ptr @ResizeMagickMemory(ptr noundef %0, i64 noundef %1) local_unnamed_addr #21 {
  %3 = icmp eq ptr %0, null
  %4 = tail call i64 @llvm.umax.i64(i64 %1, i64 1)
  br i1 %3, label %5, label %8

5:                                                ; preds = %2
  %6 = load ptr, ptr @memory_methods.0, align 8, !tbaa !12
  %7 = tail call ptr %6(i64 noundef %4) #27
  br label %14

8:                                                ; preds = %2
  %9 = load ptr, ptr @memory_methods.1, align 8, !tbaa !22
  %10 = tail call ptr %9(ptr noundef nonnull %0, i64 noundef %4) #27
  %11 = icmp eq ptr %10, null
  br i1 %11, label %12, label %14

12:                                               ; preds = %8
  %13 = load ptr, ptr @memory_methods.2, align 8, !tbaa !21
...
define dso_local ptr @ResizeQuantumMemory(ptr noundef %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #22 {
...
11:                                               ; preds = %9
  %12 = load ptr, ptr @memory_methods.2, align 8, !tbaa !21
...
18:                                               ; preds = %15
  %19 = load ptr, ptr @memory_methods.0, align 8, !tbaa !12
  %20 = tail call ptr %19(i64 noundef %17) #27
  br label %27

21:                                               ; preds = %15
  %22 = load ptr, ptr @memory_methods.1, align 8, !tbaa !22
  %23 = tail call ptr %22(ptr noundef nonnull %0, i64 noundef %17) #27
  %24 = icmp eq ptr %23, null
  br i1 %24, label %25, label %27

25:                                               ; preds = %21
  %26 = load ptr, ptr @memory_methods.2, align 8, !tbaa !21
...
define dso_local void @SetMagickMemoryMethods(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #23 {
  %4 = icmp eq ptr %0, null
  br i1 %4, label %6, label %5

5:                                                ; preds = %3
  store ptr %0, ptr @memory_methods.0, align 8, !tbaa !12
  br label %6
...
8:                                                ; preds = %6
  store ptr %1, ptr @memory_methods.1, align 8, !tbaa !22
  br label %9
...
11:                                               ; preds = %9
  store ptr %2, ptr @memory_methods.2, align 8, !tbaa !21
  br label %12
...
!12 = !{!13, !11, i64 0}
!13 = !{!"_MagickMemoryMethods", !11, i64 0, !11, i64 8, !11, i64 16}
!14 = !{!15, !16, i64 4104}
!15 = !{!"_MemoryInfo", !8, i64 0, !8, i64 4096, !16, i64 4104, !11, i64 4112, !16, i64 4120}
!16 = !{!"long", !8, i64 0}
!17 = !{!15, !16, i64 4120}
!18 = !{!15, !11, i64 4112}
!19 = !{!15, !8, i64 4096}
