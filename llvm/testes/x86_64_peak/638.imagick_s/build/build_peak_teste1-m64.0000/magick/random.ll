...
@.str.6 = private unnamed_addr constant [13 x i8] c"/dev/srandom\00", align 1
...
13:                                               ; preds = %0
  ...
  store double 0x3BF0000000000000, ptr %26, align 8, !tbaa !18
  %27 = load i64, ptr @secret_key, align 8, !tbaa !19
  ...
  store i16 1, ptr %29, align 8, !tbaa !21
  %30 = getelementptr inbounds %struct._RandomInfo, ptr %4, i64 0, i32 8
  store i16 0, ptr %30, align 2, !tbaa !22
  ...
  store i64 2880220587, ptr %35, align 8, !tbaa !25
...
67:                                               ; preds = %45
  ...
  %70 = load ptr, ptr %25, align 8, !tbaa !17
  ...
  %74 = load i64, ptr %28, align 8, !tbaa !20
  %75 = icmp eq i64 %74, -1
...
define internal fastcc ptr @GenerateEntropicChaos(ptr nocapture noundef readonly %0) unnamed_addr #0 {
  ...
  %17 = tail call i64 @pthread_self() #17
  ...
  %23 = load ptr, ptr @environ, align 8, !tbaa !26
...
28:                                               ; preds = %25, %28
  ...
  %32 = load ptr, ptr @environ, align 8, !tbaa !26
  ...
  %37 = load ptr, ptr @environ, align 8, !tbaa !26
  %38 = getelementptr inbounds ptr, ptr %37, i64 %36
  %39 = load ptr, ptr %38, align 8, !tbaa !26
  %40 = icmp eq ptr %39, null
  br i1 %40, label %41, label %28, !llvm.loop !27

41:                                               ; preds = %28, %25, %1
  %42 = call ptr @AcquireString(ptr noundef nonnull @.str.4) #16
...
63:                                               ; preds = %60, %56
  ...
  %67 = sub i64 %53, %66
  %68 = icmp eq i64 %67, 0
  br i1 %68, label %69, label %50, !llvm.loop !29
...
73:                                               ; preds = %69, %41
  %74 = load i32, ptr @gather_true_random, align 4, !tbaa !30
  %75 = icmp eq i32 %74, 0
  br i1 %75, label %115, label %76

76:                                               ; preds = %73
  %77 = call ptr @AcquireString(ptr noundef nonnull @.str.5) #16
...
83:                                               ; preds = %76
  %84 = call ptr @AcquireString(ptr noundef nonnull @.str.6) #16
...
105:                                              ; preds = %102, %98
  ...
  br i1 %110, label %111, label %92, !llvm.loop !29
...
define dso_local ptr @DestroyRandomInfo(ptr noundef %0) local_unnamed_addr #0 {
  %2 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 288, ptr noundef nonnull @.str.7) #16
...
21:                                               ; preds = %19, %16
  ...
  store i64 -2880220588, ptr %24, align 8, !tbaa !25
...
define dso_local nofpclass(nan inf) double @GetPseudoRandomValue(ptr nocapture noundef %0) local_unnamed_addr #9 {
...
28:                                               ; preds = %18, %27
  %29 = add i64 %14, -1
  %30 = icmp eq i64 %29, 0
  br i1 %30, label %31, label %13, !llvm.loop !32
...
39:                                               ; preds = %37, %39
  ...
  br i1 %57, label %58, label %39, !llvm.loop !33
...
114:                                              ; preds = %114, %108
  ...
  %119 = load <8 x i8>, ptr %118, align 1, !tbaa !30
  %120 = getelementptr i8, ptr %113, i64 %117
  store <8 x i8> %119, ptr %120, align 1, !tbaa !30
  %121 = add nuw i64 %115, 8
  %122 = icmp eq i64 %121, %110
  br i1 %122, label %123, label %114, !llvm.loop !37
...
130:                                              ; preds = %125, %130
  ...
  br i1 %138, label %139, label %130, !llvm.loop !38
...
142:                                              ; preds = %139, %142
  ...
  store i8 %146, ptr %147, align 1, !tbaa !30
  %148 = add i64 %143, -2
  ...
  br i1 %160, label %161, label %142, !llvm.loop !40
...
define dso_local i64 @GetRandomSecretKey(ptr nocapture noundef readonly %0) local_unnamed_addr #10 {
...
3:                                                ; preds = %3, %1
  ...
  %5 = icmp eq i64 %4, -1
  br i1 %5, label %3, label %6, !llvm.loop !41
...
define dso_local i32 @RandomComponentGenesis() local_unnamed_addr #0 {
  %1 = load ptr, ptr @random_semaphore, align 8, !tbaa !26
  %2 = icmp eq ptr %1, null
  br i1 %2, label %3, label %5

3:                                                ; preds = %0
  %4 = tail call ptr @AllocateSemaphoreInfo() #16
  store ptr %4, ptr @random_semaphore, align 8, !tbaa !26
  br label %5
...
define internal fastcc void @IncrementRandomNonce(ptr noundef %0) unnamed_addr #11 {
  %2 = alloca %struct._ExceptionInfo, align 8
...
9:                                                ; preds = %5
  ...
  %13 = icmp eq i8 %12, 0
  br i1 %13, label %5, label %14, !llvm.loop !42
...
define dso_local void @SeedPseudoRandomGenerator(i64 noundef %0) local_unnamed_addr #12 {
  store i64 %0, ptr @secret_key, align 8, !tbaa !19
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(write, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @SetRandomSecretKey(i64 noundef %0) local_unnamed_addr #12 {
  store i64 %0, ptr @secret_key, align 8, !tbaa !19
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(write, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @SetRandomTrueRandom(i32 noundef %0) local_unnamed_addr #12 {
  store i32 %0, ptr @gather_true_random, align 4, !tbaa !30
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(none) uwtable
define hidden nonnull ptr @GetRandomInfoSeed(ptr noundef readnone %0) local_unnamed_addr #13 {
  %2 = getelementptr inbounds %struct._RandomInfo, ptr %0, i64 0, i32 4
  ret ptr %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(argmem: read) uwtable
define hidden nofpclass(nan inf) double @GetRandomInfoNormalize(ptr nocapture noundef readonly %0) local_unnamed_addr #10 {
...
!9 = !{!"Simple C/C++ TBAA"}
!10 = !{!11, !12, i64 0}
!11 = !{!"_RandomInfo", !12, i64 0, !12, i64 8, !12, i64 16, !13, i64 24, !8, i64 32, !14, i64 64, !13, i64 72, !15, i64 80, !15, i64 82, !12, i64 88, !13, i64 96, !13, i64 104}
...
!32 = distinct !{!32, !28}
!33 = distinct !{!33, !28}
!34 = distinct !{!34, !28, !35, !36}
!35 = !{!"llvm.loop.isvectorized", i32 1}
!36 = !{!"llvm.loop.unroll.runtime.disable"}
!37 = distinct !{!37, !28, !35, !36}
!38 = distinct !{!38, !39}
!39 = !{!"llvm.loop.unroll.disable"}
!40 = distinct !{!40, !28, !35}
!41 = distinct !{!41, !28}
!42 = distinct !{!42, !28}
