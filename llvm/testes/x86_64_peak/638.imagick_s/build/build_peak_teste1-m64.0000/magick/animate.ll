; ModuleID = 'magick/animate.c'
source_filename = "magick/animate.c"
...
@.str = private unnamed_addr constant [17 x i8] c"magick/animate.c\00", align 1
...
define dso_local i32 @AnimateImages(ptr nocapture noundef readnone %0, ptr noundef %1) local_unnamed_addr #0 {
...
6:                                                ; preds = %2
  ...
  %8 = tail call i32 (i32, ptr, ptr, i64, ptr, ...) @LogMagickEvent(i32 noundef 1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 3032, ptr noundef nonnull @.str.2, ptr noundef nonnull %7) #2
  br label %9

9:                                                ; preds = %6, %2
  %10 = getelementptr inbounds %struct._Image, ptr %1, i64 0, i32 58
  %11 = getelementptr inbounds %struct._Image, ptr %1, i64 0, i32 53
  %12 = tail call i32 (ptr, ptr, ptr, i64, i32, ptr, ptr, ...) @ThrowMagickException(ptr noundef nonnull %10, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i64 noundef 3033, i32 noundef 420, ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull %11) #2
  ret i32 0
}
