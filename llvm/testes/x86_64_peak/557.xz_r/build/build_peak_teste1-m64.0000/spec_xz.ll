...
define dso_local zeroext i1 @init_encoder(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3) local_unnamed_addr #0 {
  ...
  store i64 33, ptr %5, align 16, !tbaa !5
  ...
  store i64 -1, ptr %13, align 16, !tbaa !5
...
7:                                                ; preds = %2
  %8 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19)
...
16:                                               ; preds = %2, %14, %15
  %17 = phi ptr [ @.str.14, %15 ], [ @.str.25, %14 ], [ @.str.5, %2 ]
  %18 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, ptr noundef nonnull %17, i32 noundef %6)
  br label %72

19:                                               ; preds = %7, %10, %11, %12, %13
  %20 = phi ptr [ @str.30, %13 ], [ @str, %12 ], [ @str.27, %11 ], [ @str.28, %10 ], [ @str.29, %7 ]
...
22:                                               ; preds = %19, %2
  ...
  store i64 8192, ptr %25, align 8, !tbaa !14
  br label %28
...
32:                                               ; preds = %28
  %33 = load ptr, ptr @spec_fd, align 8, !tbaa !16
...
36:                                               ; preds = %32
  ...
  %37 = load ptr, ptr @spec_fd, align 8, !tbaa !16
  ...
  store i64 %38, ptr %23, align 8, !tbaa !15
  %39 = load ptr, ptr @spec_fd, align 8, !tbaa !16
...
50:                                               ; preds = %43
  %51 = sub i64 8192, %46
  %52 = load ptr, ptr @spec_fd, align 8, !tbaa !16
...
define dso_local void @compressStream(i32 noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  ...
  %6 = alloca %struct.lzma_stream, align 8
  ...
  call void @llvm.lifetime.start.p0(i64 8192, ptr nonnull %7) #8
  call void @llvm.lifetime.start.p0(i64 8192, ptr nonnull %8) #8
  %9 = icmp sgt i32 %2, -1
  %10 = select i1 %9, i32 4, i32 10
  call void @llvm.lifetime.start.p0(i64 80, ptr nonnull %4) #8
  call void @llvm.lifetime.start.p0(i64 112, ptr nonnull %5) #8
  %11 = call zeroext i8 @lzma_lzma_preset(ptr noundef nonnull %5, i32 noundef %2) #8
  store i64 33, ptr %4, align 16, !tbaa !5
  %12 = getelementptr inbounds %struct.lzma_filter, ptr %4, i64 0, i32 1
  store ptr %5, ptr %12, align 8, !tbaa !11
  %13 = getelementptr inbounds [5 x %struct.lzma_filter], ptr %4, i64 0, i64 1
  store i64 -1, ptr %13, align 16, !tbaa !5
  %14 = call i32 @lzma_stream_encoder(ptr noundef nonnull %6, ptr noundef nonnull %4, i32 noundef %10) #8
  switch i32 %14, label %18 [
    i32 0, label %22
    i32 3, label %15
    i32 5, label %19
...
15:                                               ; preds = %3
  %16 = call i32 @lzma_get_check(ptr noundef nonnull %6) #8
  br label %19
...
19:                                               ; preds = %3, %15, %17, %18
  %20 = phi ptr [ @.str.7, %18 ], [ @.str.6, %17 ], [ @.str.5, %15 ], [ @.str.5, %3 ]
  %21 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8, i32 noundef %2, i32 noundef %10, ptr noundef nonnull %20, i32 noundef %14)
...
22:                                               ; preds = %3
  call void @llvm.lifetime.end.p0(i64 112, ptr nonnull %5) #8
  call void @llvm.lifetime.end.p0(i64 80, ptr nonnull %4) #8
  %23 = getelementptr inbounds %struct.lzma_stream, ptr %6, i64 0, i32 1
  %24 = getelementptr inbounds %struct.lzma_stream, ptr %6, i64 0, i32 3
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %6, i8 0, i64 16, i1 false)
  store ptr %8, ptr %24, align 8, !tbaa !12
  %25 = getelementptr inbounds %struct.lzma_stream, ptr %6, i64 0, i32 4
  store i64 8192, ptr %25, align 8, !tbaa !14
  br label %28
...
36:                                               ; preds = %32
  ...
  %37 = load ptr, ptr @spec_fd, align 8, !tbaa !16
  %38 = call i64 @spec_mem_fread(ptr noundef %37, i32 noundef 3, ptr noundef nonnull %7, i64 noundef 1, i32 noundef 8192, i32 noundef %0) #8
  store i64 %38, ptr %23, align 8, !tbaa !15
  %39 = load ptr, ptr @spec_fd, align 8, !tbaa !16
  %40 = call i32 @spec_mem_feof(ptr noundef %39, i32 noundef 3, i32 noundef %0) #8
  %41 = icmp eq i32 %40, 0
...
43:                                               ; preds = %36, %32, %28
  %44 = phi i32 [ %30, %32 ], [ %30, %28 ], [ %42, %36 ]
  %45 = call i32 @lzma_code(ptr noundef nonnull %6, i32 noundef %44) #8
  %46 = load i64, ptr %25, align 8, !tbaa !14
  %47 = icmp eq i64 %46, 0
  %48 = icmp eq i32 %45, 1
  %49 = select i1 %47, i1 true, i1 %48
...
50:                                               ; preds = %43
  ...
  %52 = load ptr, ptr @spec_fd, align 8, !tbaa !16
  %53 = trunc i64 %51 to i32
  %54 = call i64 @spec_mem_fwrite(ptr noundef %52, i32 noundef 3, ptr noundef nonnull %8, i64 noundef 1, i32 noundef %53, i32 noundef %1) #8
  %55 = icmp eq i64 %54, %51
  br i1 %55, label %56, label %57
...
57:                                               ; preds = %50
  ...
  %59 = load i32, ptr %58, align 4, !tbaa !18
  %60 = call ptr @strerror(i32 noundef %59) #8
  %61 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.16, i32 noundef %1, ptr noundef %60)
  br label %69
...
63:                                               ; preds = %62
  call void @lzma_end(ptr noundef nonnull %6) #8
  br label %69
...
66:                                               ; preds = %62, %65, %64
  %67 = phi ptr [ @.str.5, %64 ], [ @.str.17, %65 ], [ @.str.14, %62 ]
  %68 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.18, ptr noundef nonnull %67, i32 noundef %45)
  br label %69

69:                                               ; preds = %57, %19, %66, %63
  call void @llvm.lifetime.end.p0(i64 8192, ptr nonnull %8) #8
  call void @llvm.lifetime.end.p0(i64 8192, ptr nonnull %7) #8
...
!11 = !{!6, !10, i64 8}
!12 = !{!13, !10, i64 24}
!13 = !{!"", !10, i64 0, !7, i64 8, !7, i64 16, !10, i64 24, !7, i64 32, !7, i64 40, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !10, i64 88, !7, i64 96, !7, i64 104, !7, i64 112, !7, i64 120, !8, i64 128, !8, i64 132}
!14 = !{!13, !7, i64 32}
!15 = !{!13, !7, i64 8}
!16 = !{!10, !10, i64 0}
!17 = !{!13, !10, i64 0}
