...
13:                                               ; preds = %11
  store i64 %12, ptr @memlimit_compress, align 8, !tbaa !9
  br label %14
...
15:                                               ; preds = %14
  store i64 %12, ptr @memlimit_decompress, align 8, !tbaa !9
  br label %16
...
define dso_local void @hardware_init() local_unnamed_addr #5 {
  ...
  store i64 0, ptr @memlimit_compress, align 8, !tbaa !9
  store i64 0, ptr @memlimit_decompress, align 8, !tbaa !9
  store i32 1, ptr @threadlimit, align 4, !tbaa !5
  ret void
}
