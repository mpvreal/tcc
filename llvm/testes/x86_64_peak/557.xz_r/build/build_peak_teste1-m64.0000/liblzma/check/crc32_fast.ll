...
10:                                               ; preds = %6
  ...
  %23 = and i64 %22, 7
  %24 = icmp eq i64 %23, 0
  br i1 %24, label %127, label %25, !llvm.loop !10

25:                                               ; preds = %10
  %26 = getelementptr inbounds i8, ptr %0, i64 2
  %27 = load i8, ptr %11, align 1, !tbaa !5
  ...
  %38 = and i64 %37, 7
  %39 = icmp eq i64 %38, 0
  br i1 %39, label %127, label %40, !llvm.loop !10
...
40:                                               ; preds = %25
  ...
  %53 = and i64 %52, 7
  %54 = icmp eq i64 %53, 0
  br i1 %54, label %127, label %55, !llvm.loop !10
...
55:                                               ; preds = %40
  ...
  %68 = and i64 %67, 7
  %69 = icmp eq i64 %68, 0
  br i1 %69, label %127, label %70, !llvm.loop !10

70:                                               ; preds = %55
  %71 = getelementptr inbounds i8, ptr %0, i64 5
  %72 = load i8, ptr %56, align 1, !tbaa !5
  ...
  %83 = and i64 %82, 7
  %84 = icmp eq i64 %83, 0
  br i1 %84, label %127, label %85, !llvm.loop !10

85:                                               ; preds = %70
  %86 = getelementptr inbounds i8, ptr %0, i64 6
  %87 = load i8, ptr %71, align 1, !tbaa !5
  ...
  %98 = and i64 %97, 7
  %99 = icmp eq i64 %98, 0
  br i1 %99, label %127, label %100, !llvm.loop !10

100:                                              ; preds = %85
  %101 = getelementptr inbounds i8, ptr %0, i64 7
  %102 = load i8, ptr %86, align 1, !tbaa !5
  ...
  br i1 %114, label %127, label %115, !llvm.loop !10
...
135:                                              ; preds = %127, %135
  ...
  %138 = load i32, ptr %136, align 4, !tbaa !8
  %139 = xor i32 %138, %137
  ...
  %159 = load i32, ptr %140, align 4, !tbaa !8
  ...
  br i1 %186, label %135, label %187, !llvm.loop !12
...
195:                                              ; preds = %192
  ...
  %198 = load i8, ptr %190, align 1, !tbaa !5
...
213:                                              ; preds = %207, %213
  ...
  %229 = load i8, ptr %217, align 1, !tbaa !5
  ...
  br i1 %238, label %239, label %213, !llvm.loop !13
