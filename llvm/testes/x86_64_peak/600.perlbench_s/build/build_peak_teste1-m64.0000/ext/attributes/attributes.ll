...
60:                                               ; preds = %55
  ...
  store i64 %63, ptr %2, align 8, !tbaa !19
...
78:                                               ; preds = %76, %72
  ...
  %81 = load i32, ptr %46, align 4, !tbaa !12
  %82 = and i32 %81, 255
...
89:                                               ; preds = %86
  %90 = load ptr, ptr %41, align 8, !tbaa !15
...
98:                                               ; preds = %95
  ...
  store i32 %101, ptr %91, align 4, !tbaa !20
...
109:                                              ; preds = %106
  %110 = load ptr, ptr %41, align 8, !tbaa !22
...
119:                                              ; preds = %115
  ...
  %127 = or i32 %125, %126
  store i32 %127, ptr %111, align 4, !tbaa !20
...
131:                                              ; preds = %128
  %132 = load ptr, ptr %41, align 8, !tbaa !22
...
135:                                              ; preds = %131
  %136 = and i32 %134, -2
  store i32 %136, ptr %133, align 4, !tbaa !20
  br label %216

137:                                              ; preds = %131
  %138 = or i32 %134, 1
  store i32 %138, ptr %133, align 4, !tbaa !20
  br label %216
...
144:                                              ; preds = %141
  ...
  %148 = load ptr, ptr %41, align 8, !tbaa !22
...
156:                                              ; preds = %153, %144
  ...
  %158 = load i64, ptr %2, align 8, !tbaa !19
  %159 = add i64 %158, -1
...
169:                                              ; preds = %164
  %170 = load ptr, ptr %41, align 8, !tbaa !22
...
185:                                              ; preds = %183, %180
  %186 = load i64, ptr %2, align 8, !tbaa !19
  %187 = add i64 %186, -11
  %188 = load i32, ptr %56, align 4, !tbaa !12
...
205:                                              ; preds = %204, %203
  %206 = load ptr, ptr @PL_sharehook, align 8, !tbaa !6
...
210:                                              ; preds = %95
  ...
  store i32 %211, ptr %91, align 4, !tbaa !20
  br label %216
...
212:                                              ; preds = %115, %109
  ...
  %215 = or i32 %213, %214
  store i32 %215, ptr %111, align 4, !tbaa !20
  br label %216
...
216:                                              ; preds = %212, %210, %207, %205, %195, %185, %137, %135, %119, %98, %93
  ...
  br i1 %220, label %221, label %47, !llvm.loop !24

221:                                              ; preds = %47, %216
  %222 = phi i32 [ %217, %216 ], [ %51, %47 ]
  %223 = sext i32 %222 to i64
  %224 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
...
52:                                               ; preds = %46
  %53 = load ptr, ptr @PL_stack_max, align 8, !tbaa !6
...
80:                                               ; preds = %39, %64, %76
  ...
  store ptr %81, ptr @PL_stack_sp, align 8, !tbaa !6
  ret void
}
...
18:                                               ; preds = %1
  %19 = load ptr, ptr @PL_curpad, align 8, !tbaa !6
...
31:                                               ; preds = %30, %26
  ...
  store ptr %27, ptr %34, align 8, !tbaa !6
...
79:                                               ; preds = %77
  %80 = load ptr, ptr %51, align 8, !tbaa !6
...
85:                                               ; preds = %79
  ...
  %87 = load ptr, ptr %51, align 8, !tbaa !6
  br label %91
...
100:                                              ; preds = %95
  ...
  %102 = load ptr, ptr %51, align 8, !tbaa !6
  br label %106
...
118:                                              ; preds = %113
  ...
  %120 = load ptr, ptr %51, align 8, !tbaa !6
  br label %124
...
200:                                              ; preds = %198, %193
  %201 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
...
40:                                               ; preds = %31
  ...
  %42 = load i32, ptr %36, align 4, !tbaa !12
  br label %43
...
66:                                               ; preds = %64, %56
  ...
  store ptr %68, ptr @PL_stack_sp, align 8, !tbaa !6
  ret void
}
...
!15 = !{!13, !7, i64 0}
!16 = !{!17, !18, i64 16}
!17 = !{!"xpv", !7, i64 0, !8, i64 8, !18, i64 16, !8, i64 24}
!18 = !{!"long", !8, i64 0}
!19 = !{!18, !18, i64 0}
!20 = !{!21, !11, i64 92}
!21 = !{!"xpvcv", !7, i64 0, !8, i64 8, !18, i64 16, !8, i64 24, !7, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !7, i64 64, !8, i64 72, !7, i64 80, !11, i64 88, !11, i64 92, !11, i64 96}
!22 = !{!23, !7, i64 0}
!23 = !{!"cv", !7, i64 0, !11, i64 8, !11, i64 12, !8, i64 16}
!24 = distinct !{!24, !25}
!25 = !{!"llvm.loop.mustprogress"}
!26 = !{!27, !8, i64 35}
!27 = !{!"op", !7, i64 0, !7, i64 8, !7, i64 16, !18, i64 24, !11, i64 32, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !8, i64 34, !8, i64 35}
!28 = !{!27, !18, i64 24}
!29 = !{!30, !7, i64 0}
!30 = !{!"xpvmg", !7, i64 0, !8, i64 8, !18, i64 16, !8, i64 24, !8, i64 32, !8, i64 40}
!31 = !{!32, !11, i64 12}
!32 = !{!"hv", !7, i64 0, !11, i64 8, !11, i64 12, !8, i64 16}
!33 = !{!32, !7, i64 0}
!34 = !{!35, !18, i64 24}
!35 = !{!"xpvhv", !7, i64 0, !8, i64 8, !18, i64 16, !18, i64 24}
!36 = !{!37, !11, i64 28}
!37 = !{!"xpvhv_aux", !8, i64 0, !7, i64 8, !7, i64 16, !11, i64 24, !11, i64 28, !7, i64 32, !11, i64 40, !11, i64 44, !11, i64 48, !11, i64 52}
!38 = !{!39, !11, i64 12}
!39 = !{!"gv", !7, i64 0, !11, i64 8, !11, i64 12, !8, i64 16}
!40 = !{!39, !7, i64 0}
!41 = !{!42, !7, i64 56}
!42 = !{!"gp", !7, i64 0, !7, i64 8, !7, i64 16, !11, i64 24, !11, i64 28, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !11, i64 64, !11, i64 67, !7, i64 72}
