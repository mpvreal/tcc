...
define dso_local void @boot_Tie__Hash__NamedCapture(ptr noundef %0) local_unnamed_addr #0 {
  ...
  store i32 17563656, ptr %6, align 8, !tbaa !12
  ...
  store i32 34078724, ptr %9, align 8, !tbaa !12
  ...
  store i32 33554448, ptr %12, align 8, !tbaa !12
  ...
  store i32 33554433, ptr %15, align 8, !tbaa !12
  ...
  store i32 16777248, ptr %18, align 8, !tbaa !12
  ...
  store i32 51118082, ptr %21, align 8, !tbaa !12
...
define internal void @XS_Tie__Hash__NamedCapture_TIEHASH(ptr noundef %0) #0 {
  ...
  %4 = load ptr, ptr @PL_markstack_ptr, align 8, !tbaa !18
  %5 = getelementptr inbounds i32, ptr %4, i64 -1
  store ptr %5, ptr @PL_markstack_ptr, align 8, !tbaa !18
  %6 = load i32, ptr %4, align 4, !tbaa !19
  %7 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  %8 = add nsw i32 %6, 1
  %9 = sext i32 %6 to i64
...
17:                                               ; preds = %1
  ...
  %18 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  br label %19
...
46:                                               ; preds = %37
  ...
  store i64 %49, ptr %2, align 8, !tbaa !25
...
52:                                               ; preds = %37
  ...
  %54 = load i64, ptr %2, align 8, !tbaa !25
  br label %55
...
86:                                               ; preds = %83
  %87 = load ptr, ptr %64, align 8, !tbaa !22
...
107:                                              ; preds = %104
  %108 = load ptr, ptr %64, align 8, !tbaa !22
...
115:                                              ; preds = %112
  %116 = load ptr, ptr %64, align 8, !tbaa !22
...
125:                                              ; preds = %115, %112, %93, %86, %74, %62, %124, %71, %121, %95, %59, %55
  ...
  br i1 %128, label %37, label %129, !llvm.loop !26
...
129:                                              ; preds = %125, %33
  ...
  %134 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  %135 = getelementptr inbounds ptr, ptr %134, i64 %21
  store ptr %133, ptr %135, align 8, !tbaa !18
  %136 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  %137 = getelementptr inbounds ptr, ptr %136, i64 %21
  store ptr %137, ptr @PL_stack_sp, align 8, !tbaa !18
  ret void
}
...
define internal void @XS_Tie__Hash__NamedCapture_FETCH(ptr noundef %0) #0 {
  ...
  %22 = load ptr, ptr @PL_curpm, align 8, !tbaa !18
...
39:                                               ; preds = %37
  %40 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
...
51:                                               ; preds = %48
  ...
  %52 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
...
56:                                               ; preds = %48
  %57 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  %58 = sext i32 %7 to i64
  %59 = getelementptr inbounds ptr, ptr %57, i64 %58
  store ptr @PL_sv_undef, ptr %59, align 8, !tbaa !18
  %60 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
...
76:                                               ; preds = %74, %70
  ...
  store ptr %21, ptr @PL_stack_sp, align 8, !tbaa !18
...
86:                                               ; preds = %76
  %87 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  %88 = add nsw i32 %5, 2
...
98:                                               ; preds = %76, %86, %93
  ...
  %103 = load ptr, ptr @PL_stack_sp, align 8, !tbaa !18
...
112:                                              ; preds = %108
  %113 = add i32 %110, -1
  store i32 %113, ptr %109, align 8, !tbaa !34
  br label %121
...
118:                                              ; preds = %115, %116
  ...
  store ptr %119, ptr %120, align 8, !tbaa !18
  br label %121

121:                                              ; preds = %114, %112, %107, %118, %56
  %122 = phi ptr [ %61, %56 ], [ %120, %118 ], [ %103, %107 ], [ %103, %112 ], [ %103, %114 ]
  store ptr %122, ptr @PL_stack_sp, align 8, !tbaa !18
  ret void
}
...
33:                                               ; preds = %27
  ...
  %35 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  br label %36
...
47:                                               ; preds = %36, %40
  ...
  store ptr @PL_sv_undef, ptr %48, align 8, !tbaa !18
  %49 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
...
73:                                               ; preds = %64
  %74 = load ptr, ptr @PL_stack_base, align 8, !tbaa !18
  %75 = add nsw i32 %5, 2
...
79:                                               ; preds = %64, %73
  ...
  %83 = load ptr, ptr @PL_stack_sp, align 8, !tbaa !18
...
90:                                               ; preds = %87, %47
  ...
  store ptr %91, ptr @PL_stack_sp, align 8, !tbaa !18
  ret void
}
...
define internal void @XS_Tie__Hash__NamedCapture_flags(ptr nocapture readnone %0) #0 {
  ...
  %16 = load ptr, ptr @PL_stack_max, align 8, !tbaa !18
...
23:                                               ; preds = %1, %21
  ...
  store ptr %28, ptr @PL_stack_sp, align 8, !tbaa !18
  ret void
}
...
!12 = !{!9, !9, i64 0}
!13 = !{!14, !11, i64 92}
!14 = !{!"xpvcv", !8, i64 0, !9, i64 8, !15, i64 16, !9, i64 24, !8, i64 32, !9, i64 40, !9, i64 48, !9, i64 56, !8, i64 64, !9, i64 72, !8, i64 80, !11, i64 88, !11, i64 92, !11, i64 96}
!15 = !{!"long", !9, i64 0}
!16 = !{!17, !8, i64 0}
!17 = !{!"gv", !8, i64 0, !11, i64 8, !11, i64 12, !9, i64 16}
!18 = !{!8, !8, i64 0}
!19 = !{!11, !11, i64 0}
!20 = !{!21, !11, i64 12}
!21 = !{!"sv", !8, i64 0, !11, i64 8, !11, i64 12, !9, i64 16}
!22 = !{!21, !8, i64 0}
!23 = !{!24, !15, i64 16}
!24 = !{!"xpv", !8, i64 0, !9, i64 8, !15, i64 16, !9, i64 24}
!25 = !{!15, !15, i64 0}
!26 = distinct !{!26, !27}
!27 = !{!"llvm.loop.mustprogress"}
!28 = !{!29, !8, i64 56}
!29 = !{!"pmop", !8, i64 0, !8, i64 8, !8, i64 16, !15, i64 24, !11, i64 32, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !9, i64 34, !9, i64 35, !8, i64 40, !8, i64 48, !8, i64 56, !11, i64 64, !9, i64 72, !9, i64 80, !8, i64 88}
!30 = !{!31, !8, i64 32}
!31 = !{!"regexp", !8, i64 0, !9, i64 8, !15, i64 16, !9, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !11, i64 56, !15, i64 64, !15, i64 72, !15, i64 80, !8, i64 88, !11, i64 96, !11, i64 100, !8, i64 104, !11, i64 112, !11, i64 116, !8, i64 120, !8, i64 128, !8, i64 136, !15, i64 144, !15, i64 152, !15, i64 160, !15, i64 168, !11, i64 176, !11, i64 176, !8, i64 184}
!32 = !{!33, !8, i64 64}
!33 = !{!"regexp_engine", !8, i64 0, !8, i64 8, !8, i64 16, !8, i64 24, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !8, i64 64, !8, i64 72, !8, i64 80, !8, i64 88}
!34 = !{!21, !11, i64 8}
!35 = !{!33, !8, i64 72}
!36 = !{!37, !8, i64 32}
!37 = !{!"gp", !8, i64 0, !8, i64 8, !8, i64 16, !11, i64 24, !11, i64 28, !8, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !11, i64 64, !11, i64 67, !8, i64 72}
