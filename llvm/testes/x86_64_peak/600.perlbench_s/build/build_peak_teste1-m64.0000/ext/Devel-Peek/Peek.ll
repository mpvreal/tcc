...
21:                                               ; preds = %17
  %22 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
...
43:                                               ; preds = %19, %40
  ...
  store ptr %48, ptr @PL_stack_sp, align 8, !tbaa !6
  ret void
}
...
51:                                               ; preds = %35, %45, %49
  ...
  %54 = freeze ptr %53
  %55 = load i16, ptr @PL_dumpindent, align 2, !tbaa !16
  store i16 2, ptr @PL_dumpindent, align 2, !tbaa !16
...
62:                                               ; preds = %57, %62
  ...
  %65 = add nsw i64 %63, -1
  %66 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
  ...
  %73 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
  ...
  br i1 %77, label %149, label %62, !llvm.loop !18
...
78:                                               ; preds = %57, %145
  ...
  %92 = load i32, ptr %59, align 4, !tbaa !12
...
109:                                              ; preds = %106
  %110 = load ptr, ptr %54, align 8, !tbaa !15
...
118:                                              ; preds = %116
  %119 = load ptr, ptr %60, align 8, !tbaa !14
...
128:                                              ; preds = %125
  %129 = load ptr, ptr %54, align 8, !tbaa !15
...
145:                                              ; preds = %95, %143, %97, %112, %118, %116, %109, %133, %141, %136, %128
  ...
  br i1 %148, label %149, label %78, !llvm.loop !18

149:                                              ; preds = %145, %62, %51
  %150 = sub nsw i64 0, %21
  %151 = getelementptr inbounds ptr, ptr %2, i64 %150
  store i16 %55, ptr @PL_dumpindent, align 2, !tbaa !16
  store ptr %151, ptr @PL_stack_sp, align 8, !tbaa !6
  ret void
}
...
15:                                               ; preds = %14, %1
  %16 = load i16, ptr @PL_dumpindent, align 2, !tbaa !16
  %17 = zext i16 %16 to i32
  tail call void (ptr, ...) @Perl_warn(ptr noundef nonnull @.str.28, i32 noundef %17) #3
  %18 = load ptr, ptr @PL_main_root, align 8, !tbaa !6
...
63:                                               ; preds = %49, %61
  ...
  store ptr %36, ptr %64, align 8, !tbaa !6
  %65 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
...
15:                                               ; preds = %14, %1
  ...
  %18 = load ptr, ptr @PL_sv_arenaroot, align 8, !tbaa !6
  %19 = icmp eq ptr %18, null
...
20:                                               ; preds = %294, %28
  ...
  %26 = load ptr, ptr %29, align 8, !tbaa !6
  %27 = icmp eq ptr %26, null
  br i1 %27, label %302, label %28, !llvm.loop !27
...
54:                                               ; preds = %42
  %55 = load ptr, ptr %43, align 8, !tbaa !6
...
88:                                               ; preds = %85, %83
  ...
  %90 = load ptr, ptr %43, align 8, !tbaa !30
...
97:                                               ; preds = %88
  ...
  %102 = load i64, ptr %99, align 8, !tbaa !34
...
106:                                              ; preds = %268, %104
  ...
  br i1 %116, label %268, label %117, !llvm.loop !35
...
171:                                              ; preds = %168
  %172 = load ptr, ptr %159, align 8, !tbaa !15
...
183:                                              ; preds = %176, %171, %168, %164
  ...
  %187 = load i32, ptr %136, align 4, !tbaa !12
...
191:                                              ; preds = %250, %188
  ...
  %197 = load ptr, ptr %105, align 8, !tbaa !6
...
205:                                              ; preds = %191
  %206 = load ptr, ptr %197, align 8, !tbaa !36
...
221:                                              ; preds = %216
  ...
  %224 = load ptr, ptr %213, align 8, !tbaa !6
...
231:                                              ; preds = %228
  ...
  %234 = load ptr, ptr %213, align 8, !tbaa !6
...
237:                                              ; preds = %235
  %238 = load ptr, ptr %214, align 8, !tbaa !15
...
268:                                              ; preds = %266, %256, %124, %106
  ...
  %276 = load i64, ptr %99, align 8, !tbaa !34
...
294:                                              ; preds = %283, %94, %71, %68, %54, %42
  ...
  br i1 %301, label %42, label %20, !llvm.loop !43
...
51:                                               ; preds = %47, %44, %17, %26
  ...
  %54 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
...
20:                                               ; preds = %17
  %21 = load ptr, ptr @PL_runops, align 8, !tbaa !6
  br label %44

22:                                               ; preds = %17
  %23 = load ptr, ptr @PL_stack_base, align 8, !tbaa !6
...
36:                                               ; preds = %30, %34
  ...
  %39 = load ptr, ptr @PL_runops, align 8, !tbaa !6
...
41:                                               ; preds = %36
  ...
  store ptr %43, ptr @PL_runops, align 8, !tbaa !6
  br label %44
...
30:                                               ; preds = %23, %23, %23, %23
  ...
  %33 = or i8 %32, 16
  store i8 %33, ptr %31, align 2, !tbaa !47
  br label %38
...
34:                                               ; preds = %23
  ...
  %37 = and i8 %36, -33
  store i8 %37, ptr %35, align 2, !tbaa !47
  br label %38
...
38:                                               ; preds = %34, %30
  ...
  store ptr @S_pp_dump, ptr %46, align 8, !tbaa !48
  ...
  store i8 6, ptr %49, align 2, !tbaa !51
...
22:                                               ; preds = %0, %19
  ...
  store ptr @PL_sv_undef, ptr %23, align 8, !tbaa !6
...
16:                                               ; preds = %2, %10, %14
  ...
  %19 = load i16, ptr @PL_dumpindent, align 2, !tbaa !16
  store i16 2, ptr @PL_dumpindent, align 2, !tbaa !16
...
78:                                               ; preds = %27, %76, %29, %44, %50, %48, %41, %66, %74, %69, %61, %16
  ...
  store i16 %19, ptr @PL_dumpindent, align 2, !tbaa !16
  ret void
}
...
!20 = !{!21, !22, i64 16}
!21 = !{!"xpv", !7, i64 0, !8, i64 8, !22, i64 16, !8, i64 24}
!22 = !{!"long", !8, i64 0}
!23 = !{!24, !8, i64 35}
!24 = !{!"op", !7, i64 0, !7, i64 8, !7, i64 16, !22, i64 24, !11, i64 32, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !8, i64 34, !8, i64 35}
!25 = !{!24, !22, i64 24}
!26 = !{!13, !11, i64 8}
!27 = distinct !{!27, !19}
!28 = !{!29, !11, i64 92}
!29 = !{!"xpvcv", !7, i64 0, !8, i64 8, !22, i64 16, !8, i64 24, !7, i64 32, !8, i64 40, !8, i64 48, !8, i64 56, !7, i64 64, !8, i64 72, !7, i64 80, !11, i64 88, !11, i64 92, !11, i64 96}
!30 = !{!31, !7, i64 0}
!31 = !{!"cv", !7, i64 0, !11, i64 8, !11, i64 12, !8, i64 16}
!32 = !{!33, !7, i64 8}
!33 = !{!"padlist", !22, i64 0, !7, i64 8, !11, i64 16, !11, i64 20}
!34 = !{!33, !22, i64 0}
!35 = distinct !{!35, !19}
!36 = !{!37, !7, i64 0}
!37 = !{!"av", !7, i64 0, !11, i64 8, !11, i64 12, !8, i64 16}
!38 = !{!39, !22, i64 24}
!39 = !{!"xpvav", !7, i64 0, !8, i64 8, !22, i64 16, !22, i64 24, !7, i64 32}
!40 = !{!39, !22, i64 16}
!41 = distinct !{!41, !19}
!42 = distinct !{!42, !19}
!43 = distinct !{!43, !19}
!44 = !{!45, !7, i64 40}
!45 = !{!"unop", !7, i64 0, !7, i64 8, !7, i64 16, !22, i64 24, !11, i64 32, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !8, i64 34, !8, i64 35, !7, i64 40}
!46 = !{!24, !7, i64 8}
!47 = !{!24, !8, i64 34}
!48 = !{!49, !7, i64 16}
!49 = !{!"binop", !7, i64 0, !7, i64 8, !7, i64 16, !22, i64 24, !11, i64 32, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !11, i64 33, !8, i64 34, !8, i64 35, !7, i64 40, !7, i64 48}
!50 = !{!49, !8, i64 35}
!51 = !{!49, !8, i64 34}
!52 = !{!24, !7, i64 0}
