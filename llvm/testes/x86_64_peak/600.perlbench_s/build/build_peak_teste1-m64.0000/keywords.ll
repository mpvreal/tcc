...
27:                                               ; preds = %26
  %28 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
...
235:                                              ; preds = %234
  %236 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
...
290:                                              ; preds = %3
  %291 = load i8, ptr %0, align 1, !tbaa !6
...
658:                                              ; preds = %657
  %659 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
  %660 = getelementptr %struct.cop, ptr %659, i64 0, i32 10
  %661 = load i32, ptr %660, align 8, !tbaa !11
...
673:                                              ; preds = %3
  %674 = load i8, ptr %0, align 1, !tbaa !6
...
765:                                              ; preds = %764
  %766 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
  %767 = getelementptr %struct.cop, ptr %766, i64 0, i32 10
  %768 = load i32, ptr %767, align 8, !tbaa !11
...
901:                                              ; preds = %900
  %902 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
...
1028:                                             ; preds = %1024
  ...
  %1030 = load i8, ptr %1029, align 1, !tbaa !6
...
1109:                                             ; preds = %1108
  %1110 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
  %1111 = getelementptr %struct.cop, ptr %1110, i64 0, i32 10
  %1112 = load i32, ptr %1111, align 8, !tbaa !11
...
1140:                                             ; preds = %1136
  ...
  %1142 = load i8, ptr %1141, align 1, !tbaa !6
...
1227:                                             ; preds = %3
  %1228 = load i8, ptr %0, align 1, !tbaa !6
...
1262:                                             ; preds = %1258
  ...
  %1264 = load i8, ptr %1263, align 1, !tbaa !6
...
1314:                                             ; preds = %1310
  ...
  %1316 = load i8, ptr %1315, align 1, !tbaa !6
...
1363:                                             ; preds = %1343
  ...
  %1365 = load i8, ptr %1364, align 1, !tbaa !6
...
1375:                                             ; preds = %1371
  ...
  %1377 = load i8, ptr %1376, align 1, !tbaa !6
...
1391:                                             ; preds = %1387
  ...
  %1393 = load i8, ptr %1392, align 1, !tbaa !6
...
1415:                                             ; preds = %1411
  ...
  %1417 = load i8, ptr %1416, align 1, !tbaa !6
...
1443:                                             ; preds = %1439
  ...
  %1445 = load i8, ptr %1444, align 1, !tbaa !6
...
1447:                                             ; preds = %1443
  ...
  %1449 = load i8, ptr %1448, align 1, !tbaa !6
...
1495:                                             ; preds = %1491
  ...
  %1497 = load i8, ptr %1496, align 1, !tbaa !6
...
1535:                                             ; preds = %1531
  ...
  %1537 = load i8, ptr %1536, align 1, !tbaa !6
...
1547:                                             ; preds = %1227
  ...
  %1549 = load i8, ptr %1548, align 1, !tbaa !6
...
1563:                                             ; preds = %1559
  ...
  %1565 = load i8, ptr %1564, align 1, !tbaa !6
...
1667:                                             ; preds = %1663
  ...
  %1669 = load i8, ptr %1668, align 1, !tbaa !6
...
1695:                                             ; preds = %1691
  ...
  %1697 = load i8, ptr %1696, align 1, !tbaa !6
...
1699:                                             ; preds = %1695
  ...
  %1701 = load i8, ptr %1700, align 1, !tbaa !6
...
1707:                                             ; preds = %1703
  ...
  %1709 = load i8, ptr %1708, align 1, !tbaa !6
...
1719:                                             ; preds = %1695
  ...
  %1721 = load i8, ptr %1720, align 1, !tbaa !6
...
1735:                                             ; preds = %1731
  ...
  %1737 = load i8, ptr %1736, align 1, !tbaa !6
...
1747:                                             ; preds = %1743
  ...
  %1749 = load i8, ptr %1748, align 1, !tbaa !6
  %1750 = icmp eq i8 %1749, 115
  br i1 %1750, label %4041, label %4033

1751:                                             ; preds = %3
  %1752 = load i8, ptr %0, align 1, !tbaa !6
...
1819:                                             ; preds = %1818
  %1820 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
  %1821 = getelementptr %struct.cop, ptr %1820, i64 0, i32 10
  %1822 = load i32, ptr %1821, align 8, !tbaa !11
...
1882:                                             ; preds = %1878
  ...
  %1884 = load i8, ptr %1883, align 1, !tbaa !6
...
1923:                                             ; preds = %1922
  %1924 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
  %1925 = getelementptr %struct.cop, ptr %1924, i64 0, i32 10
  %1926 = load i32, ptr %1925, align 8, !tbaa !11
...
1938:                                             ; preds = %1906
  ...
  %1940 = load i8, ptr %1939, align 1, !tbaa !6
...
2138:                                             ; preds = %2134
  ...
  %2140 = load i8, ptr %2139, align 1, !tbaa !6
...
3000:                                             ; preds = %2999
  %3001 = load ptr, ptr @PL_curcop, align 8, !tbaa !9
  %3002 = getelementptr %struct.cop, ptr %3001, i64 0, i32 10
  %3003 = load i32, ptr %3002, align 8, !tbaa !11
...
3585:                                             ; preds = %3581
  ...
  %3587 = load i8, ptr %3586, align 1, !tbaa !6
...
!11 = !{!12, !14, i64 56}
!12 = !{!"cop", !10, i64 0, !10, i64 8, !10, i64 16, !13, i64 24, !14, i64 32, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !7, i64 34, !7, i64 35, !14, i64 36, !10, i64 40, !10, i64 48, !14, i64 56, !14, i64 60, !10, i64 64, !10, i64 72}
!13 = !{!"long", !7, i64 0}
!14 = !{!"int", !7, i64 0}
