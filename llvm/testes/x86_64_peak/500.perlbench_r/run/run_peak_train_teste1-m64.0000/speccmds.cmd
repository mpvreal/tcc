...
-o diffmail.2.550.15.24.23.100.out -e diffmail.2.550.15.24.23.100.err echo "../run_peak_train_teste1-m64.0000/perlbench_r_peak.teste1-m64 -I./lib diffmail.pl 2 550 15 24 23 100" > run.sh ; $BIND bash run.sh
-o perfect.b.3.out -e perfect.b.3.err echo "../run_peak_train_teste1-m64.0000/perlbench_r_peak.teste1-m64 -I./lib perfect.pl b 3" > run.sh ; $BIND bash run.sh
-i scrabbl.in -o scrabbl.out -e scrabbl.err echo "../run_peak_train_teste1-m64.0000/perlbench_r_peak.teste1-m64 -I. -I./lib scrabbl.pl" > run.sh ; $BIND bash run.sh
-o splitmail.535.13.25.24.1091.1.out -e splitmail.535.13.25.24.1091.1.err echo "../run_peak_train_teste1-m64.0000/perlbench_r_peak.teste1-m64 -I./lib splitmail.pl 535 13 25 24 1091 1" > run.sh ; $BIND bash run.sh
-o suns.out -e suns.err echo "../run_peak_train_teste1-m64.0000/perlbench_r_peak.teste1-m64 -I. -I./lib suns.pl" > run.sh ; $BIND bash run.sh
