...
17:                                               ; preds = %16, %1
  ...
  %22 = load ptr, ptr @PL_op, align 8, !tbaa !16
...
27:                                               ; preds = %17
  %28 = load ptr, ptr @PL_curpad, align 8, !tbaa !16
...
157:                                              ; preds = %74, %77, %80, %83, %86, %57, %64, %67, %89, %96, %106, %109, %115, %118, %121, %131, %137, %140, %143, %146
  ...
  %159 = load ptr, ptr @PL_stack_max, align 8, !tbaa !16
...
166:                                              ; preds = %157, %164
  ...
  store ptr @PL_sv_undef, ptr %168, align 8, !tbaa !16
...
175:                                              ; preds = %166, %173
  ...
  store ptr %36, ptr %176, align 8, !tbaa !16
  br label %177

177:                                              ; preds = %175, %153, %149
  %178 = phi ptr [ %176, %175 ], [ %156, %153 ], [ %152, %149 ]
  store ptr %178, ptr @PL_stack_sp, align 8, !tbaa !16
...
30:                                               ; preds = %21
  %31 = load ptr, ptr %25, align 8, !tbaa !23
...
36:                                               ; preds = %34, %30
  ...
  %38 = load ptr, ptr @PL_op, align 8, !tbaa !16
...
43:                                               ; preds = %36
  %44 = load ptr, ptr @PL_curpad, align 8, !tbaa !16
...
78:                                               ; preds = %76, %70
  ...
  %80 = load i64, ptr %4, align 8, !tbaa !5
  %81 = load i64, ptr %3, align 8, !tbaa !5
  ...
  %92 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
...
99:                                               ; preds = %78, %97
  ...
  store ptr %52, ptr %100, align 8, !tbaa !16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %4) #6
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %3) #6
  %101 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
...
51:                                               ; preds = %42, %49
  ...
  %53 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  %54 = getelementptr inbounds ptr, ptr %53, i64 %19
  store ptr %54, ptr @PL_stack_sp, align 8, !tbaa !16
  ret void
}
...
define internal void @XS_Time__HiRes_sleep(ptr nocapture readnone %0) #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %3) #6
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %4) #6
  %18 = load ptr, ptr @PL_op, align 8, !tbaa !16
...
23:                                               ; preds = %1
  %24 = load ptr, ptr @PL_curpad, align 8, !tbaa !16
...
66:                                               ; preds = %65, %63
  ...
  store i64 %58, ptr %67, align 8, !tbaa !10
...
72:                                               ; preds = %66, %69, %70
  ...
  %74 = load i64, ptr %4, align 8, !tbaa !5
  %75 = load i64, ptr %3, align 8, !tbaa !5
  ...
  %86 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
...
93:                                               ; preds = %72, %91
  ...
  store ptr %32, ptr %95, align 8, !tbaa !16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %4) #6
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %3) #6
  %96 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  %97 = getelementptr inbounds ptr, ptr %96, i64 %94
  store ptr %97, ptr @PL_stack_sp, align 8, !tbaa !16
  ret void
}
...
30:                                               ; preds = %19, %28
  %31 = load ptr, ptr @PL_op, align 8, !tbaa !16
...
36:                                               ; preds = %30
  %37 = load ptr, ptr @PL_curpad, align 8, !tbaa !16
...
47:                                               ; preds = %44
  %48 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  %49 = add nsw i32 %5, 2
...
59:                                               ; preds = %57, %47, %44
  ...
  %60 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
...
67:                                               ; preds = %59, %65
  ...
  store ptr %45, ptr %68, align 8, !tbaa !16
  %69 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  %70 = getelementptr inbounds ptr, ptr %69, i64 %21
  store ptr %70, ptr @PL_stack_sp, align 8, !tbaa !16
  ret void
}
...
23:                                               ; preds = %16
  %24 = load ptr, ptr @PL_op, align 8, !tbaa !16
...
33:                                               ; preds = %31, %29
  ...
  %35 = icmp eq i32 %34, 3
  %36 = load ptr, ptr @PL_stack_max, align 8, !tbaa !16
...
59:                                               ; preds = %55, %57
  ...
  %61 = load i64, ptr %2, align 8, !tbaa !5
...
71:                                               ; preds = %44, %59, %16
  ...
  store ptr %72, ptr @PL_stack_sp, align 8, !tbaa !16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %2) #6
  ret void
}
...
16:                                               ; preds = %15, %1
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %2) #6
  %17 = load ptr, ptr @PL_op, align 8, !tbaa !16
...
22:                                               ; preds = %16
  %23 = load ptr, ptr @PL_curpad, align 8, !tbaa !16
...
51:                                               ; preds = %42, %49
  ...
  store ptr %31, ptr %54, align 8, !tbaa !16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %2) #6
  %55 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  %56 = getelementptr inbounds ptr, ptr %55, i64 %53
  store ptr %56, ptr @PL_stack_sp, align 8, !tbaa !16
  ret void
}
...
34:                                               ; preds = %31
  %35 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
...
45:                                               ; preds = %43, %34, %31
  ...
  %46 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
...
53:                                               ; preds = %45, %51
  ...
  store ptr %32, ptr %55, align 8, !tbaa !16
  %56 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  %57 = getelementptr inbounds ptr, ptr %56, i64 %54
  store ptr %57, ptr @PL_stack_sp, align 8, !tbaa !16
  ret void
}
...
40:                                               ; preds = %31, %38
  ...
  store ptr %32, ptr %43, align 8, !tbaa !16
  %44 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  %45 = getelementptr inbounds ptr, ptr %44, i64 %42
  store ptr %45, ptr @PL_stack_sp, align 8, !tbaa !16
  ret void
}
...
38:                                               ; preds = %29, %36
  ...
  store ptr %30, ptr %41, align 8, !tbaa !16
...
define internal void @XS_Time__HiRes_stat(ptr nocapture noundef readonly %0) #0 {
  ...
  %21 = load ptr, ptr @PL_stack_max, align 8, !tbaa !16
...
36:                                               ; preds = %28
  %37 = load ptr, ptr @PL_defgv, align 8, !tbaa !16
...
46:                                               ; preds = %42, %36, %32
  ...
  store ptr %51, ptr @PL_stack_sp, align 8, !tbaa !16
  tail call void @Perl_push_scope() #6
  store i32 -1, ptr @PL_laststatval, align 4, !tbaa !17
  %52 = load ptr, ptr @PL_op, align 8, !tbaa !16
  ...
  %60 = load ptr, ptr @PL_op, align 8, !tbaa !16
  %61 = getelementptr inbounds %struct.op, ptr %60, i64 0, i32 5
  %62 = load i8, ptr %61, align 2, !tbaa !27
  %63 = and i8 %62, 3
  %64 = icmp eq i8 %63, 0
  br i1 %64, label %67, label %65
...
72:                                               ; preds = %69
  %73 = load ptr, ptr @PL_op, align 8, !tbaa !16
...
86:                                               ; preds = %69, %82
  ...
  store i8 %87, ptr %88, align 2, !tbaa !27
  store ptr %2, ptr @PL_op, align 8, !tbaa !16
  %89 = call ptr %58() #6
...
109:                                              ; preds = %100
  ...
  %111 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  br label %112
...
122:                                              ; preds = %112
  ...
  %124 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  br label %125
...
135:                                              ; preds = %125
  ...
  %137 = load ptr, ptr @PL_stack_base, align 8, !tbaa !16
  br label %138
...
138:                                              ; preds = %125, %135, %86
  ...
  store ptr %144, ptr @PL_stack_sp, align 8, !tbaa !16
...
!10 = !{!6, !7, i64 8}
!11 = !{!12, !13, i64 0}
!12 = !{!"cv", !13, i64 0, !14, i64 8, !14, i64 12, !8, i64 16}
...
!17 = !{!14, !14, i64 0}
!18 = !{!19, !8, i64 35}
!19 = !{!"op", !13, i64 0, !13, i64 8, !13, i64 16, !7, i64 24, !14, i64 32, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !14, i64 33, !8, i64 34, !8, i64 35}
!20 = !{!19, !7, i64 24}
!21 = !{!22, !14, i64 12}
!22 = !{!"sv", !13, i64 0, !14, i64 8, !14, i64 12, !8, i64 16}
!23 = !{!22, !13, i64 0}
!24 = !{!25, !7, i64 16}
!25 = !{!"xpv", !13, i64 0, !8, i64 8, !7, i64 16, !8, i64 24}
!26 = !{!7, !7, i64 0}
!27 = !{!19, !8, i64 34}
!28 = !{!29, !13, i64 0}
!29 = !{!"gp", !13, i64 0, !13, i64 8, !13, i64 16, !14, i64 24, !14, i64 28, !13, i64 32, !13, i64 40, !13, i64 48, !13, i64 56, !14, i64 64, !14, i64 67, !13, i64 72}
!30 = !{!19, !13, i64 16}
