...
define dso_local void @Perl_save_long(ptr noundef %0) local_unnamed_addr #0 {
  %2 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  %3 = add nsw i32 %2, 7
  %4 = load i32, ptr @PL_savestack_max, align 4, !tbaa !18
  %5 = icmp sgt i32 %3, %4
  br i1 %5, label %6, label %8

6:                                                ; preds = %1
  tail call void @Perl_savestack_grow() #10
  %7 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  br label %8

8:                                                ; preds = %1, %6
  %9 = phi i32 [ %2, %1 ], [ %7, %6 ]
  %10 = load i64, ptr %0, align 8, !tbaa !16
  %11 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %12 = add nsw i32 %9, 1
  store i32 %12, ptr @PL_savestack_ix, align 4, !tbaa !18
  %13 = sext i32 %9 to i64
  %14 = getelementptr inbounds %union.any, ptr %11, i64 %13
  store i64 %10, ptr %14, align 8, !tbaa !12
  %15 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %16 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  %17 = add nsw i32 %16, 1
  store i32 %17, ptr @PL_savestack_ix, align 4, !tbaa !18
  %18 = sext i32 %16 to i64
  %19 = getelementptr inbounds %union.any, ptr %15, i64 %18
  store ptr %0, ptr %19, align 8, !tbaa !12
  %20 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %21 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  %22 = add nsw i32 %21, 1
  store i32 %22, ptr @PL_savestack_ix, align 4, !tbaa !18
...
8:                                                ; preds = %1, %6
  ...
  %23 = sext i32 %21 to i64
  %24 = getelementptr inbounds %union.any, ptr %20, i64 %23
  store i64 36, ptr %24, align 8, !tbaa !12
  ret void
}
...
8:                                                ; preds = %1, %6
  %9 = phi i32 [ %2, %1 ], [ %7, %6 ]
  %10 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %11 = add nsw i32 %9, 1
  store i32 %11, ptr @PL_savestack_ix, align 4, !tbaa !18
  %12 = sext i32 %9 to i64
  %13 = getelementptr inbounds %union.any, ptr %10, i64 %12
  store ptr %0, ptr %13, align 8, !tbaa !12
  %14 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %15 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  %16 = add nsw i32 %15, 1
  store i32 %16, ptr @PL_savestack_ix, align 4, !tbaa !18
...
17:                                               ; preds = %7, %15
  ...
  %20 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  %21 = add nsw i32 %20, 7
  %22 = load i32, ptr @PL_savestack_max, align 4, !tbaa !18
  %23 = icmp sgt i32 %21, %22
  br i1 %23, label %24, label %26

24:                                               ; preds = %17
  tail call void @Perl_savestack_grow() #10
  %25 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  br label %26

26:                                               ; preds = %17, %24
  %27 = phi i32 [ %20, %17 ], [ %25, %24 ]
  %28 = load ptr, ptr %9, align 8, !tbaa !17
  %29 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %30 = add nsw i32 %27, 1
  store i32 %30, ptr @PL_savestack_ix, align 4, !tbaa !18
  %31 = sext i32 %27 to i64
  %32 = getelementptr inbounds %union.any, ptr %29, i64 %31
  store ptr %28, ptr %32, align 8, !tbaa !12
  %33 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %34 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  %35 = add nsw i32 %34, 1
  store i32 %35, ptr @PL_savestack_ix, align 4, !tbaa !18
  %36 = sext i32 %34 to i64
  %37 = getelementptr inbounds %union.any, ptr %33, i64 %36
  store ptr %18, ptr %37, align 8, !tbaa !12
  %38 = load ptr, ptr @PL_savestack, align 8, !tbaa !17
  %39 = load i32, ptr @PL_savestack_ix, align 4, !tbaa !18
  %40 = add nsw i32 %39, 1
  store i32 %40, ptr @PL_savestack_ix, align 4, !tbaa !18
  %41 = sext i32 %39 to i64
  %42 = getelementptr inbounds %union.any, ptr %38, i64 %41
  store i64 35, ptr %42, align 8, !tbaa !12
  %43 = add nuw nsw i64 %8, 1
  %44 = icmp eq i64 %43, %6
  br i1 %44, label %45, label %7, !llvm.loop !19
...
define dso_local void @Perl_save_op() local_unnamed_addr #0 {
  %1 = load ptr, ptr @PL_op, align 8, !tbaa !17
...
define dso_local zeroext i1 @Perl_isIDFIRST_lazy(ptr noundef %0) local_unnamed_addr #0 {
  %2 = load ptr, ptr @PL_curcop, align 8, !tbaa !17
...
3:                                                ; preds = %1
  %4 = load i8, ptr @PL_in_utf8_CTYPE_locale, align 1, !tbaa !25, !range !27, !noundef !28
  %5 = icmp eq i8 %4, 0
...
define dso_local ptr @Perl_pad_compname_type(i64 noundef %0) local_unnamed_addr #9 {
  %2 = load ptr, ptr @PL_comppad_name, align 8, !tbaa !17
...
!12 = !{!8, !8, i64 0}
!13 = !{!14, !15, i64 16}
!14 = !{!"xpv", !7, i64 0, !8, i64 8, !15, i64 16, !8, i64 24}
!15 = !{!"long", !8, i64 0}
!16 = !{!15, !15, i64 0}
!17 = !{!7, !7, i64 0}
!18 = !{!10, !10, i64 0}
...
!21 = !{!22, !10, i64 56}
!22 = !{!"cop", !7, i64 0, !7, i64 8, !7, i64 16, !15, i64 24, !10, i64 32, !10, i64 33, !10, i64 33, !10, i64 33, !10, i64 33, !10, i64 33, !10, i64 33, !10, i64 33, !8, i64 34, !8, i64 35, !10, i64 36, !7, i64 40, !7, i64 48, !10, i64 56, !10, i64 60, !7, i64 64, !7, i64 72}
!23 = !{!24, !24, i64 0}
!24 = !{!"short", !8, i64 0}
!25 = !{!26, !26, i64 0}
!26 = !{!"_Bool", !8, i64 0}
...
!28 = !{}
!29 = !{!30, !7, i64 8}
!30 = !{!"padnamelist", !15, i64 0, !7, i64 8, !15, i64 16, !15, i64 24, !10, i64 32}
