...
define dso_local void @Perl_taint_proper(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  %3 = load i8, ptr @PL_tainted, align 1, !tbaa !5, !range !9, !noundef !10
  %4 = icmp eq i8 %3, 0
...
11:                                               ; preds = %5
  %12 = load i8, ptr @PL_taint_warn, align 1, !range !9
  br label %21
...
13:                                               ; preds = %5
  ...
  %17 = load i8, ptr @PL_taint_warn, align 1, !range !9
...
21:                                               ; preds = %11, %18, %13
  ...
  %24 = load i8, ptr @PL_unsafe, align 1, !tbaa !5, !range !9, !noundef !10
  %25 = icmp eq i8 %24, 0
  %26 = icmp eq i8 %22, 0
...
define dso_local void @Perl_taint_env() local_unnamed_addr #0 {
  ...
  %2 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
18:                                               ; preds = %15
  %19 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
22:                                               ; preds = %18, %10, %4
  ...
  %25 = load i8, ptr @PL_tainted, align 1, !tbaa !5, !range !9, !noundef !10
...
38:                                               ; preds = %37, %36
  store i8 %25, ptr @PL_tainted, align 1, !tbaa !5
  br label %39

39:                                               ; preds = %38, %15
  %40 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
67:                                               ; preds = %66, %64, %59
  %68 = load ptr, ptr %54, align 8, !tbaa !11
...
77:                                               ; preds = %67, %71, %76, %56, %52
  %78 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
104:                                              ; preds = %102
  ...
  %105 = load i8, ptr @PL_tainted, align 1, !tbaa !5, !range !9, !noundef !10
...
111:                                              ; preds = %104
  ...
  store i64 %114, ptr %1, align 8, !tbaa !31
...
117:                                              ; preds = %104
  ...
  %119 = load i64, ptr %1, align 8, !tbaa !31
  br label %120
...
120:                                              ; preds = %117, %111
  ...
  store i8 %105, ptr @PL_tainted, align 1, !tbaa !5
...
149:                                              ; preds = %137, %145
  ...
  br i1 %151, label %137, label %153, !llvm.loop !33
...
154:                                              ; preds = %153, %102, %97, %94, %90
  %155 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
171:                                              ; preds = %167
  %172 = load ptr, ptr %169, align 8, !tbaa !11
...
182:                                              ; preds = %181, %179, %174, %171, %167
  %183 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
210:                                              ; preds = %209, %207, %202, %199, %195
  %211 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
227:                                              ; preds = %223
  %228 = load ptr, ptr %225, align 8, !tbaa !11
...
238:                                              ; preds = %237, %235, %230, %227, %223
  %239 = load ptr, ptr @PL_envgv, align 8, !tbaa !11
...
255:                                              ; preds = %251
  %256 = load ptr, ptr %253, align 8, !tbaa !11
...
!13 = !{!7, !7, i64 0}
!14 = !{!15, !12, i64 32}
!15 = !{!"gp", !12, i64 0, !12, i64 8, !12, i64 16, !16, i64 24, !16, i64 28, !12, i64 32, !12, i64 40, !12, i64 48, !12, i64 56, !16, i64 64, !16, i64 67, !12, i64 72}
!16 = !{!"int", !7, i64 0}
!17 = !{!18, !16, i64 12}
!18 = !{!"hv", !12, i64 0, !16, i64 8, !16, i64 12, !7, i64 16}
!19 = !{!15, !12, i64 56}
!20 = !{!21, !12, i64 0}
!21 = !{!"gv", !12, i64 0, !16, i64 8, !16, i64 12, !7, i64 16}
!22 = !{!23, !16, i64 12}
!23 = !{!"sv", !12, i64 0, !16, i64 8, !16, i64 12, !7, i64 16}
!24 = !{!25, !7, i64 19}
!25 = !{!"magic", !12, i64 0, !12, i64 8, !26, i64 16, !7, i64 18, !7, i64 19, !27, i64 24, !12, i64 32, !12, i64 40}
!26 = !{!"short", !7, i64 0}
!27 = !{!"long", !7, i64 0}
!28 = !{!23, !12, i64 0}
!29 = !{!30, !27, i64 16}
!30 = !{!"xpv", !12, i64 0, !7, i64 8, !27, i64 16, !7, i64 24}
!31 = !{!27, !27, i64 0}
!32 = !{!16, !16, i64 0}
!33 = distinct !{!33, !34}
