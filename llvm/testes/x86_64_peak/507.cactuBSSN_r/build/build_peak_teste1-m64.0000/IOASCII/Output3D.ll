...
@.str.1 = private unnamed_addr constant [19 x i8] c"IOASCII/Output3D.c\00", align 1
@.str.2 = private unnamed_addr constant [59 x i8] c"There is no such variable %s.  Ignoring IOASCII 3D output.\00", align 1
@.str.3 = private unnamed_addr constant [85 x i8] c"Already done IOASCII 3D output for '%s' in current iteration (probably via triggers)\00", align 1
...
@.str.5 = private unnamed_addr constant [39 x i8] c"Periodic 3D output every %d iterations\00", align 1
@.str.6 = private unnamed_addr constant [30 x i8] c"Periodic 3D output turned off\00", align 1
@.str.7 = private unnamed_addr constant [52 x i8] c"error while parsing parameter 'IOASCII::out3D_vars'\00", align 1
@.str.8 = private unnamed_addr constant [38 x i8] c"Periodic 3D output requested for '%s'\00", align 1
@.str.9 = private unnamed_addr constant [9 x i8] c"%s, '%s'\00", align 1
@.str.10 = private unnamed_addr constant [53 x i8] c"$Id: Output3D.c 207 2009-12-05 03:07:04Z schnetter $\00", align 1
@.str.11 = private unnamed_addr constant [9 x i8] c"dim != 3\00", align 1
@.str.12 = private unnamed_addr constant [29 x i8] c"not a grid function or array\00", align 1
@.str.13 = private unnamed_addr constant [34 x i8] c"No IOASCII 3D output for '%s': %s\00", align 1
...
7:                                                ; preds = %3
  %8 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 133, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.2, ptr noundef %1) #7
  br label %25
...
19:                                               ; preds = %9, %15
  %20 = phi ptr [ @.str.12, %15 ], [ @.str.11, %9 ]
  %21 = call ptr @CCTK_FullName(i32 noundef %5) #7
  %22 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 363, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.13, ptr noundef %21, ptr noundef nonnull %20) #7
...
define dso_local void @IOASCII_CheckSteerableParameters3D(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %3 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 17), align 8, !tbaa !20
  %4 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 34), align 4, !tbaa !22
  %5 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 38), align 8, !tbaa !23
  %6 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 27), align 8, !tbaa !25
...
38:                                               ; preds = %30
  ...
  %43 = tail call i32 @CCTK_Warn(i32 noundef %42, i32 noundef 296, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.7) #7
  br label %44
...
70:                                               ; preds = %54, %69
  ...
  br i1 %72, label %73, label %54, !llvm.loop !30
...
14:                                               ; preds = %3, %10
  %15 = phi ptr [ @.str.12, %10 ], [ @.str.11, %3 ]
  %16 = call ptr @CCTK_FullName(i32 noundef %0) #7
  %17 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 363, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str, ptr noundef nonnull @.str.13, ptr noundef %16, ptr noundef nonnull %15) #7
...
!18 = !{!19, !7, i64 12}
!19 = !{!"", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !7, i64 32}
!20 = !{!21, !10, i64 136}
