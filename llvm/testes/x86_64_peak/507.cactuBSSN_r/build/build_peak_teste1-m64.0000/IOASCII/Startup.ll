...
@.str.1 = private unnamed_addr constant [52 x i8] c"$Id: Startup.c 206 2009-12-05 02:14:32Z schnetter $\00", align 1
...
define dso_local i32 @IOASCII_Startup() local_unnamed_addr #1 {
  %1 = tail call i32 @CCTK_RegisterGHExtension(ptr noundef nonnull @.str) #7
...
define internal ptr @IOASCII_SetupGH(ptr nocapture readnone %0, i32 %1, ptr noundef %2) #1 {
  %4 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 9), align 8, !tbaa !5
  %5 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 12), align 8, !tbaa !12
  %6 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 15), align 8, !tbaa !13
  %7 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 20), align 4, !tbaa !14
  %8 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 30), align 4, !tbaa !15
  %9 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 34), align 4, !tbaa !16
  %10 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 18), align 8, !tbaa !17
  %11 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 27), align 8, !tbaa !19
  %12 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 56), align 8, !tbaa !20
  %13 = tail call noalias dereferenceable_or_null(160) ptr @malloc(i64 noundef 160) #8
  %14 = icmp eq ptr %13, null
  br i1 %14, label %15, label %17

15:                                               ; preds = %3
  %16 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 167, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str, ptr noundef nonnull @.str.3) #7
  br label %17

17:                                               ; preds = %15, %3
  %18 = tail call i32 @CCTKi_RegisterIOMethod(ptr noundef nonnull @.str, ptr noundef nonnull @.str.4) #7
...
25:                                               ; preds = %17
  %26 = tail call i32 @CCTKi_RegisterIOMethod(ptr noundef nonnull @.str, ptr noundef nonnull @.str.5) #7
...
32:                                               ; preds = %25
  %33 = tail call i32 @CCTKi_RegisterIOMethod(ptr noundef nonnull @.str, ptr noundef nonnull @.str.6) #7
...
56:                                               ; preds = %38
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %49, i8 -1, i64 %58, i1 false), !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr align 4 %51, i8 -1, i64 %58, i1 false), !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr align 4 %53, i8 -1, i64 %58, i1 false), !tbaa !28
  br label %59
...
59:                                               ; preds = %56, %38
  ...
  %66 = add nsw i32 %7, -1
  store i32 %66, ptr %13, align 8, !tbaa !32
  %67 = add nsw i32 %8, -1
  ...
  store i32 %12, ptr %72, align 8, !tbaa !35
  %73 = tail call i32 @CCTK_Equals(ptr noundef %11, ptr noundef nonnull @.str.8) #7
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %75, label %77

75:                                               ; preds = %59
  %76 = tail call i32 @CCTK_Info(ptr noundef nonnull @.str, ptr noundef nonnull @.str.9) #7
  br label %77
...
81:                                               ; preds = %78
  %82 = tail call i32 @CCTK_Info(ptr noundef nonnull @.str, ptr noundef nonnull @.str.10) #7
  br label %83
...
88:                                               ; preds = %85
  %89 = tail call i32 @CCTK_Info(ptr noundef nonnull @.str, ptr noundef nonnull @.str.11) #7
  br label %90
...
91:                                               ; preds = %90, %84
  ...
  %92 = load i8, ptr %4, align 1, !tbaa !36
  %93 = icmp eq i8 %92, 0
...
112:                                              ; preds = %107
  %113 = load ptr, ptr %109, align 8, !tbaa !37
  %114 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 252, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str, ptr noundef nonnull @.str.14, ptr noundef %113, i32 noundef 1) #7
  br label %121
...
118:                                              ; preds = %115
  %119 = load ptr, ptr %109, align 8, !tbaa !37
  %120 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str, ptr noundef nonnull @.str.16, i32 noundef 1, ptr noundef %119) #7
  br label %121

121:                                              ; preds = %115, %118, %112
  %122 = load i8, ptr %5, align 1, !tbaa !36
...
142:                                              ; preds = %137
  ...
  %144 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 253, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str, ptr noundef nonnull @.str.14, ptr noundef %143, i32 noundef 2) #7
  br label %151
...
148:                                              ; preds = %145
  ...
  %150 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str, ptr noundef nonnull @.str.16, i32 noundef 2, ptr noundef %149) #7
  br label %151

151:                                              ; preds = %145, %148, %142
  %152 = load i8, ptr %6, align 1, !tbaa !36
...
172:                                              ; preds = %167
  %173 = load ptr, ptr %169, align 8, !tbaa !39
  %174 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 254, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str, ptr noundef nonnull @.str.14, ptr noundef %173, i32 noundef 3) #7
  br label %181
...
178:                                              ; preds = %175
  %179 = load ptr, ptr %169, align 8, !tbaa !39
  %180 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str, ptr noundef nonnull @.str.16, i32 noundef 3, ptr noundef %179) #7
  br label %181
...
!20 = !{!18, !11, i64 336}
!21 = !{!22, !10, i64 16}
!22 = !{!"IOASCIIGH", !11, i64 0, !11, i64 4, !11, i64 8, !10, i64 16, !10, i64 24, !10, i64 32, !10, i64 40, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !10, i64 88, !10, i64 96, !10, i64 104, !10, i64 112, !10, i64 120, !10, i64 128, !10, i64 136, !10, i64 144, !11, i64 152}
!23 = !{!22, !10, i64 24}
!24 = !{!22, !10, i64 32}
!25 = !{!22, !10, i64 88}
!26 = !{!22, !10, i64 96}
