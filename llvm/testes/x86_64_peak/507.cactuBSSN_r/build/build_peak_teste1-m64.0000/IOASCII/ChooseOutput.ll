...
define dso_local void @IOASCII_Choose1D(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %4 = load double, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 2), align 8, !tbaa !5
  %5 = load double, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 5), align 8, !tbaa !12
  %6 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 25), align 8, !tbaa !13
  %7 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 26), align 4, !tbaa !14
  %8 = load double, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 6), align 8, !tbaa !15
  %9 = load <2 x double>, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 7), align 8
  %10 = load double, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 9), align 8, !tbaa !17
  %11 = load double, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 10), align 8, !tbaa !18
  %12 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 47), align 4, !tbaa !19
  %13 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 48), align 8, !tbaa !20
  %14 = tail call noalias dereferenceable_or_null(72) ptr @calloc(i64 noundef 9, i64 noundef 8) #8
  store ptr %14, ptr %3, align 16, !tbaa !21
  ...
  store ptr %22, ptr %23, align 16, !tbaa !21
  %24 = getelementptr inbounds i32, ptr %19, i64 1
  %25 = getelementptr inbounds double, ptr %14, i64 1
  %26 = load <2 x i32>, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 22), align 4, !tbaa !22
  %27 = load <2 x i32>, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 43), align 4, !tbaa !22
  %28 = icmp slt <2 x i32> %26, zeroinitializer
  %29 = select <2 x i1> %28, <2 x i32> %27, <2 x i32> %26
  store <2 x i32> %29, ptr %24, align 4, !tbaa !22
  %30 = load <2 x double>, ptr @ioasciipriv_, align 8, !tbaa !23
  %31 = load <2 x double>, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 2), align 8, !tbaa !23
  %32 = fcmp fast une <2 x double> %30, <double -4.242420e+05, double -4.242420e+05>
  %33 = select <2 x i1> %32, <2 x double> %30, <2 x double> %31
  store <2 x double> %33, ptr %25, align 8, !tbaa !23
  %34 = icmp slt i32 %6, 0
  ...
  store double %37, ptr %15, align 8, !tbaa !23
  %38 = icmp slt i32 %7, 0
  ...
  %42 = load <2 x double>, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 3), align 8, !tbaa !23
  ...
  store <2 x double> %45, ptr %41, align 8, !tbaa !23
  %46 = load <2 x i32>, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 28), align 4, !tbaa !22
  %47 = load <2 x i32>, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 50), align 8, !tbaa !22
  %48 = icmp slt <2 x i32> %46, zeroinitializer
  %49 = select <2 x i1> %48, <2 x i32> %47, <2 x i32> %46
  store <2 x i32> %49, ptr %22, align 4, !tbaa !22
  ...
  %54 = tail call ptr @CCTK_GHExtension(ptr noundef %0, ptr noundef nonnull @.str) #7
...
81:                                               ; preds = %79
  %82 = load ptr, ptr %58, align 8, !tbaa !24
...
87:                                               ; preds = %79, %81
  ...
  br i1 %89, label %90, label %62, !llvm.loop !28

90:                                               ; preds = %87
  %91 = load ptr, ptr %3, align 16, !tbaa !21
  br label %92

92:                                               ; preds = %90, %1
  %93 = phi ptr [ %91, %90 ], [ %14, %1 ]
  call void @free(ptr noundef %93) #7
  %94 = load ptr, ptr %2, align 16, !tbaa !21
...
define dso_local void @IOASCII_Choose2D(ptr noundef %0) local_unnamed_addr #1 {
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %3) #7
  %4 = load double, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 8), align 8, !tbaa !29
  %5 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 33), align 8, !tbaa !30
  %6 = load double, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 8), align 8, !tbaa !31
  %7 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 49), align 4, !tbaa !32
  %8 = load <2 x i32>, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 31), align 8, !tbaa !22
  %9 = load <2 x i32>, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 45), align 4, !tbaa !22
  %10 = icmp slt <2 x i32> %8, zeroinitializer
  %11 = select <2 x i1> %10, <2 x i32> %9, <2 x i32> %8
  store <2 x i32> %11, ptr %2, align 8, !tbaa !22
  %12 = load <2 x double>, ptr getelementptr inbounds (%struct.anon, ptr @ioasciipriv_, i64 0, i32 6), align 8, !tbaa !23
  %13 = load <2 x double>, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 4), align 8, !tbaa !23
  %14 = fcmp fast une <2 x double> %12, <double -4.242420e+05, double -4.242420e+05>
  %15 = select <2 x i1> %14, <2 x double> %12, <2 x double> %13
  store <2 x double> %15, ptr %3, align 16, !tbaa !23
  %16 = icmp slt i32 %5, 0
  ...
  store double %20, ptr %21, align 16, !tbaa !23
  %22 = tail call i32 @CCTK_MaxDim() #7
  %23 = tail call ptr @CCTK_GHExtension(ptr noundef %0, ptr noundef nonnull @.str) #7
...
29:                                               ; preds = %1
  ...
  store ptr %31, ptr %26, align 8, !tbaa !21
  %32 = icmp eq i32 %22, 1
...
38:                                               ; preds = %33
  ...
  %40 = load ptr, ptr %27, align 8, !tbaa !33
...
47:                                               ; preds = %38, %47
  ...
  br i1 %53, label %54, label %47, !llvm.loop !34
...
!23 = !{!7, !7, i64 0}
!24 = !{!25, !10, i64 136}
!25 = !{!"IOASCIIGH", !11, i64 0, !11, i64 4, !11, i64 8, !10, i64 16, !10, i64 24, !10, i64 32, !10, i64 40, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !10, i64 88, !10, i64 96, !10, i64 104, !10, i64 112, !10, i64 120, !10, i64 128, !10, i64 136, !10, i64 144, !11, i64 152}
!26 = distinct !{!26, !27}
