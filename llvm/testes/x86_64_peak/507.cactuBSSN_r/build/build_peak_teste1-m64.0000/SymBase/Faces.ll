...
49:                                               ; preds = %45
  store i32 %2, ptr %46, align 4, !tbaa !5
...
13:                                               ; preds = %11, %8
  %14 = load i32, ptr %9, align 8, !tbaa !11
  %15 = load i32, ptr %0, align 8, !tbaa !14
  %16 = tail call i32 @SymBase_SymmetryRegisterFaces(i32 noundef %14, i32 noundef %15, i32 noundef %1, ptr noundef %2, ptr noundef %3), !range !17
  ret i32 %16
}
...
21:                                               ; preds = %19, %19
  ...
  %28 = tail call i32 @SymBase_SymmetryRegisterFaces(i32 noundef %26, i32 noundef %27, i32 noundef %1, ptr noundef %2, ptr noundef %3), !range !17
  br label %31
...
8:                                                ; preds = %5
  %9 = tail call i32 @SymBase_SymmetryRegisterGI(ptr noundef %0, i32 noundef %1, ptr noundef %2, ptr noundef %3, i32 noundef %6), !range !17
  br label %10
...
56:                                               ; preds = %56, %38
  ...
  %59 = load <4 x i32>, ptr %58, align 16, !tbaa !5
  ...
  %63 = load <4 x i32>, ptr %62, align 16, !tbaa !5
  %64 = getelementptr inbounds i32, ptr %58, i64 12
  %65 = load <4 x i32>, ptr %64, align 16, !tbaa !5
  ...
  call void @llvm.masked.store.v4p0.p0(<4 x ptr> %49, ptr %70, i32 8, <4 x i1> %66), !tbaa !19
  %71 = getelementptr ptr, ptr %70, i64 4
  call void @llvm.masked.store.v4p0.p0(<4 x ptr> %51, ptr %71, i32 8, <4 x i1> %67), !tbaa !19
  %72 = getelementptr ptr, ptr %70, i64 8
  call void @llvm.masked.store.v4p0.p0(<4 x ptr> %53, ptr %72, i32 8, <4 x i1> %68), !tbaa !19
  %73 = getelementptr ptr, ptr %70, i64 12
  call void @llvm.masked.store.v4p0.p0(<4 x ptr> %55, ptr %73, i32 8, <4 x i1> %69), !tbaa !19
  %74 = add nuw i64 %57, 16
  %75 = icmp eq i64 %74, %39
  br i1 %75, label %76, label %56, !llvm.loop !20
...
85:                                               ; preds = %80
  ...
  store ptr %3, ptr %86, align 8, !tbaa !19
  br label %87
...
12:                                               ; preds = %10, %7
  ...
  %15 = tail call i32 @SymBase_SymmetryRegisterInterpolatorFaces(i32 noundef %13, i32 noundef %14, i32 noundef %1, ptr noundef %2), !range !24
  ret i32 %15
}
...
!11 = !{!12, !6, i64 0}
!12 = !{!"SymBase", !6, i64 0, !13, i64 8}
!13 = !{!"any pointer", !7, i64 0}
!14 = !{!15, !6, i64 0}
!15 = !{!"_cGH", !6, i64 0, !6, i64 4, !13, i64 8, !13, i64 16, !13, i64 24, !13, i64 32, !13, i64 40, !13, i64 48, !13, i64 56, !16, i64 64, !13, i64 72, !13, i64 80, !13, i64 88, !13, i64 96, !13, i64 104, !13, i64 112, !6, i64 120, !6, i64 124, !6, i64 128, !13, i64 136, !16, i64 144, !13, i64 152, !13, i64 160, !13, i64 168, !13, i64 176}
!16 = !{!"double", !7, i64 0}
!17 = !{i32 -9, i32 1}
!18 = !{!12, !13, i64 8}
!19 = !{!13, !13, i64 0}
