...
3:                                                ; preds = %1
  %4 = load i32, ptr @SymBase_num_symmetries, align 4, !tbaa !5
  %5 = icmp sgt i32 %4, 0
  %6 = load ptr, ptr @SymBase_symmetry_names, align 8, !tbaa !9
...
9:                                                ; preds = %12
  ...
  %11 = icmp eq i64 %10, %8
  br i1 %11, label %18, label %12, !llvm.loop !11
...
18:                                               ; preds = %9, %3
  ...
  store ptr %22, ptr @SymBase_symmetry_names, align 8, !tbaa !9
...
26:                                               ; preds = %24, %18
  ...
  %28 = load ptr, ptr @SymBase_symmetry_names, align 8, !tbaa !9
  %29 = load i32, ptr @SymBase_num_symmetries, align 4, !tbaa !5
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds ptr, ptr %28, i64 %30
  store ptr %27, ptr %31, align 8, !tbaa !9
  %32 = load ptr, ptr @SymBase_symmetry_names, align 8, !tbaa !9
...
36:                                               ; preds = %26
  ...
  %38 = load i32, ptr @SymBase_num_symmetries, align 4, !tbaa !5
  br label %39

39:                                               ; preds = %36, %26
  %40 = phi i32 [ %38, %36 ], [ %29, %26 ]
  %41 = add nsw i32 %40, 1
  store i32 %41, ptr @SymBase_num_symmetries, align 4, !tbaa !5
  br label %42
...
6:                                                ; preds = %3
  %7 = load ptr, ptr @SymBase_symmetry_names, align 8, !tbaa !9
  %8 = zext i32 %4 to i64
  br label %9
