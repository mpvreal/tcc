...
define dso_local void @SymBase_Statistics(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %4 = load i32, ptr @symbasepriv_, align 4, !tbaa !5
...
32:                                               ; preds = %26
  ...
  %34 = load i32, ptr %0, align 8, !tbaa !10
  br label %35
...
40:                                               ; preds = %38
  %41 = load i32, ptr %2, align 16, !tbaa !14
...
77:                                               ; preds = %75, %72
  ...
  %79 = load i32, ptr %0, align 8, !tbaa !10
...
97:                                               ; preds = %94
  ...
  %99 = load i32, ptr %98, align 16, !tbaa !14
...
106:                                              ; preds = %104, %101
  ...
  %108 = load i32, ptr %0, align 8, !tbaa !10
...
120:                                              ; preds = %115, %118
  ...
  %122 = load i32, ptr %0, align 8, !tbaa !10
  br label %123
...
137:                                              ; preds = %135, %132
  ...
  %148 = load i32, ptr %0, align 8, !tbaa !10
  br label %149
...
149:                                              ; preds = %126, %137
  ...
  br i1 %154, label %126, label %155, !llvm.loop !16
...
188:                                              ; preds = %158, %177, %164
  ...
  br i1 %193, label %158, label %194, !llvm.loop !20
...
!18 = !{!"llvm.loop.peeled.count", i32 6}
!19 = !{!12, !12, i64 0}
!20 = distinct !{!20, !17}
