...
53:                                               ; preds = %16, %45
  %54 = load i32, ptr %0, align 8, !tbaa !11
  %55 = icmp eq i32 %54, %1
...
66:                                               ; preds = %63
  ...
  %68 = load i32, ptr %0, align 8, !tbaa !11
  br label %69
...
69:                                               ; preds = %66, %63
  ...
  %73 = load i32, ptr %0, align 8, !tbaa !11
  %74 = shl i32 %73, 1
...
76:                                               ; preds = %69
  ...
  %78 = load i32, ptr %0, align 8, !tbaa !11
  %79 = shl i32 %78, 1
  br label %80
...
90:                                               ; preds = %90, %88
  ...
  %101 = load <4 x ptr>, ptr %100, align 16, !tbaa !15
  %102 = getelementptr inbounds ptr, ptr %100, i64 4
  %103 = load <4 x ptr>, ptr %102, align 16, !tbaa !15
  %104 = getelementptr inbounds ptr, ptr %100, i64 8
  %105 = load <4 x ptr>, ptr %104, align 16, !tbaa !15
  %106 = getelementptr inbounds ptr, ptr %100, i64 12
  %107 = load <4 x ptr>, ptr %106, align 16, !tbaa !15
  ...
  br i1 %126, label %127, label %90, !llvm.loop !16
...
136:                                              ; preds = %133, %136
  ...
  br i1 %147, label %148, label %136, !llvm.loop !19
...
35:                                               ; preds = %32, %29
  ...
  %39 = load i32, ptr %0, align 8, !tbaa !11
  %40 = shl nsw i32 %39, 1
...
72:                                               ; preds = %67
  ...
  %74 = load ptr, ptr %69, align 8, !tbaa !15
  br label %75
...
!11 = !{!12, !6, i64 0}
!12 = !{!"_cGH", !6, i64 0, !6, i64 4, !13, i64 8, !13, i64 16, !13, i64 24, !13, i64 32, !13, i64 40, !13, i64 48, !13, i64 56, !14, i64 64, !13, i64 72, !13, i64 80, !13, i64 88, !13, i64 96, !13, i64 104, !13, i64 112, !6, i64 120, !6, i64 124, !6, i64 128, !13, i64 136, !14, i64 144, !13, i64 152, !13, i64 160, !13, i64 168, !13, i64 176}
