...
@.str = private unnamed_addr constant [31 x i8] c"Cactus/main/InitialiseCactus.c\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.2 = private unnamed_addr constant [63 x i8] c"Failed to register/provide aliased functions for active thorns\00", align 1
...
define dso_local i32 @CCTKi_InitialiseCactus(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #1 {
  ...
  store i64 %4, ptr @startuptime, align 8, !tbaa !5
...
14:                                               ; preds = %3
  %15 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 109, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #5
  br label %16
...
20:                                               ; preds = %16
  %21 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 181, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #5
  br label %22
...
22:                                               ; preds = %20, %16
  ...
  %25 = tail call ptr @CCTK_ParameterGet(ptr noundef nonnull @.str.5, ptr noundef nonnull @.str.1, ptr noundef null) #5
...
define dso_local i32 @CCTK_RunTime() local_unnamed_addr #1 {
  ...
  %2 = load i64, ptr @startuptime, align 8, !tbaa !5
  %3 = sub nsw i64 %1, %2
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !12, i64 20}
!10 = !{!"", !11, i64 0, !11, i64 8, !12, i64 16, !12, i64 20}
