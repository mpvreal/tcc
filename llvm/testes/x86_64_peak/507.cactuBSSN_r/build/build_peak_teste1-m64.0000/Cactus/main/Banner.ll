...
@.str = private unnamed_addr constant [396 x i8] c"       10                                  \0A  1   0101       ************************  \0A  01  1010 10      The Cactus Code V%s    \0A 1010 1101 011      www.cactuscode.org     \0A  1001 100101    ************************  \0A    00010101                               \0A     100011     (c) Copyright The Authors  \0A      0100      GNU Licensed. No Warranty  \0A      0101                                 \0A\00", align 1
@.str.1 = private unnamed_addr constant [23 x i8] c"Cactus version:    %s\0A\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"Parameter file:    %s\0A\00", align 1
@number_banners = internal unnamed_addr global i32 0, align 4
@banner_strings = internal unnamed_addr global ptr null, align 8
@.str.3 = private unnamed_addr constant [18 x i8] c"cctk_show_banners\00", align 1
...
@.str.7 = private unnamed_addr constant [82 x i8] c"--------------------------------------------------------------------------------\0A\00", align 1
...
define dso_local void @CCTKi_CactusBanner() local_unnamed_addr #1 {
  ...
  %2 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) @.str.7)
  %3 = tail call ptr @CCTK_FullVersion() #8
  %4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef %3)
  %5 = tail call i32 @puts(ptr noundef nonnull dereferenceable(1) @.str.7)
  ...
  %9 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, ptr noundef nonnull %1)
  %10 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @.str.7)
...
define dso_local i32 @CCTK_RegisterBanner(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr @number_banners, align 4, !tbaa !5
  %3 = add nsw i32 %2, 1
  store i32 %3, ptr @number_banners, align 4, !tbaa !5
  %4 = icmp eq i32 %2, 0
  br i1 %4, label %5, label %7

5:                                                ; preds = %1
  %6 = tail call noalias dereferenceable_or_null(8) ptr @malloc(i64 noundef 8) #9
  store ptr %6, ptr @banner_strings, align 8, !tbaa !9
  br label %14

7:                                                ; preds = %1
  %8 = load ptr, ptr @banner_strings, align 8, !tbaa !9
  %9 = sext i32 %3 to i64
  %10 = shl nsw i64 %9, 3
  %11 = tail call ptr @realloc(ptr noundef %8, i64 noundef %10) #10
  store ptr %11, ptr @banner_strings, align 8, !tbaa !9
  %12 = icmp eq ptr %11, null
  br i1 %12, label %13, label %17

13:                                               ; preds = %7
  store ptr %8, ptr @banner_strings, align 8, !tbaa !9
  store i32 %2, ptr @number_banners, align 4, !tbaa !5
  br label %14
...
17:                                               ; preds = %7, %14
  ...
  %19 = load ptr, ptr @banner_strings, align 8, !tbaa !9
  %20 = load i32, ptr @number_banners, align 4, !tbaa !5
  %21 = add nsw i32 %20, -1
...
25:                                               ; preds = %17
  store i32 %21, ptr @number_banners, align 4, !tbaa !5
  br label %26
...
define dso_local void @cctk_registerbanner_(ptr nocapture noundef writeonly %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #1 {
  ...
  %5 = load i32, ptr @number_banners, align 4, !tbaa !5
  %6 = add nsw i32 %5, 1
  store i32 %6, ptr @number_banners, align 4, !tbaa !5
  %7 = icmp eq i32 %5, 0
  br i1 %7, label %8, label %10

8:                                                ; preds = %3
  %9 = tail call noalias dereferenceable_or_null(8) ptr @malloc(i64 noundef 8) #9
  store ptr %9, ptr @banner_strings, align 8, !tbaa !9
  br label %17

10:                                               ; preds = %3
  %11 = load ptr, ptr @banner_strings, align 8, !tbaa !9
  %12 = sext i32 %6 to i64
  %13 = shl nsw i64 %12, 3
  %14 = tail call ptr @realloc(ptr noundef %11, i64 noundef %13) #10
  store ptr %14, ptr @banner_strings, align 8, !tbaa !9
  %15 = icmp eq ptr %14, null
  br i1 %15, label %16, label %20

16:                                               ; preds = %10
  store ptr %11, ptr @banner_strings, align 8, !tbaa !9
  store i32 %5, ptr @number_banners, align 4, !tbaa !5
  br label %17
...
20:                                               ; preds = %17, %10
  ...
  %22 = load ptr, ptr @banner_strings, align 8, !tbaa !9
  %23 = load i32, ptr @number_banners, align 4, !tbaa !5
  %24 = add nsw i32 %23, -1
...
28:                                               ; preds = %20
  store i32 %24, ptr @number_banners, align 4, !tbaa !5
  br label %29
...
define dso_local i32 @CCTKi_PrintBanners() local_unnamed_addr #1 {
  ...
  %2 = call ptr @CCTK_ParameterGet(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4, ptr noundef nonnull %1) #8
...
5:                                                ; preds = %0
  ...
  %6 = load i32, ptr @number_banners, align 4, !tbaa !5
  %7 = icmp sgt i32 %6, 0
  br i1 %7, label %8, label %29

8:                                                ; preds = %5
  %9 = load ptr, ptr @banner_strings, align 8, !tbaa !9
  br label %10
...
18:                                               ; preds = %10
  %19 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, ptr noundef nonnull @.str.7, ptr noundef nonnull %16)
  %20 = load ptr, ptr @banner_strings, align 8, !tbaa !9
  %21 = load i32, ptr %1, align 4, !tbaa !5
  %22 = load i32, ptr @number_banners, align 4, !tbaa !5
  br label %23
...
29:                                               ; preds = %23, %5
  %30 = call i32 @puts(ptr noundef nonnull dereferenceable(1) @.str.7)
  br label %31
