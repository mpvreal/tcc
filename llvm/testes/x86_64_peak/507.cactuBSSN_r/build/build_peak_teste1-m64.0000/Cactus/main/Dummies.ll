...
@.str = private unnamed_addr constant [22 x i8] c"Cactus/main/Dummies.c\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.2 = private unnamed_addr constant [59 x i8] c"No driver thorn activated to provide storage for variables\00", align 1
@.str.3 = private unnamed_addr constant [65 x i8] c"No driver thorn activated to provide communication for variables\00", align 1
...
define dso_local i32 @CCTKi_DummyStorageOn(ptr nocapture noundef readnone %0, i32 noundef %1) local_unnamed_addr #1 {
  %3 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 22, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #3
  ret i32 0
}
...
define dso_local i32 @CCTKi_DummyStorageOff(ptr nocapture noundef readnone %0, i32 noundef %1) local_unnamed_addr #1 {
  %3 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 31, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #3
  ret i32 0
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local i32 @CCTKi_DummyCommunicationOn(ptr nocapture noundef readnone %0, i32 noundef %1) local_unnamed_addr #1 {
  %3 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 40, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3) #3
  ret i32 0
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local i32 @CCTKi_DummyCommunicationOff(ptr nocapture noundef readnone %0, i32 noundef %1) local_unnamed_addr #1 {
  %3 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 49, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3) #3
  ret i32 0
}
