...
define dso_local i32 @CCTK_RegisterGHExtension(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
...
8:                                                ; preds = %5
  ...
  %10 = load i32, ptr @num_extensions, align 4, !tbaa !9
  %11 = add nsw i32 %10, 1
  store i32 %11, ptr @num_extensions, align 4, !tbaa !9
  br label %12
...
define dso_local i32 @CCTK_UnregisterGHExtension(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %3 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
  %4 = call i32 @Util_GetHandle(ptr noundef %3, ptr noundef %0, ptr noundef nonnull %2) #7
  %5 = icmp sgt i32 %4, -1
  br i1 %5, label %6, label %14

6:                                                ; preds = %1
  %7 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
...
10:                                               ; preds = %6
  ...
  %12 = load i32, ptr @num_extensions, align 4, !tbaa !9
  %13 = add nsw i32 %12, -1
  store i32 %13, ptr @num_extensions, align 4, !tbaa !9
  br label %14
...
6:                                                ; preds = %3, %34
  %7 = phi i32 [ %35, %34 ], [ 0, %3 ]
  %8 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
...
14:                                               ; preds = %11
  %15 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
  ...
  store ptr @DummySetupGH, ptr %9, align 8, !tbaa !11
  br label %18
...
22:                                               ; preds = %18
  %23 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
  ...
  store ptr @DummyInitGH, ptr %19, align 8, !tbaa !13
  br label %26
...
30:                                               ; preds = %26
  %31 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
  ...
  store ptr @DummyScheduleTraverseGH, ptr %27, align 8, !tbaa !14
  br label %34
...
51:                                               ; preds = %49, %51
  ...
  %53 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
  ...
  %61 = load i32, ptr @num_extensions, align 4, !tbaa !9
...
define dso_local i32 @CCTKi_InitGHExtensions(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr @num_extensions, align 4, !tbaa !9
  %3 = icmp sgt i32 %2, 0
  br i1 %3, label %4, label %17

4:                                                ; preds = %1, %13
  %5 = phi i32 [ %14, %13 ], [ 0, %1 ]
  %6 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
...
13:                                               ; preds = %4, %9
  ...
  %15 = load i32, ptr @num_extensions, align 4, !tbaa !9
...
define dso_local i32 @CCTKi_ScheduleTraverseGHExtensions(ptr noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = load i32, ptr @num_extensions, align 4, !tbaa !9
  %4 = icmp slt i32 %3, 1
...
7:                                                ; preds = %2, %16
  %8 = phi i32 [ %17, %16 ], [ 0, %2 ]
  %9 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
...
16:                                               ; preds = %7, %12
  ...
  %18 = load i32, ptr @num_extensions, align 4, !tbaa !9
  %19 = icmp slt i32 %17, %18
  br i1 %19, label %7, label %20, !llvm.loop !22
...
define dso_local void @cctk_ghextensionhandle_(ptr nocapture noundef writeonly %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #1 {
  ...
  %5 = load ptr, ptr @GHExtensions, align 8, !tbaa !5
...
!10 = !{!"int", !7, i64 0}
!11 = !{!12, !6, i64 0}
!12 = !{!"GHExtension", !6, i64 0, !6, i64 8, !6, i64 16}
!13 = !{!12, !6, i64 8}
!14 = !{!12, !6, i64 16}
!15 = distinct !{!15, !16}
!16 = !{!"llvm.loop.mustprogress"}
!17 = !{!18, !6, i64 168}
!18 = !{!"_cGH", !10, i64 0, !10, i64 4, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !19, i64 64, !6, i64 72, !6, i64 80, !6, i64 88, !6, i64 96, !6, i64 104, !6, i64 112, !10, i64 120, !10, i64 124, !10, i64 128, !6, i64 136, !19, i64 144, !6, i64 152, !6, i64 160, !6, i64 168, !6, i64 176}
!19 = !{!"double", !7, i64 0}
!20 = distinct !{!20, !16}
!21 = distinct !{!21, !16}
!22 = distinct !{!22, !16}
