...
@.str.1 = private unnamed_addr constant [34 x i8] c"Cactus/main/CactusDefaultEvolve.c\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.3 = private unnamed_addr constant [83 x i8] c"Variable '%s' has multiple timelevels, default Cactus evolve routine cannot rotate\00", align 1
@CCTK_SetMainLoopIndex = external local_unnamed_addr global ptr, align 8
@.str.4 = private unnamed_addr constant [16 x i8] c"CCTK_CHECKPOINT\00", align 1
...
9:                                                ; preds = %31, %1
  ...
  %11 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @cactusrest_, i64 0, i32 5), align 4, !tbaa !12
  %12 = icmp eq i32 %11, 0
...
37:                                               ; preds = %177, %101, %107, %138
  %38 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @cactusrest_, i64 0, i32 5), align 4, !tbaa !12
  %39 = icmp eq i32 %38, 0
  br i1 %39, label %40, label %183, !llvm.loop !18
...
40:                                               ; preds = %9, %37
  ...
  %46 = load double, ptr @cactusrest_, align 8, !tbaa !21
  %47 = load double, ptr getelementptr inbounds (%struct.anon, ptr @cactusrest_, i64 0, i32 1), align 8, !tbaa !22
  %48 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @cactusrest_, i64 0, i32 3), align 8, !tbaa !23
  %49 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @cactusrest_, i64 0, i32 4), align 8, !tbaa !24
...
96:                                               ; preds = %91
  ...
  %98 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 128, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3, ptr noundef %97) #3
  br label %99

99:                                               ; preds = %91, %96
  %100 = icmp ugt i32 %92, 1
  br i1 %100, label %91, label %101, !llvm.loop !25

101:                                              ; preds = %99, %88, %86
  %102 = load ptr, ptr @CCTK_SetMainLoopIndex, align 8, !tbaa !5
  %103 = add i32 %41, 1
  %104 = tail call i32 %102(i32 noundef %103) #3
  %105 = load i32, ptr %4, align 8, !tbaa !9
...
109:                                              ; preds = %101, %132
  ...
  %112 = load ptr, ptr @CCTK_MainLoopIndex, align 8, !tbaa !5
...
117:                                              ; preds = %109
  ...
  store double %125, ptr %121, align 8, !tbaa !19
...
132:                                              ; preds = %117, %109
  ...
  %135 = load i32, ptr %4, align 8, !tbaa !9
  %136 = zext i32 %135 to i64
  %137 = icmp ult i64 %134, %136
  br i1 %137, label %109, label %107, !llvm.loop !28
...
147:                                              ; preds = %140
  ...
  %151 = tail call i32 @CCTK_Traverse(ptr noundef %150, ptr noundef nonnull @.str.4) #3
  %152 = load i32, ptr %4, align 8, !tbaa !9
  br label %153
...
153:                                              ; preds = %147, %140
  ...
  br i1 %158, label %140, label %138, !llvm.loop !29
...
166:                                              ; preds = %159
  ...
  %170 = tail call i32 @CCTK_Traverse(ptr noundef %169, ptr noundef nonnull @.str) #3
  %171 = load ptr, ptr @CCTK_OutputGH, align 8, !tbaa !5
  ...
  %176 = load i32, ptr %4, align 8, !tbaa !9
  br label %177
...
177:                                              ; preds = %166, %159
  ...
  br i1 %182, label %159, label %37, !llvm.loop !30
