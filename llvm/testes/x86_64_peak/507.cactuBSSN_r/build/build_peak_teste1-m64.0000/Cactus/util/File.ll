...
9:                                                ; preds = %2
  ...
  %10 = call ptr @Util_StrSep(ptr noundef nonnull %3, ptr noundef nonnull @.str) #10
...
19:                                               ; preds = %14
  %20 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %7, ptr noundef nonnull dereferenceable(1) @.str.1, ptr noundef nonnull %7, ptr noundef nonnull %15) #10
  br label %26

21:                                               ; preds = %14
  %22 = load i8, ptr %15, align 1, !tbaa !5
  %23 = icmp eq i8 %22, 0
  %24 = select i1 %23, ptr @.str, ptr %15
...
36:                                               ; preds = %26
  %37 = load i32, ptr %13, align 8, !tbaa !12
  %38 = and i32 %37, 61440
...
40:                                               ; preds = %36, %32, %29
  ...
  %42 = call ptr @Util_StrSep(ptr noundef nonnull %3, ptr noundef nonnull @.str) #10
  %43 = icmp eq ptr %42, null
  br i1 %43, label %44, label %14, !llvm.loop !16
