...
define dso_local ptr @Util_CacheMalloc(i32 noundef %0, i64 noundef %1, ptr nocapture noundef writeonly %2) local_unnamed_addr #1 {
  %4 = load i32, ptr @cache_set, align 4, !tbaa !5
  %5 = icmp eq i32 %4, 0
...
define dso_local i32 @Utili_CacheDataGet(ptr nocapture noundef writeonly %0, ptr nocapture noundef writeonly %1) local_unnamed_addr #2 {
  %3 = load i32, ptr @cache_set, align 4, !tbaa !5
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %8, label %5

5:                                                ; preds = %2
  %6 = load i64, ptr @cache_data.0, align 8, !tbaa !11
  store i64 %6, ptr %0, align 8, !tbaa !14
  %7 = load i64, ptr @cache_data.1, align 8, !tbaa !15
...
define dso_local i32 @Utili_CacheDataSet(i64 noundef %0, i64 noundef %1) local_unnamed_addr #4 {
  store i64 %0, ptr @cache_data.0, align 8, !tbaa !11
  store i64 %1, ptr @cache_data.1, align 8, !tbaa !15
  %3 = load i32, ptr @cache_set, align 4, !tbaa !5
  %4 = add nsw i32 %3, 1
  store i32 %4, ptr @cache_set, align 4, !tbaa !5
  ret i32 %3
}
...
!11 = !{!12, !13, i64 0}
!12 = !{!"s_cache_data", !13, i64 0, !13, i64 8}
!13 = !{!"long", !7, i64 0}
!14 = !{!13, !13, i64 0}
!15 = !{!12, !13, i64 8}
