...
@.str = private unnamed_addr constant [19 x i8] c"Cactus/util/Misc.c\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.2 = private unnamed_addr constant [43 x i8] c"CCTK_Equals: First string null (2nd is %s)\00", align 1
@.str.3 = private unnamed_addr constant [44 x i8] c"CCTK_Equals: Second string null (1st is %s)\00", align 1
@.str.4 = private unnamed_addr constant [31 x i8] c"CCTK_Equals: Both strings null\00", align 1
@.str.5 = private unnamed_addr constant [106 x i8] c"Null Terminating a string with length %d !!\0AThis is probably an error in calling a C routine from Fortran\00", align 1
@.str.6 = private unnamed_addr constant [6 x i8] c"Flesh\00", align 1
@.str.7 = private unnamed_addr constant [14 x i8] c"Invalid start\00", align 1
@.str.8 = private unnamed_addr constant [12 x i8] c"Invalid end\00", align 1
@.str.9 = private unnamed_addr constant [13 x i8] c"Invalid step\00", align 1
@.str.10 = private unnamed_addr constant [14 x i8] c"Invalid range\00", align 1
@.str.11 = private unnamed_addr constant [40 x i8] c"Invalid patten '%s' used to parse range\00", align 1
...
@.str.24 = private unnamed_addr constant [102 x i8] c"CCTK_FortranString: Fortran string buffer is too short to hold C string '%s, string will be truncated\00", align 1
@.str.25 = private unnamed_addr constant [103 x i8] c"CCTK_FortranString: Fortran string buffer is too short to hold C string '%s', string will be truncated\00", align 1
@.str.26 = private unnamed_addr constant [9 x i8] c"$Header$\00", align 1
...
9:                                                ; preds = %6
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 111, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull %1) #15
  br label %21
...
13:                                               ; preds = %11
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 117, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, ptr noundef nonnull %0) #15
  br label %21

15:                                               ; preds = %11
  %16 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 122, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #15
  br label %21
...
8:                                                ; preds = %6
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 241, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5, i32 noundef %2) #15
  br label %10
...
30:                                               ; preds = %28
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %26, ptr align 1 %1, i64 %31, i1 false), !tbaa !9
  br label %32
...
35:                                               ; preds = %22, %32
  %36 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 150, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef %26) #15
  br label %42
...
4:                                                ; preds = %2
  %5 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 241, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5, i32 noundef %1) #15
  br label %6
...
26:                                               ; preds = %24
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %22, ptr align 1 %0, i64 %27, i1 false), !tbaa !9
  br label %28
...
25:                                               ; preds = %21
  %26 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 117, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, ptr noundef nonnull %0) #15
  br label %30
...
30:                                               ; preds = %27, %25
  ...
  %32 = icmp eq i32 %31, %1
  br i1 %32, label %56, label %9, !llvm.loop !12
...
49:                                               ; preds = %45
  %50 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 122, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #15
  br label %53

51:                                               ; preds = %45
  %52 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 111, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull %47) #15
  br label %53
...
38:                                               ; preds = %33
  ...
  %42 = load i32, ptr %26, align 16, !tbaa !13
...
46:                                               ; preds = %38
  %47 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 432, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7) #15
  br label %48
...
55:                                               ; preds = %50
  ...
  %57 = load i32, ptr %56, align 16, !tbaa !13
  %58 = icmp ne i32 %57, -1
...
68:                                               ; preds = %63
  ...
  %72 = load i32, ptr %56, align 16, !tbaa !13
...
76:                                               ; preds = %68
  %77 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 454, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.8) #15
  br label %78
...
88:                                               ; preds = %83
  ...
  %90 = load i32, ptr %89, align 16, !tbaa !13
  %91 = icmp ne i32 %90, -1
...
96:                                               ; preds = %88
  ...
  %101 = load i32, ptr %89, align 16, !tbaa !13
...
105:                                              ; preds = %96
  %106 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 480, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.9) #15
...
110:                                              ; preds = %107
  %111 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 497, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.9) #15
  br label %112
...
138:                                              ; preds = %11
  %139 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 529, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.10) #15
  br label %142

140:                                              ; preds = %2
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %3) #15
  %141 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 533, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.11, ptr noundef nonnull %5) #15
  br label %142
...
38:                                               ; preds = %33
  ...
  %41 = load i32, ptr %26, align 16, !tbaa !13
...
45:                                               ; preds = %38
  %46 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 639, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7) #15
  br label %47
...
67:                                               ; preds = %62
  ...
  %70 = load i32, ptr %55, align 16, !tbaa !13
...
74:                                               ; preds = %67
  %75 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 661, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.8) #15
  br label %76
...
86:                                               ; preds = %81
  ...
  %88 = load i32, ptr %87, align 16, !tbaa !13
  %89 = icmp ne i32 %88, -1
...
94:                                               ; preds = %86
  ...
  %99 = load i32, ptr %87, align 16, !tbaa !13
...
103:                                              ; preds = %94
  %104 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 687, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.9) #15
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %8) #15
  br label %109
...
107:                                              ; preds = %105
  %108 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 704, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.9) #15
  br label %109
...
137:                                              ; preds = %11, %12
  %138 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 733, ptr noundef nonnull @.str, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.10) #15
  br label %139
...
8:                                                ; preds = %23
  ...
  %10 = icmp eq i32 %9, %1
  br i1 %10, label %28, label %11, !llvm.loop !16
...
23:                                               ; preds = %20, %15
  ...
  %26 = call i32 @Util_IntInRange(i32 noundef %0, ptr noundef %25), !range !17
  %27 = icmp eq i32 %26, 0
...
8:                                                ; preds = %23
  %9 = add nuw nsw i32 %12, 1
  %10 = icmp eq i32 %9, %1
  br i1 %10, label %28, label %11, !llvm.loop !18
...
23:                                               ; preds = %20, %15
  %24 = phi ptr [ %18, %15 ], [ %21, %20 ]
  %25 = load ptr, ptr %24, align 8
  %26 = call i32 @Util_DoubleInRange(double noundef nofpclass(nan inf) %0, ptr noundef %25), !range !17
  %27 = icmp eq i32 %26, 0
  br i1 %27, label %8, label %28
...
27:                                               ; preds = %42
  ...
  %29 = icmp eq i32 %28, %2
  br i1 %29, label %48, label %30, !llvm.loop !20
...
42:                                               ; preds = %39, %34
  ...
  %45 = call i32 @Util_DoubleInRange(double noundef nofpclass(nan inf) %19, ptr noundef %44), !range !17
  %46 = icmp eq i32 %45, 0
  br i1 %46, label %27, label %47

47:                                               ; preds = %42
  store double %19, ptr %0, align 8, !tbaa !21
  br label %48
...
15:                                               ; preds = %30
  ...
  %17 = icmp eq i32 %16, %2
  br i1 %17, label %36, label %18, !llvm.loop !23
...
30:                                               ; preds = %27, %22
  ...
  %33 = call i32 @Util_IntInRange(i32 noundef %7, ptr noundef %32), !range !17
  %34 = icmp eq i32 %33, 0
  br i1 %34, label %15, label %35

35:                                               ; preds = %30
  store i32 %7, ptr %0, align 4, !tbaa !24
  br label %36
...
26:                                               ; preds = %22
  %27 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 117, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, ptr noundef nonnull %1) #15
  br label %31
...
31:                                               ; preds = %28, %26
  ...
  %33 = icmp eq i32 %32, %2
  br i1 %33, label %68, label %10, !llvm.loop !25
...
50:                                               ; preds = %46
  %51 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 122, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #15
  br label %54

52:                                               ; preds = %46
  %53 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 111, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull %48) #15
  br label %54

54:                                               ; preds = %52, %50
  %55 = add nuw nsw i32 %35, 1
  %56 = icmp eq i32 %55, %2
  br i1 %56, label %68, label %34, !llvm.loop !25
...
46:                                               ; preds = %31, %32
  ...
  %48 = icmp eq i32 %47, %2
  br i1 %48, label %49, label %10, !llvm.loop !26
...
define dso_local i32 @CCTK_SetBoolean(ptr nocapture noundef writeonly %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = tail call i32 (ptr, i32, ...) @Util_InList(ptr noundef %1, i32 noundef 5, ptr noundef nonnull @.str.12, ptr noundef nonnull @.str.13, ptr noundef nonnull @.str.14, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.16), !range !17
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %5, label %8

5:                                                ; preds = %2
  %6 = tail call i32 (ptr, i32, ...) @Util_InList(ptr noundef %1, i32 noundef 5, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19, ptr noundef nonnull @.str.20, ptr noundef nonnull @.str.21), !range !17
  %7 = icmp eq i32 %6, 0
...
7:                                                ; preds = %3
  %8 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1424, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.24, ptr noundef %0) #15
  br label %9
...
define dso_local void @cctk_fortranstring_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef writeonly %2, i32 noundef %3) local_unnamed_addr #1 {
  ...
  store i32 %8, ptr %0, align 4, !tbaa !24
  %9 = icmp ugt i64 %7, %5
  br i1 %9, label %10, label %13

10:                                               ; preds = %4
  %11 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1451, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.25, ptr noundef %6) #15
