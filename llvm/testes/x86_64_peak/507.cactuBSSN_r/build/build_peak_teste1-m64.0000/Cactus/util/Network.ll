...
@.str = private unnamed_addr constant [22 x i8] c"Cactus/util/Network.c\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"src\00", align 1
@.str.2 = private unnamed_addr constant [44 x i8] c"Argument \22name\22 to Util_GetHostName is NULL\00", align 1
@.str.3 = private unnamed_addr constant [51 x i8] c"Argument \22length\22 to Util_GetHostName is too small\00", align 1
...
define dso_local void @Util_GetHostName(ptr noundef %0, i32 noundef %1) local_unnamed_addr #1 {
  store <4 x i8> <i8 83, i8 80, i8 69, i8 67>, ptr @Util_GetHostName.name, align 16, !tbaa !5
  store i8 0, ptr getelementptr inbounds ([100 x i8], ptr @Util_GetHostName.name, i64 0, i64 4), align 4, !tbaa !5
  %3 = icmp eq ptr %0, null
  br i1 %3, label %4, label %6

4:                                                ; preds = %2
  %5 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 124, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #4
  br label %6
...
8:                                                ; preds = %6
  %9 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 128, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3) #4
  br label %10
