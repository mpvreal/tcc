...
@.str.1 = private unnamed_addr constant [11 x i8] c"LEFT:  %s\0A\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"(none)\00", align 1
@.str.3 = private unnamed_addr constant [11 x i8] c"RIGHT: %s\0A\00", align 1
@.str.4 = private unnamed_addr constant [11 x i8] c"NEXT:  %s\0A\00", align 1
...
31:                                               ; preds = %20
  ...
  store ptr %8, ptr %32, align 8, !tbaa !14
...
49:                                               ; preds = %29, %31
  ...
  store ptr %8, ptr %50, align 8, !tbaa !12
  br label %51
...
26:                                               ; preds = %17, %23
  %27 = phi ptr [ %25, %23 ], [ @.str.2, %17 ]
  %28 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, ptr noundef %27)
...
35:                                               ; preds = %26, %32
  %36 = phi ptr [ %34, %32 ], [ @.str.2, %26 ]
  %37 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, ptr noundef %36)
...
2:                                                ; preds = %2, %1
  ...
  br i1 %5, label %6, label %2, !llvm.loop !16
...
!5 = !{!6, !7, i64 40}
!6 = !{!"T_SKTREE", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40}
