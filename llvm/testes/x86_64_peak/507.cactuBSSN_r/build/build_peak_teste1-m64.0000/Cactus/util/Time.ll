...
@.str = private unnamed_addr constant [5 x i8] c"%X%z\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%b %d %Y\00", align 1
@.str.2 = private unnamed_addr constant [20 x i8] c"%Y-%m-%dT%H:%M:%S%z\00", align 1
...
define dso_local i32 @Util_CurrentTime(i32 noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  ...
  %7 = call i64 @strftime(ptr noundef %1, i64 noundef %5, ptr noundef nonnull @.str, ptr noundef %6) #7
...
define dso_local i32 @Util_CurrentDate(i32 noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  ...
  %6 = call i64 @strftime(ptr noundef %1, i64 noundef 50, ptr noundef nonnull @.str.1, ptr noundef %5) #7
...
4:                                                ; preds = %0
  ...
  %7 = call i64 @strftime(ptr noundef nonnull %2, i64 noundef 26, ptr noundef nonnull @.str.2, ptr noundef %6) #7
...
48:                                               ; preds = %44
  store i8 %38, ptr %45, align 1, !tbaa !9
  store i8 %30, ptr %37, align 1, !tbaa !9
  store i8 58, ptr %29, align 1, !tbaa !9
  br label %49
