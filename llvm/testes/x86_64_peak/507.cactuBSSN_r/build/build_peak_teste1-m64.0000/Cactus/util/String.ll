...
11:                                               ; preds = %6
  ...
  %13 = load ptr, ptr @Util_StrSep.retval, align 8, !tbaa !5
  %14 = tail call ptr @realloc(ptr noundef %13, i64 noundef %12) #16
  %15 = icmp eq ptr %14, null
  br i1 %15, label %17, label %16

16:                                               ; preds = %11
  store ptr %14, ptr @Util_StrSep.retval, align 8, !tbaa !5
  br label %21

17:                                               ; preds = %11
  tail call void @free(ptr noundef %13) #17
  store ptr null, ptr @Util_StrSep.retval, align 8, !tbaa !5
  br label %29

18:                                               ; preds = %6
  %19 = load ptr, ptr @Util_StrSep.retval, align 8, !tbaa !5
...
27:                                               ; preds = %2
  %28 = load ptr, ptr @Util_StrSep.retval, align 8, !tbaa !5
...
34:                                               ; preds = %29
  ...
  %37 = add i64 %16, -1
  br i1 %23, label %38, label %15, !llvm.loop !15
