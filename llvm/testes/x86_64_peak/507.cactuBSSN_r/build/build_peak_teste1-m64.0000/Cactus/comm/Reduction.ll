...
@.str = private unnamed_addr constant [24 x i8] c"Cactus/comm/Reduction.c\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.2 = private unnamed_addr constant [81 x i8] c"CCTK_RegisterReductionOperator: Reduction operator with this name already exists\00", align 1
@.str.3 = private unnamed_addr constant [72 x i8] c"CCTK_ReductionHandle: No handle: '%d' found for reduction operator '%s'\00", align 1
@.str.4 = private unnamed_addr constant [50 x i8] c"CCTK_Reduce: Invalid handle passed to CCTK_Reduce\00", align 1
@.str.5 = private unnamed_addr constant [71 x i8] c"CCTK_Reduce: Reduction operation is not registeredand cannot be called\00", align 1
@.str.6 = private unnamed_addr constant [72 x i8] c"CCTK_Reduce: Reduction operation is not registered and cannot be called\00", align 1
@ReductionArrayOperators = internal global ptr null, align 8
@num_reductions_array = internal unnamed_addr global i32 0, align 4
@.str.7 = private unnamed_addr constant [92 x i8] c"CCTK_RegisterReductionArrayOperator: Array reduction operator with this name already exists\00", align 1
@.str.8 = private unnamed_addr constant [77 x i8] c"CCTK_ReductionArrayHandle: No handle found for array reduction operator '%s'\00", align 1
@.str.9 = private unnamed_addr constant [60 x i8] c"CCTK_ReduceArray: Invalid handle passed to CCTK_ReduceArray\00", align 1
@.str.10 = private unnamed_addr constant [83 x i8] c"CCTK_ReduceArray: Array reduction operation is not registered and cannot be called\00", align 1
...
@.str.11 = private unnamed_addr constant [91 x i8] c"CCTK_RegisterLocalArrayReductionOperator: Reduction operator with this name already exists\00", align 1
@.str.12 = private unnamed_addr constant [82 x i8] c"CCTK_LocalArrayReductionHandle: No handle: '%d' found for reduction operator '%s'\00", align 1
@.str.13 = private unnamed_addr constant [72 x i8] c"CCTK_LocalArraysReduce: Invalid handle passed to CCTK_ReduceLocalArrays\00", align 1
@.str.14 = private unnamed_addr constant [82 x i8] c"CCTK_ReduceLocalArrays: Reduction operation is not registeredand cannot be called\00", align 1
@.str.15 = private unnamed_addr constant [72 x i8] c"CCTK_ReduceLocalArrays: Invalid handle passed to CCTK_ReduceLocalArrays\00", align 1
@.str.16 = private unnamed_addr constant [83 x i8] c"CCTK_ReduceLocalArrays: Reduction operation is not registered and cannot be called\00", align 1
@.str.17 = private unnamed_addr constant [39 x i8] c"CCTK_ReduceOperator: Handle %d invalid\00", align 1
@.str.18 = private unnamed_addr constant [49 x i8] c"CCTK_LocalArrayReduceOperator: Handle %d invalid\00", align 1
...
@.str.19 = private unnamed_addr constant [75 x i8] c"CCTK_RegisterGridArrayReductionOperator: Reduction operator already exists\00", align 1
@.str.20 = private unnamed_addr constant [58 x i8] c"CCTK_ReduceGridArrays: no grid array reduction registered\00", align 1
@.str.21 = private unnamed_addr constant [51 x i8] c"CCTK_GAReductionOperator: no GA reduction operator\00", align 1
...
@.str.22 = private unnamed_addr constant [78 x i8] c"CCTKi_RegisterReduceArraysGloballyOperator: Reduction operator already exists\00", align 1
@.str.23 = private unnamed_addr constant [62 x i8] c"CCTK_ReduceArraysGlobally: no grid array reduction registered\00", align 1
@.str.24 = private unnamed_addr constant [79 x i8] c"CCTK_ReductionArraysGloballyOperator: no reduction of arrays globally operator\00", align 1
...
define dso_local i32 @CCTKi_RegisterReductionOperator(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #1 {
  ...
  %5 = load ptr, ptr @ReductionOperators, align 8, !tbaa !5
...
11:                                               ; preds = %8
  ...
  %16 = load i32, ptr @num_reductions, align 4, !tbaa !13
  %17 = add nsw i32 %16, 1
  store i32 %17, ptr @num_reductions, align 4, !tbaa !13
  br label %20

18:                                               ; preds = %3
  %19 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 287, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #9
  br label %20
...
define dso_local i32 @CCTK_ReductionHandle(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load ptr, ptr @ReductionOperators, align 8, !tbaa !5
  %3 = tail call i32 @Util_GetHandle(ptr noundef %2, ptr noundef %0, ptr noundef null) #9
  %4 = icmp slt i32 %3, 0
  br i1 %4, label %5, label %7

5:                                                ; preds = %1
  %6 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 318, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, i32 noundef %3, ptr noundef %0) #9
  br label %7
...
8:                                                ; preds = %3
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 318, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3, i32 noundef %6, ptr noundef %4) #9
  br label %10
...
10:                                               ; preds = %7
  %11 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 402, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #9
  br label %90

12:                                               ; preds = %7
  %13 = load ptr, ptr @ReductionOperators, align 8, !tbaa !5
  %14 = tail call ptr @Util_GetHandledData(ptr noundef %13, i32 noundef %2) #9
  %15 = icmp eq ptr %14, null
  br i1 %15, label %16, label %18

16:                                               ; preds = %12
  %17 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 412, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5) #9
  br label %90
...
60:                                               ; preds = %56, %54
  ...
  br i1 %68, label %69, label %34, !llvm.loop !15
...
12:                                               ; preds = %8
  %13 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 461, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #9
  br label %102

14:                                               ; preds = %8
  %15 = load ptr, ptr @ReductionOperators, align 8, !tbaa !5
  %16 = tail call ptr @Util_GetHandledData(ptr noundef %15, i32 noundef %10) #9
  %17 = icmp eq ptr %16, null
  br i1 %17, label %18, label %20

18:                                               ; preds = %14
  %19 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 472, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.6) #9
  br label %102
...
65:                                               ; preds = %61, %59
  ...
  store i32 %70, ptr %71, align 4, !tbaa !13
  %72 = add nuw nsw i64 %39, 2
  %73 = add i64 %42, 2
  %74 = icmp eq i64 %73, %37
  br i1 %74, label %75, label %38, !llvm.loop !17
...
102:                                              ; preds = %18, %93, %12
  ...
  store i32 %103, ptr %0, align 4, !tbaa !13
...
define dso_local i32 @CCTK_RegisterReductionArrayOperator(ptr noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = load ptr, ptr @ReductionArrayOperators, align 8, !tbaa !5
...
6:                                                ; preds = %2
  ...
  %9 = load i32, ptr @num_reductions_array, align 4, !tbaa !13
  %10 = add nsw i32 %9, 1
  store i32 %10, ptr @num_reductions_array, align 4, !tbaa !13
  br label %13

11:                                               ; preds = %2
  %12 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 544, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.7) #9
  br label %13
...
define dso_local i32 @CCTK_ReductionArrayHandle(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load ptr, ptr @ReductionArrayOperators, align 8, !tbaa !5
  %3 = tail call i32 @Util_GetHandle(ptr noundef %2, ptr noundef %0, ptr noundef null) #9
  %4 = icmp slt i32 %3, 0
  br i1 %4, label %5, label %7

5:                                                ; preds = %1
  %6 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 575, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.8, ptr noundef %0) #9
  br label %7
...
define dso_local void @cctk_reductionarrayhandle_(ptr nocapture noundef writeonly %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #1 {
  %4 = tail call ptr @Util_NullTerminateString(ptr noundef %1, i32 noundef %2) #9
  %5 = load ptr, ptr @ReductionArrayOperators, align 8, !tbaa !5
  %6 = tail call i32 @Util_GetHandle(ptr noundef %5, ptr noundef %4, ptr noundef null) #9
  %7 = icmp slt i32 %6, 0
  br i1 %7, label %8, label %10

8:                                                ; preds = %3
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 575, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.8, ptr noundef %4) #9
  br label %10
...
12:                                               ; preds = %9
  %13 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 679, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.9) #9
  br label %159

14:                                               ; preds = %9
  %15 = load ptr, ptr @ReductionArrayOperators, align 8, !tbaa !5
  %16 = tail call ptr @Util_GetHandledData(ptr noundef %15, i32 noundef %2) #9
  %17 = icmp eq ptr %16, null
  br i1 %17, label %18, label %20

18:                                               ; preds = %14
  %19 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 687, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.10) #9
  br label %159
...
95:                                               ; preds = %91, %89
  ...
  br i1 %103, label %39, label %69, !llvm.loop !20
...
130:                                              ; preds = %126, %124
  ...
  br i1 %138, label %139, label %104, !llvm.loop !21
...
14:                                               ; preds = %10
  %15 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 750, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.9) #9
  br label %175

16:                                               ; preds = %10
  %17 = load ptr, ptr @ReductionArrayOperators, align 8, !tbaa !5
  %18 = tail call ptr @Util_GetHandledData(ptr noundef %17, i32 noundef %12) #9
  %19 = icmp eq ptr %18, null
  br i1 %19, label %20, label %22

20:                                               ; preds = %16
  %21 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 758, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.10) #9
  br label %175
...
103:                                              ; preds = %99, %97
  ...
  br i1 %112, label %44, label %76, !llvm.loop !22
...
139:                                              ; preds = %135, %133
  ...
  br i1 %147, label %148, label %113, !llvm.loop !23
...
165:                                              ; preds = %161, %148, %62
  ...
  %166 = load ptr, ptr %18, align 8, !tbaa !18
  ...
  store i32 %174, ptr %0, align 4, !tbaa !13
...
define dso_local i32 @CCTK_ReduceLocalScalar(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef %5) local_unnamed_addr #1 {
  %7 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef 1, i32 noundef %5, ptr noundef %4, i32 noundef 1, i32 noundef 1, i32 noundef %5, i32 noundef 1, ptr noundef %3), !range !24
  ret i32 %7
}
...
define dso_local void @cctk_reducelocalscalar_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr noundef %4, ptr noundef %5, ptr nocapture noundef readonly %6) local_unnamed_addr #1 {
  ...
  %12 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %8, i32 noundef %9, i32 noundef %10, i32 noundef 1, i32 noundef %11, ptr noundef %5, i32 noundef 1, i32 noundef 1, i32 noundef %11, i32 noundef 1, ptr noundef %4), !range !24
...
define dso_local i32 @CCTK_ReduceLocalArray1D(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef %5, i32 noundef %6) local_unnamed_addr #1 {
  %8 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %5, i32 noundef %6, ptr noundef %4, i32 noundef 1, i32 noundef 1, i32 noundef %6, i32 noundef %5, ptr noundef %3), !range !24
  ret i32 %8
}
...
define dso_local void @cctk_reducelocalarray1d_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr noundef %4, ptr noundef %5, ptr nocapture noundef readonly %6, ptr nocapture noundef readonly %7) local_unnamed_addr #1 {
  ...
  %14 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %9, i32 noundef %10, i32 noundef %11, i32 noundef %12, i32 noundef %13, ptr noundef %5, i32 noundef 1, i32 noundef 1, i32 noundef %13, i32 noundef %12, ptr noundef %4), !range !24
...
define dso_local i32 @CCTK_ReduceLocArrayToArray2D(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7) local_unnamed_addr #1 {
  %9 = mul nsw i32 %6, %5
  %10 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %9, i32 noundef %7, ptr noundef %4, i32 noundef 2, i32 noundef 1, i32 noundef %7, i32 noundef %5, i32 noundef %6, ptr noundef %3), !range !24
  ret i32 %10
}
...
define dso_local void @cctk_reducelocarraytoarray2d_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr noundef %4, ptr noundef %5, ptr nocapture noundef readonly %6, ptr nocapture noundef readonly %7, ptr nocapture noundef readonly %8) local_unnamed_addr #1 {
  ...
  %17 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %13, i32 noundef %14, i32 noundef %15, i32 noundef %12, i32 noundef %16, ptr noundef %5, i32 noundef 2, i32 noundef 1, i32 noundef %16, i32 noundef %10, i32 noundef %11, ptr noundef %4), !range !24
...
define dso_local i32 @CCTK_ReduceLocArrayToArray3D(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7, i32 noundef %8) local_unnamed_addr #1 {
  %10 = mul nsw i32 %6, %5
  %11 = mul nsw i32 %10, %7
  %12 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %11, i32 noundef %8, ptr noundef %4, i32 noundef 3, i32 noundef 1, i32 noundef %8, i32 noundef %5, i32 noundef %6, i32 noundef %7, ptr noundef %3), !range !24
  ret i32 %12
}
...
define dso_local void @cctk_reducelocarraytoarray3d_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr noundef %4, ptr noundef %5, ptr nocapture noundef readonly %6, ptr nocapture noundef readonly %7, ptr nocapture noundef readonly %8, ptr nocapture noundef readonly %9) local_unnamed_addr #1 {
  ...
  %20 = tail call i32 (ptr, i32, i32, i32, i32, ptr, i32, i32, i32, ...) @CCTK_ReduceArray(ptr noundef %16, i32 noundef %17, i32 noundef %18, i32 noundef %15, i32 noundef %19, ptr noundef %5, i32 noundef 3, i32 noundef 1, i32 noundef %19, i32 noundef %11, i32 noundef %12, i32 noundef %14, ptr noundef %4), !range !24
...
define dso_local i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #1 {
  %4 = alloca ptr, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %4) #9
  %5 = load ptr, ptr @LocalArrayReductionOperators, align 8, !tbaa !5
  %6 = call i32 @Util_GetHandle(ptr noundef %5, ptr noundef %2, ptr noundef nonnull %4) #9
  %7 = icmp slt i32 %6, 0
...
11:                                               ; preds = %8
  ...
  %18 = load i32, ptr @num_local_array_reductions, align 4, !tbaa !13
  %19 = add nsw i32 %18, 1
  store i32 %19, ptr @num_local_array_reductions, align 4, !tbaa !13
  br label %22

20:                                               ; preds = %3
  %21 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 1089, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.11) #9
  br label %22
...
define dso_local i32 @CCTK_LocalArrayReductionHandle(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load ptr, ptr @LocalArrayReductionOperators, align 8, !tbaa !5
  %3 = tail call i32 @Util_GetHandle(ptr noundef %2, ptr noundef %0, ptr noundef null) #9
  %4 = icmp slt i32 %3, 0
  br i1 %4, label %5, label %7

5:                                                ; preds = %1
  %6 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1120, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.12, i32 noundef %3, ptr noundef %0) #9
  br label %7
...
8:                                                ; preds = %3
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 1120, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.12, i32 noundef %6, ptr noundef %4) #9
  br label %10
...
12:                                               ; preds = %10
  %13 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 1221, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.13) #9
  br label %24

14:                                               ; preds = %10
  %15 = load ptr, ptr @LocalArrayReductionOperators, align 8, !tbaa !5
  %16 = tail call ptr @Util_GetHandledData(ptr noundef %15, i32 noundef %1) #9
  %17 = icmp eq ptr %16, null
  br i1 %17, label %18, label %20

18:                                               ; preds = %14
  %19 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 1232, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.14) #9
  br label %24
...
14:                                               ; preds = %11
  %15 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 1266, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.15) #9
  br label %31

16:                                               ; preds = %11
  %17 = load ptr, ptr @LocalArrayReductionOperators, align 8, !tbaa !5
  %18 = tail call ptr @Util_GetHandledData(ptr noundef %17, i32 noundef %12) #9
  %19 = icmp eq ptr %18, null
  br i1 %19, label %20, label %22

20:                                               ; preds = %16
  %21 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 1277, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.16) #9
  br label %31
...
define dso_local void @cctk_numlocalarrayreduceoperators_(ptr nocapture noundef writeonly %0) local_unnamed_addr #8 {
  %2 = load i32, ptr @num_local_array_reductions, align 4, !tbaa !13
  store i32 %2, ptr %0, align 4, !tbaa !13
  ret void
}
...
3:                                                ; preds = %1
  %4 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1408, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.17, i32 noundef %0) #9
  br label %14

5:                                                ; preds = %1
  %6 = load ptr, ptr @ReductionOperators, align 8, !tbaa !5
...
12:                                               ; preds = %5
  %13 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1420, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.17, i32 noundef %0) #9
  br label %14
...
3:                                                ; preds = %1
  %4 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1453, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.18, i32 noundef %0) #9
  br label %14

5:                                                ; preds = %1
  %6 = load ptr, ptr @LocalArrayReductionOperators, align 8, !tbaa !5
  %7 = tail call ptr @Util_GetHandledData(ptr noundef %6, i32 noundef %0) #9
  %8 = icmp eq ptr %7, null
  br i1 %8, label %12, label %9
...
12:                                               ; preds = %5
  %13 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1465, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.18, i32 noundef %0) #9
  br label %14
...
define dso_local i32 @CCTKi_RegisterGridArrayReductionOperator(ptr noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = load i32, ptr @num_GA_reductions, align 4, !tbaa !13
  %4 = icmp eq i32 %3, 0
...
5:                                                ; preds = %2
  ...
  store ptr %1, ptr @GA_reduc, align 8, !tbaa !5
  ...
  %10 = load i32, ptr @num_GA_reductions, align 4, !tbaa !13
  %11 = add nsw i32 %10, 1
  store i32 %11, ptr @num_GA_reductions, align 4, !tbaa !13
  br label %14

12:                                               ; preds = %2
  %13 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 1511, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.19) #9
  br label %14
...
12:                                               ; preds = %9
  %13 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 1592, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.20) #9
  br label %17

14:                                               ; preds = %9
  %15 = load ptr, ptr @GA_reduc, align 8, !tbaa !5
...
define dso_local void @cctk_reducegridarrays_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr nocapture noundef readonly %4, ptr nocapture noundef readonly %5, ptr noundef %6, ptr nocapture noundef readonly %7, ptr noundef %8, ptr noundef %9) local_unnamed_addr #1 {
  %11 = load i32, ptr @num_GA_reductions, align 4, !tbaa !13
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %13, label %15

13:                                               ; preds = %10
  %14 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 1625, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.20) #9
  br label %24

15:                                               ; preds = %10
  %16 = load ptr, ptr @GA_reduc, align 8, !tbaa !5
...
24:                                               ; preds = %15, %13
  ...
  store i32 %25, ptr %0, align 4, !tbaa !13
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local i32 @CCTK_NumGridArrayReductionOperators() local_unnamed_addr #7 {
  %1 = load i32, ptr @num_GA_reductions, align 4, !tbaa !13
  ret i32 %1
}
...
define dso_local ptr @CCTK_GridArrayReductionOperator() local_unnamed_addr #1 {
  ...
  %2 = load i32, ptr @num_GA_reductions, align 4, !tbaa !13
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %4, label %6

4:                                                ; preds = %0
  %5 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1685, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.21) #9
  br label %15

6:                                                ; preds = %0
  %7 = load ptr, ptr @GridArrayReductionOperators, align 8, !tbaa !5
...
13:                                               ; preds = %6
  %14 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1697, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.21) #9
  br label %15
...
define dso_local i32 @CCTKi_RegisterReduceArraysGloballyOperator(ptr noundef %0, ptr noundef %1) local_unnamed_addr #1 {
  %3 = load i32, ptr @num_reductions_arrays_globally, align 4, !tbaa !13
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %5, label %12
...
5:                                                ; preds = %2
  ...
  store ptr %1, ptr @ArraysGlobally_reduc, align 8, !tbaa !5
  ...
  %10 = load i32, ptr @num_reductions_arrays_globally, align 4, !tbaa !13
  %11 = add nsw i32 %10, 1
  store i32 %11, ptr @num_reductions_arrays_globally, align 4, !tbaa !13
  br label %14

12:                                               ; preds = %2
  %13 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 1743, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.22) #9
  br label %14
...
define dso_local i32 @CCTK_ReduceArraysGlobally(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, ptr noundef %5, i32 noundef %6, ptr noundef %7, ptr noundef %8, i32 noundef %9, ptr noundef %10, ptr noundef %11) local_unnamed_addr #1 {
  %13 = load i32, ptr @num_reductions_arrays_globally, align 4, !tbaa !13
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %15, label %17

15:                                               ; preds = %12
  %16 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 1842, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.23) #9
  br label %20

17:                                               ; preds = %12
  %18 = load ptr, ptr @ArraysGlobally_reduc, align 8, !tbaa !5
...
define dso_local void @cctk_reducearraysglobally_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr nocapture noundef readonly %4, ptr nocapture noundef readonly %5, ptr noundef %6, ptr nocapture noundef readonly %7, ptr noundef %8, ptr noundef %9, ptr nocapture noundef readonly %10, ptr noundef %11, ptr noundef %12) local_unnamed_addr #1 {
  %14 = load i32, ptr @num_reductions_arrays_globally, align 4, !tbaa !13
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %18

16:                                               ; preds = %13
  %17 = tail call i32 @CCTK_Warn(i32 noundef 3, i32 noundef 1879, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.23) #9
  br label %28

18:                                               ; preds = %13
  %19 = load ptr, ptr @ArraysGlobally_reduc, align 8, !tbaa !5
...
define dso_local i32 @CCTK_NumReductionArraysGloballyOperators() local_unnamed_addr #7 {
  %1 = load i32, ptr @num_reductions_arrays_globally, align 4, !tbaa !13
  ret i32 %1
}
...
define dso_local ptr @CCTK_ReductionArraysGloballyOperator() local_unnamed_addr #1 {
  %1 = alloca ptr, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %1) #9
  %2 = load i32, ptr @num_reductions_arrays_globally, align 4, !tbaa !13
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %4, label %6

4:                                                ; preds = %0
  %5 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1940, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.24) #9
  br label %15

6:                                                ; preds = %0
  %7 = load ptr, ptr @ReductionArraysGloballyOperators, align 8, !tbaa !5
  %8 = call i32 @Util_GetHandle(ptr noundef %7, ptr noundef nonnull @global, ptr noundef nonnull %1) #9
  %9 = load ptr, ptr %1, align 8, !tbaa !5
  %10 = icmp eq ptr %9, null
  br i1 %10, label %13, label %11
...
13:                                               ; preds = %6
  %14 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 6, i32 noundef 1952, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.24) #9
  br label %15
