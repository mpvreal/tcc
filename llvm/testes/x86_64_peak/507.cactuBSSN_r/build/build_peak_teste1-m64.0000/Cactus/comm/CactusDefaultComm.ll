...
@.str = private unnamed_addr constant [32 x i8] c"Cactus/comm/CactusDefaultComm.c\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"Cactus\00", align 1
@.str.2 = private unnamed_addr constant [109 x i8] c"Synchronisation of individual directions isn't supported with no driver overloading CCTK_SyncGroupsByDirI().\00", align 1
@CCTK_SyncGroup = external local_unnamed_addr global ptr, align 8
@.str.3 = private unnamed_addr constant [128 x i8] c"Overloading CCTK_SyncGroup() is deprecated. Please have your driver thorn updated to overload CCTK_SyncGroupsByDirI() instead !\00", align 1
@CCTK_GroupStorageIncrease = external local_unnamed_addr global ptr, align 8
@.str.4 = private unnamed_addr constant [59 x i8] c"No driver thorn activated to provide storage for variables\00", align 1
...
@.str.5 = private unnamed_addr constant [78 x i8] c"No driver thorn activated to provide an interpolation routine for grid arrays\00", align 1
...
7:                                                ; preds = %4
  ...
  store i32 %8, ptr %5, align 8, !tbaa !5
  ...
  store double 1.000000e+00, ptr %45, align 8, !tbaa !27
...
71:                                               ; preds = %59
  ...
  br i1 %73, label %74, label %59, !llvm.loop !32
...
95:                                               ; preds = %92
  %96 = load ptr, ptr %22, align 8, !tbaa !17
...
104:                                              ; preds = %101
  %105 = load ptr, ptr %31, align 8, !tbaa !20
  %106 = icmp eq ptr %105, null
  br i1 %106, label %133, label %107

107:                                              ; preds = %104
  %108 = load ptr, ptr %33, align 8, !tbaa !21
  %109 = icmp eq ptr %108, null
  br i1 %109, label %133, label %110

110:                                              ; preds = %107
  %111 = load ptr, ptr %35, align 8, !tbaa !22
  %112 = icmp eq ptr %111, null
  br i1 %112, label %133, label %113

113:                                              ; preds = %110
  %114 = load ptr, ptr %37, align 8, !tbaa !23
  %115 = icmp eq ptr %114, null
  br i1 %115, label %133, label %116

116:                                              ; preds = %113
  %117 = load ptr, ptr %39, align 8, !tbaa !24
  %118 = icmp eq ptr %117, null
  br i1 %118, label %133, label %119

119:                                              ; preds = %116
  %120 = load ptr, ptr %42, align 8, !tbaa !25
  %121 = icmp eq ptr %120, null
  br i1 %121, label %133, label %122

122:                                              ; preds = %119
  %123 = load ptr, ptr %44, align 8, !tbaa !26
...
define dso_local i32 @CactusDefaultnProcs(ptr nocapture noundef readnone %0) local_unnamed_addr #6 {
  %2 = load i32, ptr @cctki_paramchecking, align 4, !tbaa !36
  %3 = icmp eq i32 %2, 0
...
define dso_local i32 @CactusDefaultSyncGroup(ptr noundef %0, ptr noundef %1) #1 {
  ...
  %5 = load ptr, ptr @CCTK_SyncGroupsByDirI, align 8, !tbaa !31
...
6:                                                ; preds = %4
  %7 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 562, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #12
  br label %8

8:                                                ; preds = %6, %4
  %9 = load ptr, ptr @CCTK_SyncGroup, align 8, !tbaa !31
...
13:                                               ; preds = %11
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 2, i32 noundef 575, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3) #12
  br label %15
...
19:                                               ; preds = %17, %19
  ...
  %25 = load ptr, ptr @CCTK_SyncGroup, align 8, !tbaa !31
  ...
  br i1 %31, label %32, label %19, !llvm.loop !37
...
define dso_local i32 @CactusDefaultEnableGroupStorage(ptr noundef %0, ptr noundef %1) #1 {
  ...
  %6 = load ptr, ptr @CCTK_GroupStorageIncrease, align 8, !tbaa !31
...
8:                                                ; preds = %2
  ...
  %10 = load ptr, ptr @CCTK_GroupStorageIncrease, align 8, !tbaa !31
...
13:                                               ; preds = %2
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 649, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #12
  br label %15
...
define dso_local i32 @CactusDefaultGroupStorageIncrease(ptr noundef %0, i32 noundef %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr noundef writeonly %4) #1 {
  %6 = load ptr, ptr @CCTK_EnableGroupStorage, align 8, !tbaa !31
...
22:                                               ; preds = %19
  %23 = load i32, ptr %16, align 4, !tbaa !36
...
30:                                               ; preds = %25
  ...
  %33 = load ptr, ptr @CCTK_EnableGroupStorage, align 8, !tbaa !31
...
37:                                               ; preds = %35, %13
  ...
  br i1 %40, label %72, label %13, !llvm.loop !38
...
50:                                               ; preds = %47
  %51 = load i32, ptr %44, align 4, !tbaa !36
...
58:                                               ; preds = %53
  ...
  %61 = load ptr, ptr @CCTK_EnableGroupStorage, align 8, !tbaa !31
...
63:                                               ; preds = %58, %53
  ...
  store i32 %54, ptr %65, align 4, !tbaa !36
  br label %66
...
66:                                               ; preds = %41, %63
  ...
  br i1 %69, label %72, label %41, !llvm.loop !38

70:                                               ; preds = %5
  %71 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 817, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #12
  br label %72
...
define dso_local i32 @CactusDefaultDisableGroupStorage(ptr noundef %0, ptr noundef %1) #1 {
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %4) #12
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #12
  %6 = load ptr, ptr @CCTK_GroupStorageDecrease, align 8, !tbaa !31
...
8:                                                ; preds = %2
  ...
  store i32 %9, ptr %3, align 4, !tbaa !36
  store i32 -1, ptr %4, align 4, !tbaa !36
  %10 = load ptr, ptr @CCTK_GroupStorageDecrease, align 8, !tbaa !31
  %11 = call i32 %10(ptr noundef %0, i32 noundef 1, ptr noundef nonnull %3, ptr noundef nonnull %4, ptr noundef nonnull %5) #12
  %12 = load i32, ptr %5, align 4, !tbaa !36
  br label %15

13:                                               ; preds = %2
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 708, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #12
  br label %15
...
define dso_local i32 @CactusDefaultGroupStorageDecrease(ptr noundef %0, i32 noundef %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3, ptr noundef writeonly %4) #1 {
  %6 = load ptr, ptr @CCTK_DisableGroupStorage, align 8, !tbaa !31
...
30:                                               ; preds = %25
  %31 = load i32, ptr %16, align 4, !tbaa !36
  %32 = tail call ptr @CCTK_GroupName(i32 noundef %31) #12
  %33 = load ptr, ptr @CCTK_DisableGroupStorage, align 8, !tbaa !31
  %34 = tail call i32 %33(ptr noundef %0, ptr noundef %32) #12
  tail call void @free(ptr noundef %32) #12
  br label %35
...
58:                                               ; preds = %53
  %59 = load i32, ptr %44, align 4, !tbaa !36
  %60 = tail call ptr @CCTK_GroupName(i32 noundef %59) #12
  %61 = load ptr, ptr @CCTK_DisableGroupStorage, align 8, !tbaa !31
  %62 = tail call i32 %61(ptr noundef %0, ptr noundef %60) #12
  tail call void @free(ptr noundef %60) #12
  br label %63
...
70:                                               ; preds = %5
  %71 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 927, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #12
  br label %72
...
define dso_local i32 @CactusDefaultInterpGridArrays(ptr nocapture noundef readnone %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6, ptr nocapture noundef readnone %7, i32 noundef %8, ptr nocapture noundef readnone %9, i32 noundef %10, ptr nocapture noundef readnone %11, ptr nocapture noundef readnone %12) local_unnamed_addr #1 {
  %14 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 979, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5) #12
  ret i32 -1
}
