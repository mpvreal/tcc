...
define internal i32 @CCTKi_BindingsFortranWrapperADMCoupling(ptr noundef %0, ptr nocapture noundef readonly %1) #0 {
  ...
  %4 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tt, align 4, !tbaa !9
  %5 = icmp eq i32 %4, -1
  br i1 %5, label %6, label %8

6:                                                ; preds = %2
  %7 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.7) #3
  store i32 %7, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tt, align 4, !tbaa !9
  br label %8

8:                                                ; preds = %6, %2
  %9 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_scalar, align 4, !tbaa !9
  %10 = icmp eq i32 %9, -1
  br i1 %10, label %11, label %13

11:                                               ; preds = %8
  %12 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.8) #3
  store i32 %12, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_scalar, align 4, !tbaa !9
  br label %13

13:                                               ; preds = %11, %8
  %14 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tx, align 4, !tbaa !9
  %15 = icmp eq i32 %14, -1
  br i1 %15, label %16, label %18

16:                                               ; preds = %13
  %17 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.9) #3
  store i32 %17, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tx, align 4, !tbaa !9
  br label %18

18:                                               ; preds = %16, %13
  %19 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_vector, align 4, !tbaa !9
  %20 = icmp eq i32 %19, -1
  br i1 %20, label %21, label %23

21:                                               ; preds = %18
  %22 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.10) #3
  store i32 %22, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_vector, align 4, !tbaa !9
  br label %23

23:                                               ; preds = %21, %18
  %24 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2ty, align 4, !tbaa !9
  %25 = icmp eq i32 %24, -1
  br i1 %25, label %26, label %28

26:                                               ; preds = %23
  %27 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.11) #3
  store i32 %27, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2ty, align 4, !tbaa !9
  br label %28

28:                                               ; preds = %26, %23
  %29 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tz, align 4, !tbaa !9
  %30 = icmp eq i32 %29, -1
  br i1 %30, label %31, label %33

31:                                               ; preds = %28
  %32 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.12) #3
  store i32 %32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tz, align 4, !tbaa !9
  br label %33

33:                                               ; preds = %31, %28
  %34 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xx, align 4, !tbaa !9
  %35 = icmp eq i32 %34, -1
  br i1 %35, label %36, label %38

36:                                               ; preds = %33
  %37 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.13) #3
  store i32 %37, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xx, align 4, !tbaa !9
  br label %38

38:                                               ; preds = %36, %33
  %39 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_tensor, align 4, !tbaa !9
  %40 = icmp eq i32 %39, -1
  br i1 %40, label %41, label %43

41:                                               ; preds = %38
  %42 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.14) #3
  store i32 %42, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_tensor, align 4, !tbaa !9
  br label %43

43:                                               ; preds = %41, %38
  %44 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xy, align 4, !tbaa !9
  %45 = icmp eq i32 %44, -1
  br i1 %45, label %46, label %48

46:                                               ; preds = %43
  %47 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.15) #3
  store i32 %47, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xy, align 4, !tbaa !9
  br label %48

48:                                               ; preds = %46, %43
  %49 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xz, align 4, !tbaa !9
  %50 = icmp eq i32 %49, -1
  br i1 %50, label %51, label %53

51:                                               ; preds = %48
  %52 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.16) #3
  store i32 %52, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xz, align 4, !tbaa !9
  br label %53

53:                                               ; preds = %51, %48
  %54 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2yy, align 4, !tbaa !9
  %55 = icmp eq i32 %54, -1
  br i1 %55, label %56, label %58

56:                                               ; preds = %53
  %57 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.17) #3
  store i32 %57, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2yy, align 4, !tbaa !9
  br label %58

58:                                               ; preds = %56, %53
  %59 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2yz, align 4, !tbaa !9
  %60 = icmp eq i32 %59, -1
  br i1 %60, label %61, label %63

61:                                               ; preds = %58
  %62 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.18) #3
  store i32 %62, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2yz, align 4, !tbaa !9
  br label %63

63:                                               ; preds = %61, %58
  %64 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2zz, align 4, !tbaa !9
  %65 = icmp eq i32 %64, -1
  br i1 %65, label %66, label %68

66:                                               ; preds = %63
  %67 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.19) #3
  store i32 %67, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2zz, align 4, !tbaa !9
  br label %68

68:                                               ; preds = %66, %63
  %69 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_stress_energy_2_state, align 4, !tbaa !9
  %70 = icmp eq i32 %69, -1
  br i1 %70, label %71, label %73

71:                                               ; preds = %68
  %72 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.20) #3
  store i32 %72, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_stress_energy_2_state, align 4, !tbaa !9
  br label %73

73:                                               ; preds = %71, %68
  %74 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_state, align 4, !tbaa !9
  %75 = icmp eq i32 %74, -1
  br i1 %75, label %76, label %78

76:                                               ; preds = %73
  %77 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.20) #3
  store i32 %77, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKGROUPNUM_stress_energy_2_state, align 4, !tbaa !9
  br label %78
...
78:                                               ; preds = %76, %73
  ...
  %107 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tt, align 4, !tbaa !9
...
116:                                              ; preds = %78, %109
  ...
  %118 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tx, align 4, !tbaa !9
...
127:                                              ; preds = %116, %120
  ...
  %129 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2ty, align 4, !tbaa !9
...
138:                                              ; preds = %127, %131
  ...
  %140 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2tz, align 4, !tbaa !9
...
149:                                              ; preds = %138, %142
  ...
  %151 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xx, align 4, !tbaa !9
...
160:                                              ; preds = %149, %153
  ...
  %162 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xy, align 4, !tbaa !9
...
171:                                              ; preds = %160, %164
  ...
  %173 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2xz, align 4, !tbaa !9
...
182:                                              ; preds = %171, %175
  ...
  %184 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2yy, align 4, !tbaa !9
...
193:                                              ; preds = %182, %186
  ...
  %195 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2yz, align 4, !tbaa !9
...
204:                                              ; preds = %193, %197
  ...
  %206 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_eT2zz, align 4, !tbaa !9
...
215:                                              ; preds = %204, %208
  ...
  %217 = load i32, ptr @CCTKi_BindingsFortranWrapperADMCoupling.CCTKARGNUM_stress_energy_2_state, align 4, !tbaa !9
