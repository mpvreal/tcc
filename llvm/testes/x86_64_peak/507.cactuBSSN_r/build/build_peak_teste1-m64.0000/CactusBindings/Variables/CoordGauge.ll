...
define internal i32 @CCTKi_BindingsFortranWrapperCoordGauge(ptr noundef %0, ptr nocapture noundef readonly %1) #0 {
  ...
  %4 = load i32, ptr @CCTKi_BindingsFortranWrapperCoordGauge.CCTKARGNUM_active_slicing_handle, align 4, !tbaa !8
  %5 = icmp eq i32 %4, -1
  br i1 %5, label %6, label %8

6:                                                ; preds = %2
  %7 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.15) #3
  store i32 %7, ptr @CCTKi_BindingsFortranWrapperCoordGauge.CCTKARGNUM_active_slicing_handle, align 4, !tbaa !8
  br label %8

8:                                                ; preds = %6, %2
  %9 = phi i32 [ %7, %6 ], [ %4, %2 ]
  %10 = load i32, ptr @CCTKi_BindingsFortranWrapperCoordGauge.CCTKGROUPNUM_slicing_flags, align 4, !tbaa !8
  %11 = icmp eq i32 %10, -1
  br i1 %11, label %12, label %15

12:                                               ; preds = %8
  %13 = tail call i32 @CCTK_GroupIndex(ptr noundef nonnull @.str.16) #3
  store i32 %13, ptr @CCTKi_BindingsFortranWrapperCoordGauge.CCTKGROUPNUM_slicing_flags, align 4, !tbaa !8
  %14 = load i32, ptr @CCTKi_BindingsFortranWrapperCoordGauge.CCTKARGNUM_active_slicing_handle, align 4, !tbaa !8
  br label %15
