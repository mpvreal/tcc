; ModuleID = 'CactusBindings/Variables/PUGHInterp.c'
source_filename = "CactusBindings/Variables/PUGHInterp.c"
...
@.str.6 = private unnamed_addr constant [11 x i8] c"PUGHInterp\00", align 1

; Function Attrs: nounwind sspstrong uwtable
define dso_local i32 @CactusBindingsVariables_PUGHInterp_Initialise() local_unnamed_addr #0 {
  %1 = tail call ptr @CCTK_ParameterGet(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef null) #3
  %2 = tail call i32 @CCTKi_RegisterFortranWrapper(ptr noundef nonnull @.str.6, ptr noundef nonnull @CCTKi_BindingsFortranWrapperPUGHInterp) #3
  ret i32 0
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal i32 @CCTKi_BindingsFortranWrapperPUGHInterp(ptr noundef %0, ptr nocapture noundef readonly %1) #0 {
