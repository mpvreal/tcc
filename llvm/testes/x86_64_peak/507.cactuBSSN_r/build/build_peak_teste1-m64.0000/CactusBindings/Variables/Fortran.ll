; ModuleID = 'CactusBindings/Variables/Fortran.c'
source_filename = "CactusBindings/Variables/Fortran.c"
...
define dso_local i32 @CactusBindingsVariables_Fortran_Initialise() local_unnamed_addr #0 {
  %1 = tail call ptr @CCTK_ParameterGet(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef null) #3
  %2 = tail call i32 @CCTKi_RegisterFortranWrapper(ptr noundef nonnull @.str.6, ptr noundef nonnull @CCTKi_BindingsFortranWrapperFortran) #3
  ret i32 0
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal i32 @CCTKi_BindingsFortranWrapperFortran(ptr noundef %0, ptr nocapture noundef readonly %1) #0 {
