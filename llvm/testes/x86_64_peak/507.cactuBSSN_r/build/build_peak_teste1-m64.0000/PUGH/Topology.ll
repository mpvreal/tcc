...
@.str.2 = private unnamed_addr constant [14 x i8] c"automatic_old\00", align 1
...
define dso_local i32 @PUGH_RegisterPUGHTopologyRoutines() local_unnamed_addr #1 {
  %1 = tail call i32 @PUGH_RegisterGenerateTopology(ptr noundef nonnull @TraditionalTopology, ptr noundef nonnull @.str) #10
  %2 = tail call i32 @PUGH_RegisterGenerateTopology(ptr noundef nonnull @FranksTopology, ptr noundef nonnull @.str.1) #10
  %3 = tail call i32 @PUGH_RegisterGenerateTopology(ptr noundef nonnull @TraditionalTopology, ptr noundef nonnull @.str.2) #10
  ret i32 0
}
...
109:                                              ; preds = %118
  ...
  br i1 %111, label %123, label %77, !llvm.loop !14
...
125:                                              ; preds = %123, %125
  ...
  br i1 %129, label %131, label %125, !llvm.loop !16

131:                                              ; preds = %125
  %132 = getelementptr inbounds i32, ptr %53, i64 %58
  store i32 %126, ptr %132, align 4, !tbaa !5
  %133 = add nsw i32 %59, -1
  %134 = add nuw nsw i64 %58, 1
  %135 = icmp eq i64 %134, %56
  br i1 %135, label %136, label %57, !llvm.loop !17
...
161:                                              ; preds = %155
  ...
  store i32 %164, ptr %158, align 4, !tbaa !5
...
166:                                              ; preds = %161, %155
  ...
  br i1 %170, label %171, label %143, !llvm.loop !18
...
8:                                                ; preds = %5
  %9 = tail call i32 @TraditionalTopology(i32 noundef 0, i32 noundef %1, ptr poison, ptr poison, ptr noundef %4), !range !19
  br label %118
...
24:                                               ; preds = %24, %22
  ...
  store <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, ptr %26, align 4, !tbaa !5
  %27 = getelementptr inbounds i32, ptr %26, i64 8
  store <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, ptr %27, align 4, !tbaa !5
  %28 = getelementptr inbounds i32, ptr %26, i64 16
  store <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, ptr %28, align 4, !tbaa !5
  %29 = getelementptr inbounds i32, ptr %26, i64 24
  store <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, ptr %29, align 4, !tbaa !5
...
46:                                               ; preds = %81
  ...
  %52 = add nsw i32 %49, 1
  store i32 %52, ptr %48, align 4, !tbaa !5
  %53 = icmp eq i32 %51, 0
  br i1 %53, label %88, label %43, !llvm.loop !21
...
76:                                               ; preds = %70, %64, %54
  ...
  br i1 %80, label %81, label %54, !llvm.loop !22
...
83:                                               ; preds = %34, %83
  ...
  br i1 %87, label %36, label %83, !llvm.loop !23
...
91:                                               ; preds = %81, %38, %40
  ...
  %93 = tail call i32 @TraditionalTopology(i32 noundef %0, i32 noundef %1, ptr poison, ptr poison, ptr noundef %4), !range !19
  br label %118

94:                                               ; preds = %110
  %95 = add nuw nsw i64 %102, 1
  %96 = icmp eq i64 %95, %90
  br i1 %96, label %97, label %101, !llvm.loop !24
...
98:                                               ; preds = %97
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %4, ptr align 4 %13, i64 %100, i1 false), !tbaa !5
  br label %117
...
114:                                              ; preds = %110, %106
  ...
  %116 = tail call i32 @TraditionalTopology(i32 noundef %0, i32 noundef %1, ptr poison, ptr poison, ptr noundef nonnull %4), !range !19
  br label %118
