...
37:                                               ; preds = %37, %35
  ...
  %44 = tail call <8 x i32> @llvm.masked.load.v8i32.p0(ptr %43, i32 4, <8 x i1> %41, <8 x i32> poison), !tbaa !5
  ...
  tail call void @llvm.masked.store.v8i32.p0(<8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, ptr %47, i32 4, <8 x i1> %48), !tbaa !5
  %49 = add nuw i64 %38, 8
...
71:                                               ; preds = %68, %51, %29, %21
  ...
  %75 = load i32, ptr %72, align 4, !tbaa !14
...
110:                                              ; preds = %106, %102, %98, %14
  ...
  %122 = load i32, ptr %116, align 8, !tbaa !26
  %123 = sub i32 0, %6
...
127:                                              ; preds = %110
  store ptr %121, ptr %114, align 8, !tbaa !27
...
147:                                              ; preds = %136, %163
  ...
  %151 = load i32, ptr %116, align 8, !tbaa !26
  %152 = load i32, ptr %133, align 4, !tbaa !28
  %153 = srem i32 %138, %7
  %154 = icmp eq i32 %153, 0
  br i1 %154, label %163, label %155

155:                                              ; preds = %147
  %156 = load ptr, ptr %114, align 8, !tbaa !27
...
163:                                              ; preds = %155, %147
  ...
  %166 = load ptr, ptr %114, align 8, !tbaa !27
  %167 = load i32, ptr %116, align 8, !tbaa !26
  %168 = sext i32 %167 to i64
  %169 = getelementptr inbounds ptr, ptr %166, i64 %168
  %170 = load ptr, ptr %169, align 8, !tbaa !23
  %171 = getelementptr inbounds ptr, ptr %170, i64 %149
  store ptr %165, ptr %171, align 8, !tbaa !23
  %172 = load i32, ptr %133, align 4, !tbaa !28
  %173 = add nsw i32 %172, 1
  store i32 %173, ptr %133, align 4, !tbaa !28
...
176:                                              ; preds = %163
  ...
  store i32 %177, ptr %116, align 8, !tbaa !26
  %178 = add nuw nsw i32 %138, 1
  %179 = icmp eq i32 %178, %6
  br i1 %179, label %199, label %136, !llvm.loop !30
...
182:                                              ; preds = %192, %180
  ...
  store ptr %186, ptr %187, align 8, !tbaa !23
  %188 = load ptr, ptr %114, align 8, !tbaa !27
...
192:                                              ; preds = %182
  ...
  store i32 %194, ptr %116, align 8, !tbaa !26
  %195 = add nuw nsw i32 %185, 1
  %196 = icmp eq i32 %195, %6
  br i1 %196, label %199, label %182, !llvm.loop !30
...
!14 = !{!15, !6, i64 12}
!15 = !{!"PGH", !16, i64 0, !6, i64 8, !6, i64 12, !6, i64 16, !6, i64 20, !6, i64 24, !6, i64 28, !16, i64 32, !6, i64 40, !16, i64 48, !6, i64 56, !6, i64 60, !17, i64 64, !17, i64 72, !17, i64 80, !17, i64 88, !6, i64 96, !6, i64 100, !6, i64 104, !6, i64 108, !6, i64 112, !16, i64 120, !16, i64 128, !16, i64 136}
!16 = !{!"any pointer", !7, i64 0}
!17 = !{!"double", !7, i64 0}
!18 = !{!19, !16, i64 8}
!19 = !{!"PConnectivity", !6, i64 0, !16, i64 8, !16, i64 16, !16, i64 24}
!20 = !{!19, !16, i64 16}
!21 = !{!15, !6, i64 16}
!22 = !{!15, !16, i64 128}
!23 = !{!16, !16, i64 0}
