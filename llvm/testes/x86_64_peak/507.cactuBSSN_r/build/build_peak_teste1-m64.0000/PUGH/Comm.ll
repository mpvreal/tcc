...
@.str = private unnamed_addr constant [12 x i8] c"PUGH/Comm.c\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"PUGH\00", align 1
@.str.2 = private unnamed_addr constant [34 x i8] c"PUGH_SyncGroup: Unknown group: %s\00", align 1
@.str.3 = private unnamed_addr constant [62 x i8] c"PUGH doesn't support synchronisation of individual directions\00", align 1
@.str.4 = private unnamed_addr constant [46 x i8] c"Illegal group index -- group has no variables\00", align 1
...
@.str.8 = private unnamed_addr constant [52 x i8] c"Trying to synchronize variable '%s' with no storage\00", align 1
...
6:                                                ; preds = %2
  %7 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 84, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef %1) #8
  br label %44
...
30:                                               ; preds = %20, %16
  %31 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 393, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.7) #8
...
38:                                               ; preds = %30
  %39 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 569, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5) #8
  br label %40
...
7:                                                ; preds = %4
  %8 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 158, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3) #8
  br label %9
...
24:                                               ; preds = %21
  %25 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 393, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.7) #8
  br label %26
...
35:                                               ; preds = %14, %26
  ...
  br i1 %38, label %39, label %14, !llvm.loop !18
...
9:                                                ; preds = %2
  %10 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 569, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5) #8
  br label %11
...
8:                                                ; preds = %2
  %9 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 281, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #8
  %10 = call ptr @PUGH_pGH(ptr noundef %0) #8
  %11 = call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 481, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5) #8
  br label %14
...
5:                                                ; preds = %3
  %6 = tail call i32 @CCTK_Warn(i32 noundef 0, i32 noundef 481, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5) #8
  br label %7
...
22:                                               ; preds = %6
  ...
  %24 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 2, i32 noundef 1070, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.8, ptr noundef %23) #8
  br label %374
...
97:                                               ; preds = %75, %97
  ...
  store i32 %103, ptr %104, align 4, !tbaa !17
  %105 = add nuw nsw i64 %98, 1
  %106 = load i32, ptr %79, align 8, !tbaa !31
  %107 = sext i32 %106 to i64
  %108 = icmp slt i64 %105, %107
  br i1 %108, label %97, label %109, !llvm.loop !37

109:                                              ; preds = %97, %75
  %110 = phi i32 [ %78, %75 ], [ %106, %97 ]
  %111 = load i32, ptr %90, align 4, !tbaa !17
  %112 = load i32, ptr %85, align 4, !tbaa !17
  %113 = sub nsw i32 %111, %112
  %114 = load i32, ptr %38, align 8, !tbaa !38
...
126:                                              ; preds = %120
  %127 = load i32, ptr %85, align 4, !tbaa !17
  %128 = load i32, ptr %94, align 4, !tbaa !17
  br label %313

129:                                              ; preds = %120
  %130 = load i32, ptr %39, align 4, !tbaa !17
  %131 = load i32, ptr %116, align 4, !tbaa !17
  %132 = icmp slt i32 %130, %131
  br i1 %132, label %133, label %136

133:                                              ; preds = %129
  %134 = load i32, ptr %85, align 4, !tbaa !17
  %135 = load i32, ptr %94, align 4, !tbaa !17
  br label %216
...
138:                                              ; preds = %136, %150
  ...
  store i32 %142, ptr %140, align 4, !tbaa !17
  ...
  %149 = load i32, ptr %124, align 8, !tbaa !31
...
150:                                              ; preds = %138
  ...
  br i1 %153, label %138, label %154, !llvm.loop !39
...
201:                                              ; preds = %199, %201
  ...
  store i32 %205, ptr %206, align 4, !tbaa !17
  ...
  store i32 %208, ptr %209, align 4, !tbaa !17
  %210 = icmp ugt i64 %202, 2
  br i1 %210, label %201, label %211, !llvm.loop !43

211:                                              ; preds = %201, %197
  %212 = load i32, ptr %124, align 8, !tbaa !31
  %213 = load i32, ptr %85, align 4, !tbaa !17
  %214 = load i32, ptr %94, align 4, !tbaa !17
...
230:                                              ; preds = %230, %225
  ...
  %242 = load <4 x i32>, ptr %241, align 4, !tbaa !17
  %243 = getelementptr inbounds i32, ptr %241, i64 4
  %244 = load <4 x i32>, ptr %243, align 4, !tbaa !17
  %245 = getelementptr inbounds i32, ptr %241, i64 8
  %246 = load <4 x i32>, ptr %245, align 4, !tbaa !17
  %247 = getelementptr inbounds i32, ptr %241, i64 12
  %248 = load <4 x i32>, ptr %247, align 4, !tbaa !17
  %249 = getelementptr inbounds i32, ptr %221, i64 %240
  %250 = load <4 x i32>, ptr %249, align 4, !tbaa !17
  %251 = getelementptr inbounds i32, ptr %249, i64 4
  %252 = load <4 x i32>, ptr %251, align 4, !tbaa !17
  ...
  %266 = load <4 x i32>, ptr %265, align 4, !tbaa !17
  %267 = getelementptr inbounds i32, ptr %265, i64 4
  %268 = load <4 x i32>, ptr %267, align 4, !tbaa !17
  %269 = getelementptr inbounds i32, ptr %265, i64 8
  %270 = load <4 x i32>, ptr %269, align 4, !tbaa !17
  ...
  br i1 %282, label %283, label %230, !llvm.loop !45
...
297:                                              ; preds = %293, %297
  ...
  br i1 %312, label %313, label %297, !llvm.loop !46

313:                                              ; preds = %297, %283, %211, %126
  %314 = phi i32 [ %214, %211 ], [ %128, %126 ], [ %287, %283 ], [ %310, %297 ]
  %315 = phi i32 [ %213, %211 ], [ %127, %126 ], [ %291, %283 ], [ %306, %297 ]
  %316 = load i32, ptr %40, align 4, !tbaa !47
  %317 = icmp sgt i32 %316, 0
  br i1 %317, label %318, label %347

318:                                              ; preds = %313
  %319 = load i32, ptr %9, align 8, !tbaa !23
  %320 = load i32, ptr %38, align 8, !tbaa !38
...
326:                                              ; preds = %326, %318
  ...
  %341 = load i32, ptr %40, align 4, !tbaa !47
  %342 = add nsw i32 %341, %340
  %343 = sext i32 %342 to i64
  %344 = icmp slt i64 %339, %343
  br i1 %344, label %326, label %345, !llvm.loop !49

345:                                              ; preds = %326
  %346 = load ptr, ptr %26, align 8, !tbaa !28
  br label %347
...
352:                                              ; preds = %347
  %353 = load i32, ptr %39, align 4, !tbaa !17
  %354 = add nsw i32 %353, 1
  store i32 %354, ptr %39, align 4, !tbaa !17
  %355 = load i32, ptr %41, align 4, !tbaa !17
  %356 = add nsw i32 %355, 1
  store i32 %356, ptr %41, align 4, !tbaa !17
  %357 = load i32, ptr %349, align 8, !tbaa !31
  br label %120
...
358:                                              ; preds = %136, %347, %154
  ...
  br i1 %363, label %364, label %75, !llvm.loop !50

364:                                              ; preds = %358
  %365 = load i32, ptr %359, align 8, !tbaa !31
  br label %366
...
366:                                              ; preds = %364, %55, %43
  ...
  br i1 %372, label %43, label %373, !llvm.loop !51
...
!5 = !{!6, !7, i64 16}
!6 = !{!"", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !7, i64 32}
!7 = !{!"int", !8, i64 0}
!8 = !{!"omnipotent char", !9, i64 0}
!9 = !{!"Simple C/C++ TBAA"}
!10 = !{!11, !12, i64 32}
!11 = !{!"PGH", !12, i64 0, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !12, i64 32, !7, i64 40, !12, i64 48, !7, i64 56, !7, i64 60, !13, i64 64, !13, i64 72, !13, i64 80, !13, i64 88, !7, i64 96, !7, i64 100, !7, i64 104, !7, i64 108, !7, i64 112, !12, i64 120, !12, i64 128, !12, i64 136}
!12 = !{!"any pointer", !8, i64 0}
!13 = !{!"double", !8, i64 0}
!14 = !{!12, !12, i64 0}
!15 = !{!16, !12, i64 80}
!16 = !{!"PGA", !12, i64 0, !7, i64 8, !7, i64 12, !12, i64 16, !12, i64 24, !7, i64 32, !7, i64 36, !12, i64 40, !7, i64 48, !7, i64 52, !12, i64 56, !12, i64 64, !12, i64 72, !12, i64 80, !7, i64 88, !7, i64 92, !12, i64 96}
!17 = !{!7, !7, i64 0}
!18 = distinct !{!18, !19}
...
!22 = !{!11, !7, i64 12}
!23 = !{!24, !7, i64 40}
!24 = !{!"PComm", !12, i64 0, !12, i64 8, !12, i64 16, !7, i64 24, !12, i64 32, !7, i64 40, !7, i64 44, !7, i64 48}
!25 = !{!24, !7, i64 48}
!26 = !{!16, !7, i64 32}
!27 = !{!16, !12, i64 0}
!28 = !{!16, !12, i64 56}
!29 = !{!30, !12, i64 80}
!30 = !{!"PGExtras", !7, i64 0, !12, i64 8, !13, i64 16, !12, i64 24, !12, i64 32, !12, i64 40, !12, i64 48, !7, i64 56, !12, i64 64, !12, i64 72, !12, i64 80, !12, i64 88, !12, i64 96, !8, i64 104, !8, i64 120, !8, i64 136}
!31 = !{!30, !7, i64 0}
!32 = !{!16, !12, i64 64}
!33 = !{!34, !12, i64 24}
!34 = !{!"PConnectivity", !7, i64 0, !12, i64 8, !12, i64 16, !12, i64 24}
!35 = !{!30, !12, i64 96}
!36 = !{!30, !12, i64 48}
!37 = distinct !{!37, !19}
!38 = !{!16, !7, i64 48}
