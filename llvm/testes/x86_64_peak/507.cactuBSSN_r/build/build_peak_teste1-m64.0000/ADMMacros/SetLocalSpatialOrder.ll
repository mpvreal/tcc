...
@.str.2 = private unnamed_addr constant [38 x i8] c"Spatial finite differencing order: %d\00", align 1
...
define dso_local void @ADMMacros_SetLocalSpatialOrder(ptr noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr @ADMMacros_SetLocalSpatialOrder.cctki_vi_local_spatial_order, align 4, !tbaa !5
  %3 = icmp eq i32 %2, -100
  br i1 %3, label %4, label %6

4:                                                ; preds = %1
  %5 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str) #3
  store i32 %5, ptr @ADMMacros_SetLocalSpatialOrder.cctki_vi_local_spatial_order, align 4, !tbaa !5
  br label %6

6:                                                ; preds = %4, %1
  %7 = phi i32 [ %5, %4 ], [ %2, %1 ]
  %8 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef %0, i32 noundef 0, i32 noundef %7) #3
  %9 = load i32, ptr @admmacrosrest_, align 4, !tbaa !9
  store i32 %9, ptr %8, align 4, !tbaa !5
  %10 = load ptr, ptr @CCTK_MyProc, align 8, !tbaa !11
  %11 = tail call i32 %10(ptr noundef %0) #3
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %13, label %15

13:                                               ; preds = %6
  %14 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef %9) #3
  br label %15
