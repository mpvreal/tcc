; ModuleID = 'ADMMacros/cctk_Bindings/cctk_ThornBindings.c'
source_filename = "ADMMacros/cctk_Bindings/cctk_ThornBindings.c"
...
@.str = private unnamed_addr constant [10 x i8] c"ADMMacros\00", align 1
@__const.CCTKi_BindingsThorn_ADMMacros.implementation = private unnamed_addr constant [2 x ptr] [ptr @.str, ptr null], align 16
@.str.1 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@.str.2 = private unnamed_addr constant [15 x i8] c"implementation\00", align 1

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @CCTKi_BindingsThorn_ADMMacros() local_unnamed_addr #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %1, ptr noundef nonnull align 16 dereferenceable(16) @__const.CCTKi_BindingsThorn_ADMMacros.implementation, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %2) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %2, ptr noundef nonnull align 16 dereferenceable(16) @__const.CCTKi_BindingsThorn_ADMMacros.implementation, i64 16, i1 false)
