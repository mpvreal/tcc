...
@.str = private unnamed_addr constant [25 x i8] c"CartGrid3D/GetSymmetry.c\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"CartGrid3D\00", align 1
@.str.2 = private unnamed_addr constant [42 x i8] c"Invalid variable index %d in GetCartSymVI\00", align 1
@.str.3 = private unnamed_addr constant [9 x i8] c"Symmetry\00", align 1
@.str.4 = private unnamed_addr constant [40 x i8] c"Cannot find variable %s in GetCartSymVN\00", align 1
...
9:                                                ; preds = %6, %3
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 71, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef %2) #5
  br label %45
...
define dso_local void @getcartsymvi_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef writeonly %2, ptr nocapture noundef readonly %3) local_unnamed_addr #1 {
  ...
  %7 = tail call i32 @GetCartSymVI(ptr noundef %5, ptr noundef %2, i32 noundef %6), !range !13
...
6:                                                ; preds = %3
  %7 = tail call i32 @GetCartSymVI(ptr noundef %0, ptr noundef %1, i32 noundef %4), !range !13
  br label %10

8:                                                ; preds = %3
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 126, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4, ptr noundef %2) #5
  br label %10
...
10:                                               ; preds = %5
  %11 = tail call i32 @GetCartSymVI(ptr noundef %7, ptr noundef %2, i32 noundef %8), !range !13
  br label %14

12:                                               ; preds = %5
  %13 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 126, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4, ptr noundef %6) #5
  br label %14
