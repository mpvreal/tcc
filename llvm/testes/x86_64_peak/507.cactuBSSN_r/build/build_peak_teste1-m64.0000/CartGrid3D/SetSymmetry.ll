...
@.str = private unnamed_addr constant [25 x i8] c"CartGrid3D/SetSymmetry.c\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"CartGrid3D\00", align 1
@.str.2 = private unnamed_addr constant [42 x i8] c"Invalid variable index %d in SetCartSymVI\00", align 1
@.str.3 = private unnamed_addr constant [9 x i8] c"Symmetry\00", align 1
@.str.4 = private unnamed_addr constant [38 x i8] c"Unknown variable '%s' in SetCartSymVN\00", align 1
@.str.5 = private unnamed_addr constant [53 x i8] c"Cannot find group %s (grp.index: %d) in SetCartSymGI\00", align 1
@.str.6 = private unnamed_addr constant [35 x i8] c"Unknown group '%s' in SetCartSymGN\00", align 1
...
9:                                                ; preds = %6, %3
  %10 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 73, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef %2) #5
  br label %147

11:                                               ; preds = %6
  %12 = tail call ptr @CCTK_GHExtension(ptr noundef %0, ptr noundef nonnull @.str.3) #5
  ...
  %16 = load i32, ptr %4, align 16, !tbaa !5
...
29:                                               ; preds = %11
  ...
  %31 = load i32, ptr %15, align 4, !tbaa !5
...
51:                                               ; preds = %47
  %52 = load i32, ptr %1, align 4, !tbaa !5
...
55:                                               ; preds = %47
  ...
  %57 = load i32, ptr %15, align 4, !tbaa !5
...
74:                                               ; preds = %65
  ...
  %76 = load i32, ptr %15, align 4, !tbaa !5
  %77 = mul nsw i32 %76, %75
  br label %84

78:                                               ; preds = %65
  %79 = load i32, ptr %13, align 4, !tbaa !5
  %80 = load i32, ptr %15, align 4, !tbaa !5
  %81 = mul nsw i32 %80, %79
  br label %84

82:                                               ; preds = %65
  %83 = load i32, ptr %13, align 4, !tbaa !5
  br label %84
...
89:                                               ; preds = %84
  %90 = load i32, ptr %1, align 4, !tbaa !5
  %91 = load i32, ptr %13, align 4, !tbaa !5
  %92 = mul nsw i32 %91, %90
  br label %103

93:                                               ; preds = %84
  %94 = load i32, ptr %1, align 4, !tbaa !5
  %95 = load i32, ptr %15, align 4, !tbaa !5
  %96 = mul nsw i32 %95, %94
  br label %103

97:                                               ; preds = %84
  %98 = load i32, ptr %13, align 4, !tbaa !5
  %99 = load i32, ptr %15, align 4, !tbaa !5
...
103:                                              ; preds = %84, %101, %97, %93, %89
  ...
  %107 = load i32, ptr %106, align 16, !tbaa !5
...
108:                                              ; preds = %103
  %109 = load i32, ptr %1, align 4, !tbaa !5
...
116:                                              ; preds = %103
  %117 = load i32, ptr %13, align 4, !tbaa !5
  %118 = load i32, ptr %15, align 4, !tbaa !5
  %119 = mul nsw i32 %118, %117
  br label %122

120:                                              ; preds = %103
  %121 = load i32, ptr %15, align 4, !tbaa !5
  br label %122
...
127:                                              ; preds = %122
  %128 = load i32, ptr %1, align 4, !tbaa !5
...
137:                                              ; preds = %122
  ...
  %139 = load i32, ptr %15, align 4, !tbaa !5
...
145:                                              ; preds = %122
  ...
  store i32 -42, ptr %146, align 4, !tbaa !5
  br label %147
...
define dso_local void @setcartsymvi_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3) local_unnamed_addr #1 {
  ...
  %7 = tail call i32 @SetCartSymVI(ptr noundef %5, ptr noundef %2, i32 noundef %6), !range !13
...
6:                                                ; preds = %3
  %7 = tail call i32 @SetCartSymVI(ptr noundef %0, ptr noundef %1, i32 noundef %4), !range !13
  br label %10

8:                                                ; preds = %3
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 153, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4, ptr noundef %2) #5
  br label %10
...
10:                                               ; preds = %5
  %11 = tail call i32 @SetCartSymVI(ptr noundef %7, ptr noundef %2, i32 noundef %8), !range !13
  br label %14

12:                                               ; preds = %5
  %13 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 153, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4, ptr noundef %6) #5
  br label %14
...
define dso_local i32 @SetCartSymGI(ptr noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2) local_unnamed_addr #1 {
  %4 = alloca [6 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %4) #5
  %5 = tail call ptr @CCTK_GHExtension(ptr noundef %0, ptr noundef nonnull @.str.3) #5
...
22:                                               ; preds = %3
  ...
  %24 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 195, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.5, ptr noundef %23, i32 noundef %6) #5
  br label %152

25:                                               ; preds = %11, %147
  %26 = phi i64 [ %15, %11 ], [ %150, %147 ]
  call void @DecodeSymParameters3D(ptr noundef nonnull %4) #5
  %27 = load i32, ptr %4, align 16, !tbaa !5
...
40:                                               ; preds = %25
  ...
  %42 = load i32, ptr %14, align 4, !tbaa !5
...
47:                                               ; preds = %25
  ...
  store i32 %50, ptr %53, align 4, !tbaa !5
  br label %58
...
54:                                               ; preds = %25
  ...
  store i32 -42, ptr %57, align 4, !tbaa !5
  br label %58

58:                                               ; preds = %28, %40, %54, %47, %33
  %59 = phi ptr [ %32, %28 ], [ %46, %40 ], [ %57, %54 ], [ %53, %47 ], [ %39, %33 ]
  %60 = load i32, ptr %17, align 4, !tbaa !5
...
75:                                               ; preds = %58, %73, %69, %65, %61
  ...
  %78 = load i32, ptr %18, align 8, !tbaa !5
...
83:                                               ; preds = %75
  %84 = load i32, ptr %1, align 4, !tbaa !5
...
91:                                               ; preds = %75
  %92 = load i32, ptr %13, align 4, !tbaa !5
  br label %93
...
93:                                               ; preds = %75, %91, %87, %83, %79
  ...
  %96 = load i32, ptr %19, align 4, !tbaa !5
...
101:                                              ; preds = %93
  %102 = load i32, ptr %1, align 4, !tbaa !5
  %103 = load i32, ptr %14, align 4, !tbaa !5
  %104 = mul nsw i32 %103, %102
  br label %111

105:                                              ; preds = %93
  %106 = load i32, ptr %13, align 4, !tbaa !5
...
111:                                              ; preds = %93, %109, %105, %101, %97
  ...
  %114 = load i32, ptr %20, align 16, !tbaa !5
...
115:                                              ; preds = %111
  %116 = load i32, ptr %1, align 4, !tbaa !5
  %117 = load i32, ptr %13, align 4, !tbaa !5
  %118 = mul nsw i32 %117, %116
  br label %129

119:                                              ; preds = %111
  %120 = load i32, ptr %1, align 4, !tbaa !5
...
123:                                              ; preds = %111
  ...
  %125 = load i32, ptr %14, align 4, !tbaa !5
  %126 = mul nsw i32 %125, %124
  br label %129

127:                                              ; preds = %111
  %128 = load i32, ptr %14, align 4, !tbaa !5
  br label %129
...
129:                                              ; preds = %111, %127, %123, %119, %115
  ...
  store i32 %130, ptr %131, align 4, !tbaa !5
  %132 = load i32, ptr %21, align 4, !tbaa !5
...
141:                                              ; preds = %129
  %142 = load i32, ptr %13, align 4, !tbaa !5
...
147:                                              ; preds = %129, %145, %141, %137, %133
  ...
  br i1 %151, label %25, label %152, !llvm.loop !14
...
define dso_local void @setcartsymgi_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3) local_unnamed_addr #1 {
  %5 = load ptr, ptr %1, align 8, !tbaa !12
  %6 = load i32, ptr %3, align 4, !tbaa !5
  %7 = tail call i32 @SetCartSymGI(ptr noundef %5, ptr noundef %2, i32 noundef %6), !range !13
  store i32 %7, ptr %0, align 4, !tbaa !5
  ret void
}
...
6:                                                ; preds = %3
  %7 = tail call i32 @SetCartSymGI(ptr noundef %0, ptr noundef %1, i32 noundef %4), !range !13
  br label %10

8:                                                ; preds = %3
  %9 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 278, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.6, ptr noundef %2) #5
  br label %10
...
10:                                               ; preds = %5
  %11 = tail call i32 @SetCartSymGI(ptr noundef %7, ptr noundef %2, i32 noundef %8), !range !13
  br label %14

12:                                               ; preds = %5
  %13 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 278, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.6, ptr noundef %6) #5
  br label %14
