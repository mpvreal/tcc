...
@.str.15 = private unnamed_addr constant [5 x i8] c"both\00", align 1
@.str.16 = private unnamed_addr constant [10 x i8] c"just warn\00", align 1
...
@.str.17 = private unnamed_addr constant [18 x i8] c"MoL/RHSNaNCheck.c\00", align 1
@.str.18 = private unnamed_addr constant [4 x i8] c"MoL\00", align 1
@.str.19 = private unnamed_addr constant [43 x i8] c"NaNs were found on iteration %d inside MoL\00", align 1
...
104:                                              ; preds = %102, %97
  ...
  %108 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !5
...
110:                                              ; preds = %104, %110
  ...
  %113 = load ptr, ptr @RHSVariableIndex, align 8, !tbaa !13
  ...
  %117 = tail call i32 @CheckVarsForNaN(ptr noundef %0, i32 noundef -1, ptr noundef %116, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.16) #4
  %118 = add nsw i32 %117, %112
  tail call void @free(ptr noundef %116) #4
  %119 = add nuw nsw i64 %111, 1
  %120 = load i32, ptr @MoLNumEvolvedVariables, align 4, !tbaa !5
...
125:                                              ; preds = %123
  %126 = load i32, ptr %36, align 4, !tbaa !5
  %127 = add i32 %107, 1
  %128 = sub i32 %127, %126
  %129 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 0, i32 noundef 104, ptr noundef nonnull @.str.17, ptr noundef nonnull @.str.18, ptr noundef nonnull @.str.19, i32 noundef %128) #4
  br label %130
