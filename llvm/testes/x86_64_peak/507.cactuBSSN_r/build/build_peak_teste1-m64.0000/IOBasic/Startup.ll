...
@.str.1 = private unnamed_addr constant [18 x i8] c"IOBasic/Startup.c\00", align 1
@.str.2 = private unnamed_addr constant [8 x i8] c"IOBasic\00", align 1
@.str.3 = private unnamed_addr constant [72 x i8] c"Thorn IOUtil was not activated. No IOBasic I/O methods will be enabled.\00", align 1
@IOBasic_Init.cctki_vi_next_info_output_time = internal unnamed_addr global i32 -100, align 4
@.str.4 = private unnamed_addr constant [31 x i8] c"IOBasic::next_info_output_time\00", align 1
@IOBasic_Init.cctki_vi_next_scalar_output_time = internal unnamed_addr global i32 -100, align 4
@.str.5 = private unnamed_addr constant [33 x i8] c"IOBasic::next_scalar_output_time\00", align 1
@.str.6 = private unnamed_addr constant [43 x i8] c"option list '%s' for variable '%s' ignored\00", align 1
@.str.7 = private unnamed_addr constant [22 x i8] c"CCTK_VARIABLE_COMPLEX\00", align 1
@.str.8 = private unnamed_addr constant [13 x i8] c"scalar value\00", align 1
@.str.9 = private unnamed_addr constant [10 x i8] c"real part\00", align 1
@.str.10 = private unnamed_addr constant [10 x i8] c"imag part\00", align 1
@.str.11 = private unnamed_addr constant [11 x i8] c"reductions\00", align 1
@.str.12 = private unnamed_addr constant [92 x i8] c"Key 'reductions' in option string '%s' for variable '%s' must have a non-empty string value\00", align 1
@.str.13 = private unnamed_addr constant [76 x i8] c"Option with key '%s' in option string '%s' for variable '%s' not recognized\00", align 1
@.str.14 = private unnamed_addr constant [56 x i8] c"Option string '%s' for variable '%s' couldn't be parsed\00", align 1
@.str.15 = private unnamed_addr constant [82 x i8] c"Unknown reduction operator '%s'.  Maybe you forgot to activate thorn LocalReduce?\00", align 1
@.str.16 = private unnamed_addr constant [79 x i8] c"IOBasic_AssignReductionList: Duplicate reduction operator '%s' will be ignored\00", align 1
...
@.str.21 = private unnamed_addr constant [102 x i8] c"I/O Method 'Scalar' registered: output of scalar quantities (grid scalars, reductions) to ASCII files\00", align 1
@.str.22 = private unnamed_addr constant [95 x i8] c"I/O Method 'Info' registered: output of scalar quantities (grid scalars, reductions) to screen\00", align 1
@.str.23 = private unnamed_addr constant [2 x i8] c".\00", align 1
@.str.24 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@CCTK_MyProc = external local_unnamed_addr global ptr, align 8
@.str.25 = private unnamed_addr constant [62 x i8] c"IOBasic_SetupGH: Couldn't create Scalar output directory '%s'\00", align 1
@.str.26 = private unnamed_addr constant [5 x i8] c"full\00", align 1
@.str.27 = private unnamed_addr constant [33 x i8] c"Scalar: Output to directory '%s'\00", align 1
...
define dso_local i32 @IOBasic_Startup() local_unnamed_addr #1 {
  %1 = tail call i32 @CCTK_GHExtensionHandle(ptr noundef nonnull @.str) #11
  %2 = icmp slt i32 %1, 0
  br i1 %2, label %3, label %5

3:                                                ; preds = %0
  %4 = tail call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 75, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #11
  br label %8

5:                                                ; preds = %0
  %6 = tail call i32 @CCTK_RegisterGHExtension(ptr noundef nonnull @.str.2) #11
...
define internal ptr @IOBasic_SetupGH(ptr nocapture readnone %0, i32 %1, ptr noundef %2) #1 {
  %4 = load <2 x double>, ptr @iobasicpriv_, align 8, !tbaa !5
  %5 = load ptr, ptr getelementptr inbounds (%struct.anon, ptr @iobasicpriv_, i64 0, i32 9), align 8, !tbaa !9
  %6 = load <2 x i32>, ptr getelementptr inbounds (%struct.anon, ptr @iobasicpriv_, i64 0, i32 11), align 8, !tbaa !13
  %7 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 18), align 8, !tbaa !14
  ...
  %10 = load ptr, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 27), align 8, !tbaa !16
  %11 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @iorest_, i64 0, i32 56), align 8, !tbaa !17
...
14:                                               ; preds = %3
  ...
  %17 = tail call i32 @CCTKi_RegisterIOMethod(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.18) #11
  ...
  %22 = tail call i32 @CCTKi_RegisterIOMethod(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.19) #11
  ...
  store <2 x i32> %41, ptr %12, align 8, !tbaa !13
  ...
  store <2 x double> %45, ptr %43, align 8, !tbaa !5
  ...
  store i32 %11, ptr %47, align 8, !tbaa !24
  %48 = tail call i32 @CCTK_Equals(ptr noundef %10, ptr noundef nonnull @.str.20) #11
  %49 = icmp eq i32 %48, 0
  br i1 %49, label %50, label %52

50:                                               ; preds = %14
  %51 = tail call i32 @CCTK_Info(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.21) #11
  br label %52

52:                                               ; preds = %50, %14
  tail call void @IOBasic_CheckSteerableInfoParameters(ptr noundef nonnull %12) #11
  %53 = tail call i32 @CCTK_Equals(ptr noundef %10, ptr noundef nonnull @.str.20) #11
  %54 = icmp eq i32 %53, 0
  br i1 %54, label %55, label %57

55:                                               ; preds = %52
  %56 = tail call i32 @CCTK_Info(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.22) #11
  br label %57

57:                                               ; preds = %55, %52
  tail call void @IOBasic_CheckSteerableInfoParameters(ptr noundef nonnull %12) #11
  store i32 0, ptr %47, align 8, !tbaa !24
  %58 = load i8, ptr %5, align 1, !tbaa !25
  %59 = icmp eq i8 %58, 0
  %60 = select i1 %59, ptr %7, ptr %5
  %61 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %60, ptr noundef nonnull dereferenceable(2) @.str.23) #14
  %62 = icmp eq i32 %61, 0
...
76:                                               ; preds = %57
  %77 = tail call ptr @Util_Strdup(ptr noundef nonnull @.str.24) #11
...
84:                                               ; preds = %79
  %85 = load ptr, ptr @CCTK_MyProc, align 8, !tbaa !27
...
92:                                               ; preds = %88
  %93 = load ptr, ptr %81, align 8, !tbaa !26
  %94 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 233, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.25, ptr noundef %93) #11
  br label %101

95:                                               ; preds = %88
  %96 = tail call i32 @CCTK_Equals(ptr noundef %10, ptr noundef nonnull @.str.26) #11
  %97 = icmp eq i32 %96, 0
  br i1 %97, label %101, label %98

98:                                               ; preds = %95
  %99 = load ptr, ptr %81, align 8, !tbaa !26
  %100 = tail call i32 (ptr, ptr, ...) @CCTK_VInfo(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.27, ptr noundef %99) #11
  br label %101
...
define dso_local void @IOBasic_Init(ptr noundef %0) local_unnamed_addr #1 {
  ...
  %4 = load i32, ptr @IOBasic_Init.cctki_vi_next_info_output_time, align 4, !tbaa !13
  %5 = icmp eq i32 %4, -100
  br i1 %5, label %6, label %8

6:                                                ; preds = %1
  %7 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.4) #11
  store i32 %7, ptr @IOBasic_Init.cctki_vi_next_info_output_time, align 4, !tbaa !13
  br label %8

8:                                                ; preds = %6, %1
  %9 = phi i32 [ %7, %6 ], [ %4, %1 ]
  %10 = tail call ptr @CCTKi_VarDataPtrI(ptr noundef nonnull %0, i32 noundef 0, i32 noundef %9) #11
  %11 = load i32, ptr @IOBasic_Init.cctki_vi_next_scalar_output_time, align 4, !tbaa !13
  %12 = icmp eq i32 %11, -100
  br i1 %12, label %13, label %15

13:                                               ; preds = %8
  %14 = tail call i32 @CCTK_VarIndex(ptr noundef nonnull @.str.5) #11
  store i32 %14, ptr @IOBasic_Init.cctki_vi_next_scalar_output_time, align 4, !tbaa !13
  br label %15
...
15:                                               ; preds = %13, %8
  ...
  store double %3, ptr %17, align 8, !tbaa !5
  ret void
}
...
15:                                               ; preds = %13
  ...
  %17 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 5, i32 noundef 297, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.6, ptr noundef nonnull %1, ptr noundef %16) #11
  br label %18
...
18:                                               ; preds = %15, %13
  ...
  %23 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %22, ptr noundef nonnull dereferenceable(22) @.str.7, i64 noundef 21) #14
  %24 = icmp eq i32 %23, 0
  br i1 %24, label %30, label %25

25:                                               ; preds = %18
  store i32 1, ptr %10, align 8, !tbaa !34
  %26 = tail call ptr @Util_Strdup(ptr noundef nonnull @.str.8) #11
...
30:                                               ; preds = %18
  ...
  %31 = tail call ptr @Util_Strdup(ptr noundef nonnull @.str.9) #11
  ...
  %36 = tail call ptr @Util_Strdup(ptr noundef nonnull @.str.10) #11
  ...
  store ptr %36, ptr %40, align 8, !tbaa !35
...
49:                                               ; preds = %45
  %50 = call i32 @Util_TableQueryValueInfo(i32 noundef %47, ptr noundef nonnull %5, ptr noundef nonnull %6, ptr noundef nonnull @.str.11) #11
...
58:                                               ; preds = %52
  ...
  %62 = call i32 @Util_TableGetString(i32 noundef %47, i32 noundef %59, ptr noundef %61, ptr noundef nonnull @.str.11) #11
  br label %65

63:                                               ; preds = %52
  %64 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 344, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.12, ptr noundef nonnull %1, ptr noundef %46) #11
  br label %65

65:                                               ; preds = %63, %58
  %66 = phi ptr [ %61, %58 ], [ null, %63 ]
  %67 = call i32 @Util_TableDeleteKey(i32 noundef %47, ptr noundef nonnull @.str.11) #11
  br label %68
...
77:                                               ; preds = %74
  %78 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 359, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.13, ptr noundef nonnull %4, ptr noundef nonnull %1, ptr noundef %46) #11
  %79 = call i32 @Util_TableItAdvance(i32 noundef %71) #11
  %80 = call i32 @Util_TableItQueryIsNonNull(i32 noundef %71) #11
  %81 = icmp sgt i32 %80, 0
  br i1 %81, label %74, label %84, !llvm.loop !38

82:                                               ; preds = %45
  %83 = tail call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 369, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.14, ptr noundef nonnull %1, ptr noundef %46) #11
...
100:                                              ; preds = %94
  %101 = load i8, ptr %95, align 1, !tbaa !25
...
105:                                              ; preds = %103, %151
  ...
  %108 = load ptr, ptr %104, align 8, !tbaa !27
...
146:                                              ; preds = %138
  %147 = load ptr, ptr %43, align 8, !tbaa !27
  %148 = icmp eq ptr %147, null
  br i1 %148, label %168, label %158

149:                                              ; preds = %138
  %150 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 1, i32 noundef 416, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.15, ptr noundef nonnull %98) #11
  br label %151

151:                                              ; preds = %149, %164, %168
  %152 = load i8, ptr %129, align 1, !tbaa !25
...
154:                                              ; preds = %158
  ...
  br i1 %157, label %166, label %158, !llvm.loop !45
...
164:                                              ; preds = %158
  %165 = call i32 (i32, i32, ptr, ptr, ptr, ...) @CCTK_VWarn(i32 noundef 3, i32 noundef 434, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.16, ptr noundef %98) #11
  br label %151
...
168:                                              ; preds = %166, %146
  ...
  store ptr %170, ptr %169, align 8, !tbaa !27
  store i32 %144, ptr %170, align 8, !tbaa !46
  ...
  %176 = load i32, ptr %10, align 8, !tbaa !34
  %177 = add i32 %176, 1
  store i32 %177, ptr %10, align 8, !tbaa !34
  br label %151
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !11, i64 72}
!10 = !{!"", !6, i64 0, !6, i64 8, !11, i64 16, !11, i64 24, !11, i64 32, !11, i64 40, !11, i64 48, !11, i64 56, !11, i64 64, !11, i64 72, !11, i64 80, !12, i64 88, !12, i64 92}
!11 = !{!"any pointer", !7, i64 0}
!12 = !{!"int", !7, i64 0}
!13 = !{!12, !12, i64 0}
!14 = !{!15, !11, i64 144}
!15 = !{!"", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !6, i64 32, !6, i64 40, !6, i64 48, !6, i64 56, !6, i64 64, !6, i64 72, !6, i64 80, !11, i64 88, !11, i64 96, !11, i64 104, !11, i64 112, !11, i64 120, !11, i64 128, !11, i64 136, !11, i64 144, !11, i64 152, !11, i64 160, !11, i64 168, !11, i64 176, !11, i64 184, !11, i64 192, !11, i64 200, !11, i64 208, !11, i64 216, !12, i64 224, !12, i64 228, !12, i64 232, !12, i64 236, !12, i64 240, !12, i64 244, !12, i64 248, !12, i64 252, !12, i64 256, !12, i64 260, !12, i64 264, !12, i64 268, !12, i64 272, !12, i64 276, !12, i64 280, !12, i64 284, !12, i64 288, !12, i64 292, !12, i64 296, !12, i64 300, !12, i64 304, !12, i64 308, !12, i64 312, !12, i64 316, !12, i64 320, !12, i64 324, !12, i64 328, !12, i64 332, !12, i64 336}
!16 = !{!15, !11, i64 216}
!17 = !{!15, !12, i64 336}
!18 = !{!19, !11, i64 56}
!19 = !{!"IOBASIC_GH", !12, i64 0, !12, i64 4, !6, i64 8, !6, i64 16, !7, i64 24, !11, i64 32, !11, i64 40, !11, i64 48, !11, i64 56, !11, i64 64, !11, i64 72, !12, i64 80}
!20 = !{!19, !11, i64 64}
!21 = !{!19, !11, i64 40}
!22 = !{!19, !11, i64 48}
!23 = !{!19, !11, i64 72}
...
!27 = !{!11, !11, i64 0}
!28 = !{!29, !6, i64 144}
!29 = !{!"_cGH", !12, i64 0, !12, i64 4, !11, i64 8, !11, i64 16, !11, i64 24, !11, i64 32, !11, i64 40, !11, i64 48, !11, i64 56, !6, i64 64, !11, i64 72, !11, i64 80, !11, i64 88, !11, i64 96, !11, i64 104, !11, i64 112, !12, i64 120, !12, i64 124, !12, i64 128, !11, i64 136, !6, i64 144, !11, i64 152, !11, i64 160, !11, i64 168, !11, i64 176}
!30 = !{!31, !11, i64 8}
!31 = !{!"IOBASIC_PARSEINFO", !11, i64 0, !11, i64 8}
!32 = !{!33, !11, i64 8}
!33 = !{!"IOBASIC_REDUCTIONLIST", !12, i64 0, !11, i64 8}
!34 = !{!33, !12, i64 0}
!35 = !{!36, !11, i64 8}
!36 = !{!"IOBASIC_REDUCTION", !12, i64 0, !11, i64 8, !7, i64 16, !6, i64 24, !11, i64 32}
!37 = !{!36, !11, i64 32}
!38 = distinct !{!38, !39}
