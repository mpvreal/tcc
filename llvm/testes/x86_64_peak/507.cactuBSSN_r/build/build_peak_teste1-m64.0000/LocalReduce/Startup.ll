...
@.str = private unnamed_addr constant [12 x i8] c"LocalReduce\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"mean\00", align 1
...
@.str.9 = private unnamed_addr constant [6 x i8] c"norm3\00", align 1
@.str.10 = private unnamed_addr constant [6 x i8] c"norm4\00", align 1
@.str.11 = private unnamed_addr constant [9 x i8] c"norm_inf\00", align 1
@.str.12 = private unnamed_addr constant [47 x i8] c"$Id: Startup.c 72 2005-11-16 19:17:35Z yye00 $\00", align 1
...
define dso_local i32 @LocalReduce_Startup() local_unnamed_addr #1 {
  %1 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_Mean, ptr noundef nonnull @.str.1) #3
  %2 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_Mean, ptr noundef nonnull @.str.2) #3
  %3 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_Max, ptr noundef nonnull @.str.3) #3
  %4 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_Min, ptr noundef nonnull @.str.4) #3
  %5 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_Count, ptr noundef nonnull @.str.5) #3
  %6 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_Sum, ptr noundef nonnull @.str.6) #3
  %7 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_L1, ptr noundef nonnull @.str.7) #3
  %8 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_L2, ptr noundef nonnull @.str.8) #3
  %9 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_L3, ptr noundef nonnull @.str.9) #3
  %10 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_L4, ptr noundef nonnull @.str.10) #3
  %11 = tail call i32 @CCTKi_RegisterLocalArrayReductionOperator(ptr noundef nonnull @.str, ptr noundef nonnull @LocalReduce_LInf, ptr noundef nonnull @.str.11) #3
  ret i32 0
}
