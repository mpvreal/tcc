; ModuleID = 'LocalReduce/ReductionSum.c'
source_filename = "LocalReduce/ReductionSum.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [56 x i8] c"$Id: ReductionSum.c 103 2013-03-03 22:25:23Z eschnett $\00", align 1
...
@.str.7 = private unnamed_addr constant [27 x i8] c"LocalReduce/ReductionSum.c\00", align 1
@.str.8 = private unnamed_addr constant [12 x i8] c"LocalReduce\00", align 1
@.str.9 = private unnamed_addr constant [95 x i8] c"Sum reduction returns a single value\0A                                    for each input array\0A\00", align 1
...
define dso_local nonnull ptr @CCTKi_version_CactusBase_LocalReduce_ReductionSum_c() local_unnamed_addr #0 {
  ret ptr @.str
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local i32 @LocalReduce_Sum(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %6, i32 noundef %7, ptr noundef %8, ptr noundef %9) local_unnamed_addr #1 {
  %11 = tail call i32 @LocalReduce_Reduce(i32 noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %6, i32 noundef %7, ptr noundef %8, ptr noundef %9, ptr noundef nonnull @ReductionSum) #8
  ret i32 %11
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal i32 @ReductionSum(i32 noundef %0, i32 %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr nocapture noundef readonly %5, ptr noundef %6, i32 noundef %7, ptr noundef %8, ptr noundef %9) #1 {
...
77:                                               ; preds = %71
  %78 = call i32 @CCTK_Warn(i32 noundef 1, i32 noundef 220, ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.9) #8
  br label %167
...
104:                                              ; preds = %99
  %105 = load i32, ptr %13, align 4, !tbaa !5
  %106 = load ptr, ptr %14, align 8, !tbaa !15
  %107 = trunc i64 %101 to i32
  %108 = call i32 @LocalReduce_Sum_BYTE(i32 noundef %107, i32 noundef %105, ptr noundef %106, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
...
109:                                              ; preds = %99
  ...
  %113 = call i32 @LocalReduce_Sum_INT(i32 noundef %112, i32 noundef %110, ptr noundef %111, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
  store i32 %113, ptr %11, align 4, !tbaa !5
  br label %149
...
114:                                              ; preds = %99
  ...
  %118 = call i32 @LocalReduce_Sum_INT1(i32 noundef %117, i32 noundef %115, ptr noundef %116, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
  store i32 %118, ptr %11, align 4, !tbaa !5
  br label %149

119:                                              ; preds = %99
  %120 = load i32, ptr %13, align 4, !tbaa !5
  %121 = load ptr, ptr %14, align 8, !tbaa !15
  %122 = trunc i64 %101 to i32
  %123 = call i32 @LocalReduce_Sum_INT2(i32 noundef %122, i32 noundef %120, ptr noundef %121, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
  store i32 %123, ptr %11, align 4, !tbaa !5
  br label %149

124:                                              ; preds = %99
  %125 = load i32, ptr %13, align 4, !tbaa !5
  %126 = load ptr, ptr %14, align 8, !tbaa !15
  %127 = trunc i64 %101 to i32
  %128 = call i32 @LocalReduce_Sum_INT4(i32 noundef %127, i32 noundef %125, ptr noundef %126, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
  store i32 %128, ptr %11, align 4, !tbaa !5
  br label %149

129:                                              ; preds = %99
  %130 = load i32, ptr %13, align 4, !tbaa !5
  %131 = load ptr, ptr %14, align 8, !tbaa !15
  %132 = trunc i64 %101 to i32
  %133 = call i32 @LocalReduce_Sum_INT8(i32 noundef %132, i32 noundef %130, ptr noundef %131, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
...
134:                                              ; preds = %99
  ...
  %138 = call i32 @LocalReduce_Sum_REAL(i32 noundef %137, i32 noundef %135, ptr noundef %136, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
...
139:                                              ; preds = %99
  ...
  %143 = call i32 @LocalReduce_Sum_REAL4(i32 noundef %142, i32 noundef %140, ptr noundef %141, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
  store i32 %143, ptr %11, align 4, !tbaa !5
  br label %149

144:                                              ; preds = %99
  %145 = load i32, ptr %13, align 4, !tbaa !5
  %146 = load ptr, ptr %14, align 8, !tbaa !15
  %147 = trunc i64 %101 to i32
  %148 = call i32 @LocalReduce_Sum_REAL8(i32 noundef %147, i32 noundef %145, ptr noundef %146, ptr noundef %24, ptr noundef %19, i32 noundef %80, ptr noundef %20, ptr noundef %25, ptr noundef %26, ptr noundef %4, i32 noundef %100, ptr noundef %21, ptr noundef %18, i32 noundef %0, ptr noundef %6, ptr noundef %8, ptr noundef %9, i32 noundef %2) #8
  store i32 %148, ptr %11, align 4, !tbaa !5
  br label %149
...
149:                                              ; preds = %104, %109, %114, %119, %124, %129, %134, %139, %144, %99
  ...
  br i1 %152, label %153, label %99, !llvm.loop !17
...
declare i32 @LocalReduce_Sum_BYTE(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_INT(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_INT1(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_INT2(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_INT4(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_INT8(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_REAL(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_REAL4(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

declare i32 @LocalReduce_Sum_REAL8(i32 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #2
